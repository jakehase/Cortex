...
def main() -> int:
    ...
    print(json.dumps({"success": True, "baseline": baseline, "taxonomy": taxonomy, "features": features, "candidates": candidates, "replay": replay, "rollback": rollback, "shadow": shadow, "canary": canary, "full_rollout": full_rollout}, indent=2))
    return 0
