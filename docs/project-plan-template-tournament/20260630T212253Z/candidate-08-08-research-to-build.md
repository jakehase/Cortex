# Research-to-implementation plan template

Candidate: `08-research-to-build`

## Use when

Best when current facts are uncertain and implementation depends on source comparison or design discovery.
