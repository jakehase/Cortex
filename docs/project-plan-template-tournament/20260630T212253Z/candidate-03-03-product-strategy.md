# Product strategy + build plan template

Candidate: `03-product-strategy`

## Use when

Balances user outcome, product surfaces, implementation phases, and launch readiness.
...
## User promise and product surface

- target user/operator
- promised outcome
- primary workflows
- release surface
- support/ops expectation
