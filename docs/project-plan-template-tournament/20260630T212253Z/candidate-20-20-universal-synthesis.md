# Universal serious-project plan template

Candidate: `20-universal-synthesis`

## Use when

Synthesizes the strongest sections into one default template for future projects.
...
- prior-art decision recorded
- subsystem owners listed
- verifiers mapped
