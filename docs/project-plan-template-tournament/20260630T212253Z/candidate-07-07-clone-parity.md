# Clone/parity plan template

Candidate: `07-clone-parity`

## Use when

Best for exact clone/full parity work with negative-space inventory and surface coverage.
...
## Parity and negative-space matrix

| Surface | Required behavior | Observed | Missing | Evidence |
|---|---|---|---|---|
