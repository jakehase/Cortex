# Agent orchestration plan template

Candidate: `02-agent-orchestration`

## Use when

Optimized for 10-100 agent work with ownership, leases, remote execution, and merge gates.
...
- leases defined
- remote execution boundary verified
