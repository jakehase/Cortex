# Verifier-led plan template

Candidate: `05-verifier-led`

## Use when

Starts from tests, evidence, artifacts, and claim gates before implementation.
...
| Claim | Required verifier | Evidence artifact | Failure mode |
|---|---|---|---|
