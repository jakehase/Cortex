...
Candidate: `15-api-integration`

## Use when

Best for service/API integrations with contracts, schemas, auth, rate limits, and idempotency.
...
| Endpoint/event | Auth | Idempotency | Rate limit | Test |
|---|---|---|---|---|
