# UX/application plan template

Candidate: `14-ux-application`

## Use when

Best for user-facing app work with workflows, states, and acceptance journeys.
...
| Journey | State | Inputs | Expected output | Acceptance check |
|---|---|---|---|---|
