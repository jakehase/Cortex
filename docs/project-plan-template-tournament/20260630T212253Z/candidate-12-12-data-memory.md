# Data/memory plan template

Candidate: `12-data-memory`

## Use when

Best for knowledge systems, datasets, memory, indexing, and recall quality.
...
## Data and memory quality contract
