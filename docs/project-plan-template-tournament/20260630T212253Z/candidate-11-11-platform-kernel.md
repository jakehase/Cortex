# Platform/kernel plan template

Candidate: `11-platform-kernel`

## Use when

Best for full platform or OS-scale projects with a small trusted core and large userland.
