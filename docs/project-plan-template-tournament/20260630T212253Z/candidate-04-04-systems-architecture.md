# Systems architecture plan template

Candidate: `04-systems-architecture`

## Use when

Best for platform/kernel/backend work with strong boundaries and subsystem contracts.
...
Record major decisions as ADRs with alternatives, tradeoffs, and rollback path.
