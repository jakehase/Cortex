# Safety and permissions plan template

Candidate: `06-safety-permissions`

## Use when

Best for external systems, privacy, irreversible operations, approvals, and authority boundaries.
...
## Approval and capability matrix

| Capability | Default | Requires approval? | Audit artifact | Revocation |
|---|---|---|---|---|
