...
const DOC_MATRIX_PATH = path.join(ROOT, 'docs', 'MAILCHIMP_TRUE_1TO1_SURFACE_MATRIX_2026-04-04.json');
const AUDIT_PATH = path.join(ROOT, 'docs', 'MAILCHIMP_1TO1_AUDIT_2026-04-04.md');
const EXECUTION_BRIEF_PATH = path.join(ROOT, 'docs', 'MAILCHIMP_TRUE_1TO1_EXECUTION_BRIEF_2026-04-04.md');
const GAP_PLAN_PATH = path.join(ROOT, 'docs', 'MAILCHIMP_TRUE_1TO1_GAP_CLOSURE_PLAN_2026-04-04.md');
