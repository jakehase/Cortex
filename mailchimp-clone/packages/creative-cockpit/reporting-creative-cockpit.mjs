...
export function createCreativeCockpitReportCards() {
...
export function createCreativeCockpitReviewPackets() {
...
export function summarizeCreativeCockpitReporting() {
  const cards = createCreativeCockpitReportCards();
  const packets = createCreativeCockpitReviewPackets();
  return {
