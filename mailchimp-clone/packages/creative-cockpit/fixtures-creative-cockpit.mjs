...
export function createCreativeCockpitFixtures() {
  return {
    accounts: [
...
export function summarizeCreativeCockpitFixtures(fixtures = createCreativeCockpitFixtures()) {
  return {
...
export function createCreativeCockpitDemoInputs() {
  return {
