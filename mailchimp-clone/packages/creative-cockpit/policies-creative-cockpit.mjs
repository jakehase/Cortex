...
export function createCreativeCockpitPolicies(overrides = {}) {
...
export function validateCreativeCockpitPolicies(policies = createCreativeCockpitPolicies()) {
  const issues = [];
...
export function summarizeCreativeCockpitPolicies(policies = createCreativeCockpitPolicies()) {
  return {
...
export function createCreativeCockpitEscalationDeck(policies = createCreativeCockpitPolicies()) {
