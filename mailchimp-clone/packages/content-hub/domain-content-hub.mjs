const MODULE = {
  ...
  "routeSegment": "hub",
  "title": "Content Hub",
  "focus": "Content Hub covers content operations, packaging, and channel-specific delivery shape through centralized operating views and routing.",
...
export function createContentHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentHubWorkspace(workspace = createContentHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentHubNarratives(workspace = createContentHubWorkspace()) {
...
export function createContentHubCoverageGrid(workspace = createContentHubWorkspace()) {
