...
export function createAutomationPlannerFixtures() {
  return {
    accounts: [
...
export function summarizeAutomationPlannerFixtures(fixtures = createAutomationPlannerFixtures()) {
  return {
...
export function createAutomationPlannerDemoInputs() {
  return {
