...
export function createAutomationPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAutomationPlannerWorkspace(workspace = createAutomationPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAutomationPlannerNarratives(workspace = createAutomationPlannerWorkspace()) {
...
export function createAutomationPlannerCoverageGrid(workspace = createAutomationPlannerWorkspace()) {
