...
export function createContentPlannerReportCards() {
...
export function createContentPlannerReviewPackets() {
...
export function summarizeContentPlannerReporting() {
  const cards = createContentPlannerReportCards();
  const packets = createContentPlannerReviewPackets();
  return {
