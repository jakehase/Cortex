...
export function createContentPlannerAnalyticsTimeline() {
...
export function createContentPlannerForecastEnvelope() {
...
export function createContentPlannerExceptionLedger() {
...
export function summarizeContentPlannerAnalytics() {
  const timeline = createContentPlannerAnalyticsTimeline();
  const forecast = createContentPlannerForecastEnvelope();
  return {
