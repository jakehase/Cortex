const MODULE = {
  ...
  "focus": "Content Planner covers content operations, packaging, and channel-specific delivery shape through calendar planning and execution choreography.",
...
export function createContentPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentPlannerWorkspace(workspace = createContentPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentPlannerNarratives(workspace = createContentPlannerWorkspace()) {
...
export function createContentPlannerCoverageGrid(workspace = createContentPlannerWorkspace()) {
