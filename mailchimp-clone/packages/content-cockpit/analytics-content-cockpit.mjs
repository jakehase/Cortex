...
export function createContentCockpitAnalyticsTimeline() {
...
export function createContentCockpitForecastEnvelope() {
...
export function createContentCockpitExceptionLedger() {
...
export function summarizeContentCockpitAnalytics() {
  const timeline = createContentCockpitAnalyticsTimeline();
  const forecast = createContentCockpitForecastEnvelope();
  return {
