...
export function createContentCockpitAuditTrail() {
...
export function createContentCockpitEvidenceManifest() {
...
export function createContentCockpitReadinessAttestation() {
  const auditTrail = createContentCockpitAuditTrail();
  return {
