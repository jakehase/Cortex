...
export function createContentCockpitPolicies(overrides = {}) {
...
export function validateContentCockpitPolicies(policies = createContentCockpitPolicies()) {
  const issues = [];
...
export function summarizeContentCockpitPolicies(policies = createContentCockpitPolicies()) {
  return {
...
export function createContentCockpitEscalationDeck(policies = createContentCockpitPolicies()) {
