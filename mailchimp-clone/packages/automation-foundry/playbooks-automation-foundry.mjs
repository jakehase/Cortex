...
export function createAutomationFoundryPlaybooks() {
...
export function createAutomationFoundryDecisionDeck() {
...
export function createAutomationFoundryEscalationMoments() {
