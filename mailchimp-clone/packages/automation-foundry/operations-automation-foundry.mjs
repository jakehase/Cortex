...
export function createAutomationFoundryOperationsBoard() {
...
export function createAutomationFoundryShiftChecklist() {
...
export function createAutomationFoundryIncidentDeck() {
