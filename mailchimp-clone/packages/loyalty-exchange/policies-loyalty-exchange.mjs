...
export function createLoyaltyExchangePolicies(overrides = {}) {
...
export function validateLoyaltyExchangePolicies(policies = createLoyaltyExchangePolicies()) {
  const issues = [];
...
export function summarizeLoyaltyExchangePolicies(policies = createLoyaltyExchangePolicies()) {
  return {
...
export function createLoyaltyExchangeEscalationDeck(policies = createLoyaltyExchangePolicies()) {
