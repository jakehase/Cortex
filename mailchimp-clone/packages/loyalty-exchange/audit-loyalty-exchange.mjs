...
export function createLoyaltyExchangeAuditTrail() {
...
export function createLoyaltyExchangeEvidenceManifest() {
...
export function createLoyaltyExchangeReadinessAttestation() {
  const auditTrail = createLoyaltyExchangeAuditTrail();
  return {
