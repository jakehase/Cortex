...
export function createCustomerSentinelPolicies(overrides = {}) {
...
export function validateCustomerSentinelPolicies(policies = createCustomerSentinelPolicies()) {
  const issues = [];
...
export function summarizeCustomerSentinelPolicies(policies = createCustomerSentinelPolicies()) {
  return {
...
export function createCustomerSentinelEscalationDeck(policies = createCustomerSentinelPolicies()) {
