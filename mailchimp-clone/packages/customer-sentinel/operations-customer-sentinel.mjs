...
export function createCustomerSentinelOperationsBoard() {
...
export function createCustomerSentinelShiftChecklist() {
...
export function createCustomerSentinelIncidentDeck() {
