...
export function createCampaignScorecardReportCards() {
...
export function createCampaignScorecardReviewPackets() {
...
export function summarizeCampaignScorecardReporting() {
  const cards = createCampaignScorecardReportCards();
  const packets = createCampaignScorecardReviewPackets();
  return {
