...
export function createCampaignScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignScorecardWorkspace(workspace = createCampaignScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignScorecardNarratives(workspace = createCampaignScorecardWorkspace()) {
...
export function createCampaignScorecardCoverageGrid(workspace = createCampaignScorecardWorkspace()) {
