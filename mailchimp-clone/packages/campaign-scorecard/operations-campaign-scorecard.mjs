...
export function createCampaignScorecardOperationsBoard() {
...
export function createCampaignScorecardShiftChecklist() {
...
export function createCampaignScorecardIncidentDeck() {
