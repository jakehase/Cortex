...
export function createCampaignScorecardPlaybooks() {
...
export function createCampaignScorecardDecisionDeck() {
...
export function createCampaignScorecardEscalationMoments() {
