...
export function createCampaignScorecardPolicies(overrides = {}) {
...
export function validateCampaignScorecardPolicies(policies = createCampaignScorecardPolicies()) {
  const issues = [];
...
export function summarizeCampaignScorecardPolicies(policies = createCampaignScorecardPolicies()) {
  return {
...
export function createCampaignScorecardEscalationDeck(policies = createCampaignScorecardPolicies()) {
