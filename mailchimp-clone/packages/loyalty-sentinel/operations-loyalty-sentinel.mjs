...
export function createLoyaltySentinelOperationsBoard() {
...
export function createLoyaltySentinelShiftChecklist() {
...
export function createLoyaltySentinelIncidentDeck() {
