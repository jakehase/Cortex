...
export function createComplianceConsoleOperationsBoard() {
...
export function createComplianceConsoleShiftChecklist() {
...
export function createComplianceConsoleIncidentDeck() {
