...
export function createComplianceConsoleReportCards() {
...
export function createComplianceConsoleReviewPackets() {
...
export function summarizeComplianceConsoleReporting() {
  const cards = createComplianceConsoleReportCards();
  const packets = createComplianceConsoleReviewPackets();
  return {
