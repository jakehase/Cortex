...
export function createComplianceConsoleAnalyticsTimeline() {
...
export function createComplianceConsoleForecastEnvelope() {
...
export function createComplianceConsoleExceptionLedger() {
...
export function summarizeComplianceConsoleAnalytics() {
  const timeline = createComplianceConsoleAnalyticsTimeline();
  const forecast = createComplianceConsoleForecastEnvelope();
  return {
