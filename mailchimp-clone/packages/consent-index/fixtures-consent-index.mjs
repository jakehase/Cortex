...
export function createConsentIndexFixtures() {
  return {
    accounts: [
...
export function summarizeConsentIndexFixtures(fixtures = createConsentIndexFixtures()) {
  return {
...
export function createConsentIndexDemoInputs() {
  return {
