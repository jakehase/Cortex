...
export function createConsentIndexAuditTrail() {
...
export function createConsentIndexEvidenceManifest() {
...
export function createConsentIndexReadinessAttestation() {
  const auditTrail = createConsentIndexAuditTrail();
  return {
