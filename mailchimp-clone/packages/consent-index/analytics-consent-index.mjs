...
export function createConsentIndexAnalyticsTimeline() {
...
export function createConsentIndexForecastEnvelope() {
...
export function createConsentIndexExceptionLedger() {
...
export function summarizeConsentIndexAnalytics() {
  const timeline = createConsentIndexAnalyticsTimeline();
  const forecast = createConsentIndexForecastEnvelope();
  return {
