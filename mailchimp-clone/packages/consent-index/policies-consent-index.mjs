...
export function createConsentIndexPolicies(overrides = {}) {
...
export function validateConsentIndexPolicies(policies = createConsentIndexPolicies()) {
  const issues = [];
...
export function summarizeConsentIndexPolicies(policies = createConsentIndexPolicies()) {
  return {
...
export function createConsentIndexEscalationDeck(policies = createConsentIndexPolicies()) {
