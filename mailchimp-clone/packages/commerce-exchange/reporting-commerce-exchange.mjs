...
export function createCommerceExchangeReportCards() {
...
export function createCommerceExchangeReviewPackets() {
...
export function summarizeCommerceExchangeReporting() {
  const cards = createCommerceExchangeReportCards();
  const packets = createCommerceExchangeReviewPackets();
  return {
