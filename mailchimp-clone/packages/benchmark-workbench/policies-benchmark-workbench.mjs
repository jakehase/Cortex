...
export function createBenchmarkWorkbenchPolicies(overrides = {}) {
...
export function validateBenchmarkWorkbenchPolicies(policies = createBenchmarkWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkWorkbenchPolicies(policies = createBenchmarkWorkbenchPolicies()) {
  return {
...
export function createBenchmarkWorkbenchEscalationDeck(policies = createBenchmarkWorkbenchPolicies()) {
