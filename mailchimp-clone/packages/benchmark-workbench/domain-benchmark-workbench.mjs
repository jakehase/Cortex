...
export function createBenchmarkWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBenchmarkWorkbenchWorkspace(workspace = createBenchmarkWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createBenchmarkWorkbenchNarratives(workspace = createBenchmarkWorkbenchWorkspace()) {
...
export function createBenchmarkWorkbenchCoverageGrid(workspace = createBenchmarkWorkbenchWorkspace()) {
