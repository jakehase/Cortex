...
export function createBenchmarkWorkbenchAnalyticsTimeline() {
...
export function createBenchmarkWorkbenchForecastEnvelope() {
...
export function createBenchmarkWorkbenchExceptionLedger() {
...
export function summarizeBenchmarkWorkbenchAnalytics() {
  const timeline = createBenchmarkWorkbenchAnalyticsTimeline();
  const forecast = createBenchmarkWorkbenchForecastEnvelope();
  return {
