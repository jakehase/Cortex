...
export function createCreativePlannerAnalyticsTimeline() {
...
export function createCreativePlannerForecastEnvelope() {
...
export function createCreativePlannerExceptionLedger() {
...
export function summarizeCreativePlannerAnalytics() {
  const timeline = createCreativePlannerAnalyticsTimeline();
  const forecast = createCreativePlannerForecastEnvelope();
  return {
