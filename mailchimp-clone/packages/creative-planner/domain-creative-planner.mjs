const MODULE = {
  ...
  "focus": "Creative Planner covers creative QA, variation readiness, and review-loop visibility through calendar planning and execution choreography.",
...
export function createCreativePlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCreativePlannerWorkspace(workspace = createCreativePlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCreativePlannerNarratives(workspace = createCreativePlannerWorkspace()) {
...
export function createCreativePlannerCoverageGrid(workspace = createCreativePlannerWorkspace()) {
