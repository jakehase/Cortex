...
export function createCreativePlannerAuditTrail() {
...
export function createCreativePlannerEvidenceManifest() {
...
export function createCreativePlannerReadinessAttestation() {
  const auditTrail = createCreativePlannerAuditTrail();
  return {
