...
export function createDataNavigatorAnalyticsTimeline() {
...
export function createDataNavigatorForecastEnvelope() {
...
export function createDataNavigatorExceptionLedger() {
...
export function summarizeDataNavigatorAnalytics() {
  const timeline = createDataNavigatorAnalyticsTimeline();
  const forecast = createDataNavigatorForecastEnvelope();
  return {
