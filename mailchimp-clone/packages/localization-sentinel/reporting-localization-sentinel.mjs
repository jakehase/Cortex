...
export function createLocalizationSentinelReportCards() {
...
export function createLocalizationSentinelReviewPackets() {
...
export function summarizeLocalizationSentinelReporting() {
  const cards = createLocalizationSentinelReportCards();
  const packets = createLocalizationSentinelReviewPackets();
  return {
