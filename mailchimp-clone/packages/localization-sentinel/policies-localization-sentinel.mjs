...
export function createLocalizationSentinelPolicies(overrides = {}) {
...
export function validateLocalizationSentinelPolicies(policies = createLocalizationSentinelPolicies()) {
  const issues = [];
...
export function summarizeLocalizationSentinelPolicies(policies = createLocalizationSentinelPolicies()) {
  return {
...
export function createLocalizationSentinelEscalationDeck(policies = createLocalizationSentinelPolicies()) {
