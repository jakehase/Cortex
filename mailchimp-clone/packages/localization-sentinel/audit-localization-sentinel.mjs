...
export function createLocalizationSentinelAuditTrail() {
...
export function createLocalizationSentinelEvidenceManifest() {
...
export function createLocalizationSentinelReadinessAttestation() {
  const auditTrail = createLocalizationSentinelAuditTrail();
  return {
