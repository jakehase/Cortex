...
export function createDataAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeDataAdvisorFixtures(fixtures = createDataAdvisorFixtures()) {
  return {
...
export function createDataAdvisorDemoInputs() {
  return {
