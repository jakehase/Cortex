...
export function createDeliverabilityWatchtowerAuditTrail() {
...
export function createDeliverabilityWatchtowerEvidenceManifest() {
...
export function createDeliverabilityWatchtowerReadinessAttestation() {
  const auditTrail = createDeliverabilityWatchtowerAuditTrail();
  return {
