...
export function createDeliverabilityWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityWatchtowerWorkspace(workspace = createDeliverabilityWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityWatchtowerNarratives(workspace = createDeliverabilityWatchtowerWorkspace()) {
...
export function createDeliverabilityWatchtowerCoverageGrid(workspace = createDeliverabilityWatchtowerWorkspace()) {
