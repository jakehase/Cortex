...
export function createDeliverabilityWatchtowerReportCards() {
...
export function createDeliverabilityWatchtowerReviewPackets() {
...
export function summarizeDeliverabilityWatchtowerReporting() {
  const cards = createDeliverabilityWatchtowerReportCards();
  const packets = createDeliverabilityWatchtowerReviewPackets();
  return {
