...
export function createDeliverabilityWatchtowerAnalyticsTimeline() {
...
export function createDeliverabilityWatchtowerForecastEnvelope() {
...
export function createDeliverabilityWatchtowerExceptionLedger() {
...
export function summarizeDeliverabilityWatchtowerAnalytics() {
  const timeline = createDeliverabilityWatchtowerAnalyticsTimeline();
  const forecast = createDeliverabilityWatchtowerForecastEnvelope();
  return {
