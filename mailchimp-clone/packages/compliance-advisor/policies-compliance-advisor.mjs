...
export function createComplianceAdvisorPolicies(overrides = {}) {
...
export function validateComplianceAdvisorPolicies(policies = createComplianceAdvisorPolicies()) {
  const issues = [];
...
export function summarizeComplianceAdvisorPolicies(policies = createComplianceAdvisorPolicies()) {
  return {
...
export function createComplianceAdvisorEscalationDeck(policies = createComplianceAdvisorPolicies()) {
