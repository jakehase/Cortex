...
export function createComplianceAdvisorPlaybooks() {
...
export function createComplianceAdvisorDecisionDeck() {
...
export function createComplianceAdvisorEscalationMoments() {
