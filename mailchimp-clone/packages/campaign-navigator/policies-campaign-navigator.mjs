...
export function createCampaignNavigatorPolicies(overrides = {}) {
...
export function validateCampaignNavigatorPolicies(policies = createCampaignNavigatorPolicies()) {
  const issues = [];
...
export function summarizeCampaignNavigatorPolicies(policies = createCampaignNavigatorPolicies()) {
  return {
...
export function createCampaignNavigatorEscalationDeck(policies = createCampaignNavigatorPolicies()) {
