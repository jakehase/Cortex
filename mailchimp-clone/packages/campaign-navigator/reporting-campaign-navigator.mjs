...
export function createCampaignNavigatorReportCards() {
...
export function createCampaignNavigatorReviewPackets() {
...
export function summarizeCampaignNavigatorReporting() {
  const cards = createCampaignNavigatorReportCards();
  const packets = createCampaignNavigatorReviewPackets();
  return {
