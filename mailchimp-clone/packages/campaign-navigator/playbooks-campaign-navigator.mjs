...
export function createCampaignNavigatorPlaybooks() {
...
export function createCampaignNavigatorDecisionDeck() {
...
export function createCampaignNavigatorEscalationMoments() {
