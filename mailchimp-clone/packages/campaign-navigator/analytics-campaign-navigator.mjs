...
export function createCampaignNavigatorAnalyticsTimeline() {
...
export function createCampaignNavigatorForecastEnvelope() {
...
export function createCampaignNavigatorExceptionLedger() {
...
export function summarizeCampaignNavigatorAnalytics() {
  const timeline = createCampaignNavigatorAnalyticsTimeline();
  const forecast = createCampaignNavigatorForecastEnvelope();
  return {
