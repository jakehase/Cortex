...
export function createComplianceWorkbenchFixtures() {
  return {
    accounts: [
...
export function summarizeComplianceWorkbenchFixtures(fixtures = createComplianceWorkbenchFixtures()) {
  return {
...
export function createComplianceWorkbenchDemoInputs() {
  return {
