...
export function createComplianceWorkbenchReportCards() {
...
export function createComplianceWorkbenchReviewPackets() {
...
export function summarizeComplianceWorkbenchReporting() {
  const cards = createComplianceWorkbenchReportCards();
  const packets = createComplianceWorkbenchReviewPackets();
  return {
