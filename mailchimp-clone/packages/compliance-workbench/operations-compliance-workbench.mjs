...
export function createComplianceWorkbenchOperationsBoard() {
...
export function createComplianceWorkbenchShiftChecklist() {
...
export function createComplianceWorkbenchIncidentDeck() {
