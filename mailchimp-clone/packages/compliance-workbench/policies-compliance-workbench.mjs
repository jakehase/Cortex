...
export function createComplianceWorkbenchPolicies(overrides = {}) {
...
export function validateComplianceWorkbenchPolicies(policies = createComplianceWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeComplianceWorkbenchPolicies(policies = createComplianceWorkbenchPolicies()) {
  return {
...
export function createComplianceWorkbenchEscalationDeck(policies = createComplianceWorkbenchPolicies()) {
