...
export function createDataWatchtowerReportCards() {
...
export function createDataWatchtowerReviewPackets() {
...
export function summarizeDataWatchtowerReporting() {
  const cards = createDataWatchtowerReportCards();
  const packets = createDataWatchtowerReviewPackets();
  return {
