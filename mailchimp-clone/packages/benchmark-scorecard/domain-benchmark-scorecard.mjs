...
export function createBenchmarkScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBenchmarkScorecardWorkspace(workspace = createBenchmarkScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createBenchmarkScorecardNarratives(workspace = createBenchmarkScorecardWorkspace()) {
...
export function createBenchmarkScorecardCoverageGrid(workspace = createBenchmarkScorecardWorkspace()) {
