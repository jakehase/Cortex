...
export function createBenchmarkScorecardPolicies(overrides = {}) {
...
export function validateBenchmarkScorecardPolicies(policies = createBenchmarkScorecardPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkScorecardPolicies(policies = createBenchmarkScorecardPolicies()) {
  return {
...
export function createBenchmarkScorecardEscalationDeck(policies = createBenchmarkScorecardPolicies()) {
