...
export function createBenchmarkScorecardOperationsBoard() {
...
export function createBenchmarkScorecardShiftChecklist() {
...
export function createBenchmarkScorecardIncidentDeck() {
