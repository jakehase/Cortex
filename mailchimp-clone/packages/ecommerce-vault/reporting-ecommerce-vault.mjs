...
export function createEcommerceVaultReportCards() {
...
export function createEcommerceVaultReviewPackets() {
...
export function summarizeEcommerceVaultReporting() {
  const cards = createEcommerceVaultReportCards();
  const packets = createEcommerceVaultReviewPackets();
  return {
