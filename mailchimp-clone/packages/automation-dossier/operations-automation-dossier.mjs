...
export function createAutomationDossierOperationsBoard() {
...
export function createAutomationDossierShiftChecklist() {
...
export function createAutomationDossierIncidentDeck() {
