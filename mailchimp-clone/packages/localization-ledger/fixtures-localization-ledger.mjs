...
export function createLocalizationLedgerFixtures() {
  return {
    accounts: [
...
export function summarizeLocalizationLedgerFixtures(fixtures = createLocalizationLedgerFixtures()) {
  return {
...
export function createLocalizationLedgerDemoInputs() {
  return {
