...
export function createLocalizationLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationLedgerWorkspace(workspace = createLocalizationLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationLedgerNarratives(workspace = createLocalizationLedgerWorkspace()) {
...
export function createLocalizationLedgerCoverageGrid(workspace = createLocalizationLedgerWorkspace()) {
