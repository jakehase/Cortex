...
export function createLoyaltyVaultAuditTrail() {
...
export function createLoyaltyVaultEvidenceManifest() {
...
export function createLoyaltyVaultReadinessAttestation() {
  const auditTrail = createLoyaltyVaultAuditTrail();
  return {
