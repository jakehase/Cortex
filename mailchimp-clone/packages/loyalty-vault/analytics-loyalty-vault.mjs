...
export function createLoyaltyVaultAnalyticsTimeline() {
...
export function createLoyaltyVaultForecastEnvelope() {
...
export function createLoyaltyVaultExceptionLedger() {
...
export function summarizeLoyaltyVaultAnalytics() {
  const timeline = createLoyaltyVaultAnalyticsTimeline();
  const forecast = createLoyaltyVaultForecastEnvelope();
  return {
