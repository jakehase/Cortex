...
export function createLoyaltyVaultWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyVaultWorkspace(workspace = createLoyaltyVaultWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyVaultNarratives(workspace = createLoyaltyVaultWorkspace()) {
...
export function createLoyaltyVaultCoverageGrid(workspace = createLoyaltyVaultWorkspace()) {
