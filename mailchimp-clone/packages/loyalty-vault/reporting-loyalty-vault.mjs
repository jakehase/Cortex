...
export function createLoyaltyVaultReportCards() {
...
export function createLoyaltyVaultReviewPackets() {
...
export function summarizeLoyaltyVaultReporting() {
  const cards = createLoyaltyVaultReportCards();
  const packets = createLoyaltyVaultReviewPackets();
  return {
