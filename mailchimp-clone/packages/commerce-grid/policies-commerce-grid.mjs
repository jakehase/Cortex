...
export function createCommerceGridPolicies(overrides = {}) {
...
export function validateCommerceGridPolicies(policies = createCommerceGridPolicies()) {
  const issues = [];
...
export function summarizeCommerceGridPolicies(policies = createCommerceGridPolicies()) {
  return {
...
export function createCommerceGridEscalationDeck(policies = createCommerceGridPolicies()) {
