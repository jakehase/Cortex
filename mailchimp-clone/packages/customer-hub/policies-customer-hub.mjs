...
export function createCustomerHubPolicies(overrides = {}) {
...
export function validateCustomerHubPolicies(policies = createCustomerHubPolicies()) {
  const issues = [];
...
export function summarizeCustomerHubPolicies(policies = createCustomerHubPolicies()) {
  return {
...
export function createCustomerHubEscalationDeck(policies = createCustomerHubPolicies()) {
