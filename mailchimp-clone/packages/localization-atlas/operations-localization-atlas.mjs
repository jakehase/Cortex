...
export function createLocalizationAtlasOperationsBoard() {
...
export function createLocalizationAtlasShiftChecklist() {
...
export function createLocalizationAtlasIncidentDeck() {
