...
export function createLocalizationAtlasAnalyticsTimeline() {
...
export function createLocalizationAtlasForecastEnvelope() {
...
export function createLocalizationAtlasExceptionLedger() {
...
export function summarizeLocalizationAtlasAnalytics() {
  const timeline = createLocalizationAtlasAnalyticsTimeline();
  const forecast = createLocalizationAtlasForecastEnvelope();
  return {
