...
export function createLocalizationAtlasAuditTrail() {
...
export function createLocalizationAtlasEvidenceManifest() {
...
export function createLocalizationAtlasReadinessAttestation() {
  const auditTrail = createLocalizationAtlasAuditTrail();
  return {
