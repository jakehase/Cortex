...
export function createIntegrationsAtlasPolicies(overrides = {}) {
...
export function validateIntegrationsAtlasPolicies(policies = createIntegrationsAtlasPolicies()) {
  const issues = [];
...
export function summarizeIntegrationsAtlasPolicies(policies = createIntegrationsAtlasPolicies()) {
  return {
...
export function createIntegrationsAtlasEscalationDeck(policies = createIntegrationsAtlasPolicies()) {
