...
export function createIntegrationsAtlasPlaybooks() {
...
export function createIntegrationsAtlasDecisionDeck() {
...
export function createIntegrationsAtlasEscalationMoments() {
