...
export function createIntegrationsAtlasAnalyticsTimeline() {
...
export function createIntegrationsAtlasForecastEnvelope() {
...
export function createIntegrationsAtlasExceptionLedger() {
...
export function summarizeIntegrationsAtlasAnalytics() {
  const timeline = createIntegrationsAtlasAnalyticsTimeline();
  const forecast = createIntegrationsAtlasForecastEnvelope();
  return {
