...
export function createAudienceDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceDossierWorkspace(workspace = createAudienceDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceDossierNarratives(workspace = createAudienceDossierWorkspace()) {
...
export function createAudienceDossierCoverageGrid(workspace = createAudienceDossierWorkspace()) {
