...
export function createAudienceDossierReportCards() {
...
export function createAudienceDossierReviewPackets() {
...
export function summarizeAudienceDossierReporting() {
  const cards = createAudienceDossierReportCards();
  const packets = createAudienceDossierReviewPackets();
  return {
