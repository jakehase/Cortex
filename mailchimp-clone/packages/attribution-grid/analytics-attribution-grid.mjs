...
export function createAttributionGridAnalyticsTimeline() {
...
export function createAttributionGridForecastEnvelope() {
...
export function createAttributionGridExceptionLedger() {
...
export function summarizeAttributionGridAnalytics() {
  const timeline = createAttributionGridAnalyticsTimeline();
  const forecast = createAttributionGridForecastEnvelope();
  return {
