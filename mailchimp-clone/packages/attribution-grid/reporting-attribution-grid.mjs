...
export function createAttributionGridReportCards() {
...
export function createAttributionGridReviewPackets() {
...
export function summarizeAttributionGridReporting() {
  const cards = createAttributionGridReportCards();
  const packets = createAttributionGridReviewPackets();
  return {
