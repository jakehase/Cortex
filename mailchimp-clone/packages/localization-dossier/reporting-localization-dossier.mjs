...
export function createLocalizationDossierReportCards() {
...
export function createLocalizationDossierReviewPackets() {
...
export function summarizeLocalizationDossierReporting() {
  const cards = createLocalizationDossierReportCards();
  const packets = createLocalizationDossierReviewPackets();
  return {
