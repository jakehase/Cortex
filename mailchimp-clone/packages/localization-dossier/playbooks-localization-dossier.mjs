...
export function createLocalizationDossierPlaybooks() {
...
export function createLocalizationDossierDecisionDeck() {
...
export function createLocalizationDossierEscalationMoments() {
