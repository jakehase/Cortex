...
export function createLocalizationDossierOperationsBoard() {
...
export function createLocalizationDossierShiftChecklist() {
...
export function createLocalizationDossierIncidentDeck() {
