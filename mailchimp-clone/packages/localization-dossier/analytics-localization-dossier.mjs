...
export function createLocalizationDossierAnalyticsTimeline() {
...
export function createLocalizationDossierForecastEnvelope() {
...
export function createLocalizationDossierExceptionLedger() {
...
export function summarizeLocalizationDossierAnalytics() {
  const timeline = createLocalizationDossierAnalyticsTimeline();
  const forecast = createLocalizationDossierForecastEnvelope();
  return {
