...
export function createLocalizationDossierAuditTrail() {
...
export function createLocalizationDossierEvidenceManifest() {
...
export function createLocalizationDossierReadinessAttestation() {
  const auditTrail = createLocalizationDossierAuditTrail();
  return {
