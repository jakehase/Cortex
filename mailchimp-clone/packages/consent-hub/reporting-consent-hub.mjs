...
export function createConsentHubReportCards() {
...
export function createConsentHubReviewPackets() {
...
export function summarizeConsentHubReporting() {
  const cards = createConsentHubReportCards();
  const packets = createConsentHubReviewPackets();
  return {
