...
export function createChannelIndexAuditTrail() {
...
export function createChannelIndexEvidenceManifest() {
...
export function createChannelIndexReadinessAttestation() {
  const auditTrail = createChannelIndexAuditTrail();
  return {
