...
export function createChannelIndexReportCards() {
...
export function createChannelIndexReviewPackets() {
...
export function summarizeChannelIndexReporting() {
  const cards = createChannelIndexReportCards();
  const packets = createChannelIndexReviewPackets();
  return {
