...
export function createChannelIndexPolicies(overrides = {}) {
...
export function validateChannelIndexPolicies(policies = createChannelIndexPolicies()) {
  const issues = [];
...
export function summarizeChannelIndexPolicies(policies = createChannelIndexPolicies()) {
  return {
...
export function createChannelIndexEscalationDeck(policies = createChannelIndexPolicies()) {
