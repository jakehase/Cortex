const MODULE = {
  ...
  "routeSegment": "index",
  "title": "Channel Index",
  "focus": "Channel Index covers channel operating models, readiness coverage, and mix governance through searchable summaries and coverage catalogs.",
...
export function createChannelIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelIndexWorkspace(workspace = createChannelIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelIndexNarratives(workspace = createChannelIndexWorkspace()) {
...
export function createChannelIndexCoverageGrid(workspace = createChannelIndexWorkspace()) {
