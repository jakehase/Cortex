...
export function createConsentWatchtowerPolicies(overrides = {}) {
...
export function validateConsentWatchtowerPolicies(policies = createConsentWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeConsentWatchtowerPolicies(policies = createConsentWatchtowerPolicies()) {
  return {
...
export function createConsentWatchtowerEscalationDeck(policies = createConsentWatchtowerPolicies()) {
