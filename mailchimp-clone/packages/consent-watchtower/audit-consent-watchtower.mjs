...
export function createConsentWatchtowerAuditTrail() {
...
export function createConsentWatchtowerEvidenceManifest() {
...
export function createConsentWatchtowerReadinessAttestation() {
  const auditTrail = createConsentWatchtowerAuditTrail();
  return {
