...
export function createCommerceLedgerReportCards() {
...
export function createCommerceLedgerReviewPackets() {
...
export function summarizeCommerceLedgerReporting() {
  const cards = createCommerceLedgerReportCards();
  const packets = createCommerceLedgerReviewPackets();
  return {
