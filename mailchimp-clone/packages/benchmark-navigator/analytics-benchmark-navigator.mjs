...
export function createBenchmarkNavigatorAnalyticsTimeline() {
...
export function createBenchmarkNavigatorForecastEnvelope() {
...
export function createBenchmarkNavigatorExceptionLedger() {
...
export function summarizeBenchmarkNavigatorAnalytics() {
  const timeline = createBenchmarkNavigatorAnalyticsTimeline();
  const forecast = createBenchmarkNavigatorForecastEnvelope();
  return {
