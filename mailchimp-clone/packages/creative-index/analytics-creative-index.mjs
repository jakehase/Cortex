...
export function createCreativeIndexAnalyticsTimeline() {
...
export function createCreativeIndexForecastEnvelope() {
...
export function createCreativeIndexExceptionLedger() {
...
export function summarizeCreativeIndexAnalytics() {
  const timeline = createCreativeIndexAnalyticsTimeline();
  const forecast = createCreativeIndexForecastEnvelope();
  return {
