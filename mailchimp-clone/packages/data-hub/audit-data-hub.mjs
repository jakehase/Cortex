...
export function createDataHubAuditTrail() {
...
export function createDataHubEvidenceManifest() {
...
export function createDataHubReadinessAttestation() {
  const auditTrail = createDataHubAuditTrail();
  return {
