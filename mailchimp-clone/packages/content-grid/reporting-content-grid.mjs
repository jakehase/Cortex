...
export function createContentGridReportCards() {
...
export function createContentGridReviewPackets() {
...
export function summarizeContentGridReporting() {
  const cards = createContentGridReportCards();
  const packets = createContentGridReviewPackets();
  return {
