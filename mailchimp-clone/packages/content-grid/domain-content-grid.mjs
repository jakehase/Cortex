const MODULE = {
  ...
  "routeSegment": "grid",
  "title": "Content Grid",
  "focus": "Content Grid covers content operations, packaging, and channel-specific delivery shape through portfolio views and cross-workspace rollups.",
...
export function createContentGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentGridWorkspace(workspace = createContentGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentGridNarratives(workspace = createContentGridWorkspace()) {
...
export function createContentGridCoverageGrid(workspace = createContentGridWorkspace()) {
