...
export function createDataFoundryReportCards() {
...
export function createDataFoundryReviewPackets() {
...
export function summarizeDataFoundryReporting() {
  const cards = createDataFoundryReportCards();
  const packets = createDataFoundryReviewPackets();
  return {
