...
export function createExperimentationNotebookAuditTrail() {
...
export function createExperimentationNotebookEvidenceManifest() {
...
export function createExperimentationNotebookReadinessAttestation() {
  const auditTrail = createExperimentationNotebookAuditTrail();
  return {
