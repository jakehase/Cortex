...
export function createBenchmarkFoundryOperationsBoard() {
...
export function createBenchmarkFoundryShiftChecklist() {
...
export function createBenchmarkFoundryIncidentDeck() {
