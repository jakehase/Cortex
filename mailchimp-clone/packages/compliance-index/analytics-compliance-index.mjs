...
export function createComplianceIndexAnalyticsTimeline() {
...
export function createComplianceIndexForecastEnvelope() {
...
export function createComplianceIndexExceptionLedger() {
...
export function summarizeComplianceIndexAnalytics() {
  const timeline = createComplianceIndexAnalyticsTimeline();
  const forecast = createComplianceIndexForecastEnvelope();
  return {
