...
export function createAutomationExchangeOperationsBoard() {
...
export function createAutomationExchangeShiftChecklist() {
...
export function createAutomationExchangeIncidentDeck() {
