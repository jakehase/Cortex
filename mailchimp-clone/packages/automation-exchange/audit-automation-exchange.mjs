...
export function createAutomationExchangeAuditTrail() {
...
export function createAutomationExchangeEvidenceManifest() {
...
export function createAutomationExchangeReadinessAttestation() {
  const auditTrail = createAutomationExchangeAuditTrail();
  return {
