...
export function createDataExchangeReportCards() {
...
export function createDataExchangeReviewPackets() {
...
export function summarizeDataExchangeReporting() {
  const cards = createDataExchangeReportCards();
  const packets = createDataExchangeReviewPackets();
  return {
