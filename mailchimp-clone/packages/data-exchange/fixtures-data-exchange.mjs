...
export function createDataExchangeFixtures() {
  return {
    accounts: [
...
export function summarizeDataExchangeFixtures(fixtures = createDataExchangeFixtures()) {
  return {
...
export function createDataExchangeDemoInputs() {
  return {
