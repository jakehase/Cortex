...
export function createDataExchangeAuditTrail() {
...
export function createDataExchangeEvidenceManifest() {
...
export function createDataExchangeReadinessAttestation() {
  const auditTrail = createDataExchangeAuditTrail();
  return {
