...
export function createEcommerceStudioOperationsBoard() {
...
export function createEcommerceStudioShiftChecklist() {
...
export function createEcommerceStudioIncidentDeck() {
