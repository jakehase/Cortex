...
export function createCommerceConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeCommerceConsoleFixtures(fixtures = createCommerceConsoleFixtures()) {
  return {
...
export function createCommerceConsoleDemoInputs() {
  return {
