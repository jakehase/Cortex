...
export function createCommerceConsolePolicies(overrides = {}) {
...
export function validateCommerceConsolePolicies(policies = createCommerceConsolePolicies()) {
  const issues = [];
...
export function summarizeCommerceConsolePolicies(policies = createCommerceConsolePolicies()) {
  return {
...
export function createCommerceConsoleEscalationDeck(policies = createCommerceConsolePolicies()) {
