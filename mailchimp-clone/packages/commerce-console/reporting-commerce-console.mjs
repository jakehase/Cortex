...
export function createCommerceConsoleReportCards() {
...
export function createCommerceConsoleReviewPackets() {
...
export function summarizeCommerceConsoleReporting() {
  const cards = createCommerceConsoleReportCards();
  const packets = createCommerceConsoleReviewPackets();
  return {
