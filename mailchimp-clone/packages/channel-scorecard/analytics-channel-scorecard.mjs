...
export function createChannelScorecardAnalyticsTimeline() {
...
export function createChannelScorecardForecastEnvelope() {
...
export function createChannelScorecardExceptionLedger() {
...
export function summarizeChannelScorecardAnalytics() {
  const timeline = createChannelScorecardAnalyticsTimeline();
  const forecast = createChannelScorecardForecastEnvelope();
  return {
