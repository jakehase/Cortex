...
export function createCollaborationHubPolicies(overrides = {}) {
...
export function validateCollaborationHubPolicies(policies = createCollaborationHubPolicies()) {
  const issues = [];
...
export function summarizeCollaborationHubPolicies(policies = createCollaborationHubPolicies()) {
  return {
...
export function createCollaborationHubEscalationDeck(policies = createCollaborationHubPolicies()) {
