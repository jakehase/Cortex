...
export function createBillingCockpitAnalyticsTimeline() {
...
export function createBillingCockpitForecastEnvelope() {
...
export function createBillingCockpitExceptionLedger() {
...
export function summarizeBillingCockpitAnalytics() {
  const timeline = createBillingCockpitAnalyticsTimeline();
  const forecast = createBillingCockpitForecastEnvelope();
  return {
