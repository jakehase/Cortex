...
export function createBillingCockpitReportCards() {
...
export function createBillingCockpitReviewPackets() {
...
export function summarizeBillingCockpitReporting() {
  const cards = createBillingCockpitReportCards();
  const packets = createBillingCockpitReviewPackets();
  return {
