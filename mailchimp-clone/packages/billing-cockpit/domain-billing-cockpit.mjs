...
export function createBillingCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingCockpitWorkspace(workspace = createBillingCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingCockpitNarratives(workspace = createBillingCockpitWorkspace()) {
...
export function createBillingCockpitCoverageGrid(workspace = createBillingCockpitWorkspace()) {
