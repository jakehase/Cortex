...
export function createBillingCockpitPolicies(overrides = {}) {
...
export function validateBillingCockpitPolicies(policies = createBillingCockpitPolicies()) {
  const issues = [];
...
export function summarizeBillingCockpitPolicies(policies = createBillingCockpitPolicies()) {
  return {
...
export function createBillingCockpitEscalationDeck(policies = createBillingCockpitPolicies()) {
