...
export function createAdvocacyAdvisorAuditTrail() {
...
export function createAdvocacyAdvisorEvidenceManifest() {
...
export function createAdvocacyAdvisorReadinessAttestation() {
  const auditTrail = createAdvocacyAdvisorAuditTrail();
  return {
