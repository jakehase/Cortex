...
export function createAdvocacyAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeAdvocacyAdvisorFixtures(fixtures = createAdvocacyAdvisorFixtures()) {
  return {
...
export function createAdvocacyAdvisorDemoInputs() {
  return {
