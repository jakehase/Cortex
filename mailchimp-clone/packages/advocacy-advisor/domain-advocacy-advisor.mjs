...
export function createAdvocacyAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyAdvisorWorkspace(workspace = createAdvocacyAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyAdvisorNarratives(workspace = createAdvocacyAdvisorWorkspace()) {
...
export function createAdvocacyAdvisorCoverageGrid(workspace = createAdvocacyAdvisorWorkspace()) {
