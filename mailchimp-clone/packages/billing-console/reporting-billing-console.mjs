...
export function createBillingConsoleReportCards() {
...
export function createBillingConsoleReviewPackets() {
...
export function summarizeBillingConsoleReporting() {
  const cards = createBillingConsoleReportCards();
  const packets = createBillingConsoleReviewPackets();
  return {
