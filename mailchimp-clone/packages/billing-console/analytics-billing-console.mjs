...
export function createBillingConsoleAnalyticsTimeline() {
...
export function createBillingConsoleForecastEnvelope() {
...
export function createBillingConsoleExceptionLedger() {
...
export function summarizeBillingConsoleAnalytics() {
  const timeline = createBillingConsoleAnalyticsTimeline();
  const forecast = createBillingConsoleForecastEnvelope();
  return {
