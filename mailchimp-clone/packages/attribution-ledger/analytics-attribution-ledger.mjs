...
export function createAttributionLedgerAnalyticsTimeline() {
...
export function createAttributionLedgerForecastEnvelope() {
...
export function createAttributionLedgerExceptionLedger() {
...
export function summarizeAttributionLedgerAnalytics() {
  const timeline = createAttributionLedgerAnalyticsTimeline();
  const forecast = createAttributionLedgerForecastEnvelope();
  return {
