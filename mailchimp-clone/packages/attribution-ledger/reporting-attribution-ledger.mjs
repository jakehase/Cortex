...
export function createAttributionLedgerReportCards() {
...
export function createAttributionLedgerReviewPackets() {
...
export function summarizeAttributionLedgerReporting() {
  const cards = createAttributionLedgerReportCards();
  const packets = createAttributionLedgerReviewPackets();
  return {
