...
export function createAudienceWatchtowerOperationsBoard() {
...
export function createAudienceWatchtowerShiftChecklist() {
...
export function createAudienceWatchtowerIncidentDeck() {
