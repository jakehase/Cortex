...
export function createAudienceWatchtowerAuditTrail() {
...
export function createAudienceWatchtowerEvidenceManifest() {
...
export function createAudienceWatchtowerReadinessAttestation() {
  const auditTrail = createAudienceWatchtowerAuditTrail();
  return {
