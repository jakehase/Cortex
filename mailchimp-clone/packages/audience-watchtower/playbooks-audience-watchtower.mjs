...
export function createAudienceWatchtowerPlaybooks() {
...
export function createAudienceWatchtowerDecisionDeck() {
...
export function createAudienceWatchtowerEscalationMoments() {
