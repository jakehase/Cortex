...
export function createCustomerLedgerReportCards() {
...
export function createCustomerLedgerReviewPackets() {
...
export function summarizeCustomerLedgerReporting() {
  const cards = createCustomerLedgerReportCards();
  const packets = createCustomerLedgerReviewPackets();
  return {
