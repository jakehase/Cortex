...
export function createCampaignAdvisorOperationsBoard() {
...
export function createCampaignAdvisorShiftChecklist() {
...
export function createCampaignAdvisorIncidentDeck() {
