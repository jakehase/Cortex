...
export function createCampaignAdvisorPolicies(overrides = {}) {
...
export function validateCampaignAdvisorPolicies(policies = createCampaignAdvisorPolicies()) {
  const issues = [];
...
export function summarizeCampaignAdvisorPolicies(policies = createCampaignAdvisorPolicies()) {
  return {
...
export function createCampaignAdvisorEscalationDeck(policies = createCampaignAdvisorPolicies()) {
