...
export function createCampaignAdvisorAnalyticsTimeline() {
...
export function createCampaignAdvisorForecastEnvelope() {
...
export function createCampaignAdvisorExceptionLedger() {
...
export function summarizeCampaignAdvisorAnalytics() {
  const timeline = createCampaignAdvisorAnalyticsTimeline();
  const forecast = createCampaignAdvisorForecastEnvelope();
  return {
