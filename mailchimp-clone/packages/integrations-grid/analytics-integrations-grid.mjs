...
export function createIntegrationsGridAnalyticsTimeline() {
...
export function createIntegrationsGridForecastEnvelope() {
...
export function createIntegrationsGridExceptionLedger() {
...
export function summarizeIntegrationsGridAnalytics() {
  const timeline = createIntegrationsGridAnalyticsTimeline();
  const forecast = createIntegrationsGridForecastEnvelope();
  return {
