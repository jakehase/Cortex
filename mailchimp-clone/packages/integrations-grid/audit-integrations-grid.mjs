...
export function createIntegrationsGridAuditTrail() {
...
export function createIntegrationsGridEvidenceManifest() {
...
export function createIntegrationsGridReadinessAttestation() {
  const auditTrail = createIntegrationsGridAuditTrail();
  return {
