...
export function createLocalizationHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationHubWorkspace(workspace = createLocalizationHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationHubNarratives(workspace = createLocalizationHubWorkspace()) {
...
export function createLocalizationHubCoverageGrid(workspace = createLocalizationHubWorkspace()) {
