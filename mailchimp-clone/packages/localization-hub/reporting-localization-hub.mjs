...
export function createLocalizationHubReportCards() {
...
export function createLocalizationHubReviewPackets() {
...
export function summarizeLocalizationHubReporting() {
  const cards = createLocalizationHubReportCards();
  const packets = createLocalizationHubReviewPackets();
  return {
