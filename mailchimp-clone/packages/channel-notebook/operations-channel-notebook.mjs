...
export function createChannelNotebookOperationsBoard() {
...
export function createChannelNotebookShiftChecklist() {
...
export function createChannelNotebookIncidentDeck() {
