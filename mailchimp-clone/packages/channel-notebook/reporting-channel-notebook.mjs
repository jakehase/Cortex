...
export function createChannelNotebookReportCards() {
...
export function createChannelNotebookReviewPackets() {
...
export function summarizeChannelNotebookReporting() {
  const cards = createChannelNotebookReportCards();
  const packets = createChannelNotebookReviewPackets();
  return {
