...
export function createChannelNotebookAnalyticsTimeline() {
...
export function createChannelNotebookForecastEnvelope() {
...
export function createChannelNotebookExceptionLedger() {
...
export function summarizeChannelNotebookAnalytics() {
  const timeline = createChannelNotebookAnalyticsTimeline();
  const forecast = createChannelNotebookForecastEnvelope();
  return {
