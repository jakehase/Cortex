...
export function createChannelNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelNotebookWorkspace(workspace = createChannelNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelNotebookNarratives(workspace = createChannelNotebookWorkspace()) {
...
export function createChannelNotebookCoverageGrid(workspace = createChannelNotebookWorkspace()) {
