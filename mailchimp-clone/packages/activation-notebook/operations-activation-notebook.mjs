...
export function createActivationNotebookOperationsBoard() {
...
export function createActivationNotebookShiftChecklist() {
...
export function createActivationNotebookIncidentDeck() {
