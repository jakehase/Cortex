...
export function createExperimentationGridReportCards() {
...
export function createExperimentationGridReviewPackets() {
...
export function summarizeExperimentationGridReporting() {
  const cards = createExperimentationGridReportCards();
  const packets = createExperimentationGridReviewPackets();
  return {
