const MODULE = {
  "id": "experimentation-grid",
  "ordinal": 426,
  "domain": "experimentation",
  "surfaceId": "grid",
  "surfaceTitle": "Grid",
  "routeSegment": "grid",
  "title": "Experimentation Grid",
  "focus": "Experimentation Grid covers test planning, variant analysis, and decision velocity through portfolio views and cross-workspace rollups.",
  ...
  "tags": [
    ...
    "grid",
    "intelligence",
    "experimentation-grid-wave-seven"
  ]
};
...
export function createExperimentationGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationGridWorkspace(workspace = createExperimentationGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationGridNarratives(workspace = createExperimentationGridWorkspace()) {
...
export function createExperimentationGridCoverageGrid(workspace = createExperimentationGridWorkspace()) {
