...
export function createComplianceWatchtowerOperationsBoard() {
...
export function createComplianceWatchtowerShiftChecklist() {
...
export function createComplianceWatchtowerIncidentDeck() {
