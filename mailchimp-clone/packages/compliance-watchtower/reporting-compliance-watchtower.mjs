...
export function createComplianceWatchtowerReportCards() {
...
export function createComplianceWatchtowerReviewPackets() {
...
export function summarizeComplianceWatchtowerReporting() {
  const cards = createComplianceWatchtowerReportCards();
  const packets = createComplianceWatchtowerReviewPackets();
  return {
