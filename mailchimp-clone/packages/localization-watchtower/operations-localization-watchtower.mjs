...
export function createLocalizationWatchtowerOperationsBoard() {
...
export function createLocalizationWatchtowerShiftChecklist() {
...
export function createLocalizationWatchtowerIncidentDeck() {
