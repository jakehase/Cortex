...
export function createLocalizationWatchtowerAnalyticsTimeline() {
...
export function createLocalizationWatchtowerForecastEnvelope() {
...
export function createLocalizationWatchtowerExceptionLedger() {
...
export function summarizeLocalizationWatchtowerAnalytics() {
  const timeline = createLocalizationWatchtowerAnalyticsTimeline();
  const forecast = createLocalizationWatchtowerForecastEnvelope();
  return {
