...
export function createLocalizationWatchtowerPlaybooks() {
...
export function createLocalizationWatchtowerDecisionDeck() {
...
export function createLocalizationWatchtowerEscalationMoments() {
