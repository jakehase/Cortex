...
export function createLocalizationWatchtowerAuditTrail() {
...
export function createLocalizationWatchtowerEvidenceManifest() {
...
export function createLocalizationWatchtowerReadinessAttestation() {
  const auditTrail = createLocalizationWatchtowerAuditTrail();
  return {
