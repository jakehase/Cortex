...
export function createExperimentationAtlasAnalyticsTimeline() {
...
export function createExperimentationAtlasForecastEnvelope() {
...
export function createExperimentationAtlasExceptionLedger() {
...
export function summarizeExperimentationAtlasAnalytics() {
  const timeline = createExperimentationAtlasAnalyticsTimeline();
  const forecast = createExperimentationAtlasForecastEnvelope();
  return {
