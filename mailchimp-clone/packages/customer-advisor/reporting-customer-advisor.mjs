...
export function createCustomerAdvisorReportCards() {
...
export function createCustomerAdvisorReviewPackets() {
...
export function summarizeCustomerAdvisorReporting() {
  const cards = createCustomerAdvisorReportCards();
  const packets = createCustomerAdvisorReviewPackets();
  return {
