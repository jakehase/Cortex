...
export function createLocalizationNotebookAuditTrail() {
...
export function createLocalizationNotebookEvidenceManifest() {
...
export function createLocalizationNotebookReadinessAttestation() {
  const auditTrail = createLocalizationNotebookAuditTrail();
  return {
