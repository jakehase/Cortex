...
export function createLocalizationNotebookAnalyticsTimeline() {
...
export function createLocalizationNotebookForecastEnvelope() {
...
export function createLocalizationNotebookExceptionLedger() {
...
export function summarizeLocalizationNotebookAnalytics() {
  const timeline = createLocalizationNotebookAnalyticsTimeline();
  const forecast = createLocalizationNotebookForecastEnvelope();
  return {
