...
export function createAudienceIndexReportCards() {
...
export function createAudienceIndexReviewPackets() {
...
export function summarizeAudienceIndexReporting() {
  const cards = createAudienceIndexReportCards();
  const packets = createAudienceIndexReviewPackets();
  return {
