...
export function createAudienceIndexPolicies(overrides = {}) {
...
export function validateAudienceIndexPolicies(policies = createAudienceIndexPolicies()) {
  const issues = [];
...
export function summarizeAudienceIndexPolicies(policies = createAudienceIndexPolicies()) {
  return {
...
export function createAudienceIndexEscalationDeck(policies = createAudienceIndexPolicies()) {
