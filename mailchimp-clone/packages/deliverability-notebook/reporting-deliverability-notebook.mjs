...
export function createDeliverabilityNotebookReportCards() {
...
export function createDeliverabilityNotebookReviewPackets() {
...
export function summarizeDeliverabilityNotebookReporting() {
  const cards = createDeliverabilityNotebookReportCards();
  const packets = createDeliverabilityNotebookReviewPackets();
  return {
