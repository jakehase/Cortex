...
export function createDeliverabilityNotebookAuditTrail() {
...
export function createDeliverabilityNotebookEvidenceManifest() {
...
export function createDeliverabilityNotebookReadinessAttestation() {
  const auditTrail = createDeliverabilityNotebookAuditTrail();
  return {
