...
export function createDeliverabilityNotebookAnalyticsTimeline() {
...
export function createDeliverabilityNotebookForecastEnvelope() {
...
export function createDeliverabilityNotebookExceptionLedger() {
...
export function summarizeDeliverabilityNotebookAnalytics() {
  const timeline = createDeliverabilityNotebookAnalyticsTimeline();
  const forecast = createDeliverabilityNotebookForecastEnvelope();
  return {
