...
export function createChannelLedgerFixtures() {
  return {
    accounts: [
...
export function summarizeChannelLedgerFixtures(fixtures = createChannelLedgerFixtures()) {
  return {
...
export function createChannelLedgerDemoInputs() {
  return {
