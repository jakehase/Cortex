...
export function createChannelLedgerReportCards() {
...
export function createChannelLedgerReviewPackets() {
...
export function summarizeChannelLedgerReporting() {
  const cards = createChannelLedgerReportCards();
  const packets = createChannelLedgerReviewPackets();
  return {
