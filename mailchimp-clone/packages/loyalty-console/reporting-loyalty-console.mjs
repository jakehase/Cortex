...
export function createLoyaltyConsoleReportCards() {
...
export function createLoyaltyConsoleReviewPackets() {
...
export function summarizeLoyaltyConsoleReporting() {
  const cards = createLoyaltyConsoleReportCards();
  const packets = createLoyaltyConsoleReviewPackets();
  return {
