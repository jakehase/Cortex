...
export function createLoyaltyWorkbenchAuditTrail() {
...
export function createLoyaltyWorkbenchEvidenceManifest() {
...
export function createLoyaltyWorkbenchReadinessAttestation() {
  const auditTrail = createLoyaltyWorkbenchAuditTrail();
  return {
