...
export function createLoyaltyWorkbenchReportCards() {
...
export function createLoyaltyWorkbenchReviewPackets() {
...
export function summarizeLoyaltyWorkbenchReporting() {
  const cards = createLoyaltyWorkbenchReportCards();
  const packets = createLoyaltyWorkbenchReviewPackets();
  return {
