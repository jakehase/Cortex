...
export function createBillingExchangeReportCards() {
...
export function createBillingExchangeReviewPackets() {
...
export function summarizeBillingExchangeReporting() {
  const cards = createBillingExchangeReportCards();
  const packets = createBillingExchangeReviewPackets();
  return {
