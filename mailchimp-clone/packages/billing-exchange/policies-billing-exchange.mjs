...
export function createBillingExchangePolicies(overrides = {}) {
...
export function validateBillingExchangePolicies(policies = createBillingExchangePolicies()) {
  const issues = [];
...
export function summarizeBillingExchangePolicies(policies = createBillingExchangePolicies()) {
  return {
...
export function createBillingExchangeEscalationDeck(policies = createBillingExchangePolicies()) {
