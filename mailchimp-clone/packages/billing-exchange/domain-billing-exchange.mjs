...
export function createBillingExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingExchangeWorkspace(workspace = createBillingExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingExchangeNarratives(workspace = createBillingExchangeWorkspace()) {
...
export function createBillingExchangeCoverageGrid(workspace = createBillingExchangeWorkspace()) {
