...
export function createLoyaltyPlannerAuditTrail() {
...
export function createLoyaltyPlannerEvidenceManifest() {
...
export function createLoyaltyPlannerReadinessAttestation() {
  const auditTrail = createLoyaltyPlannerAuditTrail();
  return {
