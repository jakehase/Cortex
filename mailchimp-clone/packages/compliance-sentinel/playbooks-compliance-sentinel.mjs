...
export function createComplianceSentinelPlaybooks() {
...
export function createComplianceSentinelDecisionDeck() {
...
export function createComplianceSentinelEscalationMoments() {
