...
export function createComplianceSentinelPolicies(overrides = {}) {
...
export function validateComplianceSentinelPolicies(policies = createComplianceSentinelPolicies()) {
  const issues = [];
...
export function summarizeComplianceSentinelPolicies(policies = createComplianceSentinelPolicies()) {
  return {
...
export function createComplianceSentinelEscalationDeck(policies = createComplianceSentinelPolicies()) {
