...
export function createAnalyticsPlannerReportCards() {
...
export function createAnalyticsPlannerReviewPackets() {
...
export function summarizeAnalyticsPlannerReporting() {
  const cards = createAnalyticsPlannerReportCards();
  const packets = createAnalyticsPlannerReviewPackets();
  return {
