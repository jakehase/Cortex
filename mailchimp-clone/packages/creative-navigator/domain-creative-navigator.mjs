const MODULE = {
  ...
  "title": "Creative Navigator",
  "focus": "Creative Navigator covers creative QA, variation readiness, and review-loop visibility through journey guidance and directional controls.",
...
export function createCreativeNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCreativeNavigatorWorkspace(workspace = createCreativeNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createCreativeNavigatorNarratives(workspace = createCreativeNavigatorWorkspace()) {
...
export function createCreativeNavigatorCoverageGrid(workspace = createCreativeNavigatorWorkspace()) {
