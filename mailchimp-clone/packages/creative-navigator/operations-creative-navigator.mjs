...
export function createCreativeNavigatorOperationsBoard() {
...
export function createCreativeNavigatorShiftChecklist() {
...
export function createCreativeNavigatorIncidentDeck() {
