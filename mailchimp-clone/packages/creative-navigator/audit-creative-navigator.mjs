...
export function createCreativeNavigatorAuditTrail() {
...
export function createCreativeNavigatorEvidenceManifest() {
...
export function createCreativeNavigatorReadinessAttestation() {
  const auditTrail = createCreativeNavigatorAuditTrail();
  return {
