...
export function createCreativeNavigatorPlaybooks() {
...
export function createCreativeNavigatorDecisionDeck() {
...
export function createCreativeNavigatorEscalationMoments() {
