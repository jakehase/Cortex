...
export function createCreativeNavigatorReportCards() {
...
export function createCreativeNavigatorReviewPackets() {
...
export function summarizeCreativeNavigatorReporting() {
  const cards = createCreativeNavigatorReportCards();
  const packets = createCreativeNavigatorReviewPackets();
  return {
