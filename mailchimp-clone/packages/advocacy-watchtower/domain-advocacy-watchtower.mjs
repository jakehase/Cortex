...
export function createAdvocacyWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyWatchtowerWorkspace(workspace = createAdvocacyWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyWatchtowerNarratives(workspace = createAdvocacyWatchtowerWorkspace()) {
...
export function createAdvocacyWatchtowerCoverageGrid(workspace = createAdvocacyWatchtowerWorkspace()) {
