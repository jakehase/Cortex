...
export function createAdvocacyWatchtowerPlaybooks() {
...
export function createAdvocacyWatchtowerDecisionDeck() {
...
export function createAdvocacyWatchtowerEscalationMoments() {
