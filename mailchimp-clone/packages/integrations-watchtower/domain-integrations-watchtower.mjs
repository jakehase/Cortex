...
export function createIntegrationsWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsWatchtowerWorkspace(workspace = createIntegrationsWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsWatchtowerNarratives(workspace = createIntegrationsWatchtowerWorkspace()) {
...
export function createIntegrationsWatchtowerCoverageGrid(workspace = createIntegrationsWatchtowerWorkspace()) {
