...
export function createIntegrationsWatchtowerAnalyticsTimeline() {
...
export function createIntegrationsWatchtowerForecastEnvelope() {
...
export function createIntegrationsWatchtowerExceptionLedger() {
...
export function summarizeIntegrationsWatchtowerAnalytics() {
  const timeline = createIntegrationsWatchtowerAnalyticsTimeline();
  const forecast = createIntegrationsWatchtowerForecastEnvelope();
  return {
