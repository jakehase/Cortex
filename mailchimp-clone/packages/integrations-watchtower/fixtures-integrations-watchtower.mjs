...
export function createIntegrationsWatchtowerFixtures() {
  return {
    accounts: [
...
export function summarizeIntegrationsWatchtowerFixtures(fixtures = createIntegrationsWatchtowerFixtures()) {
  return {
...
export function createIntegrationsWatchtowerDemoInputs() {
  return {
