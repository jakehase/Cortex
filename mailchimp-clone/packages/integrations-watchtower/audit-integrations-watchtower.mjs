...
export function createIntegrationsWatchtowerAuditTrail() {
...
export function createIntegrationsWatchtowerEvidenceManifest() {
...
export function createIntegrationsWatchtowerReadinessAttestation() {
  const auditTrail = createIntegrationsWatchtowerAuditTrail();
  return {
