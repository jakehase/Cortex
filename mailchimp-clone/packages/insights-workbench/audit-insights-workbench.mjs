...
export function createInsightsWorkbenchAuditTrail() {
...
export function createInsightsWorkbenchEvidenceManifest() {
...
export function createInsightsWorkbenchReadinessAttestation() {
  const auditTrail = createInsightsWorkbenchAuditTrail();
  return {
