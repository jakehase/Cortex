...
export function createChannelNavigatorReportCards() {
...
export function createChannelNavigatorReviewPackets() {
...
export function summarizeChannelNavigatorReporting() {
  const cards = createChannelNavigatorReportCards();
  const packets = createChannelNavigatorReviewPackets();
  return {
