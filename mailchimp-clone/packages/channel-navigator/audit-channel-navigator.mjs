...
export function createChannelNavigatorAuditTrail() {
...
export function createChannelNavigatorEvidenceManifest() {
...
export function createChannelNavigatorReadinessAttestation() {
  const auditTrail = createChannelNavigatorAuditTrail();
  return {
