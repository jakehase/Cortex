...
export function createEcommerceGridReportCards() {
...
export function createEcommerceGridReviewPackets() {
...
export function summarizeEcommerceGridReporting() {
  const cards = createEcommerceGridReportCards();
  const packets = createEcommerceGridReviewPackets();
  return {
