...
export function createCommerceVaultFixtures() {
  return {
    accounts: [
...
export function summarizeCommerceVaultFixtures(fixtures = createCommerceVaultFixtures()) {
  return {
...
export function createCommerceVaultDemoInputs() {
  return {
