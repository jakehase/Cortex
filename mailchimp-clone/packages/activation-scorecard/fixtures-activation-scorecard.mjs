...
export function createActivationScorecardFixtures() {
  return {
    accounts: [
...
export function summarizeActivationScorecardFixtures(fixtures = createActivationScorecardFixtures()) {
  return {
...
export function createActivationScorecardDemoInputs() {
  return {
