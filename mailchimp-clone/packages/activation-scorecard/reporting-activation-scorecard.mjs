...
export function createActivationScorecardReportCards() {
...
export function createActivationScorecardReviewPackets() {
...
export function summarizeActivationScorecardReporting() {
  const cards = createActivationScorecardReportCards();
  const packets = createActivationScorecardReviewPackets();
  return {
