...
export function createActivationScorecardPlaybooks() {
...
export function createActivationScorecardDecisionDeck() {
...
export function createActivationScorecardEscalationMoments() {
