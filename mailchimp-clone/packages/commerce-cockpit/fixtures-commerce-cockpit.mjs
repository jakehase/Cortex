...
export function createCommerceCockpitFixtures() {
  return {
    accounts: [
...
export function summarizeCommerceCockpitFixtures(fixtures = createCommerceCockpitFixtures()) {
  return {
...
export function createCommerceCockpitDemoInputs() {
  return {
