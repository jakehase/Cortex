...
export function createCommerceCockpitPolicies(overrides = {}) {
...
export function validateCommerceCockpitPolicies(policies = createCommerceCockpitPolicies()) {
  const issues = [];
...
export function summarizeCommerceCockpitPolicies(policies = createCommerceCockpitPolicies()) {
  return {
...
export function createCommerceCockpitEscalationDeck(policies = createCommerceCockpitPolicies()) {
