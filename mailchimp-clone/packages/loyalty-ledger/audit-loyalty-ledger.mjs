...
export function createLoyaltyLedgerAuditTrail() {
...
export function createLoyaltyLedgerEvidenceManifest() {
...
export function createLoyaltyLedgerReadinessAttestation() {
  const auditTrail = createLoyaltyLedgerAuditTrail();
  return {
