...
export function createLoyaltyLedgerPolicies(overrides = {}) {
...
export function validateLoyaltyLedgerPolicies(policies = createLoyaltyLedgerPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyLedgerPolicies(policies = createLoyaltyLedgerPolicies()) {
  return {
...
export function createLoyaltyLedgerEscalationDeck(policies = createLoyaltyLedgerPolicies()) {
