...
export function createEcommerceScorecardPolicies(overrides = {}) {
...
export function validateEcommerceScorecardPolicies(policies = createEcommerceScorecardPolicies()) {
  const issues = [];
...
export function summarizeEcommerceScorecardPolicies(policies = createEcommerceScorecardPolicies()) {
  return {
...
export function createEcommerceScorecardEscalationDeck(policies = createEcommerceScorecardPolicies()) {
