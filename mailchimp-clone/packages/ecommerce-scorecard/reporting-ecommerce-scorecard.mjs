...
export function createEcommerceScorecardReportCards() {
...
export function createEcommerceScorecardReviewPackets() {
...
export function summarizeEcommerceScorecardReporting() {
  const cards = createEcommerceScorecardReportCards();
  const packets = createEcommerceScorecardReviewPackets();
  return {
