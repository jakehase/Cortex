...
export function createDataDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataDossierWorkspace(workspace = createDataDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataDossierNarratives(workspace = createDataDossierWorkspace()) {
...
export function createDataDossierCoverageGrid(workspace = createDataDossierWorkspace()) {
