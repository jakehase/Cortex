...
export function createChannelGridAuditTrail() {
...
export function createChannelGridEvidenceManifest() {
...
export function createChannelGridReadinessAttestation() {
  const auditTrail = createChannelGridAuditTrail();
  return {
