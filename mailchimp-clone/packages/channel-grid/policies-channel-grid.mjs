...
export function createChannelGridPolicies(overrides = {}) {
...
export function validateChannelGridPolicies(policies = createChannelGridPolicies()) {
  const issues = [];
...
export function summarizeChannelGridPolicies(policies = createChannelGridPolicies()) {
  return {
...
export function createChannelGridEscalationDeck(policies = createChannelGridPolicies()) {
