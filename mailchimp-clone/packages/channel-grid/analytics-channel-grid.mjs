...
export function createChannelGridAnalyticsTimeline() {
...
export function createChannelGridForecastEnvelope() {
...
export function createChannelGridExceptionLedger() {
...
export function summarizeChannelGridAnalytics() {
  const timeline = createChannelGridAnalyticsTimeline();
  const forecast = createChannelGridForecastEnvelope();
  return {
