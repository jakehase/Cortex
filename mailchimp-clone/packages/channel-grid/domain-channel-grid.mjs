const MODULE = {
  ...
  "routeSegment": "grid",
  "title": "Channel Grid",
  "focus": "Channel Grid covers channel operating models, readiness coverage, and mix governance through portfolio views and cross-workspace rollups.",
...
export function createChannelGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelGridWorkspace(workspace = createChannelGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelGridNarratives(workspace = createChannelGridWorkspace()) {
...
export function createChannelGridCoverageGrid(workspace = createChannelGridWorkspace()) {
