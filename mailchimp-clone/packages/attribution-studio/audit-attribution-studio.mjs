...
export function createAttributionStudioAuditTrail() {
...
export function createAttributionStudioEvidenceManifest() {
...
export function createAttributionStudioReadinessAttestation() {
  const auditTrail = createAttributionStudioAuditTrail();
  return {
