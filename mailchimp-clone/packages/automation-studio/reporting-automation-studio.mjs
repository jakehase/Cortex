...
export function createAutomationStudioReportCards() {
...
export function createAutomationStudioReviewPackets() {
...
export function summarizeAutomationStudioReporting() {
  const cards = createAutomationStudioReportCards();
  const packets = createAutomationStudioReviewPackets();
  return {
