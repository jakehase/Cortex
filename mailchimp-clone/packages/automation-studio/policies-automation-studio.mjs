...
export function createAutomationStudioPolicies(overrides = {}) {
...
export function validateAutomationStudioPolicies(policies = createAutomationStudioPolicies()) {
  const issues = [];
...
export function summarizeAutomationStudioPolicies(policies = createAutomationStudioPolicies()) {
  return {
...
export function createAutomationStudioEscalationDeck(policies = createAutomationStudioPolicies()) {
