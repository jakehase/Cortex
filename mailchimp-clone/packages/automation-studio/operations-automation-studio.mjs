...
export function createAutomationStudioOperationsBoard() {
...
export function createAutomationStudioShiftChecklist() {
...
export function createAutomationStudioIncidentDeck() {
