...
export function createCustomerVaultReportCards() {
...
export function createCustomerVaultReviewPackets() {
...
export function summarizeCustomerVaultReporting() {
  const cards = createCustomerVaultReportCards();
  const packets = createCustomerVaultReviewPackets();
  return {
