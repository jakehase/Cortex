...
export function createCustomerVaultPolicies(overrides = {}) {
...
export function validateCustomerVaultPolicies(policies = createCustomerVaultPolicies()) {
  const issues = [];
...
export function summarizeCustomerVaultPolicies(policies = createCustomerVaultPolicies()) {
  return {
...
export function createCustomerVaultEscalationDeck(policies = createCustomerVaultPolicies()) {
