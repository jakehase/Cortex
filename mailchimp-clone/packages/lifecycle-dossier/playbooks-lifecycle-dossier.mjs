...
export function createLifecycleDossierPlaybooks() {
...
export function createLifecycleDossierDecisionDeck() {
...
export function createLifecycleDossierEscalationMoments() {
