...
export function createLifecycleDossierOperationsBoard() {
...
export function createLifecycleDossierShiftChecklist() {
...
export function createLifecycleDossierIncidentDeck() {
