...
export function createLifecycleDossierAnalyticsTimeline() {
...
export function createLifecycleDossierForecastEnvelope() {
...
export function createLifecycleDossierExceptionLedger() {
...
export function summarizeLifecycleDossierAnalytics() {
  const timeline = createLifecycleDossierAnalyticsTimeline();
  const forecast = createLifecycleDossierForecastEnvelope();
  return {
