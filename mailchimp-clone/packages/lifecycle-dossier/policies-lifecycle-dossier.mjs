...
export function createLifecycleDossierPolicies(overrides = {}) {
...
export function validateLifecycleDossierPolicies(policies = createLifecycleDossierPolicies()) {
  const issues = [];
...
export function summarizeLifecycleDossierPolicies(policies = createLifecycleDossierPolicies()) {
  return {
...
export function createLifecycleDossierEscalationDeck(policies = createLifecycleDossierPolicies()) {
