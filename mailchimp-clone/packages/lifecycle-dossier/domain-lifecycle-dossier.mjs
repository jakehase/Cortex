...
export function createLifecycleDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleDossierWorkspace(workspace = createLifecycleDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleDossierNarratives(workspace = createLifecycleDossierWorkspace()) {
...
export function createLifecycleDossierCoverageGrid(workspace = createLifecycleDossierWorkspace()) {
