...
export function createCampaignNotebookOperationsBoard() {
...
export function createCampaignNotebookShiftChecklist() {
...
export function createCampaignNotebookIncidentDeck() {
