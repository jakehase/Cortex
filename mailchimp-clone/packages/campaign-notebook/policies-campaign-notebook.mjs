...
export function createCampaignNotebookPolicies(overrides = {}) {
...
export function validateCampaignNotebookPolicies(policies = createCampaignNotebookPolicies()) {
  const issues = [];
...
export function summarizeCampaignNotebookPolicies(policies = createCampaignNotebookPolicies()) {
  return {
...
export function createCampaignNotebookEscalationDeck(policies = createCampaignNotebookPolicies()) {
