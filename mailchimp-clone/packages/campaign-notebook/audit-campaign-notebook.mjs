...
export function createCampaignNotebookAuditTrail() {
...
export function createCampaignNotebookEvidenceManifest() {
...
export function createCampaignNotebookReadinessAttestation() {
  const auditTrail = createCampaignNotebookAuditTrail();
  return {
