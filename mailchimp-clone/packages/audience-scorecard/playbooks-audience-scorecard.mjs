...
export function createAudienceScorecardPlaybooks() {
...
export function createAudienceScorecardDecisionDeck() {
...
export function createAudienceScorecardEscalationMoments() {
