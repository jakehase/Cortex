...
export function createAudienceScorecardReportCards() {
...
export function createAudienceScorecardReviewPackets() {
...
export function summarizeAudienceScorecardReporting() {
  const cards = createAudienceScorecardReportCards();
  const packets = createAudienceScorecardReviewPackets();
  return {
