...
export function createAudienceScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceScorecardWorkspace(workspace = createAudienceScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceScorecardNarratives(workspace = createAudienceScorecardWorkspace()) {
...
export function createAudienceScorecardCoverageGrid(workspace = createAudienceScorecardWorkspace()) {
