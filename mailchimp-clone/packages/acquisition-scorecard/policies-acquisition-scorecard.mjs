...
export function createAcquisitionScorecardPolicies(overrides = {}) {
...
export function validateAcquisitionScorecardPolicies(policies = createAcquisitionScorecardPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionScorecardPolicies(policies = createAcquisitionScorecardPolicies()) {
  return {
...
export function createAcquisitionScorecardEscalationDeck(policies = createAcquisitionScorecardPolicies()) {
