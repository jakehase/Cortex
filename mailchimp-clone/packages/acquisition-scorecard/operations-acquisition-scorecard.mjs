...
export function createAcquisitionScorecardOperationsBoard() {
...
export function createAcquisitionScorecardShiftChecklist() {
...
export function createAcquisitionScorecardIncidentDeck() {
