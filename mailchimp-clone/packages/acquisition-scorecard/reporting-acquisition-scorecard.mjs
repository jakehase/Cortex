...
export function createAcquisitionScorecardReportCards() {
...
export function createAcquisitionScorecardReviewPackets() {
...
export function summarizeAcquisitionScorecardReporting() {
  const cards = createAcquisitionScorecardReportCards();
  const packets = createAcquisitionScorecardReviewPackets();
  return {
