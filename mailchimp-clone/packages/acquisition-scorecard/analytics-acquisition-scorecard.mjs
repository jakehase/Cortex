...
export function createAcquisitionScorecardAnalyticsTimeline() {
...
export function createAcquisitionScorecardForecastEnvelope() {
...
export function createAcquisitionScorecardExceptionLedger() {
...
export function summarizeAcquisitionScorecardAnalytics() {
  const timeline = createAcquisitionScorecardAnalyticsTimeline();
  const forecast = createAcquisitionScorecardForecastEnvelope();
  return {
