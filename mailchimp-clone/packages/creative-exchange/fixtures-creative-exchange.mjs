...
export function createCreativeExchangeFixtures() {
  return {
    accounts: [
...
export function summarizeCreativeExchangeFixtures(fixtures = createCreativeExchangeFixtures()) {
  return {
...
export function createCreativeExchangeDemoInputs() {
  return {
