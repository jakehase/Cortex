...
export function createCreativeExchangeAuditTrail() {
...
export function createCreativeExchangeEvidenceManifest() {
...
export function createCreativeExchangeReadinessAttestation() {
  const auditTrail = createCreativeExchangeAuditTrail();
  return {
