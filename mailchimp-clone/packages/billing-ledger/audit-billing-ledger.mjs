...
export function createBillingLedgerAuditTrail() {
...
export function createBillingLedgerEvidenceManifest() {
...
export function createBillingLedgerReadinessAttestation() {
  const auditTrail = createBillingLedgerAuditTrail();
  return {
