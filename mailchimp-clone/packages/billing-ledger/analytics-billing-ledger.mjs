...
export function createBillingLedgerAnalyticsTimeline() {
...
export function createBillingLedgerForecastEnvelope() {
...
export function createBillingLedgerExceptionLedger() {
...
export function summarizeBillingLedgerAnalytics() {
  const timeline = createBillingLedgerAnalyticsTimeline();
  const forecast = createBillingLedgerForecastEnvelope();
  return {
