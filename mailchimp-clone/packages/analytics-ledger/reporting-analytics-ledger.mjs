...
export function createAnalyticsLedgerReportCards() {
...
export function createAnalyticsLedgerReviewPackets() {
...
export function summarizeAnalyticsLedgerReporting() {
  const cards = createAnalyticsLedgerReportCards();
  const packets = createAnalyticsLedgerReviewPackets();
  return {
