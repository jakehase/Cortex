...
export function createAnalyticsLedgerAnalyticsTimeline() {
...
export function createAnalyticsLedgerForecastEnvelope() {
...
export function createAnalyticsLedgerExceptionLedger() {
...
export function summarizeAnalyticsLedgerAnalytics() {
  const timeline = createAnalyticsLedgerAnalyticsTimeline();
  const forecast = createAnalyticsLedgerForecastEnvelope();
  return {
