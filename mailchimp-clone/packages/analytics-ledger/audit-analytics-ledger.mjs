...
export function createAnalyticsLedgerAuditTrail() {
...
export function createAnalyticsLedgerEvidenceManifest() {
...
export function createAnalyticsLedgerReadinessAttestation() {
  const auditTrail = createAnalyticsLedgerAuditTrail();
  return {
