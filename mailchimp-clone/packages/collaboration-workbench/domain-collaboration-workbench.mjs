const MODULE = {
  ...
  "focus": "Collaboration Workbench covers shared ownership, approvals, and cross-functional motion through hands-on workflows and analyst tooling.",
  ...
  "tags": [
    ...
    "workbench",
    "lifecycle",
    "collaboration-workbench-wave-seven"
  ]
};
...
export function createCollaborationWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationWorkbenchWorkspace(workspace = createCollaborationWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationWorkbenchNarratives(workspace = createCollaborationWorkbenchWorkspace()) {
...
export function createCollaborationWorkbenchCoverageGrid(workspace = createCollaborationWorkbenchWorkspace()) {
