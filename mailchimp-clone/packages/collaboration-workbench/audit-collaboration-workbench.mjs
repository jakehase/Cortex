...
export function createCollaborationWorkbenchAuditTrail() {
...
export function createCollaborationWorkbenchEvidenceManifest() {
...
export function createCollaborationWorkbenchReadinessAttestation() {
  const auditTrail = createCollaborationWorkbenchAuditTrail();
  return {
