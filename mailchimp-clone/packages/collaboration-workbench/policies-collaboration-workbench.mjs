...
export function createCollaborationWorkbenchPolicies(overrides = {}) {
...
export function validateCollaborationWorkbenchPolicies(policies = createCollaborationWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeCollaborationWorkbenchPolicies(policies = createCollaborationWorkbenchPolicies()) {
  return {
...
export function createCollaborationWorkbenchEscalationDeck(policies = createCollaborationWorkbenchPolicies()) {
