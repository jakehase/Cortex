...
export function createCollaborationWorkbenchPlaybooks() {
...
export function createCollaborationWorkbenchDecisionDeck() {
...
export function createCollaborationWorkbenchEscalationMoments() {
