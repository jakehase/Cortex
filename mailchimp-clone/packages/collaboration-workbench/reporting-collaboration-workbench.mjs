...
export function createCollaborationWorkbenchReportCards() {
...
export function createCollaborationWorkbenchReviewPackets() {
...
export function summarizeCollaborationWorkbenchReporting() {
  const cards = createCollaborationWorkbenchReportCards();
  const packets = createCollaborationWorkbenchReviewPackets();
  return {
