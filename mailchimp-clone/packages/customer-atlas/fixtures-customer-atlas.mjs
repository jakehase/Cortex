...
export function createCustomerAtlasFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerAtlasFixtures(fixtures = createCustomerAtlasFixtures()) {
  return {
...
export function createCustomerAtlasDemoInputs() {
  return {
