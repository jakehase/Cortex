...
export function createLoyaltyNavigatorOperationsBoard() {
...
export function createLoyaltyNavigatorShiftChecklist() {
...
export function createLoyaltyNavigatorIncidentDeck() {
