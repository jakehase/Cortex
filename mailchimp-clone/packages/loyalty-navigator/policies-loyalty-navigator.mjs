...
export function createLoyaltyNavigatorPolicies(overrides = {}) {
...
export function validateLoyaltyNavigatorPolicies(policies = createLoyaltyNavigatorPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyNavigatorPolicies(policies = createLoyaltyNavigatorPolicies()) {
  return {
...
export function createLoyaltyNavigatorEscalationDeck(policies = createLoyaltyNavigatorPolicies()) {
