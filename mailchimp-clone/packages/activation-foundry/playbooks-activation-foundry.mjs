...
export function createActivationFoundryPlaybooks() {
...
export function createActivationFoundryDecisionDeck() {
...
export function createActivationFoundryEscalationMoments() {
