...
export function createActivationFoundryReportCards() {
...
export function createActivationFoundryReviewPackets() {
...
export function summarizeActivationFoundryReporting() {
  const cards = createActivationFoundryReportCards();
  const packets = createActivationFoundryReviewPackets();
  return {
