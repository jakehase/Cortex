const MODULE = {
  "id": "activation-foundry",
  "ordinal": 27,
  "domain": "activation",
  "surfaceId": "foundry",
  "surfaceTitle": "Foundry",
  "routeSegment": "foundry",
  "title": "Activation Foundry",
  "focus": "Activation Foundry covers onboarding readiness, first-value motion, and kickoff momentum through program building and surface composition.",
...
export function createActivationFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationFoundryWorkspace(workspace = createActivationFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationFoundryNarratives(workspace = createActivationFoundryWorkspace()) {
...
export function createActivationFoundryCoverageGrid(workspace = createActivationFoundryWorkspace()) {
