...
export function createIntegrationsScorecardPolicies(overrides = {}) {
...
export function validateIntegrationsScorecardPolicies(policies = createIntegrationsScorecardPolicies()) {
  const issues = [];
...
export function summarizeIntegrationsScorecardPolicies(policies = createIntegrationsScorecardPolicies()) {
  return {
...
export function createIntegrationsScorecardEscalationDeck(policies = createIntegrationsScorecardPolicies()) {
