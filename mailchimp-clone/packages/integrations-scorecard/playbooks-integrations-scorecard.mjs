...
export function createIntegrationsScorecardPlaybooks() {
...
export function createIntegrationsScorecardDecisionDeck() {
...
export function createIntegrationsScorecardEscalationMoments() {
