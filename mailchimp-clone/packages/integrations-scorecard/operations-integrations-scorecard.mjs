...
export function createIntegrationsScorecardOperationsBoard() {
...
export function createIntegrationsScorecardShiftChecklist() {
...
export function createIntegrationsScorecardIncidentDeck() {
