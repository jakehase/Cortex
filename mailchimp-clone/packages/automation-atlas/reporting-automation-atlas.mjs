...
export function createAutomationAtlasReportCards() {
...
export function createAutomationAtlasReviewPackets() {
...
export function summarizeAutomationAtlasReporting() {
  const cards = createAutomationAtlasReportCards();
  const packets = createAutomationAtlasReviewPackets();
  return {
