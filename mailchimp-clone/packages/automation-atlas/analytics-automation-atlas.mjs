...
export function createAutomationAtlasAnalyticsTimeline() {
...
export function createAutomationAtlasForecastEnvelope() {
...
export function createAutomationAtlasExceptionLedger() {
...
export function summarizeAutomationAtlasAnalytics() {
  const timeline = createAutomationAtlasAnalyticsTimeline();
  const forecast = createAutomationAtlasForecastEnvelope();
  return {
