...
export function createAnalyticsConsoleReportCards() {
...
export function createAnalyticsConsoleReviewPackets() {
...
export function summarizeAnalyticsConsoleReporting() {
  const cards = createAnalyticsConsoleReportCards();
  const packets = createAnalyticsConsoleReviewPackets();
  return {
