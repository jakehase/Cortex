...
export function createAnalyticsConsoleOperationsBoard() {
...
export function createAnalyticsConsoleShiftChecklist() {
...
export function createAnalyticsConsoleIncidentDeck() {
