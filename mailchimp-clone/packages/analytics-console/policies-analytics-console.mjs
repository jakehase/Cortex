...
export function createAnalyticsConsolePolicies(overrides = {}) {
...
export function validateAnalyticsConsolePolicies(policies = createAnalyticsConsolePolicies()) {
  const issues = [];
...
export function summarizeAnalyticsConsolePolicies(policies = createAnalyticsConsolePolicies()) {
  return {
...
export function createAnalyticsConsoleEscalationDeck(policies = createAnalyticsConsolePolicies()) {
