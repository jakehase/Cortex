...
export function createAnalyticsConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeAnalyticsConsoleFixtures(fixtures = createAnalyticsConsoleFixtures()) {
  return {
...
export function createAnalyticsConsoleDemoInputs() {
  return {
