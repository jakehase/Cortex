...
export function createAnalyticsConsolePlaybooks() {
...
export function createAnalyticsConsoleDecisionDeck() {
...
export function createAnalyticsConsoleEscalationMoments() {
