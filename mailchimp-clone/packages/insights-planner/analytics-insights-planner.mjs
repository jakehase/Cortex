...
export function createInsightsPlannerAnalyticsTimeline() {
...
export function createInsightsPlannerForecastEnvelope() {
...
export function createInsightsPlannerExceptionLedger() {
...
export function summarizeInsightsPlannerAnalytics() {
  const timeline = createInsightsPlannerAnalyticsTimeline();
  const forecast = createInsightsPlannerForecastEnvelope();
  return {
