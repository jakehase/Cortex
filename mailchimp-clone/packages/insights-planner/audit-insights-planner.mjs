...
export function createInsightsPlannerAuditTrail() {
...
export function createInsightsPlannerEvidenceManifest() {
...
export function createInsightsPlannerReadinessAttestation() {
  const auditTrail = createInsightsPlannerAuditTrail();
  return {
