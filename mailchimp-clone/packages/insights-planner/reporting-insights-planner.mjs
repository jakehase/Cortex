...
export function createInsightsPlannerReportCards() {
...
export function createInsightsPlannerReviewPackets() {
...
export function summarizeInsightsPlannerReporting() {
  const cards = createInsightsPlannerReportCards();
  const packets = createInsightsPlannerReviewPackets();
  return {
