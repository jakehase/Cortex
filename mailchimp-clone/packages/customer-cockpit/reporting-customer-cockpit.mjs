...
export function createCustomerCockpitReportCards() {
...
export function createCustomerCockpitReviewPackets() {
...
export function summarizeCustomerCockpitReporting() {
  const cards = createCustomerCockpitReportCards();
  const packets = createCustomerCockpitReviewPackets();
  return {
