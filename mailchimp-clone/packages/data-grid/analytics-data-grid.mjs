...
export function createDataGridAnalyticsTimeline() {
...
export function createDataGridForecastEnvelope() {
...
export function createDataGridExceptionLedger() {
...
export function summarizeDataGridAnalytics() {
  const timeline = createDataGridAnalyticsTimeline();
  const forecast = createDataGridForecastEnvelope();
  return {
