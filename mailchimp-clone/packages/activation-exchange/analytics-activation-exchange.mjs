...
export function createActivationExchangeAnalyticsTimeline() {
...
export function createActivationExchangeForecastEnvelope() {
...
export function createActivationExchangeExceptionLedger() {
...
export function summarizeActivationExchangeAnalytics() {
  const timeline = createActivationExchangeAnalyticsTimeline();
  const forecast = createActivationExchangeForecastEnvelope();
  return {
