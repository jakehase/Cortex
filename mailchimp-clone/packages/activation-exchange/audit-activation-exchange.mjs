...
export function createActivationExchangeAuditTrail() {
...
export function createActivationExchangeEvidenceManifest() {
...
export function createActivationExchangeReadinessAttestation() {
  const auditTrail = createActivationExchangeAuditTrail();
  return {
