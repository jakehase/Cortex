...
export function createActivationExchangeReportCards() {
...
export function createActivationExchangeReviewPackets() {
...
export function summarizeActivationExchangeReporting() {
  const cards = createActivationExchangeReportCards();
  const packets = createActivationExchangeReviewPackets();
  return {
