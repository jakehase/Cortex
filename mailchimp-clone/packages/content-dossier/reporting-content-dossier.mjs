...
export function createContentDossierReportCards() {
...
export function createContentDossierReviewPackets() {
...
export function summarizeContentDossierReporting() {
  const cards = createContentDossierReportCards();
  const packets = createContentDossierReviewPackets();
  return {
