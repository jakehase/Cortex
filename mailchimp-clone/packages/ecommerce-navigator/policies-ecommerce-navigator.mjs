...
export function createEcommerceNavigatorPolicies(overrides = {}) {
...
export function validateEcommerceNavigatorPolicies(policies = createEcommerceNavigatorPolicies()) {
  const issues = [];
...
export function summarizeEcommerceNavigatorPolicies(policies = createEcommerceNavigatorPolicies()) {
  return {
...
export function createEcommerceNavigatorEscalationDeck(policies = createEcommerceNavigatorPolicies()) {
