...
export function createAudienceStudioAuditTrail() {
...
export function createAudienceStudioEvidenceManifest() {
...
export function createAudienceStudioReadinessAttestation() {
  const auditTrail = createAudienceStudioAuditTrail();
  return {
