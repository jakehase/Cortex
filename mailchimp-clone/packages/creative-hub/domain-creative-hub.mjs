...
export function createCreativeHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCreativeHubWorkspace(workspace = createCreativeHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createCreativeHubNarratives(workspace = createCreativeHubWorkspace()) {
...
export function createCreativeHubCoverageGrid(workspace = createCreativeHubWorkspace()) {
