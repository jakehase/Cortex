...
export function createCreativeHubReportCards() {
...
export function createCreativeHubReviewPackets() {
...
export function summarizeCreativeHubReporting() {
  const cards = createCreativeHubReportCards();
  const packets = createCreativeHubReviewPackets();
  return {
