...
export function createChannelExchangeAuditTrail() {
...
export function createChannelExchangeEvidenceManifest() {
...
export function createChannelExchangeReadinessAttestation() {
  const auditTrail = createChannelExchangeAuditTrail();
  return {
