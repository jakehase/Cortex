...
export function createChannelExchangePolicies(overrides = {}) {
...
export function validateChannelExchangePolicies(policies = createChannelExchangePolicies()) {
  const issues = [];
...
export function summarizeChannelExchangePolicies(policies = createChannelExchangePolicies()) {
  return {
...
export function createChannelExchangeEscalationDeck(policies = createChannelExchangePolicies()) {
