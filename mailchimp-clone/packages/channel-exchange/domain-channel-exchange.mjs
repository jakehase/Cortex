const MODULE = {
  ...
  "title": "Channel Exchange",
  "focus": "Channel Exchange covers channel operating models, readiness coverage, and mix governance through handoff workflows and partner coordination.",
...
export function createChannelExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelExchangeWorkspace(workspace = createChannelExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelExchangeNarratives(workspace = createChannelExchangeWorkspace()) {
...
export function createChannelExchangeCoverageGrid(workspace = createChannelExchangeWorkspace()) {
