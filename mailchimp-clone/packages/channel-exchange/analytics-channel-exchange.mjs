...
export function createChannelExchangeAnalyticsTimeline() {
...
export function createChannelExchangeForecastEnvelope() {
...
export function createChannelExchangeExceptionLedger() {
...
export function summarizeChannelExchangeAnalytics() {
  const timeline = createChannelExchangeAnalyticsTimeline();
  const forecast = createChannelExchangeForecastEnvelope();
  return {
