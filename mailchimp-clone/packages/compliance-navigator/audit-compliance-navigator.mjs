...
export function createComplianceNavigatorAuditTrail() {
...
export function createComplianceNavigatorEvidenceManifest() {
...
export function createComplianceNavigatorReadinessAttestation() {
  const auditTrail = createComplianceNavigatorAuditTrail();
  return {
