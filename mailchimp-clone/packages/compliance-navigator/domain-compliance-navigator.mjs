...
export function createComplianceNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeComplianceNavigatorWorkspace(workspace = createComplianceNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createComplianceNavigatorNarratives(workspace = createComplianceNavigatorWorkspace()) {
...
export function createComplianceNavigatorCoverageGrid(workspace = createComplianceNavigatorWorkspace()) {
