...
export function createAnalyticsAtlasPolicies(overrides = {}) {
...
export function validateAnalyticsAtlasPolicies(policies = createAnalyticsAtlasPolicies()) {
  const issues = [];
...
export function summarizeAnalyticsAtlasPolicies(policies = createAnalyticsAtlasPolicies()) {
  return {
...
export function createAnalyticsAtlasEscalationDeck(policies = createAnalyticsAtlasPolicies()) {
