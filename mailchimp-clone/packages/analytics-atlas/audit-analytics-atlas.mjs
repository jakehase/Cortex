...
export function createAnalyticsAtlasAuditTrail() {
...
export function createAnalyticsAtlasEvidenceManifest() {
...
export function createAnalyticsAtlasReadinessAttestation() {
  const auditTrail = createAnalyticsAtlasAuditTrail();
  return {
