...
export function createAnalyticsAtlasReportCards() {
...
export function createAnalyticsAtlasReviewPackets() {
...
export function summarizeAnalyticsAtlasReporting() {
  const cards = createAnalyticsAtlasReportCards();
  const packets = createAnalyticsAtlasReviewPackets();
  return {
