...
export function createActivationStudioFixtures() {
  return {
    accounts: [
...
export function summarizeActivationStudioFixtures(fixtures = createActivationStudioFixtures()) {
  return {
...
export function createActivationStudioDemoInputs() {
  return {
