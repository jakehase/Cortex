...
export function createActivationStudioAuditTrail() {
...
export function createActivationStudioEvidenceManifest() {
...
export function createActivationStudioReadinessAttestation() {
  const auditTrail = createActivationStudioAuditTrail();
  return {
