...
export function createActivationStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationStudioWorkspace(workspace = createActivationStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationStudioNarratives(workspace = createActivationStudioWorkspace()) {
...
export function createActivationStudioCoverageGrid(workspace = createActivationStudioWorkspace()) {
