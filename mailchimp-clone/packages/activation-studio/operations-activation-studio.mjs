...
export function createActivationStudioOperationsBoard() {
...
export function createActivationStudioShiftChecklist() {
...
export function createActivationStudioIncidentDeck() {
