...
export function createActivationAtlasReportCards() {
...
export function createActivationAtlasReviewPackets() {
...
export function summarizeActivationAtlasReporting() {
  const cards = createActivationAtlasReportCards();
  const packets = createActivationAtlasReviewPackets();
  return {
