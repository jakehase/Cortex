...
export function createActivationAtlasAuditTrail() {
...
export function createActivationAtlasEvidenceManifest() {
...
export function createActivationAtlasReadinessAttestation() {
  const auditTrail = createActivationAtlasAuditTrail();
  return {
