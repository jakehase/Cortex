...
export function createActivationAtlasOperationsBoard() {
...
export function createActivationAtlasShiftChecklist() {
...
export function createActivationAtlasIncidentDeck() {
