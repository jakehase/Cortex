...
export function createActivationAtlasPolicies(overrides = {}) {
...
export function validateActivationAtlasPolicies(policies = createActivationAtlasPolicies()) {
  const issues = [];
...
export function summarizeActivationAtlasPolicies(policies = createActivationAtlasPolicies()) {
  return {
...
export function createActivationAtlasEscalationDeck(policies = createActivationAtlasPolicies()) {
