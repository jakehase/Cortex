...
export function createAdvocacyExchangePolicies(overrides = {}) {
...
export function validateAdvocacyExchangePolicies(policies = createAdvocacyExchangePolicies()) {
  const issues = [];
...
export function summarizeAdvocacyExchangePolicies(policies = createAdvocacyExchangePolicies()) {
  return {
...
export function createAdvocacyExchangeEscalationDeck(policies = createAdvocacyExchangePolicies()) {
