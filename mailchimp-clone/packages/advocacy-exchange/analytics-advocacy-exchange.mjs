...
export function createAdvocacyExchangeAnalyticsTimeline() {
...
export function createAdvocacyExchangeForecastEnvelope() {
...
export function createAdvocacyExchangeExceptionLedger() {
...
export function summarizeAdvocacyExchangeAnalytics() {
  const timeline = createAdvocacyExchangeAnalyticsTimeline();
  const forecast = createAdvocacyExchangeForecastEnvelope();
  return {
