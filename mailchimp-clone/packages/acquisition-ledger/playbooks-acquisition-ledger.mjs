...
export function createAcquisitionLedgerPlaybooks() {
...
export function createAcquisitionLedgerDecisionDeck() {
...
export function createAcquisitionLedgerEscalationMoments() {
