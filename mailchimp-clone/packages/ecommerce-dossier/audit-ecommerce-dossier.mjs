...
export function createEcommerceDossierAuditTrail() {
...
export function createEcommerceDossierEvidenceManifest() {
...
export function createEcommerceDossierReadinessAttestation() {
  const auditTrail = createEcommerceDossierAuditTrail();
  return {
