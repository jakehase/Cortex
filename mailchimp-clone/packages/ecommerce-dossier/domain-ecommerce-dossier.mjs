...
export function createEcommerceDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceDossierWorkspace(workspace = createEcommerceDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceDossierNarratives(workspace = createEcommerceDossierWorkspace()) {
...
export function createEcommerceDossierCoverageGrid(workspace = createEcommerceDossierWorkspace()) {
