...
export function createEcommerceDossierReportCards() {
...
export function createEcommerceDossierReviewPackets() {
...
export function summarizeEcommerceDossierReporting() {
  const cards = createEcommerceDossierReportCards();
  const packets = createEcommerceDossierReviewPackets();
  return {
