...
export function createDeliverabilityPlannerReportCards() {
...
export function createDeliverabilityPlannerReviewPackets() {
...
export function summarizeDeliverabilityPlannerReporting() {
  const cards = createDeliverabilityPlannerReportCards();
  const packets = createDeliverabilityPlannerReviewPackets();
  return {
