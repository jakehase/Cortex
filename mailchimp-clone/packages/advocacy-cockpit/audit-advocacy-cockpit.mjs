...
export function createAdvocacyCockpitAuditTrail() {
...
export function createAdvocacyCockpitEvidenceManifest() {
...
export function createAdvocacyCockpitReadinessAttestation() {
  const auditTrail = createAdvocacyCockpitAuditTrail();
  return {
