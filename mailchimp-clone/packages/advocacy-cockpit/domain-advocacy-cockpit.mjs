...
export function createAdvocacyCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyCockpitWorkspace(workspace = createAdvocacyCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyCockpitNarratives(workspace = createAdvocacyCockpitWorkspace()) {
...
export function createAdvocacyCockpitCoverageGrid(workspace = createAdvocacyCockpitWorkspace()) {
