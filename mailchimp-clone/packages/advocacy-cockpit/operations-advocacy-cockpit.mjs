...
export function createAdvocacyCockpitOperationsBoard() {
...
export function createAdvocacyCockpitShiftChecklist() {
...
export function createAdvocacyCockpitIncidentDeck() {
