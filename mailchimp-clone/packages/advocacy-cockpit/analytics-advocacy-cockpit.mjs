...
export function createAdvocacyCockpitAnalyticsTimeline() {
...
export function createAdvocacyCockpitForecastEnvelope() {
...
export function createAdvocacyCockpitExceptionLedger() {
...
export function summarizeAdvocacyCockpitAnalytics() {
  const timeline = createAdvocacyCockpitAnalyticsTimeline();
  const forecast = createAdvocacyCockpitForecastEnvelope();
  return {
