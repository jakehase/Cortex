...
export function createCollaborationDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationDossierWorkspace(workspace = createCollaborationDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationDossierNarratives(workspace = createCollaborationDossierWorkspace()) {
...
export function createCollaborationDossierCoverageGrid(workspace = createCollaborationDossierWorkspace()) {
