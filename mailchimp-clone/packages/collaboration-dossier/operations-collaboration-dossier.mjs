...
export function createCollaborationDossierOperationsBoard() {
...
export function createCollaborationDossierShiftChecklist() {
...
export function createCollaborationDossierIncidentDeck() {
