...
export function createCollaborationDossierPlaybooks() {
...
export function createCollaborationDossierDecisionDeck() {
...
export function createCollaborationDossierEscalationMoments() {
