...
export function createAnalyticsWatchtowerAuditTrail() {
...
export function createAnalyticsWatchtowerEvidenceManifest() {
...
export function createAnalyticsWatchtowerReadinessAttestation() {
  const auditTrail = createAnalyticsWatchtowerAuditTrail();
  return {
