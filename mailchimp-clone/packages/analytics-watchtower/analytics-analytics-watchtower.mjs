...
export function createAnalyticsWatchtowerAnalyticsTimeline() {
...
export function createAnalyticsWatchtowerForecastEnvelope() {
...
export function createAnalyticsWatchtowerExceptionLedger() {
...
export function summarizeAnalyticsWatchtowerAnalytics() {
  const timeline = createAnalyticsWatchtowerAnalyticsTimeline();
  const forecast = createAnalyticsWatchtowerForecastEnvelope();
  return {
