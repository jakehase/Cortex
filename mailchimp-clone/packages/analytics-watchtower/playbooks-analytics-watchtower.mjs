...
export function createAnalyticsWatchtowerPlaybooks() {
...
export function createAnalyticsWatchtowerDecisionDeck() {
...
export function createAnalyticsWatchtowerEscalationMoments() {
