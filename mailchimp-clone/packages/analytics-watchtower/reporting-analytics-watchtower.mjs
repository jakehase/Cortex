...
export function createAnalyticsWatchtowerReportCards() {
...
export function createAnalyticsWatchtowerReviewPackets() {
...
export function summarizeAnalyticsWatchtowerReporting() {
  const cards = createAnalyticsWatchtowerReportCards();
  const packets = createAnalyticsWatchtowerReviewPackets();
  return {
