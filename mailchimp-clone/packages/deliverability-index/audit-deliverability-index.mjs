...
export function createDeliverabilityIndexAuditTrail() {
...
export function createDeliverabilityIndexEvidenceManifest() {
...
export function createDeliverabilityIndexReadinessAttestation() {
  const auditTrail = createDeliverabilityIndexAuditTrail();
  return {
