...
export function createLifecycleWorkbenchPolicies(overrides = {}) {
...
export function validateLifecycleWorkbenchPolicies(policies = createLifecycleWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeLifecycleWorkbenchPolicies(policies = createLifecycleWorkbenchPolicies()) {
  return {
...
export function createLifecycleWorkbenchEscalationDeck(policies = createLifecycleWorkbenchPolicies()) {
