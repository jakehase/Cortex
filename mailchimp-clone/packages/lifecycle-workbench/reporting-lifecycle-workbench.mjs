...
export function createLifecycleWorkbenchReportCards() {
...
export function createLifecycleWorkbenchReviewPackets() {
...
export function summarizeLifecycleWorkbenchReporting() {
  const cards = createLifecycleWorkbenchReportCards();
  const packets = createLifecycleWorkbenchReviewPackets();
  return {
