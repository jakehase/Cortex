...
export function createLifecycleWorkbenchOperationsBoard() {
...
export function createLifecycleWorkbenchShiftChecklist() {
...
export function createLifecycleWorkbenchIncidentDeck() {
