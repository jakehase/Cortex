...
export function createLocalizationScorecardAuditTrail() {
...
export function createLocalizationScorecardEvidenceManifest() {
...
export function createLocalizationScorecardReadinessAttestation() {
  const auditTrail = createLocalizationScorecardAuditTrail();
  return {
