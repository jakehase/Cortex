...
export function createLocalizationScorecardAnalyticsTimeline() {
...
export function createLocalizationScorecardForecastEnvelope() {
...
export function createLocalizationScorecardExceptionLedger() {
...
export function summarizeLocalizationScorecardAnalytics() {
  const timeline = createLocalizationScorecardAnalyticsTimeline();
  const forecast = createLocalizationScorecardForecastEnvelope();
  return {
