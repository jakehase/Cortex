const MODULE = {
  "id": "localization-scorecard",
  "ordinal": 513,
  "domain": "localization",
  "surfaceId": "scorecard",
  "surfaceTitle": "Scorecard",
  "routeSegment": "scorecard",
  "title": "Localization Scorecard",
  "focus": "Localization Scorecard covers regional readiness, translation coverage, and market-specific proof through metric tracking and readiness scoring.",
  ...
  "tags": [
    ...
    "scorecard",
    "trust",
    "localization-scorecard-wave-seven"
  ]
};
...
export function createLocalizationScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationScorecardWorkspace(workspace = createLocalizationScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationScorecardNarratives(workspace = createLocalizationScorecardWorkspace()) {
...
export function createLocalizationScorecardCoverageGrid(workspace = createLocalizationScorecardWorkspace()) {
