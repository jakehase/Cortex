...
export function createLocalizationScorecardPlaybooks() {
...
export function createLocalizationScorecardDecisionDeck() {
...
export function createLocalizationScorecardEscalationMoments() {
