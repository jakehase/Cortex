...
export function createLocalizationScorecardPolicies(overrides = {}) {
...
export function validateLocalizationScorecardPolicies(policies = createLocalizationScorecardPolicies()) {
  const issues = [];
...
export function summarizeLocalizationScorecardPolicies(policies = createLocalizationScorecardPolicies()) {
  return {
...
export function createLocalizationScorecardEscalationDeck(policies = createLocalizationScorecardPolicies()) {
