...
export function createAttributionScorecardAnalyticsTimeline() {
...
export function createAttributionScorecardForecastEnvelope() {
...
export function createAttributionScorecardExceptionLedger() {
...
export function summarizeAttributionScorecardAnalytics() {
  const timeline = createAttributionScorecardAnalyticsTimeline();
  const forecast = createAttributionScorecardForecastEnvelope();
  return {
