...
export function createComplianceStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeComplianceStudioWorkspace(workspace = createComplianceStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createComplianceStudioNarratives(workspace = createComplianceStudioWorkspace()) {
...
export function createComplianceStudioCoverageGrid(workspace = createComplianceStudioWorkspace()) {
