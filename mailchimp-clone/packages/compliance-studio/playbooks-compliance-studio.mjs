...
export function createComplianceStudioPlaybooks() {
...
export function createComplianceStudioDecisionDeck() {
...
export function createComplianceStudioEscalationMoments() {
