...
export function createComplianceStudioPolicies(overrides = {}) {
...
export function validateComplianceStudioPolicies(policies = createComplianceStudioPolicies()) {
  const issues = [];
...
export function summarizeComplianceStudioPolicies(policies = createComplianceStudioPolicies()) {
  return {
...
export function createComplianceStudioEscalationDeck(policies = createComplianceStudioPolicies()) {
