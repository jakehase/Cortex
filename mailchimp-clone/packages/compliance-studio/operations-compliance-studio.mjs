...
export function createComplianceStudioOperationsBoard() {
...
export function createComplianceStudioShiftChecklist() {
...
export function createComplianceStudioIncidentDeck() {
