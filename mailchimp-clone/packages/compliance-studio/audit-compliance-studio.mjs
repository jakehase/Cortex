...
export function createComplianceStudioAuditTrail() {
...
export function createComplianceStudioEvidenceManifest() {
...
export function createComplianceStudioReadinessAttestation() {
  const auditTrail = createComplianceStudioAuditTrail();
  return {
