...
export function createComplianceStudioFixtures() {
  return {
    accounts: [
...
export function summarizeComplianceStudioFixtures(fixtures = createComplianceStudioFixtures()) {
  return {
...
export function createComplianceStudioDemoInputs() {
  return {
