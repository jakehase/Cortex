...
export function createAttributionSentinelReportCards() {
...
export function createAttributionSentinelReviewPackets() {
...
export function summarizeAttributionSentinelReporting() {
  const cards = createAttributionSentinelReportCards();
  const packets = createAttributionSentinelReviewPackets();
  return {
