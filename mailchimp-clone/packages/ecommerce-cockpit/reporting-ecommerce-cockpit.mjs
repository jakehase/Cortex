...
export function createEcommerceCockpitReportCards() {
...
export function createEcommerceCockpitReviewPackets() {
...
export function summarizeEcommerceCockpitReporting() {
  const cards = createEcommerceCockpitReportCards();
  const packets = createEcommerceCockpitReviewPackets();
  return {
