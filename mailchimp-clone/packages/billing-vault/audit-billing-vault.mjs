...
export function createBillingVaultAuditTrail() {
...
export function createBillingVaultEvidenceManifest() {
...
export function createBillingVaultReadinessAttestation() {
  const auditTrail = createBillingVaultAuditTrail();
  return {
