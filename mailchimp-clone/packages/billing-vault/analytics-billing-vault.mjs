...
export function createBillingVaultAnalyticsTimeline() {
...
export function createBillingVaultForecastEnvelope() {
...
export function createBillingVaultExceptionLedger() {
...
export function summarizeBillingVaultAnalytics() {
  const timeline = createBillingVaultAnalyticsTimeline();
  const forecast = createBillingVaultForecastEnvelope();
  return {
