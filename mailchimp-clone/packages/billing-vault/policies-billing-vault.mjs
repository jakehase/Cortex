...
export function createBillingVaultPolicies(overrides = {}) {
...
export function validateBillingVaultPolicies(policies = createBillingVaultPolicies()) {
  const issues = [];
...
export function summarizeBillingVaultPolicies(policies = createBillingVaultPolicies()) {
  return {
...
export function createBillingVaultEscalationDeck(policies = createBillingVaultPolicies()) {
