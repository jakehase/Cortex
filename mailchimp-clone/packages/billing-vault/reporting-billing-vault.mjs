...
export function createBillingVaultReportCards() {
...
export function createBillingVaultReviewPackets() {
...
export function summarizeBillingVaultReporting() {
  const cards = createBillingVaultReportCards();
  const packets = createBillingVaultReviewPackets();
  return {
