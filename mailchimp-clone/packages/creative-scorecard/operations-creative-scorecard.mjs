...
export function createCreativeScorecardOperationsBoard() {
...
export function createCreativeScorecardShiftChecklist() {
...
export function createCreativeScorecardIncidentDeck() {
