...
export function createCreativeScorecardPlaybooks() {
...
export function createCreativeScorecardDecisionDeck() {
...
export function createCreativeScorecardEscalationMoments() {
