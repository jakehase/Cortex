...
export function createAdvocacyHubAuditTrail() {
...
export function createAdvocacyHubEvidenceManifest() {
...
export function createAdvocacyHubReadinessAttestation() {
  const auditTrail = createAdvocacyHubAuditTrail();
  return {
