...
export function createAdvocacyHubPolicies(overrides = {}) {
...
export function validateAdvocacyHubPolicies(policies = createAdvocacyHubPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyHubPolicies(policies = createAdvocacyHubPolicies()) {
  return {
...
export function createAdvocacyHubEscalationDeck(policies = createAdvocacyHubPolicies()) {
