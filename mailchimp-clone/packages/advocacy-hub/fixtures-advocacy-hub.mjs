...
export function createAdvocacyHubFixtures() {
  return {
    accounts: [
...
export function summarizeAdvocacyHubFixtures(fixtures = createAdvocacyHubFixtures()) {
  return {
...
export function createAdvocacyHubDemoInputs() {
  return {
