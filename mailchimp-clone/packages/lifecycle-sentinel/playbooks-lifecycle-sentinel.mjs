...
export function createLifecycleSentinelPlaybooks() {
...
export function createLifecycleSentinelDecisionDeck() {
...
export function createLifecycleSentinelEscalationMoments() {
