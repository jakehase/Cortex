...
export function createEcommerceWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceWatchtowerWorkspace(workspace = createEcommerceWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceWatchtowerNarratives(workspace = createEcommerceWatchtowerWorkspace()) {
...
export function createEcommerceWatchtowerCoverageGrid(workspace = createEcommerceWatchtowerWorkspace()) {
