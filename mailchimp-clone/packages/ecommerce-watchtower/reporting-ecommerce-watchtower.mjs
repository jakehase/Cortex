...
export function createEcommerceWatchtowerReportCards() {
...
export function createEcommerceWatchtowerReviewPackets() {
...
export function summarizeEcommerceWatchtowerReporting() {
  const cards = createEcommerceWatchtowerReportCards();
  const packets = createEcommerceWatchtowerReviewPackets();
  return {
