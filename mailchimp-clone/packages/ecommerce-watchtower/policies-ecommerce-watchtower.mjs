...
export function createEcommerceWatchtowerPolicies(overrides = {}) {
...
export function validateEcommerceWatchtowerPolicies(policies = createEcommerceWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeEcommerceWatchtowerPolicies(policies = createEcommerceWatchtowerPolicies()) {
  return {
...
export function createEcommerceWatchtowerEscalationDeck(policies = createEcommerceWatchtowerPolicies()) {
