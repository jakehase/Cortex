...
export function createEcommerceWatchtowerOperationsBoard() {
...
export function createEcommerceWatchtowerShiftChecklist() {
...
export function createEcommerceWatchtowerIncidentDeck() {
