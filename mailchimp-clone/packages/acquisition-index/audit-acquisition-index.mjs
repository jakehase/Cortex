...
export function createAcquisitionIndexAuditTrail() {
...
export function createAcquisitionIndexEvidenceManifest() {
...
export function createAcquisitionIndexReadinessAttestation() {
  const auditTrail = createAcquisitionIndexAuditTrail();
  return {
