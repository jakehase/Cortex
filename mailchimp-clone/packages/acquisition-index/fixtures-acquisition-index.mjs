...
export function createAcquisitionIndexFixtures() {
  return {
    accounts: [
...
export function summarizeAcquisitionIndexFixtures(fixtures = createAcquisitionIndexFixtures()) {
  return {
...
export function createAcquisitionIndexDemoInputs() {
  return {
