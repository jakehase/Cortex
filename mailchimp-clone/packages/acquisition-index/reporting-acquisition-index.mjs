...
export function createAcquisitionIndexReportCards() {
...
export function createAcquisitionIndexReviewPackets() {
...
export function summarizeAcquisitionIndexReporting() {
  const cards = createAcquisitionIndexReportCards();
  const packets = createAcquisitionIndexReviewPackets();
  return {
