...
export function createAcquisitionIndexAnalyticsTimeline() {
...
export function createAcquisitionIndexForecastEnvelope() {
...
export function createAcquisitionIndexExceptionLedger() {
...
export function summarizeAcquisitionIndexAnalytics() {
  const timeline = createAcquisitionIndexAnalyticsTimeline();
  const forecast = createAcquisitionIndexForecastEnvelope();
  return {
