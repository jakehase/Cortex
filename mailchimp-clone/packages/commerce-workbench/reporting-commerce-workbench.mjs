...
export function createCommerceWorkbenchReportCards() {
...
export function createCommerceWorkbenchReviewPackets() {
...
export function summarizeCommerceWorkbenchReporting() {
  const cards = createCommerceWorkbenchReportCards();
  const packets = createCommerceWorkbenchReviewPackets();
  return {
