...
export function createLocalizationVaultReportCards() {
...
export function createLocalizationVaultReviewPackets() {
...
export function summarizeLocalizationVaultReporting() {
  const cards = createLocalizationVaultReportCards();
  const packets = createLocalizationVaultReviewPackets();
  return {
