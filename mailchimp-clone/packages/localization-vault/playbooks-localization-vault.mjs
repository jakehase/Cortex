...
export function createLocalizationVaultPlaybooks() {
...
export function createLocalizationVaultDecisionDeck() {
...
export function createLocalizationVaultEscalationMoments() {
