...
export function createCollaborationIndexPolicies(overrides = {}) {
...
export function validateCollaborationIndexPolicies(policies = createCollaborationIndexPolicies()) {
  const issues = [];
...
export function summarizeCollaborationIndexPolicies(policies = createCollaborationIndexPolicies()) {
  return {
...
export function createCollaborationIndexEscalationDeck(policies = createCollaborationIndexPolicies()) {
