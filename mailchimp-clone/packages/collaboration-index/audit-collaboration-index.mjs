...
export function createCollaborationIndexAuditTrail() {
...
export function createCollaborationIndexEvidenceManifest() {
...
export function createCollaborationIndexReadinessAttestation() {
  const auditTrail = createCollaborationIndexAuditTrail();
  return {
