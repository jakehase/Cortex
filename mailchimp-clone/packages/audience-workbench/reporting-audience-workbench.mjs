...
export function createAudienceWorkbenchReportCards() {
...
export function createAudienceWorkbenchReviewPackets() {
...
export function summarizeAudienceWorkbenchReporting() {
  const cards = createAudienceWorkbenchReportCards();
  const packets = createAudienceWorkbenchReviewPackets();
  return {
