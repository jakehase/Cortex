...
export function createAudienceWorkbenchAnalyticsTimeline() {
...
export function createAudienceWorkbenchForecastEnvelope() {
...
export function createAudienceWorkbenchExceptionLedger() {
...
export function summarizeAudienceWorkbenchAnalytics() {
  const timeline = createAudienceWorkbenchAnalyticsTimeline();
  const forecast = createAudienceWorkbenchForecastEnvelope();
  return {
