...
export function createAudienceWorkbenchAuditTrail() {
...
export function createAudienceWorkbenchEvidenceManifest() {
...
export function createAudienceWorkbenchReadinessAttestation() {
  const auditTrail = createAudienceWorkbenchAuditTrail();
  return {
