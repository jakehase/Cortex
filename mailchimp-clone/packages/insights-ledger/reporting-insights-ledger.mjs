...
export function createInsightsLedgerReportCards() {
...
export function createInsightsLedgerReviewPackets() {
...
export function summarizeInsightsLedgerReporting() {
  const cards = createInsightsLedgerReportCards();
  const packets = createInsightsLedgerReviewPackets();
  return {
