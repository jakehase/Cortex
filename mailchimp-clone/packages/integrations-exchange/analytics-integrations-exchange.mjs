...
export function createIntegrationsExchangeAnalyticsTimeline() {
...
export function createIntegrationsExchangeForecastEnvelope() {
...
export function createIntegrationsExchangeExceptionLedger() {
...
export function summarizeIntegrationsExchangeAnalytics() {
  const timeline = createIntegrationsExchangeAnalyticsTimeline();
  const forecast = createIntegrationsExchangeForecastEnvelope();
  return {
