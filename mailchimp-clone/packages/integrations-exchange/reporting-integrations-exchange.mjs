...
export function createIntegrationsExchangeReportCards() {
...
export function createIntegrationsExchangeReviewPackets() {
...
export function summarizeIntegrationsExchangeReporting() {
  const cards = createIntegrationsExchangeReportCards();
  const packets = createIntegrationsExchangeReviewPackets();
  return {
