...
export function createLifecycleAdvisorPolicies(overrides = {}) {
...
export function validateLifecycleAdvisorPolicies(policies = createLifecycleAdvisorPolicies()) {
  const issues = [];
...
export function summarizeLifecycleAdvisorPolicies(policies = createLifecycleAdvisorPolicies()) {
  return {
...
export function createLifecycleAdvisorEscalationDeck(policies = createLifecycleAdvisorPolicies()) {
