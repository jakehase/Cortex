...
export function createLifecycleAdvisorPlaybooks() {
...
export function createLifecycleAdvisorDecisionDeck() {
...
export function createLifecycleAdvisorEscalationMoments() {
