...
export function createLifecycleAdvisorReportCards() {
...
export function createLifecycleAdvisorReviewPackets() {
...
export function summarizeLifecycleAdvisorReporting() {
  const cards = createLifecycleAdvisorReportCards();
  const packets = createLifecycleAdvisorReviewPackets();
  return {
