...
export function createCampaignPlannerReportCards() {
...
export function createCampaignPlannerReviewPackets() {
...
export function summarizeCampaignPlannerReporting() {
  const cards = createCampaignPlannerReportCards();
  const packets = createCampaignPlannerReviewPackets();
  return {
