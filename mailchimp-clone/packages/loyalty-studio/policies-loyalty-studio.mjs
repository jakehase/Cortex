...
export function createLoyaltyStudioPolicies(overrides = {}) {
...
export function validateLoyaltyStudioPolicies(policies = createLoyaltyStudioPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyStudioPolicies(policies = createLoyaltyStudioPolicies()) {
  return {
...
export function createLoyaltyStudioEscalationDeck(policies = createLoyaltyStudioPolicies()) {
