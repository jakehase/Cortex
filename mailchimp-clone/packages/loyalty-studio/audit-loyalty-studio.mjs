...
export function createLoyaltyStudioAuditTrail() {
...
export function createLoyaltyStudioEvidenceManifest() {
...
export function createLoyaltyStudioReadinessAttestation() {
  const auditTrail = createLoyaltyStudioAuditTrail();
  return {
