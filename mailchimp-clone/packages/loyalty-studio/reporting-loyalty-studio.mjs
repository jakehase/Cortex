...
export function createLoyaltyStudioReportCards() {
...
export function createLoyaltyStudioReviewPackets() {
...
export function summarizeLoyaltyStudioReporting() {
  const cards = createLoyaltyStudioReportCards();
  const packets = createLoyaltyStudioReviewPackets();
  return {
