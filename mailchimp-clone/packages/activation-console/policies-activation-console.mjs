...
export function createActivationConsolePolicies(overrides = {}) {
...
export function validateActivationConsolePolicies(policies = createActivationConsolePolicies()) {
  const issues = [];
...
export function summarizeActivationConsolePolicies(policies = createActivationConsolePolicies()) {
  return {
...
export function createActivationConsoleEscalationDeck(policies = createActivationConsolePolicies()) {
