...
export function createActivationConsoleAnalyticsTimeline() {
...
export function createActivationConsoleForecastEnvelope() {
...
export function createActivationConsoleExceptionLedger() {
...
export function summarizeActivationConsoleAnalytics() {
  const timeline = createActivationConsoleAnalyticsTimeline();
  const forecast = createActivationConsoleForecastEnvelope();
  return {
