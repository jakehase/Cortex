...
export function createLifecyclePlannerFixtures() {
  return {
    accounts: [
...
export function summarizeLifecyclePlannerFixtures(fixtures = createLifecyclePlannerFixtures()) {
  return {
...
export function createLifecyclePlannerDemoInputs() {
  return {
