...
export function createLifecyclePlannerPlaybooks() {
...
export function createLifecyclePlannerDecisionDeck() {
...
export function createLifecyclePlannerEscalationMoments() {
