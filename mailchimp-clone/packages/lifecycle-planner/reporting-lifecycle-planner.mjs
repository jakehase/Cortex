...
export function createLifecyclePlannerReportCards() {
...
export function createLifecyclePlannerReviewPackets() {
...
export function summarizeLifecyclePlannerReporting() {
  const cards = createLifecyclePlannerReportCards();
  const packets = createLifecyclePlannerReviewPackets();
  return {
