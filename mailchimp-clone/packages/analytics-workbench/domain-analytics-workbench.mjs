...
export function createAnalyticsWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsWorkbenchWorkspace(workspace = createAnalyticsWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsWorkbenchNarratives(workspace = createAnalyticsWorkbenchWorkspace()) {
...
export function createAnalyticsWorkbenchCoverageGrid(workspace = createAnalyticsWorkbenchWorkspace()) {
