...
export function createAnalyticsWorkbenchOperationsBoard() {
...
export function createAnalyticsWorkbenchShiftChecklist() {
...
export function createAnalyticsWorkbenchIncidentDeck() {
