...
export function createAnalyticsWorkbenchAnalyticsTimeline() {
...
export function createAnalyticsWorkbenchForecastEnvelope() {
...
export function createAnalyticsWorkbenchExceptionLedger() {
...
export function summarizeAnalyticsWorkbenchAnalytics() {
  const timeline = createAnalyticsWorkbenchAnalyticsTimeline();
  const forecast = createAnalyticsWorkbenchForecastEnvelope();
  return {
