...
export function createAutomationVaultReportCards() {
...
export function createAutomationVaultReviewPackets() {
...
export function summarizeAutomationVaultReporting() {
  const cards = createAutomationVaultReportCards();
  const packets = createAutomationVaultReviewPackets();
  return {
