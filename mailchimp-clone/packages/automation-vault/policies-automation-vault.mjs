...
export function createAutomationVaultPolicies(overrides = {}) {
...
export function validateAutomationVaultPolicies(policies = createAutomationVaultPolicies()) {
  const issues = [];
...
export function summarizeAutomationVaultPolicies(policies = createAutomationVaultPolicies()) {
  return {
...
export function createAutomationVaultEscalationDeck(policies = createAutomationVaultPolicies()) {
