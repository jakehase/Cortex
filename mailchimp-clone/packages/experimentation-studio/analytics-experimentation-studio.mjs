...
export function createExperimentationStudioAnalyticsTimeline() {
...
export function createExperimentationStudioForecastEnvelope() {
...
export function createExperimentationStudioExceptionLedger() {
...
export function summarizeExperimentationStudioAnalytics() {
  const timeline = createExperimentationStudioAnalyticsTimeline();
  const forecast = createExperimentationStudioForecastEnvelope();
  return {
