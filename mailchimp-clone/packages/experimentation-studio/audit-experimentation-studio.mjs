...
export function createExperimentationStudioAuditTrail() {
...
export function createExperimentationStudioEvidenceManifest() {
...
export function createExperimentationStudioReadinessAttestation() {
  const auditTrail = createExperimentationStudioAuditTrail();
  return {
