...
export function createCollaborationStudioAuditTrail() {
...
export function createCollaborationStudioEvidenceManifest() {
...
export function createCollaborationStudioReadinessAttestation() {
  const auditTrail = createCollaborationStudioAuditTrail();
  return {
