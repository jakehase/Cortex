...
export function createCollaborationStudioReportCards() {
...
export function createCollaborationStudioReviewPackets() {
...
export function summarizeCollaborationStudioReporting() {
  const cards = createCollaborationStudioReportCards();
  const packets = createCollaborationStudioReviewPackets();
  return {
