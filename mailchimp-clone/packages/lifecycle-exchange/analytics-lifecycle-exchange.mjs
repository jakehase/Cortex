...
export function createLifecycleExchangeAnalyticsTimeline() {
...
export function createLifecycleExchangeForecastEnvelope() {
...
export function createLifecycleExchangeExceptionLedger() {
...
export function summarizeLifecycleExchangeAnalytics() {
  const timeline = createLifecycleExchangeAnalyticsTimeline();
  const forecast = createLifecycleExchangeForecastEnvelope();
  return {
