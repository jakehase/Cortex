...
export function createLifecycleExchangePolicies(overrides = {}) {
...
export function validateLifecycleExchangePolicies(policies = createLifecycleExchangePolicies()) {
  const issues = [];
...
export function summarizeLifecycleExchangePolicies(policies = createLifecycleExchangePolicies()) {
  return {
...
export function createLifecycleExchangeEscalationDeck(policies = createLifecycleExchangePolicies()) {
