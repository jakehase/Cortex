...
export function createLifecycleExchangeAuditTrail() {
...
export function createLifecycleExchangeEvidenceManifest() {
...
export function createLifecycleExchangeReadinessAttestation() {
  const auditTrail = createLifecycleExchangeAuditTrail();
  return {
