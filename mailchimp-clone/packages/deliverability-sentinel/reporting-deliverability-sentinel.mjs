...
export function createDeliverabilitySentinelReportCards() {
...
export function createDeliverabilitySentinelReviewPackets() {
...
export function summarizeDeliverabilitySentinelReporting() {
  const cards = createDeliverabilitySentinelReportCards();
  const packets = createDeliverabilitySentinelReviewPackets();
  return {
