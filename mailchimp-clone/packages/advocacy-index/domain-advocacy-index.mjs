const MODULE = {
  ...
  "focus": "Advocacy Index covers customer champions, referral readiness, and proof-sharing loops through searchable summaries and coverage catalogs.",
...
export function createAdvocacyIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyIndexWorkspace(workspace = createAdvocacyIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyIndexNarratives(workspace = createAdvocacyIndexWorkspace()) {
...
export function createAdvocacyIndexCoverageGrid(workspace = createAdvocacyIndexWorkspace()) {
