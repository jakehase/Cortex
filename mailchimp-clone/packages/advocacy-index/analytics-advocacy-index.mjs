...
export function createAdvocacyIndexAnalyticsTimeline() {
...
export function createAdvocacyIndexForecastEnvelope() {
...
export function createAdvocacyIndexExceptionLedger() {
...
export function summarizeAdvocacyIndexAnalytics() {
  const timeline = createAdvocacyIndexAnalyticsTimeline();
  const forecast = createAdvocacyIndexForecastEnvelope();
  return {
