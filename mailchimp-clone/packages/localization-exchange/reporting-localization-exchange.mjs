...
export function createLocalizationExchangeReportCards() {
...
export function createLocalizationExchangeReviewPackets() {
...
export function summarizeLocalizationExchangeReporting() {
  const cards = createLocalizationExchangeReportCards();
  const packets = createLocalizationExchangeReviewPackets();
  return {
