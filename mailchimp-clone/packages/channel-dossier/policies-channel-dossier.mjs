...
export function createChannelDossierPolicies(overrides = {}) {
...
export function validateChannelDossierPolicies(policies = createChannelDossierPolicies()) {
  const issues = [];
...
export function summarizeChannelDossierPolicies(policies = createChannelDossierPolicies()) {
  return {
...
export function createChannelDossierEscalationDeck(policies = createChannelDossierPolicies()) {
