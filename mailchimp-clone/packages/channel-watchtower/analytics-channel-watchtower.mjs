...
export function createChannelWatchtowerAnalyticsTimeline() {
...
export function createChannelWatchtowerForecastEnvelope() {
...
export function createChannelWatchtowerExceptionLedger() {
...
export function summarizeChannelWatchtowerAnalytics() {
  const timeline = createChannelWatchtowerAnalyticsTimeline();
  const forecast = createChannelWatchtowerForecastEnvelope();
  return {
