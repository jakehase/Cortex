...
export function createChannelWatchtowerReportCards() {
...
export function createChannelWatchtowerReviewPackets() {
...
export function summarizeChannelWatchtowerReporting() {
  const cards = createChannelWatchtowerReportCards();
  const packets = createChannelWatchtowerReviewPackets();
  return {
