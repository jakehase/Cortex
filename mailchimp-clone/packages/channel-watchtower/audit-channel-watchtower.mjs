...
export function createChannelWatchtowerAuditTrail() {
...
export function createChannelWatchtowerEvidenceManifest() {
...
export function createChannelWatchtowerReadinessAttestation() {
  const auditTrail = createChannelWatchtowerAuditTrail();
  return {
