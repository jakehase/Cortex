...
export function createChannelWatchtowerPolicies(overrides = {}) {
...
export function validateChannelWatchtowerPolicies(policies = createChannelWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeChannelWatchtowerPolicies(policies = createChannelWatchtowerPolicies()) {
  return {
...
export function createChannelWatchtowerEscalationDeck(policies = createChannelWatchtowerPolicies()) {
