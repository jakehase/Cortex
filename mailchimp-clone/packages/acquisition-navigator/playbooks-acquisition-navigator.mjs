...
export function createAcquisitionNavigatorPlaybooks() {
...
export function createAcquisitionNavigatorDecisionDeck() {
...
export function createAcquisitionNavigatorEscalationMoments() {
