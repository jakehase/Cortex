...
export function createAcquisitionNavigatorReportCards() {
...
export function createAcquisitionNavigatorReviewPackets() {
...
export function summarizeAcquisitionNavigatorReporting() {
  const cards = createAcquisitionNavigatorReportCards();
  const packets = createAcquisitionNavigatorReviewPackets();
  return {
