...
export function createAcquisitionNavigatorOperationsBoard() {
...
export function createAcquisitionNavigatorShiftChecklist() {
...
export function createAcquisitionNavigatorIncidentDeck() {
