...
export function createPartnerAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizePartnerAdvisorFixtures(fixtures = createPartnerAdvisorFixtures()) {
  return {
...
export function createPartnerAdvisorDemoInputs() {
  return {
