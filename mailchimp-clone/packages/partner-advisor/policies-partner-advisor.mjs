...
export function createPartnerAdvisorPolicies(overrides = {}) {
...
export function validatePartnerAdvisorPolicies(policies = createPartnerAdvisorPolicies()) {
  const issues = [];
...
export function summarizePartnerAdvisorPolicies(policies = createPartnerAdvisorPolicies()) {
  return {
...
export function createPartnerAdvisorEscalationDeck(policies = createPartnerAdvisorPolicies()) {
