...
export function createCampaignCockpitPolicies(overrides = {}) {
...
export function validateCampaignCockpitPolicies(policies = createCampaignCockpitPolicies()) {
  const issues = [];
...
export function summarizeCampaignCockpitPolicies(policies = createCampaignCockpitPolicies()) {
  return {
...
export function createCampaignCockpitEscalationDeck(policies = createCampaignCockpitPolicies()) {
