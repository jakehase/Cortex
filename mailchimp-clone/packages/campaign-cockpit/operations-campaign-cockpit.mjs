...
export function createCampaignCockpitOperationsBoard() {
...
export function createCampaignCockpitShiftChecklist() {
...
export function createCampaignCockpitIncidentDeck() {
