...
export function createIntegrationsDossierAnalyticsTimeline() {
...
export function createIntegrationsDossierForecastEnvelope() {
...
export function createIntegrationsDossierExceptionLedger() {
...
export function summarizeIntegrationsDossierAnalytics() {
  const timeline = createIntegrationsDossierAnalyticsTimeline();
  const forecast = createIntegrationsDossierForecastEnvelope();
  return {
