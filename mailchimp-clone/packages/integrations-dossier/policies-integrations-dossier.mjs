...
export function createIntegrationsDossierPolicies(overrides = {}) {
...
export function validateIntegrationsDossierPolicies(policies = createIntegrationsDossierPolicies()) {
  const issues = [];
...
export function summarizeIntegrationsDossierPolicies(policies = createIntegrationsDossierPolicies()) {
  return {
...
export function createIntegrationsDossierEscalationDeck(policies = createIntegrationsDossierPolicies()) {
