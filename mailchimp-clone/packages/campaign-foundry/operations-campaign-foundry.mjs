...
export function createCampaignFoundryOperationsBoard() {
...
export function createCampaignFoundryShiftChecklist() {
...
export function createCampaignFoundryIncidentDeck() {
