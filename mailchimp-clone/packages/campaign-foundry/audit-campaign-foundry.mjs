...
export function createCampaignFoundryAuditTrail() {
...
export function createCampaignFoundryEvidenceManifest() {
...
export function createCampaignFoundryReadinessAttestation() {
  const auditTrail = createCampaignFoundryAuditTrail();
  return {
