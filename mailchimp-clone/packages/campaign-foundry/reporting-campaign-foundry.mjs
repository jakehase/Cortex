...
export function createCampaignFoundryReportCards() {
...
export function createCampaignFoundryReviewPackets() {
...
export function summarizeCampaignFoundryReporting() {
  const cards = createCampaignFoundryReportCards();
  const packets = createCampaignFoundryReviewPackets();
  return {
