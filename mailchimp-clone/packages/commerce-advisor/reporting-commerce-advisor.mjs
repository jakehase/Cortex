...
export function createCommerceAdvisorReportCards() {
...
export function createCommerceAdvisorReviewPackets() {
...
export function summarizeCommerceAdvisorReporting() {
  const cards = createCommerceAdvisorReportCards();
  const packets = createCommerceAdvisorReviewPackets();
  return {
