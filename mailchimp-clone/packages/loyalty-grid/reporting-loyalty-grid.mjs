...
export function createLoyaltyGridReportCards() {
...
export function createLoyaltyGridReviewPackets() {
...
export function summarizeLoyaltyGridReporting() {
  const cards = createLoyaltyGridReportCards();
  const packets = createLoyaltyGridReviewPackets();
  return {
