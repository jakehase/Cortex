...
export function createExperimentationCockpitAuditTrail() {
...
export function createExperimentationCockpitEvidenceManifest() {
...
export function createExperimentationCockpitReadinessAttestation() {
  const auditTrail = createExperimentationCockpitAuditTrail();
  return {
