...
export function createExperimentationCockpitAnalyticsTimeline() {
...
export function createExperimentationCockpitForecastEnvelope() {
...
export function createExperimentationCockpitExceptionLedger() {
...
export function summarizeExperimentationCockpitAnalytics() {
  const timeline = createExperimentationCockpitAnalyticsTimeline();
  const forecast = createExperimentationCockpitForecastEnvelope();
  return {
