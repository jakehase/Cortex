...
export function createCustomerNavigatorReportCards() {
...
export function createCustomerNavigatorReviewPackets() {
...
export function summarizeCustomerNavigatorReporting() {
  const cards = createCustomerNavigatorReportCards();
  const packets = createCustomerNavigatorReviewPackets();
  return {
