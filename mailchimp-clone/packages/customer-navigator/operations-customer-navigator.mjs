...
export function createCustomerNavigatorOperationsBoard() {
...
export function createCustomerNavigatorShiftChecklist() {
...
export function createCustomerNavigatorIncidentDeck() {
