...
export function createCustomerNavigatorPlaybooks() {
...
export function createCustomerNavigatorDecisionDeck() {
...
export function createCustomerNavigatorEscalationMoments() {
