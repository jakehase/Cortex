...
export function createCollaborationNotebookAnalyticsTimeline() {
...
export function createCollaborationNotebookForecastEnvelope() {
...
export function createCollaborationNotebookExceptionLedger() {
...
export function summarizeCollaborationNotebookAnalytics() {
  const timeline = createCollaborationNotebookAnalyticsTimeline();
  const forecast = createCollaborationNotebookForecastEnvelope();
  return {
