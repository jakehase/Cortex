...
export function createCollaborationNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeCollaborationNotebookFixtures(fixtures = createCollaborationNotebookFixtures()) {
  return {
...
export function createCollaborationNotebookDemoInputs() {
  return {
