...
export function createCollaborationNotebookReportCards() {
...
export function createCollaborationNotebookReviewPackets() {
...
export function summarizeCollaborationNotebookReporting() {
  const cards = createCollaborationNotebookReportCards();
  const packets = createCollaborationNotebookReviewPackets();
  return {
