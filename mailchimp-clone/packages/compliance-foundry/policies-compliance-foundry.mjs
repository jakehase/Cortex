...
export function createComplianceFoundryPolicies(overrides = {}) {
...
export function validateComplianceFoundryPolicies(policies = createComplianceFoundryPolicies()) {
  const issues = [];
...
export function summarizeComplianceFoundryPolicies(policies = createComplianceFoundryPolicies()) {
  return {
...
export function createComplianceFoundryEscalationDeck(policies = createComplianceFoundryPolicies()) {
