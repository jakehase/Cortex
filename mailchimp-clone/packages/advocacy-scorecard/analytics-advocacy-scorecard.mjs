...
export function createAdvocacyScorecardAnalyticsTimeline() {
...
export function createAdvocacyScorecardForecastEnvelope() {
...
export function createAdvocacyScorecardExceptionLedger() {
...
export function summarizeAdvocacyScorecardAnalytics() {
  const timeline = createAdvocacyScorecardAnalyticsTimeline();
  const forecast = createAdvocacyScorecardForecastEnvelope();
  return {
