...
export function createAdvocacyScorecardOperationsBoard() {
...
export function createAdvocacyScorecardShiftChecklist() {
...
export function createAdvocacyScorecardIncidentDeck() {
