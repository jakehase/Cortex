...
export function createConsentSentinelPolicies(overrides = {}) {
...
export function validateConsentSentinelPolicies(policies = createConsentSentinelPolicies()) {
  const issues = [];
...
export function summarizeConsentSentinelPolicies(policies = createConsentSentinelPolicies()) {
  return {
...
export function createConsentSentinelEscalationDeck(policies = createConsentSentinelPolicies()) {
