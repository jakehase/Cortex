...
export function createConsentSentinelAuditTrail() {
...
export function createConsentSentinelEvidenceManifest() {
...
export function createConsentSentinelReadinessAttestation() {
  const auditTrail = createConsentSentinelAuditTrail();
  return {
