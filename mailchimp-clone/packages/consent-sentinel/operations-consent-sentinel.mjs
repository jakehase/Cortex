...
export function createConsentSentinelOperationsBoard() {
...
export function createConsentSentinelShiftChecklist() {
...
export function createConsentSentinelIncidentDeck() {
