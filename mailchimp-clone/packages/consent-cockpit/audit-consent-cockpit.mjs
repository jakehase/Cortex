...
export function createConsentCockpitAuditTrail() {
...
export function createConsentCockpitEvidenceManifest() {
...
export function createConsentCockpitReadinessAttestation() {
  const auditTrail = createConsentCockpitAuditTrail();
  return {
