...
export function createConsentCockpitReportCards() {
...
export function createConsentCockpitReviewPackets() {
...
export function summarizeConsentCockpitReporting() {
  const cards = createConsentCockpitReportCards();
  const packets = createConsentCockpitReviewPackets();
  return {
