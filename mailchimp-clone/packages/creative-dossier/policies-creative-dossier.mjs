...
export function createCreativeDossierPolicies(overrides = {}) {
...
export function validateCreativeDossierPolicies(policies = createCreativeDossierPolicies()) {
  const issues = [];
...
export function summarizeCreativeDossierPolicies(policies = createCreativeDossierPolicies()) {
  return {
...
export function createCreativeDossierEscalationDeck(policies = createCreativeDossierPolicies()) {
