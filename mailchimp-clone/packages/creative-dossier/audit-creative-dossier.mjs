...
export function createCreativeDossierAuditTrail() {
...
export function createCreativeDossierEvidenceManifest() {
...
export function createCreativeDossierReadinessAttestation() {
  const auditTrail = createCreativeDossierAuditTrail();
  return {
