...
export function createAttributionIndexAnalyticsTimeline() {
...
export function createAttributionIndexForecastEnvelope() {
...
export function createAttributionIndexExceptionLedger() {
...
export function summarizeAttributionIndexAnalytics() {
  const timeline = createAttributionIndexAnalyticsTimeline();
  const forecast = createAttributionIndexForecastEnvelope();
  return {
