...
export function createCustomerGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCustomerGridWorkspace(workspace = createCustomerGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createCustomerGridNarratives(workspace = createCustomerGridWorkspace()) {
...
export function createCustomerGridCoverageGrid(workspace = createCustomerGridWorkspace()) {
