...
export function createCustomerGridReportCards() {
...
export function createCustomerGridReviewPackets() {
...
export function summarizeCustomerGridReporting() {
  const cards = createCustomerGridReportCards();
  const packets = createCustomerGridReviewPackets();
  return {
