...
export function createAcquisitionCockpitOperationsBoard() {
...
export function createAcquisitionCockpitShiftChecklist() {
...
export function createAcquisitionCockpitIncidentDeck() {
