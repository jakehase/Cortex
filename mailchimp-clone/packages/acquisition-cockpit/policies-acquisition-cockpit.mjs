...
export function createAcquisitionCockpitPolicies(overrides = {}) {
...
export function validateAcquisitionCockpitPolicies(policies = createAcquisitionCockpitPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionCockpitPolicies(policies = createAcquisitionCockpitPolicies()) {
  return {
...
export function createAcquisitionCockpitEscalationDeck(policies = createAcquisitionCockpitPolicies()) {
