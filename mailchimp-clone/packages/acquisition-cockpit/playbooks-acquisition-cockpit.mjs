...
export function createAcquisitionCockpitPlaybooks() {
...
export function createAcquisitionCockpitDecisionDeck() {
...
export function createAcquisitionCockpitEscalationMoments() {
