...
export function createAcquisitionCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionCockpitWorkspace(workspace = createAcquisitionCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionCockpitNarratives(workspace = createAcquisitionCockpitWorkspace()) {
...
export function createAcquisitionCockpitCoverageGrid(workspace = createAcquisitionCockpitWorkspace()) {
