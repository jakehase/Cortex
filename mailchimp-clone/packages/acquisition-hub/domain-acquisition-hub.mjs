const MODULE = {
  ...
  "surfaceTitle": "Hub",
  "routeSegment": "hub",
  "title": "Acquisition Hub",
  "focus": "Acquisition Hub covers new demand creation, source quality, and upstream handoff clarity through centralized operating views and routing.",
...
export function createAcquisitionHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionHubWorkspace(workspace = createAcquisitionHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionHubNarratives(workspace = createAcquisitionHubWorkspace()) {
...
export function createAcquisitionHubCoverageGrid(workspace = createAcquisitionHubWorkspace()) {
