...
export function createAcquisitionHubPolicies(overrides = {}) {
...
export function validateAcquisitionHubPolicies(policies = createAcquisitionHubPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionHubPolicies(policies = createAcquisitionHubPolicies()) {
  return {
...
export function createAcquisitionHubEscalationDeck(policies = createAcquisitionHubPolicies()) {
