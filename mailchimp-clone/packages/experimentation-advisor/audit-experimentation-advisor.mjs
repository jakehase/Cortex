...
export function createExperimentationAdvisorAuditTrail() {
...
export function createExperimentationAdvisorEvidenceManifest() {
...
export function createExperimentationAdvisorReadinessAttestation() {
  const auditTrail = createExperimentationAdvisorAuditTrail();
  return {
