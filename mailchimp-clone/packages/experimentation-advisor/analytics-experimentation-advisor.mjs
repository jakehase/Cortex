...
export function createExperimentationAdvisorAnalyticsTimeline() {
...
export function createExperimentationAdvisorForecastEnvelope() {
...
export function createExperimentationAdvisorExceptionLedger() {
...
export function summarizeExperimentationAdvisorAnalytics() {
  const timeline = createExperimentationAdvisorAnalyticsTimeline();
  const forecast = createExperimentationAdvisorForecastEnvelope();
  return {
