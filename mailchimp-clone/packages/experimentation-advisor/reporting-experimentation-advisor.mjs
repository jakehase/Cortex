...
export function createExperimentationAdvisorReportCards() {
...
export function createExperimentationAdvisorReviewPackets() {
...
export function summarizeExperimentationAdvisorReporting() {
  const cards = createExperimentationAdvisorReportCards();
  const packets = createExperimentationAdvisorReviewPackets();
  return {
