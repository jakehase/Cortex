...
export function createAutomationConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeAutomationConsoleFixtures(fixtures = createAutomationConsoleFixtures()) {
  return {
...
export function createAutomationConsoleDemoInputs() {
  return {
