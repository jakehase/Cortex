...
export function createAutomationConsolePolicies(overrides = {}) {
...
export function validateAutomationConsolePolicies(policies = createAutomationConsolePolicies()) {
  const issues = [];
...
export function summarizeAutomationConsolePolicies(policies = createAutomationConsolePolicies()) {
  return {
...
export function createAutomationConsoleEscalationDeck(policies = createAutomationConsolePolicies()) {
