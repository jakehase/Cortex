...
export function createAutomationConsoleAuditTrail() {
...
export function createAutomationConsoleEvidenceManifest() {
...
export function createAutomationConsoleReadinessAttestation() {
  const auditTrail = createAutomationConsoleAuditTrail();
  return {
