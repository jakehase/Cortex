...
export function createEcommerceWorkbenchPlaybooks() {
...
export function createEcommerceWorkbenchDecisionDeck() {
...
export function createEcommerceWorkbenchEscalationMoments() {
