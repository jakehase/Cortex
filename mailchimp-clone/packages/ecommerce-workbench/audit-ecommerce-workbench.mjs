...
export function createEcommerceWorkbenchAuditTrail() {
...
export function createEcommerceWorkbenchEvidenceManifest() {
...
export function createEcommerceWorkbenchReadinessAttestation() {
  const auditTrail = createEcommerceWorkbenchAuditTrail();
  return {
