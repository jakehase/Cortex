...
export function createEcommerceFoundryOperationsBoard() {
...
export function createEcommerceFoundryShiftChecklist() {
...
export function createEcommerceFoundryIncidentDeck() {
