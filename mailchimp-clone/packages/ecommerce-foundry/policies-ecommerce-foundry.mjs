...
export function createEcommerceFoundryPolicies(overrides = {}) {
...
export function validateEcommerceFoundryPolicies(policies = createEcommerceFoundryPolicies()) {
  const issues = [];
...
export function summarizeEcommerceFoundryPolicies(policies = createEcommerceFoundryPolicies()) {
  return {
...
export function createEcommerceFoundryEscalationDeck(policies = createEcommerceFoundryPolicies()) {
