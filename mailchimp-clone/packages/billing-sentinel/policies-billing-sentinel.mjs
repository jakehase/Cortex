...
export function createBillingSentinelPolicies(overrides = {}) {
...
export function validateBillingSentinelPolicies(policies = createBillingSentinelPolicies()) {
  const issues = [];
...
export function summarizeBillingSentinelPolicies(policies = createBillingSentinelPolicies()) {
  return {
...
export function createBillingSentinelEscalationDeck(policies = createBillingSentinelPolicies()) {
