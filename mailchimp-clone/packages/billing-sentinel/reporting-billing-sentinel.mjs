...
export function createBillingSentinelReportCards() {
...
export function createBillingSentinelReviewPackets() {
...
export function summarizeBillingSentinelReporting() {
  const cards = createBillingSentinelReportCards();
  const packets = createBillingSentinelReviewPackets();
  return {
