...
export function createDeliverabilityAdvisorAuditTrail() {
...
export function createDeliverabilityAdvisorEvidenceManifest() {
...
export function createDeliverabilityAdvisorReadinessAttestation() {
  const auditTrail = createDeliverabilityAdvisorAuditTrail();
  return {
