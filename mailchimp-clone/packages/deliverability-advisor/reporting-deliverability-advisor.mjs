...
export function createDeliverabilityAdvisorReportCards() {
...
export function createDeliverabilityAdvisorReviewPackets() {
...
export function summarizeDeliverabilityAdvisorReporting() {
  const cards = createDeliverabilityAdvisorReportCards();
  const packets = createDeliverabilityAdvisorReviewPackets();
  return {
