...
export function createDeliverabilityAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityAdvisorWorkspace(workspace = createDeliverabilityAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityAdvisorNarratives(workspace = createDeliverabilityAdvisorWorkspace()) {
...
export function createDeliverabilityAdvisorCoverageGrid(workspace = createDeliverabilityAdvisorWorkspace()) {
