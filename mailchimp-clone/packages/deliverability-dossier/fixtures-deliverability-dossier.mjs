...
export function createDeliverabilityDossierFixtures() {
  return {
    accounts: [
...
export function summarizeDeliverabilityDossierFixtures(fixtures = createDeliverabilityDossierFixtures()) {
  return {
...
export function createDeliverabilityDossierDemoInputs() {
  return {
