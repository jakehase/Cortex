...
export function createDeliverabilityDossierAuditTrail() {
...
export function createDeliverabilityDossierEvidenceManifest() {
...
export function createDeliverabilityDossierReadinessAttestation() {
  const auditTrail = createDeliverabilityDossierAuditTrail();
  return {
