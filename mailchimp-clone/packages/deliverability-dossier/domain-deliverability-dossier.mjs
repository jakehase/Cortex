...
export function createDeliverabilityDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityDossierWorkspace(workspace = createDeliverabilityDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityDossierNarratives(workspace = createDeliverabilityDossierWorkspace()) {
...
export function createDeliverabilityDossierCoverageGrid(workspace = createDeliverabilityDossierWorkspace()) {
