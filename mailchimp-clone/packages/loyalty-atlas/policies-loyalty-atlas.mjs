...
export function createLoyaltyAtlasPolicies(overrides = {}) {
...
export function validateLoyaltyAtlasPolicies(policies = createLoyaltyAtlasPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyAtlasPolicies(policies = createLoyaltyAtlasPolicies()) {
  return {
...
export function createLoyaltyAtlasEscalationDeck(policies = createLoyaltyAtlasPolicies()) {
