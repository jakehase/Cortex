...
export function createLoyaltyAtlasReportCards() {
...
export function createLoyaltyAtlasReviewPackets() {
...
export function summarizeLoyaltyAtlasReporting() {
  const cards = createLoyaltyAtlasReportCards();
  const packets = createLoyaltyAtlasReviewPackets();
  return {
