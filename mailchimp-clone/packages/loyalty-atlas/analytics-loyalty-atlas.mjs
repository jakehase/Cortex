...
export function createLoyaltyAtlasAnalyticsTimeline() {
...
export function createLoyaltyAtlasForecastEnvelope() {
...
export function createLoyaltyAtlasExceptionLedger() {
...
export function summarizeLoyaltyAtlasAnalytics() {
  const timeline = createLoyaltyAtlasAnalyticsTimeline();
  const forecast = createLoyaltyAtlasForecastEnvelope();
  return {
