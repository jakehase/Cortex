...
export function createLoyaltyScorecardOperationsBoard() {
...
export function createLoyaltyScorecardShiftChecklist() {
...
export function createLoyaltyScorecardIncidentDeck() {
