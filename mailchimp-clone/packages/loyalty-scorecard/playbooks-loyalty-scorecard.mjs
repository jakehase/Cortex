...
export function createLoyaltyScorecardPlaybooks() {
...
export function createLoyaltyScorecardDecisionDeck() {
...
export function createLoyaltyScorecardEscalationMoments() {
