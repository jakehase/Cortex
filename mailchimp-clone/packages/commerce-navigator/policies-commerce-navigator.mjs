...
export function createCommerceNavigatorPolicies(overrides = {}) {
...
export function validateCommerceNavigatorPolicies(policies = createCommerceNavigatorPolicies()) {
  const issues = [];
...
export function summarizeCommerceNavigatorPolicies(policies = createCommerceNavigatorPolicies()) {
  return {
...
export function createCommerceNavigatorEscalationDeck(policies = createCommerceNavigatorPolicies()) {
