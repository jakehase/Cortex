...
export function createCommerceNavigatorReportCards() {
...
export function createCommerceNavigatorReviewPackets() {
...
export function summarizeCommerceNavigatorReporting() {
  const cards = createCommerceNavigatorReportCards();
  const packets = createCommerceNavigatorReviewPackets();
  return {
