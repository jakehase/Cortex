...
export function createCommercePlannerPolicies(overrides = {}) {
...
export function validateCommercePlannerPolicies(policies = createCommercePlannerPolicies()) {
  const issues = [];
...
export function summarizeCommercePlannerPolicies(policies = createCommercePlannerPolicies()) {
  return {
...
export function createCommercePlannerEscalationDeck(policies = createCommercePlannerPolicies()) {
