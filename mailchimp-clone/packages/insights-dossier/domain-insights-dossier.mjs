...
export function createInsightsDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsDossierWorkspace(workspace = createInsightsDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsDossierNarratives(workspace = createInsightsDossierWorkspace()) {
...
export function createInsightsDossierCoverageGrid(workspace = createInsightsDossierWorkspace()) {
