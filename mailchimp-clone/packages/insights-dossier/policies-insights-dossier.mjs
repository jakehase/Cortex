...
export function createInsightsDossierPolicies(overrides = {}) {
...
export function validateInsightsDossierPolicies(policies = createInsightsDossierPolicies()) {
  const issues = [];
...
export function summarizeInsightsDossierPolicies(policies = createInsightsDossierPolicies()) {
  return {
...
export function createInsightsDossierEscalationDeck(policies = createInsightsDossierPolicies()) {
