...
export function createInsightsDossierAuditTrail() {
...
export function createInsightsDossierEvidenceManifest() {
...
export function createInsightsDossierReadinessAttestation() {
  const auditTrail = createInsightsDossierAuditTrail();
  return {
