const MODULE = {
  "id": "activation-sentinel",
  "ordinal": 36,
  "domain": "activation",
  "surfaceId": "sentinel",
  "surfaceTitle": "Sentinel",
  "routeSegment": "sentinel",
  "title": "Activation Sentinel",
  "focus": "Activation Sentinel covers onboarding readiness, first-value motion, and kickoff momentum through alerts, anomaly watch, and guardrails.",
  ...
  "tags": [
    ...
    "sentinel",
    "growth",
    "activation-sentinel-wave-seven"
  ]
};
...
export function createActivationSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationSentinelWorkspace(workspace = createActivationSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationSentinelNarratives(workspace = createActivationSentinelWorkspace()) {
...
export function createActivationSentinelCoverageGrid(workspace = createActivationSentinelWorkspace()) {
