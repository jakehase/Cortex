...
export function createActivationSentinelOperationsBoard() {
...
export function createActivationSentinelShiftChecklist() {
...
export function createActivationSentinelIncidentDeck() {
