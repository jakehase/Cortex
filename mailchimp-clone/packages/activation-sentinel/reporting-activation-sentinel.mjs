...
export function createActivationSentinelReportCards() {
...
export function createActivationSentinelReviewPackets() {
...
export function summarizeActivationSentinelReporting() {
  const cards = createActivationSentinelReportCards();
  const packets = createActivationSentinelReviewPackets();
  return {
