...
export function createActivationSentinelPolicies(overrides = {}) {
...
export function validateActivationSentinelPolicies(policies = createActivationSentinelPolicies()) {
  const issues = [];
...
export function summarizeActivationSentinelPolicies(policies = createActivationSentinelPolicies()) {
  return {
...
export function createActivationSentinelEscalationDeck(policies = createActivationSentinelPolicies()) {
