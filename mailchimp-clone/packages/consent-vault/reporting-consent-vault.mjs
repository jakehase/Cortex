...
export function createConsentVaultReportCards() {
...
export function createConsentVaultReviewPackets() {
...
export function summarizeConsentVaultReporting() {
  const cards = createConsentVaultReportCards();
  const packets = createConsentVaultReviewPackets();
  return {
