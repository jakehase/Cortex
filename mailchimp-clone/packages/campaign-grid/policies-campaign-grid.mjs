...
export function createCampaignGridPolicies(overrides = {}) {
...
export function validateCampaignGridPolicies(policies = createCampaignGridPolicies()) {
  const issues = [];
...
export function summarizeCampaignGridPolicies(policies = createCampaignGridPolicies()) {
  return {
...
export function createCampaignGridEscalationDeck(policies = createCampaignGridPolicies()) {
