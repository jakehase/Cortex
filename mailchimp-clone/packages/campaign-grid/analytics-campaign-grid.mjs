...
export function createCampaignGridAnalyticsTimeline() {
...
export function createCampaignGridForecastEnvelope() {
...
export function createCampaignGridExceptionLedger() {
...
export function summarizeCampaignGridAnalytics() {
  const timeline = createCampaignGridAnalyticsTimeline();
  const forecast = createCampaignGridForecastEnvelope();
  return {
