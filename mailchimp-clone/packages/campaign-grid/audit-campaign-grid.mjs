...
export function createCampaignGridAuditTrail() {
...
export function createCampaignGridEvidenceManifest() {
...
export function createCampaignGridReadinessAttestation() {
  const auditTrail = createCampaignGridAuditTrail();
  return {
