...
export function createComplianceNotebookAuditTrail() {
...
export function createComplianceNotebookEvidenceManifest() {
...
export function createComplianceNotebookReadinessAttestation() {
  const auditTrail = createComplianceNotebookAuditTrail();
  return {
