...
export function createComplianceNotebookAnalyticsTimeline() {
...
export function createComplianceNotebookForecastEnvelope() {
...
export function createComplianceNotebookExceptionLedger() {
...
export function summarizeComplianceNotebookAnalytics() {
  const timeline = createComplianceNotebookAnalyticsTimeline();
  const forecast = createComplianceNotebookForecastEnvelope();
  return {
