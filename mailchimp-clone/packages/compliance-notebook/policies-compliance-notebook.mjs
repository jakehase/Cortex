...
export function createComplianceNotebookPolicies(overrides = {}) {
...
export function validateComplianceNotebookPolicies(policies = createComplianceNotebookPolicies()) {
  const issues = [];
...
export function summarizeComplianceNotebookPolicies(policies = createComplianceNotebookPolicies()) {
  return {
...
export function createComplianceNotebookEscalationDeck(policies = createComplianceNotebookPolicies()) {
