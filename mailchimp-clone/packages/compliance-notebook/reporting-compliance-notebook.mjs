...
export function createComplianceNotebookReportCards() {
...
export function createComplianceNotebookReviewPackets() {
...
export function summarizeComplianceNotebookReporting() {
  const cards = createComplianceNotebookReportCards();
  const packets = createComplianceNotebookReviewPackets();
  return {
