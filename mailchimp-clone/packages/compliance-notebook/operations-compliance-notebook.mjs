...
export function createComplianceNotebookOperationsBoard() {
...
export function createComplianceNotebookShiftChecklist() {
...
export function createComplianceNotebookIncidentDeck() {
