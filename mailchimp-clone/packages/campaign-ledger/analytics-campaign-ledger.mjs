...
export function createCampaignLedgerAnalyticsTimeline() {
...
export function createCampaignLedgerForecastEnvelope() {
...
export function createCampaignLedgerExceptionLedger() {
...
export function summarizeCampaignLedgerAnalytics() {
  const timeline = createCampaignLedgerAnalyticsTimeline();
  const forecast = createCampaignLedgerForecastEnvelope();
  return {
