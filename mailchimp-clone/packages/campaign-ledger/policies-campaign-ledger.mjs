...
export function createCampaignLedgerPolicies(overrides = {}) {
...
export function validateCampaignLedgerPolicies(policies = createCampaignLedgerPolicies()) {
  const issues = [];
...
export function summarizeCampaignLedgerPolicies(policies = createCampaignLedgerPolicies()) {
  return {
...
export function createCampaignLedgerEscalationDeck(policies = createCampaignLedgerPolicies()) {
