...
export function createCampaignLedgerReportCards() {
...
export function createCampaignLedgerReviewPackets() {
...
export function summarizeCampaignLedgerReporting() {
  const cards = createCampaignLedgerReportCards();
  const packets = createCampaignLedgerReviewPackets();
  return {
