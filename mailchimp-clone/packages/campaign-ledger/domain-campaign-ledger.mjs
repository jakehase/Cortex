...
export function createCampaignLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignLedgerWorkspace(workspace = createCampaignLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignLedgerNarratives(workspace = createCampaignLedgerWorkspace()) {
...
export function createCampaignLedgerCoverageGrid(workspace = createCampaignLedgerWorkspace()) {
