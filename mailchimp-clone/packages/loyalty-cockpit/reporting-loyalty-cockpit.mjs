...
export function createLoyaltyCockpitReportCards() {
...
export function createLoyaltyCockpitReviewPackets() {
...
export function summarizeLoyaltyCockpitReporting() {
  const cards = createLoyaltyCockpitReportCards();
  const packets = createLoyaltyCockpitReviewPackets();
  return {
