...
export function createEcommerceSentinelPlaybooks() {
...
export function createEcommerceSentinelDecisionDeck() {
...
export function createEcommerceSentinelEscalationMoments() {
