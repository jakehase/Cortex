...
export function createInsightsIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsIndexWorkspace(workspace = createInsightsIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsIndexNarratives(workspace = createInsightsIndexWorkspace()) {
...
export function createInsightsIndexCoverageGrid(workspace = createInsightsIndexWorkspace()) {
