...
export function createInsightsIndexAnalyticsTimeline() {
...
export function createInsightsIndexForecastEnvelope() {
...
export function createInsightsIndexExceptionLedger() {
...
export function summarizeInsightsIndexAnalytics() {
  const timeline = createInsightsIndexAnalyticsTimeline();
  const forecast = createInsightsIndexForecastEnvelope();
  return {
