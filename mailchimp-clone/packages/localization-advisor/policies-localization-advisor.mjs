...
export function createLocalizationAdvisorPolicies(overrides = {}) {
...
export function validateLocalizationAdvisorPolicies(policies = createLocalizationAdvisorPolicies()) {
  const issues = [];
...
export function summarizeLocalizationAdvisorPolicies(policies = createLocalizationAdvisorPolicies()) {
  return {
...
export function createLocalizationAdvisorEscalationDeck(policies = createLocalizationAdvisorPolicies()) {
