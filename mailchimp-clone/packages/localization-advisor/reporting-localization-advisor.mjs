...
export function createLocalizationAdvisorReportCards() {
...
export function createLocalizationAdvisorReviewPackets() {
...
export function summarizeLocalizationAdvisorReporting() {
  const cards = createLocalizationAdvisorReportCards();
  const packets = createLocalizationAdvisorReviewPackets();
  return {
