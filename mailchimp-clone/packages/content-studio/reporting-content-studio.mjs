...
export function createContentStudioReportCards() {
...
export function createContentStudioReviewPackets() {
...
export function summarizeContentStudioReporting() {
  const cards = createContentStudioReportCards();
  const packets = createContentStudioReviewPackets();
  return {
