...
export function createAttributionWatchtowerOperationsBoard() {
...
export function createAttributionWatchtowerShiftChecklist() {
...
export function createAttributionWatchtowerIncidentDeck() {
