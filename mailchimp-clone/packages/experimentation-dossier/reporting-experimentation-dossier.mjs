...
export function createExperimentationDossierReportCards() {
...
export function createExperimentationDossierReviewPackets() {
...
export function summarizeExperimentationDossierReporting() {
  const cards = createExperimentationDossierReportCards();
  const packets = createExperimentationDossierReviewPackets();
  return {
