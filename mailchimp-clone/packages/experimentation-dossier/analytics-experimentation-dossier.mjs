...
export function createExperimentationDossierAnalyticsTimeline() {
...
export function createExperimentationDossierForecastEnvelope() {
...
export function createExperimentationDossierExceptionLedger() {
...
export function summarizeExperimentationDossierAnalytics() {
  const timeline = createExperimentationDossierAnalyticsTimeline();
  const forecast = createExperimentationDossierForecastEnvelope();
  return {
