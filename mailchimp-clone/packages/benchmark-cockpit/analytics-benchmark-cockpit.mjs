...
export function createBenchmarkCockpitAnalyticsTimeline() {
...
export function createBenchmarkCockpitForecastEnvelope() {
...
export function createBenchmarkCockpitExceptionLedger() {
...
export function summarizeBenchmarkCockpitAnalytics() {
  const timeline = createBenchmarkCockpitAnalyticsTimeline();
  const forecast = createBenchmarkCockpitForecastEnvelope();
  return {
