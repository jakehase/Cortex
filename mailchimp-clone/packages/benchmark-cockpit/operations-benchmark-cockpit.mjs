...
export function createBenchmarkCockpitOperationsBoard() {
...
export function createBenchmarkCockpitShiftChecklist() {
...
export function createBenchmarkCockpitIncidentDeck() {
