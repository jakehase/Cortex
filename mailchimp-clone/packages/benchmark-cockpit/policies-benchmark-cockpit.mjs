...
export function createBenchmarkCockpitPolicies(overrides = {}) {
...
export function validateBenchmarkCockpitPolicies(policies = createBenchmarkCockpitPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkCockpitPolicies(policies = createBenchmarkCockpitPolicies()) {
  return {
...
export function createBenchmarkCockpitEscalationDeck(policies = createBenchmarkCockpitPolicies()) {
