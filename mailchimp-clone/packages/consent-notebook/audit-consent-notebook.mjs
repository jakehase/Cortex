...
export function createConsentNotebookAuditTrail() {
...
export function createConsentNotebookEvidenceManifest() {
...
export function createConsentNotebookReadinessAttestation() {
  const auditTrail = createConsentNotebookAuditTrail();
  return {
