...
export function createConsentNotebookPolicies(overrides = {}) {
...
export function validateConsentNotebookPolicies(policies = createConsentNotebookPolicies()) {
  const issues = [];
...
export function summarizeConsentNotebookPolicies(policies = createConsentNotebookPolicies()) {
  return {
...
export function createConsentNotebookEscalationDeck(policies = createConsentNotebookPolicies()) {
