...
export function createAutomationWatchtowerAnalyticsTimeline() {
...
export function createAutomationWatchtowerForecastEnvelope() {
...
export function createAutomationWatchtowerExceptionLedger() {
...
export function summarizeAutomationWatchtowerAnalytics() {
  const timeline = createAutomationWatchtowerAnalyticsTimeline();
  const forecast = createAutomationWatchtowerForecastEnvelope();
  return {
