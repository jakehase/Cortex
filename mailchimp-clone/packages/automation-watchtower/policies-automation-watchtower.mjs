...
export function createAutomationWatchtowerPolicies(overrides = {}) {
...
export function validateAutomationWatchtowerPolicies(policies = createAutomationWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeAutomationWatchtowerPolicies(policies = createAutomationWatchtowerPolicies()) {
  return {
...
export function createAutomationWatchtowerEscalationDeck(policies = createAutomationWatchtowerPolicies()) {
