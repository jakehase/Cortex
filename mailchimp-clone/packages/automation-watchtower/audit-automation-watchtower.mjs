...
export function createAutomationWatchtowerAuditTrail() {
...
export function createAutomationWatchtowerEvidenceManifest() {
...
export function createAutomationWatchtowerReadinessAttestation() {
  const auditTrail = createAutomationWatchtowerAuditTrail();
  return {
