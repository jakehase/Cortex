...
export function createDataWorkbenchAnalyticsTimeline() {
...
export function createDataWorkbenchForecastEnvelope() {
...
export function createDataWorkbenchExceptionLedger() {
...
export function summarizeDataWorkbenchAnalytics() {
  const timeline = createDataWorkbenchAnalyticsTimeline();
  const forecast = createDataWorkbenchForecastEnvelope();
  return {
