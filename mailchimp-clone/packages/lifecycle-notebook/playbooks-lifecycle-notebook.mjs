...
export function createLifecycleNotebookPlaybooks() {
...
export function createLifecycleNotebookDecisionDeck() {
...
export function createLifecycleNotebookEscalationMoments() {
