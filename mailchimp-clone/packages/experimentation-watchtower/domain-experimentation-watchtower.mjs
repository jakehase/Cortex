const MODULE = {
  "id": "experimentation-watchtower",
  "ordinal": 437,
  "domain": "experimentation",
  "surfaceId": "watchtower",
  "surfaceTitle": "Watchtower",
  "routeSegment": "watchtower",
  "title": "Experimentation Watchtower",
  "focus": "Experimentation Watchtower covers test planning, variant analysis, and decision velocity through oversight dashboards and escalation views.",
  ...
  "tags": [
    ...
    "watchtower",
    "intelligence",
    "experimentation-watchtower-wave-seven"
  ]
};
...
export function createExperimentationWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationWatchtowerWorkspace(workspace = createExperimentationWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationWatchtowerNarratives(workspace = createExperimentationWatchtowerWorkspace()) {
...
export function createExperimentationWatchtowerCoverageGrid(workspace = createExperimentationWatchtowerWorkspace()) {
