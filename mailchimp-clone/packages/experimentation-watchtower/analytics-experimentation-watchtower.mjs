...
export function createExperimentationWatchtowerAnalyticsTimeline() {
...
export function createExperimentationWatchtowerForecastEnvelope() {
...
export function createExperimentationWatchtowerExceptionLedger() {
...
export function summarizeExperimentationWatchtowerAnalytics() {
  const timeline = createExperimentationWatchtowerAnalyticsTimeline();
  const forecast = createExperimentationWatchtowerForecastEnvelope();
  return {
