...
export function createExperimentationNavigatorReportCards() {
...
export function createExperimentationNavigatorReviewPackets() {
...
export function summarizeExperimentationNavigatorReporting() {
  const cards = createExperimentationNavigatorReportCards();
  const packets = createExperimentationNavigatorReviewPackets();
  return {
