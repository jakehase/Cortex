...
export function createExperimentationNavigatorAuditTrail() {
...
export function createExperimentationNavigatorEvidenceManifest() {
...
export function createExperimentationNavigatorReadinessAttestation() {
  const auditTrail = createExperimentationNavigatorAuditTrail();
  return {
