const MODULE = {
  "id": "experimentation-navigator",
  "ordinal": 430,
  "domain": "experimentation",
  "surfaceId": "navigator",
  "surfaceTitle": "Navigator",
  "routeSegment": "navigator",
  "title": "Experimentation Navigator",
  "focus": "Experimentation Navigator covers test planning, variant analysis, and decision velocity through journey guidance and directional controls.",
  ...
  "tags": [
    ...
    "navigator",
    "intelligence",
    "experimentation-navigator-wave-seven"
  ]
};
...
export function createExperimentationNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationNavigatorWorkspace(workspace = createExperimentationNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationNavigatorNarratives(workspace = createExperimentationNavigatorWorkspace()) {
...
export function createExperimentationNavigatorCoverageGrid(workspace = createExperimentationNavigatorWorkspace()) {
