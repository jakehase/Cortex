...
export function createAdvocacyNotebookAuditTrail() {
...
export function createAdvocacyNotebookEvidenceManifest() {
...
export function createAdvocacyNotebookReadinessAttestation() {
  const auditTrail = createAdvocacyNotebookAuditTrail();
  return {
