...
export function createConsentNavigatorOperationsBoard() {
...
export function createConsentNavigatorShiftChecklist() {
...
export function createConsentNavigatorIncidentDeck() {
