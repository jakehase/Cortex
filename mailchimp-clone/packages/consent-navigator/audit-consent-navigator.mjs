...
export function createConsentNavigatorAuditTrail() {
...
export function createConsentNavigatorEvidenceManifest() {
...
export function createConsentNavigatorReadinessAttestation() {
  const auditTrail = createConsentNavigatorAuditTrail();
  return {
