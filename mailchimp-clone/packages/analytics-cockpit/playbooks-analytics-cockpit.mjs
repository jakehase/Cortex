...
export function createAnalyticsCockpitPlaybooks() {
...
export function createAnalyticsCockpitDecisionDeck() {
...
export function createAnalyticsCockpitEscalationMoments() {
