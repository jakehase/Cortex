...
export function createBillingStudioReportCards() {
...
export function createBillingStudioReviewPackets() {
...
export function summarizeBillingStudioReporting() {
  const cards = createBillingStudioReportCards();
  const packets = createBillingStudioReviewPackets();
  return {
