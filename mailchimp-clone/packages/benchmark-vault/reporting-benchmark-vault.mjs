...
export function createBenchmarkVaultReportCards() {
...
export function createBenchmarkVaultReviewPackets() {
...
export function summarizeBenchmarkVaultReporting() {
  const cards = createBenchmarkVaultReportCards();
  const packets = createBenchmarkVaultReviewPackets();
  return {
