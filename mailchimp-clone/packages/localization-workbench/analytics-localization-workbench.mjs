...
export function createLocalizationWorkbenchAnalyticsTimeline() {
...
export function createLocalizationWorkbenchForecastEnvelope() {
...
export function createLocalizationWorkbenchExceptionLedger() {
...
export function summarizeLocalizationWorkbenchAnalytics() {
  const timeline = createLocalizationWorkbenchAnalyticsTimeline();
  const forecast = createLocalizationWorkbenchForecastEnvelope();
  return {
