...
export function createLocalizationWorkbenchAuditTrail() {
...
export function createLocalizationWorkbenchEvidenceManifest() {
...
export function createLocalizationWorkbenchReadinessAttestation() {
  const auditTrail = createLocalizationWorkbenchAuditTrail();
  return {
