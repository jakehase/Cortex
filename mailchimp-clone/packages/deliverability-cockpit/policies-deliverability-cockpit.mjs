...
export function createDeliverabilityCockpitPolicies(overrides = {}) {
...
export function validateDeliverabilityCockpitPolicies(policies = createDeliverabilityCockpitPolicies()) {
  const issues = [];
...
export function summarizeDeliverabilityCockpitPolicies(policies = createDeliverabilityCockpitPolicies()) {
  return {
...
export function createDeliverabilityCockpitEscalationDeck(policies = createDeliverabilityCockpitPolicies()) {
