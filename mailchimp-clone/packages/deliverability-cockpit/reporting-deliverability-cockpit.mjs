...
export function createDeliverabilityCockpitReportCards() {
...
export function createDeliverabilityCockpitReviewPackets() {
...
export function summarizeDeliverabilityCockpitReporting() {
  const cards = createDeliverabilityCockpitReportCards();
  const packets = createDeliverabilityCockpitReviewPackets();
  return {
