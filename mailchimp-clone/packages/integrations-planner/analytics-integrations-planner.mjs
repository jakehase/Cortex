...
export function createIntegrationsPlannerAnalyticsTimeline() {
...
export function createIntegrationsPlannerForecastEnvelope() {
...
export function createIntegrationsPlannerExceptionLedger() {
...
export function summarizeIntegrationsPlannerAnalytics() {
  const timeline = createIntegrationsPlannerAnalyticsTimeline();
  const forecast = createIntegrationsPlannerForecastEnvelope();
  return {
