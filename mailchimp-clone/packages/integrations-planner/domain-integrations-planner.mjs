...
export function createIntegrationsPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsPlannerWorkspace(workspace = createIntegrationsPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsPlannerNarratives(workspace = createIntegrationsPlannerWorkspace()) {
...
export function createIntegrationsPlannerCoverageGrid(workspace = createIntegrationsPlannerWorkspace()) {
