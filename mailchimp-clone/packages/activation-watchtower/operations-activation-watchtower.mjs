...
export function createActivationWatchtowerOperationsBoard() {
...
export function createActivationWatchtowerShiftChecklist() {
...
export function createActivationWatchtowerIncidentDeck() {
