...
export function createActivationWatchtowerReportCards() {
...
export function createActivationWatchtowerReviewPackets() {
...
export function summarizeActivationWatchtowerReporting() {
  const cards = createActivationWatchtowerReportCards();
  const packets = createActivationWatchtowerReviewPackets();
  return {
