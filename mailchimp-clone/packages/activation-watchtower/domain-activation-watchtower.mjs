const MODULE = {
  "id": "activation-watchtower",
  "ordinal": 39,
  "domain": "activation",
  "surfaceId": "watchtower",
  "surfaceTitle": "Watchtower",
  "routeSegment": "watchtower",
  "title": "Activation Watchtower",
  "focus": "Activation Watchtower covers onboarding readiness, first-value motion, and kickoff momentum through oversight dashboards and escalation views.",
  ...
  "tags": [
    ...
    "watchtower",
    "growth",
    "activation-watchtower-wave-seven"
  ]
};
...
export function createActivationWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationWatchtowerWorkspace(workspace = createActivationWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationWatchtowerNarratives(workspace = createActivationWatchtowerWorkspace()) {
...
export function createActivationWatchtowerCoverageGrid(workspace = createActivationWatchtowerWorkspace()) {
