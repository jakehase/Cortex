...
export function createActivationWatchtowerAuditTrail() {
...
export function createActivationWatchtowerEvidenceManifest() {
...
export function createActivationWatchtowerReadinessAttestation() {
  const auditTrail = createActivationWatchtowerAuditTrail();
  return {
