...
export function createActivationWatchtowerPlaybooks() {
...
export function createActivationWatchtowerDecisionDeck() {
...
export function createActivationWatchtowerEscalationMoments() {
