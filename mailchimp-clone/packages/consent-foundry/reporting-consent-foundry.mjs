...
export function createConsentFoundryReportCards() {
...
export function createConsentFoundryReviewPackets() {
...
export function summarizeConsentFoundryReporting() {
  const cards = createConsentFoundryReportCards();
  const packets = createConsentFoundryReviewPackets();
  return {
