...
export function createComplianceScorecardPlaybooks() {
...
export function createComplianceScorecardDecisionDeck() {
...
export function createComplianceScorecardEscalationMoments() {
