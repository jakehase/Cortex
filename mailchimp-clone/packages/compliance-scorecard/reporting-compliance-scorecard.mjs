...
export function createComplianceScorecardReportCards() {
...
export function createComplianceScorecardReviewPackets() {
...
export function summarizeComplianceScorecardReporting() {
  const cards = createComplianceScorecardReportCards();
  const packets = createComplianceScorecardReviewPackets();
  return {
