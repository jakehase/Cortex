...
export function createAcquisitionDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionDossierWorkspace(workspace = createAcquisitionDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionDossierNarratives(workspace = createAcquisitionDossierWorkspace()) {
...
export function createAcquisitionDossierCoverageGrid(workspace = createAcquisitionDossierWorkspace()) {
