...
export function createAcquisitionDossierPlaybooks() {
...
export function createAcquisitionDossierDecisionDeck() {
...
export function createAcquisitionDossierEscalationMoments() {
