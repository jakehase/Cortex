...
export function createExperimentationLedgerAuditTrail() {
...
export function createExperimentationLedgerEvidenceManifest() {
...
export function createExperimentationLedgerReadinessAttestation() {
  const auditTrail = createExperimentationLedgerAuditTrail();
  return {
