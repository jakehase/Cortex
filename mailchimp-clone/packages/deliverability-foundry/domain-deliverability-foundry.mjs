const MODULE = {
  "id": "deliverability-foundry",
  "ordinal": 385,
  "domain": "deliverability",
  "surfaceId": "foundry",
  "surfaceTitle": "Foundry",
  "routeSegment": "foundry",
  "title": "Deliverability Foundry",
  "focus": "Deliverability Foundry covers sender health, inbox placement, and response discipline through program building and surface composition.",
  ...
  "tags": [
    ...
    "foundry",
    "lifecycle",
    "deliverability-foundry-wave-seven"
  ]
};
...
export function createDeliverabilityFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityFoundryWorkspace(workspace = createDeliverabilityFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityFoundryNarratives(workspace = createDeliverabilityFoundryWorkspace()) {
...
export function createDeliverabilityFoundryCoverageGrid(workspace = createDeliverabilityFoundryWorkspace()) {
