...
export function createDeliverabilityFoundryReportCards() {
...
export function createDeliverabilityFoundryReviewPackets() {
...
export function summarizeDeliverabilityFoundryReporting() {
  const cards = createDeliverabilityFoundryReportCards();
  const packets = createDeliverabilityFoundryReviewPackets();
  return {
