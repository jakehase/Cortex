...
export function createBenchmarkConsoleAuditTrail() {
...
export function createBenchmarkConsoleEvidenceManifest() {
...
export function createBenchmarkConsoleReadinessAttestation() {
  const auditTrail = createBenchmarkConsoleAuditTrail();
  return {
