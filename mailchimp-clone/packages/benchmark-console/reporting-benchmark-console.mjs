...
export function createBenchmarkConsoleReportCards() {
...
export function createBenchmarkConsoleReviewPackets() {
...
export function summarizeBenchmarkConsoleReporting() {
  const cards = createBenchmarkConsoleReportCards();
  const packets = createBenchmarkConsoleReviewPackets();
  return {
