...
export function createAcquisitionAdvisorAuditTrail() {
...
export function createAcquisitionAdvisorEvidenceManifest() {
...
export function createAcquisitionAdvisorReadinessAttestation() {
  const auditTrail = createAcquisitionAdvisorAuditTrail();
  return {
