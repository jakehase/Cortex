...
export function createAcquisitionAdvisorReportCards() {
...
export function createAcquisitionAdvisorReviewPackets() {
...
export function summarizeAcquisitionAdvisorReporting() {
  const cards = createAcquisitionAdvisorReportCards();
  const packets = createAcquisitionAdvisorReviewPackets();
  return {
