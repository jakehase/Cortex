...
export function createLoyaltyNotebookAnalyticsTimeline() {
...
export function createLoyaltyNotebookForecastEnvelope() {
...
export function createLoyaltyNotebookExceptionLedger() {
...
export function summarizeLoyaltyNotebookAnalytics() {
  const timeline = createLoyaltyNotebookAnalyticsTimeline();
  const forecast = createLoyaltyNotebookForecastEnvelope();
  return {
