...
export function createLoyaltyNotebookReportCards() {
...
export function createLoyaltyNotebookReviewPackets() {
...
export function summarizeLoyaltyNotebookReporting() {
  const cards = createLoyaltyNotebookReportCards();
  const packets = createLoyaltyNotebookReviewPackets();
  return {
