...
export function createLoyaltyNotebookPolicies(overrides = {}) {
...
export function validateLoyaltyNotebookPolicies(policies = createLoyaltyNotebookPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyNotebookPolicies(policies = createLoyaltyNotebookPolicies()) {
  return {
...
export function createLoyaltyNotebookEscalationDeck(policies = createLoyaltyNotebookPolicies()) {
