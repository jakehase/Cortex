...
export function createLoyaltyNotebookAuditTrail() {
...
export function createLoyaltyNotebookEvidenceManifest() {
...
export function createLoyaltyNotebookReadinessAttestation() {
  const auditTrail = createLoyaltyNotebookAuditTrail();
  return {
