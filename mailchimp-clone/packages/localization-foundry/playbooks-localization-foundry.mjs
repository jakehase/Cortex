...
export function createLocalizationFoundryPlaybooks() {
...
export function createLocalizationFoundryDecisionDeck() {
...
export function createLocalizationFoundryEscalationMoments() {
