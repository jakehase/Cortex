...
export function createLocalizationFoundryOperationsBoard() {
...
export function createLocalizationFoundryShiftChecklist() {
...
export function createLocalizationFoundryIncidentDeck() {
