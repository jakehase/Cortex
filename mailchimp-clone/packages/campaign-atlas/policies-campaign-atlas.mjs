...
export function createCampaignAtlasPolicies(overrides = {}) {
...
export function validateCampaignAtlasPolicies(policies = createCampaignAtlasPolicies()) {
  const issues = [];
...
export function summarizeCampaignAtlasPolicies(policies = createCampaignAtlasPolicies()) {
  return {
...
export function createCampaignAtlasEscalationDeck(policies = createCampaignAtlasPolicies()) {
