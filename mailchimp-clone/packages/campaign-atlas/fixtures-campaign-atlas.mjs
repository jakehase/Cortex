...
export function createCampaignAtlasFixtures() {
  return {
    accounts: [
...
export function summarizeCampaignAtlasFixtures(fixtures = createCampaignAtlasFixtures()) {
  return {
...
export function createCampaignAtlasDemoInputs() {
  return {
