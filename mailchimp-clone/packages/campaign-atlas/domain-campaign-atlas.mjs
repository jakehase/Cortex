...
export function createCampaignAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignAtlasWorkspace(workspace = createCampaignAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignAtlasNarratives(workspace = createCampaignAtlasWorkspace()) {
...
export function createCampaignAtlasCoverageGrid(workspace = createCampaignAtlasWorkspace()) {
