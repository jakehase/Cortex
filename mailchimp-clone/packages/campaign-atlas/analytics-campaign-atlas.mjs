...
export function createCampaignAtlasAnalyticsTimeline() {
...
export function createCampaignAtlasForecastEnvelope() {
...
export function createCampaignAtlasExceptionLedger() {
...
export function summarizeCampaignAtlasAnalytics() {
  const timeline = createCampaignAtlasAnalyticsTimeline();
  const forecast = createCampaignAtlasForecastEnvelope();
  return {
