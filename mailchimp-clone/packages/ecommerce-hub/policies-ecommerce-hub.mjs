...
export function createEcommerceHubPolicies(overrides = {}) {
...
export function validateEcommerceHubPolicies(policies = createEcommerceHubPolicies()) {
  const issues = [];
...
export function summarizeEcommerceHubPolicies(policies = createEcommerceHubPolicies()) {
  return {
...
export function createEcommerceHubEscalationDeck(policies = createEcommerceHubPolicies()) {
