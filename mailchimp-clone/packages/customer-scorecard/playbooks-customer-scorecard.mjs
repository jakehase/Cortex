...
export function createCustomerScorecardPlaybooks() {
...
export function createCustomerScorecardDecisionDeck() {
...
export function createCustomerScorecardEscalationMoments() {
