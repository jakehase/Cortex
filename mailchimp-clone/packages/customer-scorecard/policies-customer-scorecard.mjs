...
export function createCustomerScorecardPolicies(overrides = {}) {
...
export function validateCustomerScorecardPolicies(policies = createCustomerScorecardPolicies()) {
  const issues = [];
...
export function summarizeCustomerScorecardPolicies(policies = createCustomerScorecardPolicies()) {
  return {
...
export function createCustomerScorecardEscalationDeck(policies = createCustomerScorecardPolicies()) {
