...
export function createCommerceHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCommerceHubWorkspace(workspace = createCommerceHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createCommerceHubNarratives(workspace = createCommerceHubWorkspace()) {
...
export function createCommerceHubCoverageGrid(workspace = createCommerceHubWorkspace()) {
