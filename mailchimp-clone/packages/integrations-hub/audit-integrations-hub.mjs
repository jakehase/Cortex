...
export function createIntegrationsHubAuditTrail() {
...
export function createIntegrationsHubEvidenceManifest() {
...
export function createIntegrationsHubReadinessAttestation() {
  const auditTrail = createIntegrationsHubAuditTrail();
  return {
