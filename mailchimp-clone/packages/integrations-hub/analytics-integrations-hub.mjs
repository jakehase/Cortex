...
export function createIntegrationsHubAnalyticsTimeline() {
...
export function createIntegrationsHubForecastEnvelope() {
...
export function createIntegrationsHubExceptionLedger() {
...
export function summarizeIntegrationsHubAnalytics() {
  const timeline = createIntegrationsHubAnalyticsTimeline();
  const forecast = createIntegrationsHubForecastEnvelope();
  return {
