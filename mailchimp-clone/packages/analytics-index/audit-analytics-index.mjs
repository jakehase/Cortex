...
export function createAnalyticsIndexAuditTrail() {
...
export function createAnalyticsIndexEvidenceManifest() {
...
export function createAnalyticsIndexReadinessAttestation() {
  const auditTrail = createAnalyticsIndexAuditTrail();
  return {
