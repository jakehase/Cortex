...
export function createAnalyticsIndexPolicies(overrides = {}) {
...
export function validateAnalyticsIndexPolicies(policies = createAnalyticsIndexPolicies()) {
  const issues = [];
...
export function summarizeAnalyticsIndexPolicies(policies = createAnalyticsIndexPolicies()) {
  return {
...
export function createAnalyticsIndexEscalationDeck(policies = createAnalyticsIndexPolicies()) {
