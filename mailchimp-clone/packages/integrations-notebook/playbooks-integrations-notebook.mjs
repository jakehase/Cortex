...
export function createIntegrationsNotebookPlaybooks() {
...
export function createIntegrationsNotebookDecisionDeck() {
...
export function createIntegrationsNotebookEscalationMoments() {
