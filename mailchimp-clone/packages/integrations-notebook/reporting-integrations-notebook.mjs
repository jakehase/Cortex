...
export function createIntegrationsNotebookReportCards() {
...
export function createIntegrationsNotebookReviewPackets() {
...
export function summarizeIntegrationsNotebookReporting() {
  const cards = createIntegrationsNotebookReportCards();
  const packets = createIntegrationsNotebookReviewPackets();
  return {
