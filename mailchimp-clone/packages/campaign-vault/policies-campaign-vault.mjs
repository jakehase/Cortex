...
export function createCampaignVaultPolicies(overrides = {}) {
...
export function validateCampaignVaultPolicies(policies = createCampaignVaultPolicies()) {
  const issues = [];
...
export function summarizeCampaignVaultPolicies(policies = createCampaignVaultPolicies()) {
  return {
...
export function createCampaignVaultEscalationDeck(policies = createCampaignVaultPolicies()) {
