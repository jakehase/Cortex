...
export function createLifecycleScorecardPlaybooks() {
...
export function createLifecycleScorecardDecisionDeck() {
...
export function createLifecycleScorecardEscalationMoments() {
