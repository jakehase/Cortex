...
export function createLifecycleScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleScorecardWorkspace(workspace = createLifecycleScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleScorecardNarratives(workspace = createLifecycleScorecardWorkspace()) {
...
export function createLifecycleScorecardCoverageGrid(workspace = createLifecycleScorecardWorkspace()) {
