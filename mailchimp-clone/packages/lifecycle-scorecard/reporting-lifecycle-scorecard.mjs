...
export function createLifecycleScorecardReportCards() {
...
export function createLifecycleScorecardReviewPackets() {
...
export function summarizeLifecycleScorecardReporting() {
  const cards = createLifecycleScorecardReportCards();
  const packets = createLifecycleScorecardReviewPackets();
  return {
