...
export function createLifecycleScorecardPolicies(overrides = {}) {
...
export function validateLifecycleScorecardPolicies(policies = createLifecycleScorecardPolicies()) {
  const issues = [];
...
export function summarizeLifecycleScorecardPolicies(policies = createLifecycleScorecardPolicies()) {
  return {
...
export function createLifecycleScorecardEscalationDeck(policies = createLifecycleScorecardPolicies()) {
