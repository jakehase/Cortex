...
export function createIntegrationsWorkbenchReportCards() {
...
export function createIntegrationsWorkbenchReviewPackets() {
...
export function summarizeIntegrationsWorkbenchReporting() {
  const cards = createIntegrationsWorkbenchReportCards();
  const packets = createIntegrationsWorkbenchReviewPackets();
  return {
