...
export function createIntegrationsWorkbenchAuditTrail() {
...
export function createIntegrationsWorkbenchEvidenceManifest() {
...
export function createIntegrationsWorkbenchReadinessAttestation() {
  const auditTrail = createIntegrationsWorkbenchAuditTrail();
  return {
