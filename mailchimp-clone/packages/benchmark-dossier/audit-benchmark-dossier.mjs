...
export function createBenchmarkDossierAuditTrail() {
...
export function createBenchmarkDossierEvidenceManifest() {
...
export function createBenchmarkDossierReadinessAttestation() {
  const auditTrail = createBenchmarkDossierAuditTrail();
  return {
