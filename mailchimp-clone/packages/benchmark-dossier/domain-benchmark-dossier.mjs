...
export function createBenchmarkDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBenchmarkDossierWorkspace(workspace = createBenchmarkDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createBenchmarkDossierNarratives(workspace = createBenchmarkDossierWorkspace()) {
...
export function createBenchmarkDossierCoverageGrid(workspace = createBenchmarkDossierWorkspace()) {
