...
export function createBenchmarkDossierPolicies(overrides = {}) {
...
export function validateBenchmarkDossierPolicies(policies = createBenchmarkDossierPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkDossierPolicies(policies = createBenchmarkDossierPolicies()) {
  return {
...
export function createBenchmarkDossierEscalationDeck(policies = createBenchmarkDossierPolicies()) {
