...
export function createDeliverabilityGridAuditTrail() {
...
export function createDeliverabilityGridEvidenceManifest() {
...
export function createDeliverabilityGridReadinessAttestation() {
  const auditTrail = createDeliverabilityGridAuditTrail();
  return {
