...
export function createConsentExchangeReportCards() {
...
export function createConsentExchangeReviewPackets() {
...
export function summarizeConsentExchangeReporting() {
  const cards = createConsentExchangeReportCards();
  const packets = createConsentExchangeReviewPackets();
  return {
