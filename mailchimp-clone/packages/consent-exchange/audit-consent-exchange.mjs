...
export function createConsentExchangeAuditTrail() {
...
export function createConsentExchangeEvidenceManifest() {
...
export function createConsentExchangeReadinessAttestation() {
  const auditTrail = createConsentExchangeAuditTrail();
  return {
