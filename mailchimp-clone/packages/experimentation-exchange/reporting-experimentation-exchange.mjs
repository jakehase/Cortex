...
export function createExperimentationExchangeReportCards() {
...
export function createExperimentationExchangeReviewPackets() {
...
export function summarizeExperimentationExchangeReporting() {
  const cards = createExperimentationExchangeReportCards();
  const packets = createExperimentationExchangeReviewPackets();
  return {
