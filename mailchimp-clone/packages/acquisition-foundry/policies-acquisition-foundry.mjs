...
export function createAcquisitionFoundryPolicies(overrides = {}) {
...
export function validateAcquisitionFoundryPolicies(policies = createAcquisitionFoundryPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionFoundryPolicies(policies = createAcquisitionFoundryPolicies()) {
  return {
...
export function createAcquisitionFoundryEscalationDeck(policies = createAcquisitionFoundryPolicies()) {
