const MODULE = {
  "id": "acquisition-foundry",
  "ordinal": 7,
  "domain": "acquisition",
  "surfaceId": "foundry",
  "surfaceTitle": "Foundry",
  "routeSegment": "foundry",
  "title": "Acquisition Foundry",
  "focus": "Acquisition Foundry covers new demand creation, source quality, and upstream handoff clarity through program building and surface composition.",
  ...
  "tags": [
    ...
    "foundry",
    "growth",
    "acquisition-foundry-wave-seven"
  ]
};
...
export function createAcquisitionFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionFoundryWorkspace(workspace = createAcquisitionFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionFoundryNarratives(workspace = createAcquisitionFoundryWorkspace()) {
...
export function createAcquisitionFoundryCoverageGrid(workspace = createAcquisitionFoundryWorkspace()) {
