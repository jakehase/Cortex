...
export function createAcquisitionFoundryReportCards() {
...
export function createAcquisitionFoundryReviewPackets() {
...
export function summarizeAcquisitionFoundryReporting() {
  const cards = createAcquisitionFoundryReportCards();
  const packets = createAcquisitionFoundryReviewPackets();
  return {
