...
export function createContentScorecardReportCards() {
...
export function createContentScorecardReviewPackets() {
...
export function summarizeContentScorecardReporting() {
  const cards = createContentScorecardReportCards();
  const packets = createContentScorecardReviewPackets();
  return {
