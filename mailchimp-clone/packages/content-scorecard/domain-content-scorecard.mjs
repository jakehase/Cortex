const MODULE = {
  ...
  "focus": "Content Scorecard covers content operations, packaging, and channel-specific delivery shape through metric tracking and readiness scoring.",
...
export function createContentScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentScorecardWorkspace(workspace = createContentScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentScorecardNarratives(workspace = createContentScorecardWorkspace()) {
...
export function createContentScorecardCoverageGrid(workspace = createContentScorecardWorkspace()) {
