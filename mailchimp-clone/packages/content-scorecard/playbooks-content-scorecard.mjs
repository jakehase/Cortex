...
export function createContentScorecardPlaybooks() {
...
export function createContentScorecardDecisionDeck() {
...
export function createContentScorecardEscalationMoments() {
