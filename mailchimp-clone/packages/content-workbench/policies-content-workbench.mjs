...
export function createContentWorkbenchPolicies(overrides = {}) {
...
export function validateContentWorkbenchPolicies(policies = createContentWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeContentWorkbenchPolicies(policies = createContentWorkbenchPolicies()) {
  return {
...
export function createContentWorkbenchEscalationDeck(policies = createContentWorkbenchPolicies()) {
