...
export function createContentWorkbenchAuditTrail() {
...
export function createContentWorkbenchEvidenceManifest() {
...
export function createContentWorkbenchReadinessAttestation() {
  const auditTrail = createContentWorkbenchAuditTrail();
  return {
