...
export function createContentWorkbenchOperationsBoard() {
...
export function createContentWorkbenchShiftChecklist() {
...
export function createContentWorkbenchIncidentDeck() {
