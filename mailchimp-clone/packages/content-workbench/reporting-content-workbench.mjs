...
export function createContentWorkbenchReportCards() {
...
export function createContentWorkbenchReviewPackets() {
...
export function summarizeContentWorkbenchReporting() {
  const cards = createContentWorkbenchReportCards();
  const packets = createContentWorkbenchReviewPackets();
  return {
