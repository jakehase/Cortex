...
export function createLifecycleWatchtowerAuditTrail() {
...
export function createLifecycleWatchtowerEvidenceManifest() {
...
export function createLifecycleWatchtowerReadinessAttestation() {
  const auditTrail = createLifecycleWatchtowerAuditTrail();
  return {
