...
export function createLifecycleWatchtowerAnalyticsTimeline() {
...
export function createLifecycleWatchtowerForecastEnvelope() {
...
export function createLifecycleWatchtowerExceptionLedger() {
...
export function summarizeLifecycleWatchtowerAnalytics() {
  const timeline = createLifecycleWatchtowerAnalyticsTimeline();
  const forecast = createLifecycleWatchtowerForecastEnvelope();
  return {
