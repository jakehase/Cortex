...
export function createLifecycleWatchtowerOperationsBoard() {
...
export function createLifecycleWatchtowerShiftChecklist() {
...
export function createLifecycleWatchtowerIncidentDeck() {
