...
export function createContentAtlasPolicies(overrides = {}) {
...
export function validateContentAtlasPolicies(policies = createContentAtlasPolicies()) {
  const issues = [];
...
export function summarizeContentAtlasPolicies(policies = createContentAtlasPolicies()) {
  return {
...
export function createContentAtlasEscalationDeck(policies = createContentAtlasPolicies()) {
