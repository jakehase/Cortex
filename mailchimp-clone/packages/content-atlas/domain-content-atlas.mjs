const MODULE = {
  ...
  "routeSegment": "atlas",
  "title": "Content Atlas",
  "focus": "Content Atlas covers content operations, packaging, and channel-specific delivery shape through landscape mapping and territory coverage.",
...
export function createContentAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentAtlasWorkspace(workspace = createContentAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentAtlasNarratives(workspace = createContentAtlasWorkspace()) {
...
export function createContentAtlasCoverageGrid(workspace = createContentAtlasWorkspace()) {
