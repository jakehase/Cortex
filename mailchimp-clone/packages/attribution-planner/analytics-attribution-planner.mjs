...
export function createAttributionPlannerAnalyticsTimeline() {
...
export function createAttributionPlannerForecastEnvelope() {
...
export function createAttributionPlannerExceptionLedger() {
...
export function summarizeAttributionPlannerAnalytics() {
  const timeline = createAttributionPlannerAnalyticsTimeline();
  const forecast = createAttributionPlannerForecastEnvelope();
  return {
