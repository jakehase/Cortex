...
export function createAttributionPlannerReportCards() {
...
export function createAttributionPlannerReviewPackets() {
...
export function summarizeAttributionPlannerReporting() {
  const cards = createAttributionPlannerReportCards();
  const packets = createAttributionPlannerReviewPackets();
  return {
