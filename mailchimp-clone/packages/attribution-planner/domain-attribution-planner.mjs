const MODULE = {
  "id": "attribution-planner",
  "ordinal": 94,
  "domain": "attribution",
  "surfaceId": "planner",
  "surfaceTitle": "Planner",
  "routeSegment": "planner",
  "title": "Attribution Planner",
  "focus": "Attribution Planner covers touchpoint weighting, influence mapping, and outcome reconciliation through calendar planning and execution choreography.",
  ...
  "tags": [
    ...
    "planner",
    "intelligence",
    "attribution-planner-wave-seven"
  ]
};
...
export function createAttributionPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAttributionPlannerWorkspace(workspace = createAttributionPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAttributionPlannerNarratives(workspace = createAttributionPlannerWorkspace()) {
...
export function createAttributionPlannerCoverageGrid(workspace = createAttributionPlannerWorkspace()) {
