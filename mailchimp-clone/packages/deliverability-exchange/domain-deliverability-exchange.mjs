...
export function createDeliverabilityExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityExchangeWorkspace(workspace = createDeliverabilityExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityExchangeNarratives(workspace = createDeliverabilityExchangeWorkspace()) {
...
export function createDeliverabilityExchangeCoverageGrid(workspace = createDeliverabilityExchangeWorkspace()) {
