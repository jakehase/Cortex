...
export function createAdvocacySentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacySentinelWorkspace(workspace = createAdvocacySentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacySentinelNarratives(workspace = createAdvocacySentinelWorkspace()) {
...
export function createAdvocacySentinelCoverageGrid(workspace = createAdvocacySentinelWorkspace()) {
