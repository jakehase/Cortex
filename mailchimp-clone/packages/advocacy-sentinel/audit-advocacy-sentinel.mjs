...
export function createAdvocacySentinelAuditTrail() {
...
export function createAdvocacySentinelEvidenceManifest() {
...
export function createAdvocacySentinelReadinessAttestation() {
  const auditTrail = createAdvocacySentinelAuditTrail();
  return {
