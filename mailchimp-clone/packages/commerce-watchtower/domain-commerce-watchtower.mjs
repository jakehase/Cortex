...
export function createCommerceWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCommerceWatchtowerWorkspace(workspace = createCommerceWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCommerceWatchtowerNarratives(workspace = createCommerceWatchtowerWorkspace()) {
...
export function createCommerceWatchtowerCoverageGrid(workspace = createCommerceWatchtowerWorkspace()) {
