const MODULE = {
  ...
  "title": "Benchmark Advisor",
  "focus": "Benchmark Advisor covers peer comparisons, maturity tracking, and reference baselines through recommendations and next-step framing.",
...
export function createBenchmarkAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBenchmarkAdvisorWorkspace(workspace = createBenchmarkAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createBenchmarkAdvisorNarratives(workspace = createBenchmarkAdvisorWorkspace()) {
...
export function createBenchmarkAdvisorCoverageGrid(workspace = createBenchmarkAdvisorWorkspace()) {
