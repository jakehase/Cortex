...
export function createAudienceNavigatorOperationsBoard() {
...
export function createAudienceNavigatorShiftChecklist() {
...
export function createAudienceNavigatorIncidentDeck() {
