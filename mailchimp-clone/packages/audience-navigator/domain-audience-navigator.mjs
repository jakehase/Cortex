const MODULE = {
  ...
  "title": "Audience Navigator",
  "focus": "Audience Navigator covers audience health, segment design, and targeting durability through journey guidance and directional controls.",
...
export function createAudienceNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceNavigatorWorkspace(workspace = createAudienceNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceNavigatorNarratives(workspace = createAudienceNavigatorWorkspace()) {
...
export function createAudienceNavigatorCoverageGrid(workspace = createAudienceNavigatorWorkspace()) {
