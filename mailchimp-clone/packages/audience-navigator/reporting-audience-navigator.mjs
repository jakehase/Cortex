...
export function createAudienceNavigatorReportCards() {
...
export function createAudienceNavigatorReviewPackets() {
...
export function summarizeAudienceNavigatorReporting() {
  const cards = createAudienceNavigatorReportCards();
  const packets = createAudienceNavigatorReviewPackets();
  return {
