...
export function createAudienceNavigatorAnalyticsTimeline() {
...
export function createAudienceNavigatorForecastEnvelope() {
...
export function createAudienceNavigatorExceptionLedger() {
...
export function summarizeAudienceNavigatorAnalytics() {
  const timeline = createAudienceNavigatorAnalyticsTimeline();
  const forecast = createAudienceNavigatorForecastEnvelope();
  return {
