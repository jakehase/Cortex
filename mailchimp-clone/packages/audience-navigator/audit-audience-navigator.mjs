...
export function createAudienceNavigatorAuditTrail() {
...
export function createAudienceNavigatorEvidenceManifest() {
...
export function createAudienceNavigatorReadinessAttestation() {
  const auditTrail = createAudienceNavigatorAuditTrail();
  return {
