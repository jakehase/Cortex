...
export function nav(actor) {
  if (!actor) return '<nav aria-label="Primary"><a href="/">Home</a><a href="/signup">Signup</a><a href="/login">Login</a><a href="/reset">Reset</a><a href="/status">Status</a></nav>';
  return `<nav aria-label="Primary">
    <a href="/app">Dashboard</a><a href="/workspaces">Workspaces</a><a href="/team">Team</a><a href="/billing">Billing</a><a href="/settings">Settings</a><a href="/feature-flags">Flags</a><a href="/admin">Admin</a>
    ...
    <a href="/automations">Automations</a><a href="/forms">Forms</a><a href="/landing-pages">Landing pages</a><a href="/reports">Reports</a><a href="/content/depth">Content depth</a><a href="/conversations">Inbox</a><a href="/preferences">Preferences</a><a href="/journeys/transactional">Transactional</a><a href="/surveys">Surveys</a><a href="/expansion-showcase">Expansion showcase</a><a href="/developer/api-keys">API keys</a><a href="/developer/webhooks">Webhooks</a>
...
export function page(title, actor, body) {
  const identity = actor ? `${escapeHtml(actor.user.name)} · ${escapeHtml(actor.membership.role)} · ${escapeHtml(actor.workspace.name)} · ${escapeHtml(actor.workspace.planId)}` : 'Anchor Mailer — Mailchimp clone campaign';
...
export function dashboardBody(state, actor) {
  ...
  <div class="card"><h3>Current-product depth</h3><p><a href="/optimization">Predictive optimization</a> · <a href="/omnichannel">SMS/social/ads</a> · <a href="/content/depth">Content lineage</a> · <a href="/integrations">Ecosystem realism</a></p></div>
