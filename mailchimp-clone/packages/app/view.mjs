...
export function nav(actor) {
  ...
  return `<nav aria-label="Primary">
    ...
    <a href="/automations">Automations</a><a href="/forms">Forms</a><a href="/landing-pages">Landing pages</a><a href="/reports">Reports</a><a href="/content/depth">Content depth</a><a href="/conversations">Inbox</a><a href="/preferences">Preferences</a><a href="/journeys/transactional">Transactional</a><a href="/surveys">Surveys</a><a href="/developer/api-keys">API keys</a><a href="/developer/webhooks">Webhooks</a>
