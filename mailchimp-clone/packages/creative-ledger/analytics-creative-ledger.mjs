...
export function createCreativeLedgerAnalyticsTimeline() {
...
export function createCreativeLedgerForecastEnvelope() {
...
export function createCreativeLedgerExceptionLedger() {
...
export function summarizeCreativeLedgerAnalytics() {
  const timeline = createCreativeLedgerAnalyticsTimeline();
  const forecast = createCreativeLedgerForecastEnvelope();
  return {
