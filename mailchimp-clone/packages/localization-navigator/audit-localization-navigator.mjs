...
export function createLocalizationNavigatorAuditTrail() {
...
export function createLocalizationNavigatorEvidenceManifest() {
...
export function createLocalizationNavigatorReadinessAttestation() {
  const auditTrail = createLocalizationNavigatorAuditTrail();
  return {
