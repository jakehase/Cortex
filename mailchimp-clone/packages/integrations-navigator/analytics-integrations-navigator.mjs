...
export function createIntegrationsNavigatorAnalyticsTimeline() {
...
export function createIntegrationsNavigatorForecastEnvelope() {
...
export function createIntegrationsNavigatorExceptionLedger() {
...
export function summarizeIntegrationsNavigatorAnalytics() {
  const timeline = createIntegrationsNavigatorAnalyticsTimeline();
  const forecast = createIntegrationsNavigatorForecastEnvelope();
  return {
