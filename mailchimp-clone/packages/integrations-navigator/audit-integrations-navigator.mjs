...
export function createIntegrationsNavigatorAuditTrail() {
...
export function createIntegrationsNavigatorEvidenceManifest() {
...
export function createIntegrationsNavigatorReadinessAttestation() {
  const auditTrail = createIntegrationsNavigatorAuditTrail();
  return {
