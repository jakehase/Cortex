...
export function createIntegrationsNavigatorFixtures() {
  return {
    accounts: [
...
export function summarizeIntegrationsNavigatorFixtures(fixtures = createIntegrationsNavigatorFixtures()) {
  return {
...
export function createIntegrationsNavigatorDemoInputs() {
  return {
