...
export function createIntegrationsNavigatorReportCards() {
...
export function createIntegrationsNavigatorReviewPackets() {
...
export function summarizeIntegrationsNavigatorReporting() {
  const cards = createIntegrationsNavigatorReportCards();
  const packets = createIntegrationsNavigatorReviewPackets();
  return {
