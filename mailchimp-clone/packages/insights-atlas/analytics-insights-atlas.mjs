...
export function createInsightsAtlasAnalyticsTimeline() {
...
export function createInsightsAtlasForecastEnvelope() {
...
export function createInsightsAtlasExceptionLedger() {
...
export function summarizeInsightsAtlasAnalytics() {
  const timeline = createInsightsAtlasAnalyticsTimeline();
  const forecast = createInsightsAtlasForecastEnvelope();
  return {
