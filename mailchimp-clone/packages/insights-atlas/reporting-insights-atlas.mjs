...
export function createInsightsAtlasReportCards() {
...
export function createInsightsAtlasReviewPackets() {
...
export function summarizeInsightsAtlasReporting() {
  const cards = createInsightsAtlasReportCards();
  const packets = createInsightsAtlasReviewPackets();
  return {
