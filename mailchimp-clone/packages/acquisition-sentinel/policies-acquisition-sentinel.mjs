...
export function createAcquisitionSentinelPolicies(overrides = {}) {
...
export function validateAcquisitionSentinelPolicies(policies = createAcquisitionSentinelPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionSentinelPolicies(policies = createAcquisitionSentinelPolicies()) {
  return {
...
export function createAcquisitionSentinelEscalationDeck(policies = createAcquisitionSentinelPolicies()) {
