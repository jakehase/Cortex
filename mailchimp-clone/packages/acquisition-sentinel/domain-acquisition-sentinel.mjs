...
export function createAcquisitionSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionSentinelWorkspace(workspace = createAcquisitionSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionSentinelNarratives(workspace = createAcquisitionSentinelWorkspace()) {
...
export function createAcquisitionSentinelCoverageGrid(workspace = createAcquisitionSentinelWorkspace()) {
