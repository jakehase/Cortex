...
export function createAcquisitionSentinelPlaybooks() {
...
export function createAcquisitionSentinelDecisionDeck() {
...
export function createAcquisitionSentinelEscalationMoments() {
