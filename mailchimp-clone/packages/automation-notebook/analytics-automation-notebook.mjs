...
export function createAutomationNotebookAnalyticsTimeline() {
...
export function createAutomationNotebookForecastEnvelope() {
...
export function createAutomationNotebookExceptionLedger() {
...
export function summarizeAutomationNotebookAnalytics() {
  const timeline = createAutomationNotebookAnalyticsTimeline();
  const forecast = createAutomationNotebookForecastEnvelope();
  return {
