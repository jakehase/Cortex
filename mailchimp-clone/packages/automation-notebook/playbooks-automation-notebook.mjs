...
export function createAutomationNotebookPlaybooks() {
...
export function createAutomationNotebookDecisionDeck() {
...
export function createAutomationNotebookEscalationMoments() {
