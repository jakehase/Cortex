...
export function createInsightsAdvisorAuditTrail() {
...
export function createInsightsAdvisorEvidenceManifest() {
...
export function createInsightsAdvisorReadinessAttestation() {
  const auditTrail = createInsightsAdvisorAuditTrail();
  return {
