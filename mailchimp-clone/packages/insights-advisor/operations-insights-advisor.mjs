...
export function createInsightsAdvisorOperationsBoard() {
...
export function createInsightsAdvisorShiftChecklist() {
...
export function createInsightsAdvisorIncidentDeck() {
