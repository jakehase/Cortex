...
export function createInsightsAdvisorAnalyticsTimeline() {
...
export function createInsightsAdvisorForecastEnvelope() {
...
export function createInsightsAdvisorExceptionLedger() {
...
export function summarizeInsightsAdvisorAnalytics() {
  const timeline = createInsightsAdvisorAnalyticsTimeline();
  const forecast = createInsightsAdvisorForecastEnvelope();
  return {
