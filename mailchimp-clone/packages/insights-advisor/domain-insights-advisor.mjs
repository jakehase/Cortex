const MODULE = {
  ...
  "focus": "Insights Advisor covers insight synthesis, operating narratives, and executive-ready summaries through recommendations and next-step framing.",
...
export function createInsightsAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsAdvisorWorkspace(workspace = createInsightsAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsAdvisorNarratives(workspace = createInsightsAdvisorWorkspace()) {
...
export function createInsightsAdvisorCoverageGrid(workspace = createInsightsAdvisorWorkspace()) {
