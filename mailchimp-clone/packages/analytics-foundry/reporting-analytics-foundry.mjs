...
export function createAnalyticsFoundryReportCards() {
...
export function createAnalyticsFoundryReviewPackets() {
...
export function summarizeAnalyticsFoundryReporting() {
  const cards = createAnalyticsFoundryReportCards();
  const packets = createAnalyticsFoundryReviewPackets();
  return {
