...
export function createBillingAtlasAuditTrail() {
...
export function createBillingAtlasEvidenceManifest() {
...
export function createBillingAtlasReadinessAttestation() {
  const auditTrail = createBillingAtlasAuditTrail();
  return {
