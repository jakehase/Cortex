...
export function createBillingAtlasAnalyticsTimeline() {
...
export function createBillingAtlasForecastEnvelope() {
...
export function createBillingAtlasExceptionLedger() {
...
export function summarizeBillingAtlasAnalytics() {
  const timeline = createBillingAtlasAnalyticsTimeline();
  const forecast = createBillingAtlasForecastEnvelope();
  return {
