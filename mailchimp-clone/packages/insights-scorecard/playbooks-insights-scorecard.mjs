...
export function createInsightsScorecardPlaybooks() {
...
export function createInsightsScorecardDecisionDeck() {
...
export function createInsightsScorecardEscalationMoments() {
