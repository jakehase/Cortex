...
export function createInsightsScorecardReportCards() {
...
export function createInsightsScorecardReviewPackets() {
...
export function summarizeInsightsScorecardReporting() {
  const cards = createInsightsScorecardReportCards();
  const packets = createInsightsScorecardReviewPackets();
  return {
