...
export function createLifecycleGridPolicies(overrides = {}) {
...
export function validateLifecycleGridPolicies(policies = createLifecycleGridPolicies()) {
  const issues = [];
...
export function summarizeLifecycleGridPolicies(policies = createLifecycleGridPolicies()) {
  return {
...
export function createLifecycleGridEscalationDeck(policies = createLifecycleGridPolicies()) {
