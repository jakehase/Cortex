...
export function createLifecycleAtlasFixtures() {
  return {
    accounts: [
...
export function summarizeLifecycleAtlasFixtures(fixtures = createLifecycleAtlasFixtures()) {
  return {
...
export function createLifecycleAtlasDemoInputs() {
  return {
