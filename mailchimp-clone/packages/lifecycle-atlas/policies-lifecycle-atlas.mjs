...
export function createLifecycleAtlasPolicies(overrides = {}) {
...
export function validateLifecycleAtlasPolicies(policies = createLifecycleAtlasPolicies()) {
  const issues = [];
...
export function summarizeLifecycleAtlasPolicies(policies = createLifecycleAtlasPolicies()) {
  return {
...
export function createLifecycleAtlasEscalationDeck(policies = createLifecycleAtlasPolicies()) {
