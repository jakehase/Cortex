...
export function createLifecycleAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleAtlasWorkspace(workspace = createLifecycleAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleAtlasNarratives(workspace = createLifecycleAtlasWorkspace()) {
...
export function createLifecycleAtlasCoverageGrid(workspace = createLifecycleAtlasWorkspace()) {
