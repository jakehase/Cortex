...
export function createInsightsStudioAnalyticsTimeline() {
...
export function createInsightsStudioForecastEnvelope() {
...
export function createInsightsStudioExceptionLedger() {
...
export function summarizeInsightsStudioAnalytics() {
  const timeline = createInsightsStudioAnalyticsTimeline();
  const forecast = createInsightsStudioForecastEnvelope();
  return {
