...
export function createInsightsStudioAuditTrail() {
...
export function createInsightsStudioEvidenceManifest() {
...
export function createInsightsStudioReadinessAttestation() {
  const auditTrail = createInsightsStudioAuditTrail();
  return {
