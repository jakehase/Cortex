...
export function createInsightsStudioReportCards() {
...
export function createInsightsStudioReviewPackets() {
...
export function summarizeInsightsStudioReporting() {
  const cards = createInsightsStudioReportCards();
  const packets = createInsightsStudioReviewPackets();
  return {
