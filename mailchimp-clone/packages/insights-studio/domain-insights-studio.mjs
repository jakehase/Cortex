const MODULE = {
  ...
  "focus": "Insights Studio covers insight synthesis, operating narratives, and executive-ready summaries through operator-facing creative and configuration tools.",
...
export function createInsightsStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsStudioWorkspace(workspace = createInsightsStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsStudioNarratives(workspace = createInsightsStudioWorkspace()) {
...
export function createInsightsStudioCoverageGrid(workspace = createInsightsStudioWorkspace()) {
