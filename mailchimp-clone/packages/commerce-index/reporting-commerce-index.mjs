...
export function createCommerceIndexReportCards() {
...
export function createCommerceIndexReviewPackets() {
...
export function summarizeCommerceIndexReporting() {
  const cards = createCommerceIndexReportCards();
  const packets = createCommerceIndexReviewPackets();
  return {
