...
export function createChannelPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelPlannerWorkspace(workspace = createChannelPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelPlannerNarratives(workspace = createChannelPlannerWorkspace()) {
...
export function createChannelPlannerCoverageGrid(workspace = createChannelPlannerWorkspace()) {
