...
export function createChannelPlannerAnalyticsTimeline() {
...
export function createChannelPlannerForecastEnvelope() {
...
export function createChannelPlannerExceptionLedger() {
...
export function summarizeChannelPlannerAnalytics() {
  const timeline = createChannelPlannerAnalyticsTimeline();
  const forecast = createChannelPlannerForecastEnvelope();
  return {
