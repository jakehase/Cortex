...
export function createChannelPlannerPolicies(overrides = {}) {
...
export function validateChannelPlannerPolicies(policies = createChannelPlannerPolicies()) {
  const issues = [];
...
export function summarizeChannelPlannerPolicies(policies = createChannelPlannerPolicies()) {
  return {
...
export function createChannelPlannerEscalationDeck(policies = createChannelPlannerPolicies()) {
