...
export function createDeliverabilityAtlasReportCards() {
...
export function createDeliverabilityAtlasReviewPackets() {
...
export function summarizeDeliverabilityAtlasReporting() {
  const cards = createDeliverabilityAtlasReportCards();
  const packets = createDeliverabilityAtlasReviewPackets();
  return {
