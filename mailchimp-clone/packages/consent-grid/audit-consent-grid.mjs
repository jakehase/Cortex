...
export function createConsentGridAuditTrail() {
...
export function createConsentGridEvidenceManifest() {
...
export function createConsentGridReadinessAttestation() {
  const auditTrail = createConsentGridAuditTrail();
  return {
