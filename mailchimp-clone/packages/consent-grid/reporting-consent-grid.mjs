...
export function createConsentGridReportCards() {
...
export function createConsentGridReviewPackets() {
...
export function summarizeConsentGridReporting() {
  const cards = createConsentGridReportCards();
  const packets = createConsentGridReviewPackets();
  return {
