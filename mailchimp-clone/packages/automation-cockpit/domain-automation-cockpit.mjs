...
export function createAutomationCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAutomationCockpitWorkspace(workspace = createAutomationCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createAutomationCockpitNarratives(workspace = createAutomationCockpitWorkspace()) {
...
export function createAutomationCockpitCoverageGrid(workspace = createAutomationCockpitWorkspace()) {
