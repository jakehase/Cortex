...
export function createAutomationCockpitPlaybooks() {
...
export function createAutomationCockpitDecisionDeck() {
...
export function createAutomationCockpitEscalationMoments() {
