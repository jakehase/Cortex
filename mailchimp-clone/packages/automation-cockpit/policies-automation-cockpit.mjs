...
export function createAutomationCockpitPolicies(overrides = {}) {
...
export function validateAutomationCockpitPolicies(policies = createAutomationCockpitPolicies()) {
  const issues = [];
...
export function summarizeAutomationCockpitPolicies(policies = createAutomationCockpitPolicies()) {
  return {
...
export function createAutomationCockpitEscalationDeck(policies = createAutomationCockpitPolicies()) {
