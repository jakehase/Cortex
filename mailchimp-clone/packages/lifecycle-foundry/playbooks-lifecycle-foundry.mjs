...
export function createLifecycleFoundryPlaybooks() {
...
export function createLifecycleFoundryDecisionDeck() {
...
export function createLifecycleFoundryEscalationMoments() {
