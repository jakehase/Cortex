...
export function createLifecycleFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleFoundryWorkspace(workspace = createLifecycleFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleFoundryNarratives(workspace = createLifecycleFoundryWorkspace()) {
...
export function createLifecycleFoundryCoverageGrid(workspace = createLifecycleFoundryWorkspace()) {
