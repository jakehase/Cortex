...
export function createDeliverabilityStudioReportCards() {
...
export function createDeliverabilityStudioReviewPackets() {
...
export function summarizeDeliverabilityStudioReporting() {
  const cards = createDeliverabilityStudioReportCards();
  const packets = createDeliverabilityStudioReviewPackets();
  return {
