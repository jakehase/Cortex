...
export function createChannelStudioAnalyticsTimeline() {
...
export function createChannelStudioForecastEnvelope() {
...
export function createChannelStudioExceptionLedger() {
...
export function summarizeChannelStudioAnalytics() {
  const timeline = createChannelStudioAnalyticsTimeline();
  const forecast = createChannelStudioForecastEnvelope();
  return {
