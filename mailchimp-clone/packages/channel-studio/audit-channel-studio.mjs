...
export function createChannelStudioAuditTrail() {
...
export function createChannelStudioEvidenceManifest() {
...
export function createChannelStudioReadinessAttestation() {
  const auditTrail = createChannelStudioAuditTrail();
  return {
