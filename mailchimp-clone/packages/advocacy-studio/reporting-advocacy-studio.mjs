...
export function createAdvocacyStudioReportCards() {
...
export function createAdvocacyStudioReviewPackets() {
...
export function summarizeAdvocacyStudioReporting() {
  const cards = createAdvocacyStudioReportCards();
  const packets = createAdvocacyStudioReviewPackets();
  return {
