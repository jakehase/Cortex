...
export function createAcquisitionExchangeOperationsBoard() {
...
export function createAcquisitionExchangeShiftChecklist() {
...
export function createAcquisitionExchangeIncidentDeck() {
