...
export function createAcquisitionExchangePolicies(overrides = {}) {
...
export function validateAcquisitionExchangePolicies(policies = createAcquisitionExchangePolicies()) {
  const issues = [];
...
export function summarizeAcquisitionExchangePolicies(policies = createAcquisitionExchangePolicies()) {
  return {
...
export function createAcquisitionExchangeEscalationDeck(policies = createAcquisitionExchangePolicies()) {
