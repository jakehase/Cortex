...
export function createAudienceNotebookAuditTrail() {
...
export function createAudienceNotebookEvidenceManifest() {
...
export function createAudienceNotebookReadinessAttestation() {
  const auditTrail = createAudienceNotebookAuditTrail();
  return {
