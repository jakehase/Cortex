...
export function createAudienceNotebookPlaybooks() {
...
export function createAudienceNotebookDecisionDeck() {
...
export function createAudienceNotebookEscalationMoments() {
