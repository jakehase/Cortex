...
export function createAudienceNotebookPolicies(overrides = {}) {
...
export function validateAudienceNotebookPolicies(policies = createAudienceNotebookPolicies()) {
  const issues = [];
...
export function summarizeAudienceNotebookPolicies(policies = createAudienceNotebookPolicies()) {
  return {
...
export function createAudienceNotebookEscalationDeck(policies = createAudienceNotebookPolicies()) {
