...
export function createAudienceNotebookAnalyticsTimeline() {
...
export function createAudienceNotebookForecastEnvelope() {
...
export function createAudienceNotebookExceptionLedger() {
...
export function summarizeAudienceNotebookAnalytics() {
  const timeline = createAudienceNotebookAnalyticsTimeline();
  const forecast = createAudienceNotebookForecastEnvelope();
  return {
