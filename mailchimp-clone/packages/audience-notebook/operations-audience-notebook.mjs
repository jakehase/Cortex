...
export function createAudienceNotebookOperationsBoard() {
...
export function createAudienceNotebookShiftChecklist() {
...
export function createAudienceNotebookIncidentDeck() {
