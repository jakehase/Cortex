...
export function createExperimentationPlannerAnalyticsTimeline() {
...
export function createExperimentationPlannerForecastEnvelope() {
...
export function createExperimentationPlannerExceptionLedger() {
...
export function summarizeExperimentationPlannerAnalytics() {
  const timeline = createExperimentationPlannerAnalyticsTimeline();
  const forecast = createExperimentationPlannerForecastEnvelope();
  return {
