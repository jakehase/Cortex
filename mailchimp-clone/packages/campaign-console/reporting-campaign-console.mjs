...
export function createCampaignConsoleReportCards() {
...
export function createCampaignConsoleReviewPackets() {
...
export function summarizeCampaignConsoleReporting() {
  const cards = createCampaignConsoleReportCards();
  const packets = createCampaignConsoleReviewPackets();
  return {
