...
export function createCreativeAtlasAuditTrail() {
...
export function createCreativeAtlasEvidenceManifest() {
...
export function createCreativeAtlasReadinessAttestation() {
  const auditTrail = createCreativeAtlasAuditTrail();
  return {
