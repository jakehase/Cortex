...
export function createCreativeAtlasReportCards() {
...
export function createCreativeAtlasReviewPackets() {
...
export function summarizeCreativeAtlasReporting() {
  const cards = createCreativeAtlasReportCards();
  const packets = createCreativeAtlasReviewPackets();
  return {
