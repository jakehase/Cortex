...
export function createCreativeAtlasAnalyticsTimeline() {
...
export function createCreativeAtlasForecastEnvelope() {
...
export function createCreativeAtlasExceptionLedger() {
...
export function summarizeCreativeAtlasAnalytics() {
  const timeline = createCreativeAtlasAnalyticsTimeline();
  const forecast = createCreativeAtlasForecastEnvelope();
  return {
