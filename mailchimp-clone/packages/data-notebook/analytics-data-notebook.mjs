...
export function createDataNotebookAnalyticsTimeline() {
...
export function createDataNotebookForecastEnvelope() {
...
export function createDataNotebookExceptionLedger() {
...
export function summarizeDataNotebookAnalytics() {
  const timeline = createDataNotebookAnalyticsTimeline();
  const forecast = createDataNotebookForecastEnvelope();
  return {
