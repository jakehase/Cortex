...
export function createDataNotebookAuditTrail() {
...
export function createDataNotebookEvidenceManifest() {
...
export function createDataNotebookReadinessAttestation() {
  const auditTrail = createDataNotebookAuditTrail();
  return {
