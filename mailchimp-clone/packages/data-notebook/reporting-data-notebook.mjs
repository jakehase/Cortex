...
export function createDataNotebookReportCards() {
...
export function createDataNotebookReviewPackets() {
...
export function summarizeDataNotebookReporting() {
  const cards = createDataNotebookReportCards();
  const packets = createDataNotebookReviewPackets();
  return {
