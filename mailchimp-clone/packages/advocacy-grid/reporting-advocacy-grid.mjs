...
export function createAdvocacyGridReportCards() {
...
export function createAdvocacyGridReviewPackets() {
...
export function summarizeAdvocacyGridReporting() {
  const cards = createAdvocacyGridReportCards();
  const packets = createAdvocacyGridReviewPackets();
  return {
