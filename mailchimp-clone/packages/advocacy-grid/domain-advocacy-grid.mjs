const MODULE = {
  ...
  "routeSegment": "grid",
  "title": "Advocacy Grid",
  "focus": "Advocacy Grid covers customer champions, referral readiness, and proof-sharing loops through portfolio views and cross-workspace rollups.",
...
export function createAdvocacyGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyGridWorkspace(workspace = createAdvocacyGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyGridNarratives(workspace = createAdvocacyGridWorkspace()) {
...
export function createAdvocacyGridCoverageGrid(workspace = createAdvocacyGridWorkspace()) {
