...
export function createAdvocacyGridAnalyticsTimeline() {
...
export function createAdvocacyGridForecastEnvelope() {
...
export function createAdvocacyGridExceptionLedger() {
...
export function summarizeAdvocacyGridAnalytics() {
  const timeline = createAdvocacyGridAnalyticsTimeline();
  const forecast = createAdvocacyGridForecastEnvelope();
  return {
