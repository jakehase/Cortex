...
export function createActivationGridPolicies(overrides = {}) {
...
export function validateActivationGridPolicies(policies = createActivationGridPolicies()) {
  const issues = [];
...
export function summarizeActivationGridPolicies(policies = createActivationGridPolicies()) {
  return {
...
export function createActivationGridEscalationDeck(policies = createActivationGridPolicies()) {
