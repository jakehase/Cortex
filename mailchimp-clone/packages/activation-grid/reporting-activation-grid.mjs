...
export function createActivationGridReportCards() {
...
export function createActivationGridReviewPackets() {
...
export function summarizeActivationGridReporting() {
  const cards = createActivationGridReportCards();
  const packets = createActivationGridReviewPackets();
  return {
