...
export function createComplianceHubPolicies(overrides = {}) {
...
export function validateComplianceHubPolicies(policies = createComplianceHubPolicies()) {
  const issues = [];
...
export function summarizeComplianceHubPolicies(policies = createComplianceHubPolicies()) {
  return {
...
export function createComplianceHubEscalationDeck(policies = createComplianceHubPolicies()) {
