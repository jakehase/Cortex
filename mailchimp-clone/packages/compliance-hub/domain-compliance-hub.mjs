...
export function createComplianceHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeComplianceHubWorkspace(workspace = createComplianceHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createComplianceHubNarratives(workspace = createComplianceHubWorkspace()) {
...
export function createComplianceHubCoverageGrid(workspace = createComplianceHubWorkspace()) {
