...
export function createLoyaltyIndexAnalyticsTimeline() {
...
export function createLoyaltyIndexForecastEnvelope() {
...
export function createLoyaltyIndexExceptionLedger() {
...
export function summarizeLoyaltyIndexAnalytics() {
  const timeline = createLoyaltyIndexAnalyticsTimeline();
  const forecast = createLoyaltyIndexForecastEnvelope();
  return {
