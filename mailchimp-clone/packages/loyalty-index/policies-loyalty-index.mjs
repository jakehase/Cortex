...
export function createLoyaltyIndexPolicies(overrides = {}) {
...
export function validateLoyaltyIndexPolicies(policies = createLoyaltyIndexPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyIndexPolicies(policies = createLoyaltyIndexPolicies()) {
  return {
...
export function createLoyaltyIndexEscalationDeck(policies = createLoyaltyIndexPolicies()) {
