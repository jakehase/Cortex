...
export function createLoyaltyIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyIndexWorkspace(workspace = createLoyaltyIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyIndexNarratives(workspace = createLoyaltyIndexWorkspace()) {
...
export function createLoyaltyIndexCoverageGrid(workspace = createLoyaltyIndexWorkspace()) {
