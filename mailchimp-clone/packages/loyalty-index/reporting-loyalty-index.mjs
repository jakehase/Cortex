...
export function createLoyaltyIndexReportCards() {
...
export function createLoyaltyIndexReviewPackets() {
...
export function summarizeLoyaltyIndexReporting() {
  const cards = createLoyaltyIndexReportCards();
  const packets = createLoyaltyIndexReviewPackets();
  return {
