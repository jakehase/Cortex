...
export function createLoyaltyAdvisorReportCards() {
...
export function createLoyaltyAdvisorReviewPackets() {
...
export function summarizeLoyaltyAdvisorReporting() {
  const cards = createLoyaltyAdvisorReportCards();
  const packets = createLoyaltyAdvisorReviewPackets();
  return {
