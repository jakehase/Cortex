const MODULE = {
  ...
  "title": "Loyalty Advisor",
  "focus": "Loyalty Advisor covers repeat purchase behavior, reward posture, and customer rescue depth through recommendations and next-step framing.",
...
export function createLoyaltyAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyAdvisorWorkspace(workspace = createLoyaltyAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyAdvisorNarratives(workspace = createLoyaltyAdvisorWorkspace()) {
...
export function createLoyaltyAdvisorCoverageGrid(workspace = createLoyaltyAdvisorWorkspace()) {
