...
export function createActivationDossierAnalyticsTimeline() {
...
export function createActivationDossierForecastEnvelope() {
...
export function createActivationDossierExceptionLedger() {
...
export function summarizeActivationDossierAnalytics() {
  const timeline = createActivationDossierAnalyticsTimeline();
  const forecast = createActivationDossierForecastEnvelope();
  return {
