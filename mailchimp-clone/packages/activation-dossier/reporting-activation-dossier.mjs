...
export function createActivationDossierReportCards() {
...
export function createActivationDossierReviewPackets() {
...
export function summarizeActivationDossierReporting() {
  const cards = createActivationDossierReportCards();
  const packets = createActivationDossierReviewPackets();
  return {
