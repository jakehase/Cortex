...
export function createActivationDossierAuditTrail() {
...
export function createActivationDossierEvidenceManifest() {
...
export function createActivationDossierReadinessAttestation() {
  const auditTrail = createActivationDossierAuditTrail();
  return {
