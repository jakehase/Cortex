...
export function createActivationDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationDossierWorkspace(workspace = createActivationDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationDossierNarratives(workspace = createActivationDossierWorkspace()) {
...
export function createActivationDossierCoverageGrid(workspace = createActivationDossierWorkspace()) {
