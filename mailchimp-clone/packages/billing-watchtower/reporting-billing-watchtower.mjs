...
export function createBillingWatchtowerReportCards() {
...
export function createBillingWatchtowerReviewPackets() {
...
export function summarizeBillingWatchtowerReporting() {
  const cards = createBillingWatchtowerReportCards();
  const packets = createBillingWatchtowerReviewPackets();
  return {
