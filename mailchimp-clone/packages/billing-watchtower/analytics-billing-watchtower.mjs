...
export function createBillingWatchtowerAnalyticsTimeline() {
...
export function createBillingWatchtowerForecastEnvelope() {
...
export function createBillingWatchtowerExceptionLedger() {
...
export function summarizeBillingWatchtowerAnalytics() {
  const timeline = createBillingWatchtowerAnalyticsTimeline();
  const forecast = createBillingWatchtowerForecastEnvelope();
  return {
