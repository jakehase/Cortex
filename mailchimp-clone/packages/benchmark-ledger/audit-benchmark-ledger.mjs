...
export function createBenchmarkLedgerAuditTrail() {
...
export function createBenchmarkLedgerEvidenceManifest() {
...
export function createBenchmarkLedgerReadinessAttestation() {
  const auditTrail = createBenchmarkLedgerAuditTrail();
  return {
