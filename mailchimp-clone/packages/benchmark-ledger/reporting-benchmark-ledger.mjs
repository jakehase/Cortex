...
export function createBenchmarkLedgerReportCards() {
...
export function createBenchmarkLedgerReviewPackets() {
...
export function summarizeBenchmarkLedgerReporting() {
  const cards = createBenchmarkLedgerReportCards();
  const packets = createBenchmarkLedgerReviewPackets();
  return {
