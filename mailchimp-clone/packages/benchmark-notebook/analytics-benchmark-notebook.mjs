...
export function createBenchmarkNotebookAnalyticsTimeline() {
...
export function createBenchmarkNotebookForecastEnvelope() {
...
export function createBenchmarkNotebookExceptionLedger() {
...
export function summarizeBenchmarkNotebookAnalytics() {
  const timeline = createBenchmarkNotebookAnalyticsTimeline();
  const forecast = createBenchmarkNotebookForecastEnvelope();
  return {
