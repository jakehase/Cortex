...
export function createBenchmarkNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBenchmarkNotebookWorkspace(workspace = createBenchmarkNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createBenchmarkNotebookNarratives(workspace = createBenchmarkNotebookWorkspace()) {
...
export function createBenchmarkNotebookCoverageGrid(workspace = createBenchmarkNotebookWorkspace()) {
