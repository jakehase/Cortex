...
export function createAutomationScorecardOperationsBoard() {
...
export function createAutomationScorecardShiftChecklist() {
...
export function createAutomationScorecardIncidentDeck() {
