...
export function createAutomationScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAutomationScorecardWorkspace(workspace = createAutomationScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createAutomationScorecardNarratives(workspace = createAutomationScorecardWorkspace()) {
...
export function createAutomationScorecardCoverageGrid(workspace = createAutomationScorecardWorkspace()) {
