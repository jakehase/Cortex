...
export function createCreativeStudioPolicies(overrides = {}) {
...
export function validateCreativeStudioPolicies(policies = createCreativeStudioPolicies()) {
  const issues = [];
...
export function summarizeCreativeStudioPolicies(policies = createCreativeStudioPolicies()) {
  return {
...
export function createCreativeStudioEscalationDeck(policies = createCreativeStudioPolicies()) {
