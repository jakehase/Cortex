...
export function createCreativeStudioReportCards() {
...
export function createCreativeStudioReviewPackets() {
...
export function summarizeCreativeStudioReporting() {
  const cards = createCreativeStudioReportCards();
  const packets = createCreativeStudioReviewPackets();
  return {
