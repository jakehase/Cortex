...
export function createLifecycleIndexPolicies(overrides = {}) {
...
export function validateLifecycleIndexPolicies(policies = createLifecycleIndexPolicies()) {
  const issues = [];
...
export function summarizeLifecycleIndexPolicies(policies = createLifecycleIndexPolicies()) {
  return {
...
export function createLifecycleIndexEscalationDeck(policies = createLifecycleIndexPolicies()) {
