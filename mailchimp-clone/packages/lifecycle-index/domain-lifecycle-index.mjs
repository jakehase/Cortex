...
export function createLifecycleIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleIndexWorkspace(workspace = createLifecycleIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleIndexNarratives(workspace = createLifecycleIndexWorkspace()) {
...
export function createLifecycleIndexCoverageGrid(workspace = createLifecycleIndexWorkspace()) {
