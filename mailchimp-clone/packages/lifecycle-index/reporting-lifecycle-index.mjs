...
export function createLifecycleIndexReportCards() {
...
export function createLifecycleIndexReviewPackets() {
...
export function summarizeLifecycleIndexReporting() {
  const cards = createLifecycleIndexReportCards();
  const packets = createLifecycleIndexReviewPackets();
  return {
