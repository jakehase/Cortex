...
export function createActivationNavigatorOperationsBoard() {
...
export function createActivationNavigatorShiftChecklist() {
...
export function createActivationNavigatorIncidentDeck() {
