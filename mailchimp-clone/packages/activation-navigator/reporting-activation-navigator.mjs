...
export function createActivationNavigatorReportCards() {
...
export function createActivationNavigatorReviewPackets() {
...
export function summarizeActivationNavigatorReporting() {
  const cards = createActivationNavigatorReportCards();
  const packets = createActivationNavigatorReviewPackets();
  return {
