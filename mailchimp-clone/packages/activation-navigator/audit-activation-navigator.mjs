...
export function createActivationNavigatorAuditTrail() {
...
export function createActivationNavigatorEvidenceManifest() {
...
export function createActivationNavigatorReadinessAttestation() {
  const auditTrail = createActivationNavigatorAuditTrail();
  return {
