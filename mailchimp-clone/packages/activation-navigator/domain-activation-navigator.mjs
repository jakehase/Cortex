const MODULE = {
  "id": "activation-navigator",
  "ordinal": 32,
  "domain": "activation",
  "surfaceId": "navigator",
  "surfaceTitle": "Navigator",
  "routeSegment": "navigator",
  "title": "Activation Navigator",
  "focus": "Activation Navigator covers onboarding readiness, first-value motion, and kickoff momentum through journey guidance and directional controls.",
  ...
  "tags": [
    ...
    "navigator",
    "growth",
    "activation-navigator-wave-seven"
  ]
};
...
export function createActivationNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationNavigatorWorkspace(workspace = createActivationNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationNavigatorNarratives(workspace = createActivationNavigatorWorkspace()) {
...
export function createActivationNavigatorCoverageGrid(workspace = createActivationNavigatorWorkspace()) {
