...
export function createBenchmarkGridReportCards() {
...
export function createBenchmarkGridReviewPackets() {
...
export function summarizeBenchmarkGridReporting() {
  const cards = createBenchmarkGridReportCards();
  const packets = createBenchmarkGridReviewPackets();
  return {
