...
export function createBenchmarkGridAnalyticsTimeline() {
...
export function createBenchmarkGridForecastEnvelope() {
...
export function createBenchmarkGridExceptionLedger() {
...
export function summarizeBenchmarkGridAnalytics() {
  const timeline = createBenchmarkGridAnalyticsTimeline();
  const forecast = createBenchmarkGridForecastEnvelope();
  return {
