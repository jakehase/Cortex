...
export function createChannelCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelCockpitWorkspace(workspace = createChannelCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelCockpitNarratives(workspace = createChannelCockpitWorkspace()) {
...
export function createChannelCockpitCoverageGrid(workspace = createChannelCockpitWorkspace()) {
