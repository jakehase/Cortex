...
export function createChannelCockpitFixtures() {
  return {
    accounts: [
...
export function summarizeChannelCockpitFixtures(fixtures = createChannelCockpitFixtures()) {
  return {
...
export function createChannelCockpitDemoInputs() {
  return {
