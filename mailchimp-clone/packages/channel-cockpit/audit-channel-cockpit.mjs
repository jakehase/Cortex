...
export function createChannelCockpitAuditTrail() {
...
export function createChannelCockpitEvidenceManifest() {
...
export function createChannelCockpitReadinessAttestation() {
  const auditTrail = createChannelCockpitAuditTrail();
  return {
