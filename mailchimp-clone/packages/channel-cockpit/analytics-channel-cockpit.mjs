...
export function createChannelCockpitAnalyticsTimeline() {
...
export function createChannelCockpitForecastEnvelope() {
...
export function createChannelCockpitExceptionLedger() {
...
export function summarizeChannelCockpitAnalytics() {
  const timeline = createChannelCockpitAnalyticsTimeline();
  const forecast = createChannelCockpitForecastEnvelope();
  return {
