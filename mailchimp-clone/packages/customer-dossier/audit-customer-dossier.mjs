...
export function createCustomerDossierAuditTrail() {
...
export function createCustomerDossierEvidenceManifest() {
...
export function createCustomerDossierReadinessAttestation() {
  const auditTrail = createCustomerDossierAuditTrail();
  return {
