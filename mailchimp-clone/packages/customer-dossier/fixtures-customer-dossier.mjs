...
export function createCustomerDossierFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerDossierFixtures(fixtures = createCustomerDossierFixtures()) {
  return {
...
export function createCustomerDossierDemoInputs() {
  return {
