...
export function createCustomerDossierOperationsBoard() {
...
export function createCustomerDossierShiftChecklist() {
...
export function createCustomerDossierIncidentDeck() {
