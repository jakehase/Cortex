...
export function createCreativeConsoleOperationsBoard() {
...
export function createCreativeConsoleShiftChecklist() {
...
export function createCreativeConsoleIncidentDeck() {
