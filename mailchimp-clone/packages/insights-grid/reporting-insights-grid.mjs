...
export function createInsightsGridReportCards() {
...
export function createInsightsGridReviewPackets() {
...
export function summarizeInsightsGridReporting() {
  const cards = createInsightsGridReportCards();
  const packets = createInsightsGridReviewPackets();
  return {
