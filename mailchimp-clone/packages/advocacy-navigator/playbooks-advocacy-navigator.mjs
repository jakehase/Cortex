...
export function createAdvocacyNavigatorPlaybooks() {
...
export function createAdvocacyNavigatorDecisionDeck() {
...
export function createAdvocacyNavigatorEscalationMoments() {
