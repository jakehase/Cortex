...
export function createAdvocacyNavigatorOperationsBoard() {
...
export function createAdvocacyNavigatorShiftChecklist() {
...
export function createAdvocacyNavigatorIncidentDeck() {
