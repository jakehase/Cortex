...
export function createAdvocacyNavigatorReportCards() {
...
export function createAdvocacyNavigatorReviewPackets() {
...
export function summarizeAdvocacyNavigatorReporting() {
  const cards = createAdvocacyNavigatorReportCards();
  const packets = createAdvocacyNavigatorReviewPackets();
  return {
