...
export function createBenchmarkAtlasAuditTrail() {
...
export function createBenchmarkAtlasEvidenceManifest() {
...
export function createBenchmarkAtlasReadinessAttestation() {
  const auditTrail = createBenchmarkAtlasAuditTrail();
  return {
