...
export function createAdvocacyDossierOperationsBoard() {
...
export function createAdvocacyDossierShiftChecklist() {
...
export function createAdvocacyDossierIncidentDeck() {
