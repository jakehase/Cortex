...
export function createAdvocacyDossierAuditTrail() {
...
export function createAdvocacyDossierEvidenceManifest() {
...
export function createAdvocacyDossierReadinessAttestation() {
  const auditTrail = createAdvocacyDossierAuditTrail();
  return {
