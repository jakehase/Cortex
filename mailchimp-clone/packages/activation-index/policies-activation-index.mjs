...
export function createActivationIndexPolicies(overrides = {}) {
...
export function validateActivationIndexPolicies(policies = createActivationIndexPolicies()) {
  const issues = [];
...
export function summarizeActivationIndexPolicies(policies = createActivationIndexPolicies()) {
  return {
...
export function createActivationIndexEscalationDeck(policies = createActivationIndexPolicies()) {
