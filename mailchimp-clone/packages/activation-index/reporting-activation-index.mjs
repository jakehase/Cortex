...
export function createActivationIndexReportCards() {
...
export function createActivationIndexReviewPackets() {
...
export function summarizeActivationIndexReporting() {
  const cards = createActivationIndexReportCards();
  const packets = createActivationIndexReviewPackets();
  return {
