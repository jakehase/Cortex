...
export function createActivationIndexOperationsBoard() {
...
export function createActivationIndexShiftChecklist() {
...
export function createActivationIndexIncidentDeck() {
