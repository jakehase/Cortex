...
export function createAdvocacyVaultWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyVaultWorkspace(workspace = createAdvocacyVaultWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyVaultNarratives(workspace = createAdvocacyVaultWorkspace()) {
...
export function createAdvocacyVaultCoverageGrid(workspace = createAdvocacyVaultWorkspace()) {
