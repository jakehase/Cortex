...
export function createAdvocacyVaultAuditTrail() {
...
export function createAdvocacyVaultEvidenceManifest() {
...
export function createAdvocacyVaultReadinessAttestation() {
  const auditTrail = createAdvocacyVaultAuditTrail();
  return {
