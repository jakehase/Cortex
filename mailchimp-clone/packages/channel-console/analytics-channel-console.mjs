...
export function createChannelConsoleAnalyticsTimeline() {
...
export function createChannelConsoleForecastEnvelope() {
...
export function createChannelConsoleExceptionLedger() {
...
export function summarizeChannelConsoleAnalytics() {
  const timeline = createChannelConsoleAnalyticsTimeline();
  const forecast = createChannelConsoleForecastEnvelope();
  return {
