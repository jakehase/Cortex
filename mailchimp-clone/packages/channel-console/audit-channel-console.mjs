...
export function createChannelConsoleAuditTrail() {
...
export function createChannelConsoleEvidenceManifest() {
...
export function createChannelConsoleReadinessAttestation() {
  const auditTrail = createChannelConsoleAuditTrail();
  return {
