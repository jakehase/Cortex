...
export function createCampaignSentinelPlaybooks() {
...
export function createCampaignSentinelDecisionDeck() {
...
export function createCampaignSentinelEscalationMoments() {
