...
export function createCampaignSentinelPolicies(overrides = {}) {
...
export function validateCampaignSentinelPolicies(policies = createCampaignSentinelPolicies()) {
  const issues = [];
...
export function summarizeCampaignSentinelPolicies(policies = createCampaignSentinelPolicies()) {
  return {
...
export function createCampaignSentinelEscalationDeck(policies = createCampaignSentinelPolicies()) {
