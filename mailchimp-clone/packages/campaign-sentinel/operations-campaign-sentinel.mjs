...
export function createCampaignSentinelOperationsBoard() {
...
export function createCampaignSentinelShiftChecklist() {
...
export function createCampaignSentinelIncidentDeck() {
