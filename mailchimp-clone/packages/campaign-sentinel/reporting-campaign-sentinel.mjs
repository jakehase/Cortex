...
export function createCampaignSentinelReportCards() {
...
export function createCampaignSentinelReviewPackets() {
...
export function summarizeCampaignSentinelReporting() {
  const cards = createCampaignSentinelReportCards();
  const packets = createCampaignSentinelReviewPackets();
  return {
