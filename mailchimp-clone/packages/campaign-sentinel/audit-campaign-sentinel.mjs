...
export function createCampaignSentinelAuditTrail() {
...
export function createCampaignSentinelEvidenceManifest() {
...
export function createCampaignSentinelReadinessAttestation() {
  const auditTrail = createCampaignSentinelAuditTrail();
  return {
