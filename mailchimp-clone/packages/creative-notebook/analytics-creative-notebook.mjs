...
export function createCreativeNotebookAnalyticsTimeline() {
...
export function createCreativeNotebookForecastEnvelope() {
...
export function createCreativeNotebookExceptionLedger() {
...
export function summarizeCreativeNotebookAnalytics() {
  const timeline = createCreativeNotebookAnalyticsTimeline();
  const forecast = createCreativeNotebookForecastEnvelope();
  return {
