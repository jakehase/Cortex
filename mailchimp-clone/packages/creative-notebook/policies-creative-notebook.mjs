...
export function createCreativeNotebookPolicies(overrides = {}) {
...
export function validateCreativeNotebookPolicies(policies = createCreativeNotebookPolicies()) {
  const issues = [];
...
export function summarizeCreativeNotebookPolicies(policies = createCreativeNotebookPolicies()) {
  return {
...
export function createCreativeNotebookEscalationDeck(policies = createCreativeNotebookPolicies()) {
