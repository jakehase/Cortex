...
export function createCreativeNotebookOperationsBoard() {
...
export function createCreativeNotebookShiftChecklist() {
...
export function createCreativeNotebookIncidentDeck() {
