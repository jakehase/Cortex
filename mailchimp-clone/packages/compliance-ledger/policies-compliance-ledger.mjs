...
export function createComplianceLedgerPolicies(overrides = {}) {
...
export function validateComplianceLedgerPolicies(policies = createComplianceLedgerPolicies()) {
  const issues = [];
...
export function summarizeComplianceLedgerPolicies(policies = createComplianceLedgerPolicies()) {
  return {
...
export function createComplianceLedgerEscalationDeck(policies = createComplianceLedgerPolicies()) {
