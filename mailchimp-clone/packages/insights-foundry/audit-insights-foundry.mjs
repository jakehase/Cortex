...
export function createInsightsFoundryAuditTrail() {
...
export function createInsightsFoundryEvidenceManifest() {
...
export function createInsightsFoundryReadinessAttestation() {
  const auditTrail = createInsightsFoundryAuditTrail();
  return {
