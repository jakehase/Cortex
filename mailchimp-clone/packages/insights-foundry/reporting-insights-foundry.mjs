...
export function createInsightsFoundryReportCards() {
...
export function createInsightsFoundryReviewPackets() {
...
export function summarizeInsightsFoundryReporting() {
  const cards = createInsightsFoundryReportCards();
  const packets = createInsightsFoundryReviewPackets();
  return {
