const MODULE = {
  ...
  "focus": "Insights Foundry covers insight synthesis, operating narratives, and executive-ready summaries through program building and surface composition.",
...
export function createInsightsFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsFoundryWorkspace(workspace = createInsightsFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsFoundryNarratives(workspace = createInsightsFoundryWorkspace()) {
...
export function createInsightsFoundryCoverageGrid(workspace = createInsightsFoundryWorkspace()) {
