...
export function createInsightsFoundryFixtures() {
  return {
    accounts: [
...
export function summarizeInsightsFoundryFixtures(fixtures = createInsightsFoundryFixtures()) {
  return {
...
export function createInsightsFoundryDemoInputs() {
  return {
