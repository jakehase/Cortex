...
export function createInsightsFoundryAnalyticsTimeline() {
...
export function createInsightsFoundryForecastEnvelope() {
...
export function createInsightsFoundryExceptionLedger() {
...
export function summarizeInsightsFoundryAnalytics() {
  const timeline = createInsightsFoundryAnalyticsTimeline();
  const forecast = createInsightsFoundryForecastEnvelope();
  return {
