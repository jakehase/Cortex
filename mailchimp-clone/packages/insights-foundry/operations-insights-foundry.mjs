...
export function createInsightsFoundryOperationsBoard() {
...
export function createInsightsFoundryShiftChecklist() {
...
export function createInsightsFoundryIncidentDeck() {
