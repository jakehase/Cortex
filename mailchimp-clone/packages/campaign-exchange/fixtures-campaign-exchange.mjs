...
export function createCampaignExchangeFixtures() {
  return {
    accounts: [
...
export function summarizeCampaignExchangeFixtures(fixtures = createCampaignExchangeFixtures()) {
  return {
...
export function createCampaignExchangeDemoInputs() {
  return {
