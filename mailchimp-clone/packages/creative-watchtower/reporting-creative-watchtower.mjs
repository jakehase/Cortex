...
export function createCreativeWatchtowerReportCards() {
...
export function createCreativeWatchtowerReviewPackets() {
...
export function summarizeCreativeWatchtowerReporting() {
  const cards = createCreativeWatchtowerReportCards();
  const packets = createCreativeWatchtowerReviewPackets();
  return {
