...
export function createCreativeWatchtowerPlaybooks() {
...
export function createCreativeWatchtowerDecisionDeck() {
...
export function createCreativeWatchtowerEscalationMoments() {
