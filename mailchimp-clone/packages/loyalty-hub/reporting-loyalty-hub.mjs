...
export function createLoyaltyHubReportCards() {
...
export function createLoyaltyHubReviewPackets() {
...
export function summarizeLoyaltyHubReporting() {
  const cards = createLoyaltyHubReportCards();
  const packets = createLoyaltyHubReviewPackets();
  return {
