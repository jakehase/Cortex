...
export function createLoyaltyHubPolicies(overrides = {}) {
...
export function validateLoyaltyHubPolicies(policies = createLoyaltyHubPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyHubPolicies(policies = createLoyaltyHubPolicies()) {
  return {
...
export function createLoyaltyHubEscalationDeck(policies = createLoyaltyHubPolicies()) {
