...
export function createDataCockpitAuditTrail() {
...
export function createDataCockpitEvidenceManifest() {
...
export function createDataCockpitReadinessAttestation() {
  const auditTrail = createDataCockpitAuditTrail();
  return {
