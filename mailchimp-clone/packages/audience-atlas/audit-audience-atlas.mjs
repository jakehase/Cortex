...
export function createAudienceAtlasAuditTrail() {
...
export function createAudienceAtlasEvidenceManifest() {
...
export function createAudienceAtlasReadinessAttestation() {
  const auditTrail = createAudienceAtlasAuditTrail();
  return {
