...
export function createAudienceAtlasReportCards() {
...
export function createAudienceAtlasReviewPackets() {
...
export function summarizeAudienceAtlasReporting() {
  const cards = createAudienceAtlasReportCards();
  const packets = createAudienceAtlasReviewPackets();
  return {
