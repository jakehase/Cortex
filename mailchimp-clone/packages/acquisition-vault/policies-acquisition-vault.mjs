...
export function createAcquisitionVaultPolicies(overrides = {}) {
...
export function validateAcquisitionVaultPolicies(policies = createAcquisitionVaultPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionVaultPolicies(policies = createAcquisitionVaultPolicies()) {
  return {
...
export function createAcquisitionVaultEscalationDeck(policies = createAcquisitionVaultPolicies()) {
