...
export function createAcquisitionVaultPlaybooks() {
...
export function createAcquisitionVaultDecisionDeck() {
...
export function createAcquisitionVaultEscalationMoments() {
