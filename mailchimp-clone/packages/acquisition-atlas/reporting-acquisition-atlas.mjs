...
export function createAcquisitionAtlasReportCards() {
...
export function createAcquisitionAtlasReviewPackets() {
...
export function summarizeAcquisitionAtlasReporting() {
  const cards = createAcquisitionAtlasReportCards();
  const packets = createAcquisitionAtlasReviewPackets();
  return {
