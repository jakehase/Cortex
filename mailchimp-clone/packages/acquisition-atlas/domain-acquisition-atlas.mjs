const MODULE = {
  "id": "acquisition-atlas",
  "ordinal": 2,
  "domain": "acquisition",
  "surfaceId": "atlas",
  "surfaceTitle": "Atlas",
  "routeSegment": "atlas",
  "title": "Acquisition Atlas",
  "focus": "Acquisition Atlas covers new demand creation, source quality, and upstream handoff clarity through landscape mapping and territory coverage.",
...
export function createAcquisitionAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionAtlasWorkspace(workspace = createAcquisitionAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionAtlasNarratives(workspace = createAcquisitionAtlasWorkspace()) {
...
export function createAcquisitionAtlasCoverageGrid(workspace = createAcquisitionAtlasWorkspace()) {
