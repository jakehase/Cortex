...
export function createContentNavigatorAuditTrail() {
...
export function createContentNavigatorEvidenceManifest() {
...
export function createContentNavigatorReadinessAttestation() {
  const auditTrail = createContentNavigatorAuditTrail();
  return {
