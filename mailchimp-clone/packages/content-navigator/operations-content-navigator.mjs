...
export function createContentNavigatorOperationsBoard() {
...
export function createContentNavigatorShiftChecklist() {
...
export function createContentNavigatorIncidentDeck() {
