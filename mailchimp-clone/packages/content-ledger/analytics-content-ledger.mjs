...
export function createContentLedgerAnalyticsTimeline() {
...
export function createContentLedgerForecastEnvelope() {
...
export function createContentLedgerExceptionLedger() {
...
export function summarizeContentLedgerAnalytics() {
  const timeline = createContentLedgerAnalyticsTimeline();
  const forecast = createContentLedgerForecastEnvelope();
  return {
