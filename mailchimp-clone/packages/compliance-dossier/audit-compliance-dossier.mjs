...
export function createComplianceDossierAuditTrail() {
...
export function createComplianceDossierEvidenceManifest() {
...
export function createComplianceDossierReadinessAttestation() {
  const auditTrail = createComplianceDossierAuditTrail();
  return {
