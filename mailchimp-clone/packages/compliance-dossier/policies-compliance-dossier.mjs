...
export function createComplianceDossierPolicies(overrides = {}) {
...
export function validateComplianceDossierPolicies(policies = createComplianceDossierPolicies()) {
  const issues = [];
...
export function summarizeComplianceDossierPolicies(policies = createComplianceDossierPolicies()) {
  return {
...
export function createComplianceDossierEscalationDeck(policies = createComplianceDossierPolicies()) {
