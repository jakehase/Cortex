const MODULE = {
  ...
  "focus": "Compliance Dossier covers controls, remediation steps, and governance evidence capture through evidence packets and stakeholder briefings.",
...
export function createComplianceDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeComplianceDossierWorkspace(workspace = createComplianceDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createComplianceDossierNarratives(workspace = createComplianceDossierWorkspace()) {
...
export function createComplianceDossierCoverageGrid(workspace = createComplianceDossierWorkspace()) {
