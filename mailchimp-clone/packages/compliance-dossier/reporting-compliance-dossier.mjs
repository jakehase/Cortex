...
export function createComplianceDossierReportCards() {
...
export function createComplianceDossierReviewPackets() {
...
export function summarizeComplianceDossierReporting() {
  const cards = createComplianceDossierReportCards();
  const packets = createComplianceDossierReviewPackets();
  return {
