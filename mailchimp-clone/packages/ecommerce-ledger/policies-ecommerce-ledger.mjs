...
export function createEcommerceLedgerPolicies(overrides = {}) {
...
export function validateEcommerceLedgerPolicies(policies = createEcommerceLedgerPolicies()) {
  const issues = [];
...
export function summarizeEcommerceLedgerPolicies(policies = createEcommerceLedgerPolicies()) {
  return {
...
export function createEcommerceLedgerEscalationDeck(policies = createEcommerceLedgerPolicies()) {
