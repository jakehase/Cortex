...
export function createLifecycleConsolePlaybooks() {
...
export function createLifecycleConsoleDecisionDeck() {
...
export function createLifecycleConsoleEscalationMoments() {
