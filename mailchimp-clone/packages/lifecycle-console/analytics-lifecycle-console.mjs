...
export function createLifecycleConsoleAnalyticsTimeline() {
...
export function createLifecycleConsoleForecastEnvelope() {
...
export function createLifecycleConsoleExceptionLedger() {
...
export function summarizeLifecycleConsoleAnalytics() {
  const timeline = createLifecycleConsoleAnalyticsTimeline();
  const forecast = createLifecycleConsoleForecastEnvelope();
  return {
