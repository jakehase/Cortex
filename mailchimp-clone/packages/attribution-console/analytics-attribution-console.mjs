...
export function createAttributionConsoleAnalyticsTimeline() {
...
export function createAttributionConsoleForecastEnvelope() {
...
export function createAttributionConsoleExceptionLedger() {
...
export function summarizeAttributionConsoleAnalytics() {
  const timeline = createAttributionConsoleAnalyticsTimeline();
  const forecast = createAttributionConsoleForecastEnvelope();
  return {
