...
export function createExperimentationHubAuditTrail() {
...
export function createExperimentationHubEvidenceManifest() {
...
export function createExperimentationHubReadinessAttestation() {
  const auditTrail = createExperimentationHubAuditTrail();
  return {
