...
export function createCollaborationAtlasPolicies(overrides = {}) {
...
export function validateCollaborationAtlasPolicies(policies = createCollaborationAtlasPolicies()) {
  const issues = [];
...
export function summarizeCollaborationAtlasPolicies(policies = createCollaborationAtlasPolicies()) {
  return {
...
export function createCollaborationAtlasEscalationDeck(policies = createCollaborationAtlasPolicies()) {
