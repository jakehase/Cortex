...
export function createCollaborationAtlasPlaybooks() {
...
export function createCollaborationAtlasDecisionDeck() {
...
export function createCollaborationAtlasEscalationMoments() {
