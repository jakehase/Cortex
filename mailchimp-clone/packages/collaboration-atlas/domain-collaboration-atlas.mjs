...
export function createCollaborationAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationAtlasWorkspace(workspace = createCollaborationAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationAtlasNarratives(workspace = createCollaborationAtlasWorkspace()) {
...
export function createCollaborationAtlasCoverageGrid(workspace = createCollaborationAtlasWorkspace()) {
