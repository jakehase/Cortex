...
export function createCampaignWorkbenchOperationsBoard() {
...
export function createCampaignWorkbenchShiftChecklist() {
...
export function createCampaignWorkbenchIncidentDeck() {
