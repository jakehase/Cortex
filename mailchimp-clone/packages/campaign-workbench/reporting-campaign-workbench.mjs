...
export function createCampaignWorkbenchReportCards() {
...
export function createCampaignWorkbenchReviewPackets() {
...
export function summarizeCampaignWorkbenchReporting() {
  const cards = createCampaignWorkbenchReportCards();
  const packets = createCampaignWorkbenchReviewPackets();
  return {
