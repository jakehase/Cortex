...
export function createInsightsConsoleReportCards() {
...
export function createInsightsConsoleReviewPackets() {
...
export function summarizeInsightsConsoleReporting() {
  const cards = createInsightsConsoleReportCards();
  const packets = createInsightsConsoleReviewPackets();
  return {
