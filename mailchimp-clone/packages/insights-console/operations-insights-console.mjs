...
export function createInsightsConsoleOperationsBoard() {
...
export function createInsightsConsoleShiftChecklist() {
...
export function createInsightsConsoleIncidentDeck() {
