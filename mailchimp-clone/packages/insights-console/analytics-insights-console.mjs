...
export function createInsightsConsoleAnalyticsTimeline() {
...
export function createInsightsConsoleForecastEnvelope() {
...
export function createInsightsConsoleExceptionLedger() {
...
export function summarizeInsightsConsoleAnalytics() {
  const timeline = createInsightsConsoleAnalyticsTimeline();
  const forecast = createInsightsConsoleForecastEnvelope();
  return {
