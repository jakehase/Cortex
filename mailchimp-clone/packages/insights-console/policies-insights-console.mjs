...
export function createInsightsConsolePolicies(overrides = {}) {
...
export function validateInsightsConsolePolicies(policies = createInsightsConsolePolicies()) {
  const issues = [];
...
export function summarizeInsightsConsolePolicies(policies = createInsightsConsolePolicies()) {
  return {
...
export function createInsightsConsoleEscalationDeck(policies = createInsightsConsolePolicies()) {
