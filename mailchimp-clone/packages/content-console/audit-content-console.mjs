...
export function createContentConsoleAuditTrail() {
...
export function createContentConsoleEvidenceManifest() {
...
export function createContentConsoleReadinessAttestation() {
  const auditTrail = createContentConsoleAuditTrail();
  return {
