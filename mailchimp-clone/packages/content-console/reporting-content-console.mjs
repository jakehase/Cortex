...
export function createContentConsoleReportCards() {
...
export function createContentConsoleReviewPackets() {
...
export function summarizeContentConsoleReporting() {
  const cards = createContentConsoleReportCards();
  const packets = createContentConsoleReviewPackets();
  return {
