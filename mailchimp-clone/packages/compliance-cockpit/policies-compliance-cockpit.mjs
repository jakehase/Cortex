...
export function createComplianceCockpitPolicies(overrides = {}) {
...
export function validateComplianceCockpitPolicies(policies = createComplianceCockpitPolicies()) {
  const issues = [];
...
export function summarizeComplianceCockpitPolicies(policies = createComplianceCockpitPolicies()) {
  return {
...
export function createComplianceCockpitEscalationDeck(policies = createComplianceCockpitPolicies()) {
