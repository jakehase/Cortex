...
export function createComplianceCockpitOperationsBoard() {
...
export function createComplianceCockpitShiftChecklist() {
...
export function createComplianceCockpitIncidentDeck() {
