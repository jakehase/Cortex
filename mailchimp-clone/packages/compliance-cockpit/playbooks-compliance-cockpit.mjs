...
export function createComplianceCockpitPlaybooks() {
...
export function createComplianceCockpitDecisionDeck() {
...
export function createComplianceCockpitEscalationMoments() {
