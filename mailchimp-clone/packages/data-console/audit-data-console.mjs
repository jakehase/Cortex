...
export function createDataConsoleAuditTrail() {
...
export function createDataConsoleEvidenceManifest() {
...
export function createDataConsoleReadinessAttestation() {
  const auditTrail = createDataConsoleAuditTrail();
  return {
