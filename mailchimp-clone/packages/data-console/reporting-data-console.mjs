...
export function createDataConsoleReportCards() {
...
export function createDataConsoleReviewPackets() {
...
export function summarizeDataConsoleReporting() {
  const cards = createDataConsoleReportCards();
  const packets = createDataConsoleReviewPackets();
  return {
