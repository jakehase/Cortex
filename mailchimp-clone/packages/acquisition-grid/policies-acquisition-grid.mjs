...
export function createAcquisitionGridPolicies(overrides = {}) {
...
export function validateAcquisitionGridPolicies(policies = createAcquisitionGridPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionGridPolicies(policies = createAcquisitionGridPolicies()) {
  return {
...
export function createAcquisitionGridEscalationDeck(policies = createAcquisitionGridPolicies()) {
