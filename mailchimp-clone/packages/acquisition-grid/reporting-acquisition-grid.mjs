...
export function createAcquisitionGridReportCards() {
...
export function createAcquisitionGridReviewPackets() {
...
export function summarizeAcquisitionGridReporting() {
  const cards = createAcquisitionGridReportCards();
  const packets = createAcquisitionGridReviewPackets();
  return {
