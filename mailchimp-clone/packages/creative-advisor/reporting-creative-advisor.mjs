...
export function createCreativeAdvisorReportCards() {
...
export function createCreativeAdvisorReviewPackets() {
...
export function summarizeCreativeAdvisorReporting() {
  const cards = createCreativeAdvisorReportCards();
  const packets = createCreativeAdvisorReviewPackets();
  return {
