...
export function createCreativeAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCreativeAdvisorWorkspace(workspace = createCreativeAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createCreativeAdvisorNarratives(workspace = createCreativeAdvisorWorkspace()) {
...
export function createCreativeAdvisorCoverageGrid(workspace = createCreativeAdvisorWorkspace()) {
