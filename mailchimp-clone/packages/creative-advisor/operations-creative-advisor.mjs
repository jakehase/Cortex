...
export function createCreativeAdvisorOperationsBoard() {
...
export function createCreativeAdvisorShiftChecklist() {
...
export function createCreativeAdvisorIncidentDeck() {
