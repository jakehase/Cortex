...
export function createCreativeAdvisorAnalyticsTimeline() {
...
export function createCreativeAdvisorForecastEnvelope() {
...
export function createCreativeAdvisorExceptionLedger() {
...
export function summarizeCreativeAdvisorAnalytics() {
  const timeline = createCreativeAdvisorAnalyticsTimeline();
  const forecast = createCreativeAdvisorForecastEnvelope();
  return {
