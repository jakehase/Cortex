...
export function createBillingGridAuditTrail() {
...
export function createBillingGridEvidenceManifest() {
...
export function createBillingGridReadinessAttestation() {
  const auditTrail = createBillingGridAuditTrail();
  return {
