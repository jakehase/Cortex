...
export function createCustomerWorkbenchPlaybooks() {
...
export function createCustomerWorkbenchDecisionDeck() {
...
export function createCustomerWorkbenchEscalationMoments() {
