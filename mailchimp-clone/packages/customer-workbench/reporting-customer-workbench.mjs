...
export function createCustomerWorkbenchReportCards() {
...
export function createCustomerWorkbenchReviewPackets() {
...
export function summarizeCustomerWorkbenchReporting() {
  const cards = createCustomerWorkbenchReportCards();
  const packets = createCustomerWorkbenchReviewPackets();
  return {
