...
export function createCustomerWorkbenchAuditTrail() {
...
export function createCustomerWorkbenchEvidenceManifest() {
...
export function createCustomerWorkbenchReadinessAttestation() {
  const auditTrail = createCustomerWorkbenchAuditTrail();
  return {
