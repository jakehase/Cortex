...
export function createAttributionAdvisorOperationsBoard() {
...
export function createAttributionAdvisorShiftChecklist() {
...
export function createAttributionAdvisorIncidentDeck() {
