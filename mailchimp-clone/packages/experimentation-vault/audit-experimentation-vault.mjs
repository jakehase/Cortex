...
export function createExperimentationVaultAuditTrail() {
...
export function createExperimentationVaultEvidenceManifest() {
...
export function createExperimentationVaultReadinessAttestation() {
  const auditTrail = createExperimentationVaultAuditTrail();
  return {
