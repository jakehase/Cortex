...
export function createExperimentationVaultReportCards() {
...
export function createExperimentationVaultReviewPackets() {
...
export function summarizeExperimentationVaultReporting() {
  const cards = createExperimentationVaultReportCards();
  const packets = createExperimentationVaultReviewPackets();
  return {
