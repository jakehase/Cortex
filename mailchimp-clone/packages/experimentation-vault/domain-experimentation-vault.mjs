...
export function createExperimentationVaultWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationVaultWorkspace(workspace = createExperimentationVaultWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationVaultNarratives(workspace = createExperimentationVaultWorkspace()) {
...
export function createExperimentationVaultCoverageGrid(workspace = createExperimentationVaultWorkspace()) {
