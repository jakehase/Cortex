...
export function createExperimentationVaultPolicies(overrides = {}) {
...
export function validateExperimentationVaultPolicies(policies = createExperimentationVaultPolicies()) {
  const issues = [];
...
export function summarizeExperimentationVaultPolicies(policies = createExperimentationVaultPolicies()) {
  return {
...
export function createExperimentationVaultEscalationDeck(policies = createExperimentationVaultPolicies()) {
