...
export function createDeliverabilityNavigatorReportCards() {
...
export function createDeliverabilityNavigatorReviewPackets() {
...
export function summarizeDeliverabilityNavigatorReporting() {
  const cards = createDeliverabilityNavigatorReportCards();
  const packets = createDeliverabilityNavigatorReviewPackets();
  return {
