...
export function createDeliverabilityNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityNavigatorWorkspace(workspace = createDeliverabilityNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityNavigatorNarratives(workspace = createDeliverabilityNavigatorWorkspace()) {
...
export function createDeliverabilityNavigatorCoverageGrid(workspace = createDeliverabilityNavigatorWorkspace()) {
