...
export function createDataLedgerAnalyticsTimeline() {
...
export function createDataLedgerForecastEnvelope() {
...
export function createDataLedgerExceptionLedger() {
...
export function summarizeDataLedgerAnalytics() {
  const timeline = createDataLedgerAnalyticsTimeline();
  const forecast = createDataLedgerForecastEnvelope();
  return {
