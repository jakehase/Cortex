...
export function createActivationHubPolicies(overrides = {}) {
...
export function validateActivationHubPolicies(policies = createActivationHubPolicies()) {
  const issues = [];
...
export function summarizeActivationHubPolicies(policies = createActivationHubPolicies()) {
  return {
...
export function createActivationHubEscalationDeck(policies = createActivationHubPolicies()) {
