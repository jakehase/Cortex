...
export function createActivationHubAuditTrail() {
...
export function createActivationHubEvidenceManifest() {
...
export function createActivationHubReadinessAttestation() {
  const auditTrail = createActivationHubAuditTrail();
  return {
