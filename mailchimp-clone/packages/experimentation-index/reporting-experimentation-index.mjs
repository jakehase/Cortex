...
export function createExperimentationIndexReportCards() {
...
export function createExperimentationIndexReviewPackets() {
...
export function summarizeExperimentationIndexReporting() {
  const cards = createExperimentationIndexReportCards();
  const packets = createExperimentationIndexReviewPackets();
  return {
