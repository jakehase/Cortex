...
export function createCampaignDossierPolicies(overrides = {}) {
...
export function validateCampaignDossierPolicies(policies = createCampaignDossierPolicies()) {
  const issues = [];
...
export function summarizeCampaignDossierPolicies(policies = createCampaignDossierPolicies()) {
  return {
...
export function createCampaignDossierEscalationDeck(policies = createCampaignDossierPolicies()) {
