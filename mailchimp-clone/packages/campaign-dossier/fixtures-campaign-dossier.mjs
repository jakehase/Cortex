...
export function createCampaignDossierFixtures() {
  return {
    accounts: [
...
export function summarizeCampaignDossierFixtures(fixtures = createCampaignDossierFixtures()) {
  return {
...
export function createCampaignDossierDemoInputs() {
  return {
