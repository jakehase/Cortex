...
export function createCampaignDossierReportCards() {
...
export function createCampaignDossierReviewPackets() {
...
export function summarizeCampaignDossierReporting() {
  const cards = createCampaignDossierReportCards();
  const packets = createCampaignDossierReviewPackets();
  return {
