...
export function createAdvocacyWorkbenchReportCards() {
...
export function createAdvocacyWorkbenchReviewPackets() {
...
export function summarizeAdvocacyWorkbenchReporting() {
  const cards = createAdvocacyWorkbenchReportCards();
  const packets = createAdvocacyWorkbenchReviewPackets();
  return {
