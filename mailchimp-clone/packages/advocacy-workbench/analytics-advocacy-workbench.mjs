...
export function createAdvocacyWorkbenchAnalyticsTimeline() {
...
export function createAdvocacyWorkbenchForecastEnvelope() {
...
export function createAdvocacyWorkbenchExceptionLedger() {
...
export function summarizeAdvocacyWorkbenchAnalytics() {
  const timeline = createAdvocacyWorkbenchAnalyticsTimeline();
  const forecast = createAdvocacyWorkbenchForecastEnvelope();
  return {
