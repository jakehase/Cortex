...
export function createCommerceFoundryReportCards() {
...
export function createCommerceFoundryReviewPackets() {
...
export function summarizeCommerceFoundryReporting() {
  const cards = createCommerceFoundryReportCards();
  const packets = createCommerceFoundryReviewPackets();
  return {
