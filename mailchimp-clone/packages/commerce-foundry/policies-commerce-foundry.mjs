...
export function createCommerceFoundryPolicies(overrides = {}) {
...
export function validateCommerceFoundryPolicies(policies = createCommerceFoundryPolicies()) {
  const issues = [];
...
export function summarizeCommerceFoundryPolicies(policies = createCommerceFoundryPolicies()) {
  return {
...
export function createCommerceFoundryEscalationDeck(policies = createCommerceFoundryPolicies()) {
