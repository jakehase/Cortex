...
export function createCommerceDossierAuditTrail() {
...
export function createCommerceDossierEvidenceManifest() {
...
export function createCommerceDossierReadinessAttestation() {
  const auditTrail = createCommerceDossierAuditTrail();
  return {
