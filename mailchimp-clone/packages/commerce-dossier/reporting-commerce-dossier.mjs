...
export function createCommerceDossierReportCards() {
...
export function createCommerceDossierReviewPackets() {
...
export function summarizeCommerceDossierReporting() {
  const cards = createCommerceDossierReportCards();
  const packets = createCommerceDossierReviewPackets();
  return {
