...
export function createContentAdvisorReportCards() {
...
export function createContentAdvisorReviewPackets() {
...
export function summarizeContentAdvisorReporting() {
  const cards = createContentAdvisorReportCards();
  const packets = createContentAdvisorReviewPackets();
  return {
