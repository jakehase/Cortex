...
export function createAcquisitionWorkbenchAnalyticsTimeline() {
...
export function createAcquisitionWorkbenchForecastEnvelope() {
...
export function createAcquisitionWorkbenchExceptionLedger() {
...
export function summarizeAcquisitionWorkbenchAnalytics() {
  const timeline = createAcquisitionWorkbenchAnalyticsTimeline();
  const forecast = createAcquisitionWorkbenchForecastEnvelope();
  return {
