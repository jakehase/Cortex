const MODULE = {
  ...
  "focus": "Acquisition Workbench covers new demand creation, source quality, and upstream handoff clarity through hands-on workflows and analyst tooling.",
  ...
  "tags": [
    ...
    "workbench",
    "growth",
    "acquisition-workbench-wave-seven"
  ]
};
...
export function createAcquisitionWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionWorkbenchWorkspace(workspace = createAcquisitionWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionWorkbenchNarratives(workspace = createAcquisitionWorkbenchWorkspace()) {
...
export function createAcquisitionWorkbenchCoverageGrid(workspace = createAcquisitionWorkbenchWorkspace()) {
