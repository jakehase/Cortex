...
export function createAcquisitionWorkbenchPlaybooks() {
...
export function createAcquisitionWorkbenchDecisionDeck() {
...
export function createAcquisitionWorkbenchEscalationMoments() {
