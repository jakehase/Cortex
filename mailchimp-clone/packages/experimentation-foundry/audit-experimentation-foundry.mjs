...
export function createExperimentationFoundryAuditTrail() {
...
export function createExperimentationFoundryEvidenceManifest() {
...
export function createExperimentationFoundryReadinessAttestation() {
  const auditTrail = createExperimentationFoundryAuditTrail();
  return {
