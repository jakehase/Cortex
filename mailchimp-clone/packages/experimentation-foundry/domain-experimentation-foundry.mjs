...
export function createExperimentationFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationFoundryWorkspace(workspace = createExperimentationFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationFoundryNarratives(workspace = createExperimentationFoundryWorkspace()) {
...
export function createExperimentationFoundryCoverageGrid(workspace = createExperimentationFoundryWorkspace()) {
