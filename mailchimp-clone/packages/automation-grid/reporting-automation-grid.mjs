...
export function createAutomationGridReportCards() {
...
export function createAutomationGridReviewPackets() {
...
export function summarizeAutomationGridReporting() {
  const cards = createAutomationGridReportCards();
  const packets = createAutomationGridReviewPackets();
  return {
