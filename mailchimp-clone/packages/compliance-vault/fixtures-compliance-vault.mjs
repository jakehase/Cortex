...
export function createComplianceVaultFixtures() {
  return {
    accounts: [
...
export function summarizeComplianceVaultFixtures(fixtures = createComplianceVaultFixtures()) {
  return {
...
export function createComplianceVaultDemoInputs() {
  return {
