...
export function createComplianceVaultPolicies(overrides = {}) {
...
export function validateComplianceVaultPolicies(policies = createComplianceVaultPolicies()) {
  const issues = [];
...
export function summarizeComplianceVaultPolicies(policies = createComplianceVaultPolicies()) {
  return {
...
export function createComplianceVaultEscalationDeck(policies = createComplianceVaultPolicies()) {
