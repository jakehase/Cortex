...
export function createDeliverabilityConsoleAnalyticsTimeline() {
...
export function createDeliverabilityConsoleForecastEnvelope() {
...
export function createDeliverabilityConsoleExceptionLedger() {
...
export function summarizeDeliverabilityConsoleAnalytics() {
  const timeline = createDeliverabilityConsoleAnalyticsTimeline();
  const forecast = createDeliverabilityConsoleForecastEnvelope();
  return {
