...
export function createDeliverabilityConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeDeliverabilityConsoleFixtures(fixtures = createDeliverabilityConsoleFixtures()) {
  return {
...
export function createDeliverabilityConsoleDemoInputs() {
  return {
