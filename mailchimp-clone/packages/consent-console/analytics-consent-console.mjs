...
export function createConsentConsoleAnalyticsTimeline() {
...
export function createConsentConsoleForecastEnvelope() {
...
export function createConsentConsoleExceptionLedger() {
...
export function summarizeConsentConsoleAnalytics() {
  const timeline = createConsentConsoleAnalyticsTimeline();
  const forecast = createConsentConsoleForecastEnvelope();
  return {
