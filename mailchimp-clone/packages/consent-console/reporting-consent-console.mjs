...
export function createConsentConsoleReportCards() {
...
export function createConsentConsoleReviewPackets() {
...
export function summarizeConsentConsoleReporting() {
  const cards = createConsentConsoleReportCards();
  const packets = createConsentConsoleReviewPackets();
  return {
