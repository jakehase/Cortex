...
export function createChannelHubReportCards() {
...
export function createChannelHubReviewPackets() {
...
export function summarizeChannelHubReporting() {
  const cards = createChannelHubReportCards();
  const packets = createChannelHubReviewPackets();
  return {
