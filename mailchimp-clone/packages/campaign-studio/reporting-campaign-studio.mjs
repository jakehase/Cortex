...
export function createCampaignStudioReportCards() {
...
export function createCampaignStudioReviewPackets() {
...
export function summarizeCampaignStudioReporting() {
  const cards = createCampaignStudioReportCards();
  const packets = createCampaignStudioReviewPackets();
  return {
