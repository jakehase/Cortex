...
export function createContentVaultPolicies(overrides = {}) {
...
export function validateContentVaultPolicies(policies = createContentVaultPolicies()) {
  const issues = [];
...
export function summarizeContentVaultPolicies(policies = createContentVaultPolicies()) {
  return {
...
export function createContentVaultEscalationDeck(policies = createContentVaultPolicies()) {
