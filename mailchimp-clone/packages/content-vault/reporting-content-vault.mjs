...
export function createContentVaultReportCards() {
...
export function createContentVaultReviewPackets() {
...
export function summarizeContentVaultReporting() {
  const cards = createContentVaultReportCards();
  const packets = createContentVaultReviewPackets();
  return {
