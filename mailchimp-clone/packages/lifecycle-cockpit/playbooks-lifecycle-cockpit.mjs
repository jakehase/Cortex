...
export function createLifecycleCockpitPlaybooks() {
...
export function createLifecycleCockpitDecisionDeck() {
...
export function createLifecycleCockpitEscalationMoments() {
