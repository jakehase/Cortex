...
export function createLifecycleCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleCockpitWorkspace(workspace = createLifecycleCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleCockpitNarratives(workspace = createLifecycleCockpitWorkspace()) {
...
export function createLifecycleCockpitCoverageGrid(workspace = createLifecycleCockpitWorkspace()) {
