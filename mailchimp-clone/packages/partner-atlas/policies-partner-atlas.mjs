...
export function createPartnerAtlasPolicies(overrides = {}) {
...
export function validatePartnerAtlasPolicies(policies = createPartnerAtlasPolicies()) {
  const issues = [];
...
export function summarizePartnerAtlasPolicies(policies = createPartnerAtlasPolicies()) {
  return {
...
export function createPartnerAtlasEscalationDeck(policies = createPartnerAtlasPolicies()) {
