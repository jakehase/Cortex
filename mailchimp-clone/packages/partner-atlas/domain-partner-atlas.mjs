const MODULE = {
  ...
  "routeSegment": "atlas",
  "title": "Partner Atlas",
  "focus": "Partner Atlas covers partner readiness, enablement continuity, and ecosystem execution through landscape mapping and territory coverage.",
...
export function createPartnerAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizePartnerAtlasWorkspace(workspace = createPartnerAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createPartnerAtlasNarratives(workspace = createPartnerAtlasWorkspace()) {
...
export function createPartnerAtlasCoverageGrid(workspace = createPartnerAtlasWorkspace()) {
