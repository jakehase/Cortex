...
export function createPartnerAtlasAuditTrail() {
...
export function createPartnerAtlasEvidenceManifest() {
...
export function createPartnerAtlasReadinessAttestation() {
  const auditTrail = createPartnerAtlasAuditTrail();
  return {
