...
export function createPartnerAtlasReportCards() {
...
export function createPartnerAtlasReviewPackets() {
...
export function summarizePartnerAtlasReporting() {
  const cards = createPartnerAtlasReportCards();
  const packets = createPartnerAtlasReviewPackets();
  return {
