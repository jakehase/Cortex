...
export function createAudienceGridAnalyticsTimeline() {
...
export function createAudienceGridForecastEnvelope() {
...
export function createAudienceGridExceptionLedger() {
...
export function summarizeAudienceGridAnalytics() {
  const timeline = createAudienceGridAnalyticsTimeline();
  const forecast = createAudienceGridForecastEnvelope();
  return {
