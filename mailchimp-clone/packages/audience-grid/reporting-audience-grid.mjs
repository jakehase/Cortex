...
export function createAudienceGridReportCards() {
...
export function createAudienceGridReviewPackets() {
...
export function summarizeAudienceGridReporting() {
  const cards = createAudienceGridReportCards();
  const packets = createAudienceGridReviewPackets();
  return {
