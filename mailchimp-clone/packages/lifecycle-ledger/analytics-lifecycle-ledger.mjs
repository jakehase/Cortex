...
export function createLifecycleLedgerAnalyticsTimeline() {
...
export function createLifecycleLedgerForecastEnvelope() {
...
export function createLifecycleLedgerExceptionLedger() {
...
export function summarizeLifecycleLedgerAnalytics() {
  const timeline = createLifecycleLedgerAnalyticsTimeline();
  const forecast = createLifecycleLedgerForecastEnvelope();
  return {
