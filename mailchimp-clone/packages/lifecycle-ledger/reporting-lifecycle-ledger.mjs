...
export function createLifecycleLedgerReportCards() {
...
export function createLifecycleLedgerReviewPackets() {
...
export function summarizeLifecycleLedgerReporting() {
  const cards = createLifecycleLedgerReportCards();
  const packets = createLifecycleLedgerReviewPackets();
  return {
