const MODULE = {
  ...
  "routeSegment": "studio",
  "title": "Data Studio",
  "focus": "Data Studio covers pipeline health, lineage, freshness, and operator trust in data assets through operator-facing creative and configuration tools.",
...
export function createDataStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataStudioWorkspace(workspace = createDataStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataStudioNarratives(workspace = createDataStudioWorkspace()) {
...
export function createDataStudioCoverageGrid(workspace = createDataStudioWorkspace()) {
