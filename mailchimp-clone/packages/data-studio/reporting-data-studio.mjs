...
export function createDataStudioReportCards() {
...
export function createDataStudioReviewPackets() {
...
export function summarizeDataStudioReporting() {
  const cards = createDataStudioReportCards();
  const packets = createDataStudioReviewPackets();
  return {
