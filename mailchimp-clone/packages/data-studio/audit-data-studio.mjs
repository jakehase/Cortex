...
export function createDataStudioAuditTrail() {
...
export function createDataStudioEvidenceManifest() {
...
export function createDataStudioReadinessAttestation() {
  const auditTrail = createDataStudioAuditTrail();
  return {
