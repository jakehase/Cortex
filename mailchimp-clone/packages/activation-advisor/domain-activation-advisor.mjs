const MODULE = {
  "id": "activation-advisor",
  "ordinal": 21,
  "domain": "activation",
  "surfaceId": "advisor",
  "surfaceTitle": "Advisor",
  "routeSegment": "advisor",
  "title": "Activation Advisor",
  "focus": "Activation Advisor covers onboarding readiness, first-value motion, and kickoff momentum through recommendations and next-step framing.",
...
export function createActivationAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationAdvisorWorkspace(workspace = createActivationAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationAdvisorNarratives(workspace = createActivationAdvisorWorkspace()) {
...
export function createActivationAdvisorCoverageGrid(workspace = createActivationAdvisorWorkspace()) {
