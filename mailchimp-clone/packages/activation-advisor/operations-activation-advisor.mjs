...
export function createActivationAdvisorOperationsBoard() {
...
export function createActivationAdvisorShiftChecklist() {
...
export function createActivationAdvisorIncidentDeck() {
