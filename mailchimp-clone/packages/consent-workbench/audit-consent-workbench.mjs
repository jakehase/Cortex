...
export function createConsentWorkbenchAuditTrail() {
...
export function createConsentWorkbenchEvidenceManifest() {
...
export function createConsentWorkbenchReadinessAttestation() {
  const auditTrail = createConsentWorkbenchAuditTrail();
  return {
