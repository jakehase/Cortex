...
export function createConsentWorkbenchReportCards() {
...
export function createConsentWorkbenchReviewPackets() {
...
export function summarizeConsentWorkbenchReporting() {
  const cards = createConsentWorkbenchReportCards();
  const packets = createConsentWorkbenchReviewPackets();
  return {
