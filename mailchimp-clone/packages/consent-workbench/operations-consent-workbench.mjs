...
export function createConsentWorkbenchOperationsBoard() {
...
export function createConsentWorkbenchShiftChecklist() {
...
export function createConsentWorkbenchIncidentDeck() {
