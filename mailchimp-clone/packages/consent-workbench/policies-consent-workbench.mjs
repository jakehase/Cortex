...
export function createConsentWorkbenchPolicies(overrides = {}) {
...
export function validateConsentWorkbenchPolicies(policies = createConsentWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeConsentWorkbenchPolicies(policies = createConsentWorkbenchPolicies()) {
  return {
...
export function createConsentWorkbenchEscalationDeck(policies = createConsentWorkbenchPolicies()) {
