...
export function createLifecycleStudioOperationsBoard() {
...
export function createLifecycleStudioShiftChecklist() {
...
export function createLifecycleStudioIncidentDeck() {
