...
export function createLifecycleStudioAuditTrail() {
...
export function createLifecycleStudioEvidenceManifest() {
...
export function createLifecycleStudioReadinessAttestation() {
  const auditTrail = createLifecycleStudioAuditTrail();
  return {
