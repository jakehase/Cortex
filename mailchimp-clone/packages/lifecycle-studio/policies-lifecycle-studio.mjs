...
export function createLifecycleStudioPolicies(overrides = {}) {
...
export function validateLifecycleStudioPolicies(policies = createLifecycleStudioPolicies()) {
  const issues = [];
...
export function summarizeLifecycleStudioPolicies(policies = createLifecycleStudioPolicies()) {
  return {
...
export function createLifecycleStudioEscalationDeck(policies = createLifecycleStudioPolicies()) {
