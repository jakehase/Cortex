...
export function createCollaborationLedgerAuditTrail() {
...
export function createCollaborationLedgerEvidenceManifest() {
...
export function createCollaborationLedgerReadinessAttestation() {
  const auditTrail = createCollaborationLedgerAuditTrail();
  return {
