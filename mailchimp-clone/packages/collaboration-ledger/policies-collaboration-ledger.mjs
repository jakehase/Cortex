...
export function createCollaborationLedgerPolicies(overrides = {}) {
...
export function validateCollaborationLedgerPolicies(policies = createCollaborationLedgerPolicies()) {
  const issues = [];
...
export function summarizeCollaborationLedgerPolicies(policies = createCollaborationLedgerPolicies()) {
  return {
...
export function createCollaborationLedgerEscalationDeck(policies = createCollaborationLedgerPolicies()) {
