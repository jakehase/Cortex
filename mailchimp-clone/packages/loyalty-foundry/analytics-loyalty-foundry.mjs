...
export function createLoyaltyFoundryAnalyticsTimeline() {
...
export function createLoyaltyFoundryForecastEnvelope() {
...
export function createLoyaltyFoundryExceptionLedger() {
...
export function summarizeLoyaltyFoundryAnalytics() {
  const timeline = createLoyaltyFoundryAnalyticsTimeline();
  const forecast = createLoyaltyFoundryForecastEnvelope();
  return {
