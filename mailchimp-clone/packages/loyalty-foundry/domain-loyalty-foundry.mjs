...
export function createLoyaltyFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyFoundryWorkspace(workspace = createLoyaltyFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyFoundryNarratives(workspace = createLoyaltyFoundryWorkspace()) {
...
export function createLoyaltyFoundryCoverageGrid(workspace = createLoyaltyFoundryWorkspace()) {
