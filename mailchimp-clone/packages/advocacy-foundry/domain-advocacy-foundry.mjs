...
export function createAdvocacyFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyFoundryWorkspace(workspace = createAdvocacyFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyFoundryNarratives(workspace = createAdvocacyFoundryWorkspace()) {
...
export function createAdvocacyFoundryCoverageGrid(workspace = createAdvocacyFoundryWorkspace()) {
