...
export function createAdvocacyFoundryReportCards() {
...
export function createAdvocacyFoundryReviewPackets() {
...
export function summarizeAdvocacyFoundryReporting() {
  const cards = createAdvocacyFoundryReportCards();
  const packets = createAdvocacyFoundryReviewPackets();
  return {
