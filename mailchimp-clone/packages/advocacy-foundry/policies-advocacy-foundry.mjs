...
export function createAdvocacyFoundryPolicies(overrides = {}) {
...
export function validateAdvocacyFoundryPolicies(policies = createAdvocacyFoundryPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyFoundryPolicies(policies = createAdvocacyFoundryPolicies()) {
  return {
...
export function createAdvocacyFoundryEscalationDeck(policies = createAdvocacyFoundryPolicies()) {
