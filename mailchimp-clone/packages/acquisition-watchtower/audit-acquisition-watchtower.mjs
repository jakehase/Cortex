...
export function createAcquisitionWatchtowerAuditTrail() {
...
export function createAcquisitionWatchtowerEvidenceManifest() {
...
export function createAcquisitionWatchtowerReadinessAttestation() {
  const auditTrail = createAcquisitionWatchtowerAuditTrail();
  return {
