...
export function createCampaignIndexPolicies(overrides = {}) {
...
export function validateCampaignIndexPolicies(policies = createCampaignIndexPolicies()) {
  const issues = [];
...
export function summarizeCampaignIndexPolicies(policies = createCampaignIndexPolicies()) {
  return {
...
export function createCampaignIndexEscalationDeck(policies = createCampaignIndexPolicies()) {
