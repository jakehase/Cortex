const MODULE = {
  ...
  "focus": "Campaign Index covers campaign planning, milestone choreography, and launch readiness through searchable summaries and coverage catalogs.",
...
export function createCampaignIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignIndexWorkspace(workspace = createCampaignIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignIndexNarratives(workspace = createCampaignIndexWorkspace()) {
...
export function createCampaignIndexCoverageGrid(workspace = createCampaignIndexWorkspace()) {
