...
export function createCampaignIndexReportCards() {
...
export function createCampaignIndexReviewPackets() {
...
export function summarizeCampaignIndexReporting() {
  const cards = createCampaignIndexReportCards();
  const packets = createCampaignIndexReviewPackets();
  return {
