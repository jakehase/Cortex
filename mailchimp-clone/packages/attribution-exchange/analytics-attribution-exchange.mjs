...
export function createAttributionExchangeAnalyticsTimeline() {
...
export function createAttributionExchangeForecastEnvelope() {
...
export function createAttributionExchangeExceptionLedger() {
...
export function summarizeAttributionExchangeAnalytics() {
  const timeline = createAttributionExchangeAnalyticsTimeline();
  const forecast = createAttributionExchangeForecastEnvelope();
  return {
