...
export function createAttributionExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAttributionExchangeWorkspace(workspace = createAttributionExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createAttributionExchangeNarratives(workspace = createAttributionExchangeWorkspace()) {
...
export function createAttributionExchangeCoverageGrid(workspace = createAttributionExchangeWorkspace()) {
