...
export function createActivationLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationLedgerWorkspace(workspace = createActivationLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationLedgerNarratives(workspace = createActivationLedgerWorkspace()) {
...
export function createActivationLedgerCoverageGrid(workspace = createActivationLedgerWorkspace()) {
