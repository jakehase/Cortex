...
export function createActivationLedgerReportCards() {
...
export function createActivationLedgerReviewPackets() {
...
export function summarizeActivationLedgerReporting() {
  const cards = createActivationLedgerReportCards();
  const packets = createActivationLedgerReviewPackets();
  return {
