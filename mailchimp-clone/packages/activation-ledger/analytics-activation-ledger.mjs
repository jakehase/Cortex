...
export function createActivationLedgerAnalyticsTimeline() {
...
export function createActivationLedgerForecastEnvelope() {
...
export function createActivationLedgerExceptionLedger() {
...
export function summarizeActivationLedgerAnalytics() {
  const timeline = createActivationLedgerAnalyticsTimeline();
  const forecast = createActivationLedgerForecastEnvelope();
  return {
