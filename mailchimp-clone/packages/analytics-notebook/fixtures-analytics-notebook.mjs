...
export function createAnalyticsNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeAnalyticsNotebookFixtures(fixtures = createAnalyticsNotebookFixtures()) {
  return {
...
export function createAnalyticsNotebookDemoInputs() {
  return {
