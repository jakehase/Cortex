...
export function createAnalyticsNotebookReportCards() {
...
export function createAnalyticsNotebookReviewPackets() {
...
export function summarizeAnalyticsNotebookReporting() {
  const cards = createAnalyticsNotebookReportCards();
  const packets = createAnalyticsNotebookReviewPackets();
  return {
