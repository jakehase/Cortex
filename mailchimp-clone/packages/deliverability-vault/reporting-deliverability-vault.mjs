...
export function createDeliverabilityVaultReportCards() {
...
export function createDeliverabilityVaultReviewPackets() {
...
export function summarizeDeliverabilityVaultReporting() {
  const cards = createDeliverabilityVaultReportCards();
  const packets = createDeliverabilityVaultReviewPackets();
  return {
