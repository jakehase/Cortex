...
export function createInsightsWatchtowerOperationsBoard() {
...
export function createInsightsWatchtowerShiftChecklist() {
...
export function createInsightsWatchtowerIncidentDeck() {
