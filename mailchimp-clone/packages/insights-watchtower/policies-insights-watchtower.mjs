...
export function createInsightsWatchtowerPolicies(overrides = {}) {
...
export function validateInsightsWatchtowerPolicies(policies = createInsightsWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeInsightsWatchtowerPolicies(policies = createInsightsWatchtowerPolicies()) {
  return {
...
export function createInsightsWatchtowerEscalationDeck(policies = createInsightsWatchtowerPolicies()) {
