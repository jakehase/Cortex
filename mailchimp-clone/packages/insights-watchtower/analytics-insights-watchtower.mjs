...
export function createInsightsWatchtowerAnalyticsTimeline() {
...
export function createInsightsWatchtowerForecastEnvelope() {
...
export function createInsightsWatchtowerExceptionLedger() {
...
export function summarizeInsightsWatchtowerAnalytics() {
  const timeline = createInsightsWatchtowerAnalyticsTimeline();
  const forecast = createInsightsWatchtowerForecastEnvelope();
  return {
