const MODULE = {
  "id": "insights-watchtower",
  "ordinal": 457,
  "domain": "insights",
  "surfaceId": "watchtower",
  "surfaceTitle": "Watchtower",
  "routeSegment": "watchtower",
  "title": "Insights Watchtower",
  "focus": "Insights Watchtower covers insight synthesis, operating narratives, and executive-ready summaries through oversight dashboards and escalation views.",
  ...
  "tags": [
    ...
    "watchtower",
    "revenue",
    "insights-watchtower-wave-seven"
  ]
};
...
export function createInsightsWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsWatchtowerWorkspace(workspace = createInsightsWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsWatchtowerNarratives(workspace = createInsightsWatchtowerWorkspace()) {
...
export function createInsightsWatchtowerCoverageGrid(workspace = createInsightsWatchtowerWorkspace()) {
