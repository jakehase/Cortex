const MODULE = {
  "id": "audience-sentinel",
  "ordinal": 136,
  "domain": "audience",
  "surfaceId": "sentinel",
  "surfaceTitle": "Sentinel",
  "routeSegment": "sentinel",
  "title": "Audience Sentinel",
  "focus": "Audience Sentinel covers audience health, segment design, and targeting durability through alerts, anomaly watch, and guardrails.",
...
export function createAudienceSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceSentinelWorkspace(workspace = createAudienceSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceSentinelNarratives(workspace = createAudienceSentinelWorkspace()) {
...
export function createAudienceSentinelCoverageGrid(workspace = createAudienceSentinelWorkspace()) {
