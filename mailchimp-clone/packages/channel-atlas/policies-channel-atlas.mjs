...
export function createChannelAtlasPolicies(overrides = {}) {
...
export function validateChannelAtlasPolicies(policies = createChannelAtlasPolicies()) {
  const issues = [];
...
export function summarizeChannelAtlasPolicies(policies = createChannelAtlasPolicies()) {
  return {
...
export function createChannelAtlasEscalationDeck(policies = createChannelAtlasPolicies()) {
