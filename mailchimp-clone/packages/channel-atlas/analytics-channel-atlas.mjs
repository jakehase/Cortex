...
export function createChannelAtlasAnalyticsTimeline() {
...
export function createChannelAtlasForecastEnvelope() {
...
export function createChannelAtlasExceptionLedger() {
...
export function summarizeChannelAtlasAnalytics() {
  const timeline = createChannelAtlasAnalyticsTimeline();
  const forecast = createChannelAtlasForecastEnvelope();
  return {
