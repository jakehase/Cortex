...
export function createChannelAtlasAuditTrail() {
...
export function createChannelAtlasEvidenceManifest() {
...
export function createChannelAtlasReadinessAttestation() {
  const auditTrail = createChannelAtlasAuditTrail();
  return {
