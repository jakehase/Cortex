...
export function createCustomerNotebookOperationsBoard() {
...
export function createCustomerNotebookShiftChecklist() {
...
export function createCustomerNotebookIncidentDeck() {
