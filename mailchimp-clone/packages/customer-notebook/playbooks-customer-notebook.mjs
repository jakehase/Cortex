...
export function createCustomerNotebookPlaybooks() {
...
export function createCustomerNotebookDecisionDeck() {
...
export function createCustomerNotebookEscalationMoments() {
