...
export function createCustomerNotebookAuditTrail() {
...
export function createCustomerNotebookEvidenceManifest() {
...
export function createCustomerNotebookReadinessAttestation() {
  const auditTrail = createCustomerNotebookAuditTrail();
  return {
