...
export function createCustomerNotebookReportCards() {
...
export function createCustomerNotebookReviewPackets() {
...
export function summarizeCustomerNotebookReporting() {
  const cards = createCustomerNotebookReportCards();
  const packets = createCustomerNotebookReviewPackets();
  return {
