...
export function createCustomerNotebookAnalyticsTimeline() {
...
export function createCustomerNotebookForecastEnvelope() {
...
export function createCustomerNotebookExceptionLedger() {
...
export function summarizeCustomerNotebookAnalytics() {
  const timeline = createCustomerNotebookAnalyticsTimeline();
  const forecast = createCustomerNotebookForecastEnvelope();
  return {
