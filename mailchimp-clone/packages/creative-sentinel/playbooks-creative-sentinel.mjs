...
export function createCreativeSentinelPlaybooks() {
...
export function createCreativeSentinelDecisionDeck() {
...
export function createCreativeSentinelEscalationMoments() {
