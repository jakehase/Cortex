...
export function createCreativeSentinelOperationsBoard() {
...
export function createCreativeSentinelShiftChecklist() {
...
export function createCreativeSentinelIncidentDeck() {
