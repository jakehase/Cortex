...
export function createCreativeSentinelFixtures() {
  return {
    accounts: [
...
export function summarizeCreativeSentinelFixtures(fixtures = createCreativeSentinelFixtures()) {
  return {
...
export function createCreativeSentinelDemoInputs() {
  return {
