...
export function createCreativeSentinelPolicies(overrides = {}) {
...
export function validateCreativeSentinelPolicies(policies = createCreativeSentinelPolicies()) {
  const issues = [];
...
export function summarizeCreativeSentinelPolicies(policies = createCreativeSentinelPolicies()) {
  return {
...
export function createCreativeSentinelEscalationDeck(policies = createCreativeSentinelPolicies()) {
