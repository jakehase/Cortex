...
export function createCommerceNotebookReportCards() {
...
export function createCommerceNotebookReviewPackets() {
...
export function summarizeCommerceNotebookReporting() {
  const cards = createCommerceNotebookReportCards();
  const packets = createCommerceNotebookReviewPackets();
  return {
