...
export function createBenchmarkPlannerReportCards() {
...
export function createBenchmarkPlannerReviewPackets() {
...
export function summarizeBenchmarkPlannerReporting() {
  const cards = createBenchmarkPlannerReportCards();
  const packets = createBenchmarkPlannerReviewPackets();
  return {
