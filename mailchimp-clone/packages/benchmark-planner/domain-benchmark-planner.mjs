...
export function createBenchmarkPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBenchmarkPlannerWorkspace(workspace = createBenchmarkPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createBenchmarkPlannerNarratives(workspace = createBenchmarkPlannerWorkspace()) {
...
export function createBenchmarkPlannerCoverageGrid(workspace = createBenchmarkPlannerWorkspace()) {
