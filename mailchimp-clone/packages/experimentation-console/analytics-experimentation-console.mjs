...
export function createExperimentationConsoleAnalyticsTimeline() {
...
export function createExperimentationConsoleForecastEnvelope() {
...
export function createExperimentationConsoleExceptionLedger() {
...
export function summarizeExperimentationConsoleAnalytics() {
  const timeline = createExperimentationConsoleAnalyticsTimeline();
  const forecast = createExperimentationConsoleForecastEnvelope();
  return {
