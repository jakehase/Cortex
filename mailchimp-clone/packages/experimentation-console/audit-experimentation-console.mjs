...
export function createExperimentationConsoleAuditTrail() {
...
export function createExperimentationConsoleEvidenceManifest() {
...
export function createExperimentationConsoleReadinessAttestation() {
  const auditTrail = createExperimentationConsoleAuditTrail();
  return {
