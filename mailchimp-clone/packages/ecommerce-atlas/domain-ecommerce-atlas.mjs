const MODULE = {
  ...
  "surfaceTitle": "Atlas",
  "routeSegment": "atlas",
  "title": "Ecommerce Atlas",
  "focus": "Ecommerce Atlas covers order behavior, purchase flow posture, and commerce retention signals through landscape mapping and territory coverage.",
...
export function createEcommerceAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceAtlasWorkspace(workspace = createEcommerceAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceAtlasNarratives(workspace = createEcommerceAtlasWorkspace()) {
...
export function createEcommerceAtlasCoverageGrid(workspace = createEcommerceAtlasWorkspace()) {
