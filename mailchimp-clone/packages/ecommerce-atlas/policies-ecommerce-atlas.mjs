...
export function createEcommerceAtlasPolicies(overrides = {}) {
...
export function validateEcommerceAtlasPolicies(policies = createEcommerceAtlasPolicies()) {
  const issues = [];
...
export function summarizeEcommerceAtlasPolicies(policies = createEcommerceAtlasPolicies()) {
  return {
...
export function createEcommerceAtlasEscalationDeck(policies = createEcommerceAtlasPolicies()) {
