...
export function createActivationPlannerAnalyticsTimeline() {
...
export function createActivationPlannerForecastEnvelope() {
...
export function createActivationPlannerExceptionLedger() {
...
export function summarizeActivationPlannerAnalytics() {
  const timeline = createActivationPlannerAnalyticsTimeline();
  const forecast = createActivationPlannerForecastEnvelope();
  return {
