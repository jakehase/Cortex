...
export function createAudienceLedgerAuditTrail() {
...
export function createAudienceLedgerEvidenceManifest() {
...
export function createAudienceLedgerReadinessAttestation() {
  const auditTrail = createAudienceLedgerAuditTrail();
  return {
