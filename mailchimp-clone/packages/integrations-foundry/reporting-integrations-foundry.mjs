...
export function createIntegrationsFoundryReportCards() {
...
export function createIntegrationsFoundryReviewPackets() {
...
export function summarizeIntegrationsFoundryReporting() {
  const cards = createIntegrationsFoundryReportCards();
  const packets = createIntegrationsFoundryReviewPackets();
  return {
