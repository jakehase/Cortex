...
export function createIntegrationsFoundryPlaybooks() {
...
export function createIntegrationsFoundryDecisionDeck() {
...
export function createIntegrationsFoundryEscalationMoments() {
