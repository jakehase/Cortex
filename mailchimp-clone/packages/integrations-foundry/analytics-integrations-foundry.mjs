...
export function createIntegrationsFoundryAnalyticsTimeline() {
...
export function createIntegrationsFoundryForecastEnvelope() {
...
export function createIntegrationsFoundryExceptionLedger() {
...
export function summarizeIntegrationsFoundryAnalytics() {
  const timeline = createIntegrationsFoundryAnalyticsTimeline();
  const forecast = createIntegrationsFoundryForecastEnvelope();
  return {
