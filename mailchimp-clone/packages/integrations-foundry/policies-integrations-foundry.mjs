...
export function createIntegrationsFoundryPolicies(overrides = {}) {
...
export function validateIntegrationsFoundryPolicies(policies = createIntegrationsFoundryPolicies()) {
  const issues = [];
...
export function summarizeIntegrationsFoundryPolicies(policies = createIntegrationsFoundryPolicies()) {
  return {
...
export function createIntegrationsFoundryEscalationDeck(policies = createIntegrationsFoundryPolicies()) {
