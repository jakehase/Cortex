...
export function createIntegrationsFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsFoundryWorkspace(workspace = createIntegrationsFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsFoundryNarratives(workspace = createIntegrationsFoundryWorkspace()) {
...
export function createIntegrationsFoundryCoverageGrid(workspace = createIntegrationsFoundryWorkspace()) {
