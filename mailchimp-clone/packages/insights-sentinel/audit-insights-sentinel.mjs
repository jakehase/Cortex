...
export function createInsightsSentinelAuditTrail() {
...
export function createInsightsSentinelEvidenceManifest() {
...
export function createInsightsSentinelReadinessAttestation() {
  const auditTrail = createInsightsSentinelAuditTrail();
  return {
