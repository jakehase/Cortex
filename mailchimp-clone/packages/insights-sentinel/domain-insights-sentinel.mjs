const MODULE = {
  "id": "insights-sentinel",
  "ordinal": 454,
  "domain": "insights",
  "surfaceId": "sentinel",
  "surfaceTitle": "Sentinel",
  "routeSegment": "sentinel",
  "title": "Insights Sentinel",
  "focus": "Insights Sentinel covers insight synthesis, operating narratives, and executive-ready summaries through alerts, anomaly watch, and guardrails.",
...
export function createInsightsSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsSentinelWorkspace(workspace = createInsightsSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsSentinelNarratives(workspace = createInsightsSentinelWorkspace()) {
...
export function createInsightsSentinelCoverageGrid(workspace = createInsightsSentinelWorkspace()) {
