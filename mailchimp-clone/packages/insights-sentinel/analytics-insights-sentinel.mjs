...
export function createInsightsSentinelAnalyticsTimeline() {
...
export function createInsightsSentinelForecastEnvelope() {
...
export function createInsightsSentinelExceptionLedger() {
...
export function summarizeInsightsSentinelAnalytics() {
  const timeline = createInsightsSentinelAnalyticsTimeline();
  const forecast = createInsightsSentinelForecastEnvelope();
  return {
