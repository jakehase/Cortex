...
export function createEcommerceAdvisorOperationsBoard() {
...
export function createEcommerceAdvisorShiftChecklist() {
...
export function createEcommerceAdvisorIncidentDeck() {
