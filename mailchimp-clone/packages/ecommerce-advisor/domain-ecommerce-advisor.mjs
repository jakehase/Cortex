...
export function createEcommerceAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceAdvisorWorkspace(workspace = createEcommerceAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceAdvisorNarratives(workspace = createEcommerceAdvisorWorkspace()) {
...
export function createEcommerceAdvisorCoverageGrid(workspace = createEcommerceAdvisorWorkspace()) {
