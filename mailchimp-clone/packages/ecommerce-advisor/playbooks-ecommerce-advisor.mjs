...
export function createEcommerceAdvisorPlaybooks() {
...
export function createEcommerceAdvisorDecisionDeck() {
...
export function createEcommerceAdvisorEscalationMoments() {
