...
export function createAudienceConsoleAnalyticsTimeline() {
...
export function createAudienceConsoleForecastEnvelope() {
...
export function createAudienceConsoleExceptionLedger() {
...
export function summarizeAudienceConsoleAnalytics() {
  const timeline = createAudienceConsoleAnalyticsTimeline();
  const forecast = createAudienceConsoleForecastEnvelope();
  return {
