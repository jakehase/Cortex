...
export function createAudienceConsoleAuditTrail() {
...
export function createAudienceConsoleEvidenceManifest() {
...
export function createAudienceConsoleReadinessAttestation() {
  const auditTrail = createAudienceConsoleAuditTrail();
  return {
