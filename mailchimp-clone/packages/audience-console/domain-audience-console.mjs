const MODULE = {
  ...
  "focus": "Audience Console covers audience health, segment design, and targeting durability through execution controls and workspace steering.",
...
export function createAudienceConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceConsoleWorkspace(workspace = createAudienceConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceConsoleNarratives(workspace = createAudienceConsoleWorkspace()) {
...
export function createAudienceConsoleCoverageGrid(workspace = createAudienceConsoleWorkspace()) {
