...
export function createAdvocacyConsolePolicies(overrides = {}) {
...
export function validateAdvocacyConsolePolicies(policies = createAdvocacyConsolePolicies()) {
  const issues = [];
...
export function summarizeAdvocacyConsolePolicies(policies = createAdvocacyConsolePolicies()) {
  return {
...
export function createAdvocacyConsoleEscalationDeck(policies = createAdvocacyConsolePolicies()) {
