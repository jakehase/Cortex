...
export function createAdvocacyConsoleReportCards() {
...
export function createAdvocacyConsoleReviewPackets() {
...
export function summarizeAdvocacyConsoleReporting() {
  const cards = createAdvocacyConsoleReportCards();
  const packets = createAdvocacyConsoleReviewPackets();
  return {
