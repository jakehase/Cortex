const MODULE = {
  ...
  "title": "Advocacy Console",
  "focus": "Advocacy Console covers customer champions, referral readiness, and proof-sharing loops through execution controls and workspace steering.",
...
export function createAdvocacyConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyConsoleWorkspace(workspace = createAdvocacyConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyConsoleNarratives(workspace = createAdvocacyConsoleWorkspace()) {
...
export function createAdvocacyConsoleCoverageGrid(workspace = createAdvocacyConsoleWorkspace()) {
