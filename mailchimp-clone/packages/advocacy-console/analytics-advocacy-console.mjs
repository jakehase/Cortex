...
export function createAdvocacyConsoleAnalyticsTimeline() {
...
export function createAdvocacyConsoleForecastEnvelope() {
...
export function createAdvocacyConsoleExceptionLedger() {
...
export function summarizeAdvocacyConsoleAnalytics() {
  const timeline = createAdvocacyConsoleAnalyticsTimeline();
  const forecast = createAdvocacyConsoleForecastEnvelope();
  return {
