...
export function createCollaborationFoundryReportCards() {
...
export function createCollaborationFoundryReviewPackets() {
...
export function summarizeCollaborationFoundryReporting() {
  const cards = createCollaborationFoundryReportCards();
  const packets = createCollaborationFoundryReviewPackets();
  return {
