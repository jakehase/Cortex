...
export function createCollaborationFoundryAuditTrail() {
...
export function createCollaborationFoundryEvidenceManifest() {
...
export function createCollaborationFoundryReadinessAttestation() {
  const auditTrail = createCollaborationFoundryAuditTrail();
  return {
