...
export function createActivationWorkbenchAuditTrail() {
...
export function createActivationWorkbenchEvidenceManifest() {
...
export function createActivationWorkbenchReadinessAttestation() {
  const auditTrail = createActivationWorkbenchAuditTrail();
  return {
