...
export function createActivationWorkbenchAnalyticsTimeline() {
...
export function createActivationWorkbenchForecastEnvelope() {
...
export function createActivationWorkbenchExceptionLedger() {
...
export function summarizeActivationWorkbenchAnalytics() {
  const timeline = createActivationWorkbenchAnalyticsTimeline();
  const forecast = createActivationWorkbenchForecastEnvelope();
  return {
