...
export function createActivationWorkbenchPolicies(overrides = {}) {
...
export function validateActivationWorkbenchPolicies(policies = createActivationWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeActivationWorkbenchPolicies(policies = createActivationWorkbenchPolicies()) {
  return {
...
export function createActivationWorkbenchEscalationDeck(policies = createActivationWorkbenchPolicies()) {
