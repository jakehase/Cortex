...
export function createAutomationWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAutomationWorkbenchWorkspace(workspace = createAutomationWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createAutomationWorkbenchNarratives(workspace = createAutomationWorkbenchWorkspace()) {
...
export function createAutomationWorkbenchCoverageGrid(workspace = createAutomationWorkbenchWorkspace()) {
