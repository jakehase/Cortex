...
export function createAutomationWorkbenchPolicies(overrides = {}) {
...
export function validateAutomationWorkbenchPolicies(policies = createAutomationWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeAutomationWorkbenchPolicies(policies = createAutomationWorkbenchPolicies()) {
  return {
...
export function createAutomationWorkbenchEscalationDeck(policies = createAutomationWorkbenchPolicies()) {
