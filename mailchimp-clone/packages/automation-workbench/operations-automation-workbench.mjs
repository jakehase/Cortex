...
export function createAutomationWorkbenchOperationsBoard() {
...
export function createAutomationWorkbenchShiftChecklist() {
...
export function createAutomationWorkbenchIncidentDeck() {
