...
export function createAutomationWorkbenchAuditTrail() {
...
export function createAutomationWorkbenchEvidenceManifest() {
...
export function createAutomationWorkbenchReadinessAttestation() {
  const auditTrail = createAutomationWorkbenchAuditTrail();
  return {
