...
export function createAutomationWorkbenchAnalyticsTimeline() {
...
export function createAutomationWorkbenchForecastEnvelope() {
...
export function createAutomationWorkbenchExceptionLedger() {
...
export function summarizeAutomationWorkbenchAnalytics() {
  const timeline = createAutomationWorkbenchAnalyticsTimeline();
  const forecast = createAutomationWorkbenchForecastEnvelope();
  return {
