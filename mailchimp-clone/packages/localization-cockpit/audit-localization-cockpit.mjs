...
export function createLocalizationCockpitAuditTrail() {
...
export function createLocalizationCockpitEvidenceManifest() {
...
export function createLocalizationCockpitReadinessAttestation() {
  const auditTrail = createLocalizationCockpitAuditTrail();
  return {
