...
export function createLocalizationCockpitPolicies(overrides = {}) {
...
export function validateLocalizationCockpitPolicies(policies = createLocalizationCockpitPolicies()) {
  const issues = [];
...
export function summarizeLocalizationCockpitPolicies(policies = createLocalizationCockpitPolicies()) {
  return {
...
export function createLocalizationCockpitEscalationDeck(policies = createLocalizationCockpitPolicies()) {
