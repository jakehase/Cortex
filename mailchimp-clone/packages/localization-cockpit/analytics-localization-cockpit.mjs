...
export function createLocalizationCockpitAnalyticsTimeline() {
...
export function createLocalizationCockpitForecastEnvelope() {
...
export function createLocalizationCockpitExceptionLedger() {
...
export function summarizeLocalizationCockpitAnalytics() {
  const timeline = createLocalizationCockpitAnalyticsTimeline();
  const forecast = createLocalizationCockpitForecastEnvelope();
  return {
