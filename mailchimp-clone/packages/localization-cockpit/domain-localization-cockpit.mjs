...
export function createLocalizationCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationCockpitWorkspace(workspace = createLocalizationCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationCockpitNarratives(workspace = createLocalizationCockpitWorkspace()) {
...
export function createLocalizationCockpitCoverageGrid(workspace = createLocalizationCockpitWorkspace()) {
