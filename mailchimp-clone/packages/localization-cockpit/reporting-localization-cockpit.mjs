...
export function createLocalizationCockpitReportCards() {
...
export function createLocalizationCockpitReviewPackets() {
...
export function summarizeLocalizationCockpitReporting() {
  const cards = createLocalizationCockpitReportCards();
  const packets = createLocalizationCockpitReviewPackets();
  return {
