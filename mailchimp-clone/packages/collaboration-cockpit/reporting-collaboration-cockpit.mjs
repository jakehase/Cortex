...
export function createCollaborationCockpitReportCards() {
...
export function createCollaborationCockpitReviewPackets() {
...
export function summarizeCollaborationCockpitReporting() {
  const cards = createCollaborationCockpitReportCards();
  const packets = createCollaborationCockpitReviewPackets();
  return {
