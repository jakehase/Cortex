...
export function createCollaborationCockpitAuditTrail() {
...
export function createCollaborationCockpitEvidenceManifest() {
...
export function createCollaborationCockpitReadinessAttestation() {
  const auditTrail = createCollaborationCockpitAuditTrail();
  return {
