...
export function createCollaborationCockpitPolicies(overrides = {}) {
...
export function validateCollaborationCockpitPolicies(policies = createCollaborationCockpitPolicies()) {
  const issues = [];
...
export function summarizeCollaborationCockpitPolicies(policies = createCollaborationCockpitPolicies()) {
  return {
...
export function createCollaborationCockpitEscalationDeck(policies = createCollaborationCockpitPolicies()) {
