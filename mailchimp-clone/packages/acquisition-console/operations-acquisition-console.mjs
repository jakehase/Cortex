...
export function createAcquisitionConsoleOperationsBoard() {
...
export function createAcquisitionConsoleShiftChecklist() {
...
export function createAcquisitionConsoleIncidentDeck() {
