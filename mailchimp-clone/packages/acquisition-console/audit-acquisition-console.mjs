...
export function createAcquisitionConsoleAuditTrail() {
...
export function createAcquisitionConsoleEvidenceManifest() {
...
export function createAcquisitionConsoleReadinessAttestation() {
  const auditTrail = createAcquisitionConsoleAuditTrail();
  return {
