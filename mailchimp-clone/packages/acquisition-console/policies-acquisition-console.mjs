...
export function createAcquisitionConsolePolicies(overrides = {}) {
...
export function validateAcquisitionConsolePolicies(policies = createAcquisitionConsolePolicies()) {
  const issues = [];
...
export function summarizeAcquisitionConsolePolicies(policies = createAcquisitionConsolePolicies()) {
  return {
...
export function createAcquisitionConsoleEscalationDeck(policies = createAcquisitionConsolePolicies()) {
