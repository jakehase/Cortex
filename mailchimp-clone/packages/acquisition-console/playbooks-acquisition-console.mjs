...
export function createAcquisitionConsolePlaybooks() {
...
export function createAcquisitionConsoleDecisionDeck() {
...
export function createAcquisitionConsoleEscalationMoments() {
