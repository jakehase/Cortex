...
export function createCommerceAtlasPolicies(overrides = {}) {
...
export function validateCommerceAtlasPolicies(policies = createCommerceAtlasPolicies()) {
  const issues = [];
...
export function summarizeCommerceAtlasPolicies(policies = createCommerceAtlasPolicies()) {
  return {
...
export function createCommerceAtlasEscalationDeck(policies = createCommerceAtlasPolicies()) {
