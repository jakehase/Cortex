...
export function createAnalyticsHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsHubWorkspace(workspace = createAnalyticsHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsHubNarratives(workspace = createAnalyticsHubWorkspace()) {
...
export function createAnalyticsHubCoverageGrid(workspace = createAnalyticsHubWorkspace()) {
