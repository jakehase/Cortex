...
export function createAnalyticsHubReportCards() {
...
export function createAnalyticsHubReviewPackets() {
...
export function summarizeAnalyticsHubReporting() {
  const cards = createAnalyticsHubReportCards();
  const packets = createAnalyticsHubReviewPackets();
  return {
