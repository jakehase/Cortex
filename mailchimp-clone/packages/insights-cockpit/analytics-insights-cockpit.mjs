...
export function createInsightsCockpitAnalyticsTimeline() {
...
export function createInsightsCockpitForecastEnvelope() {
...
export function createInsightsCockpitExceptionLedger() {
...
export function summarizeInsightsCockpitAnalytics() {
  const timeline = createInsightsCockpitAnalyticsTimeline();
  const forecast = createInsightsCockpitForecastEnvelope();
  return {
