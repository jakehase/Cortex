...
export function createInsightsCockpitAuditTrail() {
...
export function createInsightsCockpitEvidenceManifest() {
...
export function createInsightsCockpitReadinessAttestation() {
  const auditTrail = createInsightsCockpitAuditTrail();
  return {
