...
export function createInsightsCockpitOperationsBoard() {
...
export function createInsightsCockpitShiftChecklist() {
...
export function createInsightsCockpitIncidentDeck() {
