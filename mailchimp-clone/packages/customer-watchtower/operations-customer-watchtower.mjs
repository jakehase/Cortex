...
export function createCustomerWatchtowerOperationsBoard() {
...
export function createCustomerWatchtowerShiftChecklist() {
...
export function createCustomerWatchtowerIncidentDeck() {
