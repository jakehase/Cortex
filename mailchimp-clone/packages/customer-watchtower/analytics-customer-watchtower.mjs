...
export function createCustomerWatchtowerAnalyticsTimeline() {
...
export function createCustomerWatchtowerForecastEnvelope() {
...
export function createCustomerWatchtowerExceptionLedger() {
...
export function summarizeCustomerWatchtowerAnalytics() {
  const timeline = createCustomerWatchtowerAnalyticsTimeline();
  const forecast = createCustomerWatchtowerForecastEnvelope();
  return {
