...
export function createCustomerWatchtowerPlaybooks() {
...
export function createCustomerWatchtowerDecisionDeck() {
...
export function createCustomerWatchtowerEscalationMoments() {
