...
export function createAutomationNavigatorPolicies(overrides = {}) {
...
export function validateAutomationNavigatorPolicies(policies = createAutomationNavigatorPolicies()) {
  const issues = [];
...
export function summarizeAutomationNavigatorPolicies(policies = createAutomationNavigatorPolicies()) {
  return {
...
export function createAutomationNavigatorEscalationDeck(policies = createAutomationNavigatorPolicies()) {
