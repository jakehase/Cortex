const MODULE = {
  "id": "automation-navigator",
  "ordinal": 112,
  "domain": "automation",
  "surfaceId": "navigator",
  "surfaceTitle": "Navigator",
  "routeSegment": "navigator",
  "title": "Automation Navigator",
  "focus": "Automation Navigator covers triggered lifecycle programs, timing controls, and operator confidence through journey guidance and directional controls.",
  ...
  "tags": [
    ...
    "navigator",
    "lifecycle",
    "automation-navigator-wave-seven"
  ]
};
...
export function createAutomationNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAutomationNavigatorWorkspace(workspace = createAutomationNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAutomationNavigatorNarratives(workspace = createAutomationNavigatorWorkspace()) {
...
export function createAutomationNavigatorCoverageGrid(workspace = createAutomationNavigatorWorkspace()) {
