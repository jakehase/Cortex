...
export function createAutomationNavigatorOperationsBoard() {
...
export function createAutomationNavigatorShiftChecklist() {
...
export function createAutomationNavigatorIncidentDeck() {
