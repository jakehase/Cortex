...
export function createAutomationNavigatorReportCards() {
...
export function createAutomationNavigatorReviewPackets() {
...
export function summarizeAutomationNavigatorReporting() {
  const cards = createAutomationNavigatorReportCards();
  const packets = createAutomationNavigatorReviewPackets();
  return {
