...
export function createAutomationNavigatorAuditTrail() {
...
export function createAutomationNavigatorEvidenceManifest() {
...
export function createAutomationNavigatorReadinessAttestation() {
  const auditTrail = createAutomationNavigatorAuditTrail();
  return {
