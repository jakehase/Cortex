...
export function createBenchmarkWatchtowerAnalyticsTimeline() {
...
export function createBenchmarkWatchtowerForecastEnvelope() {
...
export function createBenchmarkWatchtowerExceptionLedger() {
...
export function summarizeBenchmarkWatchtowerAnalytics() {
  const timeline = createBenchmarkWatchtowerAnalyticsTimeline();
  const forecast = createBenchmarkWatchtowerForecastEnvelope();
  return {
