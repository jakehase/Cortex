...
export function createBenchmarkWatchtowerAuditTrail() {
...
export function createBenchmarkWatchtowerEvidenceManifest() {
...
export function createBenchmarkWatchtowerReadinessAttestation() {
  const auditTrail = createBenchmarkWatchtowerAuditTrail();
  return {
