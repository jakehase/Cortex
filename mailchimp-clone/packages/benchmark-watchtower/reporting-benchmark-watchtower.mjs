...
export function createBenchmarkWatchtowerReportCards() {
...
export function createBenchmarkWatchtowerReviewPackets() {
...
export function summarizeBenchmarkWatchtowerReporting() {
  const cards = createBenchmarkWatchtowerReportCards();
  const packets = createBenchmarkWatchtowerReviewPackets();
  return {
