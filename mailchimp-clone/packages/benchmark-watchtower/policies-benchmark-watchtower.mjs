...
export function createBenchmarkWatchtowerPolicies(overrides = {}) {
...
export function validateBenchmarkWatchtowerPolicies(policies = createBenchmarkWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkWatchtowerPolicies(policies = createBenchmarkWatchtowerPolicies()) {
  return {
...
export function createBenchmarkWatchtowerEscalationDeck(policies = createBenchmarkWatchtowerPolicies()) {
