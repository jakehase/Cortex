...
export function createCreativeWorkbenchPolicies(overrides = {}) {
...
export function validateCreativeWorkbenchPolicies(policies = createCreativeWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeCreativeWorkbenchPolicies(policies = createCreativeWorkbenchPolicies()) {
  return {
...
export function createCreativeWorkbenchEscalationDeck(policies = createCreativeWorkbenchPolicies()) {
