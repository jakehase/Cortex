...
export function createCollaborationConsoleOperationsBoard() {
...
export function createCollaborationConsoleShiftChecklist() {
...
export function createCollaborationConsoleIncidentDeck() {
