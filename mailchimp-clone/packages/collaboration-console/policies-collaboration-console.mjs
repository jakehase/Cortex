...
export function createCollaborationConsolePolicies(overrides = {}) {
...
export function validateCollaborationConsolePolicies(policies = createCollaborationConsolePolicies()) {
  const issues = [];
...
export function summarizeCollaborationConsolePolicies(policies = createCollaborationConsolePolicies()) {
  return {
...
export function createCollaborationConsoleEscalationDeck(policies = createCollaborationConsolePolicies()) {
