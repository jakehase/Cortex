...
export function createCollaborationConsoleReportCards() {
...
export function createCollaborationConsoleReviewPackets() {
...
export function summarizeCollaborationConsoleReporting() {
  const cards = createCollaborationConsoleReportCards();
  const packets = createCollaborationConsoleReviewPackets();
  return {
