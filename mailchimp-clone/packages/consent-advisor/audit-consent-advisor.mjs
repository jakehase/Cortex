...
export function createConsentAdvisorAuditTrail() {
...
export function createConsentAdvisorEvidenceManifest() {
...
export function createConsentAdvisorReadinessAttestation() {
  const auditTrail = createConsentAdvisorAuditTrail();
  return {
