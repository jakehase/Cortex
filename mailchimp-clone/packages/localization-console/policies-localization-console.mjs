...
export function createLocalizationConsolePolicies(overrides = {}) {
...
export function validateLocalizationConsolePolicies(policies = createLocalizationConsolePolicies()) {
  const issues = [];
...
export function summarizeLocalizationConsolePolicies(policies = createLocalizationConsolePolicies()) {
  return {
...
export function createLocalizationConsoleEscalationDeck(policies = createLocalizationConsolePolicies()) {
