...
export function createLocalizationConsoleAnalyticsTimeline() {
...
export function createLocalizationConsoleForecastEnvelope() {
...
export function createLocalizationConsoleExceptionLedger() {
...
export function summarizeLocalizationConsoleAnalytics() {
  const timeline = createLocalizationConsoleAnalyticsTimeline();
  const forecast = createLocalizationConsoleForecastEnvelope();
  return {
