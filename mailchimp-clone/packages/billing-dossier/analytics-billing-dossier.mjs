...
export function createBillingDossierAnalyticsTimeline() {
...
export function createBillingDossierForecastEnvelope() {
...
export function createBillingDossierExceptionLedger() {
...
export function summarizeBillingDossierAnalytics() {
  const timeline = createBillingDossierAnalyticsTimeline();
  const forecast = createBillingDossierForecastEnvelope();
  return {
