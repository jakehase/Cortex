...
export function createLoyaltyDossierReportCards() {
...
export function createLoyaltyDossierReviewPackets() {
...
export function summarizeLoyaltyDossierReporting() {
  const cards = createLoyaltyDossierReportCards();
  const packets = createLoyaltyDossierReviewPackets();
  return {
