...
export function createLoyaltyDossierPolicies(overrides = {}) {
...
export function validateLoyaltyDossierPolicies(policies = createLoyaltyDossierPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyDossierPolicies(policies = createLoyaltyDossierPolicies()) {
  return {
...
export function createLoyaltyDossierEscalationDeck(policies = createLoyaltyDossierPolicies()) {
