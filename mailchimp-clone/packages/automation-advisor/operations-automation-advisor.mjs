...
export function createAutomationAdvisorOperationsBoard() {
...
export function createAutomationAdvisorShiftChecklist() {
...
export function createAutomationAdvisorIncidentDeck() {
