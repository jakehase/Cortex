...
export function createAttributionDossierAuditTrail() {
...
export function createAttributionDossierEvidenceManifest() {
...
export function createAttributionDossierReadinessAttestation() {
  const auditTrail = createAttributionDossierAuditTrail();
  return {
