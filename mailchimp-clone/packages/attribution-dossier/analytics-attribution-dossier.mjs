...
export function createAttributionDossierAnalyticsTimeline() {
...
export function createAttributionDossierForecastEnvelope() {
...
export function createAttributionDossierExceptionLedger() {
...
export function summarizeAttributionDossierAnalytics() {
  const timeline = createAttributionDossierAnalyticsTimeline();
  const forecast = createAttributionDossierForecastEnvelope();
  return {
