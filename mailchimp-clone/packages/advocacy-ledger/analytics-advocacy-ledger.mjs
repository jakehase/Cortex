...
export function createAdvocacyLedgerAnalyticsTimeline() {
...
export function createAdvocacyLedgerForecastEnvelope() {
...
export function createAdvocacyLedgerExceptionLedger() {
...
export function summarizeAdvocacyLedgerAnalytics() {
  const timeline = createAdvocacyLedgerAnalyticsTimeline();
  const forecast = createAdvocacyLedgerForecastEnvelope();
  return {
