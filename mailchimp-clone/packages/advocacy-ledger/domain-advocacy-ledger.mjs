...
export function createAdvocacyLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyLedgerWorkspace(workspace = createAdvocacyLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyLedgerNarratives(workspace = createAdvocacyLedgerWorkspace()) {
...
export function createAdvocacyLedgerCoverageGrid(workspace = createAdvocacyLedgerWorkspace()) {
