...
export function createDataIndexAnalyticsTimeline() {
...
export function createDataIndexForecastEnvelope() {
...
export function createDataIndexExceptionLedger() {
...
export function summarizeDataIndexAnalytics() {
  const timeline = createDataIndexAnalyticsTimeline();
  const forecast = createDataIndexForecastEnvelope();
  return {
