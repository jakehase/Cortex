...
export function createLoyaltyWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyWatchtowerWorkspace(workspace = createLoyaltyWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyWatchtowerNarratives(workspace = createLoyaltyWatchtowerWorkspace()) {
...
export function createLoyaltyWatchtowerCoverageGrid(workspace = createLoyaltyWatchtowerWorkspace()) {
