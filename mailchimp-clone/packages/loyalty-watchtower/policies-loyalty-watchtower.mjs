...
export function createLoyaltyWatchtowerPolicies(overrides = {}) {
...
export function validateLoyaltyWatchtowerPolicies(policies = createLoyaltyWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyWatchtowerPolicies(policies = createLoyaltyWatchtowerPolicies()) {
  return {
...
export function createLoyaltyWatchtowerEscalationDeck(policies = createLoyaltyWatchtowerPolicies()) {
