...
export function createLoyaltyWatchtowerPlaybooks() {
...
export function createLoyaltyWatchtowerDecisionDeck() {
...
export function createLoyaltyWatchtowerEscalationMoments() {
