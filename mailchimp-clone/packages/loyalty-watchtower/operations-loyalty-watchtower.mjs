...
export function createLoyaltyWatchtowerOperationsBoard() {
...
export function createLoyaltyWatchtowerShiftChecklist() {
...
export function createLoyaltyWatchtowerIncidentDeck() {
