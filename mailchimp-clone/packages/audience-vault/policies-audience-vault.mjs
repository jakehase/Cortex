...
export function createAudienceVaultPolicies(overrides = {}) {
...
export function validateAudienceVaultPolicies(policies = createAudienceVaultPolicies()) {
  const issues = [];
...
export function summarizeAudienceVaultPolicies(policies = createAudienceVaultPolicies()) {
  return {
...
export function createAudienceVaultEscalationDeck(policies = createAudienceVaultPolicies()) {
