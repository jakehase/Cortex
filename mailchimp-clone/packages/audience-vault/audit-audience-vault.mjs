...
export function createAudienceVaultAuditTrail() {
...
export function createAudienceVaultEvidenceManifest() {
...
export function createAudienceVaultReadinessAttestation() {
  const auditTrail = createAudienceVaultAuditTrail();
  return {
