...
export function createExperimentationScorecardAuditTrail() {
...
export function createExperimentationScorecardEvidenceManifest() {
...
export function createExperimentationScorecardReadinessAttestation() {
  const auditTrail = createExperimentationScorecardAuditTrail();
  return {
