...
export function createExperimentationScorecardAnalyticsTimeline() {
...
export function createExperimentationScorecardForecastEnvelope() {
...
export function createExperimentationScorecardExceptionLedger() {
...
export function summarizeExperimentationScorecardAnalytics() {
  const timeline = createExperimentationScorecardAnalyticsTimeline();
  const forecast = createExperimentationScorecardForecastEnvelope();
  return {
