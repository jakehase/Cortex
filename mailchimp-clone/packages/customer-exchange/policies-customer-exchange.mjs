...
export function createCustomerExchangePolicies(overrides = {}) {
...
export function validateCustomerExchangePolicies(policies = createCustomerExchangePolicies()) {
  const issues = [];
...
export function summarizeCustomerExchangePolicies(policies = createCustomerExchangePolicies()) {
  return {
...
export function createCustomerExchangeEscalationDeck(policies = createCustomerExchangePolicies()) {
