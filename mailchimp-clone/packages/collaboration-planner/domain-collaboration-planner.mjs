const MODULE = {
  ...
  "focus": "Collaboration Planner covers shared ownership, approvals, and cross-functional motion through calendar planning and execution choreography.",
  ...
  "tags": [
    ...
    "planner",
    "lifecycle",
    "collaboration-planner-wave-seven"
  ]
};
...
export function createCollaborationPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationPlannerWorkspace(workspace = createCollaborationPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationPlannerNarratives(workspace = createCollaborationPlannerWorkspace()) {
...
export function createCollaborationPlannerCoverageGrid(workspace = createCollaborationPlannerWorkspace()) {
