...
export function createCollaborationPlannerPolicies(overrides = {}) {
...
export function validateCollaborationPlannerPolicies(policies = createCollaborationPlannerPolicies()) {
  const issues = [];
...
export function summarizeCollaborationPlannerPolicies(policies = createCollaborationPlannerPolicies()) {
  return {
...
export function createCollaborationPlannerEscalationDeck(policies = createCollaborationPlannerPolicies()) {
