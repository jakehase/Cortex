...
export function createDeliverabilityScorecardAnalyticsTimeline() {
...
export function createDeliverabilityScorecardForecastEnvelope() {
...
export function createDeliverabilityScorecardExceptionLedger() {
...
export function summarizeDeliverabilityScorecardAnalytics() {
  const timeline = createDeliverabilityScorecardAnalyticsTimeline();
  const forecast = createDeliverabilityScorecardForecastEnvelope();
  return {
