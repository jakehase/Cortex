...
export function createDeliverabilityScorecardPolicies(overrides = {}) {
...
export function validateDeliverabilityScorecardPolicies(policies = createDeliverabilityScorecardPolicies()) {
  const issues = [];
...
export function summarizeDeliverabilityScorecardPolicies(policies = createDeliverabilityScorecardPolicies()) {
  return {
...
export function createDeliverabilityScorecardEscalationDeck(policies = createDeliverabilityScorecardPolicies()) {
