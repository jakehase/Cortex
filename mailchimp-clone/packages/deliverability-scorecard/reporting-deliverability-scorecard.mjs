...
export function createDeliverabilityScorecardReportCards() {
...
export function createDeliverabilityScorecardReviewPackets() {
...
export function summarizeDeliverabilityScorecardReporting() {
  const cards = createDeliverabilityScorecardReportCards();
  const packets = createDeliverabilityScorecardReviewPackets();
  return {
