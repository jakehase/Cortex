...
export function createAdvocacyAtlasPolicies(overrides = {}) {
...
export function validateAdvocacyAtlasPolicies(policies = createAdvocacyAtlasPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyAtlasPolicies(policies = createAdvocacyAtlasPolicies()) {
  return {
...
export function createAdvocacyAtlasEscalationDeck(policies = createAdvocacyAtlasPolicies()) {
