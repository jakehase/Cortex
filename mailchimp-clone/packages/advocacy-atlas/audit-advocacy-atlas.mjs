...
export function createAdvocacyAtlasAuditTrail() {
...
export function createAdvocacyAtlasEvidenceManifest() {
...
export function createAdvocacyAtlasReadinessAttestation() {
  const auditTrail = createAdvocacyAtlasAuditTrail();
  return {
