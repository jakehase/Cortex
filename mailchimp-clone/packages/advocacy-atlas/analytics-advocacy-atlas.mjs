...
export function createAdvocacyAtlasAnalyticsTimeline() {
...
export function createAdvocacyAtlasForecastEnvelope() {
...
export function createAdvocacyAtlasExceptionLedger() {
...
export function summarizeAdvocacyAtlasAnalytics() {
  const timeline = createAdvocacyAtlasAnalyticsTimeline();
  const forecast = createAdvocacyAtlasForecastEnvelope();
  return {
