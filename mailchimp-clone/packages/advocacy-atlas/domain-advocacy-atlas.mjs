const MODULE = {
  ...
  "surfaceTitle": "Atlas",
  "routeSegment": "atlas",
  "title": "Advocacy Atlas",
  "focus": "Advocacy Atlas covers customer champions, referral readiness, and proof-sharing loops through landscape mapping and territory coverage.",
...
export function createAdvocacyAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyAtlasWorkspace(workspace = createAdvocacyAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyAtlasNarratives(workspace = createAdvocacyAtlasWorkspace()) {
...
export function createAdvocacyAtlasCoverageGrid(workspace = createAdvocacyAtlasWorkspace()) {
