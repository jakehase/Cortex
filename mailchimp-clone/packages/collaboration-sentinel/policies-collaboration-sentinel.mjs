...
export function createCollaborationSentinelPolicies(overrides = {}) {
...
export function validateCollaborationSentinelPolicies(policies = createCollaborationSentinelPolicies()) {
  const issues = [];
...
export function summarizeCollaborationSentinelPolicies(policies = createCollaborationSentinelPolicies()) {
  return {
...
export function createCollaborationSentinelEscalationDeck(policies = createCollaborationSentinelPolicies()) {
