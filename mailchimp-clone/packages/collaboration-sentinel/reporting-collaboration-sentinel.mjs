...
export function createCollaborationSentinelReportCards() {
...
export function createCollaborationSentinelReviewPackets() {
...
export function summarizeCollaborationSentinelReporting() {
  const cards = createCollaborationSentinelReportCards();
  const packets = createCollaborationSentinelReviewPackets();
  return {
