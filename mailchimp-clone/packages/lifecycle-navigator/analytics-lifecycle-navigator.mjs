...
export function createLifecycleNavigatorAnalyticsTimeline() {
...
export function createLifecycleNavigatorForecastEnvelope() {
...
export function createLifecycleNavigatorExceptionLedger() {
...
export function summarizeLifecycleNavigatorAnalytics() {
  const timeline = createLifecycleNavigatorAnalyticsTimeline();
  const forecast = createLifecycleNavigatorForecastEnvelope();
  return {
