...
export function createLifecycleNavigatorOperationsBoard() {
...
export function createLifecycleNavigatorShiftChecklist() {
...
export function createLifecycleNavigatorIncidentDeck() {
