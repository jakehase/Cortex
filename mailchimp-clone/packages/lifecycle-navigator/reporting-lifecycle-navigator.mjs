...
export function createLifecycleNavigatorReportCards() {
...
export function createLifecycleNavigatorReviewPackets() {
...
export function summarizeLifecycleNavigatorReporting() {
  const cards = createLifecycleNavigatorReportCards();
  const packets = createLifecycleNavigatorReviewPackets();
  return {
