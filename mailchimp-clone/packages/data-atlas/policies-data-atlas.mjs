...
export function createDataAtlasPolicies(overrides = {}) {
...
export function validateDataAtlasPolicies(policies = createDataAtlasPolicies()) {
  const issues = [];
...
export function summarizeDataAtlasPolicies(policies = createDataAtlasPolicies()) {
  return {
...
export function createDataAtlasEscalationDeck(policies = createDataAtlasPolicies()) {
