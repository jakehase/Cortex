const MODULE = {
  ...
  "routeSegment": "atlas",
  "title": "Data Atlas",
  "focus": "Data Atlas covers pipeline health, lineage, freshness, and operator trust in data assets through landscape mapping and territory coverage.",
...
export function createDataAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataAtlasWorkspace(workspace = createDataAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataAtlasNarratives(workspace = createDataAtlasWorkspace()) {
...
export function createDataAtlasCoverageGrid(workspace = createDataAtlasWorkspace()) {
