...
export function createAttributionAtlasReportCards() {
...
export function createAttributionAtlasReviewPackets() {
...
export function summarizeAttributionAtlasReporting() {
  const cards = createAttributionAtlasReportCards();
  const packets = createAttributionAtlasReviewPackets();
  return {
