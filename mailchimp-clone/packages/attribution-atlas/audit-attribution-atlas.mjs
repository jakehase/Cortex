...
export function createAttributionAtlasAuditTrail() {
...
export function createAttributionAtlasEvidenceManifest() {
...
export function createAttributionAtlasReadinessAttestation() {
  const auditTrail = createAttributionAtlasAuditTrail();
  return {
