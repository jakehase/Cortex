...
export function createAttributionAtlasOperationsBoard() {
...
export function createAttributionAtlasShiftChecklist() {
...
export function createAttributionAtlasIncidentDeck() {
