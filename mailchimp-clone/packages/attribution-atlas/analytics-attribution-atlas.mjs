...
export function createAttributionAtlasAnalyticsTimeline() {
...
export function createAttributionAtlasForecastEnvelope() {
...
export function createAttributionAtlasExceptionLedger() {
...
export function summarizeAttributionAtlasAnalytics() {
  const timeline = createAttributionAtlasAnalyticsTimeline();
  const forecast = createAttributionAtlasForecastEnvelope();
  return {
