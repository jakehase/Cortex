...
export function createInsightsNotebookPolicies(overrides = {}) {
...
export function validateInsightsNotebookPolicies(policies = createInsightsNotebookPolicies()) {
  const issues = [];
...
export function summarizeInsightsNotebookPolicies(policies = createInsightsNotebookPolicies()) {
  return {
...
export function createInsightsNotebookEscalationDeck(policies = createInsightsNotebookPolicies()) {
