...
export function createInsightsNotebookOperationsBoard() {
...
export function createInsightsNotebookShiftChecklist() {
...
export function createInsightsNotebookIncidentDeck() {
