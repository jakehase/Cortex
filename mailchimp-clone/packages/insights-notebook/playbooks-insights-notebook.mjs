...
export function createInsightsNotebookPlaybooks() {
...
export function createInsightsNotebookDecisionDeck() {
...
export function createInsightsNotebookEscalationMoments() {
