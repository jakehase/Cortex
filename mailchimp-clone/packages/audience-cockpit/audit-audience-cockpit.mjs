...
export function createAudienceCockpitAuditTrail() {
...
export function createAudienceCockpitEvidenceManifest() {
...
export function createAudienceCockpitReadinessAttestation() {
  const auditTrail = createAudienceCockpitAuditTrail();
  return {
