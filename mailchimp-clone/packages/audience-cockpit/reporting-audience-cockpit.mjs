...
export function createAudienceCockpitReportCards() {
...
export function createAudienceCockpitReviewPackets() {
...
export function summarizeAudienceCockpitReporting() {
  const cards = createAudienceCockpitReportCards();
  const packets = createAudienceCockpitReviewPackets();
  return {
