...
export function createAudienceCockpitPolicies(overrides = {}) {
...
export function validateAudienceCockpitPolicies(policies = createAudienceCockpitPolicies()) {
  const issues = [];
...
export function summarizeAudienceCockpitPolicies(policies = createAudienceCockpitPolicies()) {
  return {
...
export function createAudienceCockpitEscalationDeck(policies = createAudienceCockpitPolicies()) {
