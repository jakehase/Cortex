...
export function createIntegrationsSentinelPlaybooks() {
...
export function createIntegrationsSentinelDecisionDeck() {
...
export function createIntegrationsSentinelEscalationMoments() {
