...
export function createAnalyticsNavigatorAnalyticsTimeline() {
...
export function createAnalyticsNavigatorForecastEnvelope() {
...
export function createAnalyticsNavigatorExceptionLedger() {
...
export function summarizeAnalyticsNavigatorAnalytics() {
  const timeline = createAnalyticsNavigatorAnalyticsTimeline();
  const forecast = createAnalyticsNavigatorForecastEnvelope();
  return {
