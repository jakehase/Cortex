...
export function createLifecycleHubReportCards() {
...
export function createLifecycleHubReviewPackets() {
...
export function summarizeLifecycleHubReporting() {
  const cards = createLifecycleHubReportCards();
  const packets = createLifecycleHubReviewPackets();
  return {
