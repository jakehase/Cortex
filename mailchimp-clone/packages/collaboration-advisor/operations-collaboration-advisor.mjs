...
export function createCollaborationAdvisorOperationsBoard() {
...
export function createCollaborationAdvisorShiftChecklist() {
...
export function createCollaborationAdvisorIncidentDeck() {
