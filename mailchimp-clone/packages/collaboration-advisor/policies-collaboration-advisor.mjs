...
export function createCollaborationAdvisorPolicies(overrides = {}) {
...
export function validateCollaborationAdvisorPolicies(policies = createCollaborationAdvisorPolicies()) {
  const issues = [];
...
export function summarizeCollaborationAdvisorPolicies(policies = createCollaborationAdvisorPolicies()) {
  return {
...
export function createCollaborationAdvisorEscalationDeck(policies = createCollaborationAdvisorPolicies()) {
