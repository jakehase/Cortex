...
export function createCollaborationAdvisorAuditTrail() {
...
export function createCollaborationAdvisorEvidenceManifest() {
...
export function createCollaborationAdvisorReadinessAttestation() {
  const auditTrail = createCollaborationAdvisorAuditTrail();
  return {
