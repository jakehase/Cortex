...
export function createIntegrationsCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsCockpitWorkspace(workspace = createIntegrationsCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsCockpitNarratives(workspace = createIntegrationsCockpitWorkspace()) {
...
export function createIntegrationsCockpitCoverageGrid(workspace = createIntegrationsCockpitWorkspace()) {
