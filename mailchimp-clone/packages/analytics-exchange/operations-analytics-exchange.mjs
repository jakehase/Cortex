...
export function createAnalyticsExchangeOperationsBoard() {
...
export function createAnalyticsExchangeShiftChecklist() {
...
export function createAnalyticsExchangeIncidentDeck() {
