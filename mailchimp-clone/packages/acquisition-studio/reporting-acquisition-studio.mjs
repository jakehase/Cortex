...
export function createAcquisitionStudioReportCards() {
...
export function createAcquisitionStudioReviewPackets() {
...
export function summarizeAcquisitionStudioReporting() {
  const cards = createAcquisitionStudioReportCards();
  const packets = createAcquisitionStudioReviewPackets();
  return {
