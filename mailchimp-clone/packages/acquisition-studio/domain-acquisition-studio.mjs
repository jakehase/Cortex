const MODULE = {
  "id": "acquisition-studio",
  "ordinal": 17,
  "domain": "acquisition",
  "surfaceId": "studio",
  "surfaceTitle": "Studio",
  "routeSegment": "studio",
  "title": "Acquisition Studio",
  "focus": "Acquisition Studio covers new demand creation, source quality, and upstream handoff clarity through operator-facing creative and configuration tools.",
...
export function createAcquisitionStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionStudioWorkspace(workspace = createAcquisitionStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionStudioNarratives(workspace = createAcquisitionStudioWorkspace()) {
...
export function createAcquisitionStudioCoverageGrid(workspace = createAcquisitionStudioWorkspace()) {
