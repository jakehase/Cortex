...
export function createAcquisitionStudioOperationsBoard() {
...
export function createAcquisitionStudioShiftChecklist() {
...
export function createAcquisitionStudioIncidentDeck() {
