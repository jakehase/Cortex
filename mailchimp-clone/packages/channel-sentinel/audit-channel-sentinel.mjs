...
export function createChannelSentinelAuditTrail() {
...
export function createChannelSentinelEvidenceManifest() {
...
export function createChannelSentinelReadinessAttestation() {
  const auditTrail = createChannelSentinelAuditTrail();
  return {
