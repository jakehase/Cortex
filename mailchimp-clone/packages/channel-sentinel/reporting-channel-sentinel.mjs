...
export function createChannelSentinelReportCards() {
...
export function createChannelSentinelReviewPackets() {
...
export function summarizeChannelSentinelReporting() {
  const cards = createChannelSentinelReportCards();
  const packets = createChannelSentinelReviewPackets();
  return {
