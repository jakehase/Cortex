...
export function createChannelSentinelOperationsBoard() {
...
export function createChannelSentinelShiftChecklist() {
...
export function createChannelSentinelIncidentDeck() {
