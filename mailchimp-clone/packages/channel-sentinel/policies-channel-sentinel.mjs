...
export function createChannelSentinelPolicies(overrides = {}) {
...
export function validateChannelSentinelPolicies(policies = createChannelSentinelPolicies()) {
  const issues = [];
...
export function summarizeChannelSentinelPolicies(policies = createChannelSentinelPolicies()) {
  return {
...
export function createChannelSentinelEscalationDeck(policies = createChannelSentinelPolicies()) {
