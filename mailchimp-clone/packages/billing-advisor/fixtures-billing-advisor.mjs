...
export function createBillingAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeBillingAdvisorFixtures(fixtures = createBillingAdvisorFixtures()) {
  return {
...
export function createBillingAdvisorDemoInputs() {
  return {
