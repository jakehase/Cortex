...
export function createBillingAdvisorReportCards() {
...
export function createBillingAdvisorReviewPackets() {
...
export function summarizeBillingAdvisorReporting() {
  const cards = createBillingAdvisorReportCards();
  const packets = createBillingAdvisorReviewPackets();
  return {
