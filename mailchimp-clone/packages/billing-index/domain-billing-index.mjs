const MODULE = {
  ...
  "routeSegment": "index",
  "title": "Billing Index",
  "focus": "Billing Index covers plan posture, invoice exceptions, and collection readiness through searchable summaries and coverage catalogs.",
...
export function createBillingIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingIndexWorkspace(workspace = createBillingIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingIndexNarratives(workspace = createBillingIndexWorkspace()) {
...
export function createBillingIndexCoverageGrid(workspace = createBillingIndexWorkspace()) {
