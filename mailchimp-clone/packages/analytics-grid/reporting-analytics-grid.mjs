...
export function createAnalyticsGridReportCards() {
...
export function createAnalyticsGridReviewPackets() {
...
export function summarizeAnalyticsGridReporting() {
  const cards = createAnalyticsGridReportCards();
  const packets = createAnalyticsGridReviewPackets();
  return {
