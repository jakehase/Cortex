...
export function createCollaborationVaultReportCards() {
...
export function createCollaborationVaultReviewPackets() {
...
export function summarizeCollaborationVaultReporting() {
  const cards = createCollaborationVaultReportCards();
  const packets = createCollaborationVaultReviewPackets();
  return {
