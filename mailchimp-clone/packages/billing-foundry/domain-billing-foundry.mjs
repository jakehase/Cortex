...
export function createBillingFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingFoundryWorkspace(workspace = createBillingFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingFoundryNarratives(workspace = createBillingFoundryWorkspace()) {
...
export function createBillingFoundryCoverageGrid(workspace = createBillingFoundryWorkspace()) {
