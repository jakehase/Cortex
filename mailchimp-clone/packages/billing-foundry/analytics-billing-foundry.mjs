...
export function createBillingFoundryAnalyticsTimeline() {
...
export function createBillingFoundryForecastEnvelope() {
...
export function createBillingFoundryExceptionLedger() {
...
export function summarizeBillingFoundryAnalytics() {
  const timeline = createBillingFoundryAnalyticsTimeline();
  const forecast = createBillingFoundryForecastEnvelope();
  return {
