...
export function createConsentAtlasAuditTrail() {
...
export function createConsentAtlasEvidenceManifest() {
...
export function createConsentAtlasReadinessAttestation() {
  const auditTrail = createConsentAtlasAuditTrail();
  return {
