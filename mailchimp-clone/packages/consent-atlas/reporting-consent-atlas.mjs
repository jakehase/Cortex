...
export function createConsentAtlasReportCards() {
...
export function createConsentAtlasReviewPackets() {
...
export function summarizeConsentAtlasReporting() {
  const cards = createConsentAtlasReportCards();
  const packets = createConsentAtlasReviewPackets();
  return {
