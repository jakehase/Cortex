const MODULE = {
  ...
  "routeSegment": "atlas",
  "title": "Consent Atlas",
  "focus": "Consent Atlas covers proof of consent, subscription changes, and evidence continuity through landscape mapping and territory coverage.",
...
export function createConsentAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeConsentAtlasWorkspace(workspace = createConsentAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createConsentAtlasNarratives(workspace = createConsentAtlasWorkspace()) {
...
export function createConsentAtlasCoverageGrid(workspace = createConsentAtlasWorkspace()) {
