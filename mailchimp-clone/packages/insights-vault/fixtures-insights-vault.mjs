...
export function createInsightsVaultFixtures() {
  return {
    accounts: [
...
export function summarizeInsightsVaultFixtures(fixtures = createInsightsVaultFixtures()) {
  return {
...
export function createInsightsVaultDemoInputs() {
  return {
