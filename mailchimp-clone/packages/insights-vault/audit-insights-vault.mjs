...
export function createInsightsVaultAuditTrail() {
...
export function createInsightsVaultEvidenceManifest() {
...
export function createInsightsVaultReadinessAttestation() {
  const auditTrail = createInsightsVaultAuditTrail();
  return {
