...
export function createAcquisitionPlannerOperationsBoard() {
...
export function createAcquisitionPlannerShiftChecklist() {
...
export function createAcquisitionPlannerIncidentDeck() {
