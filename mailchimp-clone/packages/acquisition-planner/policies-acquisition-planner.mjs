...
export function createAcquisitionPlannerPolicies(overrides = {}) {
...
export function validateAcquisitionPlannerPolicies(policies = createAcquisitionPlannerPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionPlannerPolicies(policies = createAcquisitionPlannerPolicies()) {
  return {
...
export function createAcquisitionPlannerEscalationDeck(policies = createAcquisitionPlannerPolicies()) {
