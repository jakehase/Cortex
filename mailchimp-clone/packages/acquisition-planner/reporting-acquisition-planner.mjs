...
export function createAcquisitionPlannerReportCards() {
...
export function createAcquisitionPlannerReviewPackets() {
...
export function summarizeAcquisitionPlannerReporting() {
  const cards = createAcquisitionPlannerReportCards();
  const packets = createAcquisitionPlannerReviewPackets();
  return {
