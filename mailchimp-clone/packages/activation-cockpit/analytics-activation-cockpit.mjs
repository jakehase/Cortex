...
export function createActivationCockpitAnalyticsTimeline() {
...
export function createActivationCockpitForecastEnvelope() {
...
export function createActivationCockpitExceptionLedger() {
...
export function summarizeActivationCockpitAnalytics() {
  const timeline = createActivationCockpitAnalyticsTimeline();
  const forecast = createActivationCockpitForecastEnvelope();
  return {
