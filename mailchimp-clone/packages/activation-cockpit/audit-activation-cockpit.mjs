...
export function createActivationCockpitAuditTrail() {
...
export function createActivationCockpitEvidenceManifest() {
...
export function createActivationCockpitReadinessAttestation() {
  const auditTrail = createActivationCockpitAuditTrail();
  return {
