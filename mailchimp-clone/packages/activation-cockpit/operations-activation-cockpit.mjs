...
export function createActivationCockpitOperationsBoard() {
...
export function createActivationCockpitShiftChecklist() {
...
export function createActivationCockpitIncidentDeck() {
