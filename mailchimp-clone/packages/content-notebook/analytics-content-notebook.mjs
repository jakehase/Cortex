...
export function createContentNotebookAnalyticsTimeline() {
...
export function createContentNotebookForecastEnvelope() {
...
export function createContentNotebookExceptionLedger() {
...
export function summarizeContentNotebookAnalytics() {
  const timeline = createContentNotebookAnalyticsTimeline();
  const forecast = createContentNotebookForecastEnvelope();
  return {
