...
export function createContentNotebookReportCards() {
...
export function createContentNotebookReviewPackets() {
...
export function summarizeContentNotebookReporting() {
  const cards = createContentNotebookReportCards();
  const packets = createContentNotebookReviewPackets();
  return {
