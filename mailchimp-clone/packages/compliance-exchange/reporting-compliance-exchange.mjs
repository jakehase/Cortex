...
export function createComplianceExchangeReportCards() {
...
export function createComplianceExchangeReviewPackets() {
...
export function summarizeComplianceExchangeReporting() {
  const cards = createComplianceExchangeReportCards();
  const packets = createComplianceExchangeReviewPackets();
  return {
