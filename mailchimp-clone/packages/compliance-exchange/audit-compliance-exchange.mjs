...
export function createComplianceExchangeAuditTrail() {
...
export function createComplianceExchangeEvidenceManifest() {
...
export function createComplianceExchangeReadinessAttestation() {
  const auditTrail = createComplianceExchangeAuditTrail();
  return {
