const MODULE = {
  ...
  "routeSegment": "index",
  "title": "Content Index",
  "focus": "Content Index covers content operations, packaging, and channel-specific delivery shape through searchable summaries and coverage catalogs.",
...
export function createContentIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentIndexWorkspace(workspace = createContentIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentIndexNarratives(workspace = createContentIndexWorkspace()) {
...
export function createContentIndexCoverageGrid(workspace = createContentIndexWorkspace()) {
