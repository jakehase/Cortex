...
export function createContentIndexAnalyticsTimeline() {
...
export function createContentIndexForecastEnvelope() {
...
export function createContentIndexExceptionLedger() {
...
export function summarizeContentIndexAnalytics() {
  const timeline = createContentIndexAnalyticsTimeline();
  const forecast = createContentIndexForecastEnvelope();
  return {
