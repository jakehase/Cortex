...
export function createAnalyticsVaultPolicies(overrides = {}) {
...
export function validateAnalyticsVaultPolicies(policies = createAnalyticsVaultPolicies()) {
  const issues = [];
...
export function summarizeAnalyticsVaultPolicies(policies = createAnalyticsVaultPolicies()) {
  return {
...
export function createAnalyticsVaultEscalationDeck(policies = createAnalyticsVaultPolicies()) {
