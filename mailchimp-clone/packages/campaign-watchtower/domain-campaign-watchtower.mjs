...
export function createCampaignWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignWatchtowerWorkspace(workspace = createCampaignWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignWatchtowerNarratives(workspace = createCampaignWatchtowerWorkspace()) {
...
export function createCampaignWatchtowerCoverageGrid(workspace = createCampaignWatchtowerWorkspace()) {
