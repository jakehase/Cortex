...
export function createCampaignWatchtowerAnalyticsTimeline() {
...
export function createCampaignWatchtowerForecastEnvelope() {
...
export function createCampaignWatchtowerExceptionLedger() {
...
export function summarizeCampaignWatchtowerAnalytics() {
  const timeline = createCampaignWatchtowerAnalyticsTimeline();
  const forecast = createCampaignWatchtowerForecastEnvelope();
  return {
