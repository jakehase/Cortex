...
export function createCampaignWatchtowerReportCards() {
...
export function createCampaignWatchtowerReviewPackets() {
...
export function summarizeCampaignWatchtowerReporting() {
  const cards = createCampaignWatchtowerReportCards();
  const packets = createCampaignWatchtowerReviewPackets();
  return {
