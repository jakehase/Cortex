...
export function createContentFoundryReportCards() {
...
export function createContentFoundryReviewPackets() {
...
export function summarizeContentFoundryReporting() {
  const cards = createContentFoundryReportCards();
  const packets = createContentFoundryReviewPackets();
  return {
