...
export function createContentFoundryAnalyticsTimeline() {
...
export function createContentFoundryForecastEnvelope() {
...
export function createContentFoundryExceptionLedger() {
...
export function summarizeContentFoundryAnalytics() {
  const timeline = createContentFoundryAnalyticsTimeline();
  const forecast = createContentFoundryForecastEnvelope();
  return {
