const MODULE = {
  ...
  "focus": "Content Foundry covers content operations, packaging, and channel-specific delivery shape through program building and surface composition.",
...
export function createContentFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentFoundryWorkspace(workspace = createContentFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentFoundryNarratives(workspace = createContentFoundryWorkspace()) {
...
export function createContentFoundryCoverageGrid(workspace = createContentFoundryWorkspace()) {
