...
export function createContentFoundryAuditTrail() {
...
export function createContentFoundryEvidenceManifest() {
...
export function createContentFoundryReadinessAttestation() {
  const auditTrail = createContentFoundryAuditTrail();
  return {
