...
export function createCustomerConsoleReportCards() {
...
export function createCustomerConsoleReviewPackets() {
...
export function summarizeCustomerConsoleReporting() {
  const cards = createCustomerConsoleReportCards();
  const packets = createCustomerConsoleReviewPackets();
  return {
