...
export function createCustomerConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCustomerConsoleWorkspace(workspace = createCustomerConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createCustomerConsoleNarratives(workspace = createCustomerConsoleWorkspace()) {
...
export function createCustomerConsoleCoverageGrid(workspace = createCustomerConsoleWorkspace()) {
