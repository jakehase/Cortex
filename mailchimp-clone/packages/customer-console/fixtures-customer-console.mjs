...
export function createCustomerConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerConsoleFixtures(fixtures = createCustomerConsoleFixtures()) {
  return {
...
export function createCustomerConsoleDemoInputs() {
  return {
