...
export function createCustomerConsolePolicies(overrides = {}) {
...
export function validateCustomerConsolePolicies(policies = createCustomerConsolePolicies()) {
  const issues = [];
...
export function summarizeCustomerConsolePolicies(policies = createCustomerConsolePolicies()) {
  return {
...
export function createCustomerConsoleEscalationDeck(policies = createCustomerConsolePolicies()) {
