...
export function createCustomerIndexAnalyticsTimeline() {
...
export function createCustomerIndexForecastEnvelope() {
...
export function createCustomerIndexExceptionLedger() {
...
export function summarizeCustomerIndexAnalytics() {
  const timeline = createCustomerIndexAnalyticsTimeline();
  const forecast = createCustomerIndexForecastEnvelope();
  return {
