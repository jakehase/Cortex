...
export function createCustomerIndexReportCards() {
...
export function createCustomerIndexReviewPackets() {
...
export function summarizeCustomerIndexReporting() {
  const cards = createCustomerIndexReportCards();
  const packets = createCustomerIndexReviewPackets();
  return {
