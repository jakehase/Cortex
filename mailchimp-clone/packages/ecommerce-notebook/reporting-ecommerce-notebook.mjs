...
export function createEcommerceNotebookReportCards() {
...
export function createEcommerceNotebookReviewPackets() {
...
export function summarizeEcommerceNotebookReporting() {
  const cards = createEcommerceNotebookReportCards();
  const packets = createEcommerceNotebookReviewPackets();
  return {
