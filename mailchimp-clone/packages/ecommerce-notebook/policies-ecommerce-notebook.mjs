...
export function createEcommerceNotebookPolicies(overrides = {}) {
...
export function validateEcommerceNotebookPolicies(policies = createEcommerceNotebookPolicies()) {
  const issues = [];
...
export function summarizeEcommerceNotebookPolicies(policies = createEcommerceNotebookPolicies()) {
  return {
...
export function createEcommerceNotebookEscalationDeck(policies = createEcommerceNotebookPolicies()) {
