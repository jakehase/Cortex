...
export function createEcommerceNotebookAuditTrail() {
...
export function createEcommerceNotebookEvidenceManifest() {
...
export function createEcommerceNotebookReadinessAttestation() {
  const auditTrail = createEcommerceNotebookAuditTrail();
  return {
