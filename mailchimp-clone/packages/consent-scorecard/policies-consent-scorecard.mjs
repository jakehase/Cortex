...
export function createConsentScorecardPolicies(overrides = {}) {
...
export function validateConsentScorecardPolicies(policies = createConsentScorecardPolicies()) {
  const issues = [];
...
export function summarizeConsentScorecardPolicies(policies = createConsentScorecardPolicies()) {
  return {
...
export function createConsentScorecardEscalationDeck(policies = createConsentScorecardPolicies()) {
