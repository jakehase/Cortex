...
export function createAdvocacyPlannerAnalyticsTimeline() {
...
export function createAdvocacyPlannerForecastEnvelope() {
...
export function createAdvocacyPlannerExceptionLedger() {
...
export function summarizeAdvocacyPlannerAnalytics() {
  const timeline = createAdvocacyPlannerAnalyticsTimeline();
  const forecast = createAdvocacyPlannerForecastEnvelope();
  return {
