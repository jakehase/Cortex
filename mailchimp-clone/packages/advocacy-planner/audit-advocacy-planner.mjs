...
export function createAdvocacyPlannerAuditTrail() {
...
export function createAdvocacyPlannerEvidenceManifest() {
...
export function createAdvocacyPlannerReadinessAttestation() {
  const auditTrail = createAdvocacyPlannerAuditTrail();
  return {
