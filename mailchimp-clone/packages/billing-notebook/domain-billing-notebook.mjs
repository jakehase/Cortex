...
export function createBillingNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingNotebookWorkspace(workspace = createBillingNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingNotebookNarratives(workspace = createBillingNotebookWorkspace()) {
...
export function createBillingNotebookCoverageGrid(workspace = createBillingNotebookWorkspace()) {
