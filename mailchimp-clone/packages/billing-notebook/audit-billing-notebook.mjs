...
export function createBillingNotebookAuditTrail() {
...
export function createBillingNotebookEvidenceManifest() {
...
export function createBillingNotebookReadinessAttestation() {
  const auditTrail = createBillingNotebookAuditTrail();
  return {
