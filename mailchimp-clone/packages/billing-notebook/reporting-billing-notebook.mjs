...
export function createBillingNotebookReportCards() {
...
export function createBillingNotebookReviewPackets() {
...
export function summarizeBillingNotebookReporting() {
  const cards = createBillingNotebookReportCards();
  const packets = createBillingNotebookReviewPackets();
  return {
