...
export function createAutomationSentinelPolicies(overrides = {}) {
...
export function validateAutomationSentinelPolicies(policies = createAutomationSentinelPolicies()) {
  const issues = [];
...
export function summarizeAutomationSentinelPolicies(policies = createAutomationSentinelPolicies()) {
  return {
...
export function createAutomationSentinelEscalationDeck(policies = createAutomationSentinelPolicies()) {
