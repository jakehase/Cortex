...
export function createAttributionNavigatorAuditTrail() {
...
export function createAttributionNavigatorEvidenceManifest() {
...
export function createAttributionNavigatorReadinessAttestation() {
  const auditTrail = createAttributionNavigatorAuditTrail();
  return {
