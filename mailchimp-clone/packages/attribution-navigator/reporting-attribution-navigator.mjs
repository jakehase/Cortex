...
export function createAttributionNavigatorReportCards() {
...
export function createAttributionNavigatorReviewPackets() {
...
export function summarizeAttributionNavigatorReporting() {
  const cards = createAttributionNavigatorReportCards();
  const packets = createAttributionNavigatorReviewPackets();
  return {
