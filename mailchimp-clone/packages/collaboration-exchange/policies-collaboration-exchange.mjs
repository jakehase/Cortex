...
export function createCollaborationExchangePolicies(overrides = {}) {
...
export function validateCollaborationExchangePolicies(policies = createCollaborationExchangePolicies()) {
  const issues = [];
...
export function summarizeCollaborationExchangePolicies(policies = createCollaborationExchangePolicies()) {
  return {
...
export function createCollaborationExchangeEscalationDeck(policies = createCollaborationExchangePolicies()) {
