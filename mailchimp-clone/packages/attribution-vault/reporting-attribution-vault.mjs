...
export function createAttributionVaultReportCards() {
...
export function createAttributionVaultReviewPackets() {
...
export function summarizeAttributionVaultReporting() {
  const cards = createAttributionVaultReportCards();
  const packets = createAttributionVaultReviewPackets();
  return {
