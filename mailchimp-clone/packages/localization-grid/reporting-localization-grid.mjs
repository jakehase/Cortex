...
export function createLocalizationGridReportCards() {
...
export function createLocalizationGridReviewPackets() {
...
export function summarizeLocalizationGridReporting() {
  const cards = createLocalizationGridReportCards();
  const packets = createLocalizationGridReviewPackets();
  return {
