...
export function createLocalizationGridOperationsBoard() {
...
export function createLocalizationGridShiftChecklist() {
...
export function createLocalizationGridIncidentDeck() {
