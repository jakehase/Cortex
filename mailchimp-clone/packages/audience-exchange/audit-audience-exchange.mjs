...
export function createAudienceExchangeAuditTrail() {
...
export function createAudienceExchangeEvidenceManifest() {
...
export function createAudienceExchangeReadinessAttestation() {
  const auditTrail = createAudienceExchangeAuditTrail();
  return {
