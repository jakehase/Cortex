...
export function createAudienceExchangeReportCards() {
...
export function createAudienceExchangeReviewPackets() {
...
export function summarizeAudienceExchangeReporting() {
  const cards = createAudienceExchangeReportCards();
  const packets = createAudienceExchangeReviewPackets();
  return {
