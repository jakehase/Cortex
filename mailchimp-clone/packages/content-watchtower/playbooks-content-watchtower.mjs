...
export function createContentWatchtowerPlaybooks() {
...
export function createContentWatchtowerDecisionDeck() {
...
export function createContentWatchtowerEscalationMoments() {
