...
export function createContentWatchtowerReportCards() {
...
export function createContentWatchtowerReviewPackets() {
...
export function summarizeContentWatchtowerReporting() {
  const cards = createContentWatchtowerReportCards();
  const packets = createContentWatchtowerReviewPackets();
  return {
