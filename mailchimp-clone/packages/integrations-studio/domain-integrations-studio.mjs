const MODULE = {
  ...
  "surfaceTitle": "Studio",
  "routeSegment": "studio",
  "title": "Integrations Studio",
  "focus": "Integrations Studio covers destination syncs, partner activation, and cross-platform reliability through operator-facing creative and configuration tools.",
  ...
  "tags": [
    ...
    "studio",
    "intelligence",
    "integrations-studio-wave-seven"
  ]
};
...
export function createIntegrationsStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsStudioWorkspace(workspace = createIntegrationsStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsStudioNarratives(workspace = createIntegrationsStudioWorkspace()) {
...
export function createIntegrationsStudioCoverageGrid(workspace = createIntegrationsStudioWorkspace()) {
