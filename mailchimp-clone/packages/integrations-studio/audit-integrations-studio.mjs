...
export function createIntegrationsStudioAuditTrail() {
...
export function createIntegrationsStudioEvidenceManifest() {
...
export function createIntegrationsStudioReadinessAttestation() {
  const auditTrail = createIntegrationsStudioAuditTrail();
  return {
