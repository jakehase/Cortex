...
export function createIntegrationsStudioReportCards() {
...
export function createIntegrationsStudioReviewPackets() {
...
export function summarizeIntegrationsStudioReporting() {
  const cards = createIntegrationsStudioReportCards();
  const packets = createIntegrationsStudioReviewPackets();
  return {
