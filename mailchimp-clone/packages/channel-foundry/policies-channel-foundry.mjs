...
export function createChannelFoundryPolicies(overrides = {}) {
...
export function validateChannelFoundryPolicies(policies = createChannelFoundryPolicies()) {
  const issues = [];
...
export function summarizeChannelFoundryPolicies(policies = createChannelFoundryPolicies()) {
  return {
...
export function createChannelFoundryEscalationDeck(policies = createChannelFoundryPolicies()) {
