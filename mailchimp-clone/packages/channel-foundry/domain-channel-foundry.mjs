const MODULE = {
  ...
  "title": "Channel Foundry",
  "focus": "Channel Foundry covers channel operating models, readiness coverage, and mix governance through program building and surface composition.",
...
export function createChannelFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelFoundryWorkspace(workspace = createChannelFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelFoundryNarratives(workspace = createChannelFoundryWorkspace()) {
...
export function createChannelFoundryCoverageGrid(workspace = createChannelFoundryWorkspace()) {
