...
export function createChannelFoundryAuditTrail() {
...
export function createChannelFoundryEvidenceManifest() {
...
export function createChannelFoundryReadinessAttestation() {
  const auditTrail = createChannelFoundryAuditTrail();
  return {
