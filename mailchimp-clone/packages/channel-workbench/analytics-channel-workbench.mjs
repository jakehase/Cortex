...
export function createChannelWorkbenchAnalyticsTimeline() {
...
export function createChannelWorkbenchForecastEnvelope() {
...
export function createChannelWorkbenchExceptionLedger() {
...
export function summarizeChannelWorkbenchAnalytics() {
  const timeline = createChannelWorkbenchAnalyticsTimeline();
  const forecast = createChannelWorkbenchForecastEnvelope();
  return {
