...
export function createChannelWorkbenchAuditTrail() {
...
export function createChannelWorkbenchEvidenceManifest() {
...
export function createChannelWorkbenchReadinessAttestation() {
  const auditTrail = createChannelWorkbenchAuditTrail();
  return {
