...
export function createConsentDossierPolicies(overrides = {}) {
...
export function validateConsentDossierPolicies(policies = createConsentDossierPolicies()) {
  const issues = [];
...
export function summarizeConsentDossierPolicies(policies = createConsentDossierPolicies()) {
  return {
...
export function createConsentDossierEscalationDeck(policies = createConsentDossierPolicies()) {
