const MODULE = {
  ...
  "focus": "Analytics Scorecard covers portfolio analytics, operator scorecards, and query-driven reviews through metric tracking and readiness scoring.",
  ...
  "tags": [
    ...
    "scorecard",
    "revenue",
    "analytics-scorecard-wave-seven"
  ]
};
...
export function createAnalyticsScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsScorecardWorkspace(workspace = createAnalyticsScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsScorecardNarratives(workspace = createAnalyticsScorecardWorkspace()) {
...
export function createAnalyticsScorecardCoverageGrid(workspace = createAnalyticsScorecardWorkspace()) {
