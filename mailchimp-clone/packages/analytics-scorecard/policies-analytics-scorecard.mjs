...
export function createAnalyticsScorecardPolicies(overrides = {}) {
...
export function validateAnalyticsScorecardPolicies(policies = createAnalyticsScorecardPolicies()) {
  const issues = [];
...
export function summarizeAnalyticsScorecardPolicies(policies = createAnalyticsScorecardPolicies()) {
  return {
...
export function createAnalyticsScorecardEscalationDeck(policies = createAnalyticsScorecardPolicies()) {
