...
export function createAnalyticsScorecardAuditTrail() {
...
export function createAnalyticsScorecardEvidenceManifest() {
...
export function createAnalyticsScorecardReadinessAttestation() {
  const auditTrail = createAnalyticsScorecardAuditTrail();
  return {
