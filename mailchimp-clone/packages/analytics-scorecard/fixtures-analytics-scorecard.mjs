...
export function createAnalyticsScorecardFixtures() {
  return {
    accounts: [
...
export function summarizeAnalyticsScorecardFixtures(fixtures = createAnalyticsScorecardFixtures()) {
  return {
...
export function createAnalyticsScorecardDemoInputs() {
  return {
