...
export function createAnalyticsScorecardReportCards() {
...
export function createAnalyticsScorecardReviewPackets() {
...
export function summarizeAnalyticsScorecardReporting() {
  const cards = createAnalyticsScorecardReportCards();
  const packets = createAnalyticsScorecardReviewPackets();
  return {
