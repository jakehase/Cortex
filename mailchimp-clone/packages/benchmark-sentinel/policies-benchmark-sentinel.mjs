...
export function createBenchmarkSentinelPolicies(overrides = {}) {
...
export function validateBenchmarkSentinelPolicies(policies = createBenchmarkSentinelPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkSentinelPolicies(policies = createBenchmarkSentinelPolicies()) {
  return {
...
export function createBenchmarkSentinelEscalationDeck(policies = createBenchmarkSentinelPolicies()) {
