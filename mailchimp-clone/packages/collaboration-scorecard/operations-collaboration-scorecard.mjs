...
export function createCollaborationScorecardOperationsBoard() {
...
export function createCollaborationScorecardShiftChecklist() {
...
export function createCollaborationScorecardIncidentDeck() {
