...
export function createCollaborationScorecardPolicies(overrides = {}) {
...
export function validateCollaborationScorecardPolicies(policies = createCollaborationScorecardPolicies()) {
  const issues = [];
...
export function summarizeCollaborationScorecardPolicies(policies = createCollaborationScorecardPolicies()) {
  return {
...
export function createCollaborationScorecardEscalationDeck(policies = createCollaborationScorecardPolicies()) {
