...
export function createAutomationIndexOperationsBoard() {
...
export function createAutomationIndexShiftChecklist() {
...
export function createAutomationIndexIncidentDeck() {
