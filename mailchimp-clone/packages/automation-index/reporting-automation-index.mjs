...
export function createAutomationIndexReportCards() {
...
export function createAutomationIndexReviewPackets() {
...
export function summarizeAutomationIndexReporting() {
  const cards = createAutomationIndexReportCards();
  const packets = createAutomationIndexReviewPackets();
  return {
