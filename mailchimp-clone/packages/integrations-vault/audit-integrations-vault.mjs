...
export function createIntegrationsVaultAuditTrail() {
...
export function createIntegrationsVaultEvidenceManifest() {
...
export function createIntegrationsVaultReadinessAttestation() {
  const auditTrail = createIntegrationsVaultAuditTrail();
  return {
