...
export function createIntegrationsVaultAnalyticsTimeline() {
...
export function createIntegrationsVaultForecastEnvelope() {
...
export function createIntegrationsVaultExceptionLedger() {
...
export function summarizeIntegrationsVaultAnalytics() {
  const timeline = createIntegrationsVaultAnalyticsTimeline();
  const forecast = createIntegrationsVaultForecastEnvelope();
  return {
