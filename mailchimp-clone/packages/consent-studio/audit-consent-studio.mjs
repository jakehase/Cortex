...
export function createConsentStudioAuditTrail() {
...
export function createConsentStudioEvidenceManifest() {
...
export function createConsentStudioReadinessAttestation() {
  const auditTrail = createConsentStudioAuditTrail();
  return {
