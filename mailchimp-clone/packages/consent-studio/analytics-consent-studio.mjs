...
export function createConsentStudioAnalyticsTimeline() {
...
export function createConsentStudioForecastEnvelope() {
...
export function createConsentStudioExceptionLedger() {
...
export function summarizeConsentStudioAnalytics() {
  const timeline = createConsentStudioAnalyticsTimeline();
  const forecast = createConsentStudioForecastEnvelope();
  return {
