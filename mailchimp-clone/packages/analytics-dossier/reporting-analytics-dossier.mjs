...
export function createAnalyticsDossierReportCards() {
...
export function createAnalyticsDossierReviewPackets() {
...
export function summarizeAnalyticsDossierReporting() {
  const cards = createAnalyticsDossierReportCards();
  const packets = createAnalyticsDossierReviewPackets();
  return {
