...
export function createBillingWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingWorkbenchWorkspace(workspace = createBillingWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingWorkbenchNarratives(workspace = createBillingWorkbenchWorkspace()) {
...
export function createBillingWorkbenchCoverageGrid(workspace = createBillingWorkbenchWorkspace()) {
