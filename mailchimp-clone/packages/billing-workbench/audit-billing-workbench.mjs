...
export function createBillingWorkbenchAuditTrail() {
...
export function createBillingWorkbenchEvidenceManifest() {
...
export function createBillingWorkbenchReadinessAttestation() {
  const auditTrail = createBillingWorkbenchAuditTrail();
  return {
