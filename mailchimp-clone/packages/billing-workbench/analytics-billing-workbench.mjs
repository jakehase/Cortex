...
export function createBillingWorkbenchAnalyticsTimeline() {
...
export function createBillingWorkbenchForecastEnvelope() {
...
export function createBillingWorkbenchExceptionLedger() {
...
export function summarizeBillingWorkbenchAnalytics() {
  const timeline = createBillingWorkbenchAnalyticsTimeline();
  const forecast = createBillingWorkbenchForecastEnvelope();
  return {
