...
export function createCreativeFoundryFixtures() {
  return {
    accounts: [
...
export function summarizeCreativeFoundryFixtures(fixtures = createCreativeFoundryFixtures()) {
  return {
...
export function createCreativeFoundryDemoInputs() {
  return {
