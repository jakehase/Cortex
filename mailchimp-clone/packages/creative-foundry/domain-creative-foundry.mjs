...
export function createCreativeFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCreativeFoundryWorkspace(workspace = createCreativeFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createCreativeFoundryNarratives(workspace = createCreativeFoundryWorkspace()) {
...
export function createCreativeFoundryCoverageGrid(workspace = createCreativeFoundryWorkspace()) {
