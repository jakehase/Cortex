...
export function createCreativeFoundryPolicies(overrides = {}) {
...
export function validateCreativeFoundryPolicies(policies = createCreativeFoundryPolicies()) {
  const issues = [];
...
export function summarizeCreativeFoundryPolicies(policies = createCreativeFoundryPolicies()) {
  return {
...
export function createCreativeFoundryEscalationDeck(policies = createCreativeFoundryPolicies()) {
