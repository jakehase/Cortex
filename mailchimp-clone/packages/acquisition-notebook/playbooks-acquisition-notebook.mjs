...
export function createAcquisitionNotebookPlaybooks() {
...
export function createAcquisitionNotebookDecisionDeck() {
...
export function createAcquisitionNotebookEscalationMoments() {
