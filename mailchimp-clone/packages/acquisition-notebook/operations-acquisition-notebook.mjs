...
export function createAcquisitionNotebookOperationsBoard() {
...
export function createAcquisitionNotebookShiftChecklist() {
...
export function createAcquisitionNotebookIncidentDeck() {
