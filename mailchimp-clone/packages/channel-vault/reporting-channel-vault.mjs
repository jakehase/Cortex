...
export function createChannelVaultReportCards() {
...
export function createChannelVaultReviewPackets() {
...
export function summarizeChannelVaultReporting() {
  const cards = createChannelVaultReportCards();
  const packets = createChannelVaultReviewPackets();
  return {
