...
export function createComplianceAtlasPolicies(overrides = {}) {
...
export function validateComplianceAtlasPolicies(policies = createComplianceAtlasPolicies()) {
  const issues = [];
...
export function summarizeComplianceAtlasPolicies(policies = createComplianceAtlasPolicies()) {
  return {
...
export function createComplianceAtlasEscalationDeck(policies = createComplianceAtlasPolicies()) {
