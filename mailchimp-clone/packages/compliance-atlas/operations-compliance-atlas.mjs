...
export function createComplianceAtlasOperationsBoard() {
...
export function createComplianceAtlasShiftChecklist() {
...
export function createComplianceAtlasIncidentDeck() {
