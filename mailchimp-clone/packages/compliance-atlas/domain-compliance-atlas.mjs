const MODULE = {
  ...
  "focus": "Compliance Atlas covers controls, remediation steps, and governance evidence capture through landscape mapping and territory coverage.",
...
export function createComplianceAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeComplianceAtlasWorkspace(workspace = createComplianceAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createComplianceAtlasNarratives(workspace = createComplianceAtlasWorkspace()) {
...
export function createComplianceAtlasCoverageGrid(workspace = createComplianceAtlasWorkspace()) {
