...
export function createComplianceAtlasReportCards() {
...
export function createComplianceAtlasReviewPackets() {
...
export function summarizeComplianceAtlasReporting() {
  const cards = createComplianceAtlasReportCards();
  const packets = createComplianceAtlasReviewPackets();
  return {
