...
export function createAnalyticsStudioOperationsBoard() {
...
export function createAnalyticsStudioShiftChecklist() {
...
export function createAnalyticsStudioIncidentDeck() {
