...
export function createAnalyticsStudioAuditTrail() {
...
export function createAnalyticsStudioEvidenceManifest() {
...
export function createAnalyticsStudioReadinessAttestation() {
  const auditTrail = createAnalyticsStudioAuditTrail();
  return {
