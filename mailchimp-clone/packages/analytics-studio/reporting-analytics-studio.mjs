...
export function createAnalyticsStudioReportCards() {
...
export function createAnalyticsStudioReviewPackets() {
...
export function summarizeAnalyticsStudioReporting() {
  const cards = createAnalyticsStudioReportCards();
  const packets = createAnalyticsStudioReviewPackets();
  return {
