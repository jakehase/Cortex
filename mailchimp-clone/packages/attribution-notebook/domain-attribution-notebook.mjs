...
export function createAttributionNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAttributionNotebookWorkspace(workspace = createAttributionNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createAttributionNotebookNarratives(workspace = createAttributionNotebookWorkspace()) {
...
export function createAttributionNotebookCoverageGrid(workspace = createAttributionNotebookWorkspace()) {
