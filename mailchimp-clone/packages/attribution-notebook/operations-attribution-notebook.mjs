...
export function createAttributionNotebookOperationsBoard() {
...
export function createAttributionNotebookShiftChecklist() {
...
export function createAttributionNotebookIncidentDeck() {
