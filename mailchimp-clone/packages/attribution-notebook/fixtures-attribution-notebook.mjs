...
export function createAttributionNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeAttributionNotebookFixtures(fixtures = createAttributionNotebookFixtures()) {
  return {
...
export function createAttributionNotebookDemoInputs() {
  return {
