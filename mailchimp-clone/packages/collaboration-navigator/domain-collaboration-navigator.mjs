const MODULE = {
  "id": "collaboration-navigator",
  "ordinal": 231,
  "domain": "collaboration",
  "surfaceId": "navigator",
  "surfaceTitle": "Navigator",
  "routeSegment": "navigator",
  "title": "Collaboration Navigator",
  "focus": "Collaboration Navigator covers shared ownership, approvals, and cross-functional motion through journey guidance and directional controls.",
  ...
  "tags": [
    ...
    "navigator",
    "lifecycle",
    "collaboration-navigator-wave-seven"
  ]
};
...
export function createCollaborationNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationNavigatorWorkspace(workspace = createCollaborationNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationNavigatorNarratives(workspace = createCollaborationNavigatorWorkspace()) {
...
export function createCollaborationNavigatorCoverageGrid(workspace = createCollaborationNavigatorWorkspace()) {
