...
export function createCollaborationNavigatorReportCards() {
...
export function createCollaborationNavigatorReviewPackets() {
...
export function summarizeCollaborationNavigatorReporting() {
  const cards = createCollaborationNavigatorReportCards();
  const packets = createCollaborationNavigatorReviewPackets();
  return {
