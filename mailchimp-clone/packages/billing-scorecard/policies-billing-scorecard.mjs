...
export function createBillingScorecardPolicies(overrides = {}) {
...
export function validateBillingScorecardPolicies(policies = createBillingScorecardPolicies()) {
  const issues = [];
...
export function summarizeBillingScorecardPolicies(policies = createBillingScorecardPolicies()) {
  return {
...
export function createBillingScorecardEscalationDeck(policies = createBillingScorecardPolicies()) {
