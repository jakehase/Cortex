...
export function createAttributionCockpitOperationsBoard() {
...
export function createAttributionCockpitShiftChecklist() {
...
export function createAttributionCockpitIncidentDeck() {
