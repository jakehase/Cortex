...
export function createBillingHubFixtures() {
  return {
    accounts: [
...
export function summarizeBillingHubFixtures(fixtures = createBillingHubFixtures()) {
  return {
...
export function createBillingHubDemoInputs() {
  return {
