...
export function createBillingHubPolicies(overrides = {}) {
...
export function validateBillingHubPolicies(policies = createBillingHubPolicies()) {
  const issues = [];
...
export function summarizeBillingHubPolicies(policies = createBillingHubPolicies()) {
  return {
...
export function createBillingHubEscalationDeck(policies = createBillingHubPolicies()) {
