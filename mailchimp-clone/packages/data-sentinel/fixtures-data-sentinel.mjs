...
export function createDataSentinelFixtures() {
  return {
    accounts: [
...
export function summarizeDataSentinelFixtures(fixtures = createDataSentinelFixtures()) {
  return {
...
export function createDataSentinelDemoInputs() {
  return {
