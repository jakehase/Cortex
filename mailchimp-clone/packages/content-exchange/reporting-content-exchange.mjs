...
export function createContentExchangeReportCards() {
...
export function createContentExchangeReviewPackets() {
...
export function summarizeContentExchangeReporting() {
  const cards = createContentExchangeReportCards();
  const packets = createContentExchangeReviewPackets();
  return {
