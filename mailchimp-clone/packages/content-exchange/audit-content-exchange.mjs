...
export function createContentExchangeAuditTrail() {
...
export function createContentExchangeEvidenceManifest() {
...
export function createContentExchangeReadinessAttestation() {
  const auditTrail = createContentExchangeAuditTrail();
  return {
