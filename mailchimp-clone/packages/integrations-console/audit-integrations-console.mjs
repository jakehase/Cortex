...
export function createIntegrationsConsoleAuditTrail() {
...
export function createIntegrationsConsoleEvidenceManifest() {
...
export function createIntegrationsConsoleReadinessAttestation() {
  const auditTrail = createIntegrationsConsoleAuditTrail();
  return {
