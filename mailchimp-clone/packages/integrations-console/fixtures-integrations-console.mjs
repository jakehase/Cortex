...
export function createIntegrationsConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeIntegrationsConsoleFixtures(fixtures = createIntegrationsConsoleFixtures()) {
  return {
...
export function createIntegrationsConsoleDemoInputs() {
  return {
