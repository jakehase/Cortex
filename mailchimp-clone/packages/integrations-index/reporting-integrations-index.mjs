...
export function createIntegrationsIndexReportCards() {
...
export function createIntegrationsIndexReviewPackets() {
...
export function summarizeIntegrationsIndexReporting() {
  const cards = createIntegrationsIndexReportCards();
  const packets = createIntegrationsIndexReviewPackets();
  return {
