...
export function createActivationVaultPolicies(overrides = {}) {
...
export function validateActivationVaultPolicies(policies = createActivationVaultPolicies()) {
  const issues = [];
...
export function summarizeActivationVaultPolicies(policies = createActivationVaultPolicies()) {
  return {
...
export function createActivationVaultEscalationDeck(policies = createActivationVaultPolicies()) {
