...
export function createBenchmarkIndexAuditTrail() {
...
export function createBenchmarkIndexEvidenceManifest() {
...
export function createBenchmarkIndexReadinessAttestation() {
  const auditTrail = createBenchmarkIndexAuditTrail();
  return {
