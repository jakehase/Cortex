...
export function createCommerceScorecardPolicies(overrides = {}) {
...
export function validateCommerceScorecardPolicies(policies = createCommerceScorecardPolicies()) {
  const issues = [];
...
export function summarizeCommerceScorecardPolicies(policies = createCommerceScorecardPolicies()) {
  return {
...
export function createCommerceScorecardEscalationDeck(policies = createCommerceScorecardPolicies()) {
