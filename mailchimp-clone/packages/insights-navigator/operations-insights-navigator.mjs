...
export function createInsightsNavigatorOperationsBoard() {
...
export function createInsightsNavigatorShiftChecklist() {
...
export function createInsightsNavigatorIncidentDeck() {
