...
export function createInsightsNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsNavigatorWorkspace(workspace = createInsightsNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsNavigatorNarratives(workspace = createInsightsNavigatorWorkspace()) {
...
export function createInsightsNavigatorCoverageGrid(workspace = createInsightsNavigatorWorkspace()) {
