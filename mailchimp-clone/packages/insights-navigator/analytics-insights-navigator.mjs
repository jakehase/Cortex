...
export function createInsightsNavigatorAnalyticsTimeline() {
...
export function createInsightsNavigatorForecastEnvelope() {
...
export function createInsightsNavigatorExceptionLedger() {
...
export function summarizeInsightsNavigatorAnalytics() {
  const timeline = createInsightsNavigatorAnalyticsTimeline();
  const forecast = createInsightsNavigatorForecastEnvelope();
  return {
