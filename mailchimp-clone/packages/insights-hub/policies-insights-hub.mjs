...
export function createInsightsHubPolicies(overrides = {}) {
...
export function validateInsightsHubPolicies(policies = createInsightsHubPolicies()) {
  const issues = [];
...
export function summarizeInsightsHubPolicies(policies = createInsightsHubPolicies()) {
  return {
...
export function createInsightsHubEscalationDeck(policies = createInsightsHubPolicies()) {
