...
export function createInsightsHubReportCards() {
...
export function createInsightsHubReviewPackets() {
...
export function summarizeInsightsHubReporting() {
  const cards = createInsightsHubReportCards();
  const packets = createInsightsHubReviewPackets();
  return {
