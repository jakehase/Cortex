...
export function createInsightsHubAuditTrail() {
...
export function createInsightsHubEvidenceManifest() {
...
export function createInsightsHubReadinessAttestation() {
  const auditTrail = createInsightsHubAuditTrail();
  return {
