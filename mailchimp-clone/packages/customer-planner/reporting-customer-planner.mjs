...
export function createCustomerPlannerReportCards() {
...
export function createCustomerPlannerReviewPackets() {
...
export function summarizeCustomerPlannerReporting() {
  const cards = createCustomerPlannerReportCards();
  const packets = createCustomerPlannerReviewPackets();
  return {
