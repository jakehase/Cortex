...
export function createCustomerPlannerPolicies(overrides = {}) {
...
export function validateCustomerPlannerPolicies(policies = createCustomerPlannerPolicies()) {
  const issues = [];
...
export function summarizeCustomerPlannerPolicies(policies = createCustomerPlannerPolicies()) {
  return {
...
export function createCustomerPlannerEscalationDeck(policies = createCustomerPlannerPolicies()) {
