...
export function createCampaignHubReportCards() {
...
export function createCampaignHubReviewPackets() {
...
export function summarizeCampaignHubReporting() {
  const cards = createCampaignHubReportCards();
  const packets = createCampaignHubReviewPackets();
  return {
