...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--remote-state-root", default="/home/jake/.local/state/cortex-learning-os/training/states")
    parser.add_argument("--remote-artifact-root", default="/home/jake/.local/state/cortex-learning-os/training/artifacts")
    parser.add_argument("--local-incoming-root", default="/root/.openclaw/cortex-learning-os/training/incoming")
