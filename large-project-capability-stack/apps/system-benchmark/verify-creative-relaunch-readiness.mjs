...
check(checks, promptMode !== 'compact' || stopOnExternalVerificationFailure, 'compact_external_verification_fail_closed', 'compact mode marks external verifier failures non-retryable to avoid repeated invalid token spend', { CREATIVE_WORKER_STOP_ON_EXTERNAL_VERIFICATION_FAILURE: env.CREATIVE_WORKER_STOP_ON_EXTERNAL_VERIFICATION_FAILURE || null, promptMode });
