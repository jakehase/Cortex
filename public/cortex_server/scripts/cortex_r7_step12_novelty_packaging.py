...
ARTIFACT_DIR = ROOT / "artifacts" / "cortex_roadmap" / "r7_value_homeostasis" / "step12"
...
def main() -> int:
    ...
    claim_map = build_claim_map(artifact_root=ROOT / "artifacts" / "cortex_roadmap" / "r7_value_homeostasis")
    reproducibility_pack = build_reproducibility_pack(artifact_root=ROOT / "artifacts" / "cortex_roadmap" / "r7_value_homeostasis")
