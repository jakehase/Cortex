...
def main() -> int:
    ...
    step11 = run_json("scripts/cortex_r7_step11_operator_dashboard.py")
    step12 = run_json("scripts/cortex_r7_step12_novelty_packaging.py")
    payload = {
        "success": True,
        "phase": "phase_e_r7",
        "landed_steps": list(range(1, 13)),
        "remaining_steps": [],
        "step1": step1,
        "step2": step2,
        "step3": step3,
