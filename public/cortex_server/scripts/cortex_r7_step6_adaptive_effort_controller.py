...
CASES = [
    ...
    {"case_id": "high_risk_reminder", "intent": "reminder", "risk_tier": "high", "state_snapshot": NORMAL, "observed_load": {"token_pressure": 0.08, "depth_pressure": 0.05, "latency_pressure": 0.08}, "expected_mode": "normal", "expected_prefer_chain": "safe_reminder", "min_reasoning_depth": 2, "expect_human_review": True, "expect_escalation": True},
