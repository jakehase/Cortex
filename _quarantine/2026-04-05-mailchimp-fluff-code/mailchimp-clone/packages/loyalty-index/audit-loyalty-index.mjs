...
export function createLoyaltyIndexAuditTrail() {
...
export function createLoyaltyIndexEvidenceManifest() {
...
export function createLoyaltyIndexReadinessAttestation() {
  const auditTrail = createLoyaltyIndexAuditTrail();
  return {
