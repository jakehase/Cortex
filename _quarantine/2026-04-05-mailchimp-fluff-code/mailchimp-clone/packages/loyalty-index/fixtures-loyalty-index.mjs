...
export function createLoyaltyIndexFixtures() {
  return {
    accounts: [
...
export function summarizeLoyaltyIndexFixtures(fixtures = createLoyaltyIndexFixtures()) {
  return {
...
export function createLoyaltyIndexDemoInputs() {
  return {
