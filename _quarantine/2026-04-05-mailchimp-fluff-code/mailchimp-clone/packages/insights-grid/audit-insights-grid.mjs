...
export function createInsightsGridAuditTrail() {
...
export function createInsightsGridEvidenceManifest() {
...
export function createInsightsGridReadinessAttestation() {
  const auditTrail = createInsightsGridAuditTrail();
  return {
