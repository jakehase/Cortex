...
export function createInsightsGridPolicies(overrides = {}) {
...
export function validateInsightsGridPolicies(policies = createInsightsGridPolicies()) {
  const issues = [];
...
export function summarizeInsightsGridPolicies(policies = createInsightsGridPolicies()) {
  return {
...
export function createInsightsGridEscalationDeck(policies = createInsightsGridPolicies()) {
