...
export function createInsightsGridAnalyticsTimeline() {
...
export function createInsightsGridForecastEnvelope() {
...
export function createInsightsGridExceptionLedger() {
...
export function summarizeInsightsGridAnalytics() {
  const timeline = createInsightsGridAnalyticsTimeline();
  const forecast = createInsightsGridForecastEnvelope();
  return {
