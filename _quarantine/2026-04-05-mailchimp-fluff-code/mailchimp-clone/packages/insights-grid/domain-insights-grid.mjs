const MODULE = {
  ...
  "routeSegment": "grid",
  "title": "Insights Grid",
  "focus": "Insights Grid covers insight synthesis, operating narratives, and executive-ready summaries through portfolio views and cross-workspace rollups.",
...
export function createInsightsGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsGridWorkspace(workspace = createInsightsGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsGridNarratives(workspace = createInsightsGridWorkspace()) {
...
export function createInsightsGridCoverageGrid(workspace = createInsightsGridWorkspace()) {
