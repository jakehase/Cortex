...
export function createCollaborationStudioPolicies(overrides = {}) {
...
export function validateCollaborationStudioPolicies(policies = createCollaborationStudioPolicies()) {
  const issues = [];
...
export function summarizeCollaborationStudioPolicies(policies = createCollaborationStudioPolicies()) {
  return {
...
export function createCollaborationStudioEscalationDeck(policies = createCollaborationStudioPolicies()) {
