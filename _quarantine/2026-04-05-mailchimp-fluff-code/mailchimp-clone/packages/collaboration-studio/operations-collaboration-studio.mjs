...
export function createCollaborationStudioOperationsBoard() {
...
export function createCollaborationStudioShiftChecklist() {
...
export function createCollaborationStudioIncidentDeck() {
