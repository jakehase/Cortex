...
export function createCollaborationStudioPlaybooks() {
...
export function createCollaborationStudioDecisionDeck() {
...
export function createCollaborationStudioEscalationMoments() {
