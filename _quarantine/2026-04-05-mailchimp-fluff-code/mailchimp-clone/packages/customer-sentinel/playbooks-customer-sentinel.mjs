...
export function createCustomerSentinelPlaybooks() {
...
export function createCustomerSentinelDecisionDeck() {
...
export function createCustomerSentinelEscalationMoments() {
