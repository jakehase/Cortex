...
export function createCustomerSentinelReportCards() {
...
export function createCustomerSentinelReviewPackets() {
...
export function summarizeCustomerSentinelReporting() {
  const cards = createCustomerSentinelReportCards();
  const packets = createCustomerSentinelReviewPackets();
  return {
