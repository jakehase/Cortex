...
export function createCustomerSentinelFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerSentinelFixtures(fixtures = createCustomerSentinelFixtures()) {
  return {
...
export function createCustomerSentinelDemoInputs() {
  return {
