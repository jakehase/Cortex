...
export function createActivationDossierPolicies(overrides = {}) {
...
export function validateActivationDossierPolicies(policies = createActivationDossierPolicies()) {
  const issues = [];
...
export function summarizeActivationDossierPolicies(policies = createActivationDossierPolicies()) {
  return {
...
export function createActivationDossierEscalationDeck(policies = createActivationDossierPolicies()) {
