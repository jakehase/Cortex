...
export function createActivationDossierPlaybooks() {
...
export function createActivationDossierDecisionDeck() {
...
export function createActivationDossierEscalationMoments() {
