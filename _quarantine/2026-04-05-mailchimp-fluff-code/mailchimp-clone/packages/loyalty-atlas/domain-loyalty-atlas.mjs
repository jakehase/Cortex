const MODULE = {
  ...
  "routeSegment": "atlas",
  "title": "Loyalty Atlas",
  "focus": "Loyalty Atlas covers repeat purchase behavior, reward posture, and customer rescue depth through landscape mapping and territory coverage.",
...
export function createLoyaltyAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyAtlasWorkspace(workspace = createLoyaltyAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyAtlasNarratives(workspace = createLoyaltyAtlasWorkspace()) {
...
export function createLoyaltyAtlasCoverageGrid(workspace = createLoyaltyAtlasWorkspace()) {
