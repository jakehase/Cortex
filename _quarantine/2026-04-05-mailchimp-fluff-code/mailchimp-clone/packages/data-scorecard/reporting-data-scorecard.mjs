...
export function createDataScorecardReportCards() {
...
export function createDataScorecardReviewPackets() {
...
export function summarizeDataScorecardReporting() {
  const cards = createDataScorecardReportCards();
  const packets = createDataScorecardReviewPackets();
  return {
