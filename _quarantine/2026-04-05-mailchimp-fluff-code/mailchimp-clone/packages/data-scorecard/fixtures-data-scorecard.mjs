...
export function createDataScorecardFixtures() {
  return {
    accounts: [
...
export function summarizeDataScorecardFixtures(fixtures = createDataScorecardFixtures()) {
  return {
...
export function createDataScorecardDemoInputs() {
  return {
