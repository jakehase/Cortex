...
export function createDataScorecardPolicies(overrides = {}) {
...
export function validateDataScorecardPolicies(policies = createDataScorecardPolicies()) {
  const issues = [];
...
export function summarizeDataScorecardPolicies(policies = createDataScorecardPolicies()) {
  return {
...
export function createDataScorecardEscalationDeck(policies = createDataScorecardPolicies()) {
