...
export function createIntegrationsNotebookAuditTrail() {
...
export function createIntegrationsNotebookEvidenceManifest() {
...
export function createIntegrationsNotebookReadinessAttestation() {
  const auditTrail = createIntegrationsNotebookAuditTrail();
  return {
