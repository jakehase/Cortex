const MODULE = {
  ...
  "focus": "Integrations Notebook covers destination syncs, partner activation, and cross-platform reliability through working notes and experiment memory.",
  ...
  "tags": [
    ...
    "notebook",
    "intelligence",
    "integrations-notebook-wave-seven"
  ]
};
...
export function createIntegrationsNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsNotebookWorkspace(workspace = createIntegrationsNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsNotebookNarratives(workspace = createIntegrationsNotebookWorkspace()) {
...
export function createIntegrationsNotebookCoverageGrid(workspace = createIntegrationsNotebookWorkspace()) {
