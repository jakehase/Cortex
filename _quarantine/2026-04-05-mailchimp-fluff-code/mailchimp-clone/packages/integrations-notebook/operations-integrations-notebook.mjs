...
export function createIntegrationsNotebookOperationsBoard() {
...
export function createIntegrationsNotebookShiftChecklist() {
...
export function createIntegrationsNotebookIncidentDeck() {
