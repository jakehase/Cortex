...
export function createIntegrationsNotebookAnalyticsTimeline() {
...
export function createIntegrationsNotebookForecastEnvelope() {
...
export function createIntegrationsNotebookExceptionLedger() {
...
export function summarizeIntegrationsNotebookAnalytics() {
  const timeline = createIntegrationsNotebookAnalyticsTimeline();
  const forecast = createIntegrationsNotebookForecastEnvelope();
  return {
