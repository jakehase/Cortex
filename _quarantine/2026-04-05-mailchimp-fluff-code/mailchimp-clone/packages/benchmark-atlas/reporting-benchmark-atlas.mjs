...
export function createBenchmarkAtlasReportCards() {
...
export function createBenchmarkAtlasReviewPackets() {
...
export function summarizeBenchmarkAtlasReporting() {
  const cards = createBenchmarkAtlasReportCards();
  const packets = createBenchmarkAtlasReviewPackets();
  return {
