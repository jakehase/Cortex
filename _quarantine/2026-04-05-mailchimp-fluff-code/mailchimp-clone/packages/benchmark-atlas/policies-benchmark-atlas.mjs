...
export function createBenchmarkAtlasPolicies(overrides = {}) {
...
export function validateBenchmarkAtlasPolicies(policies = createBenchmarkAtlasPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkAtlasPolicies(policies = createBenchmarkAtlasPolicies()) {
  return {
...
export function createBenchmarkAtlasEscalationDeck(policies = createBenchmarkAtlasPolicies()) {
