...
export function createBenchmarkAtlasAnalyticsTimeline() {
...
export function createBenchmarkAtlasForecastEnvelope() {
...
export function createBenchmarkAtlasExceptionLedger() {
...
export function summarizeBenchmarkAtlasAnalytics() {
  const timeline = createBenchmarkAtlasAnalyticsTimeline();
  const forecast = createBenchmarkAtlasForecastEnvelope();
  return {
