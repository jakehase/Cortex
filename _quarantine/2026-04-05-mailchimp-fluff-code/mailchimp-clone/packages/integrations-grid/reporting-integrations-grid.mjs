...
export function createIntegrationsGridReportCards() {
...
export function createIntegrationsGridReviewPackets() {
...
export function summarizeIntegrationsGridReporting() {
  const cards = createIntegrationsGridReportCards();
  const packets = createIntegrationsGridReviewPackets();
  return {
