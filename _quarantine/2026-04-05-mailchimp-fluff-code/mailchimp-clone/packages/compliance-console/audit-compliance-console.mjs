...
export function createComplianceConsoleAuditTrail() {
...
export function createComplianceConsoleEvidenceManifest() {
...
export function createComplianceConsoleReadinessAttestation() {
  const auditTrail = createComplianceConsoleAuditTrail();
  return {
