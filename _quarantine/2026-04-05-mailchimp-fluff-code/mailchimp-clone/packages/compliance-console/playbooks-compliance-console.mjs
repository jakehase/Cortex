...
export function createComplianceConsolePlaybooks() {
...
export function createComplianceConsoleDecisionDeck() {
...
export function createComplianceConsoleEscalationMoments() {
