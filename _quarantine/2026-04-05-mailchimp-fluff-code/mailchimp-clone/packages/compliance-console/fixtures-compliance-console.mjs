...
export function createComplianceConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeComplianceConsoleFixtures(fixtures = createComplianceConsoleFixtures()) {
  return {
...
export function createComplianceConsoleDemoInputs() {
  return {
