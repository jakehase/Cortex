...
export function createComplianceConsolePolicies(overrides = {}) {
...
export function validateComplianceConsolePolicies(policies = createComplianceConsolePolicies()) {
  const issues = [];
...
export function summarizeComplianceConsolePolicies(policies = createComplianceConsolePolicies()) {
  return {
...
export function createComplianceConsoleEscalationDeck(policies = createComplianceConsolePolicies()) {
