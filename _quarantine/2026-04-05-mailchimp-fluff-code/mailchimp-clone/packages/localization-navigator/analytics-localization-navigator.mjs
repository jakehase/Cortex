...
export function createLocalizationNavigatorAnalyticsTimeline() {
...
export function createLocalizationNavigatorForecastEnvelope() {
...
export function createLocalizationNavigatorExceptionLedger() {
...
export function summarizeLocalizationNavigatorAnalytics() {
  const timeline = createLocalizationNavigatorAnalyticsTimeline();
  const forecast = createLocalizationNavigatorForecastEnvelope();
  return {
