...
export function createLocalizationNavigatorReportCards() {
...
export function createLocalizationNavigatorReviewPackets() {
...
export function summarizeLocalizationNavigatorReporting() {
  const cards = createLocalizationNavigatorReportCards();
  const packets = createLocalizationNavigatorReviewPackets();
  return {
