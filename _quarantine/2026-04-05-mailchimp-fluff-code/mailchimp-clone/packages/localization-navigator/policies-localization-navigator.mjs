...
export function createLocalizationNavigatorPolicies(overrides = {}) {
...
export function validateLocalizationNavigatorPolicies(policies = createLocalizationNavigatorPolicies()) {
  const issues = [];
...
export function summarizeLocalizationNavigatorPolicies(policies = createLocalizationNavigatorPolicies()) {
  return {
...
export function createLocalizationNavigatorEscalationDeck(policies = createLocalizationNavigatorPolicies()) {
