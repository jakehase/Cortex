...
export function createLoyaltyExchangeReportCards() {
...
export function createLoyaltyExchangeReviewPackets() {
...
export function summarizeLoyaltyExchangeReporting() {
  const cards = createLoyaltyExchangeReportCards();
  const packets = createLoyaltyExchangeReviewPackets();
  return {
