...
export function createLoyaltyExchangeFixtures() {
  return {
    accounts: [
...
export function summarizeLoyaltyExchangeFixtures(fixtures = createLoyaltyExchangeFixtures()) {
  return {
...
export function createLoyaltyExchangeDemoInputs() {
  return {
