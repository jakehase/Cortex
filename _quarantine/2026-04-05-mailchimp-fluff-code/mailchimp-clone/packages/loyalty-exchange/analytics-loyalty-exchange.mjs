...
export function createLoyaltyExchangeAnalyticsTimeline() {
...
export function createLoyaltyExchangeForecastEnvelope() {
...
export function createLoyaltyExchangeExceptionLedger() {
...
export function summarizeLoyaltyExchangeAnalytics() {
  const timeline = createLoyaltyExchangeAnalyticsTimeline();
  const forecast = createLoyaltyExchangeForecastEnvelope();
  return {
