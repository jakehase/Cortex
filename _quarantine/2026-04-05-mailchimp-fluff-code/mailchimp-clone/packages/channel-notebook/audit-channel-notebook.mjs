...
export function createChannelNotebookAuditTrail() {
...
export function createChannelNotebookEvidenceManifest() {
...
export function createChannelNotebookReadinessAttestation() {
  const auditTrail = createChannelNotebookAuditTrail();
  return {
