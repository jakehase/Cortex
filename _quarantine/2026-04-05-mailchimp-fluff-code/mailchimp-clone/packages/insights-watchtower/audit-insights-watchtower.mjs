...
export function createInsightsWatchtowerAuditTrail() {
...
export function createInsightsWatchtowerEvidenceManifest() {
...
export function createInsightsWatchtowerReadinessAttestation() {
  const auditTrail = createInsightsWatchtowerAuditTrail();
  return {
