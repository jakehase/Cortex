...
export function createInsightsWatchtowerReportCards() {
...
export function createInsightsWatchtowerReviewPackets() {
...
export function summarizeInsightsWatchtowerReporting() {
  const cards = createInsightsWatchtowerReportCards();
  const packets = createInsightsWatchtowerReviewPackets();
  return {
