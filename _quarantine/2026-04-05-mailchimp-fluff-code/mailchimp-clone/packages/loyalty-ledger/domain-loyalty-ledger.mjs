...
export function createLoyaltyLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyLedgerWorkspace(workspace = createLoyaltyLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyLedgerNarratives(workspace = createLoyaltyLedgerWorkspace()) {
...
export function createLoyaltyLedgerCoverageGrid(workspace = createLoyaltyLedgerWorkspace()) {
