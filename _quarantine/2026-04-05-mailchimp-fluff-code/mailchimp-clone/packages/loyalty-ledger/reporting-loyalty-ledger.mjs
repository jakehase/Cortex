...
export function createLoyaltyLedgerReportCards() {
...
export function createLoyaltyLedgerReviewPackets() {
...
export function summarizeLoyaltyLedgerReporting() {
  const cards = createLoyaltyLedgerReportCards();
  const packets = createLoyaltyLedgerReviewPackets();
  return {
