...
export function createLoyaltyLedgerAnalyticsTimeline() {
...
export function createLoyaltyLedgerForecastEnvelope() {
...
export function createLoyaltyLedgerExceptionLedger() {
...
export function summarizeLoyaltyLedgerAnalytics() {
  const timeline = createLoyaltyLedgerAnalyticsTimeline();
  const forecast = createLoyaltyLedgerForecastEnvelope();
  return {
