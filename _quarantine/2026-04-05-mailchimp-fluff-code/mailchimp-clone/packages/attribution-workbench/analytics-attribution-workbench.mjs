...
export function createAttributionWorkbenchAnalyticsTimeline() {
...
export function createAttributionWorkbenchForecastEnvelope() {
...
export function createAttributionWorkbenchExceptionLedger() {
...
export function summarizeAttributionWorkbenchAnalytics() {
  const timeline = createAttributionWorkbenchAnalyticsTimeline();
  const forecast = createAttributionWorkbenchForecastEnvelope();
  return {
