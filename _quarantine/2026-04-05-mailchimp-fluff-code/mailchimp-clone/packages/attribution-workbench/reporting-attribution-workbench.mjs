...
export function createAttributionWorkbenchReportCards() {
...
export function createAttributionWorkbenchReviewPackets() {
...
export function summarizeAttributionWorkbenchReporting() {
  const cards = createAttributionWorkbenchReportCards();
  const packets = createAttributionWorkbenchReviewPackets();
  return {
