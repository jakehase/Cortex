...
export function createAttributionWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAttributionWorkbenchWorkspace(workspace = createAttributionWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createAttributionWorkbenchNarratives(workspace = createAttributionWorkbenchWorkspace()) {
...
export function createAttributionWorkbenchCoverageGrid(workspace = createAttributionWorkbenchWorkspace()) {
