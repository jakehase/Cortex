...
export function createConsentAtlasPolicies(overrides = {}) {
...
export function validateConsentAtlasPolicies(policies = createConsentAtlasPolicies()) {
  const issues = [];
...
export function summarizeConsentAtlasPolicies(policies = createConsentAtlasPolicies()) {
  return {
...
export function createConsentAtlasEscalationDeck(policies = createConsentAtlasPolicies()) {
