...
export function createDeliverabilityNavigatorAnalyticsTimeline() {
...
export function createDeliverabilityNavigatorForecastEnvelope() {
...
export function createDeliverabilityNavigatorExceptionLedger() {
...
export function summarizeDeliverabilityNavigatorAnalytics() {
  const timeline = createDeliverabilityNavigatorAnalyticsTimeline();
  const forecast = createDeliverabilityNavigatorForecastEnvelope();
  return {
