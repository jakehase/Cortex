...
export function createDeliverabilityNavigatorAuditTrail() {
...
export function createDeliverabilityNavigatorEvidenceManifest() {
...
export function createDeliverabilityNavigatorReadinessAttestation() {
  const auditTrail = createDeliverabilityNavigatorAuditTrail();
  return {
