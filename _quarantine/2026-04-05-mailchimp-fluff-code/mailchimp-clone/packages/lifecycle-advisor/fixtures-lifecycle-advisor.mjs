...
export function createLifecycleAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeLifecycleAdvisorFixtures(fixtures = createLifecycleAdvisorFixtures()) {
  return {
...
export function createLifecycleAdvisorDemoInputs() {
  return {
