...
export function createLifecycleAdvisorAuditTrail() {
...
export function createLifecycleAdvisorEvidenceManifest() {
...
export function createLifecycleAdvisorReadinessAttestation() {
  const auditTrail = createLifecycleAdvisorAuditTrail();
  return {
