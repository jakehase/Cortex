...
export function createDeliverabilityExchangeAuditTrail() {
...
export function createDeliverabilityExchangeEvidenceManifest() {
...
export function createDeliverabilityExchangeReadinessAttestation() {
  const auditTrail = createDeliverabilityExchangeAuditTrail();
  return {
