...
export function createCommerceIndexPolicies(overrides = {}) {
...
export function validateCommerceIndexPolicies(policies = createCommerceIndexPolicies()) {
  const issues = [];
...
export function summarizeCommerceIndexPolicies(policies = createCommerceIndexPolicies()) {
  return {
...
export function createCommerceIndexEscalationDeck(policies = createCommerceIndexPolicies()) {
