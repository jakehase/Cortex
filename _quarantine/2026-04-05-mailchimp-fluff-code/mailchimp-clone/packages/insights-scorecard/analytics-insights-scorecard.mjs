...
export function createInsightsScorecardAnalyticsTimeline() {
...
export function createInsightsScorecardForecastEnvelope() {
...
export function createInsightsScorecardExceptionLedger() {
...
export function summarizeInsightsScorecardAnalytics() {
  const timeline = createInsightsScorecardAnalyticsTimeline();
  const forecast = createInsightsScorecardForecastEnvelope();
  return {
