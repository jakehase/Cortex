...
export function createInsightsScorecardPolicies(overrides = {}) {
...
export function validateInsightsScorecardPolicies(policies = createInsightsScorecardPolicies()) {
  const issues = [];
...
export function summarizeInsightsScorecardPolicies(policies = createInsightsScorecardPolicies()) {
  return {
...
export function createInsightsScorecardEscalationDeck(policies = createInsightsScorecardPolicies()) {
