...
export function createInsightsScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsScorecardWorkspace(workspace = createInsightsScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsScorecardNarratives(workspace = createInsightsScorecardWorkspace()) {
...
export function createInsightsScorecardCoverageGrid(workspace = createInsightsScorecardWorkspace()) {
