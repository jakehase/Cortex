...
export function createInsightsScorecardOperationsBoard() {
...
export function createInsightsScorecardShiftChecklist() {
...
export function createInsightsScorecardIncidentDeck() {
