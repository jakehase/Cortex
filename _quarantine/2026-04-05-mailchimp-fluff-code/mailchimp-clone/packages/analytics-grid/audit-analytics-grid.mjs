...
export function createAnalyticsGridAuditTrail() {
...
export function createAnalyticsGridEvidenceManifest() {
...
export function createAnalyticsGridReadinessAttestation() {
  const auditTrail = createAnalyticsGridAuditTrail();
  return {
