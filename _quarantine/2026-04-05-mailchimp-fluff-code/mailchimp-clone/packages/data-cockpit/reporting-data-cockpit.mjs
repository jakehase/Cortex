...
export function createDataCockpitReportCards() {
...
export function createDataCockpitReviewPackets() {
...
export function summarizeDataCockpitReporting() {
  const cards = createDataCockpitReportCards();
  const packets = createDataCockpitReviewPackets();
  return {
