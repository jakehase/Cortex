const MODULE = {
  ...
  "title": "Data Cockpit",
  "focus": "Data Cockpit covers pipeline health, lineage, freshness, and operator trust in data assets through operator controls and active monitoring.",
...
export function createDataCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataCockpitWorkspace(workspace = createDataCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataCockpitNarratives(workspace = createDataCockpitWorkspace()) {
...
export function createDataCockpitCoverageGrid(workspace = createDataCockpitWorkspace()) {
