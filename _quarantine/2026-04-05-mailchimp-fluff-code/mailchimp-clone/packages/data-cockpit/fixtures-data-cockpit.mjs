...
export function createDataCockpitFixtures() {
  return {
    accounts: [
...
export function summarizeDataCockpitFixtures(fixtures = createDataCockpitFixtures()) {
  return {
...
export function createDataCockpitDemoInputs() {
  return {
