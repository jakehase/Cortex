...
export function createLifecycleStudioFixtures() {
  return {
    accounts: [
...
export function summarizeLifecycleStudioFixtures(fixtures = createLifecycleStudioFixtures()) {
  return {
...
export function createLifecycleStudioDemoInputs() {
  return {
