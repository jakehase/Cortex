...
export function createLifecycleStudioReportCards() {
...
export function createLifecycleStudioReviewPackets() {
...
export function summarizeLifecycleStudioReporting() {
  const cards = createLifecycleStudioReportCards();
  const packets = createLifecycleStudioReviewPackets();
  return {
