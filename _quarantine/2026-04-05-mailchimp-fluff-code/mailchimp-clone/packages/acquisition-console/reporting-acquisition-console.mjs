...
export function createAcquisitionConsoleReportCards() {
...
export function createAcquisitionConsoleReviewPackets() {
...
export function summarizeAcquisitionConsoleReporting() {
  const cards = createAcquisitionConsoleReportCards();
  const packets = createAcquisitionConsoleReviewPackets();
  return {
