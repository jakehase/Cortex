const MODULE = {
  "id": "acquisition-console",
  "ordinal": 4,
  "domain": "acquisition",
  "surfaceId": "console",
  "surfaceTitle": "Console",
  "routeSegment": "console",
  "title": "Acquisition Console",
  "focus": "Acquisition Console covers new demand creation, source quality, and upstream handoff clarity through execution controls and workspace steering.",
  ...
  "tags": [
    ...
    "console",
    "growth",
    "acquisition-console-wave-seven"
  ]
};
...
export function createAcquisitionConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionConsoleWorkspace(workspace = createAcquisitionConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionConsoleNarratives(workspace = createAcquisitionConsoleWorkspace()) {
...
export function createAcquisitionConsoleCoverageGrid(workspace = createAcquisitionConsoleWorkspace()) {
