...
export function createInsightsVaultPolicies(overrides = {}) {
...
export function validateInsightsVaultPolicies(policies = createInsightsVaultPolicies()) {
  const issues = [];
...
export function summarizeInsightsVaultPolicies(policies = createInsightsVaultPolicies()) {
  return {
...
export function createInsightsVaultEscalationDeck(policies = createInsightsVaultPolicies()) {
