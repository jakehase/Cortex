...
export function createInsightsVaultWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsVaultWorkspace(workspace = createInsightsVaultWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsVaultNarratives(workspace = createInsightsVaultWorkspace()) {
...
export function createInsightsVaultCoverageGrid(workspace = createInsightsVaultWorkspace()) {
