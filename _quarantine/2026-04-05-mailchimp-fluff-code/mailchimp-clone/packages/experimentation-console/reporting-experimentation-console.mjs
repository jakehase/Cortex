...
export function createExperimentationConsoleReportCards() {
...
export function createExperimentationConsoleReviewPackets() {
...
export function summarizeExperimentationConsoleReporting() {
  const cards = createExperimentationConsoleReportCards();
  const packets = createExperimentationConsoleReviewPackets();
  return {
