...
export function createComplianceIndexReportCards() {
...
export function createComplianceIndexReviewPackets() {
...
export function summarizeComplianceIndexReporting() {
  const cards = createComplianceIndexReportCards();
  const packets = createComplianceIndexReviewPackets();
  return {
