...
export function createComplianceIndexOperationsBoard() {
...
export function createComplianceIndexShiftChecklist() {
...
export function createComplianceIndexIncidentDeck() {
