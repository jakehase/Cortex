...
export function createComplianceIndexPolicies(overrides = {}) {
...
export function validateComplianceIndexPolicies(policies = createComplianceIndexPolicies()) {
  const issues = [];
...
export function summarizeComplianceIndexPolicies(policies = createComplianceIndexPolicies()) {
  return {
...
export function createComplianceIndexEscalationDeck(policies = createComplianceIndexPolicies()) {
