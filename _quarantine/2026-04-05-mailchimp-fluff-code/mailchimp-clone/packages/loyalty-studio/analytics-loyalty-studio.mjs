...
export function createLoyaltyStudioAnalyticsTimeline() {
...
export function createLoyaltyStudioForecastEnvelope() {
...
export function createLoyaltyStudioExceptionLedger() {
...
export function summarizeLoyaltyStudioAnalytics() {
  const timeline = createLoyaltyStudioAnalyticsTimeline();
  const forecast = createLoyaltyStudioForecastEnvelope();
  return {
