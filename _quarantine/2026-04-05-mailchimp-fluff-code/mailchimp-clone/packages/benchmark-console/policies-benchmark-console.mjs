...
export function createBenchmarkConsolePolicies(overrides = {}) {
...
export function validateBenchmarkConsolePolicies(policies = createBenchmarkConsolePolicies()) {
  const issues = [];
...
export function summarizeBenchmarkConsolePolicies(policies = createBenchmarkConsolePolicies()) {
  return {
...
export function createBenchmarkConsoleEscalationDeck(policies = createBenchmarkConsolePolicies()) {
