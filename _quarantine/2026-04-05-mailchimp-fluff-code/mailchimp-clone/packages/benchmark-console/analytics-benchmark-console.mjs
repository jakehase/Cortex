...
export function createBenchmarkConsoleAnalyticsTimeline() {
...
export function createBenchmarkConsoleForecastEnvelope() {
...
export function createBenchmarkConsoleExceptionLedger() {
...
export function summarizeBenchmarkConsoleAnalytics() {
  const timeline = createBenchmarkConsoleAnalyticsTimeline();
  const forecast = createBenchmarkConsoleForecastEnvelope();
  return {
