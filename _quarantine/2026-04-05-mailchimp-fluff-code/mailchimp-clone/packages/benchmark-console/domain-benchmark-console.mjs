...
export function createBenchmarkConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBenchmarkConsoleWorkspace(workspace = createBenchmarkConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createBenchmarkConsoleNarratives(workspace = createBenchmarkConsoleWorkspace()) {
...
export function createBenchmarkConsoleCoverageGrid(workspace = createBenchmarkConsoleWorkspace()) {
