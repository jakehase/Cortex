...
export function createContentNavigatorReportCards() {
...
export function createContentNavigatorReviewPackets() {
...
export function summarizeContentNavigatorReporting() {
  const cards = createContentNavigatorReportCards();
  const packets = createContentNavigatorReviewPackets();
  return {
