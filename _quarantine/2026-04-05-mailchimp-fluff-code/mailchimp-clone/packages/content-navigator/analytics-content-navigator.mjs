...
export function createContentNavigatorAnalyticsTimeline() {
...
export function createContentNavigatorForecastEnvelope() {
...
export function createContentNavigatorExceptionLedger() {
...
export function summarizeContentNavigatorAnalytics() {
  const timeline = createContentNavigatorAnalyticsTimeline();
  const forecast = createContentNavigatorForecastEnvelope();
  return {
