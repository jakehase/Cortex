const MODULE = {
  ...
  "focus": "Content Navigator covers content operations, packaging, and channel-specific delivery shape through journey guidance and directional controls.",
...
export function createContentNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentNavigatorWorkspace(workspace = createContentNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentNavigatorNarratives(workspace = createContentNavigatorWorkspace()) {
...
export function createContentNavigatorCoverageGrid(workspace = createContentNavigatorWorkspace()) {
