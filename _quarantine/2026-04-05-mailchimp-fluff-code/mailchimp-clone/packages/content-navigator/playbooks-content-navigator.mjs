...
export function createContentNavigatorPlaybooks() {
...
export function createContentNavigatorDecisionDeck() {
...
export function createContentNavigatorEscalationMoments() {
