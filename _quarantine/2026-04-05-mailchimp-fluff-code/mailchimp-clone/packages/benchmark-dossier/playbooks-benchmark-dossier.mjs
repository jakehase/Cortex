...
export function createBenchmarkDossierPlaybooks() {
...
export function createBenchmarkDossierDecisionDeck() {
...
export function createBenchmarkDossierEscalationMoments() {
