...
export function createCreativeDossierReportCards() {
...
export function createCreativeDossierReviewPackets() {
...
export function summarizeCreativeDossierReporting() {
  const cards = createCreativeDossierReportCards();
  const packets = createCreativeDossierReviewPackets();
  return {
