...
export function createAnalyticsScorecardPlaybooks() {
...
export function createAnalyticsScorecardDecisionDeck() {
...
export function createAnalyticsScorecardEscalationMoments() {
