...
export function createAnalyticsScorecardOperationsBoard() {
...
export function createAnalyticsScorecardShiftChecklist() {
...
export function createAnalyticsScorecardIncidentDeck() {
