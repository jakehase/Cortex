...
export function createIntegrationsVaultPlaybooks() {
...
export function createIntegrationsVaultDecisionDeck() {
...
export function createIntegrationsVaultEscalationMoments() {
