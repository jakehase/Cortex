...
export function createIntegrationsVaultReportCards() {
...
export function createIntegrationsVaultReviewPackets() {
...
export function summarizeIntegrationsVaultReporting() {
  const cards = createIntegrationsVaultReportCards();
  const packets = createIntegrationsVaultReviewPackets();
  return {
