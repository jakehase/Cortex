...
export function createIntegrationsVaultPolicies(overrides = {}) {
...
export function validateIntegrationsVaultPolicies(policies = createIntegrationsVaultPolicies()) {
  const issues = [];
...
export function summarizeIntegrationsVaultPolicies(policies = createIntegrationsVaultPolicies()) {
  return {
...
export function createIntegrationsVaultEscalationDeck(policies = createIntegrationsVaultPolicies()) {
