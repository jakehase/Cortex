...
export function createBenchmarkCockpitReportCards() {
...
export function createBenchmarkCockpitReviewPackets() {
...
export function summarizeBenchmarkCockpitReporting() {
  const cards = createBenchmarkCockpitReportCards();
  const packets = createBenchmarkCockpitReviewPackets();
  return {
