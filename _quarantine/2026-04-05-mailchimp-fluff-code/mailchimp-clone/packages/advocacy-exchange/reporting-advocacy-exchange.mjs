...
export function createAdvocacyExchangeReportCards() {
...
export function createAdvocacyExchangeReviewPackets() {
...
export function summarizeAdvocacyExchangeReporting() {
  const cards = createAdvocacyExchangeReportCards();
  const packets = createAdvocacyExchangeReviewPackets();
  return {
