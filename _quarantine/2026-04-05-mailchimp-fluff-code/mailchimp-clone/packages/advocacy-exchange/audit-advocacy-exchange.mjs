...
export function createAdvocacyExchangeAuditTrail() {
...
export function createAdvocacyExchangeEvidenceManifest() {
...
export function createAdvocacyExchangeReadinessAttestation() {
  const auditTrail = createAdvocacyExchangeAuditTrail();
  return {
