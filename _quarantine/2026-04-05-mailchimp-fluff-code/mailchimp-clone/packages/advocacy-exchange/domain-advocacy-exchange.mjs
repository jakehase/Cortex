...
export function createAdvocacyExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyExchangeWorkspace(workspace = createAdvocacyExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyExchangeNarratives(workspace = createAdvocacyExchangeWorkspace()) {
...
export function createAdvocacyExchangeCoverageGrid(workspace = createAdvocacyExchangeWorkspace()) {
