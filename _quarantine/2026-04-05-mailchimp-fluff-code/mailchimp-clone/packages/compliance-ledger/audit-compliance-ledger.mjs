...
export function createComplianceLedgerAuditTrail() {
...
export function createComplianceLedgerEvidenceManifest() {
...
export function createComplianceLedgerReadinessAttestation() {
  const auditTrail = createComplianceLedgerAuditTrail();
  return {
