...
export function createDeliverabilityAtlasAuditTrail() {
...
export function createDeliverabilityAtlasEvidenceManifest() {
...
export function createDeliverabilityAtlasReadinessAttestation() {
  const auditTrail = createDeliverabilityAtlasAuditTrail();
  return {
