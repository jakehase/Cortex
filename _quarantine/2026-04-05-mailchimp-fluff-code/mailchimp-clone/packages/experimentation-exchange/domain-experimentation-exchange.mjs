const MODULE = {
  "id": "experimentation-exchange",
  "ordinal": 424,
  "domain": "experimentation",
  "surfaceId": "exchange",
  "surfaceTitle": "Exchange",
  "routeSegment": "exchange",
  "title": "Experimentation Exchange",
  "focus": "Experimentation Exchange covers test planning, variant analysis, and decision velocity through handoff workflows and partner coordination.",
  ...
  "tags": [
    ...
    "exchange",
    "intelligence",
    "experimentation-exchange-wave-seven"
  ]
};
...
export function createExperimentationExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationExchangeWorkspace(workspace = createExperimentationExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationExchangeNarratives(workspace = createExperimentationExchangeWorkspace()) {
...
export function createExperimentationExchangeCoverageGrid(workspace = createExperimentationExchangeWorkspace()) {
