...
export function createExperimentationExchangeAuditTrail() {
...
export function createExperimentationExchangeEvidenceManifest() {
...
export function createExperimentationExchangeReadinessAttestation() {
  const auditTrail = createExperimentationExchangeAuditTrail();
  return {
