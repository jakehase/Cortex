...
export function createExperimentationExchangeAnalyticsTimeline() {
...
export function createExperimentationExchangeForecastEnvelope() {
...
export function createExperimentationExchangeExceptionLedger() {
...
export function summarizeExperimentationExchangeAnalytics() {
  const timeline = createExperimentationExchangeAnalyticsTimeline();
  const forecast = createExperimentationExchangeForecastEnvelope();
  return {
