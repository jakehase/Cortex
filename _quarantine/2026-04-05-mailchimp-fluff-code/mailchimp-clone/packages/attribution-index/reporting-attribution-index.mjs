...
export function createAttributionIndexReportCards() {
...
export function createAttributionIndexReviewPackets() {
...
export function summarizeAttributionIndexReporting() {
  const cards = createAttributionIndexReportCards();
  const packets = createAttributionIndexReviewPackets();
  return {
