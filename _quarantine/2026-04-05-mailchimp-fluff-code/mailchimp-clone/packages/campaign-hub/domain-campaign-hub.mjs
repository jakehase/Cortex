const MODULE = {
  ...
  "routeSegment": "hub",
  "title": "Campaign Hub",
  "focus": "Campaign Hub covers campaign planning, milestone choreography, and launch readiness through centralized operating views and routing.",
...
export function createCampaignHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignHubWorkspace(workspace = createCampaignHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignHubNarratives(workspace = createCampaignHubWorkspace()) {
...
export function createCampaignHubCoverageGrid(workspace = createCampaignHubWorkspace()) {
