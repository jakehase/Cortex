...
export function createCampaignHubPolicies(overrides = {}) {
...
export function validateCampaignHubPolicies(policies = createCampaignHubPolicies()) {
  const issues = [];
...
export function summarizeCampaignHubPolicies(policies = createCampaignHubPolicies()) {
  return {
...
export function createCampaignHubEscalationDeck(policies = createCampaignHubPolicies()) {
