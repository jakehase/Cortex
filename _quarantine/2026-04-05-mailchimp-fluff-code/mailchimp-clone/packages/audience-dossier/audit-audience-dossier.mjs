...
export function createAudienceDossierAuditTrail() {
...
export function createAudienceDossierEvidenceManifest() {
...
export function createAudienceDossierReadinessAttestation() {
  const auditTrail = createAudienceDossierAuditTrail();
  return {
