...
export function createCollaborationPlannerReportCards() {
...
export function createCollaborationPlannerReviewPackets() {
...
export function summarizeCollaborationPlannerReporting() {
  const cards = createCollaborationPlannerReportCards();
  const packets = createCollaborationPlannerReviewPackets();
  return {
