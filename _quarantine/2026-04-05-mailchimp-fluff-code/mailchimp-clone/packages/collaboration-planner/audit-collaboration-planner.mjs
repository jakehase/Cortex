...
export function createCollaborationPlannerAuditTrail() {
...
export function createCollaborationPlannerEvidenceManifest() {
...
export function createCollaborationPlannerReadinessAttestation() {
  const auditTrail = createCollaborationPlannerAuditTrail();
  return {
