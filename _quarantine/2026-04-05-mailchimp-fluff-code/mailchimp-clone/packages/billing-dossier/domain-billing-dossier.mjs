...
export function createBillingDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingDossierWorkspace(workspace = createBillingDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingDossierNarratives(workspace = createBillingDossierWorkspace()) {
...
export function createBillingDossierCoverageGrid(workspace = createBillingDossierWorkspace()) {
