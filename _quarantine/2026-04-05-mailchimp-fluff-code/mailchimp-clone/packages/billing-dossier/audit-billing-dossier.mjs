...
export function createBillingDossierAuditTrail() {
...
export function createBillingDossierEvidenceManifest() {
...
export function createBillingDossierReadinessAttestation() {
  const auditTrail = createBillingDossierAuditTrail();
  return {
