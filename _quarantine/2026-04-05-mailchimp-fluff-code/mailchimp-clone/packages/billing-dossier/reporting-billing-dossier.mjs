...
export function createBillingDossierReportCards() {
...
export function createBillingDossierReviewPackets() {
...
export function summarizeBillingDossierReporting() {
  const cards = createBillingDossierReportCards();
  const packets = createBillingDossierReviewPackets();
  return {
