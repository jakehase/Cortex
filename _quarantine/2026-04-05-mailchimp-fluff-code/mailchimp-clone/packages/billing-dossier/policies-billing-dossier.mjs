...
export function createBillingDossierPolicies(overrides = {}) {
...
export function validateBillingDossierPolicies(policies = createBillingDossierPolicies()) {
  const issues = [];
...
export function summarizeBillingDossierPolicies(policies = createBillingDossierPolicies()) {
  return {
...
export function createBillingDossierEscalationDeck(policies = createBillingDossierPolicies()) {
