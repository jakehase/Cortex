...
export function createBenchmarkIndexAnalyticsTimeline() {
...
export function createBenchmarkIndexForecastEnvelope() {
...
export function createBenchmarkIndexExceptionLedger() {
...
export function summarizeBenchmarkIndexAnalytics() {
  const timeline = createBenchmarkIndexAnalyticsTimeline();
  const forecast = createBenchmarkIndexForecastEnvelope();
  return {
