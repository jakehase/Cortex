...
export function createLifecycleFoundryPolicies(overrides = {}) {
...
export function validateLifecycleFoundryPolicies(policies = createLifecycleFoundryPolicies()) {
  const issues = [];
...
export function summarizeLifecycleFoundryPolicies(policies = createLifecycleFoundryPolicies()) {
  return {
...
export function createLifecycleFoundryEscalationDeck(policies = createLifecycleFoundryPolicies()) {
