...
export function createLifecycleFoundryReportCards() {
...
export function createLifecycleFoundryReviewPackets() {
...
export function summarizeLifecycleFoundryReporting() {
  const cards = createLifecycleFoundryReportCards();
  const packets = createLifecycleFoundryReviewPackets();
  return {
