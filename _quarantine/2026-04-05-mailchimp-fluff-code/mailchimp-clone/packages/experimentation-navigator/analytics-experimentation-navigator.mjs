...
export function createExperimentationNavigatorAnalyticsTimeline() {
...
export function createExperimentationNavigatorForecastEnvelope() {
...
export function createExperimentationNavigatorExceptionLedger() {
...
export function summarizeExperimentationNavigatorAnalytics() {
  const timeline = createExperimentationNavigatorAnalyticsTimeline();
  const forecast = createExperimentationNavigatorForecastEnvelope();
  return {
