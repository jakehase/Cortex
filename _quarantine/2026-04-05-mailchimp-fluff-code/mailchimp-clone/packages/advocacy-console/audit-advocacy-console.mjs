...
export function createAdvocacyConsoleAuditTrail() {
...
export function createAdvocacyConsoleEvidenceManifest() {
...
export function createAdvocacyConsoleReadinessAttestation() {
  const auditTrail = createAdvocacyConsoleAuditTrail();
  return {
