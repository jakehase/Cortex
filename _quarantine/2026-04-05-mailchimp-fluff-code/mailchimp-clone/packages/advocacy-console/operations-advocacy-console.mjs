...
export function createAdvocacyConsoleOperationsBoard() {
...
export function createAdvocacyConsoleShiftChecklist() {
...
export function createAdvocacyConsoleIncidentDeck() {
