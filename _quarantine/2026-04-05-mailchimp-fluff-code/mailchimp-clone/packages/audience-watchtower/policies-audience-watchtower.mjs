...
export function createAudienceWatchtowerPolicies(overrides = {}) {
...
export function validateAudienceWatchtowerPolicies(policies = createAudienceWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeAudienceWatchtowerPolicies(policies = createAudienceWatchtowerPolicies()) {
  return {
...
export function createAudienceWatchtowerEscalationDeck(policies = createAudienceWatchtowerPolicies()) {
