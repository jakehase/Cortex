...
export function createAudienceWatchtowerFixtures() {
  return {
    accounts: [
...
export function summarizeAudienceWatchtowerFixtures(fixtures = createAudienceWatchtowerFixtures()) {
  return {
...
export function createAudienceWatchtowerDemoInputs() {
  return {
