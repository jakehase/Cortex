...
export function createAudienceWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceWatchtowerWorkspace(workspace = createAudienceWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceWatchtowerNarratives(workspace = createAudienceWatchtowerWorkspace()) {
...
export function createAudienceWatchtowerCoverageGrid(workspace = createAudienceWatchtowerWorkspace()) {
