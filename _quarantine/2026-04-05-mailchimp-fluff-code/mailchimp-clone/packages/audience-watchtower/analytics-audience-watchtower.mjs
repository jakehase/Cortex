...
export function createAudienceWatchtowerAnalyticsTimeline() {
...
export function createAudienceWatchtowerForecastEnvelope() {
...
export function createAudienceWatchtowerExceptionLedger() {
...
export function summarizeAudienceWatchtowerAnalytics() {
  const timeline = createAudienceWatchtowerAnalyticsTimeline();
  const forecast = createAudienceWatchtowerForecastEnvelope();
  return {
