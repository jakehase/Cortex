...
export function createInsightsStudioPolicies(overrides = {}) {
...
export function validateInsightsStudioPolicies(policies = createInsightsStudioPolicies()) {
  const issues = [];
...
export function summarizeInsightsStudioPolicies(policies = createInsightsStudioPolicies()) {
  return {
...
export function createInsightsStudioEscalationDeck(policies = createInsightsStudioPolicies()) {
