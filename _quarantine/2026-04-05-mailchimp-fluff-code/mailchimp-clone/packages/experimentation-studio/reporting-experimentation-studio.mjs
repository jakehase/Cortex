...
export function createExperimentationStudioReportCards() {
...
export function createExperimentationStudioReviewPackets() {
...
export function summarizeExperimentationStudioReporting() {
  const cards = createExperimentationStudioReportCards();
  const packets = createExperimentationStudioReviewPackets();
  return {
