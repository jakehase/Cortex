...
export function createCreativeHubPolicies(overrides = {}) {
...
export function validateCreativeHubPolicies(policies = createCreativeHubPolicies()) {
  const issues = [];
...
export function summarizeCreativeHubPolicies(policies = createCreativeHubPolicies()) {
  return {
...
export function createCreativeHubEscalationDeck(policies = createCreativeHubPolicies()) {
