...
export function createAudienceAdvisorReportCards() {
...
export function createAudienceAdvisorReviewPackets() {
...
export function summarizeAudienceAdvisorReporting() {
  const cards = createAudienceAdvisorReportCards();
  const packets = createAudienceAdvisorReviewPackets();
  return {
