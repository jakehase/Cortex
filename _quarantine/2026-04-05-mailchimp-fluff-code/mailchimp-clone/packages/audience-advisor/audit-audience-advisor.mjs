...
export function createAudienceAdvisorAuditTrail() {
...
export function createAudienceAdvisorEvidenceManifest() {
...
export function createAudienceAdvisorReadinessAttestation() {
  const auditTrail = createAudienceAdvisorAuditTrail();
  return {
