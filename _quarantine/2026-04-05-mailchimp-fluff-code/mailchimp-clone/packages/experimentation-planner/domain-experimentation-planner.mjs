...
export function createExperimentationPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationPlannerWorkspace(workspace = createExperimentationPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationPlannerNarratives(workspace = createExperimentationPlannerWorkspace()) {
...
export function createExperimentationPlannerCoverageGrid(workspace = createExperimentationPlannerWorkspace()) {
