...
export function createExperimentationPlannerAuditTrail() {
...
export function createExperimentationPlannerEvidenceManifest() {
...
export function createExperimentationPlannerReadinessAttestation() {
  const auditTrail = createExperimentationPlannerAuditTrail();
  return {
