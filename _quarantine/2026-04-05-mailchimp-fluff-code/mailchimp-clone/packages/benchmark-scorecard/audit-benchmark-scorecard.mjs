...
export function createBenchmarkScorecardAuditTrail() {
...
export function createBenchmarkScorecardEvidenceManifest() {
...
export function createBenchmarkScorecardReadinessAttestation() {
  const auditTrail = createBenchmarkScorecardAuditTrail();
  return {
