...
export function createBenchmarkScorecardReportCards() {
...
export function createBenchmarkScorecardReviewPackets() {
...
export function summarizeBenchmarkScorecardReporting() {
  const cards = createBenchmarkScorecardReportCards();
  const packets = createBenchmarkScorecardReviewPackets();
  return {
