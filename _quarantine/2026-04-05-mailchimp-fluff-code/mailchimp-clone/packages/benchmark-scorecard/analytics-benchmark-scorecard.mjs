...
export function createBenchmarkScorecardAnalyticsTimeline() {
...
export function createBenchmarkScorecardForecastEnvelope() {
...
export function createBenchmarkScorecardExceptionLedger() {
...
export function summarizeBenchmarkScorecardAnalytics() {
  const timeline = createBenchmarkScorecardAnalyticsTimeline();
  const forecast = createBenchmarkScorecardForecastEnvelope();
  return {
