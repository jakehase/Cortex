...
export function createAnalyticsWatchtowerPolicies(overrides = {}) {
...
export function validateAnalyticsWatchtowerPolicies(policies = createAnalyticsWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeAnalyticsWatchtowerPolicies(policies = createAnalyticsWatchtowerPolicies()) {
  return {
...
export function createAnalyticsWatchtowerEscalationDeck(policies = createAnalyticsWatchtowerPolicies()) {
