...
export function createAnalyticsWatchtowerOperationsBoard() {
...
export function createAnalyticsWatchtowerShiftChecklist() {
...
export function createAnalyticsWatchtowerIncidentDeck() {
