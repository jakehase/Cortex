const MODULE = {
  "id": "analytics-watchtower",
  "ordinal": 79,
  "domain": "analytics",
  "surfaceId": "watchtower",
  "surfaceTitle": "Watchtower",
  "routeSegment": "watchtower",
  "title": "Analytics Watchtower",
  "focus": "Analytics Watchtower covers portfolio analytics, operator scorecards, and query-driven reviews through oversight dashboards and escalation views.",
  ...
  "tags": [
    ...
    "watchtower",
    "revenue",
    "analytics-watchtower-wave-seven"
  ]
};
...
export function createAnalyticsWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsWatchtowerWorkspace(workspace = createAnalyticsWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsWatchtowerNarratives(workspace = createAnalyticsWatchtowerWorkspace()) {
...
export function createAnalyticsWatchtowerCoverageGrid(workspace = createAnalyticsWatchtowerWorkspace()) {
