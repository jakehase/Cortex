...
export function createLocalizationCockpitOperationsBoard() {
...
export function createLocalizationCockpitShiftChecklist() {
...
export function createLocalizationCockpitIncidentDeck() {
