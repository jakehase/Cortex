...
export function createLifecycleDossierReportCards() {
...
export function createLifecycleDossierReviewPackets() {
...
export function summarizeLifecycleDossierReporting() {
  const cards = createLifecycleDossierReportCards();
  const packets = createLifecycleDossierReviewPackets();
  return {
