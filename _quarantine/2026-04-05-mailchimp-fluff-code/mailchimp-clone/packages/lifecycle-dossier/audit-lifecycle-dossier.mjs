...
export function createLifecycleDossierAuditTrail() {
...
export function createLifecycleDossierEvidenceManifest() {
...
export function createLifecycleDossierReadinessAttestation() {
  const auditTrail = createLifecycleDossierAuditTrail();
  return {
