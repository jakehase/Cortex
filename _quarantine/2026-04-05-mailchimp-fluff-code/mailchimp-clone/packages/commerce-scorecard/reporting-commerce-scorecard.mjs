...
export function createCommerceScorecardReportCards() {
...
export function createCommerceScorecardReviewPackets() {
...
export function summarizeCommerceScorecardReporting() {
  const cards = createCommerceScorecardReportCards();
  const packets = createCommerceScorecardReviewPackets();
  return {
