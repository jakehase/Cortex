...
export function createLoyaltyAdvisorAnalyticsTimeline() {
...
export function createLoyaltyAdvisorForecastEnvelope() {
...
export function createLoyaltyAdvisorExceptionLedger() {
...
export function summarizeLoyaltyAdvisorAnalytics() {
  const timeline = createLoyaltyAdvisorAnalyticsTimeline();
  const forecast = createLoyaltyAdvisorForecastEnvelope();
  return {
