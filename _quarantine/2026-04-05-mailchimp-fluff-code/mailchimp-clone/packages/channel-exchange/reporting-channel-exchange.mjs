...
export function createChannelExchangeReportCards() {
...
export function createChannelExchangeReviewPackets() {
...
export function summarizeChannelExchangeReporting() {
  const cards = createChannelExchangeReportCards();
  const packets = createChannelExchangeReviewPackets();
  return {
