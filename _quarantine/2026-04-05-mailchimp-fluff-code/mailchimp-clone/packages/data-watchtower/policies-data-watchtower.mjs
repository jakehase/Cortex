...
export function createDataWatchtowerPolicies(overrides = {}) {
...
export function validateDataWatchtowerPolicies(policies = createDataWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeDataWatchtowerPolicies(policies = createDataWatchtowerPolicies()) {
  return {
...
export function createDataWatchtowerEscalationDeck(policies = createDataWatchtowerPolicies()) {
