...
export function createDataWatchtowerAuditTrail() {
...
export function createDataWatchtowerEvidenceManifest() {
...
export function createDataWatchtowerReadinessAttestation() {
  const auditTrail = createDataWatchtowerAuditTrail();
  return {
