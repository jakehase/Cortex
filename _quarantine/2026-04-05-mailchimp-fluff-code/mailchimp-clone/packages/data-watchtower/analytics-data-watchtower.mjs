...
export function createDataWatchtowerAnalyticsTimeline() {
...
export function createDataWatchtowerForecastEnvelope() {
...
export function createDataWatchtowerExceptionLedger() {
...
export function summarizeDataWatchtowerAnalytics() {
  const timeline = createDataWatchtowerAnalyticsTimeline();
  const forecast = createDataWatchtowerForecastEnvelope();
  return {
