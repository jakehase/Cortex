...
export function createDataWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataWatchtowerWorkspace(workspace = createDataWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataWatchtowerNarratives(workspace = createDataWatchtowerWorkspace()) {
...
export function createDataWatchtowerCoverageGrid(workspace = createDataWatchtowerWorkspace()) {
