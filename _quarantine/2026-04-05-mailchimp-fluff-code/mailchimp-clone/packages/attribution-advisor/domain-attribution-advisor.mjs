...
export function createAttributionAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAttributionAdvisorWorkspace(workspace = createAttributionAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAttributionAdvisorNarratives(workspace = createAttributionAdvisorWorkspace()) {
...
export function createAttributionAdvisorCoverageGrid(workspace = createAttributionAdvisorWorkspace()) {
