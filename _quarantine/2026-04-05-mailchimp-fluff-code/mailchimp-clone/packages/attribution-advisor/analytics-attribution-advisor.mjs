...
export function createAttributionAdvisorAnalyticsTimeline() {
...
export function createAttributionAdvisorForecastEnvelope() {
...
export function createAttributionAdvisorExceptionLedger() {
...
export function summarizeAttributionAdvisorAnalytics() {
  const timeline = createAttributionAdvisorAnalyticsTimeline();
  const forecast = createAttributionAdvisorForecastEnvelope();
  return {
