...
export function createAttributionAdvisorReportCards() {
...
export function createAttributionAdvisorReviewPackets() {
...
export function summarizeAttributionAdvisorReporting() {
  const cards = createAttributionAdvisorReportCards();
  const packets = createAttributionAdvisorReviewPackets();
  return {
