...
export function createAutomationWatchtowerOperationsBoard() {
...
export function createAutomationWatchtowerShiftChecklist() {
...
export function createAutomationWatchtowerIncidentDeck() {
