...
export function createAutomationWatchtowerReportCards() {
...
export function createAutomationWatchtowerReviewPackets() {
...
export function summarizeAutomationWatchtowerReporting() {
  const cards = createAutomationWatchtowerReportCards();
  const packets = createAutomationWatchtowerReviewPackets();
  return {
