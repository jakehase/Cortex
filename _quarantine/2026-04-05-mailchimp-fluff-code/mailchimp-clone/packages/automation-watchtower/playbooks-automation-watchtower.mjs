...
export function createAutomationWatchtowerPlaybooks() {
...
export function createAutomationWatchtowerDecisionDeck() {
...
export function createAutomationWatchtowerEscalationMoments() {
