...
export function createLocalizationFoundryPolicies(overrides = {}) {
...
export function validateLocalizationFoundryPolicies(policies = createLocalizationFoundryPolicies()) {
  const issues = [];
...
export function summarizeLocalizationFoundryPolicies(policies = createLocalizationFoundryPolicies()) {
  return {
...
export function createLocalizationFoundryEscalationDeck(policies = createLocalizationFoundryPolicies()) {
