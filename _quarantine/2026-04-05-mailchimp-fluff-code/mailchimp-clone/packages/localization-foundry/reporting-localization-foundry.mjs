...
export function createLocalizationFoundryReportCards() {
...
export function createLocalizationFoundryReviewPackets() {
...
export function summarizeLocalizationFoundryReporting() {
  const cards = createLocalizationFoundryReportCards();
  const packets = createLocalizationFoundryReviewPackets();
  return {
