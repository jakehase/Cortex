...
export function createLocalizationFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationFoundryWorkspace(workspace = createLocalizationFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationFoundryNarratives(workspace = createLocalizationFoundryWorkspace()) {
...
export function createLocalizationFoundryCoverageGrid(workspace = createLocalizationFoundryWorkspace()) {
