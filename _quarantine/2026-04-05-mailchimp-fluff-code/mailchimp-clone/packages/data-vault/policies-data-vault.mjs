...
export function createDataVaultPolicies(overrides = {}) {
...
export function validateDataVaultPolicies(policies = createDataVaultPolicies()) {
  const issues = [];
...
export function summarizeDataVaultPolicies(policies = createDataVaultPolicies()) {
  return {
...
export function createDataVaultEscalationDeck(policies = createDataVaultPolicies()) {
