...
export function createDataVaultReportCards() {
...
export function createDataVaultReviewPackets() {
...
export function summarizeDataVaultReporting() {
  const cards = createDataVaultReportCards();
  const packets = createDataVaultReviewPackets();
  return {
