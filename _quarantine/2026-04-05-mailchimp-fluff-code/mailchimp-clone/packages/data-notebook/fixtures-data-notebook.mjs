...
export function createDataNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeDataNotebookFixtures(fixtures = createDataNotebookFixtures()) {
  return {
...
export function createDataNotebookDemoInputs() {
  return {
