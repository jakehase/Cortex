...
export function createConsentScorecardReportCards() {
...
export function createConsentScorecardReviewPackets() {
...
export function summarizeConsentScorecardReporting() {
  const cards = createConsentScorecardReportCards();
  const packets = createConsentScorecardReviewPackets();
  return {
