...
export function createConsentScorecardOperationsBoard() {
...
export function createConsentScorecardShiftChecklist() {
...
export function createConsentScorecardIncidentDeck() {
