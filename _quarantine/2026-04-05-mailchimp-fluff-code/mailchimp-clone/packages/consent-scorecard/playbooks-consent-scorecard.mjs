...
export function createConsentScorecardPlaybooks() {
...
export function createConsentScorecardDecisionDeck() {
...
export function createConsentScorecardEscalationMoments() {
