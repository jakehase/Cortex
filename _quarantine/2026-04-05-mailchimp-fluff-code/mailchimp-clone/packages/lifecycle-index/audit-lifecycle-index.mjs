...
export function createLifecycleIndexAuditTrail() {
...
export function createLifecycleIndexEvidenceManifest() {
...
export function createLifecycleIndexReadinessAttestation() {
  const auditTrail = createLifecycleIndexAuditTrail();
  return {
