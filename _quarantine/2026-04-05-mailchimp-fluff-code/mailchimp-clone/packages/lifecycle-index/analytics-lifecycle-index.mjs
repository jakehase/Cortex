...
export function createLifecycleIndexAnalyticsTimeline() {
...
export function createLifecycleIndexForecastEnvelope() {
...
export function createLifecycleIndexExceptionLedger() {
...
export function summarizeLifecycleIndexAnalytics() {
  const timeline = createLifecycleIndexAnalyticsTimeline();
  const forecast = createLifecycleIndexForecastEnvelope();
  return {
