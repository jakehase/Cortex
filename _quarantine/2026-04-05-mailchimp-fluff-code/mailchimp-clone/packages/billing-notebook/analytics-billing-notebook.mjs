...
export function createBillingNotebookAnalyticsTimeline() {
...
export function createBillingNotebookForecastEnvelope() {
...
export function createBillingNotebookExceptionLedger() {
...
export function summarizeBillingNotebookAnalytics() {
  const timeline = createBillingNotebookAnalyticsTimeline();
  const forecast = createBillingNotebookForecastEnvelope();
  return {
