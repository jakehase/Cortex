...
export function createBillingNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeBillingNotebookFixtures(fixtures = createBillingNotebookFixtures()) {
  return {
...
export function createBillingNotebookDemoInputs() {
  return {
