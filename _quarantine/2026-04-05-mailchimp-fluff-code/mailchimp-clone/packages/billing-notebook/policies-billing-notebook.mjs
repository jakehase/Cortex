...
export function createBillingNotebookPolicies(overrides = {}) {
...
export function validateBillingNotebookPolicies(policies = createBillingNotebookPolicies()) {
  const issues = [];
...
export function summarizeBillingNotebookPolicies(policies = createBillingNotebookPolicies()) {
  return {
...
export function createBillingNotebookEscalationDeck(policies = createBillingNotebookPolicies()) {
