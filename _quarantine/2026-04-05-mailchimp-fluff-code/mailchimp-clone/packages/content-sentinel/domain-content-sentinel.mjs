const MODULE = {
  ...
  "title": "Content Sentinel",
  "focus": "Content Sentinel covers content operations, packaging, and channel-specific delivery shape through alerts, anomaly watch, and guardrails.",
...
export function createContentSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentSentinelWorkspace(workspace = createContentSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentSentinelNarratives(workspace = createContentSentinelWorkspace()) {
...
export function createContentSentinelCoverageGrid(workspace = createContentSentinelWorkspace()) {
