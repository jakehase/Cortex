...
export function createContentSentinelOperationsBoard() {
...
export function createContentSentinelShiftChecklist() {
...
export function createContentSentinelIncidentDeck() {
