...
export function createContentSentinelAuditTrail() {
...
export function createContentSentinelEvidenceManifest() {
...
export function createContentSentinelReadinessAttestation() {
  const auditTrail = createContentSentinelAuditTrail();
  return {
