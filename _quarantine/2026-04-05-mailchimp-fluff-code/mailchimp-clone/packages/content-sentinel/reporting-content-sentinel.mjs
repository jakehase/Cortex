...
export function createContentSentinelReportCards() {
...
export function createContentSentinelReviewPackets() {
...
export function summarizeContentSentinelReporting() {
  const cards = createContentSentinelReportCards();
  const packets = createContentSentinelReviewPackets();
  return {
