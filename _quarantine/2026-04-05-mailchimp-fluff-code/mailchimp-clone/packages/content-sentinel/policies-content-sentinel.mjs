...
export function createContentSentinelPolicies(overrides = {}) {
...
export function validateContentSentinelPolicies(policies = createContentSentinelPolicies()) {
  const issues = [];
...
export function summarizeContentSentinelPolicies(policies = createContentSentinelPolicies()) {
  return {
...
export function createContentSentinelEscalationDeck(policies = createContentSentinelPolicies()) {
