...
export function createContentFoundryPolicies(overrides = {}) {
...
export function validateContentFoundryPolicies(policies = createContentFoundryPolicies()) {
  const issues = [];
...
export function summarizeContentFoundryPolicies(policies = createContentFoundryPolicies()) {
  return {
...
export function createContentFoundryEscalationDeck(policies = createContentFoundryPolicies()) {
