...
export function createCustomerCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCustomerCockpitWorkspace(workspace = createCustomerCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createCustomerCockpitNarratives(workspace = createCustomerCockpitWorkspace()) {
...
export function createCustomerCockpitCoverageGrid(workspace = createCustomerCockpitWorkspace()) {
