...
export function createCustomerCockpitPolicies(overrides = {}) {
...
export function validateCustomerCockpitPolicies(policies = createCustomerCockpitPolicies()) {
  const issues = [];
...
export function summarizeCustomerCockpitPolicies(policies = createCustomerCockpitPolicies()) {
  return {
...
export function createCustomerCockpitEscalationDeck(policies = createCustomerCockpitPolicies()) {
