...
export function createCustomerCockpitOperationsBoard() {
...
export function createCustomerCockpitShiftChecklist() {
...
export function createCustomerCockpitIncidentDeck() {
