...
export function createInsightsExchangeAuditTrail() {
...
export function createInsightsExchangeEvidenceManifest() {
...
export function createInsightsExchangeReadinessAttestation() {
  const auditTrail = createInsightsExchangeAuditTrail();
  return {
