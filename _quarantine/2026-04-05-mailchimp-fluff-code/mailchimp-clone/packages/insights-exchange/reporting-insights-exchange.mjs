...
export function createInsightsExchangeReportCards() {
...
export function createInsightsExchangeReviewPackets() {
...
export function summarizeInsightsExchangeReporting() {
  const cards = createInsightsExchangeReportCards();
  const packets = createInsightsExchangeReviewPackets();
  return {
