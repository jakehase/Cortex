...
export function createInsightsExchangeAnalyticsTimeline() {
...
export function createInsightsExchangeForecastEnvelope() {
...
export function createInsightsExchangeExceptionLedger() {
...
export function summarizeInsightsExchangeAnalytics() {
  const timeline = createInsightsExchangeAnalyticsTimeline();
  const forecast = createInsightsExchangeForecastEnvelope();
  return {
