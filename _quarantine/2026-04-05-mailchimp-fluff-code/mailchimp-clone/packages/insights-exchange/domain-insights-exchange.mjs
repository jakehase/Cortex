const MODULE = {
  ...
  "title": "Insights Exchange",
  "focus": "Insights Exchange covers insight synthesis, operating narratives, and executive-ready summaries through handoff workflows and partner coordination.",
...
export function createInsightsExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsExchangeWorkspace(workspace = createInsightsExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsExchangeNarratives(workspace = createInsightsExchangeWorkspace()) {
...
export function createInsightsExchangeCoverageGrid(workspace = createInsightsExchangeWorkspace()) {
