...
export function createChannelLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelLedgerWorkspace(workspace = createChannelLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelLedgerNarratives(workspace = createChannelLedgerWorkspace()) {
...
export function createChannelLedgerCoverageGrid(workspace = createChannelLedgerWorkspace()) {
