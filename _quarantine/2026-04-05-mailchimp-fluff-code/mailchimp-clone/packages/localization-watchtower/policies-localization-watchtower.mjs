...
export function createLocalizationWatchtowerPolicies(overrides = {}) {
...
export function validateLocalizationWatchtowerPolicies(policies = createLocalizationWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeLocalizationWatchtowerPolicies(policies = createLocalizationWatchtowerPolicies()) {
  return {
...
export function createLocalizationWatchtowerEscalationDeck(policies = createLocalizationWatchtowerPolicies()) {
