...
export function createLocalizationWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationWatchtowerWorkspace(workspace = createLocalizationWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationWatchtowerNarratives(workspace = createLocalizationWatchtowerWorkspace()) {
...
export function createLocalizationWatchtowerCoverageGrid(workspace = createLocalizationWatchtowerWorkspace()) {
