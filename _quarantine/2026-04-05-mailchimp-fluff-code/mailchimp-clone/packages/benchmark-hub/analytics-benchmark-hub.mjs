...
export function createBenchmarkHubAnalyticsTimeline() {
...
export function createBenchmarkHubForecastEnvelope() {
...
export function createBenchmarkHubExceptionLedger() {
...
export function summarizeBenchmarkHubAnalytics() {
  const timeline = createBenchmarkHubAnalyticsTimeline();
  const forecast = createBenchmarkHubForecastEnvelope();
  return {
