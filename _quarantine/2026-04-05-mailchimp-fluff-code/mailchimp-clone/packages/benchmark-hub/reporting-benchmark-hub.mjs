...
export function createBenchmarkHubReportCards() {
...
export function createBenchmarkHubReviewPackets() {
...
export function summarizeBenchmarkHubReporting() {
  const cards = createBenchmarkHubReportCards();
  const packets = createBenchmarkHubReviewPackets();
  return {
