...
export function createCampaignNotebookPlaybooks() {
...
export function createCampaignNotebookDecisionDeck() {
...
export function createCampaignNotebookEscalationMoments() {
