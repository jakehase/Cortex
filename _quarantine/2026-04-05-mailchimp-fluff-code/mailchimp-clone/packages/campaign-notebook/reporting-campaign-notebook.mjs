...
export function createCampaignNotebookReportCards() {
...
export function createCampaignNotebookReviewPackets() {
...
export function summarizeCampaignNotebookReporting() {
  const cards = createCampaignNotebookReportCards();
  const packets = createCampaignNotebookReviewPackets();
  return {
