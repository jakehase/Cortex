...
export function createCampaignNotebookAnalyticsTimeline() {
...
export function createCampaignNotebookForecastEnvelope() {
...
export function createCampaignNotebookExceptionLedger() {
...
export function summarizeCampaignNotebookAnalytics() {
  const timeline = createCampaignNotebookAnalyticsTimeline();
  const forecast = createCampaignNotebookForecastEnvelope();
  return {
