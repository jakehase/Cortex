...
export function createLifecycleWorkbenchAnalyticsTimeline() {
...
export function createLifecycleWorkbenchForecastEnvelope() {
...
export function createLifecycleWorkbenchExceptionLedger() {
...
export function summarizeLifecycleWorkbenchAnalytics() {
  const timeline = createLifecycleWorkbenchAnalyticsTimeline();
  const forecast = createLifecycleWorkbenchForecastEnvelope();
  return {
