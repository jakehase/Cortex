...
export function createLifecycleWorkbenchAuditTrail() {
...
export function createLifecycleWorkbenchEvidenceManifest() {
...
export function createLifecycleWorkbenchReadinessAttestation() {
  const auditTrail = createLifecycleWorkbenchAuditTrail();
  return {
