...
export function createLifecycleWorkbenchFixtures() {
  return {
    accounts: [
...
export function summarizeLifecycleWorkbenchFixtures(fixtures = createLifecycleWorkbenchFixtures()) {
  return {
...
export function createLifecycleWorkbenchDemoInputs() {
  return {
