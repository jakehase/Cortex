...
export function createComplianceNotebookPlaybooks() {
...
export function createComplianceNotebookDecisionDeck() {
...
export function createComplianceNotebookEscalationMoments() {
