...
export function createActivationNotebookAuditTrail() {
...
export function createActivationNotebookEvidenceManifest() {
...
export function createActivationNotebookReadinessAttestation() {
  const auditTrail = createActivationNotebookAuditTrail();
  return {
