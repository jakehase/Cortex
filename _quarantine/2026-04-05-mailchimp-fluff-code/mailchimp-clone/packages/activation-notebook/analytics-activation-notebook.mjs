...
export function createActivationNotebookAnalyticsTimeline() {
...
export function createActivationNotebookForecastEnvelope() {
...
export function createActivationNotebookExceptionLedger() {
...
export function summarizeActivationNotebookAnalytics() {
  const timeline = createActivationNotebookAnalyticsTimeline();
  const forecast = createActivationNotebookForecastEnvelope();
  return {
