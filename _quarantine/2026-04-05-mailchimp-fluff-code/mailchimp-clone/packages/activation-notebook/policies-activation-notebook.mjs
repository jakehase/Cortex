...
export function createActivationNotebookPolicies(overrides = {}) {
...
export function validateActivationNotebookPolicies(policies = createActivationNotebookPolicies()) {
  const issues = [];
...
export function summarizeActivationNotebookPolicies(policies = createActivationNotebookPolicies()) {
  return {
...
export function createActivationNotebookEscalationDeck(policies = createActivationNotebookPolicies()) {
