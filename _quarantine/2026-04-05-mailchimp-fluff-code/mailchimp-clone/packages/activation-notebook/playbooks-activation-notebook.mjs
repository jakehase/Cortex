...
export function createActivationNotebookPlaybooks() {
...
export function createActivationNotebookDecisionDeck() {
...
export function createActivationNotebookEscalationMoments() {
