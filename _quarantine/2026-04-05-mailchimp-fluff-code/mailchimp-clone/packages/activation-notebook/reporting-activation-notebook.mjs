...
export function createActivationNotebookReportCards() {
...
export function createActivationNotebookReviewPackets() {
...
export function summarizeActivationNotebookReporting() {
  const cards = createActivationNotebookReportCards();
  const packets = createActivationNotebookReviewPackets();
  return {
