const MODULE = {
  "id": "activation-notebook",
  "ordinal": 33,
  "domain": "activation",
  "surfaceId": "notebook",
  "surfaceTitle": "Notebook",
  "routeSegment": "notebook",
  "title": "Activation Notebook",
  "focus": "Activation Notebook covers onboarding readiness, first-value motion, and kickoff momentum through working notes and experiment memory.",
  ...
  "tags": [
    ...
    "notebook",
    "growth",
    "activation-notebook-wave-seven"
  ]
};
...
export function createActivationNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationNotebookWorkspace(workspace = createActivationNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationNotebookNarratives(workspace = createActivationNotebookWorkspace()) {
...
export function createActivationNotebookCoverageGrid(workspace = createActivationNotebookWorkspace()) {
