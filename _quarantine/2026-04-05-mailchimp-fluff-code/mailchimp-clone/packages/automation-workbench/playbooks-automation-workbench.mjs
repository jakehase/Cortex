...
export function createAutomationWorkbenchPlaybooks() {
...
export function createAutomationWorkbenchDecisionDeck() {
...
export function createAutomationWorkbenchEscalationMoments() {
