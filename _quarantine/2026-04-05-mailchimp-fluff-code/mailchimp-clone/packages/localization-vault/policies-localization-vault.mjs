...
export function createLocalizationVaultPolicies(overrides = {}) {
...
export function validateLocalizationVaultPolicies(policies = createLocalizationVaultPolicies()) {
  const issues = [];
...
export function summarizeLocalizationVaultPolicies(policies = createLocalizationVaultPolicies()) {
  return {
...
export function createLocalizationVaultEscalationDeck(policies = createLocalizationVaultPolicies()) {
