...
export function createInsightsWorkbenchOperationsBoard() {
...
export function createInsightsWorkbenchShiftChecklist() {
...
export function createInsightsWorkbenchIncidentDeck() {
