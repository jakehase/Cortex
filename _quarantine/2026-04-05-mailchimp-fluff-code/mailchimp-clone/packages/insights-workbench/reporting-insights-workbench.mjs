...
export function createInsightsWorkbenchReportCards() {
...
export function createInsightsWorkbenchReviewPackets() {
...
export function summarizeInsightsWorkbenchReporting() {
  const cards = createInsightsWorkbenchReportCards();
  const packets = createInsightsWorkbenchReviewPackets();
  return {
