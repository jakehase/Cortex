...
export function createInsightsWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsWorkbenchWorkspace(workspace = createInsightsWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsWorkbenchNarratives(workspace = createInsightsWorkbenchWorkspace()) {
...
export function createInsightsWorkbenchCoverageGrid(workspace = createInsightsWorkbenchWorkspace()) {
