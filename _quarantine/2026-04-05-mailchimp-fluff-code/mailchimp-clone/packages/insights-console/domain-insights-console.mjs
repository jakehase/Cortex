const MODULE = {
  ...
  "focus": "Insights Console covers insight synthesis, operating narratives, and executive-ready summaries through execution controls and workspace steering.",
...
export function createInsightsConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsConsoleWorkspace(workspace = createInsightsConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsConsoleNarratives(workspace = createInsightsConsoleWorkspace()) {
...
export function createInsightsConsoleCoverageGrid(workspace = createInsightsConsoleWorkspace()) {
