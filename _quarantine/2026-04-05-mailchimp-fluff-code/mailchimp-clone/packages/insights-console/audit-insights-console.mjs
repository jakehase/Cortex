...
export function createInsightsConsoleAuditTrail() {
...
export function createInsightsConsoleEvidenceManifest() {
...
export function createInsightsConsoleReadinessAttestation() {
  const auditTrail = createInsightsConsoleAuditTrail();
  return {
