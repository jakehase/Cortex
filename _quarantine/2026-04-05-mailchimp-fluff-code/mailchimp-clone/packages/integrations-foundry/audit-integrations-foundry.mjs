...
export function createIntegrationsFoundryAuditTrail() {
...
export function createIntegrationsFoundryEvidenceManifest() {
...
export function createIntegrationsFoundryReadinessAttestation() {
  const auditTrail = createIntegrationsFoundryAuditTrail();
  return {
