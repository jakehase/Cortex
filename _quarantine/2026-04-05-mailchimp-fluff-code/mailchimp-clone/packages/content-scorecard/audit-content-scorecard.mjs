...
export function createContentScorecardAuditTrail() {
...
export function createContentScorecardEvidenceManifest() {
...
export function createContentScorecardReadinessAttestation() {
  const auditTrail = createContentScorecardAuditTrail();
  return {
