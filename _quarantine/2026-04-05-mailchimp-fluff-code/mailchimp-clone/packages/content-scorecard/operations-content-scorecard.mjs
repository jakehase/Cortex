...
export function createContentScorecardOperationsBoard() {
...
export function createContentScorecardShiftChecklist() {
...
export function createContentScorecardIncidentDeck() {
