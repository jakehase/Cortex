...
export function createContentScorecardPolicies(overrides = {}) {
...
export function validateContentScorecardPolicies(policies = createContentScorecardPolicies()) {
  const issues = [];
...
export function summarizeContentScorecardPolicies(policies = createContentScorecardPolicies()) {
  return {
...
export function createContentScorecardEscalationDeck(policies = createContentScorecardPolicies()) {
