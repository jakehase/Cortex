...
export function createAutomationStudioAuditTrail() {
...
export function createAutomationStudioEvidenceManifest() {
...
export function createAutomationStudioReadinessAttestation() {
  const auditTrail = createAutomationStudioAuditTrail();
  return {
