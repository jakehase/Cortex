...
export function createBenchmarkWorkbenchAuditTrail() {
...
export function createBenchmarkWorkbenchEvidenceManifest() {
...
export function createBenchmarkWorkbenchReadinessAttestation() {
  const auditTrail = createBenchmarkWorkbenchAuditTrail();
  return {
