...
export function createEcommerceDossierPlaybooks() {
...
export function createEcommerceDossierDecisionDeck() {
...
export function createEcommerceDossierEscalationMoments() {
