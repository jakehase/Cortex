...
export function createEcommerceDossierPolicies(overrides = {}) {
...
export function validateEcommerceDossierPolicies(policies = createEcommerceDossierPolicies()) {
  const issues = [];
...
export function summarizeEcommerceDossierPolicies(policies = createEcommerceDossierPolicies()) {
  return {
...
export function createEcommerceDossierEscalationDeck(policies = createEcommerceDossierPolicies()) {
