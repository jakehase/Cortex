...
export function createCreativeIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCreativeIndexWorkspace(workspace = createCreativeIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createCreativeIndexNarratives(workspace = createCreativeIndexWorkspace()) {
...
export function createCreativeIndexCoverageGrid(workspace = createCreativeIndexWorkspace()) {
