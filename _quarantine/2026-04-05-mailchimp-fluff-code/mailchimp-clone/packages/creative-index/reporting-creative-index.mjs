...
export function createCreativeIndexReportCards() {
...
export function createCreativeIndexReviewPackets() {
...
export function summarizeCreativeIndexReporting() {
  const cards = createCreativeIndexReportCards();
  const packets = createCreativeIndexReviewPackets();
  return {
