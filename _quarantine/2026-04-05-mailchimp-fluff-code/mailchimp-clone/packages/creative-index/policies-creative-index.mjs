...
export function createCreativeIndexPolicies(overrides = {}) {
...
export function validateCreativeIndexPolicies(policies = createCreativeIndexPolicies()) {
  const issues = [];
...
export function summarizeCreativeIndexPolicies(policies = createCreativeIndexPolicies()) {
  return {
...
export function createCreativeIndexEscalationDeck(policies = createCreativeIndexPolicies()) {
