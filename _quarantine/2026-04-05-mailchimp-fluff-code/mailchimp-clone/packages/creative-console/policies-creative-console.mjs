...
export function createCreativeConsolePolicies(overrides = {}) {
...
export function validateCreativeConsolePolicies(policies = createCreativeConsolePolicies()) {
  const issues = [];
...
export function summarizeCreativeConsolePolicies(policies = createCreativeConsolePolicies()) {
  return {
...
export function createCreativeConsoleEscalationDeck(policies = createCreativeConsolePolicies()) {
