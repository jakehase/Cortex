...
export function createCreativeConsoleReportCards() {
...
export function createCreativeConsoleReviewPackets() {
...
export function summarizeCreativeConsoleReporting() {
  const cards = createCreativeConsoleReportCards();
  const packets = createCreativeConsoleReviewPackets();
  return {
