...
export function createCreativeConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeCreativeConsoleFixtures(fixtures = createCreativeConsoleFixtures()) {
  return {
...
export function createCreativeConsoleDemoInputs() {
  return {
