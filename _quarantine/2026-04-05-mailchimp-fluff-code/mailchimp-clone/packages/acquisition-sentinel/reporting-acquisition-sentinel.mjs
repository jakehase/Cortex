...
export function createAcquisitionSentinelReportCards() {
...
export function createAcquisitionSentinelReviewPackets() {
...
export function summarizeAcquisitionSentinelReporting() {
  const cards = createAcquisitionSentinelReportCards();
  const packets = createAcquisitionSentinelReviewPackets();
  return {
