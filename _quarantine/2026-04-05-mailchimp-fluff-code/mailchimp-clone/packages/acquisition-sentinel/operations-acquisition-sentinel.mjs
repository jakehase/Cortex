...
export function createAcquisitionSentinelOperationsBoard() {
...
export function createAcquisitionSentinelShiftChecklist() {
...
export function createAcquisitionSentinelIncidentDeck() {
