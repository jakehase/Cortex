...
export function createBenchmarkAdvisorReportCards() {
...
export function createBenchmarkAdvisorReviewPackets() {
...
export function summarizeBenchmarkAdvisorReporting() {
  const cards = createBenchmarkAdvisorReportCards();
  const packets = createBenchmarkAdvisorReviewPackets();
  return {
