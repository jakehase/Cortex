...
export function createBenchmarkAdvisorAnalyticsTimeline() {
...
export function createBenchmarkAdvisorForecastEnvelope() {
...
export function createBenchmarkAdvisorExceptionLedger() {
...
export function summarizeBenchmarkAdvisorAnalytics() {
  const timeline = createBenchmarkAdvisorAnalyticsTimeline();
  const forecast = createBenchmarkAdvisorForecastEnvelope();
  return {
