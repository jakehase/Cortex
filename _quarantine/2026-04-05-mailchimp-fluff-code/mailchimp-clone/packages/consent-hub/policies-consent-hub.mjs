...
export function createConsentHubPolicies(overrides = {}) {
...
export function validateConsentHubPolicies(policies = createConsentHubPolicies()) {
  const issues = [];
...
export function summarizeConsentHubPolicies(policies = createConsentHubPolicies()) {
  return {
...
export function createConsentHubEscalationDeck(policies = createConsentHubPolicies()) {
