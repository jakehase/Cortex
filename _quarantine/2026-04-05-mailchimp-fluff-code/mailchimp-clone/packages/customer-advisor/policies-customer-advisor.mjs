...
export function createCustomerAdvisorPolicies(overrides = {}) {
...
export function validateCustomerAdvisorPolicies(policies = createCustomerAdvisorPolicies()) {
  const issues = [];
...
export function summarizeCustomerAdvisorPolicies(policies = createCustomerAdvisorPolicies()) {
  return {
...
export function createCustomerAdvisorEscalationDeck(policies = createCustomerAdvisorPolicies()) {
