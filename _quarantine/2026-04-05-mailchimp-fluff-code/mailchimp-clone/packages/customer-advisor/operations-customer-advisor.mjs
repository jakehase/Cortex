...
export function createCustomerAdvisorOperationsBoard() {
...
export function createCustomerAdvisorShiftChecklist() {
...
export function createCustomerAdvisorIncidentDeck() {
