...
export function createCustomerAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerAdvisorFixtures(fixtures = createCustomerAdvisorFixtures()) {
  return {
...
export function createCustomerAdvisorDemoInputs() {
  return {
