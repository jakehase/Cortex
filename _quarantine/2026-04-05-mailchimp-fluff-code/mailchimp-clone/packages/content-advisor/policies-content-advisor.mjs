...
export function createContentAdvisorPolicies(overrides = {}) {
...
export function validateContentAdvisorPolicies(policies = createContentAdvisorPolicies()) {
  const issues = [];
...
export function summarizeContentAdvisorPolicies(policies = createContentAdvisorPolicies()) {
  return {
...
export function createContentAdvisorEscalationDeck(policies = createContentAdvisorPolicies()) {
