const MODULE = {
  ...
  "focus": "Content Advisor covers content operations, packaging, and channel-specific delivery shape through recommendations and next-step framing.",
...
export function createContentAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentAdvisorWorkspace(workspace = createContentAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentAdvisorNarratives(workspace = createContentAdvisorWorkspace()) {
...
export function createContentAdvisorCoverageGrid(workspace = createContentAdvisorWorkspace()) {
