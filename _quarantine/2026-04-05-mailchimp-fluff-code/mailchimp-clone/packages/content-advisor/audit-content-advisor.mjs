...
export function createContentAdvisorAuditTrail() {
...
export function createContentAdvisorEvidenceManifest() {
...
export function createContentAdvisorReadinessAttestation() {
  const auditTrail = createContentAdvisorAuditTrail();
  return {
