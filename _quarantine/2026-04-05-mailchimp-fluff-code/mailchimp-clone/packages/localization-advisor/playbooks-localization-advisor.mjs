...
export function createLocalizationAdvisorPlaybooks() {
...
export function createLocalizationAdvisorDecisionDeck() {
...
export function createLocalizationAdvisorEscalationMoments() {
