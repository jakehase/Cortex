...
export function createLocalizationAdvisorOperationsBoard() {
...
export function createLocalizationAdvisorShiftChecklist() {
...
export function createLocalizationAdvisorIncidentDeck() {
