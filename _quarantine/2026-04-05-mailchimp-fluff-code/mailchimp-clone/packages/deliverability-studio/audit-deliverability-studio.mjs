...
export function createDeliverabilityStudioAuditTrail() {
...
export function createDeliverabilityStudioEvidenceManifest() {
...
export function createDeliverabilityStudioReadinessAttestation() {
  const auditTrail = createDeliverabilityStudioAuditTrail();
  return {
