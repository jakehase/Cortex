...
export function createDeliverabilityStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityStudioWorkspace(workspace = createDeliverabilityStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityStudioNarratives(workspace = createDeliverabilityStudioWorkspace()) {
...
export function createDeliverabilityStudioCoverageGrid(workspace = createDeliverabilityStudioWorkspace()) {
