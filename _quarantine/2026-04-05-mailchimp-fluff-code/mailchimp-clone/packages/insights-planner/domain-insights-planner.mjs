const MODULE = {
  ...
  "title": "Insights Planner",
  "focus": "Insights Planner covers insight synthesis, operating narratives, and executive-ready summaries through calendar planning and execution choreography.",
...
export function createInsightsPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsPlannerWorkspace(workspace = createInsightsPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsPlannerNarratives(workspace = createInsightsPlannerWorkspace()) {
...
export function createInsightsPlannerCoverageGrid(workspace = createInsightsPlannerWorkspace()) {
