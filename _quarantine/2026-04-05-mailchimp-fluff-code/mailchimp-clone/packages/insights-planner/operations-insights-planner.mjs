...
export function createInsightsPlannerOperationsBoard() {
...
export function createInsightsPlannerShiftChecklist() {
...
export function createInsightsPlannerIncidentDeck() {
