...
export function createChannelAdvisorReportCards() {
...
export function createChannelAdvisorReviewPackets() {
...
export function summarizeChannelAdvisorReporting() {
  const cards = createChannelAdvisorReportCards();
  const packets = createChannelAdvisorReviewPackets();
  return {
