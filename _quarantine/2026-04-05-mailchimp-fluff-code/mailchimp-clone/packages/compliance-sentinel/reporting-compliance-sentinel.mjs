...
export function createComplianceSentinelReportCards() {
...
export function createComplianceSentinelReviewPackets() {
...
export function summarizeComplianceSentinelReporting() {
  const cards = createComplianceSentinelReportCards();
  const packets = createComplianceSentinelReviewPackets();
  return {
