...
export function createComplianceSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeComplianceSentinelWorkspace(workspace = createComplianceSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createComplianceSentinelNarratives(workspace = createComplianceSentinelWorkspace()) {
...
export function createComplianceSentinelCoverageGrid(workspace = createComplianceSentinelWorkspace()) {
