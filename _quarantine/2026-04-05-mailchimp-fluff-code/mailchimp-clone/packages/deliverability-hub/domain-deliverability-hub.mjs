...
export function createDeliverabilityHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityHubWorkspace(workspace = createDeliverabilityHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityHubNarratives(workspace = createDeliverabilityHubWorkspace()) {
...
export function createDeliverabilityHubCoverageGrid(workspace = createDeliverabilityHubWorkspace()) {
