...
export function createDeliverabilityHubReportCards() {
...
export function createDeliverabilityHubReviewPackets() {
...
export function summarizeDeliverabilityHubReporting() {
  const cards = createDeliverabilityHubReportCards();
  const packets = createDeliverabilityHubReviewPackets();
  return {
