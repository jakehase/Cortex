...
export function createAdvocacyScorecardPlaybooks() {
...
export function createAdvocacyScorecardDecisionDeck() {
...
export function createAdvocacyScorecardEscalationMoments() {
