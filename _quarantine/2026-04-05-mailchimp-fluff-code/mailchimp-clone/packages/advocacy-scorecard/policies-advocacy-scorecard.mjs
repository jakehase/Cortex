...
export function createAdvocacyScorecardPolicies(overrides = {}) {
...
export function validateAdvocacyScorecardPolicies(policies = createAdvocacyScorecardPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyScorecardPolicies(policies = createAdvocacyScorecardPolicies()) {
  return {
...
export function createAdvocacyScorecardEscalationDeck(policies = createAdvocacyScorecardPolicies()) {
