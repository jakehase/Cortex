...
export function createAdvocacyScorecardReportCards() {
...
export function createAdvocacyScorecardReviewPackets() {
...
export function summarizeAdvocacyScorecardReporting() {
  const cards = createAdvocacyScorecardReportCards();
  const packets = createAdvocacyScorecardReviewPackets();
  return {
