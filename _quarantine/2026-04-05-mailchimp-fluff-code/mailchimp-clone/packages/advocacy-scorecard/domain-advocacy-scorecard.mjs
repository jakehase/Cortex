const MODULE = {
  "id": "advocacy-scorecard",
  "ordinal": 55,
  "domain": "advocacy",
  "surfaceId": "scorecard",
  "surfaceTitle": "Scorecard",
  "routeSegment": "scorecard",
  "title": "Advocacy Scorecard",
  "focus": "Advocacy Scorecard covers customer champions, referral readiness, and proof-sharing loops through metric tracking and readiness scoring.",
...
export function createAdvocacyScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyScorecardWorkspace(workspace = createAdvocacyScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyScorecardNarratives(workspace = createAdvocacyScorecardWorkspace()) {
...
export function createAdvocacyScorecardCoverageGrid(workspace = createAdvocacyScorecardWorkspace()) {
