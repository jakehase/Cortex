...
export function createAdvocacyScorecardAuditTrail() {
...
export function createAdvocacyScorecardEvidenceManifest() {
...
export function createAdvocacyScorecardReadinessAttestation() {
  const auditTrail = createAdvocacyScorecardAuditTrail();
  return {
