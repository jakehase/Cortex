...
export function createCollaborationExchangeAuditTrail() {
...
export function createCollaborationExchangeEvidenceManifest() {
...
export function createCollaborationExchangeReadinessAttestation() {
  const auditTrail = createCollaborationExchangeAuditTrail();
  return {
