...
export function createCollaborationExchangeReportCards() {
...
export function createCollaborationExchangeReviewPackets() {
...
export function summarizeCollaborationExchangeReporting() {
  const cards = createCollaborationExchangeReportCards();
  const packets = createCollaborationExchangeReviewPackets();
  return {
