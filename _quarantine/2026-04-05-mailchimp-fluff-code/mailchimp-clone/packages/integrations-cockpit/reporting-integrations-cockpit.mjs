...
export function createIntegrationsCockpitReportCards() {
...
export function createIntegrationsCockpitReviewPackets() {
...
export function summarizeIntegrationsCockpitReporting() {
  const cards = createIntegrationsCockpitReportCards();
  const packets = createIntegrationsCockpitReviewPackets();
  return {
