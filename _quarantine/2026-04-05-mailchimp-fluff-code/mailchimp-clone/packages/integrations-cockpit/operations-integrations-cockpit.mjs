...
export function createIntegrationsCockpitOperationsBoard() {
...
export function createIntegrationsCockpitShiftChecklist() {
...
export function createIntegrationsCockpitIncidentDeck() {
