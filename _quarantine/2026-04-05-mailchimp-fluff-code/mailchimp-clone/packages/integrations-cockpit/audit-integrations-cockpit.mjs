...
export function createIntegrationsCockpitAuditTrail() {
...
export function createIntegrationsCockpitEvidenceManifest() {
...
export function createIntegrationsCockpitReadinessAttestation() {
  const auditTrail = createIntegrationsCockpitAuditTrail();
  return {
