...
export function createBenchmarkWatchtowerPlaybooks() {
...
export function createBenchmarkWatchtowerDecisionDeck() {
...
export function createBenchmarkWatchtowerEscalationMoments() {
