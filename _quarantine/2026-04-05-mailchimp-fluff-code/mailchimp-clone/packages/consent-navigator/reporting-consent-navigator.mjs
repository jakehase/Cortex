...
export function createConsentNavigatorReportCards() {
...
export function createConsentNavigatorReviewPackets() {
...
export function summarizeConsentNavigatorReporting() {
  const cards = createConsentNavigatorReportCards();
  const packets = createConsentNavigatorReviewPackets();
  return {
