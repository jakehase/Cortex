...
export function createConsentNavigatorPolicies(overrides = {}) {
...
export function validateConsentNavigatorPolicies(policies = createConsentNavigatorPolicies()) {
  const issues = [];
...
export function summarizeConsentNavigatorPolicies(policies = createConsentNavigatorPolicies()) {
  return {
...
export function createConsentNavigatorEscalationDeck(policies = createConsentNavigatorPolicies()) {
