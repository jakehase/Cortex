...
export function createConsentNavigatorAnalyticsTimeline() {
...
export function createConsentNavigatorForecastEnvelope() {
...
export function createConsentNavigatorExceptionLedger() {
...
export function summarizeConsentNavigatorAnalytics() {
  const timeline = createConsentNavigatorAnalyticsTimeline();
  const forecast = createConsentNavigatorForecastEnvelope();
  return {
