...
export function createAttributionCockpitAnalyticsTimeline() {
...
export function createAttributionCockpitForecastEnvelope() {
...
export function createAttributionCockpitExceptionLedger() {
...
export function summarizeAttributionCockpitAnalytics() {
  const timeline = createAttributionCockpitAnalyticsTimeline();
  const forecast = createAttributionCockpitForecastEnvelope();
  return {
