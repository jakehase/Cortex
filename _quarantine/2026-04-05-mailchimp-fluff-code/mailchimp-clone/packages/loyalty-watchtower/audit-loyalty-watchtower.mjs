...
export function createLoyaltyWatchtowerAuditTrail() {
...
export function createLoyaltyWatchtowerEvidenceManifest() {
...
export function createLoyaltyWatchtowerReadinessAttestation() {
  const auditTrail = createLoyaltyWatchtowerAuditTrail();
  return {
