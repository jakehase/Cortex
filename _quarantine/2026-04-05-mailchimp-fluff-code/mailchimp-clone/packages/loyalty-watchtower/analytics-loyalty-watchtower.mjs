...
export function createLoyaltyWatchtowerAnalyticsTimeline() {
...
export function createLoyaltyWatchtowerForecastEnvelope() {
...
export function createLoyaltyWatchtowerExceptionLedger() {
...
export function summarizeLoyaltyWatchtowerAnalytics() {
  const timeline = createLoyaltyWatchtowerAnalyticsTimeline();
  const forecast = createLoyaltyWatchtowerForecastEnvelope();
  return {
