...
export function createLoyaltyWatchtowerReportCards() {
...
export function createLoyaltyWatchtowerReviewPackets() {
...
export function summarizeLoyaltyWatchtowerReporting() {
  const cards = createLoyaltyWatchtowerReportCards();
  const packets = createLoyaltyWatchtowerReviewPackets();
  return {
