...
export function createCollaborationAtlasAuditTrail() {
...
export function createCollaborationAtlasEvidenceManifest() {
...
export function createCollaborationAtlasReadinessAttestation() {
  const auditTrail = createCollaborationAtlasAuditTrail();
  return {
