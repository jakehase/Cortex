...
export function createCollaborationAtlasReportCards() {
...
export function createCollaborationAtlasReviewPackets() {
...
export function summarizeCollaborationAtlasReporting() {
  const cards = createCollaborationAtlasReportCards();
  const packets = createCollaborationAtlasReviewPackets();
  return {
