...
export function createCollaborationScorecardPlaybooks() {
...
export function createCollaborationScorecardDecisionDeck() {
...
export function createCollaborationScorecardEscalationMoments() {
