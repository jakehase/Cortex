const MODULE = {
  "id": "collaboration-scorecard",
  "ordinal": 234,
  "domain": "collaboration",
  "surfaceId": "scorecard",
  "surfaceTitle": "Scorecard",
  "routeSegment": "scorecard",
  "title": "Collaboration Scorecard",
  "focus": "Collaboration Scorecard covers shared ownership, approvals, and cross-functional motion through metric tracking and readiness scoring.",
  ...
  "tags": [
    ...
    "scorecard",
    "lifecycle",
    "collaboration-scorecard-wave-seven"
  ]
};
...
export function createCollaborationScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationScorecardWorkspace(workspace = createCollaborationScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationScorecardNarratives(workspace = createCollaborationScorecardWorkspace()) {
...
export function createCollaborationScorecardCoverageGrid(workspace = createCollaborationScorecardWorkspace()) {
