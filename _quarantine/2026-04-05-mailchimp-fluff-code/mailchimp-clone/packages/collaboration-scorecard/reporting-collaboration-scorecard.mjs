...
export function createCollaborationScorecardReportCards() {
...
export function createCollaborationScorecardReviewPackets() {
...
export function summarizeCollaborationScorecardReporting() {
  const cards = createCollaborationScorecardReportCards();
  const packets = createCollaborationScorecardReviewPackets();
  return {
