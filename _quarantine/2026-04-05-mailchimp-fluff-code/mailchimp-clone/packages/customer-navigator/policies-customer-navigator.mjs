...
export function createCustomerNavigatorPolicies(overrides = {}) {
...
export function validateCustomerNavigatorPolicies(policies = createCustomerNavigatorPolicies()) {
  const issues = [];
...
export function summarizeCustomerNavigatorPolicies(policies = createCustomerNavigatorPolicies()) {
  return {
...
export function createCustomerNavigatorEscalationDeck(policies = createCustomerNavigatorPolicies()) {
