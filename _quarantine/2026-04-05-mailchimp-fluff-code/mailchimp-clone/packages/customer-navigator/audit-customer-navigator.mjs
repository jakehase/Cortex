...
export function createCustomerNavigatorAuditTrail() {
...
export function createCustomerNavigatorEvidenceManifest() {
...
export function createCustomerNavigatorReadinessAttestation() {
  const auditTrail = createCustomerNavigatorAuditTrail();
  return {
