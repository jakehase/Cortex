...
export function createCustomerNavigatorFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerNavigatorFixtures(fixtures = createCustomerNavigatorFixtures()) {
  return {
...
export function createCustomerNavigatorDemoInputs() {
  return {
