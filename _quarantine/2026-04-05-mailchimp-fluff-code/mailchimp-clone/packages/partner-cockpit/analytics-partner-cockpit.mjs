...
export function createPartnerCockpitAnalyticsTimeline() {
...
export function createPartnerCockpitForecastEnvelope() {
...
export function createPartnerCockpitExceptionLedger() {
...
export function summarizePartnerCockpitAnalytics() {
  const timeline = createPartnerCockpitAnalyticsTimeline();
  const forecast = createPartnerCockpitForecastEnvelope();
  return {
