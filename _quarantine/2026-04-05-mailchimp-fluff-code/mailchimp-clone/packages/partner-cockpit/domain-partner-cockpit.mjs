...
export function createPartnerCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizePartnerCockpitWorkspace(workspace = createPartnerCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createPartnerCockpitNarratives(workspace = createPartnerCockpitWorkspace()) {
...
export function createPartnerCockpitCoverageGrid(workspace = createPartnerCockpitWorkspace()) {
