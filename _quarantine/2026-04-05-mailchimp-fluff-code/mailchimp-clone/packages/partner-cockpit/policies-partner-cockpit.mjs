...
export function createPartnerCockpitPolicies(overrides = {}) {
...
export function validatePartnerCockpitPolicies(policies = createPartnerCockpitPolicies()) {
  const issues = [];
...
export function summarizePartnerCockpitPolicies(policies = createPartnerCockpitPolicies()) {
  return {
...
export function createPartnerCockpitEscalationDeck(policies = createPartnerCockpitPolicies()) {
