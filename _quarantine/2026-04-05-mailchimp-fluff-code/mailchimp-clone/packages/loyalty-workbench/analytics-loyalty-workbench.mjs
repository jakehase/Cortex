...
export function createLoyaltyWorkbenchAnalyticsTimeline() {
...
export function createLoyaltyWorkbenchForecastEnvelope() {
...
export function createLoyaltyWorkbenchExceptionLedger() {
...
export function summarizeLoyaltyWorkbenchAnalytics() {
  const timeline = createLoyaltyWorkbenchAnalyticsTimeline();
  const forecast = createLoyaltyWorkbenchForecastEnvelope();
  return {
