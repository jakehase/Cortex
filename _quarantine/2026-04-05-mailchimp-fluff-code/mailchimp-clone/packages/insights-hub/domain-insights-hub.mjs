const MODULE = {
  ...
  "routeSegment": "hub",
  "title": "Insights Hub",
  "focus": "Insights Hub covers insight synthesis, operating narratives, and executive-ready summaries through centralized operating views and routing.",
...
export function createInsightsHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsHubWorkspace(workspace = createInsightsHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsHubNarratives(workspace = createInsightsHubWorkspace()) {
...
export function createInsightsHubCoverageGrid(workspace = createInsightsHubWorkspace()) {
