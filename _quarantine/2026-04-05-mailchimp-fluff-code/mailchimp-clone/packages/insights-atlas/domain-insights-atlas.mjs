...
export function createInsightsAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsAtlasWorkspace(workspace = createInsightsAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsAtlasNarratives(workspace = createInsightsAtlasWorkspace()) {
...
export function createInsightsAtlasCoverageGrid(workspace = createInsightsAtlasWorkspace()) {
