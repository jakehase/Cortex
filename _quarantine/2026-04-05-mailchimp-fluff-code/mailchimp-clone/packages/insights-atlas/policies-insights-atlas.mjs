...
export function createInsightsAtlasPolicies(overrides = {}) {
...
export function validateInsightsAtlasPolicies(policies = createInsightsAtlasPolicies()) {
  const issues = [];
...
export function summarizeInsightsAtlasPolicies(policies = createInsightsAtlasPolicies()) {
  return {
...
export function createInsightsAtlasEscalationDeck(policies = createInsightsAtlasPolicies()) {
