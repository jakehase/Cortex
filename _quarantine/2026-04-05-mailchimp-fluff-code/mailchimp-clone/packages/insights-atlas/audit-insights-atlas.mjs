...
export function createInsightsAtlasAuditTrail() {
...
export function createInsightsAtlasEvidenceManifest() {
...
export function createInsightsAtlasReadinessAttestation() {
  const auditTrail = createInsightsAtlasAuditTrail();
  return {
