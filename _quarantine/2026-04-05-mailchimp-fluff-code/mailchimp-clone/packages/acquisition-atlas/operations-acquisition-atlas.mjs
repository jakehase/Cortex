...
export function createAcquisitionAtlasOperationsBoard() {
...
export function createAcquisitionAtlasShiftChecklist() {
...
export function createAcquisitionAtlasIncidentDeck() {
