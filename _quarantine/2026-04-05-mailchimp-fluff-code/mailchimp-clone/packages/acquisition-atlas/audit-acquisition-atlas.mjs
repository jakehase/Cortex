...
export function createAcquisitionAtlasAuditTrail() {
...
export function createAcquisitionAtlasEvidenceManifest() {
...
export function createAcquisitionAtlasReadinessAttestation() {
  const auditTrail = createAcquisitionAtlasAuditTrail();
  return {
