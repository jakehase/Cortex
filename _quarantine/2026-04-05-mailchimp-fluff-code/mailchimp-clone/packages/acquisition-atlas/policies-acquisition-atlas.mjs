...
export function createAcquisitionAtlasPolicies(overrides = {}) {
...
export function validateAcquisitionAtlasPolicies(policies = createAcquisitionAtlasPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionAtlasPolicies(policies = createAcquisitionAtlasPolicies()) {
  return {
...
export function createAcquisitionAtlasEscalationDeck(policies = createAcquisitionAtlasPolicies()) {
