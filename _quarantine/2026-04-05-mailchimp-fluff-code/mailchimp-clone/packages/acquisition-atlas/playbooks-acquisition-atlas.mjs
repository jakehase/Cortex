...
export function createAcquisitionAtlasPlaybooks() {
...
export function createAcquisitionAtlasDecisionDeck() {
...
export function createAcquisitionAtlasEscalationMoments() {
