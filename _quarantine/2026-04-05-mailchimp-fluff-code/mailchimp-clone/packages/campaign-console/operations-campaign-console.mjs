...
export function createCampaignConsoleOperationsBoard() {
...
export function createCampaignConsoleShiftChecklist() {
...
export function createCampaignConsoleIncidentDeck() {
