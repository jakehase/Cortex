...
export function createCampaignConsolePolicies(overrides = {}) {
...
export function validateCampaignConsolePolicies(policies = createCampaignConsolePolicies()) {
  const issues = [];
...
export function summarizeCampaignConsolePolicies(policies = createCampaignConsolePolicies()) {
  return {
...
export function createCampaignConsoleEscalationDeck(policies = createCampaignConsolePolicies()) {
