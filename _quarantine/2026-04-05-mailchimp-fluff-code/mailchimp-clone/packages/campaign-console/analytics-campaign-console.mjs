...
export function createCampaignConsoleAnalyticsTimeline() {
...
export function createCampaignConsoleForecastEnvelope() {
...
export function createCampaignConsoleExceptionLedger() {
...
export function summarizeCampaignConsoleAnalytics() {
  const timeline = createCampaignConsoleAnalyticsTimeline();
  const forecast = createCampaignConsoleForecastEnvelope();
  return {
