...
export function createCampaignConsoleAuditTrail() {
...
export function createCampaignConsoleEvidenceManifest() {
...
export function createCampaignConsoleReadinessAttestation() {
  const auditTrail = createCampaignConsoleAuditTrail();
  return {
