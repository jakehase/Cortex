...
export function createAcquisitionFoundryPlaybooks() {
...
export function createAcquisitionFoundryDecisionDeck() {
...
export function createAcquisitionFoundryEscalationMoments() {
