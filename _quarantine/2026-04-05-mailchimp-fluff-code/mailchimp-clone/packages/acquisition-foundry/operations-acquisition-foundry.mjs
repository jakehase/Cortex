...
export function createAcquisitionFoundryOperationsBoard() {
...
export function createAcquisitionFoundryShiftChecklist() {
...
export function createAcquisitionFoundryIncidentDeck() {
