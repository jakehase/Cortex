...
export function createActivationLedgerAuditTrail() {
...
export function createActivationLedgerEvidenceManifest() {
...
export function createActivationLedgerReadinessAttestation() {
  const auditTrail = createActivationLedgerAuditTrail();
  return {
