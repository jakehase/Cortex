...
export function createActivationNavigatorAnalyticsTimeline() {
...
export function createActivationNavigatorForecastEnvelope() {
...
export function createActivationNavigatorExceptionLedger() {
...
export function summarizeActivationNavigatorAnalytics() {
  const timeline = createActivationNavigatorAnalyticsTimeline();
  const forecast = createActivationNavigatorForecastEnvelope();
  return {
