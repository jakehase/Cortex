...
export function createAcquisitionGridOperationsBoard() {
...
export function createAcquisitionGridShiftChecklist() {
...
export function createAcquisitionGridIncidentDeck() {
