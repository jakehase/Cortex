...
export function createAcquisitionGridAnalyticsTimeline() {
...
export function createAcquisitionGridForecastEnvelope() {
...
export function createAcquisitionGridExceptionLedger() {
...
export function summarizeAcquisitionGridAnalytics() {
  const timeline = createAcquisitionGridAnalyticsTimeline();
  const forecast = createAcquisitionGridForecastEnvelope();
  return {
