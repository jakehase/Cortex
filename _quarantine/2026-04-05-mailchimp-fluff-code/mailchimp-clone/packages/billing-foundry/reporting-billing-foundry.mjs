...
export function createBillingFoundryReportCards() {
...
export function createBillingFoundryReviewPackets() {
...
export function summarizeBillingFoundryReporting() {
  const cards = createBillingFoundryReportCards();
  const packets = createBillingFoundryReviewPackets();
  return {
