...
export function createBillingFoundryPolicies(overrides = {}) {
...
export function validateBillingFoundryPolicies(policies = createBillingFoundryPolicies()) {
  const issues = [];
...
export function summarizeBillingFoundryPolicies(policies = createBillingFoundryPolicies()) {
  return {
...
export function createBillingFoundryEscalationDeck(policies = createBillingFoundryPolicies()) {
