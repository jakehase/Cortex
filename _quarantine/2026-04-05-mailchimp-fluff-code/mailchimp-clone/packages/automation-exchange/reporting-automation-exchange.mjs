...
export function createAutomationExchangeReportCards() {
...
export function createAutomationExchangeReviewPackets() {
...
export function summarizeAutomationExchangeReporting() {
  const cards = createAutomationExchangeReportCards();
  const packets = createAutomationExchangeReviewPackets();
  return {
