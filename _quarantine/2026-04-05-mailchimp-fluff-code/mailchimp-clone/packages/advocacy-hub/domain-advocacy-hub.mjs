...
export function createAdvocacyHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyHubWorkspace(workspace = createAdvocacyHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyHubNarratives(workspace = createAdvocacyHubWorkspace()) {
...
export function createAdvocacyHubCoverageGrid(workspace = createAdvocacyHubWorkspace()) {
