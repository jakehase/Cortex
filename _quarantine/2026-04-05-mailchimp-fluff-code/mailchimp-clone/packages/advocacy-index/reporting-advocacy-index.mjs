...
export function createAdvocacyIndexReportCards() {
...
export function createAdvocacyIndexReviewPackets() {
...
export function summarizeAdvocacyIndexReporting() {
  const cards = createAdvocacyIndexReportCards();
  const packets = createAdvocacyIndexReviewPackets();
  return {
