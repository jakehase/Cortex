...
export function createAdvocacyIndexPolicies(overrides = {}) {
...
export function validateAdvocacyIndexPolicies(policies = createAdvocacyIndexPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyIndexPolicies(policies = createAdvocacyIndexPolicies()) {
  return {
...
export function createAdvocacyIndexEscalationDeck(policies = createAdvocacyIndexPolicies()) {
