...
export function createAdvocacyIndexAuditTrail() {
...
export function createAdvocacyIndexEvidenceManifest() {
...
export function createAdvocacyIndexReadinessAttestation() {
  const auditTrail = createAdvocacyIndexAuditTrail();
  return {
