...
export function createComplianceCockpitReportCards() {
...
export function createComplianceCockpitReviewPackets() {
...
export function summarizeComplianceCockpitReporting() {
  const cards = createComplianceCockpitReportCards();
  const packets = createComplianceCockpitReviewPackets();
  return {
