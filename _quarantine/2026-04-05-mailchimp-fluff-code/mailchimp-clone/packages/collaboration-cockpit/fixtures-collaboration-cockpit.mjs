...
export function createCollaborationCockpitFixtures() {
  return {
    accounts: [
...
export function summarizeCollaborationCockpitFixtures(fixtures = createCollaborationCockpitFixtures()) {
  return {
...
export function createCollaborationCockpitDemoInputs() {
  return {
