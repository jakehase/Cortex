...
export function createCollaborationCockpitOperationsBoard() {
...
export function createCollaborationCockpitShiftChecklist() {
...
export function createCollaborationCockpitIncidentDeck() {
