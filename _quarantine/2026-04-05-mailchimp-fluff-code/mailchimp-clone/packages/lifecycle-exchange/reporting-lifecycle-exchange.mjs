...
export function createLifecycleExchangeReportCards() {
...
export function createLifecycleExchangeReviewPackets() {
...
export function summarizeLifecycleExchangeReporting() {
  const cards = createLifecycleExchangeReportCards();
  const packets = createLifecycleExchangeReviewPackets();
  return {
