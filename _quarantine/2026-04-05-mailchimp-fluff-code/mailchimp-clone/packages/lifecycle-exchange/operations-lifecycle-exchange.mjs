...
export function createLifecycleExchangeOperationsBoard() {
...
export function createLifecycleExchangeShiftChecklist() {
...
export function createLifecycleExchangeIncidentDeck() {
