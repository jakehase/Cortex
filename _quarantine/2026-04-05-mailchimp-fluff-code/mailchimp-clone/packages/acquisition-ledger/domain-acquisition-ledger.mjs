...
export function createAcquisitionLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionLedgerWorkspace(workspace = createAcquisitionLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionLedgerNarratives(workspace = createAcquisitionLedgerWorkspace()) {
...
export function createAcquisitionLedgerCoverageGrid(workspace = createAcquisitionLedgerWorkspace()) {
