...
export function createAcquisitionLedgerPolicies(overrides = {}) {
...
export function validateAcquisitionLedgerPolicies(policies = createAcquisitionLedgerPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionLedgerPolicies(policies = createAcquisitionLedgerPolicies()) {
  return {
...
export function createAcquisitionLedgerEscalationDeck(policies = createAcquisitionLedgerPolicies()) {
