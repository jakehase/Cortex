...
export function createAcquisitionLedgerReportCards() {
...
export function createAcquisitionLedgerReviewPackets() {
...
export function summarizeAcquisitionLedgerReporting() {
  const cards = createAcquisitionLedgerReportCards();
  const packets = createAcquisitionLedgerReviewPackets();
  return {
