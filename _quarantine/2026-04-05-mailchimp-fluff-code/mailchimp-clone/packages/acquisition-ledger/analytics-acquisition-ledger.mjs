...
export function createAcquisitionLedgerAnalyticsTimeline() {
...
export function createAcquisitionLedgerForecastEnvelope() {
...
export function createAcquisitionLedgerExceptionLedger() {
...
export function summarizeAcquisitionLedgerAnalytics() {
  const timeline = createAcquisitionLedgerAnalyticsTimeline();
  const forecast = createAcquisitionLedgerForecastEnvelope();
  return {
