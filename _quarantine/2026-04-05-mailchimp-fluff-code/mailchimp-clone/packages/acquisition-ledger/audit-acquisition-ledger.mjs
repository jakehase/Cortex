...
export function createAcquisitionLedgerAuditTrail() {
...
export function createAcquisitionLedgerEvidenceManifest() {
...
export function createAcquisitionLedgerReadinessAttestation() {
  const auditTrail = createAcquisitionLedgerAuditTrail();
  return {
