...
export function createEcommerceVaultPolicies(overrides = {}) {
...
export function validateEcommerceVaultPolicies(policies = createEcommerceVaultPolicies()) {
  const issues = [];
...
export function summarizeEcommerceVaultPolicies(policies = createEcommerceVaultPolicies()) {
  return {
...
export function createEcommerceVaultEscalationDeck(policies = createEcommerceVaultPolicies()) {
