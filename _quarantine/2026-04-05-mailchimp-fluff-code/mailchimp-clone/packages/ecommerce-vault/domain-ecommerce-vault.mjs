...
export function createEcommerceVaultWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceVaultWorkspace(workspace = createEcommerceVaultWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceVaultNarratives(workspace = createEcommerceVaultWorkspace()) {
...
export function createEcommerceVaultCoverageGrid(workspace = createEcommerceVaultWorkspace()) {
