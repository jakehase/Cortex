...
export function createEcommercePlannerFixtures() {
  return {
    accounts: [
...
export function summarizeEcommercePlannerFixtures(fixtures = createEcommercePlannerFixtures()) {
  return {
...
export function createEcommercePlannerDemoInputs() {
  return {
