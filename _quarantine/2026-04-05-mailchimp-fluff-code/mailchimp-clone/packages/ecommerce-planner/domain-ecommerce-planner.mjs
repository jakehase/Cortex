...
export function createEcommercePlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommercePlannerWorkspace(workspace = createEcommercePlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommercePlannerNarratives(workspace = createEcommercePlannerWorkspace()) {
...
export function createEcommercePlannerCoverageGrid(workspace = createEcommercePlannerWorkspace()) {
