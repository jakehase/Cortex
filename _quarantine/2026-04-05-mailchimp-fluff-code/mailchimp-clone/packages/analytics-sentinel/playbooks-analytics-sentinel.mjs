...
export function createAnalyticsSentinelPlaybooks() {
...
export function createAnalyticsSentinelDecisionDeck() {
...
export function createAnalyticsSentinelEscalationMoments() {
