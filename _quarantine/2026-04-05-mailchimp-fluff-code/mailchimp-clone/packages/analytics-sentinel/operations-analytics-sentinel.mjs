...
export function createAnalyticsSentinelOperationsBoard() {
...
export function createAnalyticsSentinelShiftChecklist() {
...
export function createAnalyticsSentinelIncidentDeck() {
