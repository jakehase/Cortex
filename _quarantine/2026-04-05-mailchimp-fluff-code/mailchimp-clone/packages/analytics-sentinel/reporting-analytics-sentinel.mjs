...
export function createAnalyticsSentinelReportCards() {
...
export function createAnalyticsSentinelReviewPackets() {
...
export function summarizeAnalyticsSentinelReporting() {
  const cards = createAnalyticsSentinelReportCards();
  const packets = createAnalyticsSentinelReviewPackets();
  return {
