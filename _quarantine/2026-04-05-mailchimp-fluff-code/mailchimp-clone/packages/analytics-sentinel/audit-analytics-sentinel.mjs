...
export function createAnalyticsSentinelAuditTrail() {
...
export function createAnalyticsSentinelEvidenceManifest() {
...
export function createAnalyticsSentinelReadinessAttestation() {
  const auditTrail = createAnalyticsSentinelAuditTrail();
  return {
