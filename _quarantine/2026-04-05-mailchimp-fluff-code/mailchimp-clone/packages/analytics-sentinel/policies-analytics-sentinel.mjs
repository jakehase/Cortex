...
export function createAnalyticsSentinelPolicies(overrides = {}) {
...
export function validateAnalyticsSentinelPolicies(policies = createAnalyticsSentinelPolicies()) {
  const issues = [];
...
export function summarizeAnalyticsSentinelPolicies(policies = createAnalyticsSentinelPolicies()) {
  return {
...
export function createAnalyticsSentinelEscalationDeck(policies = createAnalyticsSentinelPolicies()) {
