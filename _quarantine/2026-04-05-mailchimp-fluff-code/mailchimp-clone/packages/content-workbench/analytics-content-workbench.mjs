...
export function createContentWorkbenchAnalyticsTimeline() {
...
export function createContentWorkbenchForecastEnvelope() {
...
export function createContentWorkbenchExceptionLedger() {
...
export function summarizeContentWorkbenchAnalytics() {
  const timeline = createContentWorkbenchAnalyticsTimeline();
  const forecast = createContentWorkbenchForecastEnvelope();
  return {
