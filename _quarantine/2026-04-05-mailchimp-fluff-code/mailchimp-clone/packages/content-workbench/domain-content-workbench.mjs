const MODULE = {
  ...
  "focus": "Content Workbench covers content operations, packaging, and channel-specific delivery shape through hands-on workflows and analyst tooling.",
...
export function createContentWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentWorkbenchWorkspace(workspace = createContentWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentWorkbenchNarratives(workspace = createContentWorkbenchWorkspace()) {
...
export function createContentWorkbenchCoverageGrid(workspace = createContentWorkbenchWorkspace()) {
