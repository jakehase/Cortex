const MODULE = {
  ...
  "title": "Content Dossier",
  "focus": "Content Dossier covers content operations, packaging, and channel-specific delivery shape through evidence packets and stakeholder briefings.",
...
export function createContentDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentDossierWorkspace(workspace = createContentDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentDossierNarratives(workspace = createContentDossierWorkspace()) {
...
export function createContentDossierCoverageGrid(workspace = createContentDossierWorkspace()) {
