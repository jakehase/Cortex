...
export function createContentDossierAuditTrail() {
...
export function createContentDossierEvidenceManifest() {
...
export function createContentDossierReadinessAttestation() {
  const auditTrail = createContentDossierAuditTrail();
  return {
