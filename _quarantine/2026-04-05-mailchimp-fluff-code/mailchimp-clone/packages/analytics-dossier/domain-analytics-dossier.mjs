const MODULE = {
  "id": "analytics-dossier",
  "ordinal": 65,
  "domain": "analytics",
  "surfaceId": "dossier",
  "surfaceTitle": "Dossier",
  "routeSegment": "dossier",
  "title": "Analytics Dossier",
  "focus": "Analytics Dossier covers portfolio analytics, operator scorecards, and query-driven reviews through evidence packets and stakeholder briefings.",
...
export function createAnalyticsDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsDossierWorkspace(workspace = createAnalyticsDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsDossierNarratives(workspace = createAnalyticsDossierWorkspace()) {
...
export function createAnalyticsDossierCoverageGrid(workspace = createAnalyticsDossierWorkspace()) {
