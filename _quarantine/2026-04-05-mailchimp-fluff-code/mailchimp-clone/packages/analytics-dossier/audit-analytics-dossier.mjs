...
export function createAnalyticsDossierAuditTrail() {
...
export function createAnalyticsDossierEvidenceManifest() {
...
export function createAnalyticsDossierReadinessAttestation() {
  const auditTrail = createAnalyticsDossierAuditTrail();
  return {
