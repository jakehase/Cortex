...
export function createAnalyticsDossierPlaybooks() {
...
export function createAnalyticsDossierDecisionDeck() {
...
export function createAnalyticsDossierEscalationMoments() {
