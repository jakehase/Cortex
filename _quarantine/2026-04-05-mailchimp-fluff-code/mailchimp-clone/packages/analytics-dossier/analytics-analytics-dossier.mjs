...
export function createAnalyticsDossierAnalyticsTimeline() {
...
export function createAnalyticsDossierForecastEnvelope() {
...
export function createAnalyticsDossierExceptionLedger() {
...
export function summarizeAnalyticsDossierAnalytics() {
  const timeline = createAnalyticsDossierAnalyticsTimeline();
  const forecast = createAnalyticsDossierForecastEnvelope();
  return {
