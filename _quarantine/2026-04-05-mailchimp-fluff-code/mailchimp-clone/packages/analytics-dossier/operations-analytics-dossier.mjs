...
export function createAnalyticsDossierOperationsBoard() {
...
export function createAnalyticsDossierShiftChecklist() {
...
export function createAnalyticsDossierIncidentDeck() {
