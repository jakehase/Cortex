...
export function createAttributionFoundryReportCards() {
...
export function createAttributionFoundryReviewPackets() {
...
export function summarizeAttributionFoundryReporting() {
  const cards = createAttributionFoundryReportCards();
  const packets = createAttributionFoundryReviewPackets();
  return {
