...
export function createAutomationConsoleReportCards() {
...
export function createAutomationConsoleReviewPackets() {
...
export function summarizeAutomationConsoleReporting() {
  const cards = createAutomationConsoleReportCards();
  const packets = createAutomationConsoleReviewPackets();
  return {
