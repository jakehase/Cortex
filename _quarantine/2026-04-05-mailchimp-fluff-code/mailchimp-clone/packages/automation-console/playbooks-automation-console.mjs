...
export function createAutomationConsolePlaybooks() {
...
export function createAutomationConsoleDecisionDeck() {
...
export function createAutomationConsoleEscalationMoments() {
