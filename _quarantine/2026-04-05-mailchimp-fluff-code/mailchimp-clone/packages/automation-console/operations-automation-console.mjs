...
export function createAutomationConsoleOperationsBoard() {
...
export function createAutomationConsoleShiftChecklist() {
...
export function createAutomationConsoleIncidentDeck() {
