...
export function createAutomationIndexAnalyticsTimeline() {
...
export function createAutomationIndexForecastEnvelope() {
...
export function createAutomationIndexExceptionLedger() {
...
export function summarizeAutomationIndexAnalytics() {
  const timeline = createAutomationIndexAnalyticsTimeline();
  const forecast = createAutomationIndexForecastEnvelope();
  return {
