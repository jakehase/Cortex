...
export function createAutomationIndexPolicies(overrides = {}) {
...
export function validateAutomationIndexPolicies(policies = createAutomationIndexPolicies()) {
  const issues = [];
...
export function summarizeAutomationIndexPolicies(policies = createAutomationIndexPolicies()) {
  return {
...
export function createAutomationIndexEscalationDeck(policies = createAutomationIndexPolicies()) {
