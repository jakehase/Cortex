...
export function createAutomationIndexAuditTrail() {
...
export function createAutomationIndexEvidenceManifest() {
...
export function createAutomationIndexReadinessAttestation() {
  const auditTrail = createAutomationIndexAuditTrail();
  return {
