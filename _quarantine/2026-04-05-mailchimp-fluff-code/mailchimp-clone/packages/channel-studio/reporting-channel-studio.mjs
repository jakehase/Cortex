...
export function createChannelStudioReportCards() {
...
export function createChannelStudioReviewPackets() {
...
export function summarizeChannelStudioReporting() {
  const cards = createChannelStudioReportCards();
  const packets = createChannelStudioReviewPackets();
  return {
