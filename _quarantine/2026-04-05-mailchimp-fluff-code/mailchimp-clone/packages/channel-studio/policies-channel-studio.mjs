...
export function createChannelStudioPolicies(overrides = {}) {
...
export function validateChannelStudioPolicies(policies = createChannelStudioPolicies()) {
  const issues = [];
...
export function summarizeChannelStudioPolicies(policies = createChannelStudioPolicies()) {
  return {
...
export function createChannelStudioEscalationDeck(policies = createChannelStudioPolicies()) {
