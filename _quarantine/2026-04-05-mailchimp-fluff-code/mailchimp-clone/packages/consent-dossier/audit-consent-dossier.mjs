...
export function createConsentDossierAuditTrail() {
...
export function createConsentDossierEvidenceManifest() {
...
export function createConsentDossierReadinessAttestation() {
  const auditTrail = createConsentDossierAuditTrail();
  return {
