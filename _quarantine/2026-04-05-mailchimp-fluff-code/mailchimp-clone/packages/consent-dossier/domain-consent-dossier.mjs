const MODULE = {
  ...
  "title": "Consent Dossier",
  "focus": "Consent Dossier covers proof of consent, subscription changes, and evidence continuity through evidence packets and stakeholder briefings.",
...
export function createConsentDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeConsentDossierWorkspace(workspace = createConsentDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createConsentDossierNarratives(workspace = createConsentDossierWorkspace()) {
...
export function createConsentDossierCoverageGrid(workspace = createConsentDossierWorkspace()) {
