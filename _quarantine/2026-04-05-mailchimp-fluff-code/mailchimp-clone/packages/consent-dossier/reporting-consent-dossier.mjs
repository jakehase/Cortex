...
export function createConsentDossierReportCards() {
...
export function createConsentDossierReviewPackets() {
...
export function summarizeConsentDossierReporting() {
  const cards = createConsentDossierReportCards();
  const packets = createConsentDossierReviewPackets();
  return {
