const MODULE = {
  ...
  "focus": "Analytics Console covers portfolio analytics, operator scorecards, and query-driven reviews through execution controls and workspace steering.",
...
export function createAnalyticsConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsConsoleWorkspace(workspace = createAnalyticsConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsConsoleNarratives(workspace = createAnalyticsConsoleWorkspace()) {
...
export function createAnalyticsConsoleCoverageGrid(workspace = createAnalyticsConsoleWorkspace()) {
