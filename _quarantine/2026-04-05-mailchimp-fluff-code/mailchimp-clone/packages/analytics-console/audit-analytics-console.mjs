...
export function createAnalyticsConsoleAuditTrail() {
...
export function createAnalyticsConsoleEvidenceManifest() {
...
export function createAnalyticsConsoleReadinessAttestation() {
  const auditTrail = createAnalyticsConsoleAuditTrail();
  return {
