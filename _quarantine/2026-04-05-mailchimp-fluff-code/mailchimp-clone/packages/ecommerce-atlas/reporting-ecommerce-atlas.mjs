...
export function createEcommerceAtlasReportCards() {
...
export function createEcommerceAtlasReviewPackets() {
...
export function summarizeEcommerceAtlasReporting() {
  const cards = createEcommerceAtlasReportCards();
  const packets = createEcommerceAtlasReviewPackets();
  return {
