...
export function createIntegrationsNavigatorOperationsBoard() {
...
export function createIntegrationsNavigatorShiftChecklist() {
...
export function createIntegrationsNavigatorIncidentDeck() {
