...
export function createIntegrationsNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsNavigatorWorkspace(workspace = createIntegrationsNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsNavigatorNarratives(workspace = createIntegrationsNavigatorWorkspace()) {
...
export function createIntegrationsNavigatorCoverageGrid(workspace = createIntegrationsNavigatorWorkspace()) {
