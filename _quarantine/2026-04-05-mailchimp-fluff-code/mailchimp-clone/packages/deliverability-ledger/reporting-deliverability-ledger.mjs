...
export function createDeliverabilityLedgerReportCards() {
...
export function createDeliverabilityLedgerReviewPackets() {
...
export function summarizeDeliverabilityLedgerReporting() {
  const cards = createDeliverabilityLedgerReportCards();
  const packets = createDeliverabilityLedgerReviewPackets();
  return {
