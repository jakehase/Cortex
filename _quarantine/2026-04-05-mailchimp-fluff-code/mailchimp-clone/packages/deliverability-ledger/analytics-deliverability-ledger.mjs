...
export function createDeliverabilityLedgerAnalyticsTimeline() {
...
export function createDeliverabilityLedgerForecastEnvelope() {
...
export function createDeliverabilityLedgerExceptionLedger() {
...
export function summarizeDeliverabilityLedgerAnalytics() {
  const timeline = createDeliverabilityLedgerAnalyticsTimeline();
  const forecast = createDeliverabilityLedgerForecastEnvelope();
  return {
