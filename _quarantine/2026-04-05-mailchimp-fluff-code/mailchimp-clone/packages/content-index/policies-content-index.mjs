...
export function createContentIndexPolicies(overrides = {}) {
...
export function validateContentIndexPolicies(policies = createContentIndexPolicies()) {
  const issues = [];
...
export function summarizeContentIndexPolicies(policies = createContentIndexPolicies()) {
  return {
...
export function createContentIndexEscalationDeck(policies = createContentIndexPolicies()) {
