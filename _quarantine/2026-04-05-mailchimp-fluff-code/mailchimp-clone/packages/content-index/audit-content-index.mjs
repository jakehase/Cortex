...
export function createContentIndexAuditTrail() {
...
export function createContentIndexEvidenceManifest() {
...
export function createContentIndexReadinessAttestation() {
  const auditTrail = createContentIndexAuditTrail();
  return {
