...
export function createContentIndexReportCards() {
...
export function createContentIndexReviewPackets() {
...
export function summarizeContentIndexReporting() {
  const cards = createContentIndexReportCards();
  const packets = createContentIndexReviewPackets();
  return {
