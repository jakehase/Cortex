...
export function createCollaborationWatchtowerAuditTrail() {
...
export function createCollaborationWatchtowerEvidenceManifest() {
...
export function createCollaborationWatchtowerReadinessAttestation() {
  const auditTrail = createCollaborationWatchtowerAuditTrail();
  return {
