...
export function createCollaborationWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationWatchtowerWorkspace(workspace = createCollaborationWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationWatchtowerNarratives(workspace = createCollaborationWatchtowerWorkspace()) {
...
export function createCollaborationWatchtowerCoverageGrid(workspace = createCollaborationWatchtowerWorkspace()) {
