...
export function createLocalizationAtlasReportCards() {
...
export function createLocalizationAtlasReviewPackets() {
...
export function summarizeLocalizationAtlasReporting() {
  const cards = createLocalizationAtlasReportCards();
  const packets = createLocalizationAtlasReviewPackets();
  return {
