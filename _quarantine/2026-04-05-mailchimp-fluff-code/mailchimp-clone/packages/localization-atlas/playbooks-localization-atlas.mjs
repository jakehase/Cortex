...
export function createLocalizationAtlasPlaybooks() {
...
export function createLocalizationAtlasDecisionDeck() {
...
export function createLocalizationAtlasEscalationMoments() {
