const MODULE = {
  "id": "localization-atlas",
  "ordinal": 500,
  "domain": "localization",
  "surfaceId": "atlas",
  "surfaceTitle": "Atlas",
  "routeSegment": "atlas",
  "title": "Localization Atlas",
  "focus": "Localization Atlas covers regional readiness, translation coverage, and market-specific proof through landscape mapping and territory coverage.",
...
export function createLocalizationAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationAtlasWorkspace(workspace = createLocalizationAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationAtlasNarratives(workspace = createLocalizationAtlasWorkspace()) {
...
export function createLocalizationAtlasCoverageGrid(workspace = createLocalizationAtlasWorkspace()) {
