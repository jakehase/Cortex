...
export function createLocalizationAtlasPolicies(overrides = {}) {
...
export function validateLocalizationAtlasPolicies(policies = createLocalizationAtlasPolicies()) {
  const issues = [];
...
export function summarizeLocalizationAtlasPolicies(policies = createLocalizationAtlasPolicies()) {
  return {
...
export function createLocalizationAtlasEscalationDeck(policies = createLocalizationAtlasPolicies()) {
