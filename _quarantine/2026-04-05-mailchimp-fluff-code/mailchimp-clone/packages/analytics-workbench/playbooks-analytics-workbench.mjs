...
export function createAnalyticsWorkbenchPlaybooks() {
...
export function createAnalyticsWorkbenchDecisionDeck() {
...
export function createAnalyticsWorkbenchEscalationMoments() {
