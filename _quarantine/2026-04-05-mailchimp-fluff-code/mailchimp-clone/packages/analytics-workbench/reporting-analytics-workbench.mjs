...
export function createAnalyticsWorkbenchReportCards() {
...
export function createAnalyticsWorkbenchReviewPackets() {
...
export function summarizeAnalyticsWorkbenchReporting() {
  const cards = createAnalyticsWorkbenchReportCards();
  const packets = createAnalyticsWorkbenchReviewPackets();
  return {
