...
export function createAnalyticsWorkbenchAuditTrail() {
...
export function createAnalyticsWorkbenchEvidenceManifest() {
...
export function createAnalyticsWorkbenchReadinessAttestation() {
  const auditTrail = createAnalyticsWorkbenchAuditTrail();
  return {
