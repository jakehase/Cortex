...
export function createAudienceHubReportCards() {
...
export function createAudienceHubReviewPackets() {
...
export function summarizeAudienceHubReporting() {
  const cards = createAudienceHubReportCards();
  const packets = createAudienceHubReviewPackets();
  return {
