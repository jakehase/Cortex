const MODULE = {
  ...
  "routeSegment": "hub",
  "title": "Audience Hub",
  "focus": "Audience Hub covers audience health, segment design, and targeting durability through centralized operating views and routing.",
...
export function createAudienceHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceHubWorkspace(workspace = createAudienceHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceHubNarratives(workspace = createAudienceHubWorkspace()) {
...
export function createAudienceHubCoverageGrid(workspace = createAudienceHubWorkspace()) {
