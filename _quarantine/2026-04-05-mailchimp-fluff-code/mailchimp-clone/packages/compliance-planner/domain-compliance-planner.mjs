const MODULE = {
  ...
  "focus": "Compliance Planner covers controls, remediation steps, and governance evidence capture through calendar planning and execution choreography.",
...
export function createCompliancePlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCompliancePlannerWorkspace(workspace = createCompliancePlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCompliancePlannerNarratives(workspace = createCompliancePlannerWorkspace()) {
...
export function createCompliancePlannerCoverageGrid(workspace = createCompliancePlannerWorkspace()) {
