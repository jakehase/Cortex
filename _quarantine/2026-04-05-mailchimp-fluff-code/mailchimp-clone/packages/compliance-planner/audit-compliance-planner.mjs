...
export function createCompliancePlannerAuditTrail() {
...
export function createCompliancePlannerEvidenceManifest() {
...
export function createCompliancePlannerReadinessAttestation() {
  const auditTrail = createCompliancePlannerAuditTrail();
  return {
