...
export function createCompliancePlannerReportCards() {
...
export function createCompliancePlannerReviewPackets() {
...
export function summarizeCompliancePlannerReporting() {
  const cards = createCompliancePlannerReportCards();
  const packets = createCompliancePlannerReviewPackets();
  return {
