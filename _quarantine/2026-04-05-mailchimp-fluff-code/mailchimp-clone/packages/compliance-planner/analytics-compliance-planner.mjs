...
export function createCompliancePlannerAnalyticsTimeline() {
...
export function createCompliancePlannerForecastEnvelope() {
...
export function createCompliancePlannerExceptionLedger() {
...
export function summarizeCompliancePlannerAnalytics() {
  const timeline = createCompliancePlannerAnalyticsTimeline();
  const forecast = createCompliancePlannerForecastEnvelope();
  return {
