const MODULE = {
  "id": "experimentation-atlas",
  "ordinal": 420,
  "domain": "experimentation",
  "surfaceId": "atlas",
  "surfaceTitle": "Atlas",
  "routeSegment": "atlas",
  "title": "Experimentation Atlas",
  "focus": "Experimentation Atlas covers test planning, variant analysis, and decision velocity through landscape mapping and territory coverage.",
  ...
  "tags": [
    ...
    "atlas",
    "intelligence",
    "experimentation-atlas-wave-seven"
  ]
};
...
export function createExperimentationAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationAtlasWorkspace(workspace = createExperimentationAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationAtlasNarratives(workspace = createExperimentationAtlasWorkspace()) {
...
export function createExperimentationAtlasCoverageGrid(workspace = createExperimentationAtlasWorkspace()) {
