...
export function createExperimentationAtlasAuditTrail() {
...
export function createExperimentationAtlasEvidenceManifest() {
...
export function createExperimentationAtlasReadinessAttestation() {
  const auditTrail = createExperimentationAtlasAuditTrail();
  return {
