...
export function createExperimentationAtlasReportCards() {
...
export function createExperimentationAtlasReviewPackets() {
...
export function summarizeExperimentationAtlasReporting() {
  const cards = createExperimentationAtlasReportCards();
  const packets = createExperimentationAtlasReviewPackets();
  return {
