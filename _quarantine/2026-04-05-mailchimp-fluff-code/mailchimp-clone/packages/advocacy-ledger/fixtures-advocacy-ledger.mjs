...
export function createAdvocacyLedgerFixtures() {
  return {
    accounts: [
...
export function summarizeAdvocacyLedgerFixtures(fixtures = createAdvocacyLedgerFixtures()) {
  return {
...
export function createAdvocacyLedgerDemoInputs() {
  return {
