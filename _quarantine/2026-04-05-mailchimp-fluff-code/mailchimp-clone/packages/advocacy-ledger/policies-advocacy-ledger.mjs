...
export function createAdvocacyLedgerPolicies(overrides = {}) {
...
export function validateAdvocacyLedgerPolicies(policies = createAdvocacyLedgerPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyLedgerPolicies(policies = createAdvocacyLedgerPolicies()) {
  return {
...
export function createAdvocacyLedgerEscalationDeck(policies = createAdvocacyLedgerPolicies()) {
