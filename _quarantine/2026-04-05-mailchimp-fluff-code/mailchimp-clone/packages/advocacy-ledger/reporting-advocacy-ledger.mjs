...
export function createAdvocacyLedgerReportCards() {
...
export function createAdvocacyLedgerReviewPackets() {
...
export function summarizeAdvocacyLedgerReporting() {
  const cards = createAdvocacyLedgerReportCards();
  const packets = createAdvocacyLedgerReviewPackets();
  return {
