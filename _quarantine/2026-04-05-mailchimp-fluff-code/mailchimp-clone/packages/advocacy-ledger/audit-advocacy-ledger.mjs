...
export function createAdvocacyLedgerAuditTrail() {
...
export function createAdvocacyLedgerEvidenceManifest() {
...
export function createAdvocacyLedgerReadinessAttestation() {
  const auditTrail = createAdvocacyLedgerAuditTrail();
  return {
