...
export function createExperimentationDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationDossierWorkspace(workspace = createExperimentationDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationDossierNarratives(workspace = createExperimentationDossierWorkspace()) {
...
export function createExperimentationDossierCoverageGrid(workspace = createExperimentationDossierWorkspace()) {
