...
export function createExperimentationDossierFixtures() {
  return {
    accounts: [
...
export function summarizeExperimentationDossierFixtures(fixtures = createExperimentationDossierFixtures()) {
  return {
...
export function createExperimentationDossierDemoInputs() {
  return {
