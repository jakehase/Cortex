...
export function createExperimentationDossierAuditTrail() {
...
export function createExperimentationDossierEvidenceManifest() {
...
export function createExperimentationDossierReadinessAttestation() {
  const auditTrail = createExperimentationDossierAuditTrail();
  return {
