...
export function createExperimentationWatchtowerAuditTrail() {
...
export function createExperimentationWatchtowerEvidenceManifest() {
...
export function createExperimentationWatchtowerReadinessAttestation() {
  const auditTrail = createExperimentationWatchtowerAuditTrail();
  return {
