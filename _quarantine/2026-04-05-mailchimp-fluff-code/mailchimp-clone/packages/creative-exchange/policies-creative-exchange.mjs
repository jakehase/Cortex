...
export function createCreativeExchangePolicies(overrides = {}) {
...
export function validateCreativeExchangePolicies(policies = createCreativeExchangePolicies()) {
  const issues = [];
...
export function summarizeCreativeExchangePolicies(policies = createCreativeExchangePolicies()) {
  return {
...
export function createCreativeExchangeEscalationDeck(policies = createCreativeExchangePolicies()) {
