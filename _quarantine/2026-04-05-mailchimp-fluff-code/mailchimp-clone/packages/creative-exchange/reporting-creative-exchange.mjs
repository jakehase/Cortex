...
export function createCreativeExchangeReportCards() {
...
export function createCreativeExchangeReviewPackets() {
...
export function summarizeCreativeExchangeReporting() {
  const cards = createCreativeExchangeReportCards();
  const packets = createCreativeExchangeReviewPackets();
  return {
