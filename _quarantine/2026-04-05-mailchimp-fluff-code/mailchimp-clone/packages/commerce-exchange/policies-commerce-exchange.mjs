...
export function createCommerceExchangePolicies(overrides = {}) {
...
export function validateCommerceExchangePolicies(policies = createCommerceExchangePolicies()) {
  const issues = [];
...
export function summarizeCommerceExchangePolicies(policies = createCommerceExchangePolicies()) {
  return {
...
export function createCommerceExchangeEscalationDeck(policies = createCommerceExchangePolicies()) {
