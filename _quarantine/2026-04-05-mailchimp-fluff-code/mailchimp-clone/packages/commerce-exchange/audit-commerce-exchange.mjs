...
export function createCommerceExchangeAuditTrail() {
...
export function createCommerceExchangeEvidenceManifest() {
...
export function createCommerceExchangeReadinessAttestation() {
  const auditTrail = createCommerceExchangeAuditTrail();
  return {
