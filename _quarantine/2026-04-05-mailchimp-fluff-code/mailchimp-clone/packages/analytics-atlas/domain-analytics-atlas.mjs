const MODULE = {
  ...
  "focus": "Analytics Atlas covers portfolio analytics, operator scorecards, and query-driven reviews through landscape mapping and territory coverage.",
...
export function createAnalyticsAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsAtlasWorkspace(workspace = createAnalyticsAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsAtlasNarratives(workspace = createAnalyticsAtlasWorkspace()) {
...
export function createAnalyticsAtlasCoverageGrid(workspace = createAnalyticsAtlasWorkspace()) {
