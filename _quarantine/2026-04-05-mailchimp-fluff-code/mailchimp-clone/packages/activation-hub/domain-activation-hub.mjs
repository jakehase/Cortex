const MODULE = {
  ...
  "surfaceTitle": "Hub",
  "routeSegment": "hub",
  "title": "Activation Hub",
  "focus": "Activation Hub covers onboarding readiness, first-value motion, and kickoff momentum through centralized operating views and routing.",
...
export function createActivationHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationHubWorkspace(workspace = createActivationHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationHubNarratives(workspace = createActivationHubWorkspace()) {
...
export function createActivationHubCoverageGrid(workspace = createActivationHubWorkspace()) {
