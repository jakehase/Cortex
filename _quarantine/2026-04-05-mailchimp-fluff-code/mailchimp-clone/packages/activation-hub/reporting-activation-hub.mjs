...
export function createActivationHubReportCards() {
...
export function createActivationHubReviewPackets() {
...
export function summarizeActivationHubReporting() {
  const cards = createActivationHubReportCards();
  const packets = createActivationHubReviewPackets();
  return {
