...
export function createComplianceGridPolicies(overrides = {}) {
...
export function validateComplianceGridPolicies(policies = createComplianceGridPolicies()) {
  const issues = [];
...
export function summarizeComplianceGridPolicies(policies = createComplianceGridPolicies()) {
  return {
...
export function createComplianceGridEscalationDeck(policies = createComplianceGridPolicies()) {
