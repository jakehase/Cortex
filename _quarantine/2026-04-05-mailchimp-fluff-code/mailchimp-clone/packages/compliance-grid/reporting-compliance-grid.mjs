...
export function createComplianceGridReportCards() {
...
export function createComplianceGridReviewPackets() {
...
export function summarizeComplianceGridReporting() {
  const cards = createComplianceGridReportCards();
  const packets = createComplianceGridReviewPackets();
  return {
