...
export function createAttributionStudioReportCards() {
...
export function createAttributionStudioReviewPackets() {
...
export function summarizeAttributionStudioReporting() {
  const cards = createAttributionStudioReportCards();
  const packets = createAttributionStudioReviewPackets();
  return {
