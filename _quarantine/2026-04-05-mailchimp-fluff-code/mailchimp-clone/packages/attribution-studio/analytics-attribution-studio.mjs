...
export function createAttributionStudioAnalyticsTimeline() {
...
export function createAttributionStudioForecastEnvelope() {
...
export function createAttributionStudioExceptionLedger() {
...
export function summarizeAttributionStudioAnalytics() {
  const timeline = createAttributionStudioAnalyticsTimeline();
  const forecast = createAttributionStudioForecastEnvelope();
  return {
