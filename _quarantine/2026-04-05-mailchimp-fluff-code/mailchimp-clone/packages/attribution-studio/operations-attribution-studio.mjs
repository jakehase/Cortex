...
export function createAttributionStudioOperationsBoard() {
...
export function createAttributionStudioShiftChecklist() {
...
export function createAttributionStudioIncidentDeck() {
