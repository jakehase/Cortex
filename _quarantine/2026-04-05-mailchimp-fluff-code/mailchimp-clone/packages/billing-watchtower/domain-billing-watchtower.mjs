...
export function createBillingWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingWatchtowerWorkspace(workspace = createBillingWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingWatchtowerNarratives(workspace = createBillingWatchtowerWorkspace()) {
...
export function createBillingWatchtowerCoverageGrid(workspace = createBillingWatchtowerWorkspace()) {
