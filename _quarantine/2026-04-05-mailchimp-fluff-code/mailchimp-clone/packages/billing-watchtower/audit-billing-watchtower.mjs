...
export function createBillingWatchtowerAuditTrail() {
...
export function createBillingWatchtowerEvidenceManifest() {
...
export function createBillingWatchtowerReadinessAttestation() {
  const auditTrail = createBillingWatchtowerAuditTrail();
  return {
