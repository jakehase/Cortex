...
export function createCreativeLedgerReportCards() {
...
export function createCreativeLedgerReviewPackets() {
...
export function summarizeCreativeLedgerReporting() {
  const cards = createCreativeLedgerReportCards();
  const packets = createCreativeLedgerReviewPackets();
  return {
