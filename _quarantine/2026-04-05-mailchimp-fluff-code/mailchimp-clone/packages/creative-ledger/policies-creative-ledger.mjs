...
export function createCreativeLedgerPolicies(overrides = {}) {
...
export function validateCreativeLedgerPolicies(policies = createCreativeLedgerPolicies()) {
  const issues = [];
...
export function summarizeCreativeLedgerPolicies(policies = createCreativeLedgerPolicies()) {
  return {
...
export function createCreativeLedgerEscalationDeck(policies = createCreativeLedgerPolicies()) {
