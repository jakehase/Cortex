...
export function createCampaignExchangeReportCards() {
...
export function createCampaignExchangeReviewPackets() {
...
export function summarizeCampaignExchangeReporting() {
  const cards = createCampaignExchangeReportCards();
  const packets = createCampaignExchangeReviewPackets();
  return {
