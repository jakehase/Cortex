...
export function createCampaignExchangeOperationsBoard() {
...
export function createCampaignExchangeShiftChecklist() {
...
export function createCampaignExchangeIncidentDeck() {
