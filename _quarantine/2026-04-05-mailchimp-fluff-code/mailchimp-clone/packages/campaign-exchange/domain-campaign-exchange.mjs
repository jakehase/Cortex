...
export function createCampaignExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignExchangeWorkspace(workspace = createCampaignExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignExchangeNarratives(workspace = createCampaignExchangeWorkspace()) {
...
export function createCampaignExchangeCoverageGrid(workspace = createCampaignExchangeWorkspace()) {
