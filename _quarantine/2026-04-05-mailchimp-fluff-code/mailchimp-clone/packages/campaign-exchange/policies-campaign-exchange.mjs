...
export function createCampaignExchangePolicies(overrides = {}) {
...
export function validateCampaignExchangePolicies(policies = createCampaignExchangePolicies()) {
  const issues = [];
...
export function summarizeCampaignExchangePolicies(policies = createCampaignExchangePolicies()) {
  return {
...
export function createCampaignExchangeEscalationDeck(policies = createCampaignExchangePolicies()) {
