...
export function createCampaignExchangeAnalyticsTimeline() {
...
export function createCampaignExchangeForecastEnvelope() {
...
export function createCampaignExchangeExceptionLedger() {
...
export function summarizeCampaignExchangeAnalytics() {
  const timeline = createCampaignExchangeAnalyticsTimeline();
  const forecast = createCampaignExchangeForecastEnvelope();
  return {
