...
export function createBillingStudioAuditTrail() {
...
export function createBillingStudioEvidenceManifest() {
...
export function createBillingStudioReadinessAttestation() {
  const auditTrail = createBillingStudioAuditTrail();
  return {
