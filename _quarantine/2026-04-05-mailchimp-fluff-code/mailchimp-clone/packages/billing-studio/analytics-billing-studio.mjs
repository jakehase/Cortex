...
export function createBillingStudioAnalyticsTimeline() {
...
export function createBillingStudioForecastEnvelope() {
...
export function createBillingStudioExceptionLedger() {
...
export function summarizeBillingStudioAnalytics() {
  const timeline = createBillingStudioAnalyticsTimeline();
  const forecast = createBillingStudioForecastEnvelope();
  return {
