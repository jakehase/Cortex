...
export function createCreativeWorkbenchFixtures() {
  return {
    accounts: [
...
export function summarizeCreativeWorkbenchFixtures(fixtures = createCreativeWorkbenchFixtures()) {
  return {
...
export function createCreativeWorkbenchDemoInputs() {
  return {
