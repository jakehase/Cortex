...
export function createCreativeWorkbenchAuditTrail() {
...
export function createCreativeWorkbenchEvidenceManifest() {
...
export function createCreativeWorkbenchReadinessAttestation() {
  const auditTrail = createCreativeWorkbenchAuditTrail();
  return {
