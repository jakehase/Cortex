...
export function createCreativeWorkbenchReportCards() {
...
export function createCreativeWorkbenchReviewPackets() {
...
export function summarizeCreativeWorkbenchReporting() {
  const cards = createCreativeWorkbenchReportCards();
  const packets = createCreativeWorkbenchReviewPackets();
  return {
