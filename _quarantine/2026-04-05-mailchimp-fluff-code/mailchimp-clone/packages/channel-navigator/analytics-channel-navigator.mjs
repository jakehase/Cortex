...
export function createChannelNavigatorAnalyticsTimeline() {
...
export function createChannelNavigatorForecastEnvelope() {
...
export function createChannelNavigatorExceptionLedger() {
...
export function summarizeChannelNavigatorAnalytics() {
  const timeline = createChannelNavigatorAnalyticsTimeline();
  const forecast = createChannelNavigatorForecastEnvelope();
  return {
