...
export function createChannelNavigatorPolicies(overrides = {}) {
...
export function validateChannelNavigatorPolicies(policies = createChannelNavigatorPolicies()) {
  const issues = [];
...
export function summarizeChannelNavigatorPolicies(policies = createChannelNavigatorPolicies()) {
  return {
...
export function createChannelNavigatorEscalationDeck(policies = createChannelNavigatorPolicies()) {
