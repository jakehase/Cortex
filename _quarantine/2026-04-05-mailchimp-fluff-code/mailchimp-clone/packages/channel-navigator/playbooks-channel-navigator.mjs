...
export function createChannelNavigatorPlaybooks() {
...
export function createChannelNavigatorDecisionDeck() {
...
export function createChannelNavigatorEscalationMoments() {
