...
export function createChannelNavigatorOperationsBoard() {
...
export function createChannelNavigatorShiftChecklist() {
...
export function createChannelNavigatorIncidentDeck() {
