...
export function createIntegrationsLedgerReportCards() {
...
export function createIntegrationsLedgerReviewPackets() {
...
export function summarizeIntegrationsLedgerReporting() {
  const cards = createIntegrationsLedgerReportCards();
  const packets = createIntegrationsLedgerReviewPackets();
  return {
