...
export function createIntegrationsLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsLedgerWorkspace(workspace = createIntegrationsLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsLedgerNarratives(workspace = createIntegrationsLedgerWorkspace()) {
...
export function createIntegrationsLedgerCoverageGrid(workspace = createIntegrationsLedgerWorkspace()) {
