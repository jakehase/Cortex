...
export function createIntegrationsLedgerAuditTrail() {
...
export function createIntegrationsLedgerEvidenceManifest() {
...
export function createIntegrationsLedgerReadinessAttestation() {
  const auditTrail = createIntegrationsLedgerAuditTrail();
  return {
