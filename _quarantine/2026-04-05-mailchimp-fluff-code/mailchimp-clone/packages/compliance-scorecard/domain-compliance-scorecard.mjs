...
export function createComplianceScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeComplianceScorecardWorkspace(workspace = createComplianceScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createComplianceScorecardNarratives(workspace = createComplianceScorecardWorkspace()) {
...
export function createComplianceScorecardCoverageGrid(workspace = createComplianceScorecardWorkspace()) {
