...
export function createComplianceScorecardPolicies(overrides = {}) {
...
export function validateComplianceScorecardPolicies(policies = createComplianceScorecardPolicies()) {
  const issues = [];
...
export function summarizeComplianceScorecardPolicies(policies = createComplianceScorecardPolicies()) {
  return {
...
export function createComplianceScorecardEscalationDeck(policies = createComplianceScorecardPolicies()) {
