...
export function createComplianceScorecardOperationsBoard() {
...
export function createComplianceScorecardShiftChecklist() {
...
export function createComplianceScorecardIncidentDeck() {
