...
export function createDataWorkbenchAuditTrail() {
...
export function createDataWorkbenchEvidenceManifest() {
...
export function createDataWorkbenchReadinessAttestation() {
  const auditTrail = createDataWorkbenchAuditTrail();
  return {
