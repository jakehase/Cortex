...
export function createDataWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataWorkbenchWorkspace(workspace = createDataWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataWorkbenchNarratives(workspace = createDataWorkbenchWorkspace()) {
...
export function createDataWorkbenchCoverageGrid(workspace = createDataWorkbenchWorkspace()) {
