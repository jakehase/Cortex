...
export function createCustomerWorkbenchFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerWorkbenchFixtures(fixtures = createCustomerWorkbenchFixtures()) {
  return {
...
export function createCustomerWorkbenchDemoInputs() {
  return {
