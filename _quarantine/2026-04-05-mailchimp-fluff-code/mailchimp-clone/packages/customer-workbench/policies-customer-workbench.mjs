...
export function createCustomerWorkbenchPolicies(overrides = {}) {
...
export function validateCustomerWorkbenchPolicies(policies = createCustomerWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeCustomerWorkbenchPolicies(policies = createCustomerWorkbenchPolicies()) {
  return {
...
export function createCustomerWorkbenchEscalationDeck(policies = createCustomerWorkbenchPolicies()) {
