...
export function createCustomerWorkbenchOperationsBoard() {
...
export function createCustomerWorkbenchShiftChecklist() {
...
export function createCustomerWorkbenchIncidentDeck() {
