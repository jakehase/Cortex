...
export function createCommerceVaultWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCommerceVaultWorkspace(workspace = createCommerceVaultWorkspace()) {
  return {
    id: workspace.id,
...
export function createCommerceVaultNarratives(workspace = createCommerceVaultWorkspace()) {
...
export function createCommerceVaultCoverageGrid(workspace = createCommerceVaultWorkspace()) {
