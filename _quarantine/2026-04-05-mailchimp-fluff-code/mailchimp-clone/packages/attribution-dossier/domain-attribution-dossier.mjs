...
export function createAttributionDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAttributionDossierWorkspace(workspace = createAttributionDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createAttributionDossierNarratives(workspace = createAttributionDossierWorkspace()) {
...
export function createAttributionDossierCoverageGrid(workspace = createAttributionDossierWorkspace()) {
