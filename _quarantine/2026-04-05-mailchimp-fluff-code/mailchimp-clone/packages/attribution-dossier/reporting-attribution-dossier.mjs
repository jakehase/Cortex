...
export function createAttributionDossierReportCards() {
...
export function createAttributionDossierReviewPackets() {
...
export function summarizeAttributionDossierReporting() {
  const cards = createAttributionDossierReportCards();
  const packets = createAttributionDossierReviewPackets();
  return {
