...
export function createAcquisitionIndexOperationsBoard() {
...
export function createAcquisitionIndexShiftChecklist() {
...
export function createAcquisitionIndexIncidentDeck() {
