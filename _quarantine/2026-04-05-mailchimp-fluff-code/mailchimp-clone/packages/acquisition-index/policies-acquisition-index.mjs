...
export function createAcquisitionIndexPolicies(overrides = {}) {
...
export function validateAcquisitionIndexPolicies(policies = createAcquisitionIndexPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionIndexPolicies(policies = createAcquisitionIndexPolicies()) {
  return {
...
export function createAcquisitionIndexEscalationDeck(policies = createAcquisitionIndexPolicies()) {
