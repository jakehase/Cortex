...
export function createAcquisitionIndexPlaybooks() {
...
export function createAcquisitionIndexDecisionDeck() {
...
export function createAcquisitionIndexEscalationMoments() {
