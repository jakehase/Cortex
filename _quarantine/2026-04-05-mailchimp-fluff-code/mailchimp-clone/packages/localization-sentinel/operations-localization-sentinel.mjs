...
export function createLocalizationSentinelOperationsBoard() {
...
export function createLocalizationSentinelShiftChecklist() {
...
export function createLocalizationSentinelIncidentDeck() {
