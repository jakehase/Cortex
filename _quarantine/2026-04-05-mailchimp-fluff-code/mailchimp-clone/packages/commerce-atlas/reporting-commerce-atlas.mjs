...
export function createCommerceAtlasReportCards() {
...
export function createCommerceAtlasReviewPackets() {
...
export function summarizeCommerceAtlasReporting() {
  const cards = createCommerceAtlasReportCards();
  const packets = createCommerceAtlasReviewPackets();
  return {
