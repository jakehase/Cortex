...
export function createLifecycleSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleSentinelWorkspace(workspace = createLifecycleSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleSentinelNarratives(workspace = createLifecycleSentinelWorkspace()) {
...
export function createLifecycleSentinelCoverageGrid(workspace = createLifecycleSentinelWorkspace()) {
