...
export function createLifecycleSentinelPolicies(overrides = {}) {
...
export function validateLifecycleSentinelPolicies(policies = createLifecycleSentinelPolicies()) {
  const issues = [];
...
export function summarizeLifecycleSentinelPolicies(policies = createLifecycleSentinelPolicies()) {
  return {
...
export function createLifecycleSentinelEscalationDeck(policies = createLifecycleSentinelPolicies()) {
