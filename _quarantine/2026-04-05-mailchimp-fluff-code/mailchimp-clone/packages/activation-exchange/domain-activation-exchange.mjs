const MODULE = {
  "id": "activation-exchange",
  "ordinal": 26,
  "domain": "activation",
  "surfaceId": "exchange",
  "surfaceTitle": "Exchange",
  "routeSegment": "exchange",
  "title": "Activation Exchange",
  "focus": "Activation Exchange covers onboarding readiness, first-value motion, and kickoff momentum through handoff workflows and partner coordination.",
  ...
  "tags": [
    ...
    "exchange",
    "growth",
    "activation-exchange-wave-seven"
  ]
};
...
export function createActivationExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationExchangeWorkspace(workspace = createActivationExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationExchangeNarratives(workspace = createActivationExchangeWorkspace()) {
...
export function createActivationExchangeCoverageGrid(workspace = createActivationExchangeWorkspace()) {
