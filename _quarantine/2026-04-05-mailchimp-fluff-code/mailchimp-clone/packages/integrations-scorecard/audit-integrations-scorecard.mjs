...
export function createIntegrationsScorecardAuditTrail() {
...
export function createIntegrationsScorecardEvidenceManifest() {
...
export function createIntegrationsScorecardReadinessAttestation() {
  const auditTrail = createIntegrationsScorecardAuditTrail();
  return {
