...
export function createIntegrationsScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsScorecardWorkspace(workspace = createIntegrationsScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsScorecardNarratives(workspace = createIntegrationsScorecardWorkspace()) {
...
export function createIntegrationsScorecardCoverageGrid(workspace = createIntegrationsScorecardWorkspace()) {
