...
export function createConsentExchangePolicies(overrides = {}) {
...
export function validateConsentExchangePolicies(policies = createConsentExchangePolicies()) {
  const issues = [];
...
export function summarizeConsentExchangePolicies(policies = createConsentExchangePolicies()) {
  return {
...
export function createConsentExchangeEscalationDeck(policies = createConsentExchangePolicies()) {
