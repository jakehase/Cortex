...
export function createLocalizationDossierPolicies(overrides = {}) {
...
export function validateLocalizationDossierPolicies(policies = createLocalizationDossierPolicies()) {
  const issues = [];
...
export function summarizeLocalizationDossierPolicies(policies = createLocalizationDossierPolicies()) {
  return {
...
export function createLocalizationDossierEscalationDeck(policies = createLocalizationDossierPolicies()) {
