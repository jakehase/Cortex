...
export function createLocalizationDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationDossierWorkspace(workspace = createLocalizationDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationDossierNarratives(workspace = createLocalizationDossierWorkspace()) {
...
export function createLocalizationDossierCoverageGrid(workspace = createLocalizationDossierWorkspace()) {
