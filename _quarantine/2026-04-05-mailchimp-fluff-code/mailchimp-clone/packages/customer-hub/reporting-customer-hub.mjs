...
export function createCustomerHubReportCards() {
...
export function createCustomerHubReviewPackets() {
...
export function summarizeCustomerHubReporting() {
  const cards = createCustomerHubReportCards();
  const packets = createCustomerHubReviewPackets();
  return {
