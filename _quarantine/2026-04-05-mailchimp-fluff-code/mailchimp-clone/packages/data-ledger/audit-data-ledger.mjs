...
export function createDataLedgerAuditTrail() {
...
export function createDataLedgerEvidenceManifest() {
...
export function createDataLedgerReadinessAttestation() {
  const auditTrail = createDataLedgerAuditTrail();
  return {
