const MODULE = {
  ...
  "routeSegment": "ledger",
  "title": "Data Ledger",
  "focus": "Data Ledger covers pipeline health, lineage, freshness, and operator trust in data assets through audit history and change accountability.",
...
export function createDataLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataLedgerWorkspace(workspace = createDataLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataLedgerNarratives(workspace = createDataLedgerWorkspace()) {
...
export function createDataLedgerCoverageGrid(workspace = createDataLedgerWorkspace()) {
