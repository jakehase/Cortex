...
export function createIntegrationsIndexAnalyticsTimeline() {
...
export function createIntegrationsIndexForecastEnvelope() {
...
export function createIntegrationsIndexExceptionLedger() {
...
export function summarizeIntegrationsIndexAnalytics() {
  const timeline = createIntegrationsIndexAnalyticsTimeline();
  const forecast = createIntegrationsIndexForecastEnvelope();
  return {
