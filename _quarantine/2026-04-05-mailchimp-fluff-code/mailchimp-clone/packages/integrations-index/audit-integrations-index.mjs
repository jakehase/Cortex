...
export function createIntegrationsIndexAuditTrail() {
...
export function createIntegrationsIndexEvidenceManifest() {
...
export function createIntegrationsIndexReadinessAttestation() {
  const auditTrail = createIntegrationsIndexAuditTrail();
  return {
