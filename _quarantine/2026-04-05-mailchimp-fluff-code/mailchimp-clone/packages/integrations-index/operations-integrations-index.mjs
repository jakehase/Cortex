...
export function createIntegrationsIndexOperationsBoard() {
...
export function createIntegrationsIndexShiftChecklist() {
...
export function createIntegrationsIndexIncidentDeck() {
