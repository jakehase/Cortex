...
export function createAcquisitionWorkbenchPolicies(overrides = {}) {
...
export function validateAcquisitionWorkbenchPolicies(policies = createAcquisitionWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionWorkbenchPolicies(policies = createAcquisitionWorkbenchPolicies()) {
  return {
...
export function createAcquisitionWorkbenchEscalationDeck(policies = createAcquisitionWorkbenchPolicies()) {
