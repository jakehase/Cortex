...
export function createAcquisitionWorkbenchAuditTrail() {
...
export function createAcquisitionWorkbenchEvidenceManifest() {
...
export function createAcquisitionWorkbenchReadinessAttestation() {
  const auditTrail = createAcquisitionWorkbenchAuditTrail();
  return {
