...
export function createAcquisitionWorkbenchOperationsBoard() {
...
export function createAcquisitionWorkbenchShiftChecklist() {
...
export function createAcquisitionWorkbenchIncidentDeck() {
