...
export function createBillingAdvisorAnalyticsTimeline() {
...
export function createBillingAdvisorForecastEnvelope() {
...
export function createBillingAdvisorExceptionLedger() {
...
export function summarizeBillingAdvisorAnalytics() {
  const timeline = createBillingAdvisorAnalyticsTimeline();
  const forecast = createBillingAdvisorForecastEnvelope();
  return {
