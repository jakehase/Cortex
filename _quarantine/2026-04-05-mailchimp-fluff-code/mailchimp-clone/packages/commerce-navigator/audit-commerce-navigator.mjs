...
export function createCommerceNavigatorAuditTrail() {
...
export function createCommerceNavigatorEvidenceManifest() {
...
export function createCommerceNavigatorReadinessAttestation() {
  const auditTrail = createCommerceNavigatorAuditTrail();
  return {
