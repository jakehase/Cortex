...
export function createAudienceConsoleReportCards() {
...
export function createAudienceConsoleReviewPackets() {
...
export function summarizeAudienceConsoleReporting() {
  const cards = createAudienceConsoleReportCards();
  const packets = createAudienceConsoleReviewPackets();
  return {
