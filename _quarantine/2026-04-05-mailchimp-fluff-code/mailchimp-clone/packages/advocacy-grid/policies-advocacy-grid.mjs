...
export function createAdvocacyGridPolicies(overrides = {}) {
...
export function validateAdvocacyGridPolicies(policies = createAdvocacyGridPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyGridPolicies(policies = createAdvocacyGridPolicies()) {
  return {
...
export function createAdvocacyGridEscalationDeck(policies = createAdvocacyGridPolicies()) {
