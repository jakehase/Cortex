...
export function createCustomerNotebookPolicies(overrides = {}) {
...
export function validateCustomerNotebookPolicies(policies = createCustomerNotebookPolicies()) {
  const issues = [];
...
export function summarizeCustomerNotebookPolicies(policies = createCustomerNotebookPolicies()) {
  return {
...
export function createCustomerNotebookEscalationDeck(policies = createCustomerNotebookPolicies()) {
