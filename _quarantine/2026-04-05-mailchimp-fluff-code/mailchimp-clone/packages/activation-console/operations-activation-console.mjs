...
export function createActivationConsoleOperationsBoard() {
...
export function createActivationConsoleShiftChecklist() {
...
export function createActivationConsoleIncidentDeck() {
