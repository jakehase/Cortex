...
export function createActivationConsoleAuditTrail() {
...
export function createActivationConsoleEvidenceManifest() {
...
export function createActivationConsoleReadinessAttestation() {
  const auditTrail = createActivationConsoleAuditTrail();
  return {
