...
export function createActivationConsoleReportCards() {
...
export function createActivationConsoleReviewPackets() {
...
export function summarizeActivationConsoleReporting() {
  const cards = createActivationConsoleReportCards();
  const packets = createActivationConsoleReviewPackets();
  return {
