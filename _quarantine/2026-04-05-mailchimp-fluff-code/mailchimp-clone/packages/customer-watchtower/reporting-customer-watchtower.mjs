...
export function createCustomerWatchtowerReportCards() {
...
export function createCustomerWatchtowerReviewPackets() {
...
export function summarizeCustomerWatchtowerReporting() {
  const cards = createCustomerWatchtowerReportCards();
  const packets = createCustomerWatchtowerReviewPackets();
  return {
