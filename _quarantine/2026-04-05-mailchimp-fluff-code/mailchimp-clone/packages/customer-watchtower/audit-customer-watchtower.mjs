...
export function createCustomerWatchtowerAuditTrail() {
...
export function createCustomerWatchtowerEvidenceManifest() {
...
export function createCustomerWatchtowerReadinessAttestation() {
  const auditTrail = createCustomerWatchtowerAuditTrail();
  return {
