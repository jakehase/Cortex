...
export function createCustomerConsoleOperationsBoard() {
...
export function createCustomerConsoleShiftChecklist() {
...
export function createCustomerConsoleIncidentDeck() {
