...
export function createActivationCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationCockpitWorkspace(workspace = createActivationCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationCockpitNarratives(workspace = createActivationCockpitWorkspace()) {
...
export function createActivationCockpitCoverageGrid(workspace = createActivationCockpitWorkspace()) {
