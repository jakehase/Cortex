...
export function createActivationCockpitPolicies(overrides = {}) {
...
export function validateActivationCockpitPolicies(policies = createActivationCockpitPolicies()) {
  const issues = [];
...
export function summarizeActivationCockpitPolicies(policies = createActivationCockpitPolicies()) {
  return {
...
export function createActivationCockpitEscalationDeck(policies = createActivationCockpitPolicies()) {
