...
export function createActivationCockpitPlaybooks() {
...
export function createActivationCockpitDecisionDeck() {
...
export function createActivationCockpitEscalationMoments() {
