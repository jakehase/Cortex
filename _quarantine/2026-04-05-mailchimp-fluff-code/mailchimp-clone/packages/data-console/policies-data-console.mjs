...
export function createDataConsolePolicies(overrides = {}) {
...
export function validateDataConsolePolicies(policies = createDataConsolePolicies()) {
  const issues = [];
...
export function summarizeDataConsolePolicies(policies = createDataConsolePolicies()) {
  return {
...
export function createDataConsoleEscalationDeck(policies = createDataConsolePolicies()) {
