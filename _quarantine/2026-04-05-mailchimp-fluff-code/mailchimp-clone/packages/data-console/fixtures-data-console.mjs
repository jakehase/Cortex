...
export function createDataConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeDataConsoleFixtures(fixtures = createDataConsoleFixtures()) {
  return {
...
export function createDataConsoleDemoInputs() {
  return {
