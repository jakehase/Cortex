...
export function createDataConsoleAnalyticsTimeline() {
...
export function createDataConsoleForecastEnvelope() {
...
export function createDataConsoleExceptionLedger() {
...
export function summarizeDataConsoleAnalytics() {
  const timeline = createDataConsoleAnalyticsTimeline();
  const forecast = createDataConsoleForecastEnvelope();
  return {
