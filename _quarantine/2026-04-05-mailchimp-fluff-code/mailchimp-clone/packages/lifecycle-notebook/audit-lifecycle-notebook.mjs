...
export function createLifecycleNotebookAuditTrail() {
...
export function createLifecycleNotebookEvidenceManifest() {
...
export function createLifecycleNotebookReadinessAttestation() {
  const auditTrail = createLifecycleNotebookAuditTrail();
  return {
