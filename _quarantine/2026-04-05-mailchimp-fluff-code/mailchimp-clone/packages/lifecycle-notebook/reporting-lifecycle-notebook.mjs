...
export function createLifecycleNotebookReportCards() {
...
export function createLifecycleNotebookReviewPackets() {
...
export function summarizeLifecycleNotebookReporting() {
  const cards = createLifecycleNotebookReportCards();
  const packets = createLifecycleNotebookReviewPackets();
  return {
