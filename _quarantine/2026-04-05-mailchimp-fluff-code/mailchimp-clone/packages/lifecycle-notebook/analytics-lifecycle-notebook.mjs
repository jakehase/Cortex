...
export function createLifecycleNotebookAnalyticsTimeline() {
...
export function createLifecycleNotebookForecastEnvelope() {
...
export function createLifecycleNotebookExceptionLedger() {
...
export function summarizeLifecycleNotebookAnalytics() {
  const timeline = createLifecycleNotebookAnalyticsTimeline();
  const forecast = createLifecycleNotebookForecastEnvelope();
  return {
