...
export function createLifecycleNotebookOperationsBoard() {
...
export function createLifecycleNotebookShiftChecklist() {
...
export function createLifecycleNotebookIncidentDeck() {
