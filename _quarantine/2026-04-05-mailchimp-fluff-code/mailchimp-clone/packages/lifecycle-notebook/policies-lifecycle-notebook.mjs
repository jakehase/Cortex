...
export function createLifecycleNotebookPolicies(overrides = {}) {
...
export function validateLifecycleNotebookPolicies(policies = createLifecycleNotebookPolicies()) {
  const issues = [];
...
export function summarizeLifecycleNotebookPolicies(policies = createLifecycleNotebookPolicies()) {
  return {
...
export function createLifecycleNotebookEscalationDeck(policies = createLifecycleNotebookPolicies()) {
