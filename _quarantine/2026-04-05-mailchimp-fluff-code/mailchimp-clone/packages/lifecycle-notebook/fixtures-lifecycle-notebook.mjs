...
export function createLifecycleNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeLifecycleNotebookFixtures(fixtures = createLifecycleNotebookFixtures()) {
  return {
...
export function createLifecycleNotebookDemoInputs() {
  return {
