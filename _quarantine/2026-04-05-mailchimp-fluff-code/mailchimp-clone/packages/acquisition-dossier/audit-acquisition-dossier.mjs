...
export function createAcquisitionDossierAuditTrail() {
...
export function createAcquisitionDossierEvidenceManifest() {
...
export function createAcquisitionDossierReadinessAttestation() {
  const auditTrail = createAcquisitionDossierAuditTrail();
  return {
