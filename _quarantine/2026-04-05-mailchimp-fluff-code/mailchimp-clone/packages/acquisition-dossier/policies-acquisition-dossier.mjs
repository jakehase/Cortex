...
export function createAcquisitionDossierPolicies(overrides = {}) {
...
export function validateAcquisitionDossierPolicies(policies = createAcquisitionDossierPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionDossierPolicies(policies = createAcquisitionDossierPolicies()) {
  return {
...
export function createAcquisitionDossierEscalationDeck(policies = createAcquisitionDossierPolicies()) {
