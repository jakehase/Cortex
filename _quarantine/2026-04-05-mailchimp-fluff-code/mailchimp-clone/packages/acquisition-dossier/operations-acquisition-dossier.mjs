...
export function createAcquisitionDossierOperationsBoard() {
...
export function createAcquisitionDossierShiftChecklist() {
...
export function createAcquisitionDossierIncidentDeck() {
