...
export function createBillingConsolePolicies(overrides = {}) {
...
export function validateBillingConsolePolicies(policies = createBillingConsolePolicies()) {
  const issues = [];
...
export function summarizeBillingConsolePolicies(policies = createBillingConsolePolicies()) {
  return {
...
export function createBillingConsoleEscalationDeck(policies = createBillingConsolePolicies()) {
