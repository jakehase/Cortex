...
export function createBillingConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeBillingConsoleFixtures(fixtures = createBillingConsoleFixtures()) {
  return {
...
export function createBillingConsoleDemoInputs() {
  return {
