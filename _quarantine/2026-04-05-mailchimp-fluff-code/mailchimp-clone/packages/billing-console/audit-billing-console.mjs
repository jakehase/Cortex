...
export function createBillingConsoleAuditTrail() {
...
export function createBillingConsoleEvidenceManifest() {
...
export function createBillingConsoleReadinessAttestation() {
  const auditTrail = createBillingConsoleAuditTrail();
  return {
