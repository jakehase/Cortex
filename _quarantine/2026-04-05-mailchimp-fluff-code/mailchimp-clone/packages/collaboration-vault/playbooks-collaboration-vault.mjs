...
export function createCollaborationVaultPlaybooks() {
...
export function createCollaborationVaultDecisionDeck() {
...
export function createCollaborationVaultEscalationMoments() {
