...
export function createCollaborationVaultPolicies(overrides = {}) {
...
export function validateCollaborationVaultPolicies(policies = createCollaborationVaultPolicies()) {
  const issues = [];
...
export function summarizeCollaborationVaultPolicies(policies = createCollaborationVaultPolicies()) {
  return {
...
export function createCollaborationVaultEscalationDeck(policies = createCollaborationVaultPolicies()) {
