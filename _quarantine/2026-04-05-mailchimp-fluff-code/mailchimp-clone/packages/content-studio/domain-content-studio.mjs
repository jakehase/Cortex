const MODULE = {
  ...
  "focus": "Content Studio covers content operations, packaging, and channel-specific delivery shape through operator-facing creative and configuration tools.",
...
export function createContentStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentStudioWorkspace(workspace = createContentStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentStudioNarratives(workspace = createContentStudioWorkspace()) {
...
export function createContentStudioCoverageGrid(workspace = createContentStudioWorkspace()) {
