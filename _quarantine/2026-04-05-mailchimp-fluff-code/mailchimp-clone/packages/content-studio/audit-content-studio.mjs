...
export function createContentStudioAuditTrail() {
...
export function createContentStudioEvidenceManifest() {
...
export function createContentStudioReadinessAttestation() {
  const auditTrail = createContentStudioAuditTrail();
  return {
