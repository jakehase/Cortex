...
export function createBenchmarkNotebookAuditTrail() {
...
export function createBenchmarkNotebookEvidenceManifest() {
...
export function createBenchmarkNotebookReadinessAttestation() {
  const auditTrail = createBenchmarkNotebookAuditTrail();
  return {
