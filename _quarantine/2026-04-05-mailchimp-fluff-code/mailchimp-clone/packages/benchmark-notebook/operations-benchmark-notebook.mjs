...
export function createBenchmarkNotebookOperationsBoard() {
...
export function createBenchmarkNotebookShiftChecklist() {
...
export function createBenchmarkNotebookIncidentDeck() {
