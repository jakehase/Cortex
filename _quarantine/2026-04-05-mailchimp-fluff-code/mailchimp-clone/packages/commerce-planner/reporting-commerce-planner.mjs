...
export function createCommercePlannerReportCards() {
...
export function createCommercePlannerReviewPackets() {
...
export function summarizeCommercePlannerReporting() {
  const cards = createCommercePlannerReportCards();
  const packets = createCommercePlannerReviewPackets();
  return {
