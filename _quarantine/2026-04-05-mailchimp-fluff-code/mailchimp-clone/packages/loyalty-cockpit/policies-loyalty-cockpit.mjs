...
export function createLoyaltyCockpitPolicies(overrides = {}) {
...
export function validateLoyaltyCockpitPolicies(policies = createLoyaltyCockpitPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyCockpitPolicies(policies = createLoyaltyCockpitPolicies()) {
  return {
...
export function createLoyaltyCockpitEscalationDeck(policies = createLoyaltyCockpitPolicies()) {
