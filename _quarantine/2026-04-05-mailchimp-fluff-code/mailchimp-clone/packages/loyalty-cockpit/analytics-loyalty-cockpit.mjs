...
export function createLoyaltyCockpitAnalyticsTimeline() {
...
export function createLoyaltyCockpitForecastEnvelope() {
...
export function createLoyaltyCockpitExceptionLedger() {
...
export function summarizeLoyaltyCockpitAnalytics() {
  const timeline = createLoyaltyCockpitAnalyticsTimeline();
  const forecast = createLoyaltyCockpitForecastEnvelope();
  return {
