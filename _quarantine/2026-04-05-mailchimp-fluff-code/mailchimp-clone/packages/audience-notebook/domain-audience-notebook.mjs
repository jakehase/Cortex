const MODULE = {
  "id": "audience-notebook",
  "ordinal": 133,
  "domain": "audience",
  "surfaceId": "notebook",
  "surfaceTitle": "Notebook",
  "routeSegment": "notebook",
  "title": "Audience Notebook",
  "focus": "Audience Notebook covers audience health, segment design, and targeting durability through working notes and experiment memory.",
...
export function createAudienceNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceNotebookWorkspace(workspace = createAudienceNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceNotebookNarratives(workspace = createAudienceNotebookWorkspace()) {
...
export function createAudienceNotebookCoverageGrid(workspace = createAudienceNotebookWorkspace()) {
