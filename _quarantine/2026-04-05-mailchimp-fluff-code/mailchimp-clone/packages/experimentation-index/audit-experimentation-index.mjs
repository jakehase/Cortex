...
export function createExperimentationIndexAuditTrail() {
...
export function createExperimentationIndexEvidenceManifest() {
...
export function createExperimentationIndexReadinessAttestation() {
  const auditTrail = createExperimentationIndexAuditTrail();
  return {
