...
export function createExperimentationIndexAnalyticsTimeline() {
...
export function createExperimentationIndexForecastEnvelope() {
...
export function createExperimentationIndexExceptionLedger() {
...
export function summarizeExperimentationIndexAnalytics() {
  const timeline = createExperimentationIndexAnalyticsTimeline();
  const forecast = createExperimentationIndexForecastEnvelope();
  return {
