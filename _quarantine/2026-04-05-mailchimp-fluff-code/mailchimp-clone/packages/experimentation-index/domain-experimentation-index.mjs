...
export function createExperimentationIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationIndexWorkspace(workspace = createExperimentationIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationIndexNarratives(workspace = createExperimentationIndexWorkspace()) {
...
export function createExperimentationIndexCoverageGrid(workspace = createExperimentationIndexWorkspace()) {
