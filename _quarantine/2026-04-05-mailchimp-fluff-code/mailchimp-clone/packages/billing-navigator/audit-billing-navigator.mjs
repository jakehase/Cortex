...
export function createBillingNavigatorAuditTrail() {
...
export function createBillingNavigatorEvidenceManifest() {
...
export function createBillingNavigatorReadinessAttestation() {
  const auditTrail = createBillingNavigatorAuditTrail();
  return {
