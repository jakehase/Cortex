...
export function createBillingNavigatorReportCards() {
...
export function createBillingNavigatorReviewPackets() {
...
export function summarizeBillingNavigatorReporting() {
  const cards = createBillingNavigatorReportCards();
  const packets = createBillingNavigatorReviewPackets();
  return {
