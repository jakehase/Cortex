...
export function createBillingNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingNavigatorWorkspace(workspace = createBillingNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingNavigatorNarratives(workspace = createBillingNavigatorWorkspace()) {
...
export function createBillingNavigatorCoverageGrid(workspace = createBillingNavigatorWorkspace()) {
