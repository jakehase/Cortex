...
export function createBillingNavigatorAnalyticsTimeline() {
...
export function createBillingNavigatorForecastEnvelope() {
...
export function createBillingNavigatorExceptionLedger() {
...
export function summarizeBillingNavigatorAnalytics() {
  const timeline = createBillingNavigatorAnalyticsTimeline();
  const forecast = createBillingNavigatorForecastEnvelope();
  return {
