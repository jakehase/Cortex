...
export function createAudienceWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceWorkbenchWorkspace(workspace = createAudienceWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceWorkbenchNarratives(workspace = createAudienceWorkbenchWorkspace()) {
...
export function createAudienceWorkbenchCoverageGrid(workspace = createAudienceWorkbenchWorkspace()) {
