...
export function createLifecycleConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeLifecycleConsoleFixtures(fixtures = createLifecycleConsoleFixtures()) {
  return {
...
export function createLifecycleConsoleDemoInputs() {
  return {
