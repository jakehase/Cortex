...
export function createLifecycleConsolePolicies(overrides = {}) {
...
export function validateLifecycleConsolePolicies(policies = createLifecycleConsolePolicies()) {
  const issues = [];
...
export function summarizeLifecycleConsolePolicies(policies = createLifecycleConsolePolicies()) {
  return {
...
export function createLifecycleConsoleEscalationDeck(policies = createLifecycleConsolePolicies()) {
