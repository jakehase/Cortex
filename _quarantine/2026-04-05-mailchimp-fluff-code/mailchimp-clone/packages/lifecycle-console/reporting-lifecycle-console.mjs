...
export function createLifecycleConsoleReportCards() {
...
export function createLifecycleConsoleReviewPackets() {
...
export function summarizeLifecycleConsoleReporting() {
  const cards = createLifecycleConsoleReportCards();
  const packets = createLifecycleConsoleReviewPackets();
  return {
