...
export function createLifecycleConsoleAuditTrail() {
...
export function createLifecycleConsoleEvidenceManifest() {
...
export function createLifecycleConsoleReadinessAttestation() {
  const auditTrail = createLifecycleConsoleAuditTrail();
  return {
