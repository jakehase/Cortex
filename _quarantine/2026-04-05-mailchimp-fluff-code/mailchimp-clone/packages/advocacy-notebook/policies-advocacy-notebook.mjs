...
export function createAdvocacyNotebookPolicies(overrides = {}) {
...
export function validateAdvocacyNotebookPolicies(policies = createAdvocacyNotebookPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyNotebookPolicies(policies = createAdvocacyNotebookPolicies()) {
  return {
...
export function createAdvocacyNotebookEscalationDeck(policies = createAdvocacyNotebookPolicies()) {
