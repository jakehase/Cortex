const MODULE = {
  "id": "advocacy-notebook",
  "ordinal": 53,
  "domain": "advocacy",
  "surfaceId": "notebook",
  "surfaceTitle": "Notebook",
  "routeSegment": "notebook",
  "title": "Advocacy Notebook",
  "focus": "Advocacy Notebook covers customer champions, referral readiness, and proof-sharing loops through working notes and experiment memory.",
...
export function createAdvocacyNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyNotebookWorkspace(workspace = createAdvocacyNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyNotebookNarratives(workspace = createAdvocacyNotebookWorkspace()) {
...
export function createAdvocacyNotebookCoverageGrid(workspace = createAdvocacyNotebookWorkspace()) {
