...
export function createAdvocacyNotebookOperationsBoard() {
...
export function createAdvocacyNotebookShiftChecklist() {
...
export function createAdvocacyNotebookIncidentDeck() {
