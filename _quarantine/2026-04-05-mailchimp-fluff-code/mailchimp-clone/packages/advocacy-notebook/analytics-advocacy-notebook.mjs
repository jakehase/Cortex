...
export function createAdvocacyNotebookAnalyticsTimeline() {
...
export function createAdvocacyNotebookForecastEnvelope() {
...
export function createAdvocacyNotebookExceptionLedger() {
...
export function summarizeAdvocacyNotebookAnalytics() {
  const timeline = createAdvocacyNotebookAnalyticsTimeline();
  const forecast = createAdvocacyNotebookForecastEnvelope();
  return {
