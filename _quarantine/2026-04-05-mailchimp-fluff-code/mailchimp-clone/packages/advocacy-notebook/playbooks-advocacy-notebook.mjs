...
export function createAdvocacyNotebookPlaybooks() {
...
export function createAdvocacyNotebookDecisionDeck() {
...
export function createAdvocacyNotebookEscalationMoments() {
