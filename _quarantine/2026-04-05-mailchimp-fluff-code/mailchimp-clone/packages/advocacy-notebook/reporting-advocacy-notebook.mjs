...
export function createAdvocacyNotebookReportCards() {
...
export function createAdvocacyNotebookReviewPackets() {
...
export function summarizeAdvocacyNotebookReporting() {
  const cards = createAdvocacyNotebookReportCards();
  const packets = createAdvocacyNotebookReviewPackets();
  return {
