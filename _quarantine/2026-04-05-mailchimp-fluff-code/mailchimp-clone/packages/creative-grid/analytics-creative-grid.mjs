...
export function createCreativeGridAnalyticsTimeline() {
...
export function createCreativeGridForecastEnvelope() {
...
export function createCreativeGridExceptionLedger() {
...
export function summarizeCreativeGridAnalytics() {
  const timeline = createCreativeGridAnalyticsTimeline();
  const forecast = createCreativeGridForecastEnvelope();
  return {
