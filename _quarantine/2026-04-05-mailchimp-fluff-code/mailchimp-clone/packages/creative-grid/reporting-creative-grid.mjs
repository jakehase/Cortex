...
export function createCreativeGridReportCards() {
...
export function createCreativeGridReviewPackets() {
...
export function summarizeCreativeGridReporting() {
  const cards = createCreativeGridReportCards();
  const packets = createCreativeGridReviewPackets();
  return {
