...
export function createCollaborationFoundryPlaybooks() {
...
export function createCollaborationFoundryDecisionDeck() {
...
export function createCollaborationFoundryEscalationMoments() {
