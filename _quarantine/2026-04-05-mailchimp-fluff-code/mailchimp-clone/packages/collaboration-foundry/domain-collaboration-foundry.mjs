...
export function createCollaborationFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationFoundryWorkspace(workspace = createCollaborationFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationFoundryNarratives(workspace = createCollaborationFoundryWorkspace()) {
...
export function createCollaborationFoundryCoverageGrid(workspace = createCollaborationFoundryWorkspace()) {
