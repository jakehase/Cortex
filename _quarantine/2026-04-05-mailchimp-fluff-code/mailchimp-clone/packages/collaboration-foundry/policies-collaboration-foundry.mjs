...
export function createCollaborationFoundryPolicies(overrides = {}) {
...
export function validateCollaborationFoundryPolicies(policies = createCollaborationFoundryPolicies()) {
  const issues = [];
...
export function summarizeCollaborationFoundryPolicies(policies = createCollaborationFoundryPolicies()) {
  return {
...
export function createCollaborationFoundryEscalationDeck(policies = createCollaborationFoundryPolicies()) {
