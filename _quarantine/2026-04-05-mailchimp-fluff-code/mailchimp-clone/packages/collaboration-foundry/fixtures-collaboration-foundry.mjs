...
export function createCollaborationFoundryFixtures() {
  return {
    accounts: [
...
export function summarizeCollaborationFoundryFixtures(fixtures = createCollaborationFoundryFixtures()) {
  return {
...
export function createCollaborationFoundryDemoInputs() {
  return {
