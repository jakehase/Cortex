...
export function createCollaborationFoundryOperationsBoard() {
...
export function createCollaborationFoundryShiftChecklist() {
...
export function createCollaborationFoundryIncidentDeck() {
