...
export function createCreativeNavigatorPolicies(overrides = {}) {
...
export function validateCreativeNavigatorPolicies(policies = createCreativeNavigatorPolicies()) {
  const issues = [];
...
export function summarizeCreativeNavigatorPolicies(policies = createCreativeNavigatorPolicies()) {
  return {
...
export function createCreativeNavigatorEscalationDeck(policies = createCreativeNavigatorPolicies()) {
