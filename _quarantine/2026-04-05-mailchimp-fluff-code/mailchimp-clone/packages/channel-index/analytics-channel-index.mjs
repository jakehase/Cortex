...
export function createChannelIndexAnalyticsTimeline() {
...
export function createChannelIndexForecastEnvelope() {
...
export function createChannelIndexExceptionLedger() {
...
export function summarizeChannelIndexAnalytics() {
  const timeline = createChannelIndexAnalyticsTimeline();
  const forecast = createChannelIndexForecastEnvelope();
  return {
