...
export function createCustomerStudioAuditTrail() {
...
export function createCustomerStudioEvidenceManifest() {
...
export function createCustomerStudioReadinessAttestation() {
  const auditTrail = createCustomerStudioAuditTrail();
  return {
