...
export function createCustomerStudioReportCards() {
...
export function createCustomerStudioReviewPackets() {
...
export function summarizeCustomerStudioReporting() {
  const cards = createCustomerStudioReportCards();
  const packets = createCustomerStudioReviewPackets();
  return {
