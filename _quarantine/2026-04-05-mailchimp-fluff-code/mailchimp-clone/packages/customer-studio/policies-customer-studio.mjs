...
export function createCustomerStudioPolicies(overrides = {}) {
...
export function validateCustomerStudioPolicies(policies = createCustomerStudioPolicies()) {
  const issues = [];
...
export function summarizeCustomerStudioPolicies(policies = createCustomerStudioPolicies()) {
  return {
...
export function createCustomerStudioEscalationDeck(policies = createCustomerStudioPolicies()) {
