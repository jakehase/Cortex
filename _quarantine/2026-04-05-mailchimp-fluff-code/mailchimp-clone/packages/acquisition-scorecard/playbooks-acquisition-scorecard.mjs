...
export function createAcquisitionScorecardPlaybooks() {
...
export function createAcquisitionScorecardDecisionDeck() {
...
export function createAcquisitionScorecardEscalationMoments() {
