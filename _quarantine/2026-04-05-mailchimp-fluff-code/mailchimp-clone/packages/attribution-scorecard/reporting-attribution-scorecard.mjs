...
export function createAttributionScorecardReportCards() {
...
export function createAttributionScorecardReviewPackets() {
...
export function summarizeAttributionScorecardReporting() {
  const cards = createAttributionScorecardReportCards();
  const packets = createAttributionScorecardReviewPackets();
  return {
