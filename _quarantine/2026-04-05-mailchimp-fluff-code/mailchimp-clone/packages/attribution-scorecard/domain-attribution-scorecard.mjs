...
export function createAttributionScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAttributionScorecardWorkspace(workspace = createAttributionScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createAttributionScorecardNarratives(workspace = createAttributionScorecardWorkspace()) {
...
export function createAttributionScorecardCoverageGrid(workspace = createAttributionScorecardWorkspace()) {
