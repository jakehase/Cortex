...
export function createAttributionScorecardOperationsBoard() {
...
export function createAttributionScorecardShiftChecklist() {
...
export function createAttributionScorecardIncidentDeck() {
