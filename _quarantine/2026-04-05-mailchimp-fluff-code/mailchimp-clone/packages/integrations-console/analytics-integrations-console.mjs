...
export function createIntegrationsConsoleAnalyticsTimeline() {
...
export function createIntegrationsConsoleForecastEnvelope() {
...
export function createIntegrationsConsoleExceptionLedger() {
...
export function summarizeIntegrationsConsoleAnalytics() {
  const timeline = createIntegrationsConsoleAnalyticsTimeline();
  const forecast = createIntegrationsConsoleForecastEnvelope();
  return {
