...
export function createIntegrationsConsoleReportCards() {
...
export function createIntegrationsConsoleReviewPackets() {
...
export function summarizeIntegrationsConsoleReporting() {
  const cards = createIntegrationsConsoleReportCards();
  const packets = createIntegrationsConsoleReviewPackets();
  return {
