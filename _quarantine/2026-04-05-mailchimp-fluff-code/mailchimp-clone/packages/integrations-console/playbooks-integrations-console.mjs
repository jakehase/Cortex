...
export function createIntegrationsConsolePlaybooks() {
...
export function createIntegrationsConsoleDecisionDeck() {
...
export function createIntegrationsConsoleEscalationMoments() {
