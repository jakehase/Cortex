...
export function createIntegrationsConsoleOperationsBoard() {
...
export function createIntegrationsConsoleShiftChecklist() {
...
export function createIntegrationsConsoleIncidentDeck() {
