...
export function createConsentCockpitPolicies(overrides = {}) {
...
export function validateConsentCockpitPolicies(policies = createConsentCockpitPolicies()) {
  const issues = [];
...
export function summarizeConsentCockpitPolicies(policies = createConsentCockpitPolicies()) {
  return {
...
export function createConsentCockpitEscalationDeck(policies = createConsentCockpitPolicies()) {
