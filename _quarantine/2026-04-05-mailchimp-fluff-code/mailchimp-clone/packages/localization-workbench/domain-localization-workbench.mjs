...
export function createLocalizationWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationWorkbenchWorkspace(workspace = createLocalizationWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationWorkbenchNarratives(workspace = createLocalizationWorkbenchWorkspace()) {
...
export function createLocalizationWorkbenchCoverageGrid(workspace = createLocalizationWorkbenchWorkspace()) {
