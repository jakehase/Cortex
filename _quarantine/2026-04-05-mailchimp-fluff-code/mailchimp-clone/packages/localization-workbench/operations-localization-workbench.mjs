...
export function createLocalizationWorkbenchOperationsBoard() {
...
export function createLocalizationWorkbenchShiftChecklist() {
...
export function createLocalizationWorkbenchIncidentDeck() {
