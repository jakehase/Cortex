...
export function createConsentVaultPolicies(overrides = {}) {
...
export function validateConsentVaultPolicies(policies = createConsentVaultPolicies()) {
  const issues = [];
...
export function summarizeConsentVaultPolicies(policies = createConsentVaultPolicies()) {
  return {
...
export function createConsentVaultEscalationDeck(policies = createConsentVaultPolicies()) {
