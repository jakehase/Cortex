...
export function createCampaignFoundryPolicies(overrides = {}) {
...
export function validateCampaignFoundryPolicies(policies = createCampaignFoundryPolicies()) {
  const issues = [];
...
export function summarizeCampaignFoundryPolicies(policies = createCampaignFoundryPolicies()) {
  return {
...
export function createCampaignFoundryEscalationDeck(policies = createCampaignFoundryPolicies()) {
