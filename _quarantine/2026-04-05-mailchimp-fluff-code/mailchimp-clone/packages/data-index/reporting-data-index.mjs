...
export function createDataIndexReportCards() {
...
export function createDataIndexReviewPackets() {
...
export function summarizeDataIndexReporting() {
  const cards = createDataIndexReportCards();
  const packets = createDataIndexReviewPackets();
  return {
