...
export function createDataIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataIndexWorkspace(workspace = createDataIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataIndexNarratives(workspace = createDataIndexWorkspace()) {
...
export function createDataIndexCoverageGrid(workspace = createDataIndexWorkspace()) {
