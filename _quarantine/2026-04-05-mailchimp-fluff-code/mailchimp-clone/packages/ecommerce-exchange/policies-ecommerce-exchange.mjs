...
export function createEcommerceExchangePolicies(overrides = {}) {
...
export function validateEcommerceExchangePolicies(policies = createEcommerceExchangePolicies()) {
  const issues = [];
...
export function summarizeEcommerceExchangePolicies(policies = createEcommerceExchangePolicies()) {
  return {
...
export function createEcommerceExchangeEscalationDeck(policies = createEcommerceExchangePolicies()) {
