...
export function createEcommerceExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceExchangeWorkspace(workspace = createEcommerceExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceExchangeNarratives(workspace = createEcommerceExchangeWorkspace()) {
...
export function createEcommerceExchangeCoverageGrid(workspace = createEcommerceExchangeWorkspace()) {
