...
export function createEcommerceExchangeAuditTrail() {
...
export function createEcommerceExchangeEvidenceManifest() {
...
export function createEcommerceExchangeReadinessAttestation() {
  const auditTrail = createEcommerceExchangeAuditTrail();
  return {
