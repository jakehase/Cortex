...
export function createAdvocacyPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyPlannerWorkspace(workspace = createAdvocacyPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyPlannerNarratives(workspace = createAdvocacyPlannerWorkspace()) {
...
export function createAdvocacyPlannerCoverageGrid(workspace = createAdvocacyPlannerWorkspace()) {
