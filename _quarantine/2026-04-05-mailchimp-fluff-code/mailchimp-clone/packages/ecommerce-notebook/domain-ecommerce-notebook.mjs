...
export function createEcommerceNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceNotebookWorkspace(workspace = createEcommerceNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceNotebookNarratives(workspace = createEcommerceNotebookWorkspace()) {
...
export function createEcommerceNotebookCoverageGrid(workspace = createEcommerceNotebookWorkspace()) {
