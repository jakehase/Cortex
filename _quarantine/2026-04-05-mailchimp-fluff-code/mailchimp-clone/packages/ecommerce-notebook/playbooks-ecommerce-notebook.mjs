...
export function createEcommerceNotebookPlaybooks() {
...
export function createEcommerceNotebookDecisionDeck() {
...
export function createEcommerceNotebookEscalationMoments() {
