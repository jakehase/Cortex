...
export function createInsightsNavigatorPlaybooks() {
...
export function createInsightsNavigatorDecisionDeck() {
...
export function createInsightsNavigatorEscalationMoments() {
