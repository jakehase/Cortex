...
export function createInsightsNavigatorReportCards() {
...
export function createInsightsNavigatorReviewPackets() {
...
export function summarizeInsightsNavigatorReporting() {
  const cards = createInsightsNavigatorReportCards();
  const packets = createInsightsNavigatorReviewPackets();
  return {
