...
export function createInsightsNavigatorFixtures() {
  return {
    accounts: [
...
export function summarizeInsightsNavigatorFixtures(fixtures = createInsightsNavigatorFixtures()) {
  return {
...
export function createInsightsNavigatorDemoInputs() {
  return {
