...
export function createConsentAdvisorPolicies(overrides = {}) {
...
export function validateConsentAdvisorPolicies(policies = createConsentAdvisorPolicies()) {
  const issues = [];
...
export function summarizeConsentAdvisorPolicies(policies = createConsentAdvisorPolicies()) {
  return {
...
export function createConsentAdvisorEscalationDeck(policies = createConsentAdvisorPolicies()) {
