...
export function createConsentAdvisorReportCards() {
...
export function createConsentAdvisorReviewPackets() {
...
export function summarizeConsentAdvisorReporting() {
  const cards = createConsentAdvisorReportCards();
  const packets = createConsentAdvisorReviewPackets();
  return {
