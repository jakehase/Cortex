...
export function createEcommerceNavigatorAuditTrail() {
...
export function createEcommerceNavigatorEvidenceManifest() {
...
export function createEcommerceNavigatorReadinessAttestation() {
  const auditTrail = createEcommerceNavigatorAuditTrail();
  return {
