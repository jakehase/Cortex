...
export function createEcommerceNavigatorReportCards() {
...
export function createEcommerceNavigatorReviewPackets() {
...
export function summarizeEcommerceNavigatorReporting() {
  const cards = createEcommerceNavigatorReportCards();
  const packets = createEcommerceNavigatorReviewPackets();
  return {
