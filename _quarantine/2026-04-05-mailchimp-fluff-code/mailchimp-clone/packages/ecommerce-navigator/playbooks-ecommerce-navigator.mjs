...
export function createEcommerceNavigatorPlaybooks() {
...
export function createEcommerceNavigatorDecisionDeck() {
...
export function createEcommerceNavigatorEscalationMoments() {
