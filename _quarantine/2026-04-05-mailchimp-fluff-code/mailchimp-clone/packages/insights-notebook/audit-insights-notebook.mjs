...
export function createInsightsNotebookAuditTrail() {
...
export function createInsightsNotebookEvidenceManifest() {
...
export function createInsightsNotebookReadinessAttestation() {
  const auditTrail = createInsightsNotebookAuditTrail();
  return {
