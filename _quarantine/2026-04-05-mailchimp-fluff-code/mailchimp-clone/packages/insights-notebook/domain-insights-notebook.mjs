...
export function createInsightsNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsNotebookWorkspace(workspace = createInsightsNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsNotebookNarratives(workspace = createInsightsNotebookWorkspace()) {
...
export function createInsightsNotebookCoverageGrid(workspace = createInsightsNotebookWorkspace()) {
