...
export function createInsightsNotebookAnalyticsTimeline() {
...
export function createInsightsNotebookForecastEnvelope() {
...
export function createInsightsNotebookExceptionLedger() {
...
export function summarizeInsightsNotebookAnalytics() {
  const timeline = createInsightsNotebookAnalyticsTimeline();
  const forecast = createInsightsNotebookForecastEnvelope();
  return {
