...
export function createInsightsNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeInsightsNotebookFixtures(fixtures = createInsightsNotebookFixtures()) {
  return {
...
export function createInsightsNotebookDemoInputs() {
  return {
