...
export function createCollaborationConsoleAuditTrail() {
...
export function createCollaborationConsoleEvidenceManifest() {
...
export function createCollaborationConsoleReadinessAttestation() {
  const auditTrail = createCollaborationConsoleAuditTrail();
  return {
