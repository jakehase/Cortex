...
export function createCampaignPlannerAuditTrail() {
...
export function createCampaignPlannerEvidenceManifest() {
...
export function createCampaignPlannerReadinessAttestation() {
  const auditTrail = createCampaignPlannerAuditTrail();
  return {
