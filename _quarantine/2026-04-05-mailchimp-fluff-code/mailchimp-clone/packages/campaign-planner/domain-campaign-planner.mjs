...
export function createCampaignPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignPlannerWorkspace(workspace = createCampaignPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignPlannerNarratives(workspace = createCampaignPlannerWorkspace()) {
...
export function createCampaignPlannerCoverageGrid(workspace = createCampaignPlannerWorkspace()) {
