...
export function createCampaignPlannerPolicies(overrides = {}) {
...
export function validateCampaignPlannerPolicies(policies = createCampaignPlannerPolicies()) {
  const issues = [];
...
export function summarizeCampaignPlannerPolicies(policies = createCampaignPlannerPolicies()) {
  return {
...
export function createCampaignPlannerEscalationDeck(policies = createCampaignPlannerPolicies()) {
