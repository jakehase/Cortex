...
export function createLoyaltyNavigatorAnalyticsTimeline() {
...
export function createLoyaltyNavigatorForecastEnvelope() {
...
export function createLoyaltyNavigatorExceptionLedger() {
...
export function summarizeLoyaltyNavigatorAnalytics() {
  const timeline = createLoyaltyNavigatorAnalyticsTimeline();
  const forecast = createLoyaltyNavigatorForecastEnvelope();
  return {
