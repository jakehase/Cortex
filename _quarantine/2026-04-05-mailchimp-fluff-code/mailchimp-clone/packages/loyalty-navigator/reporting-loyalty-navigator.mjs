...
export function createLoyaltyNavigatorReportCards() {
...
export function createLoyaltyNavigatorReviewPackets() {
...
export function summarizeLoyaltyNavigatorReporting() {
  const cards = createLoyaltyNavigatorReportCards();
  const packets = createLoyaltyNavigatorReviewPackets();
  return {
