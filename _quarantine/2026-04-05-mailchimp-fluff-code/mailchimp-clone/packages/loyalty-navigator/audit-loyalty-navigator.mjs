...
export function createLoyaltyNavigatorAuditTrail() {
...
export function createLoyaltyNavigatorEvidenceManifest() {
...
export function createLoyaltyNavigatorReadinessAttestation() {
  const auditTrail = createLoyaltyNavigatorAuditTrail();
  return {
