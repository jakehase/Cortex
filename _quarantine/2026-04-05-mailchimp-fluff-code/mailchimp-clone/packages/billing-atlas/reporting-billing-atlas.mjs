...
export function createBillingAtlasReportCards() {
...
export function createBillingAtlasReviewPackets() {
...
export function summarizeBillingAtlasReporting() {
  const cards = createBillingAtlasReportCards();
  const packets = createBillingAtlasReviewPackets();
  return {
