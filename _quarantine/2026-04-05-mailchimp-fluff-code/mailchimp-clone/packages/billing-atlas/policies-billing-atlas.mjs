...
export function createBillingAtlasPolicies(overrides = {}) {
...
export function validateBillingAtlasPolicies(policies = createBillingAtlasPolicies()) {
  const issues = [];
...
export function summarizeBillingAtlasPolicies(policies = createBillingAtlasPolicies()) {
  return {
...
export function createBillingAtlasEscalationDeck(policies = createBillingAtlasPolicies()) {
