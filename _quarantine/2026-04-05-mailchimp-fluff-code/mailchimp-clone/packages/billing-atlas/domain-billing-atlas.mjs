const MODULE = {
  ...
  "routeSegment": "atlas",
  "title": "Billing Atlas",
  "focus": "Billing Atlas covers plan posture, invoice exceptions, and collection readiness through landscape mapping and territory coverage.",
...
export function createBillingAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBillingAtlasWorkspace(workspace = createBillingAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createBillingAtlasNarratives(workspace = createBillingAtlasWorkspace()) {
...
export function createBillingAtlasCoverageGrid(workspace = createBillingAtlasWorkspace()) {
