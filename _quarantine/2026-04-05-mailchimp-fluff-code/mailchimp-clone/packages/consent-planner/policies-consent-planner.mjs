...
export function createConsentPlannerPolicies(overrides = {}) {
...
export function validateConsentPlannerPolicies(policies = createConsentPlannerPolicies()) {
  const issues = [];
...
export function summarizeConsentPlannerPolicies(policies = createConsentPlannerPolicies()) {
  return {
...
export function createConsentPlannerEscalationDeck(policies = createConsentPlannerPolicies()) {
