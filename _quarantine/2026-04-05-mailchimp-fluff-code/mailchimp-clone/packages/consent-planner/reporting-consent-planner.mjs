...
export function createConsentPlannerReportCards() {
...
export function createConsentPlannerReviewPackets() {
...
export function summarizeConsentPlannerReporting() {
  const cards = createConsentPlannerReportCards();
  const packets = createConsentPlannerReviewPackets();
  return {
