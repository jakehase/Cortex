...
export function createDataExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataExchangeWorkspace(workspace = createDataExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataExchangeNarratives(workspace = createDataExchangeWorkspace()) {
...
export function createDataExchangeCoverageGrid(workspace = createDataExchangeWorkspace()) {
