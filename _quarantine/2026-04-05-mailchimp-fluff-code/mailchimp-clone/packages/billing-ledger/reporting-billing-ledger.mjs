...
export function createBillingLedgerReportCards() {
...
export function createBillingLedgerReviewPackets() {
...
export function summarizeBillingLedgerReporting() {
  const cards = createBillingLedgerReportCards();
  const packets = createBillingLedgerReviewPackets();
  return {
