...
export function createCreativeAtlasPolicies(overrides = {}) {
...
export function validateCreativeAtlasPolicies(policies = createCreativeAtlasPolicies()) {
  const issues = [];
...
export function summarizeCreativeAtlasPolicies(policies = createCreativeAtlasPolicies()) {
  return {
...
export function createCreativeAtlasEscalationDeck(policies = createCreativeAtlasPolicies()) {
