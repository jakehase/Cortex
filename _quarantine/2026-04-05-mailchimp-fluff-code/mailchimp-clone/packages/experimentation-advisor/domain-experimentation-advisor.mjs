const MODULE = {
  "id": "experimentation-advisor",
  "ordinal": 419,
  "domain": "experimentation",
  "surfaceId": "advisor",
  "surfaceTitle": "Advisor",
  "routeSegment": "advisor",
  "title": "Experimentation Advisor",
  "focus": "Experimentation Advisor covers test planning, variant analysis, and decision velocity through recommendations and next-step framing.",
  ...
  "tags": [
    ...
    "advisor",
    "intelligence",
    "experimentation-advisor-wave-seven"
  ]
};
...
export function createExperimentationAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationAdvisorWorkspace(workspace = createExperimentationAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationAdvisorNarratives(workspace = createExperimentationAdvisorWorkspace()) {
...
export function createExperimentationAdvisorCoverageGrid(workspace = createExperimentationAdvisorWorkspace()) {
