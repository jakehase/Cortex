...
export function createAnalyticsCockpitOperationsBoard() {
...
export function createAnalyticsCockpitShiftChecklist() {
...
export function createAnalyticsCockpitIncidentDeck() {
