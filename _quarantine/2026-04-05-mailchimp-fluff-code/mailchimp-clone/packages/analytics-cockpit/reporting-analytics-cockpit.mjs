...
export function createAnalyticsCockpitReportCards() {
...
export function createAnalyticsCockpitReviewPackets() {
...
export function summarizeAnalyticsCockpitReporting() {
  const cards = createAnalyticsCockpitReportCards();
  const packets = createAnalyticsCockpitReviewPackets();
  return {
