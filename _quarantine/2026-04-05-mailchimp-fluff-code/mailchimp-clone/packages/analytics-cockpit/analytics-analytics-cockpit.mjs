...
export function createAnalyticsCockpitAnalyticsTimeline() {
...
export function createAnalyticsCockpitForecastEnvelope() {
...
export function createAnalyticsCockpitExceptionLedger() {
...
export function summarizeAnalyticsCockpitAnalytics() {
  const timeline = createAnalyticsCockpitAnalyticsTimeline();
  const forecast = createAnalyticsCockpitForecastEnvelope();
  return {
