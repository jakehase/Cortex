...
export function createAnalyticsCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsCockpitWorkspace(workspace = createAnalyticsCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsCockpitNarratives(workspace = createAnalyticsCockpitWorkspace()) {
...
export function createAnalyticsCockpitCoverageGrid(workspace = createAnalyticsCockpitWorkspace()) {
