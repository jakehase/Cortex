...
export function createAnalyticsCockpitPolicies(overrides = {}) {
...
export function validateAnalyticsCockpitPolicies(policies = createAnalyticsCockpitPolicies()) {
  const issues = [];
...
export function summarizeAnalyticsCockpitPolicies(policies = createAnalyticsCockpitPolicies()) {
  return {
...
export function createAnalyticsCockpitEscalationDeck(policies = createAnalyticsCockpitPolicies()) {
