...
export function createCreativeVaultPolicies(overrides = {}) {
...
export function validateCreativeVaultPolicies(policies = createCreativeVaultPolicies()) {
  const issues = [];
...
export function summarizeCreativeVaultPolicies(policies = createCreativeVaultPolicies()) {
  return {
...
export function createCreativeVaultEscalationDeck(policies = createCreativeVaultPolicies()) {
