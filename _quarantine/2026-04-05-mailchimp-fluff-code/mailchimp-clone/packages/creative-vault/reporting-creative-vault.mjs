...
export function createCreativeVaultReportCards() {
...
export function createCreativeVaultReviewPackets() {
...
export function summarizeCreativeVaultReporting() {
  const cards = createCreativeVaultReportCards();
  const packets = createCreativeVaultReviewPackets();
  return {
