...
export function createAcquisitionWatchtowerPlaybooks() {
...
export function createAcquisitionWatchtowerDecisionDeck() {
...
export function createAcquisitionWatchtowerEscalationMoments() {
