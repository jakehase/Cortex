const MODULE = {
  "id": "acquisition-watchtower",
  "ordinal": 19,
  "domain": "acquisition",
  "surfaceId": "watchtower",
  "surfaceTitle": "Watchtower",
  "routeSegment": "watchtower",
  "title": "Acquisition Watchtower",
  "focus": "Acquisition Watchtower covers new demand creation, source quality, and upstream handoff clarity through oversight dashboards and escalation views.",
  ...
  "tags": [
    ...
    "watchtower",
    "growth",
    "acquisition-watchtower-wave-seven"
  ]
};
...
export function createAcquisitionWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionWatchtowerWorkspace(workspace = createAcquisitionWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionWatchtowerNarratives(workspace = createAcquisitionWatchtowerWorkspace()) {
...
export function createAcquisitionWatchtowerCoverageGrid(workspace = createAcquisitionWatchtowerWorkspace()) {
