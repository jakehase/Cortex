...
export function createAcquisitionWatchtowerPolicies(overrides = {}) {
...
export function validateAcquisitionWatchtowerPolicies(policies = createAcquisitionWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionWatchtowerPolicies(policies = createAcquisitionWatchtowerPolicies()) {
  return {
...
export function createAcquisitionWatchtowerEscalationDeck(policies = createAcquisitionWatchtowerPolicies()) {
