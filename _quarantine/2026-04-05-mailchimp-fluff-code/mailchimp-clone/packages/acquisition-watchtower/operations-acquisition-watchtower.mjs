...
export function createAcquisitionWatchtowerOperationsBoard() {
...
export function createAcquisitionWatchtowerShiftChecklist() {
...
export function createAcquisitionWatchtowerIncidentDeck() {
