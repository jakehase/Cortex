...
export function createAcquisitionWatchtowerAnalyticsTimeline() {
...
export function createAcquisitionWatchtowerForecastEnvelope() {
...
export function createAcquisitionWatchtowerExceptionLedger() {
...
export function summarizeAcquisitionWatchtowerAnalytics() {
  const timeline = createAcquisitionWatchtowerAnalyticsTimeline();
  const forecast = createAcquisitionWatchtowerForecastEnvelope();
  return {
