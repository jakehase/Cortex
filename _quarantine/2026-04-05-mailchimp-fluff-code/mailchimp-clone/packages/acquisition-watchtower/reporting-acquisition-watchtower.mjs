...
export function createAcquisitionWatchtowerReportCards() {
...
export function createAcquisitionWatchtowerReviewPackets() {
...
export function summarizeAcquisitionWatchtowerReporting() {
  const cards = createAcquisitionWatchtowerReportCards();
  const packets = createAcquisitionWatchtowerReviewPackets();
  return {
