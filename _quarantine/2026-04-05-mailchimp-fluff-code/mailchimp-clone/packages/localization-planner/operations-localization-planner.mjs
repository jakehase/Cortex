...
export function createLocalizationPlannerOperationsBoard() {
...
export function createLocalizationPlannerShiftChecklist() {
...
export function createLocalizationPlannerIncidentDeck() {
