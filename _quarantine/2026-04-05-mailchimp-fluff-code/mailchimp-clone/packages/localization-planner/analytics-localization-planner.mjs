...
export function createLocalizationPlannerAnalyticsTimeline() {
...
export function createLocalizationPlannerForecastEnvelope() {
...
export function createLocalizationPlannerExceptionLedger() {
...
export function summarizeLocalizationPlannerAnalytics() {
  const timeline = createLocalizationPlannerAnalyticsTimeline();
  const forecast = createLocalizationPlannerForecastEnvelope();
  return {
