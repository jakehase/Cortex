...
export function createLocalizationPlannerAuditTrail() {
...
export function createLocalizationPlannerEvidenceManifest() {
...
export function createLocalizationPlannerReadinessAttestation() {
  const auditTrail = createLocalizationPlannerAuditTrail();
  return {
