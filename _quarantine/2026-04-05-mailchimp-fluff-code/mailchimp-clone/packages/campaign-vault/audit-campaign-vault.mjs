...
export function createCampaignVaultAuditTrail() {
...
export function createCampaignVaultEvidenceManifest() {
...
export function createCampaignVaultReadinessAttestation() {
  const auditTrail = createCampaignVaultAuditTrail();
  return {
