...
export function createCampaignVaultReportCards() {
...
export function createCampaignVaultReviewPackets() {
...
export function summarizeCampaignVaultReporting() {
  const cards = createCampaignVaultReportCards();
  const packets = createCampaignVaultReviewPackets();
  return {
