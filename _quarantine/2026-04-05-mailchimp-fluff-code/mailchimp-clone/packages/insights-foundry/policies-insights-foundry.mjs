...
export function createInsightsFoundryPolicies(overrides = {}) {
...
export function validateInsightsFoundryPolicies(policies = createInsightsFoundryPolicies()) {
  const issues = [];
...
export function summarizeInsightsFoundryPolicies(policies = createInsightsFoundryPolicies()) {
  return {
...
export function createInsightsFoundryEscalationDeck(policies = createInsightsFoundryPolicies()) {
