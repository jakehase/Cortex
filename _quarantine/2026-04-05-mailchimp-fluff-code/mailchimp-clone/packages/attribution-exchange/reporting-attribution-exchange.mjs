...
export function createAttributionExchangeReportCards() {
...
export function createAttributionExchangeReviewPackets() {
...
export function summarizeAttributionExchangeReporting() {
  const cards = createAttributionExchangeReportCards();
  const packets = createAttributionExchangeReviewPackets();
  return {
