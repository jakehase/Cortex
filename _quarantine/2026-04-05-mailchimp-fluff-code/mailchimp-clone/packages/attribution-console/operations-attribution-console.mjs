...
export function createAttributionConsoleOperationsBoard() {
...
export function createAttributionConsoleShiftChecklist() {
...
export function createAttributionConsoleIncidentDeck() {
