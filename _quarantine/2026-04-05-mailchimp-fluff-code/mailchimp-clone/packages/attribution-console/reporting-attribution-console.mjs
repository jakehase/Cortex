...
export function createAttributionConsoleReportCards() {
...
export function createAttributionConsoleReviewPackets() {
...
export function summarizeAttributionConsoleReporting() {
  const cards = createAttributionConsoleReportCards();
  const packets = createAttributionConsoleReviewPackets();
  return {
