...
export function createConsentNotebookAnalyticsTimeline() {
...
export function createConsentNotebookForecastEnvelope() {
...
export function createConsentNotebookExceptionLedger() {
...
export function summarizeConsentNotebookAnalytics() {
  const timeline = createConsentNotebookAnalyticsTimeline();
  const forecast = createConsentNotebookForecastEnvelope();
  return {
