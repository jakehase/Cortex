...
export function createConsentNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeConsentNotebookWorkspace(workspace = createConsentNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createConsentNotebookNarratives(workspace = createConsentNotebookWorkspace()) {
...
export function createConsentNotebookCoverageGrid(workspace = createConsentNotebookWorkspace()) {
