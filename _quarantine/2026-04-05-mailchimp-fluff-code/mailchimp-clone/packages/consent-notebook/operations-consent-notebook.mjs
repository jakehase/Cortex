...
export function createConsentNotebookOperationsBoard() {
...
export function createConsentNotebookShiftChecklist() {
...
export function createConsentNotebookIncidentDeck() {
