...
export function createPartnerAtlasAnalyticsTimeline() {
...
export function createPartnerAtlasForecastEnvelope() {
...
export function createPartnerAtlasExceptionLedger() {
...
export function summarizePartnerAtlasAnalytics() {
  const timeline = createPartnerAtlasAnalyticsTimeline();
  const forecast = createPartnerAtlasForecastEnvelope();
  return {
