...
export function createAnalyticsAdvisorOperationsBoard() {
...
export function createAnalyticsAdvisorShiftChecklist() {
...
export function createAnalyticsAdvisorIncidentDeck() {
