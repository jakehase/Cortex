...
export function createAnalyticsAdvisorAuditTrail() {
...
export function createAnalyticsAdvisorEvidenceManifest() {
...
export function createAnalyticsAdvisorReadinessAttestation() {
  const auditTrail = createAnalyticsAdvisorAuditTrail();
  return {
