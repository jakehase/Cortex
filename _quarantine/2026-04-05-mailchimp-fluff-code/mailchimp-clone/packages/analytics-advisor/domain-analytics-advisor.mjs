...
export function createAnalyticsAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsAdvisorWorkspace(workspace = createAnalyticsAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsAdvisorNarratives(workspace = createAnalyticsAdvisorWorkspace()) {
...
export function createAnalyticsAdvisorCoverageGrid(workspace = createAnalyticsAdvisorWorkspace()) {
