...
export function createAnalyticsAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeAnalyticsAdvisorFixtures(fixtures = createAnalyticsAdvisorFixtures()) {
  return {
...
export function createAnalyticsAdvisorDemoInputs() {
  return {
