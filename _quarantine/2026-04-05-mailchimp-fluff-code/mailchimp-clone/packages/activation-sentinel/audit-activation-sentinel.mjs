...
export function createActivationSentinelAuditTrail() {
...
export function createActivationSentinelEvidenceManifest() {
...
export function createActivationSentinelReadinessAttestation() {
  const auditTrail = createActivationSentinelAuditTrail();
  return {
