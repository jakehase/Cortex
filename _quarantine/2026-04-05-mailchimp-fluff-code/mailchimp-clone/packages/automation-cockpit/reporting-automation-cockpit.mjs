...
export function createAutomationCockpitReportCards() {
...
export function createAutomationCockpitReviewPackets() {
...
export function summarizeAutomationCockpitReporting() {
  const cards = createAutomationCockpitReportCards();
  const packets = createAutomationCockpitReviewPackets();
  return {
