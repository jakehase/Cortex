...
export function createAutomationCockpitAuditTrail() {
...
export function createAutomationCockpitEvidenceManifest() {
...
export function createAutomationCockpitReadinessAttestation() {
  const auditTrail = createAutomationCockpitAuditTrail();
  return {
