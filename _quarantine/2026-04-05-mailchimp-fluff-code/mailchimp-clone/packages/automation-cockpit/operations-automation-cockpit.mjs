...
export function createAutomationCockpitOperationsBoard() {
...
export function createAutomationCockpitShiftChecklist() {
...
export function createAutomationCockpitIncidentDeck() {
