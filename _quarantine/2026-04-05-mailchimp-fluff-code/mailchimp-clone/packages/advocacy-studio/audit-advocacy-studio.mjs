...
export function createAdvocacyStudioAuditTrail() {
...
export function createAdvocacyStudioEvidenceManifest() {
...
export function createAdvocacyStudioReadinessAttestation() {
  const auditTrail = createAdvocacyStudioAuditTrail();
  return {
