...
export function createLifecycleNavigatorAuditTrail() {
...
export function createLifecycleNavigatorEvidenceManifest() {
...
export function createLifecycleNavigatorReadinessAttestation() {
  const auditTrail = createLifecycleNavigatorAuditTrail();
  return {
