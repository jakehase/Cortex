...
export function createLifecycleNavigatorPolicies(overrides = {}) {
...
export function validateLifecycleNavigatorPolicies(policies = createLifecycleNavigatorPolicies()) {
  const issues = [];
...
export function summarizeLifecycleNavigatorPolicies(policies = createLifecycleNavigatorPolicies()) {
  return {
...
export function createLifecycleNavigatorEscalationDeck(policies = createLifecycleNavigatorPolicies()) {
