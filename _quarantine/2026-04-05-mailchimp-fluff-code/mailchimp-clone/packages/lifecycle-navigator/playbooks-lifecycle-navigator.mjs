...
export function createLifecycleNavigatorPlaybooks() {
...
export function createLifecycleNavigatorDecisionDeck() {
...
export function createLifecycleNavigatorEscalationMoments() {
