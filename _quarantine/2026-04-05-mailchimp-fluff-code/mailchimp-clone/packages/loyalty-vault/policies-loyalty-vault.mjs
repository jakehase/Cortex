...
export function createLoyaltyVaultPolicies(overrides = {}) {
...
export function validateLoyaltyVaultPolicies(policies = createLoyaltyVaultPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyVaultPolicies(policies = createLoyaltyVaultPolicies()) {
  return {
...
export function createLoyaltyVaultEscalationDeck(policies = createLoyaltyVaultPolicies()) {
