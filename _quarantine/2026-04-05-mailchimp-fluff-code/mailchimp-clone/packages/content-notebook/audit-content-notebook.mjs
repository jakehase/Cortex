...
export function createContentNotebookAuditTrail() {
...
export function createContentNotebookEvidenceManifest() {
...
export function createContentNotebookReadinessAttestation() {
  const auditTrail = createContentNotebookAuditTrail();
  return {
