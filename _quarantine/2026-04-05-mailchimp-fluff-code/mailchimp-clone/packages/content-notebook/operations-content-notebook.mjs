...
export function createContentNotebookOperationsBoard() {
...
export function createContentNotebookShiftChecklist() {
...
export function createContentNotebookIncidentDeck() {
