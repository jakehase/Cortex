const MODULE = {
  ...
  "focus": "Content Notebook covers content operations, packaging, and channel-specific delivery shape through working notes and experiment memory.",
...
export function createContentNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentNotebookWorkspace(workspace = createContentNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentNotebookNarratives(workspace = createContentNotebookWorkspace()) {
...
export function createContentNotebookCoverageGrid(workspace = createContentNotebookWorkspace()) {
