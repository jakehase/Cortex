...
export function createContentNotebookPolicies(overrides = {}) {
...
export function validateContentNotebookPolicies(policies = createContentNotebookPolicies()) {
  const issues = [];
...
export function summarizeContentNotebookPolicies(policies = createContentNotebookPolicies()) {
  return {
...
export function createContentNotebookEscalationDeck(policies = createContentNotebookPolicies()) {
