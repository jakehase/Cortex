...
export function createAutomationFoundryPolicies(overrides = {}) {
...
export function validateAutomationFoundryPolicies(policies = createAutomationFoundryPolicies()) {
  const issues = [];
...
export function summarizeAutomationFoundryPolicies(policies = createAutomationFoundryPolicies()) {
  return {
...
export function createAutomationFoundryEscalationDeck(policies = createAutomationFoundryPolicies()) {
