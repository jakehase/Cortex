...
export function createCampaignDossierAuditTrail() {
...
export function createCampaignDossierEvidenceManifest() {
...
export function createCampaignDossierReadinessAttestation() {
  const auditTrail = createCampaignDossierAuditTrail();
  return {
