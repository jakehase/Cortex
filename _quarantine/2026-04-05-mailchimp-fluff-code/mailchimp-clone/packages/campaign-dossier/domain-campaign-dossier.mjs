...
export function createCampaignDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignDossierWorkspace(workspace = createCampaignDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignDossierNarratives(workspace = createCampaignDossierWorkspace()) {
...
export function createCampaignDossierCoverageGrid(workspace = createCampaignDossierWorkspace()) {
