...
export function createCampaignDossierAnalyticsTimeline() {
...
export function createCampaignDossierForecastEnvelope() {
...
export function createCampaignDossierExceptionLedger() {
...
export function summarizeCampaignDossierAnalytics() {
  const timeline = createCampaignDossierAnalyticsTimeline();
  const forecast = createCampaignDossierForecastEnvelope();
  return {
