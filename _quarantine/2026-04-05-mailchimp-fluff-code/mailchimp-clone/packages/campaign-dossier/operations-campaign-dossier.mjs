...
export function createCampaignDossierOperationsBoard() {
...
export function createCampaignDossierShiftChecklist() {
...
export function createCampaignDossierIncidentDeck() {
