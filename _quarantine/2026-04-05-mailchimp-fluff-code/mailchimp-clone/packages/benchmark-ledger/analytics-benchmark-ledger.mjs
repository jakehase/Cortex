...
export function createBenchmarkLedgerAnalyticsTimeline() {
...
export function createBenchmarkLedgerForecastEnvelope() {
...
export function createBenchmarkLedgerExceptionLedger() {
...
export function summarizeBenchmarkLedgerAnalytics() {
  const timeline = createBenchmarkLedgerAnalyticsTimeline();
  const forecast = createBenchmarkLedgerForecastEnvelope();
  return {
