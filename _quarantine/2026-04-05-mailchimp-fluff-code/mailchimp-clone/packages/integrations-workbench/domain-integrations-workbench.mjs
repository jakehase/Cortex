...
export function createIntegrationsWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsWorkbenchWorkspace(workspace = createIntegrationsWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsWorkbenchNarratives(workspace = createIntegrationsWorkbenchWorkspace()) {
...
export function createIntegrationsWorkbenchCoverageGrid(workspace = createIntegrationsWorkbenchWorkspace()) {
