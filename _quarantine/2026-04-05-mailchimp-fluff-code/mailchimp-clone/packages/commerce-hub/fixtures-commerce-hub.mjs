...
export function createCommerceHubFixtures() {
  return {
    accounts: [
...
export function summarizeCommerceHubFixtures(fixtures = createCommerceHubFixtures()) {
  return {
...
export function createCommerceHubDemoInputs() {
  return {
