...
export function createCommerceHubReportCards() {
...
export function createCommerceHubReviewPackets() {
...
export function summarizeCommerceHubReporting() {
  const cards = createCommerceHubReportCards();
  const packets = createCommerceHubReviewPackets();
  return {
