...
export function createAcquisitionNavigatorAuditTrail() {
...
export function createAcquisitionNavigatorEvidenceManifest() {
...
export function createAcquisitionNavigatorReadinessAttestation() {
  const auditTrail = createAcquisitionNavigatorAuditTrail();
  return {
