...
export function createAcquisitionNavigatorPolicies(overrides = {}) {
...
export function validateAcquisitionNavigatorPolicies(policies = createAcquisitionNavigatorPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionNavigatorPolicies(policies = createAcquisitionNavigatorPolicies()) {
  return {
...
export function createAcquisitionNavigatorEscalationDeck(policies = createAcquisitionNavigatorPolicies()) {
