...
export function createAcquisitionNavigatorAnalyticsTimeline() {
...
export function createAcquisitionNavigatorForecastEnvelope() {
...
export function createAcquisitionNavigatorExceptionLedger() {
...
export function summarizeAcquisitionNavigatorAnalytics() {
  const timeline = createAcquisitionNavigatorAnalyticsTimeline();
  const forecast = createAcquisitionNavigatorForecastEnvelope();
  return {
