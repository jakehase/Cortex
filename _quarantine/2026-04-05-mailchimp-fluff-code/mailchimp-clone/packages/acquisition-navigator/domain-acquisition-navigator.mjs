...
export function createAcquisitionNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionNavigatorWorkspace(workspace = createAcquisitionNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionNavigatorNarratives(workspace = createAcquisitionNavigatorWorkspace()) {
...
export function createAcquisitionNavigatorCoverageGrid(workspace = createAcquisitionNavigatorWorkspace()) {
