...
export function createBenchmarkNavigatorReportCards() {
...
export function createBenchmarkNavigatorReviewPackets() {
...
export function summarizeBenchmarkNavigatorReporting() {
  const cards = createBenchmarkNavigatorReportCards();
  const packets = createBenchmarkNavigatorReviewPackets();
  return {
