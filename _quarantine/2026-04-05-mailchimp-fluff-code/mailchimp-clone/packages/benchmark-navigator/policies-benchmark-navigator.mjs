...
export function createBenchmarkNavigatorPolicies(overrides = {}) {
...
export function validateBenchmarkNavigatorPolicies(policies = createBenchmarkNavigatorPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkNavigatorPolicies(policies = createBenchmarkNavigatorPolicies()) {
  return {
...
export function createBenchmarkNavigatorEscalationDeck(policies = createBenchmarkNavigatorPolicies()) {
