...
export function createBenchmarkNavigatorAuditTrail() {
...
export function createBenchmarkNavigatorEvidenceManifest() {
...
export function createBenchmarkNavigatorReadinessAttestation() {
  const auditTrail = createBenchmarkNavigatorAuditTrail();
  return {
