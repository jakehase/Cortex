...
export function createAutomationNavigatorAnalyticsTimeline() {
...
export function createAutomationNavigatorForecastEnvelope() {
...
export function createAutomationNavigatorExceptionLedger() {
...
export function summarizeAutomationNavigatorAnalytics() {
  const timeline = createAutomationNavigatorAnalyticsTimeline();
  const forecast = createAutomationNavigatorForecastEnvelope();
  return {
