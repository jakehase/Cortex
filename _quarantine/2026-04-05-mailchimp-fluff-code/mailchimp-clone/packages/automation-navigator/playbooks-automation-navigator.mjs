...
export function createAutomationNavigatorPlaybooks() {
...
export function createAutomationNavigatorDecisionDeck() {
...
export function createAutomationNavigatorEscalationMoments() {
