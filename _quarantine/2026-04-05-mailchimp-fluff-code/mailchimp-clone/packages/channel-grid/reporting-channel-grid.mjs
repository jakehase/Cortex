...
export function createChannelGridReportCards() {
...
export function createChannelGridReviewPackets() {
...
export function summarizeChannelGridReporting() {
  const cards = createChannelGridReportCards();
  const packets = createChannelGridReviewPackets();
  return {
