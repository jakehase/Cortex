...
export function createChannelAtlasReportCards() {
...
export function createChannelAtlasReviewPackets() {
...
export function summarizeChannelAtlasReporting() {
  const cards = createChannelAtlasReportCards();
  const packets = createChannelAtlasReviewPackets();
  return {
