const MODULE = {
  ...
  "routeSegment": "atlas",
  "title": "Channel Atlas",
  "focus": "Channel Atlas covers channel operating models, readiness coverage, and mix governance through landscape mapping and territory coverage.",
...
export function createChannelAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelAtlasWorkspace(workspace = createChannelAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelAtlasNarratives(workspace = createChannelAtlasWorkspace()) {
...
export function createChannelAtlasCoverageGrid(workspace = createChannelAtlasWorkspace()) {
