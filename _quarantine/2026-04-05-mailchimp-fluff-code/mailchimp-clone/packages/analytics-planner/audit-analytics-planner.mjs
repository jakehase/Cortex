...
export function createAnalyticsPlannerAuditTrail() {
...
export function createAnalyticsPlannerEvidenceManifest() {
...
export function createAnalyticsPlannerReadinessAttestation() {
  const auditTrail = createAnalyticsPlannerAuditTrail();
  return {
