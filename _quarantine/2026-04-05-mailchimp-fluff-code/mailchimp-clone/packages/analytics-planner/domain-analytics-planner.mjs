...
export function createAnalyticsPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsPlannerWorkspace(workspace = createAnalyticsPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsPlannerNarratives(workspace = createAnalyticsPlannerWorkspace()) {
...
export function createAnalyticsPlannerCoverageGrid(workspace = createAnalyticsPlannerWorkspace()) {
