...
export function createAdvocacyAdvisorReportCards() {
...
export function createAdvocacyAdvisorReviewPackets() {
...
export function summarizeAdvocacyAdvisorReporting() {
  const cards = createAdvocacyAdvisorReportCards();
  const packets = createAdvocacyAdvisorReviewPackets();
  return {
