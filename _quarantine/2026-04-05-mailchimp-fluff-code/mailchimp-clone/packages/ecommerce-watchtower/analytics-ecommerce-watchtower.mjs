...
export function createEcommerceWatchtowerAnalyticsTimeline() {
...
export function createEcommerceWatchtowerForecastEnvelope() {
...
export function createEcommerceWatchtowerExceptionLedger() {
...
export function summarizeEcommerceWatchtowerAnalytics() {
  const timeline = createEcommerceWatchtowerAnalyticsTimeline();
  const forecast = createEcommerceWatchtowerForecastEnvelope();
  return {
