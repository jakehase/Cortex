...
export function createEcommerceWatchtowerPlaybooks() {
...
export function createEcommerceWatchtowerDecisionDeck() {
...
export function createEcommerceWatchtowerEscalationMoments() {
