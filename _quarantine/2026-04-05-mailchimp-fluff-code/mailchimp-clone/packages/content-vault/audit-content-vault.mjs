...
export function createContentVaultAuditTrail() {
...
export function createContentVaultEvidenceManifest() {
...
export function createContentVaultReadinessAttestation() {
  const auditTrail = createContentVaultAuditTrail();
  return {
