...
export function createInsightsDossierAnalyticsTimeline() {
...
export function createInsightsDossierForecastEnvelope() {
...
export function createInsightsDossierExceptionLedger() {
...
export function summarizeInsightsDossierAnalytics() {
  const timeline = createInsightsDossierAnalyticsTimeline();
  const forecast = createInsightsDossierForecastEnvelope();
  return {
