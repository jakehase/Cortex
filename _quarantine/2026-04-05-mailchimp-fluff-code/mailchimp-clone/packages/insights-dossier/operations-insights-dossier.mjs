...
export function createInsightsDossierOperationsBoard() {
...
export function createInsightsDossierShiftChecklist() {
...
export function createInsightsDossierIncidentDeck() {
