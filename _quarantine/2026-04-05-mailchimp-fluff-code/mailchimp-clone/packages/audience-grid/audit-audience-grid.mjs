...
export function createAudienceGridAuditTrail() {
...
export function createAudienceGridEvidenceManifest() {
...
export function createAudienceGridReadinessAttestation() {
  const auditTrail = createAudienceGridAuditTrail();
  return {
