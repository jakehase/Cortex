const MODULE = {
  ...
  "routeSegment": "grid",
  "title": "Audience Grid",
  "focus": "Audience Grid covers audience health, segment design, and targeting durability through portfolio views and cross-workspace rollups.",
...
export function createAudienceGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceGridWorkspace(workspace = createAudienceGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceGridNarratives(workspace = createAudienceGridWorkspace()) {
...
export function createAudienceGridCoverageGrid(workspace = createAudienceGridWorkspace()) {
