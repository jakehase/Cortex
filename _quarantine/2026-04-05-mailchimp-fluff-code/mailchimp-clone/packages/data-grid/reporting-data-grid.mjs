...
export function createDataGridReportCards() {
...
export function createDataGridReviewPackets() {
...
export function summarizeDataGridReporting() {
  const cards = createDataGridReportCards();
  const packets = createDataGridReviewPackets();
  return {
