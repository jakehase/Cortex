...
export function createAcquisitionHubReportCards() {
...
export function createAcquisitionHubReviewPackets() {
...
export function summarizeAcquisitionHubReporting() {
  const cards = createAcquisitionHubReportCards();
  const packets = createAcquisitionHubReviewPackets();
  return {
