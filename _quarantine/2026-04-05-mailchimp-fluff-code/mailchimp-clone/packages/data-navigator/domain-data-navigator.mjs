...
export function createDataNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataNavigatorWorkspace(workspace = createDataNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataNavigatorNarratives(workspace = createDataNavigatorWorkspace()) {
...
export function createDataNavigatorCoverageGrid(workspace = createDataNavigatorWorkspace()) {
