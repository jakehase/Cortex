...
export function createDataNavigatorAuditTrail() {
...
export function createDataNavigatorEvidenceManifest() {
...
export function createDataNavigatorReadinessAttestation() {
  const auditTrail = createDataNavigatorAuditTrail();
  return {
