...
export function createDataNavigatorReportCards() {
...
export function createDataNavigatorReviewPackets() {
...
export function summarizeDataNavigatorReporting() {
  const cards = createDataNavigatorReportCards();
  const packets = createDataNavigatorReviewPackets();
  return {
