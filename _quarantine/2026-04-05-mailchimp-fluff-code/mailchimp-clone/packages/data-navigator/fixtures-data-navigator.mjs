...
export function createDataNavigatorFixtures() {
  return {
    accounts: [
...
export function summarizeDataNavigatorFixtures(fixtures = createDataNavigatorFixtures()) {
  return {
...
export function createDataNavigatorDemoInputs() {
  return {
