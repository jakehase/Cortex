const MODULE = {
  "id": "analytics-navigator",
  "ordinal": 72,
  "domain": "analytics",
  "surfaceId": "navigator",
  "surfaceTitle": "Navigator",
  "routeSegment": "navigator",
  "title": "Analytics Navigator",
  "focus": "Analytics Navigator covers portfolio analytics, operator scorecards, and query-driven reviews through journey guidance and directional controls.",
  ...
  "tags": [
    ...
    "navigator",
    "revenue",
    "analytics-navigator-wave-seven"
  ]
};
...
export function createAnalyticsNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsNavigatorWorkspace(workspace = createAnalyticsNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsNavigatorNarratives(workspace = createAnalyticsNavigatorWorkspace()) {
...
export function createAnalyticsNavigatorCoverageGrid(workspace = createAnalyticsNavigatorWorkspace()) {
