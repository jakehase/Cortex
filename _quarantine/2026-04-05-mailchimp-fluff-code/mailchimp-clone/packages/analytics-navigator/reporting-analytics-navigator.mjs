...
export function createAnalyticsNavigatorReportCards() {
...
export function createAnalyticsNavigatorReviewPackets() {
...
export function summarizeAnalyticsNavigatorReporting() {
  const cards = createAnalyticsNavigatorReportCards();
  const packets = createAnalyticsNavigatorReviewPackets();
  return {
