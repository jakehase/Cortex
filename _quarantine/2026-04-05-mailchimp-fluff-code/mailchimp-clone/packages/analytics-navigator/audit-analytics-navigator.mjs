...
export function createAnalyticsNavigatorAuditTrail() {
...
export function createAnalyticsNavigatorEvidenceManifest() {
...
export function createAnalyticsNavigatorReadinessAttestation() {
  const auditTrail = createAnalyticsNavigatorAuditTrail();
  return {
