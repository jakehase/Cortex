...
export function createAnalyticsNavigatorOperationsBoard() {
...
export function createAnalyticsNavigatorShiftChecklist() {
...
export function createAnalyticsNavigatorIncidentDeck() {
