...
export function createInsightsLedgerAuditTrail() {
...
export function createInsightsLedgerEvidenceManifest() {
...
export function createInsightsLedgerReadinessAttestation() {
  const auditTrail = createInsightsLedgerAuditTrail();
  return {
