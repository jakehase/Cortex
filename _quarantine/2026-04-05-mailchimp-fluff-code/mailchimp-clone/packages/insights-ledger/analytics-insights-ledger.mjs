...
export function createInsightsLedgerAnalyticsTimeline() {
...
export function createInsightsLedgerForecastEnvelope() {
...
export function createInsightsLedgerExceptionLedger() {
...
export function summarizeInsightsLedgerAnalytics() {
  const timeline = createInsightsLedgerAnalyticsTimeline();
  const forecast = createInsightsLedgerForecastEnvelope();
  return {
