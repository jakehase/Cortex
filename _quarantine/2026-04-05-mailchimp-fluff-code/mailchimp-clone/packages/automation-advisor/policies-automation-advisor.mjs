...
export function createAutomationAdvisorPolicies(overrides = {}) {
...
export function validateAutomationAdvisorPolicies(policies = createAutomationAdvisorPolicies()) {
  const issues = [];
...
export function summarizeAutomationAdvisorPolicies(policies = createAutomationAdvisorPolicies()) {
  return {
...
export function createAutomationAdvisorEscalationDeck(policies = createAutomationAdvisorPolicies()) {
