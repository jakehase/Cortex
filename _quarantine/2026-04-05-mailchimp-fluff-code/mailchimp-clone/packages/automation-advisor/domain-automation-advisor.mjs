...
export function createAutomationAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAutomationAdvisorWorkspace(workspace = createAutomationAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAutomationAdvisorNarratives(workspace = createAutomationAdvisorWorkspace()) {
...
export function createAutomationAdvisorCoverageGrid(workspace = createAutomationAdvisorWorkspace()) {
