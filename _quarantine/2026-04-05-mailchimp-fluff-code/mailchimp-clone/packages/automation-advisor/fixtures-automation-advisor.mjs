...
export function createAutomationAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeAutomationAdvisorFixtures(fixtures = createAutomationAdvisorFixtures()) {
  return {
...
export function createAutomationAdvisorDemoInputs() {
  return {
