...
export function createAutomationAdvisorReportCards() {
...
export function createAutomationAdvisorReviewPackets() {
...
export function summarizeAutomationAdvisorReporting() {
  const cards = createAutomationAdvisorReportCards();
  const packets = createAutomationAdvisorReviewPackets();
  return {
