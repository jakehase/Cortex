...
export function createConsentConsolePolicies(overrides = {}) {
...
export function validateConsentConsolePolicies(policies = createConsentConsolePolicies()) {
  const issues = [];
...
export function summarizeConsentConsolePolicies(policies = createConsentConsolePolicies()) {
  return {
...
export function createConsentConsoleEscalationDeck(policies = createConsentConsolePolicies()) {
