...
export function createConsentConsoleAuditTrail() {
...
export function createConsentConsoleEvidenceManifest() {
...
export function createConsentConsoleReadinessAttestation() {
  const auditTrail = createConsentConsoleAuditTrail();
  return {
