...
export function createBillingGridAnalyticsTimeline() {
...
export function createBillingGridForecastEnvelope() {
...
export function createBillingGridExceptionLedger() {
...
export function summarizeBillingGridAnalytics() {
  const timeline = createBillingGridAnalyticsTimeline();
  const forecast = createBillingGridForecastEnvelope();
  return {
