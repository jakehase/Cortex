...
export function createBillingGridReportCards() {
...
export function createBillingGridReviewPackets() {
...
export function summarizeBillingGridReporting() {
  const cards = createBillingGridReportCards();
  const packets = createBillingGridReviewPackets();
  return {
