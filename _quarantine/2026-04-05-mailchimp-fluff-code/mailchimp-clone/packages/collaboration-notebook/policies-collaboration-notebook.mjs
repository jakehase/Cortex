...
export function createCollaborationNotebookPolicies(overrides = {}) {
...
export function validateCollaborationNotebookPolicies(policies = createCollaborationNotebookPolicies()) {
  const issues = [];
...
export function summarizeCollaborationNotebookPolicies(policies = createCollaborationNotebookPolicies()) {
  return {
...
export function createCollaborationNotebookEscalationDeck(policies = createCollaborationNotebookPolicies()) {
