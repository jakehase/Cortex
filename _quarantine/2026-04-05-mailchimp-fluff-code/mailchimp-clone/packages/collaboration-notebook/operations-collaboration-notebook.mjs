...
export function createCollaborationNotebookOperationsBoard() {
...
export function createCollaborationNotebookShiftChecklist() {
...
export function createCollaborationNotebookIncidentDeck() {
