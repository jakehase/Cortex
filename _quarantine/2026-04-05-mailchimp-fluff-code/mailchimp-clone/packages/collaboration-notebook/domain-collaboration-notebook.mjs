...
export function createCollaborationNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationNotebookWorkspace(workspace = createCollaborationNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationNotebookNarratives(workspace = createCollaborationNotebookWorkspace()) {
...
export function createCollaborationNotebookCoverageGrid(workspace = createCollaborationNotebookWorkspace()) {
