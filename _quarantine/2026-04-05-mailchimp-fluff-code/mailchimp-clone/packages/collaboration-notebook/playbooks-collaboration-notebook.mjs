...
export function createCollaborationNotebookPlaybooks() {
...
export function createCollaborationNotebookDecisionDeck() {
...
export function createCollaborationNotebookEscalationMoments() {
