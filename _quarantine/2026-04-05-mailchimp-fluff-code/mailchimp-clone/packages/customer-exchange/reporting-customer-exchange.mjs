...
export function createCustomerExchangeReportCards() {
...
export function createCustomerExchangeReviewPackets() {
...
export function summarizeCustomerExchangeReporting() {
  const cards = createCustomerExchangeReportCards();
  const packets = createCustomerExchangeReviewPackets();
  return {
