...
export function createCustomerExchangeAuditTrail() {
...
export function createCustomerExchangeEvidenceManifest() {
...
export function createCustomerExchangeReadinessAttestation() {
  const auditTrail = createCustomerExchangeAuditTrail();
  return {
