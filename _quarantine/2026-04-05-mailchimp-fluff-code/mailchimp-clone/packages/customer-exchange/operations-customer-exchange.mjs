...
export function createCustomerExchangeOperationsBoard() {
...
export function createCustomerExchangeShiftChecklist() {
...
export function createCustomerExchangeIncidentDeck() {
