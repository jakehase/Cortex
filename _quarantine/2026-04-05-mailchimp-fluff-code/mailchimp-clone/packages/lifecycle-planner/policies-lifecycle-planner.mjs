...
export function createLifecyclePlannerPolicies(overrides = {}) {
...
export function validateLifecyclePlannerPolicies(policies = createLifecyclePlannerPolicies()) {
  const issues = [];
...
export function summarizeLifecyclePlannerPolicies(policies = createLifecyclePlannerPolicies()) {
  return {
...
export function createLifecyclePlannerEscalationDeck(policies = createLifecyclePlannerPolicies()) {
