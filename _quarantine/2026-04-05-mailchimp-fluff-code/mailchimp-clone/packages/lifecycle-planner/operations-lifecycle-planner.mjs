...
export function createLifecyclePlannerOperationsBoard() {
...
export function createLifecyclePlannerShiftChecklist() {
...
export function createLifecyclePlannerIncidentDeck() {
