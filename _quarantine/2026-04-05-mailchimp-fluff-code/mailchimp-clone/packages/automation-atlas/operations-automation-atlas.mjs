...
export function createAutomationAtlasOperationsBoard() {
...
export function createAutomationAtlasShiftChecklist() {
...
export function createAutomationAtlasIncidentDeck() {
