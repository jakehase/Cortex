...
export function createAutomationAtlasPolicies(overrides = {}) {
...
export function validateAutomationAtlasPolicies(policies = createAutomationAtlasPolicies()) {
  const issues = [];
...
export function summarizeAutomationAtlasPolicies(policies = createAutomationAtlasPolicies()) {
  return {
...
export function createAutomationAtlasEscalationDeck(policies = createAutomationAtlasPolicies()) {
