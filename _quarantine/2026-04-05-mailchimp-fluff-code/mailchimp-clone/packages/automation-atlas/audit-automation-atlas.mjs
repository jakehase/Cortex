...
export function createAutomationAtlasAuditTrail() {
...
export function createAutomationAtlasEvidenceManifest() {
...
export function createAutomationAtlasReadinessAttestation() {
  const auditTrail = createAutomationAtlasAuditTrail();
  return {
