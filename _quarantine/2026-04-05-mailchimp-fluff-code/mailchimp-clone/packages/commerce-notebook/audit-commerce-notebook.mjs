...
export function createCommerceNotebookAuditTrail() {
...
export function createCommerceNotebookEvidenceManifest() {
...
export function createCommerceNotebookReadinessAttestation() {
  const auditTrail = createCommerceNotebookAuditTrail();
  return {
