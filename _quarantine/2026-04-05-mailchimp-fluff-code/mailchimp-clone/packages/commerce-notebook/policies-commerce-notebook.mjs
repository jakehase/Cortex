...
export function createCommerceNotebookPolicies(overrides = {}) {
...
export function validateCommerceNotebookPolicies(policies = createCommerceNotebookPolicies()) {
  const issues = [];
...
export function summarizeCommerceNotebookPolicies(policies = createCommerceNotebookPolicies()) {
  return {
...
export function createCommerceNotebookEscalationDeck(policies = createCommerceNotebookPolicies()) {
