...
export function createLocalizationIndexAnalyticsTimeline() {
...
export function createLocalizationIndexForecastEnvelope() {
...
export function createLocalizationIndexExceptionLedger() {
...
export function summarizeLocalizationIndexAnalytics() {
  const timeline = createLocalizationIndexAnalyticsTimeline();
  const forecast = createLocalizationIndexForecastEnvelope();
  return {
