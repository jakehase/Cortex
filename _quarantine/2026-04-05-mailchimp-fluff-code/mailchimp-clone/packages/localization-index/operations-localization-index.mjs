...
export function createLocalizationIndexOperationsBoard() {
...
export function createLocalizationIndexShiftChecklist() {
...
export function createLocalizationIndexIncidentDeck() {
