...
export function createLocalizationIndexReportCards() {
...
export function createLocalizationIndexReviewPackets() {
...
export function summarizeLocalizationIndexReporting() {
  const cards = createLocalizationIndexReportCards();
  const packets = createLocalizationIndexReviewPackets();
  return {
