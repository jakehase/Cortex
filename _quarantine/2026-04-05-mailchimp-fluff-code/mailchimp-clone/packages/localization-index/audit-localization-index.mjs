...
export function createLocalizationIndexAuditTrail() {
...
export function createLocalizationIndexEvidenceManifest() {
...
export function createLocalizationIndexReadinessAttestation() {
  const auditTrail = createLocalizationIndexAuditTrail();
  return {
