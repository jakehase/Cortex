...
export function createContentAtlasAnalyticsTimeline() {
...
export function createContentAtlasForecastEnvelope() {
...
export function createContentAtlasExceptionLedger() {
...
export function summarizeContentAtlasAnalytics() {
  const timeline = createContentAtlasAnalyticsTimeline();
  const forecast = createContentAtlasForecastEnvelope();
  return {
