...
export function createContentAtlasReportCards() {
...
export function createContentAtlasReviewPackets() {
...
export function summarizeContentAtlasReporting() {
  const cards = createContentAtlasReportCards();
  const packets = createContentAtlasReviewPackets();
  return {
