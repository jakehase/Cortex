...
export function createContentAtlasAuditTrail() {
...
export function createContentAtlasEvidenceManifest() {
...
export function createContentAtlasReadinessAttestation() {
  const auditTrail = createContentAtlasAuditTrail();
  return {
