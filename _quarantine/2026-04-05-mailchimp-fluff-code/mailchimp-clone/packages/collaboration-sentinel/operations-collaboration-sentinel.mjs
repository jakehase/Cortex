...
export function createCollaborationSentinelOperationsBoard() {
...
export function createCollaborationSentinelShiftChecklist() {
...
export function createCollaborationSentinelIncidentDeck() {
