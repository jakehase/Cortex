...
export function createConsentGridPolicies(overrides = {}) {
...
export function validateConsentGridPolicies(policies = createConsentGridPolicies()) {
  const issues = [];
...
export function summarizeConsentGridPolicies(policies = createConsentGridPolicies()) {
  return {
...
export function createConsentGridEscalationDeck(policies = createConsentGridPolicies()) {
