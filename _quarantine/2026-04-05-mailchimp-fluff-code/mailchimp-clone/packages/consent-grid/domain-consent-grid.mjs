...
export function createConsentGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeConsentGridWorkspace(workspace = createConsentGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createConsentGridNarratives(workspace = createConsentGridWorkspace()) {
...
export function createConsentGridCoverageGrid(workspace = createConsentGridWorkspace()) {
