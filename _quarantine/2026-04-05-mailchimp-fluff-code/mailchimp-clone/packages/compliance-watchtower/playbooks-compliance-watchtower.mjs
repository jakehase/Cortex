...
export function createComplianceWatchtowerPlaybooks() {
...
export function createComplianceWatchtowerDecisionDeck() {
...
export function createComplianceWatchtowerEscalationMoments() {
