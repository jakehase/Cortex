...
export function createComplianceWatchtowerPolicies(overrides = {}) {
...
export function validateComplianceWatchtowerPolicies(policies = createComplianceWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeComplianceWatchtowerPolicies(policies = createComplianceWatchtowerPolicies()) {
  return {
...
export function createComplianceWatchtowerEscalationDeck(policies = createComplianceWatchtowerPolicies()) {
