...
export function createCustomerDossierReportCards() {
...
export function createCustomerDossierReviewPackets() {
...
export function summarizeCustomerDossierReporting() {
  const cards = createCustomerDossierReportCards();
  const packets = createCustomerDossierReviewPackets();
  return {
