...
export function createCustomerDossierPolicies(overrides = {}) {
...
export function validateCustomerDossierPolicies(policies = createCustomerDossierPolicies()) {
  const issues = [];
...
export function summarizeCustomerDossierPolicies(policies = createCustomerDossierPolicies()) {
  return {
...
export function createCustomerDossierEscalationDeck(policies = createCustomerDossierPolicies()) {
