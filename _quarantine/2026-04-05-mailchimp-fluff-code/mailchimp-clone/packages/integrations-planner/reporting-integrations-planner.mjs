...
export function createIntegrationsPlannerReportCards() {
...
export function createIntegrationsPlannerReviewPackets() {
...
export function summarizeIntegrationsPlannerReporting() {
  const cards = createIntegrationsPlannerReportCards();
  const packets = createIntegrationsPlannerReviewPackets();
  return {
