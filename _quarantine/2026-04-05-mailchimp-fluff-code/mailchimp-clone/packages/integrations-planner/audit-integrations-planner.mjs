...
export function createIntegrationsPlannerAuditTrail() {
...
export function createIntegrationsPlannerEvidenceManifest() {
...
export function createIntegrationsPlannerReadinessAttestation() {
  const auditTrail = createIntegrationsPlannerAuditTrail();
  return {
