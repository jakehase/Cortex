...
export function createCustomerIndexPolicies(overrides = {}) {
...
export function validateCustomerIndexPolicies(policies = createCustomerIndexPolicies()) {
  const issues = [];
...
export function summarizeCustomerIndexPolicies(policies = createCustomerIndexPolicies()) {
  return {
...
export function createCustomerIndexEscalationDeck(policies = createCustomerIndexPolicies()) {
