...
export function createLocalizationConsoleAuditTrail() {
...
export function createLocalizationConsoleEvidenceManifest() {
...
export function createLocalizationConsoleReadinessAttestation() {
  const auditTrail = createLocalizationConsoleAuditTrail();
  return {
