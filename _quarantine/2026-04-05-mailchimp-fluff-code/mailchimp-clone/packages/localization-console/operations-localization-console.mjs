...
export function createLocalizationConsoleOperationsBoard() {
...
export function createLocalizationConsoleShiftChecklist() {
...
export function createLocalizationConsoleIncidentDeck() {
