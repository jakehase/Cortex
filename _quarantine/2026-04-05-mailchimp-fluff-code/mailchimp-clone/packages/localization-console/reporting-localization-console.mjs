...
export function createLocalizationConsoleReportCards() {
...
export function createLocalizationConsoleReviewPackets() {
...
export function summarizeLocalizationConsoleReporting() {
  const cards = createLocalizationConsoleReportCards();
  const packets = createLocalizationConsoleReviewPackets();
  return {
