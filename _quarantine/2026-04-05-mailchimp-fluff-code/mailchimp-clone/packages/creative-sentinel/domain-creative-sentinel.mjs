...
export function createCreativeSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCreativeSentinelWorkspace(workspace = createCreativeSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createCreativeSentinelNarratives(workspace = createCreativeSentinelWorkspace()) {
...
export function createCreativeSentinelCoverageGrid(workspace = createCreativeSentinelWorkspace()) {
