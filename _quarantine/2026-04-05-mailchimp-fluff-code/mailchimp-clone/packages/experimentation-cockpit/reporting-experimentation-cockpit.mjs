...
export function createExperimentationCockpitReportCards() {
...
export function createExperimentationCockpitReviewPackets() {
...
export function summarizeExperimentationCockpitReporting() {
  const cards = createExperimentationCockpitReportCards();
  const packets = createExperimentationCockpitReviewPackets();
  return {
