...
export function createExperimentationCockpitFixtures() {
  return {
    accounts: [
...
export function summarizeExperimentationCockpitFixtures(fixtures = createExperimentationCockpitFixtures()) {
  return {
...
export function createExperimentationCockpitDemoInputs() {
  return {
