...
export function createAcquisitionNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionNotebookWorkspace(workspace = createAcquisitionNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionNotebookNarratives(workspace = createAcquisitionNotebookWorkspace()) {
...
export function createAcquisitionNotebookCoverageGrid(workspace = createAcquisitionNotebookWorkspace()) {
