...
export function createAcquisitionNotebookPolicies(overrides = {}) {
...
export function validateAcquisitionNotebookPolicies(policies = createAcquisitionNotebookPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionNotebookPolicies(policies = createAcquisitionNotebookPolicies()) {
  return {
...
export function createAcquisitionNotebookEscalationDeck(policies = createAcquisitionNotebookPolicies()) {
