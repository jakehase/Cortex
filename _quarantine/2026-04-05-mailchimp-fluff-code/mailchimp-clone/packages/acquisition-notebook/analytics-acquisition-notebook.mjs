...
export function createAcquisitionNotebookAnalyticsTimeline() {
...
export function createAcquisitionNotebookForecastEnvelope() {
...
export function createAcquisitionNotebookExceptionLedger() {
...
export function summarizeAcquisitionNotebookAnalytics() {
  const timeline = createAcquisitionNotebookAnalyticsTimeline();
  const forecast = createAcquisitionNotebookForecastEnvelope();
  return {
