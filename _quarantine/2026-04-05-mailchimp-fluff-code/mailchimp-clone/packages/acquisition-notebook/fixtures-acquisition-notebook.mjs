...
export function createAcquisitionNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeAcquisitionNotebookFixtures(fixtures = createAcquisitionNotebookFixtures()) {
  return {
...
export function createAcquisitionNotebookDemoInputs() {
  return {
