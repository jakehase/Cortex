...
export function createLocalizationLedgerAuditTrail() {
...
export function createLocalizationLedgerEvidenceManifest() {
...
export function createLocalizationLedgerReadinessAttestation() {
  const auditTrail = createLocalizationLedgerAuditTrail();
  return {
