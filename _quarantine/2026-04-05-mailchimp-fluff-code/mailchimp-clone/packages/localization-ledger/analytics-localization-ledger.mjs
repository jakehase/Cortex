...
export function createLocalizationLedgerAnalyticsTimeline() {
...
export function createLocalizationLedgerForecastEnvelope() {
...
export function createLocalizationLedgerExceptionLedger() {
...
export function summarizeLocalizationLedgerAnalytics() {
  const timeline = createLocalizationLedgerAnalyticsTimeline();
  const forecast = createLocalizationLedgerForecastEnvelope();
  return {
