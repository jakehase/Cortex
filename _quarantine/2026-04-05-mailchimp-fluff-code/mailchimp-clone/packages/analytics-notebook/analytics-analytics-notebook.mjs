...
export function createAnalyticsNotebookAnalyticsTimeline() {
...
export function createAnalyticsNotebookForecastEnvelope() {
...
export function createAnalyticsNotebookExceptionLedger() {
...
export function summarizeAnalyticsNotebookAnalytics() {
  const timeline = createAnalyticsNotebookAnalyticsTimeline();
  const forecast = createAnalyticsNotebookForecastEnvelope();
  return {
