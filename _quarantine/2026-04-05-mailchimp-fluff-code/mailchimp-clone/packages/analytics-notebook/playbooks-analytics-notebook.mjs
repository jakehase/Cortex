...
export function createAnalyticsNotebookPlaybooks() {
...
export function createAnalyticsNotebookDecisionDeck() {
...
export function createAnalyticsNotebookEscalationMoments() {
