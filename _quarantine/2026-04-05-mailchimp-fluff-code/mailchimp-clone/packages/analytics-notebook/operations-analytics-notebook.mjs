...
export function createAnalyticsNotebookOperationsBoard() {
...
export function createAnalyticsNotebookShiftChecklist() {
...
export function createAnalyticsNotebookIncidentDeck() {
