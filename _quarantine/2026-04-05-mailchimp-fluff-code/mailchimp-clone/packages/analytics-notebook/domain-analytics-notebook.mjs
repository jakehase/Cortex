...
export function createAnalyticsNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsNotebookWorkspace(workspace = createAnalyticsNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsNotebookNarratives(workspace = createAnalyticsNotebookWorkspace()) {
...
export function createAnalyticsNotebookCoverageGrid(workspace = createAnalyticsNotebookWorkspace()) {
