...
export function createActivationIndexAnalyticsTimeline() {
...
export function createActivationIndexForecastEnvelope() {
...
export function createActivationIndexExceptionLedger() {
...
export function summarizeActivationIndexAnalytics() {
  const timeline = createActivationIndexAnalyticsTimeline();
  const forecast = createActivationIndexForecastEnvelope();
  return {
