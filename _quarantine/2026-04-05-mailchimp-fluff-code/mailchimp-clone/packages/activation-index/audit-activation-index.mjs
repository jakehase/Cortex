...
export function createActivationIndexAuditTrail() {
...
export function createActivationIndexEvidenceManifest() {
...
export function createActivationIndexReadinessAttestation() {
  const auditTrail = createActivationIndexAuditTrail();
  return {
