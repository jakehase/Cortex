const MODULE = {
  ...
  "focus": "Activation Index covers onboarding readiness, first-value motion, and kickoff momentum through searchable summaries and coverage catalogs.",
...
export function createActivationIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationIndexWorkspace(workspace = createActivationIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationIndexNarratives(workspace = createActivationIndexWorkspace()) {
...
export function createActivationIndexCoverageGrid(workspace = createActivationIndexWorkspace()) {
