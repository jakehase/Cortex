...
export function createActivationFoundryAnalyticsTimeline() {
...
export function createActivationFoundryForecastEnvelope() {
...
export function createActivationFoundryExceptionLedger() {
...
export function summarizeActivationFoundryAnalytics() {
  const timeline = createActivationFoundryAnalyticsTimeline();
  const forecast = createActivationFoundryForecastEnvelope();
  return {
