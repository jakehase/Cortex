...
export function createActivationFoundryOperationsBoard() {
...
export function createActivationFoundryShiftChecklist() {
...
export function createActivationFoundryIncidentDeck() {
