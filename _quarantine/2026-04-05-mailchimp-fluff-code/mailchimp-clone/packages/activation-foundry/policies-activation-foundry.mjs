...
export function createActivationFoundryPolicies(overrides = {}) {
...
export function validateActivationFoundryPolicies(policies = createActivationFoundryPolicies()) {
  const issues = [];
...
export function summarizeActivationFoundryPolicies(policies = createActivationFoundryPolicies()) {
  return {
...
export function createActivationFoundryEscalationDeck(policies = createActivationFoundryPolicies()) {
