...
export function createBenchmarkExchangeReportCards() {
...
export function createBenchmarkExchangeReviewPackets() {
...
export function summarizeBenchmarkExchangeReporting() {
  const cards = createBenchmarkExchangeReportCards();
  const packets = createBenchmarkExchangeReviewPackets();
  return {
