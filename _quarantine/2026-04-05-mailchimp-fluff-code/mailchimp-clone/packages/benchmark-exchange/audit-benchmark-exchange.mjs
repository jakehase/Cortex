...
export function createBenchmarkExchangeAuditTrail() {
...
export function createBenchmarkExchangeEvidenceManifest() {
...
export function createBenchmarkExchangeReadinessAttestation() {
  const auditTrail = createBenchmarkExchangeAuditTrail();
  return {
