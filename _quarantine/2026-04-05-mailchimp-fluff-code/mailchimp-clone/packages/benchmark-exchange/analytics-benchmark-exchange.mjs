...
export function createBenchmarkExchangeAnalyticsTimeline() {
...
export function createBenchmarkExchangeForecastEnvelope() {
...
export function createBenchmarkExchangeExceptionLedger() {
...
export function summarizeBenchmarkExchangeAnalytics() {
  const timeline = createBenchmarkExchangeAnalyticsTimeline();
  const forecast = createBenchmarkExchangeForecastEnvelope();
  return {
