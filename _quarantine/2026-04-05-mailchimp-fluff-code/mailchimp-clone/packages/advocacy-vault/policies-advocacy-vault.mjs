...
export function createAdvocacyVaultPolicies(overrides = {}) {
...
export function validateAdvocacyVaultPolicies(policies = createAdvocacyVaultPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyVaultPolicies(policies = createAdvocacyVaultPolicies()) {
  return {
...
export function createAdvocacyVaultEscalationDeck(policies = createAdvocacyVaultPolicies()) {
