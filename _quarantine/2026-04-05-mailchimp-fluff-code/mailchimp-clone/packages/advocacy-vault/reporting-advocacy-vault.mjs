...
export function createAdvocacyVaultReportCards() {
...
export function createAdvocacyVaultReviewPackets() {
...
export function summarizeAdvocacyVaultReporting() {
  const cards = createAdvocacyVaultReportCards();
  const packets = createAdvocacyVaultReviewPackets();
  return {
