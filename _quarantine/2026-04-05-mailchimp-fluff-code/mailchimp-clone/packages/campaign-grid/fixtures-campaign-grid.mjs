...
export function createCampaignGridFixtures() {
  return {
    accounts: [
...
export function summarizeCampaignGridFixtures(fixtures = createCampaignGridFixtures()) {
  return {
...
export function createCampaignGridDemoInputs() {
  return {
