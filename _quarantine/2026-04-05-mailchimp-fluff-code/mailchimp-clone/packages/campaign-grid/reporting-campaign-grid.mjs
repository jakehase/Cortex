...
export function createCampaignGridReportCards() {
...
export function createCampaignGridReviewPackets() {
...
export function summarizeCampaignGridReporting() {
  const cards = createCampaignGridReportCards();
  const packets = createCampaignGridReviewPackets();
  return {
