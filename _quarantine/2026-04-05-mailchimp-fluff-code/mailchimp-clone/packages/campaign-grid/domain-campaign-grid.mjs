...
export function createCampaignGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCampaignGridWorkspace(workspace = createCampaignGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createCampaignGridNarratives(workspace = createCampaignGridWorkspace()) {
...
export function createCampaignGridCoverageGrid(workspace = createCampaignGridWorkspace()) {
