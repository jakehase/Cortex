...
export function createLoyaltyPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyPlannerWorkspace(workspace = createLoyaltyPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyPlannerNarratives(workspace = createLoyaltyPlannerWorkspace()) {
...
export function createLoyaltyPlannerCoverageGrid(workspace = createLoyaltyPlannerWorkspace()) {
