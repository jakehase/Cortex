...
export function createLoyaltyPlannerFixtures() {
  return {
    accounts: [
...
export function summarizeLoyaltyPlannerFixtures(fixtures = createLoyaltyPlannerFixtures()) {
  return {
...
export function createLoyaltyPlannerDemoInputs() {
  return {
