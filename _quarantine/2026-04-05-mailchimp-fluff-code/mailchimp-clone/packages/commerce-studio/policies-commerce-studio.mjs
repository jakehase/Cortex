...
export function createCommerceStudioPolicies(overrides = {}) {
...
export function validateCommerceStudioPolicies(policies = createCommerceStudioPolicies()) {
  const issues = [];
...
export function summarizeCommerceStudioPolicies(policies = createCommerceStudioPolicies()) {
  return {
...
export function createCommerceStudioEscalationDeck(policies = createCommerceStudioPolicies()) {
