...
export function createCommerceStudioReportCards() {
...
export function createCommerceStudioReviewPackets() {
...
export function summarizeCommerceStudioReporting() {
  const cards = createCommerceStudioReportCards();
  const packets = createCommerceStudioReviewPackets();
  return {
