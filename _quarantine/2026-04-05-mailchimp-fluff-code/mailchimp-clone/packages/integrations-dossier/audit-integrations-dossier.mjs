...
export function createIntegrationsDossierAuditTrail() {
...
export function createIntegrationsDossierEvidenceManifest() {
...
export function createIntegrationsDossierReadinessAttestation() {
  const auditTrail = createIntegrationsDossierAuditTrail();
  return {
