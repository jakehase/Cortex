...
export function createIntegrationsDossierReportCards() {
...
export function createIntegrationsDossierReviewPackets() {
...
export function summarizeIntegrationsDossierReporting() {
  const cards = createIntegrationsDossierReportCards();
  const packets = createIntegrationsDossierReviewPackets();
  return {
