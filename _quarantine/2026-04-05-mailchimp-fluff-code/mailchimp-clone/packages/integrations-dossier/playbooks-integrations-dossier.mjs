...
export function createIntegrationsDossierPlaybooks() {
...
export function createIntegrationsDossierDecisionDeck() {
...
export function createIntegrationsDossierEscalationMoments() {
