...
export function createCampaignStudioAuditTrail() {
...
export function createCampaignStudioEvidenceManifest() {
...
export function createCampaignStudioReadinessAttestation() {
  const auditTrail = createCampaignStudioAuditTrail();
  return {
