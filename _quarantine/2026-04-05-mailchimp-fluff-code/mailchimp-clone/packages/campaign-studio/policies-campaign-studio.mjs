...
export function createCampaignStudioPolicies(overrides = {}) {
...
export function validateCampaignStudioPolicies(policies = createCampaignStudioPolicies()) {
  const issues = [];
...
export function summarizeCampaignStudioPolicies(policies = createCampaignStudioPolicies()) {
  return {
...
export function createCampaignStudioEscalationDeck(policies = createCampaignStudioPolicies()) {
