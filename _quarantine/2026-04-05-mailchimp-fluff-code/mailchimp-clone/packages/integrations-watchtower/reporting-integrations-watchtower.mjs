...
export function createIntegrationsWatchtowerReportCards() {
...
export function createIntegrationsWatchtowerReviewPackets() {
...
export function summarizeIntegrationsWatchtowerReporting() {
  const cards = createIntegrationsWatchtowerReportCards();
  const packets = createIntegrationsWatchtowerReviewPackets();
  return {
