...
export function createActivationAdvisorPolicies(overrides = {}) {
...
export function validateActivationAdvisorPolicies(policies = createActivationAdvisorPolicies()) {
  const issues = [];
...
export function summarizeActivationAdvisorPolicies(policies = createActivationAdvisorPolicies()) {
  return {
...
export function createActivationAdvisorEscalationDeck(policies = createActivationAdvisorPolicies()) {
