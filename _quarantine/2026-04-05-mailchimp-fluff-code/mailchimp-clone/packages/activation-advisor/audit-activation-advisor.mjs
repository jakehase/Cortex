...
export function createActivationAdvisorAuditTrail() {
...
export function createActivationAdvisorEvidenceManifest() {
...
export function createActivationAdvisorReadinessAttestation() {
  const auditTrail = createActivationAdvisorAuditTrail();
  return {
