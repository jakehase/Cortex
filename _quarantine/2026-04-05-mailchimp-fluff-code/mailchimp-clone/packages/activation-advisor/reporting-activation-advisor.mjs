...
export function createActivationAdvisorReportCards() {
...
export function createActivationAdvisorReviewPackets() {
...
export function summarizeActivationAdvisorReporting() {
  const cards = createActivationAdvisorReportCards();
  const packets = createActivationAdvisorReviewPackets();
  return {
