...
export function createActivationAdvisorAnalyticsTimeline() {
...
export function createActivationAdvisorForecastEnvelope() {
...
export function createActivationAdvisorExceptionLedger() {
...
export function summarizeActivationAdvisorAnalytics() {
  const timeline = createActivationAdvisorAnalyticsTimeline();
  const forecast = createActivationAdvisorForecastEnvelope();
  return {
