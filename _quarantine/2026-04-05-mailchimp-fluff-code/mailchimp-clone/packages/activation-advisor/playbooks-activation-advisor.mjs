...
export function createActivationAdvisorPlaybooks() {
...
export function createActivationAdvisorDecisionDeck() {
...
export function createActivationAdvisorEscalationMoments() {
