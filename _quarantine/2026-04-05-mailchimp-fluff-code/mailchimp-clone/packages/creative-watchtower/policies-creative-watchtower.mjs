...
export function createCreativeWatchtowerPolicies(overrides = {}) {
...
export function validateCreativeWatchtowerPolicies(policies = createCreativeWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeCreativeWatchtowerPolicies(policies = createCreativeWatchtowerPolicies()) {
  return {
...
export function createCreativeWatchtowerEscalationDeck(policies = createCreativeWatchtowerPolicies()) {
