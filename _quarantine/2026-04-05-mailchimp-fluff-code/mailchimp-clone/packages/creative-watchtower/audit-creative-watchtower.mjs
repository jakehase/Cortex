...
export function createCreativeWatchtowerAuditTrail() {
...
export function createCreativeWatchtowerEvidenceManifest() {
...
export function createCreativeWatchtowerReadinessAttestation() {
  const auditTrail = createCreativeWatchtowerAuditTrail();
  return {
