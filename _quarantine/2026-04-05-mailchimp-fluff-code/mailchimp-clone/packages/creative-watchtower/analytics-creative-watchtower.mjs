...
export function createCreativeWatchtowerAnalyticsTimeline() {
...
export function createCreativeWatchtowerForecastEnvelope() {
...
export function createCreativeWatchtowerExceptionLedger() {
...
export function summarizeCreativeWatchtowerAnalytics() {
  const timeline = createCreativeWatchtowerAnalyticsTimeline();
  const forecast = createCreativeWatchtowerForecastEnvelope();
  return {
