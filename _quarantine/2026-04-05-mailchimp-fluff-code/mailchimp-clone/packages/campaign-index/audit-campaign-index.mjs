...
export function createCampaignIndexAuditTrail() {
...
export function createCampaignIndexEvidenceManifest() {
...
export function createCampaignIndexReadinessAttestation() {
  const auditTrail = createCampaignIndexAuditTrail();
  return {
