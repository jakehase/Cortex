...
export function createCampaignIndexAnalyticsTimeline() {
...
export function createCampaignIndexForecastEnvelope() {
...
export function createCampaignIndexExceptionLedger() {
...
export function summarizeCampaignIndexAnalytics() {
  const timeline = createCampaignIndexAnalyticsTimeline();
  const forecast = createCampaignIndexForecastEnvelope();
  return {
