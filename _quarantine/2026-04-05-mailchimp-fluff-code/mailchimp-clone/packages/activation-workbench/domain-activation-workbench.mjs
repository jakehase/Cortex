...
export function createActivationWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationWorkbenchWorkspace(workspace = createActivationWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationWorkbenchNarratives(workspace = createActivationWorkbenchWorkspace()) {
...
export function createActivationWorkbenchCoverageGrid(workspace = createActivationWorkbenchWorkspace()) {
