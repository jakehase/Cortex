...
export function createActivationScorecardAnalyticsTimeline() {
...
export function createActivationScorecardForecastEnvelope() {
...
export function createActivationScorecardExceptionLedger() {
...
export function summarizeActivationScorecardAnalytics() {
  const timeline = createActivationScorecardAnalyticsTimeline();
  const forecast = createActivationScorecardForecastEnvelope();
  return {
