...
export function createActivationScorecardOperationsBoard() {
...
export function createActivationScorecardShiftChecklist() {
...
export function createActivationScorecardIncidentDeck() {
