...
export function createActivationScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationScorecardWorkspace(workspace = createActivationScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationScorecardNarratives(workspace = createActivationScorecardWorkspace()) {
...
export function createActivationScorecardCoverageGrid(workspace = createActivationScorecardWorkspace()) {
