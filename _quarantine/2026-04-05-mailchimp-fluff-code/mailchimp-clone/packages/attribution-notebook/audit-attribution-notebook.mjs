...
export function createAttributionNotebookAuditTrail() {
...
export function createAttributionNotebookEvidenceManifest() {
...
export function createAttributionNotebookReadinessAttestation() {
  const auditTrail = createAttributionNotebookAuditTrail();
  return {
