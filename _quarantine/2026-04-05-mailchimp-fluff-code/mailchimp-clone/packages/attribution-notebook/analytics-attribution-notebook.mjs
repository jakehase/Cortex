...
export function createAttributionNotebookAnalyticsTimeline() {
...
export function createAttributionNotebookForecastEnvelope() {
...
export function createAttributionNotebookExceptionLedger() {
...
export function summarizeAttributionNotebookAnalytics() {
  const timeline = createAttributionNotebookAnalyticsTimeline();
  const forecast = createAttributionNotebookForecastEnvelope();
  return {
