...
export function createAnalyticsExchangeReportCards() {
...
export function createAnalyticsExchangeReviewPackets() {
...
export function summarizeAnalyticsExchangeReporting() {
  const cards = createAnalyticsExchangeReportCards();
  const packets = createAnalyticsExchangeReviewPackets();
  return {
