...
export function createAnalyticsExchangeAuditTrail() {
...
export function createAnalyticsExchangeEvidenceManifest() {
...
export function createAnalyticsExchangeReadinessAttestation() {
  const auditTrail = createAnalyticsExchangeAuditTrail();
  return {
