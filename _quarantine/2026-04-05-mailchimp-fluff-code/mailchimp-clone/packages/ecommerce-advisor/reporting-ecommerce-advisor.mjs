...
export function createEcommerceAdvisorReportCards() {
...
export function createEcommerceAdvisorReviewPackets() {
...
export function summarizeEcommerceAdvisorReporting() {
  const cards = createEcommerceAdvisorReportCards();
  const packets = createEcommerceAdvisorReviewPackets();
  return {
