...
export function createEcommerceAdvisorPolicies(overrides = {}) {
...
export function validateEcommerceAdvisorPolicies(policies = createEcommerceAdvisorPolicies()) {
  const issues = [];
...
export function summarizeEcommerceAdvisorPolicies(policies = createEcommerceAdvisorPolicies()) {
  return {
...
export function createEcommerceAdvisorEscalationDeck(policies = createEcommerceAdvisorPolicies()) {
