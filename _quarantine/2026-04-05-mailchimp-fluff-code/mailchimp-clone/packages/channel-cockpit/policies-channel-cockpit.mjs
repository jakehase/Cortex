...
export function createChannelCockpitPolicies(overrides = {}) {
...
export function validateChannelCockpitPolicies(policies = createChannelCockpitPolicies()) {
  const issues = [];
...
export function summarizeChannelCockpitPolicies(policies = createChannelCockpitPolicies()) {
  return {
...
export function createChannelCockpitEscalationDeck(policies = createChannelCockpitPolicies()) {
