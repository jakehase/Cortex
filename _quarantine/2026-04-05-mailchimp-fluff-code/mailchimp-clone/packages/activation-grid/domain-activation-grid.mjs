const MODULE = {
  ...
  "surfaceTitle": "Grid",
  "routeSegment": "grid",
  "title": "Activation Grid",
  "focus": "Activation Grid covers onboarding readiness, first-value motion, and kickoff momentum through portfolio views and cross-workspace rollups.",
...
export function createActivationGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationGridWorkspace(workspace = createActivationGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationGridNarratives(workspace = createActivationGridWorkspace()) {
...
export function createActivationGridCoverageGrid(workspace = createActivationGridWorkspace()) {
