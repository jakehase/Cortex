...
export function createActivationGridAnalyticsTimeline() {
...
export function createActivationGridForecastEnvelope() {
...
export function createActivationGridExceptionLedger() {
...
export function summarizeActivationGridAnalytics() {
  const timeline = createActivationGridAnalyticsTimeline();
  const forecast = createActivationGridForecastEnvelope();
  return {
