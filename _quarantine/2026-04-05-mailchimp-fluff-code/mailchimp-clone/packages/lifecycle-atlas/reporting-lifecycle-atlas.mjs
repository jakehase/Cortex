...
export function createLifecycleAtlasReportCards() {
...
export function createLifecycleAtlasReviewPackets() {
...
export function summarizeLifecycleAtlasReporting() {
  const cards = createLifecycleAtlasReportCards();
  const packets = createLifecycleAtlasReviewPackets();
  return {
