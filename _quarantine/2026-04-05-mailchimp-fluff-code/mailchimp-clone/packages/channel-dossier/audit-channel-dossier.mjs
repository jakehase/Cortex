...
export function createChannelDossierAuditTrail() {
...
export function createChannelDossierEvidenceManifest() {
...
export function createChannelDossierReadinessAttestation() {
  const auditTrail = createChannelDossierAuditTrail();
  return {
