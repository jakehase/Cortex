...
export function createChannelDossierReportCards() {
...
export function createChannelDossierReviewPackets() {
...
export function summarizeChannelDossierReporting() {
  const cards = createChannelDossierReportCards();
  const packets = createChannelDossierReviewPackets();
  return {
