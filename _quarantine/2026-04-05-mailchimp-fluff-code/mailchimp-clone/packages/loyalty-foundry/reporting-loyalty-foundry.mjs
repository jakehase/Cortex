...
export function createLoyaltyFoundryReportCards() {
...
export function createLoyaltyFoundryReviewPackets() {
...
export function summarizeLoyaltyFoundryReporting() {
  const cards = createLoyaltyFoundryReportCards();
  const packets = createLoyaltyFoundryReviewPackets();
  return {
