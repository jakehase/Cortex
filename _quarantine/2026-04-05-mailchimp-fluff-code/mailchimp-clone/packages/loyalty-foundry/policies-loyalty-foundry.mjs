...
export function createLoyaltyFoundryPolicies(overrides = {}) {
...
export function validateLoyaltyFoundryPolicies(policies = createLoyaltyFoundryPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyFoundryPolicies(policies = createLoyaltyFoundryPolicies()) {
  return {
...
export function createLoyaltyFoundryEscalationDeck(policies = createLoyaltyFoundryPolicies()) {
