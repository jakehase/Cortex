...
export function createLoyaltySentinelAnalyticsTimeline() {
...
export function createLoyaltySentinelForecastEnvelope() {
...
export function createLoyaltySentinelExceptionLedger() {
...
export function summarizeLoyaltySentinelAnalytics() {
  const timeline = createLoyaltySentinelAnalyticsTimeline();
  const forecast = createLoyaltySentinelForecastEnvelope();
  return {
