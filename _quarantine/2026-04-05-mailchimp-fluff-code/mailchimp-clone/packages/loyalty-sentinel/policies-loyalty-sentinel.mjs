...
export function createLoyaltySentinelPolicies(overrides = {}) {
...
export function validateLoyaltySentinelPolicies(policies = createLoyaltySentinelPolicies()) {
  const issues = [];
...
export function summarizeLoyaltySentinelPolicies(policies = createLoyaltySentinelPolicies()) {
  return {
...
export function createLoyaltySentinelEscalationDeck(policies = createLoyaltySentinelPolicies()) {
