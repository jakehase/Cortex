...
export function createLoyaltySentinelAuditTrail() {
...
export function createLoyaltySentinelEvidenceManifest() {
...
export function createLoyaltySentinelReadinessAttestation() {
  const auditTrail = createLoyaltySentinelAuditTrail();
  return {
