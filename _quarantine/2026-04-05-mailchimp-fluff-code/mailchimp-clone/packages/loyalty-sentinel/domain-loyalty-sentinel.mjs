...
export function createLoyaltySentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltySentinelWorkspace(workspace = createLoyaltySentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltySentinelNarratives(workspace = createLoyaltySentinelWorkspace()) {
...
export function createLoyaltySentinelCoverageGrid(workspace = createLoyaltySentinelWorkspace()) {
