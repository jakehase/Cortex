...
export function createCreativePlannerReportCards() {
...
export function createCreativePlannerReviewPackets() {
...
export function summarizeCreativePlannerReporting() {
  const cards = createCreativePlannerReportCards();
  const packets = createCreativePlannerReviewPackets();
  return {
