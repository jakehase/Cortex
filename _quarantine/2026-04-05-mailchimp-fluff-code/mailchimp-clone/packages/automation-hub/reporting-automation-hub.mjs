...
export function createAutomationHubReportCards() {
...
export function createAutomationHubReviewPackets() {
...
export function summarizeAutomationHubReporting() {
  const cards = createAutomationHubReportCards();
  const packets = createAutomationHubReviewPackets();
  return {
