...
export function createAutomationHubPolicies(overrides = {}) {
...
export function validateAutomationHubPolicies(policies = createAutomationHubPolicies()) {
  const issues = [];
...
export function summarizeAutomationHubPolicies(policies = createAutomationHubPolicies()) {
  return {
...
export function createAutomationHubEscalationDeck(policies = createAutomationHubPolicies()) {
