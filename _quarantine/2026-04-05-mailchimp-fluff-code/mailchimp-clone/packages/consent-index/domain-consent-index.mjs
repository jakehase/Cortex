...
export function createConsentIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeConsentIndexWorkspace(workspace = createConsentIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createConsentIndexNarratives(workspace = createConsentIndexWorkspace()) {
...
export function createConsentIndexCoverageGrid(workspace = createConsentIndexWorkspace()) {
