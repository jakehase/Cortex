...
export function createConsentIndexReportCards() {
...
export function createConsentIndexReviewPackets() {
...
export function summarizeConsentIndexReporting() {
  const cards = createConsentIndexReportCards();
  const packets = createConsentIndexReviewPackets();
  return {
