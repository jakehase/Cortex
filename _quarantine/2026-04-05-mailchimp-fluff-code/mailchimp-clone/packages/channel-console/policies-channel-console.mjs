...
export function createChannelConsolePolicies(overrides = {}) {
...
export function validateChannelConsolePolicies(policies = createChannelConsolePolicies()) {
  const issues = [];
...
export function summarizeChannelConsolePolicies(policies = createChannelConsolePolicies()) {
  return {
...
export function createChannelConsoleEscalationDeck(policies = createChannelConsolePolicies()) {
