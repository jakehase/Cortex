...
export function createChannelConsoleReportCards() {
...
export function createChannelConsoleReviewPackets() {
...
export function summarizeChannelConsoleReporting() {
  const cards = createChannelConsoleReportCards();
  const packets = createChannelConsoleReviewPackets();
  return {
