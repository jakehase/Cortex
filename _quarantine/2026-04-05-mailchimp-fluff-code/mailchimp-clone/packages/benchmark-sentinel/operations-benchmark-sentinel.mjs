...
export function createBenchmarkSentinelOperationsBoard() {
...
export function createBenchmarkSentinelShiftChecklist() {
...
export function createBenchmarkSentinelIncidentDeck() {
