...
export function createLocalizationNotebookPlaybooks() {
...
export function createLocalizationNotebookDecisionDeck() {
...
export function createLocalizationNotebookEscalationMoments() {
