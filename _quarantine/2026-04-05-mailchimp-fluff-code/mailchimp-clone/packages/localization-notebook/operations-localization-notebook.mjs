...
export function createLocalizationNotebookOperationsBoard() {
...
export function createLocalizationNotebookShiftChecklist() {
...
export function createLocalizationNotebookIncidentDeck() {
