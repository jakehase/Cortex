...
export function createLocalizationNotebookReportCards() {
...
export function createLocalizationNotebookReviewPackets() {
...
export function summarizeLocalizationNotebookReporting() {
  const cards = createLocalizationNotebookReportCards();
  const packets = createLocalizationNotebookReviewPackets();
  return {
