const MODULE = {
  "id": "localization-notebook",
  "ordinal": 511,
  "domain": "localization",
  "surfaceId": "notebook",
  "surfaceTitle": "Notebook",
  "routeSegment": "notebook",
  "title": "Localization Notebook",
  "focus": "Localization Notebook covers regional readiness, translation coverage, and market-specific proof through working notes and experiment memory.",
  ...
  "tags": [
    ...
    "notebook",
    "trust",
    "localization-notebook-wave-seven"
  ]
};
...
export function createLocalizationNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLocalizationNotebookWorkspace(workspace = createLocalizationNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createLocalizationNotebookNarratives(workspace = createLocalizationNotebookWorkspace()) {
...
export function createLocalizationNotebookCoverageGrid(workspace = createLocalizationNotebookWorkspace()) {
