...
export function createExperimentationScorecardReportCards() {
...
export function createExperimentationScorecardReviewPackets() {
...
export function summarizeExperimentationScorecardReporting() {
  const cards = createExperimentationScorecardReportCards();
  const packets = createExperimentationScorecardReviewPackets();
  return {
