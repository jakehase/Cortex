...
export function createExperimentationScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationScorecardWorkspace(workspace = createExperimentationScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationScorecardNarratives(workspace = createExperimentationScorecardWorkspace()) {
...
export function createExperimentationScorecardCoverageGrid(workspace = createExperimentationScorecardWorkspace()) {
