...
export function createAudienceSentinelAuditTrail() {
...
export function createAudienceSentinelEvidenceManifest() {
...
export function createAudienceSentinelReadinessAttestation() {
  const auditTrail = createAudienceSentinelAuditTrail();
  return {
