...
export function createAudienceSentinelPlaybooks() {
...
export function createAudienceSentinelDecisionDeck() {
...
export function createAudienceSentinelEscalationMoments() {
