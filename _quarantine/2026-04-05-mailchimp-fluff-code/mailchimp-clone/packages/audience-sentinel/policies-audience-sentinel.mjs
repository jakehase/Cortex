...
export function createAudienceSentinelPolicies(overrides = {}) {
...
export function validateAudienceSentinelPolicies(policies = createAudienceSentinelPolicies()) {
  const issues = [];
...
export function summarizeAudienceSentinelPolicies(policies = createAudienceSentinelPolicies()) {
  return {
...
export function createAudienceSentinelEscalationDeck(policies = createAudienceSentinelPolicies()) {
