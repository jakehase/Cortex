...
export function createConsentWorkbenchAnalyticsTimeline() {
...
export function createConsentWorkbenchForecastEnvelope() {
...
export function createConsentWorkbenchExceptionLedger() {
...
export function summarizeConsentWorkbenchAnalytics() {
  const timeline = createConsentWorkbenchAnalyticsTimeline();
  const forecast = createConsentWorkbenchForecastEnvelope();
  return {
