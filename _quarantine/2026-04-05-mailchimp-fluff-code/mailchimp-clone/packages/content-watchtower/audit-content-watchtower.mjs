...
export function createContentWatchtowerAuditTrail() {
...
export function createContentWatchtowerEvidenceManifest() {
...
export function createContentWatchtowerReadinessAttestation() {
  const auditTrail = createContentWatchtowerAuditTrail();
  return {
