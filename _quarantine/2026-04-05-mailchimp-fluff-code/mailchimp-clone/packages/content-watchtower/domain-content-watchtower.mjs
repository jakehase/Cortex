...
export function createContentWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentWatchtowerWorkspace(workspace = createContentWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentWatchtowerNarratives(workspace = createContentWatchtowerWorkspace()) {
...
export function createContentWatchtowerCoverageGrid(workspace = createContentWatchtowerWorkspace()) {
