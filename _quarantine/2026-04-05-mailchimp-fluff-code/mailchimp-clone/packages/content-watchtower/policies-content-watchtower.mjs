const MODULE = {
  "id": "content-watchtower",
  "ordinal": 317,
  "domain": "content",
  "surfaceId": "watchtower",
  "surfaceTitle": "Watchtower",
  "routeSegment": "watchtower",
  "title": "Content Watchtower",
  "focus": "Content Watchtower covers content operations, packaging, and channel-specific delivery shape through oversight dashboards and escalation views.",
  "descriptor": "content operations, packaging, and channel-specific delivery shape",
  "groupId": "growth",
...
export function createContentWatchtowerPolicies(overrides = {}) {
...
export function validateContentWatchtowerPolicies(policies = createContentWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeContentWatchtowerPolicies(policies = createContentWatchtowerPolicies()) {
  return {
...
export function createContentWatchtowerEscalationDeck(policies = createContentWatchtowerPolicies()) {
