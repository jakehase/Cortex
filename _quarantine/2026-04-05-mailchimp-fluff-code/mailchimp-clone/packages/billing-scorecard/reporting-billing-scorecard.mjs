...
export function createBillingScorecardReportCards() {
...
export function createBillingScorecardReviewPackets() {
...
export function summarizeBillingScorecardReporting() {
  const cards = createBillingScorecardReportCards();
  const packets = createBillingScorecardReviewPackets();
  return {
