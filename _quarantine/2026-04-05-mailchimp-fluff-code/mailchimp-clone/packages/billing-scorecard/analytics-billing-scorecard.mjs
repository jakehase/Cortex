...
export function createBillingScorecardAnalyticsTimeline() {
...
export function createBillingScorecardForecastEnvelope() {
...
export function createBillingScorecardExceptionLedger() {
...
export function summarizeBillingScorecardAnalytics() {
  const timeline = createBillingScorecardAnalyticsTimeline();
  const forecast = createBillingScorecardForecastEnvelope();
  return {
