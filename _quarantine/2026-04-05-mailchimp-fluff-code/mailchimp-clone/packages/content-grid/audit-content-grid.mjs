...
export function createContentGridAuditTrail() {
...
export function createContentGridEvidenceManifest() {
...
export function createContentGridReadinessAttestation() {
  const auditTrail = createContentGridAuditTrail();
  return {
