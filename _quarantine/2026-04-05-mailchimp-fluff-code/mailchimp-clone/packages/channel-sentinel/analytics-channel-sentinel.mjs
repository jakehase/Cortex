...
export function createChannelSentinelAnalyticsTimeline() {
...
export function createChannelSentinelForecastEnvelope() {
...
export function createChannelSentinelExceptionLedger() {
...
export function summarizeChannelSentinelAnalytics() {
  const timeline = createChannelSentinelAnalyticsTimeline();
  const forecast = createChannelSentinelForecastEnvelope();
  return {
