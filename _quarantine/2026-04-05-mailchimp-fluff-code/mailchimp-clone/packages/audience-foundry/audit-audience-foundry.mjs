...
export function createAudienceFoundryAuditTrail() {
...
export function createAudienceFoundryEvidenceManifest() {
...
export function createAudienceFoundryReadinessAttestation() {
  const auditTrail = createAudienceFoundryAuditTrail();
  return {
