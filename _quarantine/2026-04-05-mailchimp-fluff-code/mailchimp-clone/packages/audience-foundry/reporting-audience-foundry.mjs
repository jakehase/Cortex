...
export function createAudienceFoundryReportCards() {
...
export function createAudienceFoundryReviewPackets() {
...
export function summarizeAudienceFoundryReporting() {
  const cards = createAudienceFoundryReportCards();
  const packets = createAudienceFoundryReviewPackets();
  return {
