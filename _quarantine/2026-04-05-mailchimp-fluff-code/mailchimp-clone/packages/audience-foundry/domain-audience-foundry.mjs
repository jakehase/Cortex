const MODULE = {
  ...
  "title": "Audience Foundry",
  "focus": "Audience Foundry covers audience health, segment design, and targeting durability through program building and surface composition.",
...
export function createAudienceFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceFoundryWorkspace(workspace = createAudienceFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceFoundryNarratives(workspace = createAudienceFoundryWorkspace()) {
...
export function createAudienceFoundryCoverageGrid(workspace = createAudienceFoundryWorkspace()) {
