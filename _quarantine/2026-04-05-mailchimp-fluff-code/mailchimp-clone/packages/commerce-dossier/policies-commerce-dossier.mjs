...
export function createCommerceDossierPolicies(overrides = {}) {
...
export function validateCommerceDossierPolicies(policies = createCommerceDossierPolicies()) {
  const issues = [];
...
export function summarizeCommerceDossierPolicies(policies = createCommerceDossierPolicies()) {
  return {
...
export function createCommerceDossierEscalationDeck(policies = createCommerceDossierPolicies()) {
