...
export function createDataAdvisorAuditTrail() {
...
export function createDataAdvisorEvidenceManifest() {
...
export function createDataAdvisorReadinessAttestation() {
  const auditTrail = createDataAdvisorAuditTrail();
  return {
