...
export function createDataAdvisorReportCards() {
...
export function createDataAdvisorReviewPackets() {
...
export function summarizeDataAdvisorReporting() {
  const cards = createDataAdvisorReportCards();
  const packets = createDataAdvisorReviewPackets();
  return {
