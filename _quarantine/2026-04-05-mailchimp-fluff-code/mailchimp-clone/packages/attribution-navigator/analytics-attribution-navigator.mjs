...
export function createAttributionNavigatorAnalyticsTimeline() {
...
export function createAttributionNavigatorForecastEnvelope() {
...
export function createAttributionNavigatorExceptionLedger() {
...
export function summarizeAttributionNavigatorAnalytics() {
  const timeline = createAttributionNavigatorAnalyticsTimeline();
  const forecast = createAttributionNavigatorForecastEnvelope();
  return {
