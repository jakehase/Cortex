...
export function createAttributionNavigatorOperationsBoard() {
...
export function createAttributionNavigatorShiftChecklist() {
...
export function createAttributionNavigatorIncidentDeck() {
