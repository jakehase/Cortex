...
export function createCustomerScorecardReportCards() {
...
export function createCustomerScorecardReviewPackets() {
...
export function summarizeCustomerScorecardReporting() {
  const cards = createCustomerScorecardReportCards();
  const packets = createCustomerScorecardReviewPackets();
  return {
