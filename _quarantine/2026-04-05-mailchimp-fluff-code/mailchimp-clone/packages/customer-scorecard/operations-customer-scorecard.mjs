...
export function createCustomerScorecardOperationsBoard() {
...
export function createCustomerScorecardShiftChecklist() {
...
export function createCustomerScorecardIncidentDeck() {
