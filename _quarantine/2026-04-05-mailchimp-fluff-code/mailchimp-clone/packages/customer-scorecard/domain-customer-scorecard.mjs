...
export function createCustomerScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCustomerScorecardWorkspace(workspace = createCustomerScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createCustomerScorecardNarratives(workspace = createCustomerScorecardWorkspace()) {
...
export function createCustomerScorecardCoverageGrid(workspace = createCustomerScorecardWorkspace()) {
