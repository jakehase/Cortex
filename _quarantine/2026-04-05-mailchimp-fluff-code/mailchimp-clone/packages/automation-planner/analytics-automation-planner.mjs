...
export function createAutomationPlannerAnalyticsTimeline() {
...
export function createAutomationPlannerForecastEnvelope() {
...
export function createAutomationPlannerExceptionLedger() {
...
export function summarizeAutomationPlannerAnalytics() {
  const timeline = createAutomationPlannerAnalyticsTimeline();
  const forecast = createAutomationPlannerForecastEnvelope();
  return {
