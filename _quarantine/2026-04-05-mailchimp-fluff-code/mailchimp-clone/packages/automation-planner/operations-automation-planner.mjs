...
export function createAutomationPlannerOperationsBoard() {
...
export function createAutomationPlannerShiftChecklist() {
...
export function createAutomationPlannerIncidentDeck() {
