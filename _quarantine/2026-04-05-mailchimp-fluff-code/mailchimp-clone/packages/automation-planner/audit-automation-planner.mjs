...
export function createAutomationPlannerAuditTrail() {
...
export function createAutomationPlannerEvidenceManifest() {
...
export function createAutomationPlannerReadinessAttestation() {
  const auditTrail = createAutomationPlannerAuditTrail();
  return {
