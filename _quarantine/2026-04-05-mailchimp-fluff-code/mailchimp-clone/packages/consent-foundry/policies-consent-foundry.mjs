...
export function createConsentFoundryPolicies(overrides = {}) {
...
export function validateConsentFoundryPolicies(policies = createConsentFoundryPolicies()) {
  const issues = [];
...
export function summarizeConsentFoundryPolicies(policies = createConsentFoundryPolicies()) {
  return {
...
export function createConsentFoundryEscalationDeck(policies = createConsentFoundryPolicies()) {
