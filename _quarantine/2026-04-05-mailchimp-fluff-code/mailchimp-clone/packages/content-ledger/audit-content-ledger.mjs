...
export function createContentLedgerAuditTrail() {
...
export function createContentLedgerEvidenceManifest() {
...
export function createContentLedgerReadinessAttestation() {
  const auditTrail = createContentLedgerAuditTrail();
  return {
