...
export function createContentLedgerReportCards() {
...
export function createContentLedgerReviewPackets() {
...
export function summarizeContentLedgerReporting() {
  const cards = createContentLedgerReportCards();
  const packets = createContentLedgerReviewPackets();
  return {
