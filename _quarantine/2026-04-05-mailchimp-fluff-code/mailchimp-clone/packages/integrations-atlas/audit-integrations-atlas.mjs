...
export function createIntegrationsAtlasAuditTrail() {
...
export function createIntegrationsAtlasEvidenceManifest() {
...
export function createIntegrationsAtlasReadinessAttestation() {
  const auditTrail = createIntegrationsAtlasAuditTrail();
  return {
