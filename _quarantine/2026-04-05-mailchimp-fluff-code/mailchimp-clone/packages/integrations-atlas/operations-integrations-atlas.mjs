...
export function createIntegrationsAtlasOperationsBoard() {
...
export function createIntegrationsAtlasShiftChecklist() {
...
export function createIntegrationsAtlasIncidentDeck() {
