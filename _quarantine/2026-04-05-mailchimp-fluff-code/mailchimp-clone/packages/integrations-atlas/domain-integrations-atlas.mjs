const MODULE = {
  ...
  "focus": "Integrations Atlas covers destination syncs, partner activation, and cross-platform reliability through landscape mapping and territory coverage.",
...
export function createIntegrationsAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsAtlasWorkspace(workspace = createIntegrationsAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsAtlasNarratives(workspace = createIntegrationsAtlasWorkspace()) {
...
export function createIntegrationsAtlasCoverageGrid(workspace = createIntegrationsAtlasWorkspace()) {
