...
export function createIntegrationsAtlasReportCards() {
...
export function createIntegrationsAtlasReviewPackets() {
...
export function summarizeIntegrationsAtlasReporting() {
  const cards = createIntegrationsAtlasReportCards();
  const packets = createIntegrationsAtlasReviewPackets();
  return {
