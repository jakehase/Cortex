...
export function createAdvocacyWorkbenchAuditTrail() {
...
export function createAdvocacyWorkbenchEvidenceManifest() {
...
export function createAdvocacyWorkbenchReadinessAttestation() {
  const auditTrail = createAdvocacyWorkbenchAuditTrail();
  return {
