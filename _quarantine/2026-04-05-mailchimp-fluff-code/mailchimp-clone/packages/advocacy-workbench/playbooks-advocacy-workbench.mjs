...
export function createAdvocacyWorkbenchPlaybooks() {
...
export function createAdvocacyWorkbenchDecisionDeck() {
...
export function createAdvocacyWorkbenchEscalationMoments() {
