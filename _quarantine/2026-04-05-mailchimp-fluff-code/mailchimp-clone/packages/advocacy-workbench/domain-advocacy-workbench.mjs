const MODULE = {
  "id": "advocacy-workbench",
  "ordinal": 60,
  "domain": "advocacy",
  "surfaceId": "workbench",
  "surfaceTitle": "Workbench",
  "routeSegment": "workbench",
  "title": "Advocacy Workbench",
  "focus": "Advocacy Workbench covers customer champions, referral readiness, and proof-sharing loops through hands-on workflows and analyst tooling.",
...
export function createAdvocacyWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyWorkbenchWorkspace(workspace = createAdvocacyWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyWorkbenchNarratives(workspace = createAdvocacyWorkbenchWorkspace()) {
...
export function createAdvocacyWorkbenchCoverageGrid(workspace = createAdvocacyWorkbenchWorkspace()) {
