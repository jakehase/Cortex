...
export function createAdvocacyWorkbenchPolicies(overrides = {}) {
...
export function validateAdvocacyWorkbenchPolicies(policies = createAdvocacyWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyWorkbenchPolicies(policies = createAdvocacyWorkbenchPolicies()) {
  return {
...
export function createAdvocacyWorkbenchEscalationDeck(policies = createAdvocacyWorkbenchPolicies()) {
