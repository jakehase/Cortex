...
export function createCustomerAtlasPolicies(overrides = {}) {
...
export function validateCustomerAtlasPolicies(policies = createCustomerAtlasPolicies()) {
  const issues = [];
...
export function summarizeCustomerAtlasPolicies(policies = createCustomerAtlasPolicies()) {
  return {
...
export function createCustomerAtlasEscalationDeck(policies = createCustomerAtlasPolicies()) {
