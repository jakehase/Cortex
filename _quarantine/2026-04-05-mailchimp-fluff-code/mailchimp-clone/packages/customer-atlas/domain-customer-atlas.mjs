...
export function createCustomerAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCustomerAtlasWorkspace(workspace = createCustomerAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createCustomerAtlasNarratives(workspace = createCustomerAtlasWorkspace()) {
...
export function createCustomerAtlasCoverageGrid(workspace = createCustomerAtlasWorkspace()) {
