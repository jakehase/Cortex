...
export function createCustomerAtlasReportCards() {
...
export function createCustomerAtlasReviewPackets() {
...
export function summarizeCustomerAtlasReporting() {
  const cards = createCustomerAtlasReportCards();
  const packets = createCustomerAtlasReviewPackets();
  return {
