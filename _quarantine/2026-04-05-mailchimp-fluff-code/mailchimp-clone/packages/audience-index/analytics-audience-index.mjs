...
export function createAudienceIndexAnalyticsTimeline() {
...
export function createAudienceIndexForecastEnvelope() {
...
export function createAudienceIndexExceptionLedger() {
...
export function summarizeAudienceIndexAnalytics() {
  const timeline = createAudienceIndexAnalyticsTimeline();
  const forecast = createAudienceIndexForecastEnvelope();
  return {
