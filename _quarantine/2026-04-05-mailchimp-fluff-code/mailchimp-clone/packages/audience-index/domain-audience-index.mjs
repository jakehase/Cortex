...
export function createAudienceIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceIndexWorkspace(workspace = createAudienceIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceIndexNarratives(workspace = createAudienceIndexWorkspace()) {
...
export function createAudienceIndexCoverageGrid(workspace = createAudienceIndexWorkspace()) {
