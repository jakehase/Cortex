...
export function createAudienceIndexAuditTrail() {
...
export function createAudienceIndexEvidenceManifest() {
...
export function createAudienceIndexReadinessAttestation() {
  const auditTrail = createAudienceIndexAuditTrail();
  return {
