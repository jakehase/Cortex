...
export function createLifecycleWatchtowerPolicies(overrides = {}) {
...
export function validateLifecycleWatchtowerPolicies(policies = createLifecycleWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeLifecycleWatchtowerPolicies(policies = createLifecycleWatchtowerPolicies()) {
  return {
...
export function createLifecycleWatchtowerEscalationDeck(policies = createLifecycleWatchtowerPolicies()) {
