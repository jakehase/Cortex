...
export function createLifecycleWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleWatchtowerWorkspace(workspace = createLifecycleWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleWatchtowerNarratives(workspace = createLifecycleWatchtowerWorkspace()) {
...
export function createLifecycleWatchtowerCoverageGrid(workspace = createLifecycleWatchtowerWorkspace()) {
