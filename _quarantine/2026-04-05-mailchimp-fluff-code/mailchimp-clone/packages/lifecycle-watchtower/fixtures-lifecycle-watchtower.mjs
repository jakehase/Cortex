...
export function createLifecycleWatchtowerFixtures() {
  return {
    accounts: [
...
export function summarizeLifecycleWatchtowerFixtures(fixtures = createLifecycleWatchtowerFixtures()) {
  return {
...
export function createLifecycleWatchtowerDemoInputs() {
  return {
