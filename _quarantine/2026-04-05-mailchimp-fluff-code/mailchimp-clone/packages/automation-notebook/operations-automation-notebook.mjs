...
export function createAutomationNotebookOperationsBoard() {
...
export function createAutomationNotebookShiftChecklist() {
...
export function createAutomationNotebookIncidentDeck() {
