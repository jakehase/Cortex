...
export function createAutomationNotebookPolicies(overrides = {}) {
...
export function validateAutomationNotebookPolicies(policies = createAutomationNotebookPolicies()) {
  const issues = [];
...
export function summarizeAutomationNotebookPolicies(policies = createAutomationNotebookPolicies()) {
  return {
...
export function createAutomationNotebookEscalationDeck(policies = createAutomationNotebookPolicies()) {
