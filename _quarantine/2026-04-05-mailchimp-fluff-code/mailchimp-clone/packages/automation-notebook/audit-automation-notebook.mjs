...
export function createAutomationNotebookAuditTrail() {
...
export function createAutomationNotebookEvidenceManifest() {
...
export function createAutomationNotebookReadinessAttestation() {
  const auditTrail = createAutomationNotebookAuditTrail();
  return {
