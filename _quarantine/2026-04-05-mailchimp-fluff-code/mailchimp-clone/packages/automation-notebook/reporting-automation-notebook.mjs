...
export function createAutomationNotebookReportCards() {
...
export function createAutomationNotebookReviewPackets() {
...
export function summarizeAutomationNotebookReporting() {
  const cards = createAutomationNotebookReportCards();
  const packets = createAutomationNotebookReviewPackets();
  return {
