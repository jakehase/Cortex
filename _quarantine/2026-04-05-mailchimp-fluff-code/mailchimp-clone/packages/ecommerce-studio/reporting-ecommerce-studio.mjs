...
export function createEcommerceStudioReportCards() {
...
export function createEcommerceStudioReviewPackets() {
...
export function summarizeEcommerceStudioReporting() {
  const cards = createEcommerceStudioReportCards();
  const packets = createEcommerceStudioReviewPackets();
  return {
