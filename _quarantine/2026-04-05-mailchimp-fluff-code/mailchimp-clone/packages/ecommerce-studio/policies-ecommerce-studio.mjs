...
export function createEcommerceStudioPolicies(overrides = {}) {
...
export function validateEcommerceStudioPolicies(policies = createEcommerceStudioPolicies()) {
  const issues = [];
...
export function summarizeEcommerceStudioPolicies(policies = createEcommerceStudioPolicies()) {
  return {
...
export function createEcommerceStudioEscalationDeck(policies = createEcommerceStudioPolicies()) {
