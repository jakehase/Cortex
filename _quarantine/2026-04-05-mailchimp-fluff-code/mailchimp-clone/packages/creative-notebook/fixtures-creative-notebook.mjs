...
export function createCreativeNotebookFixtures() {
  return {
    accounts: [
...
export function summarizeCreativeNotebookFixtures(fixtures = createCreativeNotebookFixtures()) {
  return {
...
export function createCreativeNotebookDemoInputs() {
  return {
