...
export function createCreativeNotebookAuditTrail() {
...
export function createCreativeNotebookEvidenceManifest() {
...
export function createCreativeNotebookReadinessAttestation() {
  const auditTrail = createCreativeNotebookAuditTrail();
  return {
