...
export function createCreativeNotebookReportCards() {
...
export function createCreativeNotebookReviewPackets() {
...
export function summarizeCreativeNotebookReporting() {
  const cards = createCreativeNotebookReportCards();
  const packets = createCreativeNotebookReviewPackets();
  return {
