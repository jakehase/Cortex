...
export function createDataSentinelReportCards() {
...
export function createDataSentinelReviewPackets() {
...
export function summarizeDataSentinelReporting() {
  const cards = createDataSentinelReportCards();
  const packets = createDataSentinelReviewPackets();
  return {
