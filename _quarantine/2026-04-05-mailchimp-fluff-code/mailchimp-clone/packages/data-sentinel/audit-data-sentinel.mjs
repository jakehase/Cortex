...
export function createDataSentinelAuditTrail() {
...
export function createDataSentinelEvidenceManifest() {
...
export function createDataSentinelReadinessAttestation() {
  const auditTrail = createDataSentinelAuditTrail();
  return {
