...
export function createBenchmarkPlannerAuditTrail() {
...
export function createBenchmarkPlannerEvidenceManifest() {
...
export function createBenchmarkPlannerReadinessAttestation() {
  const auditTrail = createBenchmarkPlannerAuditTrail();
  return {
