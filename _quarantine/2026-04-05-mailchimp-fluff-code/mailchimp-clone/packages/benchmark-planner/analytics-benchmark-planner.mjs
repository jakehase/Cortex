...
export function createBenchmarkPlannerAnalyticsTimeline() {
...
export function createBenchmarkPlannerForecastEnvelope() {
...
export function createBenchmarkPlannerExceptionLedger() {
...
export function summarizeBenchmarkPlannerAnalytics() {
  const timeline = createBenchmarkPlannerAnalyticsTimeline();
  const forecast = createBenchmarkPlannerForecastEnvelope();
  return {
