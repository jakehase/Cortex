...
export function createLoyaltyDossierAnalyticsTimeline() {
...
export function createLoyaltyDossierForecastEnvelope() {
...
export function createLoyaltyDossierExceptionLedger() {
...
export function summarizeLoyaltyDossierAnalytics() {
  const timeline = createLoyaltyDossierAnalyticsTimeline();
  const forecast = createLoyaltyDossierForecastEnvelope();
  return {
