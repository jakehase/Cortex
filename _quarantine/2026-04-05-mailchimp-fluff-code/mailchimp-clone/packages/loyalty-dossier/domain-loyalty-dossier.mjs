...
export function createLoyaltyDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLoyaltyDossierWorkspace(workspace = createLoyaltyDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createLoyaltyDossierNarratives(workspace = createLoyaltyDossierWorkspace()) {
...
export function createLoyaltyDossierCoverageGrid(workspace = createLoyaltyDossierWorkspace()) {
