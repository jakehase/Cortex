...
export function createLoyaltyDossierAuditTrail() {
...
export function createLoyaltyDossierEvidenceManifest() {
...
export function createLoyaltyDossierReadinessAttestation() {
  const auditTrail = createLoyaltyDossierAuditTrail();
  return {
