...
export function createChannelHubAuditTrail() {
...
export function createChannelHubEvidenceManifest() {
...
export function createChannelHubReadinessAttestation() {
  const auditTrail = createChannelHubAuditTrail();
  return {
