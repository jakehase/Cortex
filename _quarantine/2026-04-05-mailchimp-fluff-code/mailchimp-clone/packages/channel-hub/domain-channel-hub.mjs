const MODULE = {
  ...
  "routeSegment": "hub",
  "title": "Channel Hub",
  "focus": "Channel Hub covers channel operating models, readiness coverage, and mix governance through centralized operating views and routing.",
...
export function createChannelHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeChannelHubWorkspace(workspace = createChannelHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createChannelHubNarratives(workspace = createChannelHubWorkspace()) {
...
export function createChannelHubCoverageGrid(workspace = createChannelHubWorkspace()) {
