...
export function createCollaborationNavigatorOperationsBoard() {
...
export function createCollaborationNavigatorShiftChecklist() {
...
export function createCollaborationNavigatorIncidentDeck() {
