...
export function createCollaborationNavigatorPlaybooks() {
...
export function createCollaborationNavigatorDecisionDeck() {
...
export function createCollaborationNavigatorEscalationMoments() {
