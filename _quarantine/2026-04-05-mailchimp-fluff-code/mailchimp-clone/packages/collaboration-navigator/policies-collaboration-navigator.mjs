...
export function createCollaborationNavigatorPolicies(overrides = {}) {
...
export function validateCollaborationNavigatorPolicies(policies = createCollaborationNavigatorPolicies()) {
  const issues = [];
...
export function summarizeCollaborationNavigatorPolicies(policies = createCollaborationNavigatorPolicies()) {
  return {
...
export function createCollaborationNavigatorEscalationDeck(policies = createCollaborationNavigatorPolicies()) {
