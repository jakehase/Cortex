...
export function createCollaborationNavigatorAuditTrail() {
...
export function createCollaborationNavigatorEvidenceManifest() {
...
export function createCollaborationNavigatorReadinessAttestation() {
  const auditTrail = createCollaborationNavigatorAuditTrail();
  return {
