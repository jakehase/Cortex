...
export function createCreativeCockpitOperationsBoard() {
...
export function createCreativeCockpitShiftChecklist() {
...
export function createCreativeCockpitIncidentDeck() {
