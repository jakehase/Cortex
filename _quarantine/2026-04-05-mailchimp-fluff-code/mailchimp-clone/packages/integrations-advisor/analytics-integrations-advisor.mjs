...
export function createIntegrationsAdvisorAnalyticsTimeline() {
...
export function createIntegrationsAdvisorForecastEnvelope() {
...
export function createIntegrationsAdvisorExceptionLedger() {
...
export function summarizeIntegrationsAdvisorAnalytics() {
  const timeline = createIntegrationsAdvisorAnalyticsTimeline();
  const forecast = createIntegrationsAdvisorForecastEnvelope();
  return {
