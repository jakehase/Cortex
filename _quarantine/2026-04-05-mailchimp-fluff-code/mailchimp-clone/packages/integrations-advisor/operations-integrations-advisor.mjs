...
export function createIntegrationsAdvisorOperationsBoard() {
...
export function createIntegrationsAdvisorShiftChecklist() {
...
export function createIntegrationsAdvisorIncidentDeck() {
