...
export function createIntegrationsAdvisorReportCards() {
...
export function createIntegrationsAdvisorReviewPackets() {
...
export function summarizeIntegrationsAdvisorReporting() {
  const cards = createIntegrationsAdvisorReportCards();
  const packets = createIntegrationsAdvisorReviewPackets();
  return {
