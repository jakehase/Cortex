...
export function createIntegrationsAdvisorAuditTrail() {
...
export function createIntegrationsAdvisorEvidenceManifest() {
...
export function createIntegrationsAdvisorReadinessAttestation() {
  const auditTrail = createIntegrationsAdvisorAuditTrail();
  return {
