...
export function createConsentStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeConsentStudioWorkspace(workspace = createConsentStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createConsentStudioNarratives(workspace = createConsentStudioWorkspace()) {
...
export function createConsentStudioCoverageGrid(workspace = createConsentStudioWorkspace()) {
