...
export function createConsentStudioReportCards() {
...
export function createConsentStudioReviewPackets() {
...
export function summarizeConsentStudioReporting() {
  const cards = createConsentStudioReportCards();
  const packets = createConsentStudioReviewPackets();
  return {
