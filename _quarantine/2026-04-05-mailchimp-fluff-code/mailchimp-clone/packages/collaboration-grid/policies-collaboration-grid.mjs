...
export function createCollaborationGridPolicies(overrides = {}) {
...
export function validateCollaborationGridPolicies(policies = createCollaborationGridPolicies()) {
  const issues = [];
...
export function summarizeCollaborationGridPolicies(policies = createCollaborationGridPolicies()) {
  return {
...
export function createCollaborationGridEscalationDeck(policies = createCollaborationGridPolicies()) {
