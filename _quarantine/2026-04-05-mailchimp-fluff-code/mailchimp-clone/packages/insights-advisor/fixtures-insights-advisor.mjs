...
export function createInsightsAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeInsightsAdvisorFixtures(fixtures = createInsightsAdvisorFixtures()) {
  return {
...
export function createInsightsAdvisorDemoInputs() {
  return {
