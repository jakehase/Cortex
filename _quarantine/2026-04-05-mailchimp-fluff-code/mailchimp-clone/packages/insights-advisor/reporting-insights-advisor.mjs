...
export function createInsightsAdvisorReportCards() {
...
export function createInsightsAdvisorReviewPackets() {
...
export function summarizeInsightsAdvisorReporting() {
  const cards = createInsightsAdvisorReportCards();
  const packets = createInsightsAdvisorReviewPackets();
  return {
