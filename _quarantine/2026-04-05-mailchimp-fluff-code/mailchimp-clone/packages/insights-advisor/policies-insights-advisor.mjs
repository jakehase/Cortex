...
export function createInsightsAdvisorPolicies(overrides = {}) {
...
export function validateInsightsAdvisorPolicies(policies = createInsightsAdvisorPolicies()) {
  const issues = [];
...
export function summarizeInsightsAdvisorPolicies(policies = createInsightsAdvisorPolicies()) {
  return {
...
export function createInsightsAdvisorEscalationDeck(policies = createInsightsAdvisorPolicies()) {
