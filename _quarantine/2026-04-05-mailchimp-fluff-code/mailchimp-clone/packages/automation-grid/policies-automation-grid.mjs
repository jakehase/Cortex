...
export function createAutomationGridPolicies(overrides = {}) {
...
export function validateAutomationGridPolicies(policies = createAutomationGridPolicies()) {
  const issues = [];
...
export function summarizeAutomationGridPolicies(policies = createAutomationGridPolicies()) {
  return {
...
export function createAutomationGridEscalationDeck(policies = createAutomationGridPolicies()) {
