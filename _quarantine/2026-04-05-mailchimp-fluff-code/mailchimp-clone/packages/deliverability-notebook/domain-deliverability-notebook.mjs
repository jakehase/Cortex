...
export function createDeliverabilityNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityNotebookWorkspace(workspace = createDeliverabilityNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityNotebookNarratives(workspace = createDeliverabilityNotebookWorkspace()) {
...
export function createDeliverabilityNotebookCoverageGrid(workspace = createDeliverabilityNotebookWorkspace()) {
