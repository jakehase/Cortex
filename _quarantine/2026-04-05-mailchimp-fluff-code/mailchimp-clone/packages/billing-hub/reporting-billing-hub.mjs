...
export function createBillingHubReportCards() {
...
export function createBillingHubReviewPackets() {
...
export function summarizeBillingHubReporting() {
  const cards = createBillingHubReportCards();
  const packets = createBillingHubReviewPackets();
  return {
