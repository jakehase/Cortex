...
export function createLifecycleVaultPolicies(overrides = {}) {
...
export function validateLifecycleVaultPolicies(policies = createLifecycleVaultPolicies()) {
  const issues = [];
...
export function summarizeLifecycleVaultPolicies(policies = createLifecycleVaultPolicies()) {
  return {
...
export function createLifecycleVaultEscalationDeck(policies = createLifecycleVaultPolicies()) {
