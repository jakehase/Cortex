...
export function createCampaignCockpitReportCards() {
...
export function createCampaignCockpitReviewPackets() {
...
export function summarizeCampaignCockpitReporting() {
  const cards = createCampaignCockpitReportCards();
  const packets = createCampaignCockpitReviewPackets();
  return {
