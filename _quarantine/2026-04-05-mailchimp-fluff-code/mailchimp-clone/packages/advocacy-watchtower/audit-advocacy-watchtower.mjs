...
export function createAdvocacyWatchtowerAuditTrail() {
...
export function createAdvocacyWatchtowerEvidenceManifest() {
...
export function createAdvocacyWatchtowerReadinessAttestation() {
  const auditTrail = createAdvocacyWatchtowerAuditTrail();
  return {
