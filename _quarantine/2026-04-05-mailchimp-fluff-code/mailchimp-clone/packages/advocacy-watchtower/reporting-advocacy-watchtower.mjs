...
export function createAdvocacyWatchtowerReportCards() {
...
export function createAdvocacyWatchtowerReviewPackets() {
...
export function summarizeAdvocacyWatchtowerReporting() {
  const cards = createAdvocacyWatchtowerReportCards();
  const packets = createAdvocacyWatchtowerReviewPackets();
  return {
