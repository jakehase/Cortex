...
export function createAdvocacyWatchtowerAnalyticsTimeline() {
...
export function createAdvocacyWatchtowerForecastEnvelope() {
...
export function createAdvocacyWatchtowerExceptionLedger() {
...
export function summarizeAdvocacyWatchtowerAnalytics() {
  const timeline = createAdvocacyWatchtowerAnalyticsTimeline();
  const forecast = createAdvocacyWatchtowerForecastEnvelope();
  return {
