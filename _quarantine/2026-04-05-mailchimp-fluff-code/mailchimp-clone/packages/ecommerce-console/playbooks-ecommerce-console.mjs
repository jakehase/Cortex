...
export function createEcommerceConsolePlaybooks() {
...
export function createEcommerceConsoleDecisionDeck() {
...
export function createEcommerceConsoleEscalationMoments() {
