...
export function createEcommerceConsoleFixtures() {
  return {
    accounts: [
...
export function summarizeEcommerceConsoleFixtures(fixtures = createEcommerceConsoleFixtures()) {
  return {
...
export function createEcommerceConsoleDemoInputs() {
  return {
