...
export function createEcommerceConsolePolicies(overrides = {}) {
...
export function validateEcommerceConsolePolicies(policies = createEcommerceConsolePolicies()) {
  const issues = [];
...
export function summarizeEcommerceConsolePolicies(policies = createEcommerceConsolePolicies()) {
  return {
...
export function createEcommerceConsoleEscalationDeck(policies = createEcommerceConsolePolicies()) {
