...
export function createEcommerceConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceConsoleWorkspace(workspace = createEcommerceConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceConsoleNarratives(workspace = createEcommerceConsoleWorkspace()) {
...
export function createEcommerceConsoleCoverageGrid(workspace = createEcommerceConsoleWorkspace()) {
