...
export function createBillingExchangeAuditTrail() {
...
export function createBillingExchangeEvidenceManifest() {
...
export function createBillingExchangeReadinessAttestation() {
  const auditTrail = createBillingExchangeAuditTrail();
  return {
