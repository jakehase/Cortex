...
export function createBillingExchangeFixtures() {
  return {
    accounts: [
...
export function summarizeBillingExchangeFixtures(fixtures = createBillingExchangeFixtures()) {
  return {
...
export function createBillingExchangeDemoInputs() {
  return {
