...
export function createBenchmarkVaultPolicies(overrides = {}) {
...
export function validateBenchmarkVaultPolicies(policies = createBenchmarkVaultPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkVaultPolicies(policies = createBenchmarkVaultPolicies()) {
  return {
...
export function createBenchmarkVaultEscalationDeck(policies = createBenchmarkVaultPolicies()) {
