...
export function createPartnerAdvisorAnalyticsTimeline() {
...
export function createPartnerAdvisorForecastEnvelope() {
...
export function createPartnerAdvisorExceptionLedger() {
...
export function summarizePartnerAdvisorAnalytics() {
  const timeline = createPartnerAdvisorAnalyticsTimeline();
  const forecast = createPartnerAdvisorForecastEnvelope();
  return {
