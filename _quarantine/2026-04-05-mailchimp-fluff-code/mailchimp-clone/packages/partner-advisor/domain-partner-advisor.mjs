...
export function createPartnerAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizePartnerAdvisorWorkspace(workspace = createPartnerAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createPartnerAdvisorNarratives(workspace = createPartnerAdvisorWorkspace()) {
...
export function createPartnerAdvisorCoverageGrid(workspace = createPartnerAdvisorWorkspace()) {
