...
export function createCollaborationWorkbenchOperationsBoard() {
...
export function createCollaborationWorkbenchShiftChecklist() {
...
export function createCollaborationWorkbenchIncidentDeck() {
