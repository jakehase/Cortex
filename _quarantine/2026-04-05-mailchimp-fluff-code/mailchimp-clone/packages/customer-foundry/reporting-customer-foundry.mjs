...
export function createCustomerFoundryReportCards() {
...
export function createCustomerFoundryReviewPackets() {
...
export function summarizeCustomerFoundryReporting() {
  const cards = createCustomerFoundryReportCards();
  const packets = createCustomerFoundryReviewPackets();
  return {
