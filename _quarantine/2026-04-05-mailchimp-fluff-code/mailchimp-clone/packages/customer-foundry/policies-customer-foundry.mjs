...
export function createCustomerFoundryPolicies(overrides = {}) {
...
export function validateCustomerFoundryPolicies(policies = createCustomerFoundryPolicies()) {
  const issues = [];
...
export function summarizeCustomerFoundryPolicies(policies = createCustomerFoundryPolicies()) {
  return {
...
export function createCustomerFoundryEscalationDeck(policies = createCustomerFoundryPolicies()) {
