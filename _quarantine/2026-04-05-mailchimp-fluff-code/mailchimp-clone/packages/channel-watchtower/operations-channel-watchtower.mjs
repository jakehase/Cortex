...
export function createChannelWatchtowerOperationsBoard() {
...
export function createChannelWatchtowerShiftChecklist() {
...
export function createChannelWatchtowerIncidentDeck() {
