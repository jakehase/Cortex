...
export function createCustomerPlannerOperationsBoard() {
...
export function createCustomerPlannerShiftChecklist() {
...
export function createCustomerPlannerIncidentDeck() {
