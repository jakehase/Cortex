...
export function createExperimentationWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationWorkbenchWorkspace(workspace = createExperimentationWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationWorkbenchNarratives(workspace = createExperimentationWorkbenchWorkspace()) {
...
export function createExperimentationWorkbenchCoverageGrid(workspace = createExperimentationWorkbenchWorkspace()) {
