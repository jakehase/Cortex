...
export function createExperimentationWorkbenchAnalyticsTimeline() {
...
export function createExperimentationWorkbenchForecastEnvelope() {
...
export function createExperimentationWorkbenchExceptionLedger() {
...
export function summarizeExperimentationWorkbenchAnalytics() {
  const timeline = createExperimentationWorkbenchAnalyticsTimeline();
  const forecast = createExperimentationWorkbenchForecastEnvelope();
  return {
