...
export function createExperimentationWorkbenchAuditTrail() {
...
export function createExperimentationWorkbenchEvidenceManifest() {
...
export function createExperimentationWorkbenchReadinessAttestation() {
  const auditTrail = createExperimentationWorkbenchAuditTrail();
  return {
