...
export function createEcommerceIndexPolicies(overrides = {}) {
...
export function validateEcommerceIndexPolicies(policies = createEcommerceIndexPolicies()) {
  const issues = [];
...
export function summarizeEcommerceIndexPolicies(policies = createEcommerceIndexPolicies()) {
  return {
...
export function createEcommerceIndexEscalationDeck(policies = createEcommerceIndexPolicies()) {
