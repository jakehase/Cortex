...
export function createEcommerceIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceIndexWorkspace(workspace = createEcommerceIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceIndexNarratives(workspace = createEcommerceIndexWorkspace()) {
...
export function createEcommerceIndexCoverageGrid(workspace = createEcommerceIndexWorkspace()) {
