...
export function createDataStudioAnalyticsTimeline() {
...
export function createDataStudioForecastEnvelope() {
...
export function createDataStudioExceptionLedger() {
...
export function summarizeDataStudioAnalytics() {
  const timeline = createDataStudioAnalyticsTimeline();
  const forecast = createDataStudioForecastEnvelope();
  return {
