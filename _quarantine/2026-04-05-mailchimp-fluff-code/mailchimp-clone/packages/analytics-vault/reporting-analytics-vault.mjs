...
export function createAnalyticsVaultReportCards() {
...
export function createAnalyticsVaultReviewPackets() {
...
export function summarizeAnalyticsVaultReporting() {
  const cards = createAnalyticsVaultReportCards();
  const packets = createAnalyticsVaultReviewPackets();
  return {
