...
export function createChannelVaultAuditTrail() {
...
export function createChannelVaultEvidenceManifest() {
...
export function createChannelVaultReadinessAttestation() {
  const auditTrail = createChannelVaultAuditTrail();
  return {
