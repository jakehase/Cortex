...
export function createChannelVaultPolicies(overrides = {}) {
...
export function validateChannelVaultPolicies(policies = createChannelVaultPolicies()) {
  const issues = [];
...
export function summarizeChannelVaultPolicies(policies = createChannelVaultPolicies()) {
  return {
...
export function createChannelVaultEscalationDeck(policies = createChannelVaultPolicies()) {
