...
export function createIntegrationsHubReportCards() {
...
export function createIntegrationsHubReviewPackets() {
...
export function summarizeIntegrationsHubReporting() {
  const cards = createIntegrationsHubReportCards();
  const packets = createIntegrationsHubReviewPackets();
  return {
