...
export function createComplianceVaultWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeComplianceVaultWorkspace(workspace = createComplianceVaultWorkspace()) {
  return {
    id: workspace.id,
...
export function createComplianceVaultNarratives(workspace = createComplianceVaultWorkspace()) {
...
export function createComplianceVaultCoverageGrid(workspace = createComplianceVaultWorkspace()) {
