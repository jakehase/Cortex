...
export function createBillingPlannerReportCards() {
...
export function createBillingPlannerReviewPackets() {
...
export function summarizeBillingPlannerReporting() {
  const cards = createBillingPlannerReportCards();
  const packets = createBillingPlannerReviewPackets();
  return {
