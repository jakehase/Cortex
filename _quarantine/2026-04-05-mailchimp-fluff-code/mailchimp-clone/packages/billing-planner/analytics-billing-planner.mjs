...
export function createBillingPlannerAnalyticsTimeline() {
...
export function createBillingPlannerForecastEnvelope() {
...
export function createBillingPlannerExceptionLedger() {
...
export function summarizeBillingPlannerAnalytics() {
  const timeline = createBillingPlannerAnalyticsTimeline();
  const forecast = createBillingPlannerForecastEnvelope();
  return {
