...
export function createBillingPlannerFixtures() {
  return {
    accounts: [
...
export function summarizeBillingPlannerFixtures(fixtures = createBillingPlannerFixtures()) {
  return {
...
export function createBillingPlannerDemoInputs() {
  return {
