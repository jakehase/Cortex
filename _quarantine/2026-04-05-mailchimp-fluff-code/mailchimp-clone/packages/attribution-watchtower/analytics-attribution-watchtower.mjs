...
export function createAttributionWatchtowerAnalyticsTimeline() {
...
export function createAttributionWatchtowerForecastEnvelope() {
...
export function createAttributionWatchtowerExceptionLedger() {
...
export function summarizeAttributionWatchtowerAnalytics() {
  const timeline = createAttributionWatchtowerAnalyticsTimeline();
  const forecast = createAttributionWatchtowerForecastEnvelope();
  return {
