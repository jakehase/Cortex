...
export function createAttributionWatchtowerReportCards() {
...
export function createAttributionWatchtowerReviewPackets() {
...
export function summarizeAttributionWatchtowerReporting() {
  const cards = createAttributionWatchtowerReportCards();
  const packets = createAttributionWatchtowerReviewPackets();
  return {
