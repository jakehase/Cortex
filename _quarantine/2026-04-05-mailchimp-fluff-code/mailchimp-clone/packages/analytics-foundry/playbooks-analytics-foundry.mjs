...
export function createAnalyticsFoundryPlaybooks() {
...
export function createAnalyticsFoundryDecisionDeck() {
...
export function createAnalyticsFoundryEscalationMoments() {
