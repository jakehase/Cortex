...
export function createAnalyticsFoundryOperationsBoard() {
...
export function createAnalyticsFoundryShiftChecklist() {
...
export function createAnalyticsFoundryIncidentDeck() {
