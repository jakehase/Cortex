const MODULE = {
  "id": "analytics-foundry",
  "ordinal": 67,
  "domain": "analytics",
  "surfaceId": "foundry",
  "surfaceTitle": "Foundry",
  "routeSegment": "foundry",
  "title": "Analytics Foundry",
  "focus": "Analytics Foundry covers portfolio analytics, operator scorecards, and query-driven reviews through program building and surface composition.",
...
export function createAnalyticsFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsFoundryWorkspace(workspace = createAnalyticsFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsFoundryNarratives(workspace = createAnalyticsFoundryWorkspace()) {
...
export function createAnalyticsFoundryCoverageGrid(workspace = createAnalyticsFoundryWorkspace()) {
