const MODULE = {
  ...
  "focus": "Collaboration Index covers shared ownership, approvals, and cross-functional motion through searchable summaries and coverage catalogs.",
  ...
  "tags": [
    ...
    "index",
    "lifecycle",
    "collaboration-index-wave-seven"
  ]
};
...
export function createCollaborationIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCollaborationIndexWorkspace(workspace = createCollaborationIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createCollaborationIndexNarratives(workspace = createCollaborationIndexWorkspace()) {
...
export function createCollaborationIndexCoverageGrid(workspace = createCollaborationIndexWorkspace()) {
