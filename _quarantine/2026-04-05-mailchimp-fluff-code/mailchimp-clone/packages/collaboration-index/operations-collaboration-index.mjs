...
export function createCollaborationIndexOperationsBoard() {
...
export function createCollaborationIndexShiftChecklist() {
...
export function createCollaborationIndexIncidentDeck() {
