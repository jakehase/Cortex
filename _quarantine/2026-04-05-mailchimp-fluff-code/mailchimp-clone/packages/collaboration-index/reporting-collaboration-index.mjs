...
export function createCollaborationIndexReportCards() {
...
export function createCollaborationIndexReviewPackets() {
...
export function summarizeCollaborationIndexReporting() {
  const cards = createCollaborationIndexReportCards();
  const packets = createCollaborationIndexReviewPackets();
  return {
