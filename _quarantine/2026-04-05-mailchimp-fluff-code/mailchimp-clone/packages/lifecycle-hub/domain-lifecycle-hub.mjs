...
export function createLifecycleHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeLifecycleHubWorkspace(workspace = createLifecycleHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createLifecycleHubNarratives(workspace = createLifecycleHubWorkspace()) {
...
export function createLifecycleHubCoverageGrid(workspace = createLifecycleHubWorkspace()) {
