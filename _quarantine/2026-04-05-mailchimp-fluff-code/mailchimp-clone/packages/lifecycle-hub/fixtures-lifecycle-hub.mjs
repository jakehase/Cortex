...
export function createLifecycleHubFixtures() {
  return {
    accounts: [
...
export function summarizeLifecycleHubFixtures(fixtures = createLifecycleHubFixtures()) {
  return {
...
export function createLifecycleHubDemoInputs() {
  return {
