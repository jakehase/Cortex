...
export function createLifecycleHubAuditTrail() {
...
export function createLifecycleHubEvidenceManifest() {
...
export function createLifecycleHubReadinessAttestation() {
  const auditTrail = createLifecycleHubAuditTrail();
  return {
