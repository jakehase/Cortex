...
export function createComplianceAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeComplianceAdvisorFixtures(fixtures = createComplianceAdvisorFixtures()) {
  return {
...
export function createComplianceAdvisorDemoInputs() {
  return {
