...
export function createComplianceAdvisorReportCards() {
...
export function createComplianceAdvisorReviewPackets() {
...
export function summarizeComplianceAdvisorReporting() {
  const cards = createComplianceAdvisorReportCards();
  const packets = createComplianceAdvisorReviewPackets();
  return {
