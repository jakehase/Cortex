...
export function createComplianceAdvisorOperationsBoard() {
...
export function createComplianceAdvisorShiftChecklist() {
...
export function createComplianceAdvisorIncidentDeck() {
