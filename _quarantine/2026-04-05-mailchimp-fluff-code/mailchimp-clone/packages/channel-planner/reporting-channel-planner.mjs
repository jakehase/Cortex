...
export function createChannelPlannerReportCards() {
...
export function createChannelPlannerReviewPackets() {
...
export function summarizeChannelPlannerReporting() {
  const cards = createChannelPlannerReportCards();
  const packets = createChannelPlannerReviewPackets();
  return {
