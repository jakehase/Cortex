...
export function createChannelPlannerAuditTrail() {
...
export function createChannelPlannerEvidenceManifest() {
...
export function createChannelPlannerReadinessAttestation() {
  const auditTrail = createChannelPlannerAuditTrail();
  return {
