...
export function createComplianceFoundryReportCards() {
...
export function createComplianceFoundryReviewPackets() {
...
export function summarizeComplianceFoundryReporting() {
  const cards = createComplianceFoundryReportCards();
  const packets = createComplianceFoundryReviewPackets();
  return {
