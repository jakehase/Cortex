...
export function createComplianceFoundryOperationsBoard() {
...
export function createComplianceFoundryShiftChecklist() {
...
export function createComplianceFoundryIncidentDeck() {
