...
export function createLifecycleGridReportCards() {
...
export function createLifecycleGridReviewPackets() {
...
export function summarizeLifecycleGridReporting() {
  const cards = createLifecycleGridReportCards();
  const packets = createLifecycleGridReviewPackets();
  return {
