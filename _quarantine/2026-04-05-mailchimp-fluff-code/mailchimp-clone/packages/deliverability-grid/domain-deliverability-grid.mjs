...
export function createDeliverabilityGridWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityGridWorkspace(workspace = createDeliverabilityGridWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityGridNarratives(workspace = createDeliverabilityGridWorkspace()) {
...
export function createDeliverabilityGridCoverageGrid(workspace = createDeliverabilityGridWorkspace()) {
