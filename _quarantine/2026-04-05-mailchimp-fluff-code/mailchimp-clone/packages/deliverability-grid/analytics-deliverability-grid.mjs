...
export function createDeliverabilityGridAnalyticsTimeline() {
...
export function createDeliverabilityGridForecastEnvelope() {
...
export function createDeliverabilityGridExceptionLedger() {
...
export function summarizeDeliverabilityGridAnalytics() {
  const timeline = createDeliverabilityGridAnalyticsTimeline();
  const forecast = createDeliverabilityGridForecastEnvelope();
  return {
