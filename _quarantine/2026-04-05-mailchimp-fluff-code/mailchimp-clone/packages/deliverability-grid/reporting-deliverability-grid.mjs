...
export function createDeliverabilityGridReportCards() {
...
export function createDeliverabilityGridReviewPackets() {
...
export function summarizeDeliverabilityGridReporting() {
  const cards = createDeliverabilityGridReportCards();
  const packets = createDeliverabilityGridReviewPackets();
  return {
