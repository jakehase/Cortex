...
export function createDeliverabilityWorkbenchAuditTrail() {
...
export function createDeliverabilityWorkbenchEvidenceManifest() {
...
export function createDeliverabilityWorkbenchReadinessAttestation() {
  const auditTrail = createDeliverabilityWorkbenchAuditTrail();
  return {
