...
export function createExperimentationNotebookReportCards() {
...
export function createExperimentationNotebookReviewPackets() {
...
export function summarizeExperimentationNotebookReporting() {
  const cards = createExperimentationNotebookReportCards();
  const packets = createExperimentationNotebookReviewPackets();
  return {
