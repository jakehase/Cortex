...
export function createExperimentationNotebookAnalyticsTimeline() {
...
export function createExperimentationNotebookForecastEnvelope() {
...
export function createExperimentationNotebookExceptionLedger() {
...
export function summarizeExperimentationNotebookAnalytics() {
  const timeline = createExperimentationNotebookAnalyticsTimeline();
  const forecast = createExperimentationNotebookForecastEnvelope();
  return {
