const MODULE = {
  "id": "experimentation-notebook",
  "ordinal": 431,
  "domain": "experimentation",
  "surfaceId": "notebook",
  "surfaceTitle": "Notebook",
  "routeSegment": "notebook",
  "title": "Experimentation Notebook",
  "focus": "Experimentation Notebook covers test planning, variant analysis, and decision velocity through working notes and experiment memory.",
  ...
  "tags": [
    ...
    "notebook",
    "intelligence",
    "experimentation-notebook-wave-seven"
  ]
};
...
export function createExperimentationNotebookWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationNotebookWorkspace(workspace = createExperimentationNotebookWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationNotebookNarratives(workspace = createExperimentationNotebookWorkspace()) {
...
export function createExperimentationNotebookCoverageGrid(workspace = createExperimentationNotebookWorkspace()) {
