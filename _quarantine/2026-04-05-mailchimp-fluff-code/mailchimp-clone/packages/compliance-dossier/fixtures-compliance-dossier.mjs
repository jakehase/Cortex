...
export function createComplianceDossierFixtures() {
  return {
    accounts: [
...
export function summarizeComplianceDossierFixtures(fixtures = createComplianceDossierFixtures()) {
  return {
...
export function createComplianceDossierDemoInputs() {
  return {
