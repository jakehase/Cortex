...
export function createCampaignLedgerAuditTrail() {
...
export function createCampaignLedgerEvidenceManifest() {
...
export function createCampaignLedgerReadinessAttestation() {
  const auditTrail = createCampaignLedgerAuditTrail();
  return {
