...
export function createDataDossierAuditTrail() {
...
export function createDataDossierEvidenceManifest() {
...
export function createDataDossierReadinessAttestation() {
  const auditTrail = createDataDossierAuditTrail();
  return {
