...
export function createContentCockpitReportCards() {
...
export function createContentCockpitReviewPackets() {
...
export function summarizeContentCockpitReporting() {
  const cards = createContentCockpitReportCards();
  const packets = createContentCockpitReviewPackets();
  return {
