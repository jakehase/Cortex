const MODULE = {
  ...
  "focus": "Content Cockpit covers content operations, packaging, and channel-specific delivery shape through operator controls and active monitoring.",
...
export function createContentCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentCockpitWorkspace(workspace = createContentCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentCockpitNarratives(workspace = createContentCockpitWorkspace()) {
...
export function createContentCockpitCoverageGrid(workspace = createContentCockpitWorkspace()) {
