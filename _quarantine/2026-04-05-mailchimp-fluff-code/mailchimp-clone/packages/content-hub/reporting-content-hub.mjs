...
export function createContentHubReportCards() {
...
export function createContentHubReviewPackets() {
...
export function summarizeContentHubReporting() {
  const cards = createContentHubReportCards();
  const packets = createContentHubReviewPackets();
  return {
