...
export function createContentHubPolicies(overrides = {}) {
...
export function validateContentHubPolicies(policies = createContentHubPolicies()) {
  const issues = [];
...
export function summarizeContentHubPolicies(policies = createContentHubPolicies()) {
  return {
...
export function createContentHubEscalationDeck(policies = createContentHubPolicies()) {
