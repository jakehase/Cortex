...
export function createDeliverabilitySentinelPolicies(overrides = {}) {
...
export function validateDeliverabilitySentinelPolicies(policies = createDeliverabilitySentinelPolicies()) {
  const issues = [];
...
export function summarizeDeliverabilitySentinelPolicies(policies = createDeliverabilitySentinelPolicies()) {
  return {
...
export function createDeliverabilitySentinelEscalationDeck(policies = createDeliverabilitySentinelPolicies()) {
