...
export function createAdvocacyCockpitPolicies(overrides = {}) {
...
export function validateAdvocacyCockpitPolicies(policies = createAdvocacyCockpitPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyCockpitPolicies(policies = createAdvocacyCockpitPolicies()) {
  return {
...
export function createAdvocacyCockpitEscalationDeck(policies = createAdvocacyCockpitPolicies()) {
