...
export function createAdvocacyCockpitReportCards() {
...
export function createAdvocacyCockpitReviewPackets() {
...
export function summarizeAdvocacyCockpitReporting() {
  const cards = createAdvocacyCockpitReportCards();
  const packets = createAdvocacyCockpitReviewPackets();
  return {
