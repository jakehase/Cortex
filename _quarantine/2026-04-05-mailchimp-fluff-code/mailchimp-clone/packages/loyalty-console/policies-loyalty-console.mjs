...
export function createLoyaltyConsolePolicies(overrides = {}) {
...
export function validateLoyaltyConsolePolicies(policies = createLoyaltyConsolePolicies()) {
  const issues = [];
...
export function summarizeLoyaltyConsolePolicies(policies = createLoyaltyConsolePolicies()) {
  return {
...
export function createLoyaltyConsoleEscalationDeck(policies = createLoyaltyConsolePolicies()) {
