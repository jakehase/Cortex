...
export function createLoyaltyConsoleAuditTrail() {
...
export function createLoyaltyConsoleEvidenceManifest() {
...
export function createLoyaltyConsoleReadinessAttestation() {
  const auditTrail = createLoyaltyConsoleAuditTrail();
  return {
