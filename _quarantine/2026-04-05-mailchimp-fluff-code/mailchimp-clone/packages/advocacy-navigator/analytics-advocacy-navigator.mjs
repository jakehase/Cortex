...
export function createAdvocacyNavigatorAnalyticsTimeline() {
...
export function createAdvocacyNavigatorForecastEnvelope() {
...
export function createAdvocacyNavigatorExceptionLedger() {
...
export function summarizeAdvocacyNavigatorAnalytics() {
  const timeline = createAdvocacyNavigatorAnalyticsTimeline();
  const forecast = createAdvocacyNavigatorForecastEnvelope();
  return {
