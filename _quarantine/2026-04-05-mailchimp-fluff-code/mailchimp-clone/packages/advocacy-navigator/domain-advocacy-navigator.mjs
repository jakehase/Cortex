const MODULE = {
  "id": "advocacy-navigator",
  "ordinal": 52,
  "domain": "advocacy",
  "surfaceId": "navigator",
  "surfaceTitle": "Navigator",
  "routeSegment": "navigator",
  "title": "Advocacy Navigator",
  "focus": "Advocacy Navigator covers customer champions, referral readiness, and proof-sharing loops through journey guidance and directional controls.",
...
export function createAdvocacyNavigatorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyNavigatorWorkspace(workspace = createAdvocacyNavigatorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyNavigatorNarratives(workspace = createAdvocacyNavigatorWorkspace()) {
...
export function createAdvocacyNavigatorCoverageGrid(workspace = createAdvocacyNavigatorWorkspace()) {
