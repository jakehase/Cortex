...
export function createAdvocacyNavigatorAuditTrail() {
...
export function createAdvocacyNavigatorEvidenceManifest() {
...
export function createAdvocacyNavigatorReadinessAttestation() {
  const auditTrail = createAdvocacyNavigatorAuditTrail();
  return {
