...
export function createCommerceSentinelPolicies(overrides = {}) {
...
export function validateCommerceSentinelPolicies(policies = createCommerceSentinelPolicies()) {
  const issues = [];
...
export function summarizeCommerceSentinelPolicies(policies = createCommerceSentinelPolicies()) {
  return {
...
export function createCommerceSentinelEscalationDeck(policies = createCommerceSentinelPolicies()) {
