const MODULE = {
  ...
  "focus": "Activation Planner covers onboarding readiness, first-value motion, and kickoff momentum through calendar planning and execution choreography.",
...
export function createActivationPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationPlannerWorkspace(workspace = createActivationPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationPlannerNarratives(workspace = createActivationPlannerWorkspace()) {
...
export function createActivationPlannerCoverageGrid(workspace = createActivationPlannerWorkspace()) {
