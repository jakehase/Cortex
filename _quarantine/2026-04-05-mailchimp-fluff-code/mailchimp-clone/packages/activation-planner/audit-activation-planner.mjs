...
export function createActivationPlannerAuditTrail() {
...
export function createActivationPlannerEvidenceManifest() {
...
export function createActivationPlannerReadinessAttestation() {
  const auditTrail = createActivationPlannerAuditTrail();
  return {
