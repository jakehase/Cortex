...
export function createAutomationLedgerPolicies(overrides = {}) {
...
export function validateAutomationLedgerPolicies(policies = createAutomationLedgerPolicies()) {
  const issues = [];
...
export function summarizeAutomationLedgerPolicies(policies = createAutomationLedgerPolicies()) {
  return {
...
export function createAutomationLedgerEscalationDeck(policies = createAutomationLedgerPolicies()) {
