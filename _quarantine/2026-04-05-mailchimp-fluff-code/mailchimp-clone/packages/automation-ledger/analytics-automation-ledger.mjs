...
export function createAutomationLedgerAnalyticsTimeline() {
...
export function createAutomationLedgerForecastEnvelope() {
...
export function createAutomationLedgerExceptionLedger() {
...
export function summarizeAutomationLedgerAnalytics() {
  const timeline = createAutomationLedgerAnalyticsTimeline();
  const forecast = createAutomationLedgerForecastEnvelope();
  return {
