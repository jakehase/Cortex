...
export function createAutomationLedgerReportCards() {
...
export function createAutomationLedgerReviewPackets() {
...
export function summarizeAutomationLedgerReporting() {
  const cards = createAutomationLedgerReportCards();
  const packets = createAutomationLedgerReviewPackets();
  return {
