...
export function createAutomationLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAutomationLedgerWorkspace(workspace = createAutomationLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAutomationLedgerNarratives(workspace = createAutomationLedgerWorkspace()) {
...
export function createAutomationLedgerCoverageGrid(workspace = createAutomationLedgerWorkspace()) {
