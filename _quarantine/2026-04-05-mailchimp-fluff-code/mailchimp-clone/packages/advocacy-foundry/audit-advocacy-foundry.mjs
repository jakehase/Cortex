...
export function createAdvocacyFoundryAuditTrail() {
...
export function createAdvocacyFoundryEvidenceManifest() {
...
export function createAdvocacyFoundryReadinessAttestation() {
  const auditTrail = createAdvocacyFoundryAuditTrail();
  return {
