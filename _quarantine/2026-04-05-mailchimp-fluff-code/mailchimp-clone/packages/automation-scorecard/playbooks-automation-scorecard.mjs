...
export function createAutomationScorecardPlaybooks() {
...
export function createAutomationScorecardDecisionDeck() {
...
export function createAutomationScorecardEscalationMoments() {
