...
export function createAutomationScorecardPolicies(overrides = {}) {
...
export function validateAutomationScorecardPolicies(policies = createAutomationScorecardPolicies()) {
  const issues = [];
...
export function summarizeAutomationScorecardPolicies(policies = createAutomationScorecardPolicies()) {
  return {
...
export function createAutomationScorecardEscalationDeck(policies = createAutomationScorecardPolicies()) {
