...
export function createAutomationScorecardAnalyticsTimeline() {
...
export function createAutomationScorecardForecastEnvelope() {
...
export function createAutomationScorecardExceptionLedger() {
...
export function summarizeAutomationScorecardAnalytics() {
  const timeline = createAutomationScorecardAnalyticsTimeline();
  const forecast = createAutomationScorecardForecastEnvelope();
  return {
