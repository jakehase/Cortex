...
export function createAutomationScorecardFixtures() {
  return {
    accounts: [
...
export function summarizeAutomationScorecardFixtures(fixtures = createAutomationScorecardFixtures()) {
  return {
...
export function createAutomationScorecardDemoInputs() {
  return {
