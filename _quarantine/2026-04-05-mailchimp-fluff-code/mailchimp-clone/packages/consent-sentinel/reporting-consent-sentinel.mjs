...
export function createConsentSentinelReportCards() {
...
export function createConsentSentinelReviewPackets() {
...
export function summarizeConsentSentinelReporting() {
  const cards = createConsentSentinelReportCards();
  const packets = createConsentSentinelReviewPackets();
  return {
