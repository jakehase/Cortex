const MODULE = {
  "id": "acquisition-exchange",
  "ordinal": 6,
  "domain": "acquisition",
  "surfaceId": "exchange",
  "surfaceTitle": "Exchange",
  "routeSegment": "exchange",
  "title": "Acquisition Exchange",
  "focus": "Acquisition Exchange covers new demand creation, source quality, and upstream handoff clarity through handoff workflows and partner coordination.",
  ...
  "tags": [
    ...
    "exchange",
    "growth",
    "acquisition-exchange-wave-seven"
  ]
};
...
export function createAcquisitionExchangeWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionExchangeWorkspace(workspace = createAcquisitionExchangeWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionExchangeNarratives(workspace = createAcquisitionExchangeWorkspace()) {
...
export function createAcquisitionExchangeCoverageGrid(workspace = createAcquisitionExchangeWorkspace()) {
