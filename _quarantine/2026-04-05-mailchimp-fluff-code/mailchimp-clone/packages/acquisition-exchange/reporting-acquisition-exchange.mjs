...
export function createAcquisitionExchangeReportCards() {
...
export function createAcquisitionExchangeReviewPackets() {
...
export function summarizeAcquisitionExchangeReporting() {
  const cards = createAcquisitionExchangeReportCards();
  const packets = createAcquisitionExchangeReviewPackets();
  return {
