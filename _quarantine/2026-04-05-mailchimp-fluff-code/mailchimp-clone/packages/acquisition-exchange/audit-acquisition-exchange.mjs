...
export function createAcquisitionExchangeAuditTrail() {
...
export function createAcquisitionExchangeEvidenceManifest() {
...
export function createAcquisitionExchangeReadinessAttestation() {
  const auditTrail = createAcquisitionExchangeAuditTrail();
  return {
