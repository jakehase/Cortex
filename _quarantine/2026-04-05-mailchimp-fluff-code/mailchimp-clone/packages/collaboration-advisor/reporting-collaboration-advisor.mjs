...
export function createCollaborationAdvisorReportCards() {
...
export function createCollaborationAdvisorReviewPackets() {
...
export function summarizeCollaborationAdvisorReporting() {
  const cards = createCollaborationAdvisorReportCards();
  const packets = createCollaborationAdvisorReviewPackets();
  return {
