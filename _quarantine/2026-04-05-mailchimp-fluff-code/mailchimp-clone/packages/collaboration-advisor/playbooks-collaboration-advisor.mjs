...
export function createCollaborationAdvisorPlaybooks() {
...
export function createCollaborationAdvisorDecisionDeck() {
...
export function createCollaborationAdvisorEscalationMoments() {
