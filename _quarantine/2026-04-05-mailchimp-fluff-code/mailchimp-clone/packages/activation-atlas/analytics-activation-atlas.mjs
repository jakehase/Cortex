...
export function createActivationAtlasAnalyticsTimeline() {
...
export function createActivationAtlasForecastEnvelope() {
...
export function createActivationAtlasExceptionLedger() {
...
export function summarizeActivationAtlasAnalytics() {
  const timeline = createActivationAtlasAnalyticsTimeline();
  const forecast = createActivationAtlasForecastEnvelope();
  return {
