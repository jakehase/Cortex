const MODULE = {
  ...
  "focus": "Activation Atlas covers onboarding readiness, first-value motion, and kickoff momentum through landscape mapping and territory coverage.",
...
export function createActivationAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeActivationAtlasWorkspace(workspace = createActivationAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createActivationAtlasNarratives(workspace = createActivationAtlasWorkspace()) {
...
export function createActivationAtlasCoverageGrid(workspace = createActivationAtlasWorkspace()) {
