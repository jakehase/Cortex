...
export function createActivationWatchtowerAnalyticsTimeline() {
...
export function createActivationWatchtowerForecastEnvelope() {
...
export function createActivationWatchtowerExceptionLedger() {
...
export function summarizeActivationWatchtowerAnalytics() {
  const timeline = createActivationWatchtowerAnalyticsTimeline();
  const forecast = createActivationWatchtowerForecastEnvelope();
  return {
