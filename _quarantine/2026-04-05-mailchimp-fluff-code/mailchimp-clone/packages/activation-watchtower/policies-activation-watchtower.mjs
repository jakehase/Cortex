...
export function createActivationWatchtowerPolicies(overrides = {}) {
...
export function validateActivationWatchtowerPolicies(policies = createActivationWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeActivationWatchtowerPolicies(policies = createActivationWatchtowerPolicies()) {
  return {
...
export function createActivationWatchtowerEscalationDeck(policies = createActivationWatchtowerPolicies()) {
