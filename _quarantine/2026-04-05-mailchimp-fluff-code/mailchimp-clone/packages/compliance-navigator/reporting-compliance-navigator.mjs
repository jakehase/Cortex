...
export function createComplianceNavigatorReportCards() {
...
export function createComplianceNavigatorReviewPackets() {
...
export function summarizeComplianceNavigatorReporting() {
  const cards = createComplianceNavigatorReportCards();
  const packets = createComplianceNavigatorReviewPackets();
  return {
