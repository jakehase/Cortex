...
export function createComplianceNavigatorAnalyticsTimeline() {
...
export function createComplianceNavigatorForecastEnvelope() {
...
export function createComplianceNavigatorExceptionLedger() {
...
export function summarizeComplianceNavigatorAnalytics() {
  const timeline = createComplianceNavigatorAnalyticsTimeline();
  const forecast = createComplianceNavigatorForecastEnvelope();
  return {
