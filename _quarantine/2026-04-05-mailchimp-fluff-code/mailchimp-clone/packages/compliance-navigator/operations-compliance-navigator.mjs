...
export function createComplianceNavigatorOperationsBoard() {
...
export function createComplianceNavigatorShiftChecklist() {
...
export function createComplianceNavigatorIncidentDeck() {
