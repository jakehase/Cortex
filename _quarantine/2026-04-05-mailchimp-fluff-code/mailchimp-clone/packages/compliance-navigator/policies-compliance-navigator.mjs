...
export function createComplianceNavigatorPolicies(overrides = {}) {
...
export function validateComplianceNavigatorPolicies(policies = createComplianceNavigatorPolicies()) {
  const issues = [];
...
export function summarizeComplianceNavigatorPolicies(policies = createComplianceNavigatorPolicies()) {
  return {
...
export function createComplianceNavigatorEscalationDeck(policies = createComplianceNavigatorPolicies()) {
