...
export function createComplianceNavigatorPlaybooks() {
...
export function createComplianceNavigatorDecisionDeck() {
...
export function createComplianceNavigatorEscalationMoments() {
