...
export function createLocalizationExchangeAnalyticsTimeline() {
...
export function createLocalizationExchangeForecastEnvelope() {
...
export function createLocalizationExchangeExceptionLedger() {
...
export function summarizeLocalizationExchangeAnalytics() {
  const timeline = createLocalizationExchangeAnalyticsTimeline();
  const forecast = createLocalizationExchangeForecastEnvelope();
  return {
