...
export function createLocalizationExchangeOperationsBoard() {
...
export function createLocalizationExchangeShiftChecklist() {
...
export function createLocalizationExchangeIncidentDeck() {
