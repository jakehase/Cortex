...
export function createLocalizationExchangeAuditTrail() {
...
export function createLocalizationExchangeEvidenceManifest() {
...
export function createLocalizationExchangeReadinessAttestation() {
  const auditTrail = createLocalizationExchangeAuditTrail();
  return {
