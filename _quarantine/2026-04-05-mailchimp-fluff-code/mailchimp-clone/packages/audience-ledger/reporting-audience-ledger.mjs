...
export function createAudienceLedgerReportCards() {
...
export function createAudienceLedgerReviewPackets() {
...
export function summarizeAudienceLedgerReporting() {
  const cards = createAudienceLedgerReportCards();
  const packets = createAudienceLedgerReviewPackets();
  return {
