const MODULE = {
  ...
  "surfaceTitle": "Ledger",
  "routeSegment": "ledger",
  "title": "Audience Ledger",
  "focus": "Audience Ledger covers audience health, segment design, and targeting durability through audit history and change accountability.",
...
export function createAudienceLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceLedgerWorkspace(workspace = createAudienceLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceLedgerNarratives(workspace = createAudienceLedgerWorkspace()) {
...
export function createAudienceLedgerCoverageGrid(workspace = createAudienceLedgerWorkspace()) {
