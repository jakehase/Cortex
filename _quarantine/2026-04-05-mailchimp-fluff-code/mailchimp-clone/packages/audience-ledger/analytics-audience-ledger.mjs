...
export function createAudienceLedgerAnalyticsTimeline() {
...
export function createAudienceLedgerForecastEnvelope() {
...
export function createAudienceLedgerExceptionLedger() {
...
export function summarizeAudienceLedgerAnalytics() {
  const timeline = createAudienceLedgerAnalyticsTimeline();
  const forecast = createAudienceLedgerForecastEnvelope();
  return {
