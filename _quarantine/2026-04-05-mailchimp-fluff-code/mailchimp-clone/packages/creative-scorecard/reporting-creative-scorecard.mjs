...
export function createCreativeScorecardReportCards() {
...
export function createCreativeScorecardReviewPackets() {
...
export function summarizeCreativeScorecardReporting() {
  const cards = createCreativeScorecardReportCards();
  const packets = createCreativeScorecardReviewPackets();
  return {
