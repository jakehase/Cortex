...
export function createCreativeScorecardPolicies(overrides = {}) {
...
export function validateCreativeScorecardPolicies(policies = createCreativeScorecardPolicies()) {
  const issues = [];
...
export function summarizeCreativeScorecardPolicies(policies = createCreativeScorecardPolicies()) {
  return {
...
export function createCreativeScorecardEscalationDeck(policies = createCreativeScorecardPolicies()) {
