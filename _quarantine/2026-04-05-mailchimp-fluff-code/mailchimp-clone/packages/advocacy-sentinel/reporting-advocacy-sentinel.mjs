...
export function createAdvocacySentinelReportCards() {
...
export function createAdvocacySentinelReviewPackets() {
...
export function summarizeAdvocacySentinelReporting() {
  const cards = createAdvocacySentinelReportCards();
  const packets = createAdvocacySentinelReviewPackets();
  return {
