...
export function createAdvocacySentinelPlaybooks() {
...
export function createAdvocacySentinelDecisionDeck() {
...
export function createAdvocacySentinelEscalationMoments() {
