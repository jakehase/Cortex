...
export function createAdvocacySentinelPolicies(overrides = {}) {
...
export function validateAdvocacySentinelPolicies(policies = createAdvocacySentinelPolicies()) {
  const issues = [];
...
export function summarizeAdvocacySentinelPolicies(policies = createAdvocacySentinelPolicies()) {
  return {
...
export function createAdvocacySentinelEscalationDeck(policies = createAdvocacySentinelPolicies()) {
