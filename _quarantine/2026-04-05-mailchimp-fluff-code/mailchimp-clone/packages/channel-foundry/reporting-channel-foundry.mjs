...
export function createChannelFoundryReportCards() {
...
export function createChannelFoundryReviewPackets() {
...
export function summarizeChannelFoundryReporting() {
  const cards = createChannelFoundryReportCards();
  const packets = createChannelFoundryReviewPackets();
  return {
