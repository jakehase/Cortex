...
export function createDataPlannerFixtures() {
  return {
    accounts: [
...
export function summarizeDataPlannerFixtures(fixtures = createDataPlannerFixtures()) {
  return {
...
export function createDataPlannerDemoInputs() {
  return {
