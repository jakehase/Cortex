...
export function createDataPlannerAnalyticsTimeline() {
...
export function createDataPlannerForecastEnvelope() {
...
export function createDataPlannerExceptionLedger() {
...
export function summarizeDataPlannerAnalytics() {
  const timeline = createDataPlannerAnalyticsTimeline();
  const forecast = createDataPlannerForecastEnvelope();
  return {
