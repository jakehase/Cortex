const MODULE = {
  ...
  "title": "Data Planner",
  "focus": "Data Planner covers pipeline health, lineage, freshness, and operator trust in data assets through calendar planning and execution choreography.",
...
export function createDataPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataPlannerWorkspace(workspace = createDataPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataPlannerNarratives(workspace = createDataPlannerWorkspace()) {
...
export function createDataPlannerCoverageGrid(workspace = createDataPlannerWorkspace()) {
