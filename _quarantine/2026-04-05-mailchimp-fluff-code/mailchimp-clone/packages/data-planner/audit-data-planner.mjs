...
export function createDataPlannerAuditTrail() {
...
export function createDataPlannerEvidenceManifest() {
...
export function createDataPlannerReadinessAttestation() {
  const auditTrail = createDataPlannerAuditTrail();
  return {
