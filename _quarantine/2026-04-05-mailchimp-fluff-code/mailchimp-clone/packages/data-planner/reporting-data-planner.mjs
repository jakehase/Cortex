...
export function createDataPlannerReportCards() {
...
export function createDataPlannerReviewPackets() {
...
export function summarizeDataPlannerReporting() {
  const cards = createDataPlannerReportCards();
  const packets = createDataPlannerReviewPackets();
  return {
