...
export function createCampaignWorkbenchAnalyticsTimeline() {
...
export function createCampaignWorkbenchForecastEnvelope() {
...
export function createCampaignWorkbenchExceptionLedger() {
...
export function summarizeCampaignWorkbenchAnalytics() {
  const timeline = createCampaignWorkbenchAnalyticsTimeline();
  const forecast = createCampaignWorkbenchForecastEnvelope();
  return {
