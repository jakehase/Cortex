...
export function createCampaignWorkbenchPolicies(overrides = {}) {
...
export function validateCampaignWorkbenchPolicies(policies = createCampaignWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeCampaignWorkbenchPolicies(policies = createCampaignWorkbenchPolicies()) {
  return {
...
export function createCampaignWorkbenchEscalationDeck(policies = createCampaignWorkbenchPolicies()) {
