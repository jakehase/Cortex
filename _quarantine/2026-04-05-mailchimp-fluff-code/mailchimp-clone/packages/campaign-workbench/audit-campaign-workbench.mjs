...
export function createCampaignWorkbenchAuditTrail() {
...
export function createCampaignWorkbenchEvidenceManifest() {
...
export function createCampaignWorkbenchReadinessAttestation() {
  const auditTrail = createCampaignWorkbenchAuditTrail();
  return {
