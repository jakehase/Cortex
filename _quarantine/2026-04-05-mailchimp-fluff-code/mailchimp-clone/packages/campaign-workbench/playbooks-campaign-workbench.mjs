...
export function createCampaignWorkbenchPlaybooks() {
...
export function createCampaignWorkbenchDecisionDeck() {
...
export function createCampaignWorkbenchEscalationMoments() {
