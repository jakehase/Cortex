...
export function createDataAtlasReportCards() {
...
export function createDataAtlasReviewPackets() {
...
export function summarizeDataAtlasReporting() {
  const cards = createDataAtlasReportCards();
  const packets = createDataAtlasReviewPackets();
  return {
