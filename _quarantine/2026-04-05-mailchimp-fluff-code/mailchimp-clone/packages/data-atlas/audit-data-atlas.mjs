...
export function createDataAtlasAuditTrail() {
...
export function createDataAtlasEvidenceManifest() {
...
export function createDataAtlasReadinessAttestation() {
  const auditTrail = createDataAtlasAuditTrail();
  return {
