...
export function createCustomerLedgerAuditTrail() {
...
export function createCustomerLedgerEvidenceManifest() {
...
export function createCustomerLedgerReadinessAttestation() {
  const auditTrail = createCustomerLedgerAuditTrail();
  return {
