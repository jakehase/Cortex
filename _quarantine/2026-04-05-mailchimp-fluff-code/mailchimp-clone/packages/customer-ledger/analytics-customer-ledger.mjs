...
export function createCustomerLedgerAnalyticsTimeline() {
...
export function createCustomerLedgerForecastEnvelope() {
...
export function createCustomerLedgerExceptionLedger() {
...
export function summarizeCustomerLedgerAnalytics() {
  const timeline = createCustomerLedgerAnalyticsTimeline();
  const forecast = createCustomerLedgerForecastEnvelope();
  return {
