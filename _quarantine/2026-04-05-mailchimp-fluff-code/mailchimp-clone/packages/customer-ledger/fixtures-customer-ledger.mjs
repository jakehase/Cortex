...
export function createCustomerLedgerFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerLedgerFixtures(fixtures = createCustomerLedgerFixtures()) {
  return {
...
export function createCustomerLedgerDemoInputs() {
  return {
