...
export function createCustomerLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeCustomerLedgerWorkspace(workspace = createCustomerLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createCustomerLedgerNarratives(workspace = createCustomerLedgerWorkspace()) {
...
export function createCustomerLedgerCoverageGrid(workspace = createCustomerLedgerWorkspace()) {
