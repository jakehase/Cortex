...
export function createConsentWatchtowerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeConsentWatchtowerWorkspace(workspace = createConsentWatchtowerWorkspace()) {
  return {
    id: workspace.id,
...
export function createConsentWatchtowerNarratives(workspace = createConsentWatchtowerWorkspace()) {
...
export function createConsentWatchtowerCoverageGrid(workspace = createConsentWatchtowerWorkspace()) {
