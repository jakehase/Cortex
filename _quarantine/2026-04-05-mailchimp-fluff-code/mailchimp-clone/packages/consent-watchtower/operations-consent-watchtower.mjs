...
export function createConsentWatchtowerOperationsBoard() {
...
export function createConsentWatchtowerShiftChecklist() {
...
export function createConsentWatchtowerIncidentDeck() {
