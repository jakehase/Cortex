...
export function createConsentWatchtowerAnalyticsTimeline() {
...
export function createConsentWatchtowerForecastEnvelope() {
...
export function createConsentWatchtowerExceptionLedger() {
...
export function summarizeConsentWatchtowerAnalytics() {
  const timeline = createConsentWatchtowerAnalyticsTimeline();
  const forecast = createConsentWatchtowerForecastEnvelope();
  return {
