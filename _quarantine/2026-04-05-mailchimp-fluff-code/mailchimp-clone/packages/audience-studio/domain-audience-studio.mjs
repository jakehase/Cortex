...
export function createAudienceStudioWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceStudioWorkspace(workspace = createAudienceStudioWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceStudioNarratives(workspace = createAudienceStudioWorkspace()) {
...
export function createAudienceStudioCoverageGrid(workspace = createAudienceStudioWorkspace()) {
