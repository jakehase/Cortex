...
export function createAudienceStudioFixtures() {
  return {
    accounts: [
...
export function summarizeAudienceStudioFixtures(fixtures = createAudienceStudioFixtures()) {
  return {
...
export function createAudienceStudioDemoInputs() {
  return {
