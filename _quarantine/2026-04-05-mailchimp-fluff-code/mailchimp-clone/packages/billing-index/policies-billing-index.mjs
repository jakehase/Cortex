...
export function createBillingIndexPolicies(overrides = {}) {
...
export function validateBillingIndexPolicies(policies = createBillingIndexPolicies()) {
  const issues = [];
...
export function summarizeBillingIndexPolicies(policies = createBillingIndexPolicies()) {
  return {
...
export function createBillingIndexEscalationDeck(policies = createBillingIndexPolicies()) {
