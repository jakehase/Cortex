...
export function createBillingIndexReportCards() {
...
export function createBillingIndexReviewPackets() {
...
export function summarizeBillingIndexReporting() {
  const cards = createBillingIndexReportCards();
  const packets = createBillingIndexReviewPackets();
  return {
