...
export function createBillingIndexAuditTrail() {
...
export function createBillingIndexEvidenceManifest() {
...
export function createBillingIndexReadinessAttestation() {
  const auditTrail = createBillingIndexAuditTrail();
  return {
