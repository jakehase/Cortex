...
export function createAttributionSentinelPolicies(overrides = {}) {
...
export function validateAttributionSentinelPolicies(policies = createAttributionSentinelPolicies()) {
  const issues = [];
...
export function summarizeAttributionSentinelPolicies(policies = createAttributionSentinelPolicies()) {
  return {
...
export function createAttributionSentinelEscalationDeck(policies = createAttributionSentinelPolicies()) {
