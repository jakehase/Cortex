...
export function createAnalyticsIndexReportCards() {
...
export function createAnalyticsIndexReviewPackets() {
...
export function summarizeAnalyticsIndexReporting() {
  const cards = createAnalyticsIndexReportCards();
  const packets = createAnalyticsIndexReviewPackets();
  return {
