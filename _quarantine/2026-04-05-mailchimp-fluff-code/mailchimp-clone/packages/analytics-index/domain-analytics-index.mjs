const MODULE = {
  ...
  "focus": "Analytics Index covers portfolio analytics, operator scorecards, and query-driven reviews through searchable summaries and coverage catalogs.",
...
export function createAnalyticsIndexWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAnalyticsIndexWorkspace(workspace = createAnalyticsIndexWorkspace()) {
  return {
    id: workspace.id,
...
export function createAnalyticsIndexNarratives(workspace = createAnalyticsIndexWorkspace()) {
...
export function createAnalyticsIndexCoverageGrid(workspace = createAnalyticsIndexWorkspace()) {
