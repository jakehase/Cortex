...
export function createChannelScorecardOperationsBoard() {
...
export function createChannelScorecardShiftChecklist() {
...
export function createChannelScorecardIncidentDeck() {
