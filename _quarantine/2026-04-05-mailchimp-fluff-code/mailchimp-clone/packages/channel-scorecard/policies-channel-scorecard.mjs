...
export function createChannelScorecardPolicies(overrides = {}) {
...
export function validateChannelScorecardPolicies(policies = createChannelScorecardPolicies()) {
  const issues = [];
...
export function summarizeChannelScorecardPolicies(policies = createChannelScorecardPolicies()) {
  return {
...
export function createChannelScorecardEscalationDeck(policies = createChannelScorecardPolicies()) {
