...
export function createChannelScorecardAuditTrail() {
...
export function createChannelScorecardEvidenceManifest() {
...
export function createChannelScorecardReadinessAttestation() {
  const auditTrail = createChannelScorecardAuditTrail();
  return {
