...
export function createChannelScorecardReportCards() {
...
export function createChannelScorecardReviewPackets() {
...
export function summarizeChannelScorecardReporting() {
  const cards = createChannelScorecardReportCards();
  const packets = createChannelScorecardReviewPackets();
  return {
