...
export function createAudienceCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceCockpitWorkspace(workspace = createAudienceCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceCockpitNarratives(workspace = createAudienceCockpitWorkspace()) {
...
export function createAudienceCockpitCoverageGrid(workspace = createAudienceCockpitWorkspace()) {
