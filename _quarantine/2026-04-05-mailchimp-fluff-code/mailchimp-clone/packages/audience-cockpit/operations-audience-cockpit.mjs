...
export function createAudienceCockpitOperationsBoard() {
...
export function createAudienceCockpitShiftChecklist() {
...
export function createAudienceCockpitIncidentDeck() {
