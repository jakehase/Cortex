...
export function createCampaignAdvisorAuditTrail() {
...
export function createCampaignAdvisorEvidenceManifest() {
...
export function createCampaignAdvisorReadinessAttestation() {
  const auditTrail = createCampaignAdvisorAuditTrail();
  return {
