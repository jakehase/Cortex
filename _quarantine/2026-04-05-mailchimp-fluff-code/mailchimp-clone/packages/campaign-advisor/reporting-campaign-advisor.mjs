...
export function createCampaignAdvisorReportCards() {
...
export function createCampaignAdvisorReviewPackets() {
...
export function summarizeCampaignAdvisorReporting() {
  const cards = createCampaignAdvisorReportCards();
  const packets = createCampaignAdvisorReviewPackets();
  return {
