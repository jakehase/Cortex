...
export function createEcommerceFoundryPlaybooks() {
...
export function createEcommerceFoundryDecisionDeck() {
...
export function createEcommerceFoundryEscalationMoments() {
