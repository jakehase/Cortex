...
export function createEcommerceLedgerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceLedgerWorkspace(workspace = createEcommerceLedgerWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceLedgerNarratives(workspace = createEcommerceLedgerWorkspace()) {
...
export function createEcommerceLedgerCoverageGrid(workspace = createEcommerceLedgerWorkspace()) {
