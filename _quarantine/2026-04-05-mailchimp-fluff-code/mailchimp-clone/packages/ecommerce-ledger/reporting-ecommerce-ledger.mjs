...
export function createEcommerceLedgerReportCards() {
...
export function createEcommerceLedgerReviewPackets() {
...
export function summarizeEcommerceLedgerReporting() {
  const cards = createEcommerceLedgerReportCards();
  const packets = createEcommerceLedgerReviewPackets();
  return {
