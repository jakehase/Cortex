...
export function createEcommerceLedgerAnalyticsTimeline() {
...
export function createEcommerceLedgerForecastEnvelope() {
...
export function createEcommerceLedgerExceptionLedger() {
...
export function summarizeEcommerceLedgerAnalytics() {
  const timeline = createEcommerceLedgerAnalyticsTimeline();
  const forecast = createEcommerceLedgerForecastEnvelope();
  return {
