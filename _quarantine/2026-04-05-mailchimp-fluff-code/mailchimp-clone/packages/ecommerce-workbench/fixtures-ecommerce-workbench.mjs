...
export function createEcommerceWorkbenchFixtures() {
  return {
    accounts: [
...
export function summarizeEcommerceWorkbenchFixtures(fixtures = createEcommerceWorkbenchFixtures()) {
  return {
...
export function createEcommerceWorkbenchDemoInputs() {
  return {
