...
export function createEcommerceWorkbenchPolicies(overrides = {}) {
...
export function validateEcommerceWorkbenchPolicies(policies = createEcommerceWorkbenchPolicies()) {
  const issues = [];
...
export function summarizeEcommerceWorkbenchPolicies(policies = createEcommerceWorkbenchPolicies()) {
  return {
...
export function createEcommerceWorkbenchEscalationDeck(policies = createEcommerceWorkbenchPolicies()) {
