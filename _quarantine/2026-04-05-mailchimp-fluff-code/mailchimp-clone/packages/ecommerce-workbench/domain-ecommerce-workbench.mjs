...
export function createEcommerceWorkbenchWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceWorkbenchWorkspace(workspace = createEcommerceWorkbenchWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceWorkbenchNarratives(workspace = createEcommerceWorkbenchWorkspace()) {
...
export function createEcommerceWorkbenchCoverageGrid(workspace = createEcommerceWorkbenchWorkspace()) {
