...
export function createCampaignNavigatorOperationsBoard() {
...
export function createCampaignNavigatorShiftChecklist() {
...
export function createCampaignNavigatorIncidentDeck() {
