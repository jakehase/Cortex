...
export function createCampaignNavigatorAuditTrail() {
...
export function createCampaignNavigatorEvidenceManifest() {
...
export function createCampaignNavigatorReadinessAttestation() {
  const auditTrail = createCampaignNavigatorAuditTrail();
  return {
