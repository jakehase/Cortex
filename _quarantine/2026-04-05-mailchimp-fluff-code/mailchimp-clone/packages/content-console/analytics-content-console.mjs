...
export function createContentConsoleAnalyticsTimeline() {
...
export function createContentConsoleForecastEnvelope() {
...
export function createContentConsoleExceptionLedger() {
...
export function summarizeContentConsoleAnalytics() {
  const timeline = createContentConsoleAnalyticsTimeline();
  const forecast = createContentConsoleForecastEnvelope();
  return {
