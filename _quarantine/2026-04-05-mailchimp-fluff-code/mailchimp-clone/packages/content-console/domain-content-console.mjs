const MODULE = {
  ...
  "focus": "Content Console covers content operations, packaging, and channel-specific delivery shape through execution controls and workspace steering.",
...
export function createContentConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeContentConsoleWorkspace(workspace = createContentConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createContentConsoleNarratives(workspace = createContentConsoleWorkspace()) {
...
export function createContentConsoleCoverageGrid(workspace = createContentConsoleWorkspace()) {
