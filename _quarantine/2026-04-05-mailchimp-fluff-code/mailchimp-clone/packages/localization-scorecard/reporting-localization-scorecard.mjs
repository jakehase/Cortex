...
export function createLocalizationScorecardReportCards() {
...
export function createLocalizationScorecardReviewPackets() {
...
export function summarizeLocalizationScorecardReporting() {
  const cards = createLocalizationScorecardReportCards();
  const packets = createLocalizationScorecardReviewPackets();
  return {
