...
export function createAudienceVaultReportCards() {
...
export function createAudienceVaultReviewPackets() {
...
export function summarizeAudienceVaultReporting() {
  const cards = createAudienceVaultReportCards();
  const packets = createAudienceVaultReviewPackets();
  return {
