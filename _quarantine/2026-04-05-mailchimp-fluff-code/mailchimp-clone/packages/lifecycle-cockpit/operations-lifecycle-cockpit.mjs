...
export function createLifecycleCockpitOperationsBoard() {
...
export function createLifecycleCockpitShiftChecklist() {
...
export function createLifecycleCockpitIncidentDeck() {
