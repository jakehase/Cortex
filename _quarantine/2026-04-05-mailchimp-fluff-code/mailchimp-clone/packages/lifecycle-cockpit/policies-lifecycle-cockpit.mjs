...
export function createLifecycleCockpitPolicies(overrides = {}) {
...
export function validateLifecycleCockpitPolicies(policies = createLifecycleCockpitPolicies()) {
  const issues = [];
...
export function summarizeLifecycleCockpitPolicies(policies = createLifecycleCockpitPolicies()) {
  return {
...
export function createLifecycleCockpitEscalationDeck(policies = createLifecycleCockpitPolicies()) {
