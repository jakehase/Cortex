...
export function createLifecycleCockpitAuditTrail() {
...
export function createLifecycleCockpitEvidenceManifest() {
...
export function createLifecycleCockpitReadinessAttestation() {
  const auditTrail = createLifecycleCockpitAuditTrail();
  return {
