...
export function createDeliverabilityVaultPolicies(overrides = {}) {
...
export function validateDeliverabilityVaultPolicies(policies = createDeliverabilityVaultPolicies()) {
  const issues = [];
...
export function summarizeDeliverabilityVaultPolicies(policies = createDeliverabilityVaultPolicies()) {
  return {
...
export function createDeliverabilityVaultEscalationDeck(policies = createDeliverabilityVaultPolicies()) {
