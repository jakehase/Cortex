...
export function createLoyaltyNotebookOperationsBoard() {
...
export function createLoyaltyNotebookShiftChecklist() {
...
export function createLoyaltyNotebookIncidentDeck() {
