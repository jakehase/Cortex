...
export function createContentPlannerAuditTrail() {
...
export function createContentPlannerEvidenceManifest() {
...
export function createContentPlannerReadinessAttestation() {
  const auditTrail = createContentPlannerAuditTrail();
  return {
