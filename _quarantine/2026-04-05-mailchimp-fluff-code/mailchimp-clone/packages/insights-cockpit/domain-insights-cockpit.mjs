const MODULE = {
  ...
  "title": "Insights Cockpit",
  "focus": "Insights Cockpit covers insight synthesis, operating narratives, and executive-ready summaries through operator controls and active monitoring.",
...
export function createInsightsCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeInsightsCockpitWorkspace(workspace = createInsightsCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createInsightsCockpitNarratives(workspace = createInsightsCockpitWorkspace()) {
...
export function createInsightsCockpitCoverageGrid(workspace = createInsightsCockpitWorkspace()) {
