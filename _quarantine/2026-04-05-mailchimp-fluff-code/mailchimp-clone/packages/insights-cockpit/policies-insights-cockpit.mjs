...
export function createInsightsCockpitPolicies(overrides = {}) {
...
export function validateInsightsCockpitPolicies(policies = createInsightsCockpitPolicies()) {
  const issues = [];
...
export function summarizeInsightsCockpitPolicies(policies = createInsightsCockpitPolicies()) {
  return {
...
export function createInsightsCockpitEscalationDeck(policies = createInsightsCockpitPolicies()) {
