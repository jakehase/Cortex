...
export function createCampaignWatchtowerPolicies(overrides = {}) {
...
export function validateCampaignWatchtowerPolicies(policies = createCampaignWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeCampaignWatchtowerPolicies(policies = createCampaignWatchtowerPolicies()) {
  return {
...
export function createCampaignWatchtowerEscalationDeck(policies = createCampaignWatchtowerPolicies()) {
