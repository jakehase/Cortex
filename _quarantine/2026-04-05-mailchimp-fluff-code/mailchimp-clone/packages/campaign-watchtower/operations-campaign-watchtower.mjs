...
export function createCampaignWatchtowerOperationsBoard() {
...
export function createCampaignWatchtowerShiftChecklist() {
...
export function createCampaignWatchtowerIncidentDeck() {
