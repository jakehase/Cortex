...
export function createCampaignWatchtowerPlaybooks() {
...
export function createCampaignWatchtowerDecisionDeck() {
...
export function createCampaignWatchtowerEscalationMoments() {
