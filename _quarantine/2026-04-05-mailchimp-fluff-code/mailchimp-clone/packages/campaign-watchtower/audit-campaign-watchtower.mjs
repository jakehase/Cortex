...
export function createCampaignWatchtowerAuditTrail() {
...
export function createCampaignWatchtowerEvidenceManifest() {
...
export function createCampaignWatchtowerReadinessAttestation() {
  const auditTrail = createCampaignWatchtowerAuditTrail();
  return {
