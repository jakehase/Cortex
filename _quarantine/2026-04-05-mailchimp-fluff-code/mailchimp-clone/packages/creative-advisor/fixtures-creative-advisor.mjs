...
export function createCreativeAdvisorFixtures() {
  return {
    accounts: [
...
export function summarizeCreativeAdvisorFixtures(fixtures = createCreativeAdvisorFixtures()) {
  return {
...
export function createCreativeAdvisorDemoInputs() {
  return {
