...
export function createAudiencePlannerAuditTrail() {
...
export function createAudiencePlannerEvidenceManifest() {
...
export function createAudiencePlannerReadinessAttestation() {
  const auditTrail = createAudiencePlannerAuditTrail();
  return {
