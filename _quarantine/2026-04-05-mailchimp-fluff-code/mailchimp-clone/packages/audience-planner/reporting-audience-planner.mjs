...
export function createAudiencePlannerReportCards() {
...
export function createAudiencePlannerReviewPackets() {
...
export function summarizeAudiencePlannerReporting() {
  const cards = createAudiencePlannerReportCards();
  const packets = createAudiencePlannerReviewPackets();
  return {
