...
export function createAudiencePlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudiencePlannerWorkspace(workspace = createAudiencePlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudiencePlannerNarratives(workspace = createAudiencePlannerWorkspace()) {
...
export function createAudiencePlannerCoverageGrid(workspace = createAudiencePlannerWorkspace()) {
