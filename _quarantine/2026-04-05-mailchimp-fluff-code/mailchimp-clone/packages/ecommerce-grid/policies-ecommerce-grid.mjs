...
export function createEcommerceGridPolicies(overrides = {}) {
...
export function validateEcommerceGridPolicies(policies = createEcommerceGridPolicies()) {
  const issues = [];
...
export function summarizeEcommerceGridPolicies(policies = createEcommerceGridPolicies()) {
  return {
...
export function createEcommerceGridEscalationDeck(policies = createEcommerceGridPolicies()) {
