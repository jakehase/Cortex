...
export function createEcommerceCockpitPlaybooks() {
...
export function createEcommerceCockpitDecisionDeck() {
...
export function createEcommerceCockpitEscalationMoments() {
