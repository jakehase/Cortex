...
export function createEcommerceCockpitWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceCockpitWorkspace(workspace = createEcommerceCockpitWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceCockpitNarratives(workspace = createEcommerceCockpitWorkspace()) {
...
export function createEcommerceCockpitCoverageGrid(workspace = createEcommerceCockpitWorkspace()) {
