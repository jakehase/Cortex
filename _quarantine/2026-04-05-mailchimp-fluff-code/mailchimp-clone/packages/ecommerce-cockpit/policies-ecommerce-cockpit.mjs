...
export function createEcommerceCockpitPolicies(overrides = {}) {
...
export function validateEcommerceCockpitPolicies(policies = createEcommerceCockpitPolicies()) {
  const issues = [];
...
export function summarizeEcommerceCockpitPolicies(policies = createEcommerceCockpitPolicies()) {
  return {
...
export function createEcommerceCockpitEscalationDeck(policies = createEcommerceCockpitPolicies()) {
