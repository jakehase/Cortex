...
export function createEcommerceCockpitOperationsBoard() {
...
export function createEcommerceCockpitShiftChecklist() {
...
export function createEcommerceCockpitIncidentDeck() {
