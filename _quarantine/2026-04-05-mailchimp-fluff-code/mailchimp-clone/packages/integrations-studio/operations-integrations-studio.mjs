...
export function createIntegrationsStudioOperationsBoard() {
...
export function createIntegrationsStudioShiftChecklist() {
...
export function createIntegrationsStudioIncidentDeck() {
