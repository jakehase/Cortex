...
export function createIntegrationsStudioAnalyticsTimeline() {
...
export function createIntegrationsStudioForecastEnvelope() {
...
export function createIntegrationsStudioExceptionLedger() {
...
export function summarizeIntegrationsStudioAnalytics() {
  const timeline = createIntegrationsStudioAnalyticsTimeline();
  const forecast = createIntegrationsStudioForecastEnvelope();
  return {
