...
export function createExperimentationSentinelPolicies(overrides = {}) {
...
export function validateExperimentationSentinelPolicies(policies = createExperimentationSentinelPolicies()) {
  const issues = [];
...
export function summarizeExperimentationSentinelPolicies(policies = createExperimentationSentinelPolicies()) {
  return {
...
export function createExperimentationSentinelEscalationDeck(policies = createExperimentationSentinelPolicies()) {
