...
export function createExperimentationSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeExperimentationSentinelWorkspace(workspace = createExperimentationSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createExperimentationSentinelNarratives(workspace = createExperimentationSentinelWorkspace()) {
...
export function createExperimentationSentinelCoverageGrid(workspace = createExperimentationSentinelWorkspace()) {
