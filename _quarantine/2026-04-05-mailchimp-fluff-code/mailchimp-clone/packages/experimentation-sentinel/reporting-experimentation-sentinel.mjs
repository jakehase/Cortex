...
export function createExperimentationSentinelReportCards() {
...
export function createExperimentationSentinelReviewPackets() {
...
export function summarizeExperimentationSentinelReporting() {
  const cards = createExperimentationSentinelReportCards();
  const packets = createExperimentationSentinelReviewPackets();
  return {
