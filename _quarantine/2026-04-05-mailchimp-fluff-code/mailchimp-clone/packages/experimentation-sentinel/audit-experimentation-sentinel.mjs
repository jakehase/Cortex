...
export function createExperimentationSentinelAuditTrail() {
...
export function createExperimentationSentinelEvidenceManifest() {
...
export function createExperimentationSentinelReadinessAttestation() {
  const auditTrail = createExperimentationSentinelAuditTrail();
  return {
