...
export function createCommerceAdvisorPolicies(overrides = {}) {
...
export function validateCommerceAdvisorPolicies(policies = createCommerceAdvisorPolicies()) {
  const issues = [];
...
export function summarizeCommerceAdvisorPolicies(policies = createCommerceAdvisorPolicies()) {
  return {
...
export function createCommerceAdvisorEscalationDeck(policies = createCommerceAdvisorPolicies()) {
