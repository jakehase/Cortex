...
export function createDeliverabilityConsoleWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDeliverabilityConsoleWorkspace(workspace = createDeliverabilityConsoleWorkspace()) {
  return {
    id: workspace.id,
...
export function createDeliverabilityConsoleNarratives(workspace = createDeliverabilityConsoleWorkspace()) {
...
export function createDeliverabilityConsoleCoverageGrid(workspace = createDeliverabilityConsoleWorkspace()) {
