...
export function createDeliverabilityConsoleAuditTrail() {
...
export function createDeliverabilityConsoleEvidenceManifest() {
...
export function createDeliverabilityConsoleReadinessAttestation() {
  const auditTrail = createDeliverabilityConsoleAuditTrail();
  return {
