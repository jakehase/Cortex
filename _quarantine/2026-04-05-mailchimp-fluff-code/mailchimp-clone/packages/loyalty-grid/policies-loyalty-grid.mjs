...
export function createLoyaltyGridPolicies(overrides = {}) {
...
export function validateLoyaltyGridPolicies(policies = createLoyaltyGridPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyGridPolicies(policies = createLoyaltyGridPolicies()) {
  return {
...
export function createLoyaltyGridEscalationDeck(policies = createLoyaltyGridPolicies()) {
