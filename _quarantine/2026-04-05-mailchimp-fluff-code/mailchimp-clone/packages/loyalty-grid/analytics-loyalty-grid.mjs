...
export function createLoyaltyGridAnalyticsTimeline() {
...
export function createLoyaltyGridForecastEnvelope() {
...
export function createLoyaltyGridExceptionLedger() {
...
export function summarizeLoyaltyGridAnalytics() {
  const timeline = createLoyaltyGridAnalyticsTimeline();
  const forecast = createLoyaltyGridForecastEnvelope();
  return {
