...
export function createComplianceWorkbenchAnalyticsTimeline() {
...
export function createComplianceWorkbenchForecastEnvelope() {
...
export function createComplianceWorkbenchExceptionLedger() {
...
export function summarizeComplianceWorkbenchAnalytics() {
  const timeline = createComplianceWorkbenchAnalyticsTimeline();
  const forecast = createComplianceWorkbenchForecastEnvelope();
  return {
