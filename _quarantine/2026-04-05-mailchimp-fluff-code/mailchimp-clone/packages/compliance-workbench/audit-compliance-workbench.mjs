...
export function createComplianceWorkbenchAuditTrail() {
...
export function createComplianceWorkbenchEvidenceManifest() {
...
export function createComplianceWorkbenchReadinessAttestation() {
  const auditTrail = createComplianceWorkbenchAuditTrail();
  return {
