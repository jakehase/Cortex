...
export function createComplianceWorkbenchPlaybooks() {
...
export function createComplianceWorkbenchDecisionDeck() {
...
export function createComplianceWorkbenchEscalationMoments() {
