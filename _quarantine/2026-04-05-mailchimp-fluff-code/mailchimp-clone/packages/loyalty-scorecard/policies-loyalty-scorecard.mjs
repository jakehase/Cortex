...
export function createLoyaltyScorecardPolicies(overrides = {}) {
...
export function validateLoyaltyScorecardPolicies(policies = createLoyaltyScorecardPolicies()) {
  const issues = [];
...
export function summarizeLoyaltyScorecardPolicies(policies = createLoyaltyScorecardPolicies()) {
  return {
...
export function createLoyaltyScorecardEscalationDeck(policies = createLoyaltyScorecardPolicies()) {
