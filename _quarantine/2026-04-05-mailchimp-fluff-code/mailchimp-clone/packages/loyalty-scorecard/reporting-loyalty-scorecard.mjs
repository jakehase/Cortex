...
export function createLoyaltyScorecardReportCards() {
...
export function createLoyaltyScorecardReviewPackets() {
...
export function summarizeLoyaltyScorecardReporting() {
  const cards = createLoyaltyScorecardReportCards();
  const packets = createLoyaltyScorecardReviewPackets();
  return {
