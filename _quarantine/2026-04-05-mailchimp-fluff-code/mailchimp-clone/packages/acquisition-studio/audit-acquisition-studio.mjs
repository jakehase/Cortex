...
export function createAcquisitionStudioAuditTrail() {
...
export function createAcquisitionStudioEvidenceManifest() {
...
export function createAcquisitionStudioReadinessAttestation() {
  const auditTrail = createAcquisitionStudioAuditTrail();
  return {
