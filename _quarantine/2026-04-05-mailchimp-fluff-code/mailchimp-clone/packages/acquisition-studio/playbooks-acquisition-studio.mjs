...
export function createAcquisitionStudioPlaybooks() {
...
export function createAcquisitionStudioDecisionDeck() {
...
export function createAcquisitionStudioEscalationMoments() {
