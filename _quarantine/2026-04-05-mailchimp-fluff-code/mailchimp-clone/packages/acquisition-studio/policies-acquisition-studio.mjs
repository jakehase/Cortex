...
export function createAcquisitionStudioPolicies(overrides = {}) {
...
export function validateAcquisitionStudioPolicies(policies = createAcquisitionStudioPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionStudioPolicies(policies = createAcquisitionStudioPolicies()) {
  return {
...
export function createAcquisitionStudioEscalationDeck(policies = createAcquisitionStudioPolicies()) {
