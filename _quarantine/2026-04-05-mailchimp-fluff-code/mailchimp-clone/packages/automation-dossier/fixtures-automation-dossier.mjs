...
export function createAutomationDossierFixtures() {
  return {
    accounts: [
...
export function summarizeAutomationDossierFixtures(fixtures = createAutomationDossierFixtures()) {
  return {
...
export function createAutomationDossierDemoInputs() {
  return {
