...
export function createAutomationDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAutomationDossierWorkspace(workspace = createAutomationDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createAutomationDossierNarratives(workspace = createAutomationDossierWorkspace()) {
...
export function createAutomationDossierCoverageGrid(workspace = createAutomationDossierWorkspace()) {
