...
export function createAutomationDossierPolicies(overrides = {}) {
...
export function validateAutomationDossierPolicies(policies = createAutomationDossierPolicies()) {
  const issues = [];
...
export function summarizeAutomationDossierPolicies(policies = createAutomationDossierPolicies()) {
  return {
...
export function createAutomationDossierEscalationDeck(policies = createAutomationDossierPolicies()) {
