...
export function createInsightsIndexPolicies(overrides = {}) {
...
export function validateInsightsIndexPolicies(policies = createInsightsIndexPolicies()) {
  const issues = [];
...
export function summarizeInsightsIndexPolicies(policies = createInsightsIndexPolicies()) {
  return {
...
export function createInsightsIndexEscalationDeck(policies = createInsightsIndexPolicies()) {
