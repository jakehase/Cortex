...
export function createAdvocacyDossierAnalyticsTimeline() {
...
export function createAdvocacyDossierForecastEnvelope() {
...
export function createAdvocacyDossierExceptionLedger() {
...
export function summarizeAdvocacyDossierAnalytics() {
  const timeline = createAdvocacyDossierAnalyticsTimeline();
  const forecast = createAdvocacyDossierForecastEnvelope();
  return {
