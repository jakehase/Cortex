...
export function createAdvocacyDossierPolicies(overrides = {}) {
...
export function validateAdvocacyDossierPolicies(policies = createAdvocacyDossierPolicies()) {
  const issues = [];
...
export function summarizeAdvocacyDossierPolicies(policies = createAdvocacyDossierPolicies()) {
  return {
...
export function createAdvocacyDossierEscalationDeck(policies = createAdvocacyDossierPolicies()) {
