...
export function createAdvocacyDossierReportCards() {
...
export function createAdvocacyDossierReviewPackets() {
...
export function summarizeAdvocacyDossierReporting() {
  const cards = createAdvocacyDossierReportCards();
  const packets = createAdvocacyDossierReviewPackets();
  return {
