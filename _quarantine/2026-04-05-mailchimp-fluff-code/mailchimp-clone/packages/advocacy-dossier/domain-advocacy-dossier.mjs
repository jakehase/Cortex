...
export function createAdvocacyDossierWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAdvocacyDossierWorkspace(workspace = createAdvocacyDossierWorkspace()) {
  return {
    id: workspace.id,
...
export function createAdvocacyDossierNarratives(workspace = createAdvocacyDossierWorkspace()) {
...
export function createAdvocacyDossierCoverageGrid(workspace = createAdvocacyDossierWorkspace()) {
