...
export function createCommerceWatchtowerPolicies(overrides = {}) {
...
export function validateCommerceWatchtowerPolicies(policies = createCommerceWatchtowerPolicies()) {
  const issues = [];
...
export function summarizeCommerceWatchtowerPolicies(policies = createCommerceWatchtowerPolicies()) {
  return {
...
export function createCommerceWatchtowerEscalationDeck(policies = createCommerceWatchtowerPolicies()) {
