...
export function createCommerceWatchtowerReportCards() {
...
export function createCommerceWatchtowerReviewPackets() {
...
export function summarizeCommerceWatchtowerReporting() {
  const cards = createCommerceWatchtowerReportCards();
  const packets = createCommerceWatchtowerReviewPackets();
  return {
