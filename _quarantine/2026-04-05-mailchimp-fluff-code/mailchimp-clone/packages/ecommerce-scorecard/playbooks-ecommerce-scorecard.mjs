...
export function createEcommerceScorecardPlaybooks() {
...
export function createEcommerceScorecardDecisionDeck() {
...
export function createEcommerceScorecardEscalationMoments() {
