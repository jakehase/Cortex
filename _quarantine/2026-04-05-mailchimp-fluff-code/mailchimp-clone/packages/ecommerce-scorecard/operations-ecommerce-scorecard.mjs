...
export function createEcommerceScorecardOperationsBoard() {
...
export function createEcommerceScorecardShiftChecklist() {
...
export function createEcommerceScorecardIncidentDeck() {
