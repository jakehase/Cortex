...
export function createEcommerceScorecardWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeEcommerceScorecardWorkspace(workspace = createEcommerceScorecardWorkspace()) {
  return {
    id: workspace.id,
...
export function createEcommerceScorecardNarratives(workspace = createEcommerceScorecardWorkspace()) {
...
export function createEcommerceScorecardCoverageGrid(workspace = createEcommerceScorecardWorkspace()) {
