...
export function createAutomationSentinelOperationsBoard() {
...
export function createAutomationSentinelShiftChecklist() {
...
export function createAutomationSentinelIncidentDeck() {
