...
export function createAutomationSentinelPlaybooks() {
...
export function createAutomationSentinelDecisionDeck() {
...
export function createAutomationSentinelEscalationMoments() {
