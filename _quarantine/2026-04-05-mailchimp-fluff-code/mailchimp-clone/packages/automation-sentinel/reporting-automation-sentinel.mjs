...
export function createAutomationSentinelReportCards() {
...
export function createAutomationSentinelReviewPackets() {
...
export function summarizeAutomationSentinelReporting() {
  const cards = createAutomationSentinelReportCards();
  const packets = createAutomationSentinelReviewPackets();
  return {
