...
export function createDataHubReportCards() {
...
export function createDataHubReviewPackets() {
...
export function summarizeDataHubReporting() {
  const cards = createDataHubReportCards();
  const packets = createDataHubReviewPackets();
  return {
