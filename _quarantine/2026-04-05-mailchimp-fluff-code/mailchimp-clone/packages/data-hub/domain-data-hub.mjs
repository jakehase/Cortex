const MODULE = {
  ...
  "routeSegment": "hub",
  "title": "Data Hub",
  "focus": "Data Hub covers pipeline health, lineage, freshness, and operator trust in data assets through centralized operating views and routing.",
...
export function createDataHubWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataHubWorkspace(workspace = createDataHubWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataHubNarratives(workspace = createDataHubWorkspace()) {
...
export function createDataHubCoverageGrid(workspace = createDataHubWorkspace()) {
