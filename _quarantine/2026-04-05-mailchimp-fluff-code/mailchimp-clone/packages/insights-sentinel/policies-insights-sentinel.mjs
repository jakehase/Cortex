...
export function createInsightsSentinelPolicies(overrides = {}) {
...
export function validateInsightsSentinelPolicies(policies = createInsightsSentinelPolicies()) {
  const issues = [];
...
export function summarizeInsightsSentinelPolicies(policies = createInsightsSentinelPolicies()) {
  return {
...
export function createInsightsSentinelEscalationDeck(policies = createInsightsSentinelPolicies()) {
