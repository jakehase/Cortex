...
export function createInsightsSentinelReportCards() {
...
export function createInsightsSentinelReviewPackets() {
...
export function summarizeInsightsSentinelReporting() {
  const cards = createInsightsSentinelReportCards();
  const packets = createInsightsSentinelReviewPackets();
  return {
