...
export function createInsightsSentinelOperationsBoard() {
...
export function createInsightsSentinelShiftChecklist() {
...
export function createInsightsSentinelIncidentDeck() {
