...
export function createInsightsSentinelPlaybooks() {
...
export function createInsightsSentinelDecisionDeck() {
...
export function createInsightsSentinelEscalationMoments() {
