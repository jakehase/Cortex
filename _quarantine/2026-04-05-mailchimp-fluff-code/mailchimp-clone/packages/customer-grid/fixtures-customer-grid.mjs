...
export function createCustomerGridFixtures() {
  return {
    accounts: [
...
export function summarizeCustomerGridFixtures(fixtures = createCustomerGridFixtures()) {
  return {
...
export function createCustomerGridDemoInputs() {
  return {
