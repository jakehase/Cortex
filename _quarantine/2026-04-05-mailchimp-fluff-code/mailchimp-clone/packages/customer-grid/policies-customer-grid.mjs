...
export function createCustomerGridPolicies(overrides = {}) {
...
export function validateCustomerGridPolicies(policies = createCustomerGridPolicies()) {
  const issues = [];
...
export function summarizeCustomerGridPolicies(policies = createCustomerGridPolicies()) {
  return {
...
export function createCustomerGridEscalationDeck(policies = createCustomerGridPolicies()) {
