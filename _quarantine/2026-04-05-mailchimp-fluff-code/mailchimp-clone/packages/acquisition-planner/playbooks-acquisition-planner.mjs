...
export function createAcquisitionPlannerPlaybooks() {
...
export function createAcquisitionPlannerDecisionDeck() {
...
export function createAcquisitionPlannerEscalationMoments() {
