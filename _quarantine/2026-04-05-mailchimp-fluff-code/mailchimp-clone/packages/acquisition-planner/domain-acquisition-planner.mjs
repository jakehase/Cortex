const MODULE = {
  ...
  "focus": "Acquisition Planner covers new demand creation, source quality, and upstream handoff clarity through calendar planning and execution choreography.",
  ...
  "tags": [
    ...
    "planner",
    "growth",
    "acquisition-planner-wave-seven"
  ]
};
...
export function createAcquisitionPlannerWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionPlannerWorkspace(workspace = createAcquisitionPlannerWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionPlannerNarratives(workspace = createAcquisitionPlannerWorkspace()) {
...
export function createAcquisitionPlannerCoverageGrid(workspace = createAcquisitionPlannerWorkspace()) {
