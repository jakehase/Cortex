...
export function createAudienceScorecardAuditTrail() {
...
export function createAudienceScorecardEvidenceManifest() {
...
export function createAudienceScorecardReadinessAttestation() {
  const auditTrail = createAudienceScorecardAuditTrail();
  return {
