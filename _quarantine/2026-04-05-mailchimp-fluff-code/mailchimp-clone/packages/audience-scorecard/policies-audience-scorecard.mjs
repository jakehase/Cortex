...
export function createAudienceScorecardPolicies(overrides = {}) {
...
export function validateAudienceScorecardPolicies(policies = createAudienceScorecardPolicies()) {
  const issues = [];
...
export function summarizeAudienceScorecardPolicies(policies = createAudienceScorecardPolicies()) {
  return {
...
export function createAudienceScorecardEscalationDeck(policies = createAudienceScorecardPolicies()) {
