...
export function createAcquisitionCockpitAuditTrail() {
...
export function createAcquisitionCockpitEvidenceManifest() {
...
export function createAcquisitionCockpitReadinessAttestation() {
  const auditTrail = createAcquisitionCockpitAuditTrail();
  return {
