const MODULE = {
  ...
  "focus": "Acquisition Advisor covers new demand creation, source quality, and upstream handoff clarity through recommendations and next-step framing.",
  ...
  "tags": [
    ...
    "advisor",
    "growth",
    "acquisition-advisor-wave-seven"
  ]
};
...
export function createAcquisitionAdvisorWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAcquisitionAdvisorWorkspace(workspace = createAcquisitionAdvisorWorkspace()) {
  return {
    id: workspace.id,
...
export function createAcquisitionAdvisorNarratives(workspace = createAcquisitionAdvisorWorkspace()) {
...
export function createAcquisitionAdvisorCoverageGrid(workspace = createAcquisitionAdvisorWorkspace()) {
