...
export function createAcquisitionAdvisorPlaybooks() {
...
export function createAcquisitionAdvisorDecisionDeck() {
...
export function createAcquisitionAdvisorEscalationMoments() {
