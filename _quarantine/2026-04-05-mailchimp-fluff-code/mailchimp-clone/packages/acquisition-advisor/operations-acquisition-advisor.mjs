...
export function createAcquisitionAdvisorOperationsBoard() {
...
export function createAcquisitionAdvisorShiftChecklist() {
...
export function createAcquisitionAdvisorIncidentDeck() {
