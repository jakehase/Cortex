...
export function createAcquisitionAdvisorPolicies(overrides = {}) {
...
export function validateAcquisitionAdvisorPolicies(policies = createAcquisitionAdvisorPolicies()) {
  const issues = [];
...
export function summarizeAcquisitionAdvisorPolicies(policies = createAcquisitionAdvisorPolicies()) {
  return {
...
export function createAcquisitionAdvisorEscalationDeck(policies = createAcquisitionAdvisorPolicies()) {
