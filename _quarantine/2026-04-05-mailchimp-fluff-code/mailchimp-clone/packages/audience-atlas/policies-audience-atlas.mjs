...
export function createAudienceAtlasPolicies(overrides = {}) {
...
export function validateAudienceAtlasPolicies(policies = createAudienceAtlasPolicies()) {
  const issues = [];
...
export function summarizeAudienceAtlasPolicies(policies = createAudienceAtlasPolicies()) {
  return {
...
export function createAudienceAtlasEscalationDeck(policies = createAudienceAtlasPolicies()) {
