const MODULE = {
  ...
  "focus": "Audience Atlas covers audience health, segment design, and targeting durability through landscape mapping and territory coverage.",
...
export function createAudienceAtlasWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeAudienceAtlasWorkspace(workspace = createAudienceAtlasWorkspace()) {
  return {
    id: workspace.id,
...
export function createAudienceAtlasNarratives(workspace = createAudienceAtlasWorkspace()) {
...
export function createAudienceAtlasCoverageGrid(workspace = createAudienceAtlasWorkspace()) {
