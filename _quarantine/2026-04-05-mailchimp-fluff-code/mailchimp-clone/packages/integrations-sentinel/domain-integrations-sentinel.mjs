...
export function createIntegrationsSentinelWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeIntegrationsSentinelWorkspace(workspace = createIntegrationsSentinelWorkspace()) {
  return {
    id: workspace.id,
...
export function createIntegrationsSentinelNarratives(workspace = createIntegrationsSentinelWorkspace()) {
...
export function createIntegrationsSentinelCoverageGrid(workspace = createIntegrationsSentinelWorkspace()) {
