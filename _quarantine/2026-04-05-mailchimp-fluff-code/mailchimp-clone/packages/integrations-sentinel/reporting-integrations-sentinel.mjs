...
export function createIntegrationsSentinelReportCards() {
...
export function createIntegrationsSentinelReviewPackets() {
...
export function summarizeIntegrationsSentinelReporting() {
  const cards = createIntegrationsSentinelReportCards();
  const packets = createIntegrationsSentinelReviewPackets();
  return {
