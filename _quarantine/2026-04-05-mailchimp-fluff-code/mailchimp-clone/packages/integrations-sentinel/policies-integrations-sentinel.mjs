...
export function createIntegrationsSentinelPolicies(overrides = {}) {
...
export function validateIntegrationsSentinelPolicies(policies = createIntegrationsSentinelPolicies()) {
  const issues = [];
...
export function summarizeIntegrationsSentinelPolicies(policies = createIntegrationsSentinelPolicies()) {
  return {
...
export function createIntegrationsSentinelEscalationDeck(policies = createIntegrationsSentinelPolicies()) {
