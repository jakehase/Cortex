...
export function createIntegrationsSentinelOperationsBoard() {
...
export function createIntegrationsSentinelShiftChecklist() {
...
export function createIntegrationsSentinelIncidentDeck() {
