...
export function createIntegrationsSentinelAuditTrail() {
...
export function createIntegrationsSentinelEvidenceManifest() {
...
export function createIntegrationsSentinelReadinessAttestation() {
  const auditTrail = createIntegrationsSentinelAuditTrail();
  return {
