...
export function createBenchmarkFoundryPolicies(overrides = {}) {
...
export function validateBenchmarkFoundryPolicies(policies = createBenchmarkFoundryPolicies()) {
  const issues = [];
...
export function summarizeBenchmarkFoundryPolicies(policies = createBenchmarkFoundryPolicies()) {
  return {
...
export function createBenchmarkFoundryEscalationDeck(policies = createBenchmarkFoundryPolicies()) {
