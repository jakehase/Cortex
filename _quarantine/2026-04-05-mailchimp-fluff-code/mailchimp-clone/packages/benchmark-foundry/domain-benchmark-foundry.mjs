...
export function createBenchmarkFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeBenchmarkFoundryWorkspace(workspace = createBenchmarkFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createBenchmarkFoundryNarratives(workspace = createBenchmarkFoundryWorkspace()) {
...
export function createBenchmarkFoundryCoverageGrid(workspace = createBenchmarkFoundryWorkspace()) {
