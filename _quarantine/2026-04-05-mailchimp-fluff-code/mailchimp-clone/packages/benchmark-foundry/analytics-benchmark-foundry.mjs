...
export function createBenchmarkFoundryAnalyticsTimeline() {
...
export function createBenchmarkFoundryForecastEnvelope() {
...
export function createBenchmarkFoundryExceptionLedger() {
...
export function summarizeBenchmarkFoundryAnalytics() {
  const timeline = createBenchmarkFoundryAnalyticsTimeline();
  const forecast = createBenchmarkFoundryForecastEnvelope();
  return {
