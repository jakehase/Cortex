...
export function createBenchmarkFoundryReportCards() {
...
export function createBenchmarkFoundryReviewPackets() {
...
export function summarizeBenchmarkFoundryReporting() {
  const cards = createBenchmarkFoundryReportCards();
  const packets = createBenchmarkFoundryReviewPackets();
  return {
