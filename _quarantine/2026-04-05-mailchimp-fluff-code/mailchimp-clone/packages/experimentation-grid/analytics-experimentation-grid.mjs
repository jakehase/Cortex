...
export function createExperimentationGridAnalyticsTimeline() {
...
export function createExperimentationGridForecastEnvelope() {
...
export function createExperimentationGridExceptionLedger() {
...
export function summarizeExperimentationGridAnalytics() {
  const timeline = createExperimentationGridAnalyticsTimeline();
  const forecast = createExperimentationGridForecastEnvelope();
  return {
