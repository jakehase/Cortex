...
export function createExperimentationGridAuditTrail() {
...
export function createExperimentationGridEvidenceManifest() {
...
export function createExperimentationGridReadinessAttestation() {
  const auditTrail = createExperimentationGridAuditTrail();
  return {
