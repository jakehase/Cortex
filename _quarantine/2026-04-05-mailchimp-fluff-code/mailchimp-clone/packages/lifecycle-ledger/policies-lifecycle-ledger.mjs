...
export function createLifecycleLedgerPolicies(overrides = {}) {
...
export function validateLifecycleLedgerPolicies(policies = createLifecycleLedgerPolicies()) {
  const issues = [];
...
export function summarizeLifecycleLedgerPolicies(policies = createLifecycleLedgerPolicies()) {
  return {
...
export function createLifecycleLedgerEscalationDeck(policies = createLifecycleLedgerPolicies()) {
