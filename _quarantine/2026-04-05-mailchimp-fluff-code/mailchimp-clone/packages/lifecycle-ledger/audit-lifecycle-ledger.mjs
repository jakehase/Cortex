...
export function createLifecycleLedgerAuditTrail() {
...
export function createLifecycleLedgerEvidenceManifest() {
...
export function createLifecycleLedgerReadinessAttestation() {
  const auditTrail = createLifecycleLedgerAuditTrail();
  return {
