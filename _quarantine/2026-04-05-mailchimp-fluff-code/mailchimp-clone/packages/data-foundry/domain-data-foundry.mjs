const MODULE = {
  ...
  "title": "Data Foundry",
  "focus": "Data Foundry covers pipeline health, lineage, freshness, and operator trust in data assets through program building and surface composition.",
...
export function createDataFoundryWorkspace(workspaceName = 'Scale Wave Seven workspace') {
  return {
    ...MODULE,
    workspaceName,
...
export function summarizeDataFoundryWorkspace(workspace = createDataFoundryWorkspace()) {
  return {
    id: workspace.id,
...
export function createDataFoundryNarratives(workspace = createDataFoundryWorkspace()) {
...
export function createDataFoundryCoverageGrid(workspace = createDataFoundryWorkspace()) {
