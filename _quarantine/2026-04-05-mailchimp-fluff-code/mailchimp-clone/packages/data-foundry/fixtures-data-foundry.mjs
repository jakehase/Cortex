...
export function createDataFoundryFixtures() {
  return {
    accounts: [
...
export function summarizeDataFoundryFixtures(fixtures = createDataFoundryFixtures()) {
  return {
...
export function createDataFoundryDemoInputs() {
  return {
