...
export function createCollaborationDossierAuditTrail() {
...
export function createCollaborationDossierEvidenceManifest() {
...
export function createCollaborationDossierReadinessAttestation() {
  const auditTrail = createCollaborationDossierAuditTrail();
  return {
