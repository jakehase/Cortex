...
export function createCollaborationDossierPolicies(overrides = {}) {
...
export function validateCollaborationDossierPolicies(policies = createCollaborationDossierPolicies()) {
  const issues = [];
...
export function summarizeCollaborationDossierPolicies(policies = createCollaborationDossierPolicies()) {
  return {
...
export function createCollaborationDossierEscalationDeck(policies = createCollaborationDossierPolicies()) {
